...
class ButtonData
{
    ...
    public function new(text : String, callback : Function = null, toolTipText : String = "", toolTipHeader : String = "")
    {
        this.text = text;
    ...
    public function enable(callback : Function = null, toolTipText : String = null, toolTipHeader : String = null) : ButtonData
    {
        ...
        if (Std.is(toolTipText, String))
        {
            this.toolTipText = toolTipText;
        }
        if (Std.is(toolTipHeader, String))
        {
            this.toolTipHeader = toolTipHeader;
        }
    ...
    public function disableIf(condition : Bool, toolTipText : String = null, toolTipHeader : String = null, text : String = null) : ButtonData
    {
        if (condition)
        {
	 ...
	 */
    public function extra(extraData : Dynamic) : ButtonData
    {
    ...
    public function applyTo(btn : CoCButton) : Void
    {
        ...
        {
            btn.show(text, callback, toolTipText, toolTipHeader).color(labelColor).disableIf(!enabled).icon(iconId, iconQty).cornerLabel(cornerLabelText);
        }
    }
    /**
	 ...
	 */
    public function requireSoulforce(cost : Float) : ButtonData
    {
        toolTipText += "\nSoulforce cost: " + cost;
	 ...
	 */
    public function requireLust(cost : Float) : ButtonData
    {
        toolTipText += "\nLust cost: " + cost;
	 ...
	 */
    public function requireWrath(cost : Float) : ButtonData
    {
        toolTipText += "\nWrath cost: " + cost;
	 ...
	 */
    public function requireMana(cost : Float, allowBloodMage : Bool = false) : ButtonData
    {
        toolTipText += "\nMana cost: " + cost;
	 ...
	 * @param allowBloodMage Do not disable button if player has Blood Mage perk
	 */
    public function requireFatigue(cost : Float, allowBloodMage : Bool = false) : ButtonData
    {
        toolTipText += "\nFatigue cost: " + cost;
