...
class DraconicLungMutation extends IMutationPerkType
{
    ...
    override public function pReqs(pCheck : Int = -1) : Void
    {
        try
        {
            ...
            if (pTier == 0)
            {
                this.requireLungsMutationSlot().requirePerks(PerkLib.DragonFireBreath, PerkLib.DragonIceBreath, PerkLib.DragonLightningBreath, PerkLib.DragonDarknessBreath).requireRace(Races.DRAGON);
            }
            else
            {
