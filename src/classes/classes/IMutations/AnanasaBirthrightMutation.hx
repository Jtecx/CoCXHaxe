...
class AnanasaBirthrightMutation extends IMutationPerkType
{
    ...
    override public function mDesc(params : PerkClass, pTier : Int = -1) : String
    {
        ...
        if (descS != "")
        {
            descS += " multi-functional self-sustain system modeled after progenitor of all werespiders.";
        }
        return descS;
    }
    ...
    override public function pReqs(pCheck : Int = -1) : Void
    {
        try
        {
            ...
            //.requirePerk(PerkLib.){
                this.requireAdaptationsMutationSlot().requireRace(Races.WERESPIDER);
            }
            else
            {
