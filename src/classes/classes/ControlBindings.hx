    ...
    private function run(inputManager : InputManager) : Void
    {
        ...
        inputManager.AddBindableControl(
                ...
                function() : Void
                {
                    ...
                    {
                        var saveFile : Dynamic = SharedObject.getLocal("CoC_1", "/");
        ...
        inputManager.AddBindableControl(
                ...
                function() : Void
                {
                    if (CoC.instance.mainView.menuButtonIsVisible(MainView.MENU_DATA))
                    {
                        var saveFile : Dynamic = SharedObject.getLocal("CoC_2", "/");
                        if (saveFile.data.exists)
                        {
        ...
        inputManager.AddBindableControl(
                ...
                function() : Void
                {
                    if (CoC.instance.mainView.menuButtonIsVisible(MainView.MENU_DATA))
                    {
                        var saveFile : Dynamic = SharedObject.getLocal("CoC_3", "/");
                        if (saveFile.data.exists)
                        {
        ...
        inputManager.AddBindableControl(
                ...
                function() : Void
                {
                    if (CoC.instance.mainView.menuButtonIsVisible(MainView.MENU_DATA))
                    {
                        var saveFile : Dynamic = SharedObject.getLocal("CoC_4", "/");
                        if (saveFile.data.exists)
                        {
        ...
        inputManager.AddBindableControl(
                ...
                function() : Void
                {
                    if (CoC.instance.mainView.menuButtonIsVisible(MainView.MENU_DATA))
                    {
                        var saveFile : Dynamic = SharedObject.getLocal("CoC_5", "/");
                        if (saveFile.data.exists)
                        {
        ...
        inputManager.AddBindableControl(
                ...
                function() : Void
                {
                    if (CoC.instance.mainView.menuButtonIsVisible(MainView.MENU_DATA))
                    {
                        CoC.instance.saves.saveLoad(null);
                    }
                }, 
                mainView.dataButton
        );
