...
class Regeneration6Perk extends PerkType
{
    ...
    public function new()
    {
        super("Regeneration VI", "Regeneration VI", 
                ...
                "You choose the 'Regeneration VI' perk, giving you an additional 0,5% of max HP per turn in combat and 1% of max HP per hour."
        );
    }
}
