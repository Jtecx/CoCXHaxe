...
class InquisitorsTome extends WeaponRange
{
    ...
    override public function equipText() : Void
    {
        ...
        if (game.player.hasPerk(PerkLib.JobSorcerer))
        {
            outputText("Beyond the words... you feel power in the pages, the ink and the binding. ");
        }
        outputText("You reclasp the tome, and hang it ");
        if (game.player.armorName == "nothing")
        {
            outputText("from your shoulder");
        }
        else
        {
            outputText("from your belt");
        }
