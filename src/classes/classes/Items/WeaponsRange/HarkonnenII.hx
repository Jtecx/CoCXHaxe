...
class HarkonnenII extends WeaponRange
{
    ...
    override public function canEquip(doOutput : Bool, slot : Int) : Bool
    {
        ...
        if (doOutput)
        {
            outputText("You aren't skilled in handling large firearms with one hand yet to effectively use those cannons. Unless you want to hurt yourself instead of your enemies when trying to use them...  ");
        }
        return false;
    }
}
