...
class SluttySwimwear extends Armor
{
    ...
    override public function equipText() : Void
    {
        ...
        if (game.player.cockTotal() == 0)
        {
            ...
            {
                if (game.player.ballSize > 5)
                {
                    outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + game.player.ballsDescriptLight() + " hang on the sides, exposed.  Maybe if you shrunk your male parts down a little...");
                }
                else
                {
                    outputText("However, your testicles do serve as an area of discomfort, stretching the material and bulging out the sides slightly.  ");
                }
            }
        }
        else
        {
            ...
            game.player.dynStats("lus", 5, "scale", false);
            if (game.player.biggestCockArea() >= 20)
            {
                outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + game.player.cockDescript(game.player.biggestCockIndex()) + " has popped out of the top, completely exposed.  Maybe if you shrunk your male parts down a little...");
            }
            //[If dick is 7+ inches OR balls are apple-sized]
            else if (game.player.ballSize > 5)
            {
                outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + game.player.ballsDescriptLight() + " hang on the sides, exposed.  Maybe if you shrunk your male parts down a little...");
            }
        }
