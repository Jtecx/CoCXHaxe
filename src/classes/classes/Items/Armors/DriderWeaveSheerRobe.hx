...
class DriderWeaveSheerRobe extends Armor
{
    ...
    override public function equipText() : Void
    {
        ...
        {
            outputText("You poke your [uppergarment] through the sheer fabric, then take some of the robe between two fingers.");
        }
        else
        {
            outputText("Your [breasts] are visible to the world, and as you watch, your nipples stand up at the exposure.");
        }
        if (game.player.lowerGarment.isNothing)
        {
            outputText("\n\nYou look between your [legs], and to your ");
            if (game.player.cor < 30)
            {
                outputText("dismay");
            }
            else if (game.player.cor > 60)
            {
                outputText("delight");
            }
            else
            {
                outputText("indifference");
            }
