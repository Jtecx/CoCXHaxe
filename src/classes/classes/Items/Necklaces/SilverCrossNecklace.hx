...
class SilverCrossNecklace extends Necklace
{
    ...
    {
        if (!game.isLoadingSave && !game.player.hasStatusEffect(StatusEffects.MeetXuviel))
        {
            game.player.createStatusEffect(StatusEffects.MeetXuviel, 0, 0, 0, 0);
        }
