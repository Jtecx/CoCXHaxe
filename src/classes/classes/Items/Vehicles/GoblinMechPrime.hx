...
class GoblinMechPrime extends Vehicles
{
    ...
    override public function canEquip(doOutput : Bool, slot : Int) : Bool
    {
        ...
        if (game.player.basetallness > 48 || game.player.tailType != Tail.NONE || game.player.hasPhysicalWings())
        
        //Taller than 4 ft or having wings/tail{
