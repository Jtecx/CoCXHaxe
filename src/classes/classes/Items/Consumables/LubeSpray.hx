 ...
 * @author Svalkash
 * */
class LubeSpray extends Consumable
{
    public function new()
    {
    ...
    {
        var desc : String = (flags[kFLAGS.DISCUSSED_LUBE_SPRAY] != null) ? "A highly concentrated spray juice Lianna distilled for you, it may have some transforming properties." : 
    ...
    override public function useItem() : Bool
    {
        ...
        if (player.ass.analWetness < AssClass.WETNESS_SLIME_DROOLING && rand(2) == 0)
        {
            choices.push(1);
        }  //rare enough?  
        ...
        switch (choice)
        {
            ...
            case 1:
                ...
                {
                    outputText("<b>Your anus is now permanently wet, ensuring it will always be lubed!</b>");
                }
                else
                {
                    outputText("<b>Your anus is even wetter, ensuring even better lubrication!</b>");
                }
