...
class HairDye extends Consumable
{
    ...
    public static var RARITY_TO_VALUE : Dynamic = {
            1 : 6,
            2 : 10,
            3 : 50,
            4 : 100
    ...
    public function new(id : String, params : Dynamic)
    {
        ...
        super(id, shortName, longName, Reflect.field(RARITY_TO_VALUE, Std.string(rarity)) || 6, description);
    ...
    override public function useItem() : Bool
    {
        ...
        else
        {
        ...
        ])
            {
                ...
                {
                    itemCnt = 1;
                    if (player.coatType() == Skin.DRAGON_SCALES)
                    {
                        itemCnt = 2;
                    }
                }
                ...
                var present : Bool = player.hasBodyMaterial(type);
                if (present)
                {
    ...
    private function dye(material : Int, itemReq : ItemType, itemCnt : Int, slot : String = "") : Void
    {
        ...
        Reflect.setField(bm, slot, _color);
