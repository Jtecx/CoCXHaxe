...
@:final class BangBallMk1 extends Consumable
{
    ...
    override public function useItem() : Bool
    {
        ...
        if (game.monster.spe - 160 > Utils.rand(100) + 1)
        
        //1% dodge for each point of speed over 160{
        ...
        else
        {
            ...
            var damage : Float = 280 + Utils.rand(141);
