...
@:final class DeBimbo extends Consumable
{
    ...
    {
        if (game.player.hasPerk(PerkLib.BimboBrains) || game.player.hasPerk(PerkLib.FutaFaculties) || game.player.hasPerk(PerkLib.BroBrains))
        {
            return true;
        }
