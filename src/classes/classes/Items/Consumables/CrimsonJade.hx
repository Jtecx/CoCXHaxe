...
class CrimsonJade extends Consumable
{
    ...
    public function crimsonJade() : Void
    {
        ...
        if (player.hasPerk(PerkLib.HiddenJobBloodDemon))
        {
            ...
            {
                EngineCore.addButton(2, "B.Swip", crimsonJade1, 1).hint("Learn Blood Swipe soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(2, "B.Swip", "You not have have enough wis or already know this soulskill.");
            }
            if (player.wis >= 30 && !player.hasStatusEffect(StatusEffects.KnowsHeartSeeker))
            {
                EngineCore.addButton(3, "H.Seek", crimsonJade1, 2).hint("Learn Heart Seeker soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(3, "H.Seek", "You not have have enough wis or already know this soulskill.");
            }
            if (player.wis >= 40 && !player.hasStatusEffect(StatusEffects.KnowsBloodDewdrops))
            {
                EngineCore.addButton(4, "B.Dewd", crimsonJade1, 3).hint("Learn Blood Dewdrops soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(4, "B.Dewd", "You not have have enough wis or already know this soulskill.");
            }
            if (player.wis >= 50 && !player.hasStatusEffect(StatusEffects.KnowsBloodRequiem))
            {
                EngineCore.addButton(5, "B.Requ", crimsonJade1, 4).hint("Learn Blood Requiem soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(5, "B.Requ", "You not have have enough wis or already know this soulskill.");
            }
            ...
            {
                EngineCore.addButton(7, "S.S.Ch", crimsonJade1, 6).hint("Learn Scarlet Spirit Charge soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(7, "S.S.Ch", "You not have have enough wis or already know this soulskill.");
            }
        }
        if (player.hasPerk(PerkLib.MyBloodForBloodPuppies))
        {
            if (player.wis >= 30 && !player.hasStatusEffect(StatusEffects.KnowsBloodSwipeSF) && player.hasStatusEffect(StatusEffects.KnowsBloodSwipe))
            {
                EngineCore.addButton(8, "S.B.Swip", crimsonJade1, 7).hint("Learn (Soulforce infused) Blood Swipe soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(8, "S.B.Swip", "You not have have enough wis or already know this soulskill.");
            }
            if (player.wis >= 40 && !player.hasStatusEffect(StatusEffects.KnowsHeartSeekerSF) && player.hasStatusEffect(StatusEffects.KnowsHeartSeeker))
            {
                EngineCore.addButton(9, "S.H.Seek", crimsonJade1, 8).hint("Learn (Soulforce infused) Heart Seeker soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(9, "S.H.Seek", "You not have have enough wis or already know this soulskill.");
            }
            if (player.wis >= 50 && !player.hasStatusEffect(StatusEffects.KnowsBloodDewdropsSF) && player.hasStatusEffect(StatusEffects.KnowsBloodDewdrops))
            {
                EngineCore.addButton(10, "S.B.Dewd", crimsonJade1, 9).hint("Learn (Soulforce infused) Blood Dewdrops soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(10, "S.B.Dewd", "You not have have enough wis or already know this soulskill.");
            }
            if (player.wis >= 60 && !player.hasStatusEffect(StatusEffects.KnowsBloodRequiemSF) && player.hasStatusEffect(StatusEffects.KnowsBloodRequiem))
            {
                EngineCore.addButton(11, "S.B.Requ", crimsonJade1, 10).hint("Learn (Soulforce infused) Blood Requiem soulskill.");
            }
            else
            {
                EngineCore.addButtonDisabled(11, "S.B.Requ", "You not have have enough wis or already know this soulskill.");
            }
        }
    }
    ...
    public function crimsonJade1(soulskill : Float) : Void
    {
        clearOutput();
