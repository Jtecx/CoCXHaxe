...
class VampireBlood extends Consumable
{
    private var pure : Bool;
    public static var first : Bool = true;
    public function new(purified : Bool = false)
    {
        super(
    ...
    override public function useItem() : Bool
    {
        ...
        else
        {
            ...
            if (EngineCore.silly())
            {
                outputText("What else were you expecting with that label and smell? Tomato juice with iron shavings?\n\n");
            }
