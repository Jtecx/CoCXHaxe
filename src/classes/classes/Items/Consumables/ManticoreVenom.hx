...
class ManticoreVenom extends Consumable
{
    public function new()
    {
    ...
    override public function useItem() : Bool
    {
        ...
        if (player.cor < 100 && changes < changeLimit && rand(2) == 0)
        {
            ...
            if (player.cor < 50)
            {
                outputText(" You suddenly realize what you're doing and shake your head, trying to clear your mind, disgusted with yourself.");
            }
            else
            {
                outputText(" You idly start fingering yourself as you keep imagining the various tortures you will inflict on the cumpumps that are your victims. Seeing yourself drinking their cum as they beg you to stop. You almost orgasm at the thought of it, however, you're brought back to reality as your knees hit the ground.");
            }
            dynStats("cor", 1);
            changes++;
        }
