...
class OnikiriSake extends Consumable
{
    public function new()
    {
    ...
    override private function get_description() : String
    {
        ...
        {
            desc += " Izumi kept a full stock of this in her camp. A strong beverage just like the people who drinks it.";
        }
        desc += "\n\nType: Consumable ";
    ...
    override public function useItem() : Bool
    {
        ...
        if (CoC.instance.inCombat)
        {
            ...
            if (EngineCore.silly())
            {
                outputText("A walking amphora full of red wine bursts through a nearby wall and waves at you. ");
            }
            outputText("That's just what you needed to quench your thirst... now time to beat up those puny eeehhh... things to a pulp!");
        }
        else
        {
            outputText("Woa! That sake sure is powerful. You laugh as your cheeks redden with the obvious sign of complete inebriation. You're so drunk you barely register as your body begins to change.");
        }
        ...
        if (rand(4) == 0)
        {
            outputText(player.modTone(85, 3));
        }
        //FAILSAFE CHANGE
        if (changes == 0)
        {
