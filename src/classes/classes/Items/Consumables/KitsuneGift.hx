...
@:final class KitsuneGift extends Consumable
{
    ...
    override public function useItem() : Bool
    {
        ...
        switch (Utils.rand(12))
        {
            ...
            case 2:
                ...
                var gems : Int = as3hx.Compat.parseInt(20 + Utils.rand(10));
            ...
            case 6:
                ...
                var stolen : Float = 20 + Utils.rand(10);
                if (game.player.gems - stolen < 0)
                {
                    stolen = game.player.gems;
                }
