...
class AsteriusRage extends Weapon
{
    ...
    {
        var boost : Int = 0;
        if (game.player.str >= 1300)
        {
            boost += 40;
        }
        if (game.player.str >= 1200)
        {
            boost += 35;
        }
        if (game.player.str >= 1100)
        {
            boost += 30;
        }
        if (game.player.str >= 1000)
        {
            boost += 30;
        }
        if (game.player.str >= 900)
        {
            boost += 9;
        }
        if (game.player.str >= 800)
        {
            boost += 8;
        }
        if (game.player.str >= 700)
        {
            boost += 7;
        }
        if (game.player.str >= 600)
        {
            boost += 6;
        }
        ...
        boost += as3hx.Compat.parseInt((game.player.cor) / 5);
        return (1 + boost);
    }
}
