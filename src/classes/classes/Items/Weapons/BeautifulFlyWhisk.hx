...
class BeautifulFlyWhisk extends Weapon implements TimeAwareInterface
{
    ...
    public function calcCultivatorMult() : Float
    {
    ...
    public function updateCultivatorMult() : Void
    {
        ...
        {
            var newMult : Float = calcCultivatorMult();
            Reflect.setField(_buffs, "psoulskillpower", newMult);
            Reflect.setField(_buffs, "msoulskillpower", newMult);
