...
class SphinxAccessorySet extends HeadJewelry
{
    ...
    override public function afterEquip(doOutput : Bool, slot : Int) : Void
    {
        ...
        {
            while (game.player.hasStatusEffect(StatusEffects.SphinxAS))
            {
                game.player.removeStatusEffect(StatusEffects.SphinxAS);
            }
