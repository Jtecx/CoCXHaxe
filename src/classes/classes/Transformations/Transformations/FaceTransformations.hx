 ...
 */
class FaceTransformations extends MutationsHelper
{
    ...
    */
    ...
    /*
      */
    public var FaceHuman(default, never) : Transformation = new SimpleTransformation("Human Face", 
        // apply effect
    ...
    public var FaceHorse(default, never) : Transformation = new SimpleTransformation("Horse Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Mind-numbing pain shatters through you as you feel your facial bones rearranging. You clutch at your face in agony as your skin crawls and shifts, your visage reshaping to replace your dog-like characteristics with those of a horse. <b>You now have a horse's face.</b>";
            }
            else
            {
                desc += "Mind-numbing pain shatters through you as you feel your facial bones breaking and shifting. You clutch at yourself in agony as you feel your skin crawl and elongate under your fingers. Eventually the pain subsides, leaving you with a face that seamlessly blends human and equine features. <b>You have a very equine-looking face.</b>";
            }
    ...
    public var FaceDog(default, never) : Transformation = new SimpleTransformation("Dog Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Your face is wracked with pain. You throw back your head and scream in agony as you feel your cheekbones breaking and shifting, reforming into something else. <b>Your horse-like features rearrange to take on many canine aspects.</b>";
            }
            else
            {
    ...
    public var FaceCerberus(default, never) : Transformation = new SimpleTransformation("Cerberus Tripple Head", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceCowMinotaur(default, never) : Transformation = new SimpleTransformation("Cow Minotaur Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var FaceSharkTeeth(default, never) : Transformation = new SimpleTransformation("Shark Teeth Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceSnakeFangs(default, never) : Transformation = new SimpleTransformation("Snake Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += " As the change progresses, your [face] reshapes. The sensation is far more pleasant than teeth cutting into gums, and as the tingling transformation completes, <b>you've gained with a normal-looking, human visage.</b>";
            }
    ...
    public var FaceCat(default, never) : Transformation = new SimpleTransformation("Cat Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (choice == 0)
            {
                desc += "Your face is wracked with pain. You throw back your head and scream in agony as you feel your cheekbones breaking and shifting, reforming into something... different. You find a puddle to view your reflection and discover <b>your face is now a cross between human and feline features.</b>";
            }
            else if (choice == 1)
            {
                desc += "Mind-numbing pain courses through you as you feel your facial bones rearranging. You clutch at your face in agony as your skin crawls and shifts, your visage reshaping to replace your facial characteristics with those of a feline. <b>You now have an anthropomorphic cat-face.</b>";
            }
            else
            {
                desc += "Your face is wracked with pain. You throw back your head and scream in agony as you feel your cheekbones breaking and shifting, reforming into something else. <b>Your facial features rearrange to take on many feline aspects.</b>";
            }
    ...
    public var FaceCatCanines(default, never) : Transformation = new SimpleTransformation("Cat Canines Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var startsWithCatFace : Bool = player.faceType == Face.CAT;
            
            TransformationUtils.applyTFIfNotPresent(transformations.FaceHuman, doOutput);
            
            if (!startsWithCatFace)
            {
            ...
            {
                desc += "However, your mouth remains filled with cat-like canines.";
            }
    ...
    public var FaceLizard(default, never) : Transformation = new SimpleTransformation("Lizard Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceBunny(default, never) : Transformation = new SimpleTransformation("Bunny Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceKangaroo(default, never) : Transformation = new SimpleTransformation("Kangaroo Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            
            if (player.faceType == Face.HUMAN || player.faceType == Face.SNAKE_FANGS || player.faceType == Face.SHARK_TEETH || player.faceType == Face.BUNNY)
            {
                desc += "The base of your nose suddenly hurts, as though someone were pinching and pulling at it. As you shut your eyes against the pain and bring your hands to your face, you can feel your nose and palate shifting and elongating. This continues for about twenty seconds as you stand there, quaking. When the pain subsides, you run your hands all over your face; what you feel is a long muzzle sticking out, whiskered at the end and with a cleft lip under a pair of flat nostrils. You open your eyes and receive confirmation. <b>You now have a kangaroo face!  Crikey!</b>";
            }
            else
            {
                desc += "Your nose tingles. As you focus your eyes toward the end of it, it twitches and shifts into a muzzle similar to a stretched-out rabbit's, complete with harelip and whiskers. <b>You now have a kangaroo face!</b>";
            }
    ...
    public var FaceSpiderFangs(default, never) : Transformation = new SimpleTransformation("Spider Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var FaceFox(default, never) : Transformation = new SimpleTransformation("Fox Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (silly())
            {
                desc += "  And they called you crazy...";
            }
    ...
    public var FaceDragon(default, never) : Transformation = new SimpleTransformation("Draconic Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceDragonFangs(default, never) : Transformation = new SimpleTransformation("Draconic Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceRaccoonMask(default, never) : Transformation = new SimpleTransformation("Raccoon Mask Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.faceType == Face.HUMAN || player.faceType == Face.SHARK_TEETH || player.faceType == Face.SNAKE_FANGS || player.faceType == Face.BUNNY)
            {
                ...
                {
                    desc += "A dark, almost black mask shades the " + player.skinFurScales() + " around your eyes and over the topmost portion of your nose, lending you a criminal air! Furthermore your canines have slightly elongated not unlike those of an animal. <b>You now have a raccoon mask and sharp canines like those of a raccoon!</b>";
                }
            }
            else
            {
                ...
                if ((player.hairColor == "black" || player.hairColor == "midnight") && (player.isFurCovered() || player.isScaleCovered()))
                {
                    desc += "your face apparently returned to normal shape, albeit still covered in " + player.skinFurScales() + ". You look closer and discover a darker, mask-line outline on your already inky visage. <b>You now have a barely-visible raccoon mask on your otherwise normal human face.</b>";
                }
                else if ((player.skinColor == "ebony" || player.skinColor == "black") && (!player.hasCoat()))
                {
                    desc += "your face apparently returned to normal shape. You look closer and discover a darker, mask-line outline on your already inky visage. <b>You now have a barely-visible raccoon mask on your normal human face.</b>";
                }
                else
                {
                    desc += "your face returned to human dimensions, but shaded by a black mask around the eyes and over the nose!  <b>You now have a humanoid face with a raccoon mask!</b>";
                }
            }
    ...
    public var FaceRaccoon(default, never) : Transformation = new SimpleTransformation("Raccoon Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceBuckteeth(default, never) : Transformation = new SimpleTransformation("Buckteeth Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "the sharp teeth receding and ";
            }
    ...
    public var FaceMouse(default, never) : Transformation = new SimpleTransformation("Mouse Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceFerretMask(default, never) : Transformation = new SimpleTransformation("Ferret Mask Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceFerret(default, never) : Transformation = new SimpleTransformation("Ferret Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FacePig(default, never) : Transformation = new SimpleTransformation("Pig Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceBoar(default, never) : Transformation = new SimpleTransformation("Boar Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceRhino(default, never) : Transformation = new SimpleTransformation("Rhino Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceEchidna(default, never) : Transformation = new SimpleTransformation("Echidna Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceDeer(default, never) : Transformation = new SimpleTransformation("Deer Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceWolf(default, never) : Transformation = new SimpleTransformation("Wolf Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceManticore(default, never) : Transformation = new SimpleTransformation("Manticore Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceSalamanderFangs(default, never) : Transformation = new SimpleTransformation("Salamander Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceYetiFangs(default, never) : Transformation = new SimpleTransformation("Yeti Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceOrca(default, never) : Transformation = new SimpleTransformation("Orca Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FacePlantDragon(default, never) : Transformation = new SimpleTransformation("Plant Dragon Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceDevilFangs(default, never) : Transformation = new SimpleTransformation("Devil Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceInnocent(default, never) : Transformation = new SimpleTransformation("Azazel Innocent Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceOniTeeth(default, never) : Transformation = new SimpleTransformation("Oni Teeth Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceWeasel(default, never) : Transformation = new SimpleTransformation("Weasel Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceVampire(default, never) : Transformation = new SimpleTransformation("Vampire Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceBucktooth(default, never) : Transformation = new SimpleTransformation("Bucktooth Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceJabberwocky(default, never) : Transformation = new SimpleTransformation("Jabberwocky Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceRedPanda(default, never) : Transformation = new SimpleTransformation("Red Panda Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceCheshire(default, never) : Transformation = new SimpleTransformation("Cheshire Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var startsWithCheshireSmile : Bool = player.faceType == Face.CHESHIRE_SMILE;
            
            TransformationUtils.applyTFIfNotPresent(transformations.FaceCat, doOutput);
            
            if (!startsWithCheshireSmile)
            {
            ...
            {
                desc += "Of course, your fanged cheshire smile is still there.";
            }
    ...
    public var FaceCheshireSmile(default, never) : Transformation = new SimpleTransformation("Cheshire Smile Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var startsWithCheshireFace : Bool = player.faceType == Face.CHESHIRE;
    ...
    public var FaceAvian(default, never) : Transformation = new SimpleTransformation("Avian Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceWolfFangs(default, never) : Transformation = new SimpleTransformation("Wolf Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var startsWithWolfFace : Bool = player.faceType == Face.WOLF;
            
            TransformationUtils.applyTFIfNotPresent(transformations.FaceHuman, doOutput);
            
            if (!startsWithWolfFace)
            {
                desc += "You feel your canines changing, elongating into sharp dagger-like teeth capable of causing severe injuries. Funnily, your face remained relatively human even after the change. <b>Your mouth is now filled with wolf-like canines.</b>";
            }
            else
            {
                desc += "However, your mouth remains filled with wolf-like canines.";
            }
    ...
    public var FaceFoxFangs(default, never) : Transformation = new SimpleTransformation("Fox Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var startsWithFoxFace : Bool = player.faceType == Face.FOX;
            
            TransformationUtils.applyTFIfNotPresent(transformations.FaceHuman, doOutput);
            
            if (!startsWithFoxFace)
            {
                desc += "You feel your canines changing, elongating into sharp dagger-like teeth capable of causing severe injuries. Funnily, your face remained relatively human even after the change. <b>Your mouth is now filled with fox-like canines.</b>";
            }
            else
            {
                desc += "However, your mouth remains filled with fox-like canines.";
            }
    ...
    public var FaceOrcFangs(default, never) : Transformation = new SimpleTransformation("Orc Fangs Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceAnimalTeeth(default, never) : Transformation = new SimpleTransformation("Animal Teeth Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceBear(default, never) : Transformation = new SimpleTransformation("Bear Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FacePanda(default, never) : Transformation = new SimpleTransformation("Panda Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceFireSnail(default, never) : Transformation = new SimpleTransformation("Fire Snail Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceGhost(default, never) : Transformation = new SimpleTransformation("Ghost Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceJiangshi(default, never) : Transformation = new SimpleTransformation("Jiangshi Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceYukiOnna(default, never) : Transformation = new SimpleTransformation("Yuki Onna Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceKudere(default, never) : Transformation = new SimpleTransformation("Kudere Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (silly())
            {
                desc += "Card sharks would gladly sell their souls for a poker face as good as yours.";
            }
            desc += "</b>";
    ...
    public var FaceUshiOniOnna(default, never) : Transformation = new SimpleTransformation("Ushi Oni/Onna Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceFairy(default, never) : Transformation = new SimpleTransformation("Fairy Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceCrazy(default, never) : Transformation = new SimpleTransformation("Crazy Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceSmug(default, never) : Transformation = new SimpleTransformation("Smug Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceSquirrel(default, never) : Transformation = new SimpleTransformation("Squirrel Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceElf(default, never) : Transformation = new SimpleTransformation("Elf Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceAnt(default, never) : Transformation = new SimpleTransformation("Ant Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var FaceAbyssalShark(default, never) : Transformation = new SimpleTransformation("Abyssal Shark Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceArigean(default, never) : Transformation = new SimpleTransformation("Arigean Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceDemon(default, never) : Transformation = new SimpleTransformation("Demon Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceTroll(default, never) : Transformation = new SimpleTransformation("Troll Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var FaceGlacialTroll(default, never) : Transformation = new SimpleTransformation("Glacial Troll Face", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
