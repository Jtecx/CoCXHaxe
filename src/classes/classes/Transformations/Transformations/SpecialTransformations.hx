 ...
 */
class SpecialTransformations extends MutationsHelper
{
    /*
    * 	   █████  ████████ ██    ██ ██████ ██████
    *  	 ██    ██    ██    ██    ██ ██     ██   ██
    ...
    */
    ...
    /*
    */
    public var RemoveOvipositor(default, never) : Transformation = new SimpleTransformation("Remove Oviposition", 
        // apply
    ...
    public var GainOvipositor(default, never) : Transformation = new SimpleTransformation("Remove Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
    ...
    public var OvipositorBee(default, never) : Transformation = new SimpleTransformation("Bee Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var OvipositorSpider(default, never) : Transformation = new SimpleTransformation("Spider Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var OvipositorMantis(default, never) : Transformation = new SimpleTransformation("Mantis Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            TransformationUtils.applyTFIfNotPresent(transformations.SkinChitin(Skin.COVERAGE_LOW, {
                                colors : MantisRace.MantisChitinColors
                            }), doOutput);
    ...
    public var OvipositorAnt(default, never) : Transformation = new SimpleTransformation("Mantis Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RemoveOviposition(default, never) : Transformation = new SimpleTransformation("Stop Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var GainOviposition(default, never) : Transformation = new SimpleTransformation("Start Oviposition", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
        ...
        function() : Bool
        {
            ...
            player.hasPerk(PerkLib.BasiliskWomb));
        });
    
    public var AssholeGlowing(default, never) : Transformation = new SimpleTransformation("Glowing asshole", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
    ...
    public var AssholeNormal(default, never) : Transformation = new SimpleTransformation("Normal asshole", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
