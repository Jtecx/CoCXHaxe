 ...
 */
class RearBodyTransformations extends MutationsHelper
{
    /*
    *    ██████  ███████  █████  ██████      ██████   ██████  ██████  ██    ██
    *    ██   ██ ██      ██   ██ ██   ██     ██   ██ ██    ██ ██   ██  ██  ██
    ...
    */
    ...
    /*
      */
    public var RearBodyNone(default, never) : Transformation = new SimpleTransformation("No Rear Body", 
        // apply effect
    ...
    public var RearBodyLionMane(default, never) : Transformation = new SimpleTransformation("Lion Mane Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyDisplacerTentacles(default, never) : Transformation = new SimpleTransformation("Displacer Tentacles Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyBatCollar(default, never) : Transformation = new SimpleTransformation("Bat Collar Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyRaijuMane(default, never) : Transformation = new SimpleTransformation("Raiju Mane Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyOrcaBlowhole(default, never) : Transformation = new SimpleTransformation("Orca Blowhole Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (silly())
            {
                desc += " Well it doesn't matter because now you can break the world record of the longest breath holding by sitting on the ocean floor for more than 90 minutes.";
            }
    ...
    public var RearBodySharkFin(default, never) : Transformation = new SimpleTransformation("Shark Fin Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyMetamorphicGoo(default, never) : Transformation = new SimpleTransformation("Metamorphic Goo Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyGhostlyAura(default, never) : Transformation = new SimpleTransformation("Ghostly Aura Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyTentacleEyestalks(default, never) : Transformation = new SimpleTransformation("Tentacle Eyestalks Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyKraken(default, never) : Transformation = new SimpleTransformation("Kraken Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyYetiFur(default, never) : Transformation = new SimpleTransformation("Yeti Fur Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            TransformationUtils.applyTFIfNotPresent(transformations.SkinFur(Skin.COVERAGE_LOW, {
                                color : "white"
                            }), false);
    ...
    public var RearBodyGlacialAura(default, never) : Transformation = new SimpleTransformation("Glacial Aura Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyFrostwyrm(default, never) : Transformation = new SimpleTransformation("Frostwyrm Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodySnailShell(default, never) : Transformation = new SimpleTransformation("Snail Shell Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyCentipede(default, never) : Transformation = new SimpleTransformation("Centipede Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyFenrirIceSpikes(default, never) : Transformation = new SimpleTransformation("Fenrir Ice Spikes Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyWolfCollar(default, never) : Transformation = new SimpleTransformation("Wolf Collar Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyHellhoundCollar(default, never) : Transformation = new SimpleTransformation("Hellhound Collar Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyFurCoat(default, never) : Transformation = new SimpleTransformation("Fur Coat Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyAtlachNacha(default, never) : Transformation = new SimpleTransformation("Atlach Nacha rear legs", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyCobraHood(default, never) : Transformation = new SimpleTransformation("Cobra Hood", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyAbyssalSharkFin(default, never) : Transformation = new SimpleTransformation("Abyss Shark Fin Rear Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.isNaked())
            {
                desc += " Though, perhaps armor is not the biggest concern you have with your new body.";
            }
    ...
    public var RearBodyArigeanAuraRed(default, never) : Transformation = new SimpleTransformation("Arigean Red Aura", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyArigeanAuraYellow(default, never) : Transformation = new SimpleTransformation("Arigean Yellow Aura", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var RearBodyMoth(default, never) : Transformation = new SimpleTransformation("Moth Fluffy Collar", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
