 ...
 */
class BallsTransformations extends MutationsHelper
{
    /*
    *	 ██████   █████  ██     ██     ███████
    * 	 ██   ██ ██   ██ ██     ██     ██
    ...
    */
    ...
    /*
    */
    public var BallsNone(default, never) : Transformation = new SimpleTransformation("Remove Bals", 
        // apply
    ...
    public var BallsDuo(default, never) : Transformation = new SimpleTransformation("Two balls only", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
            ...
            if (player.balls < 2)
            {
                ...
                if (rand(2) == 0)
                {
                    desc += "A nauseating pressure forms just under the base of your maleness.  With agonizing pain the flesh bulges and distends, pushing out a rounded lump of flesh that you recognize as a testicle!  A moment later relief overwhelms you as the second drops into your newly formed sack.";
                }
                else
                {
    ...
    public var BallsTrap(default, never) : Transformation = new SimpleTransformation("Trap pouch", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
