 ...
 */
class EarsTransformations extends MutationsHelper
{
    /*
    *    ███████  █████  ██████  ███████
    *    ██      ██   ██ ██   ██ ██
    ...
    */
    ...
    /*
      */
    public var EarsHuman(default, never) : Transformation = new SimpleTransformation("Human Ears", 
        // apply effect
    ...
    public var EarsLion(default, never) : Transformation = new SimpleTransformation("Lion Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.ears.type == Ears.HUMAN)
            {
                if (rand(3) == 0)
                {
                    desc += "The skin on the sides of your face stretches painfully as your ears migrate upwards, towards the top of your head. They shift and elongate a little, fur growing on them as they become feline in nature. <b>You now have lion ears.</b>";
                }
                else if (rand(3) == 1)
                {
                    desc += "Your ears begin to tingle. You reach up with one hand and gently rub them. They appear to be growing fur. Within a few moments, they've migrated up to the top of your head and increased in size. The tingling stops and you find yourself hearing noises in a whole new way. <b>You now have lion ears.</b>";
                }
                else
                {
                    desc += "Your ears suddenly stretch painfully, making you scream in pain as they move toward the top of your head, growing rounder and bigger. Putting your hands to your ears you discover they are now covered with a fair amount of dark fur. <b>You now have lion ears.</b>";
                }
            }
            else if (rand(2) == 0)
            {
                desc += "Your ears change shape, morphing into round, feline ears not unlike those of a lion!	They swivel about reflexively as you adjust to them. <b>You now have lion ears.</b>";
            }
            else
            {
                desc += "Your ears tingle and begin to change shape. Within a few moments, they've become long and feline. Thanks to the new fuzzy organs, you find yourself able to hear things that eluded your notice up until now. <b>You now have lion ears.</b>";
            }
    ...
    public var EarsDisplacer(default, never) : Transformation = new SimpleTransformation("Displacer Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsCat(default, never) : Transformation = new SimpleTransformation("Cat Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.ears.type == Ears.HUMAN)
            {
                if (rand(2) == 0)
                {
                    desc += "The skin on the sides of your face stretches painfully as your ears migrate upwards, towards the top of your head. They shift and elongate a little, fur growing on them as they become feline in nature. <b>You now have cat ears.</b>";
                }
                else
                {
                    desc += "Your ears begin to tingle. You reach up with one hand and gently rub them. They appear to be growing fur. Within a few moments, they've migrated up to the top of your head and increased in size. The tingling stops and you find yourself hearing noises in a whole new way. <b>You now have cat ears.</b>";
                }
            }
            else if (rand(2) == 0)
            {
                desc += "Your ears change shape, morphing into pointed, feline ears! They swivel about reflexively as you adjust to them. <b>You now have cat ears.</b>";
            }
            else
            {
                desc += "Your ears tingle and begin to change shape. Within a few moments, they've become long and feline. Thanks to the new fuzzy organs, you find yourself able to hear things that eluded your notice up until now. <b>You now have cat ears.</b>";
            }
    ...
    public var EarsRedPanda(default, never) : Transformation = new SimpleTransformation("RedPanda Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "The warned dizziness";
            }
            else
            {
                desc += "A sudden dizziness";
            }
    ...
    public var EarsHorse(default, never) : Transformation = new SimpleTransformation("Horse Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Two painful lumps sprout on the top of your head, forming into tear-drop shaped ears, covered with short fur. ";
            }
            if (player.ears.type == Ears.HUMAN)
            {
                desc += "Your ears tug painfully on your face as they begin shifting, moving upwards to the top of your head and transforming into a upright animalistic ears. ";
            }
            if (player.ears.type == Ears.DOG)
            {
                desc += "Your ears change shape, morphing into from their doglike shape into equine-like ears! ";
            }
            else
            {
                desc += "Your ears change shape, morphing into teardrop-shaped horse ears! ";
            }
    ...
    public var EarsKirin(default, never) : Transformation = new SimpleTransformation("Kirin Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.ears.type == -1)
            {
                desc += "Two painful lumps sprout on the top of your head, forming into tear-drop shaped ears, covered with short fur and hard scales. ";
            }
            if (player.ears.type == Ears.HUMAN)
            {
                desc += "Your ears tug painfully on your face as they begin shifting, turning into sideway animalistic ears. ";
            }
            if (player.ears.type == Ears.DOG)
            {
                desc += "Your ears change shape, morphing into from their doglike shape into scaly animalistic ears! ";
            }
            else
            {
                desc += "Your ears change shape, morphing into teardrop-shaped sideway kirin ears! ";
            }
    ...
    public var EarsPig(default, never) : Transformation = new SimpleTransformation("Pig Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsVampire(default, never) : Transformation = new SimpleTransformation("Vampire Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsBat(default, never) : Transformation = new SimpleTransformation("Bat Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsWeasel(default, never) : Transformation = new SimpleTransformation("Weasel Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.racialScore(Races.RAIJU, false) >= 5)
            {
    ...
    public var EarsOni(default, never) : Transformation = new SimpleTransformation("Oni Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsElven(default, never) : Transformation = new SimpleTransformation("Elven Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsGoat(default, never) : Transformation = new SimpleTransformation("Goat Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsCow(default, never) : Transformation = new SimpleTransformation("Cow Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsDraconic(default, never) : Transformation = new SimpleTransformation("Draconic Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsSnake(default, never) : Transformation = new SimpleTransformation("Snake Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsOrca(default, never) : Transformation = new SimpleTransformation("Orca Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsOrca2(default, never) : Transformation = new SimpleTransformation("Orca Ears 2", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsLizard(default, never) : Transformation = new SimpleTransformation("Lizard Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsInsect(default, never) : Transformation = new SimpleTransformation("Insect Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsFox(default, never) : Transformation = new SimpleTransformation("Fox Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsElfin(default, never) : Transformation = new SimpleTransformation("Elfin Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += " As you examine your new elfin ears you feel fur grow around them, matching the rest of you.";
            }
    ...
    public var EarsWolf(default, never) : Transformation = new SimpleTransformation("Wolf Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsDog(default, never) : Transformation = new SimpleTransformation("Dog Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.ears.type == -1)
            {
                desc += "Two painful nubs begin sprouting from your head, growing and opening into canine ears. ";
            }
            if (player.ears.type == Ears.HUMAN)
            {
                desc += "The skin on the sides of your face stretches painfully as your ears migrate upwards, towards the top of your head. They shift and elongate, becoming canine in nature. ";
            }
            if (player.ears.type == Ears.HORSE)
            {
                desc += "Your equine ears twist as they transform into canine versions. ";
            }
            if (player.ears.type > Ears.DOG)
            {
                desc += "Your ears transform, becoming more canine in appearance. ";
            }
    ...
    public var EarsGremlin(default, never) : Transformation = new SimpleTransformation("Gremlin Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsShark(default, never) : Transformation = new SimpleTransformation("Shark Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsCaveWyrm(default, never) : Transformation = new SimpleTransformation("Cave Wyrm Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsBunny(default, never) : Transformation = new SimpleTransformation("Bunny Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsAvian(default, never) : Transformation = new SimpleTransformation("Avian Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsGryphon(default, never) : Transformation = new SimpleTransformation("Gryphon Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsKangaroo(default, never) : Transformation = new SimpleTransformation("Kangaroo Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Your ears stiffen and shift to the sides!	You reach up and find them pointed outwards instead of up and down; they feel a bit wider now as well. As you touch them, you can feel them swiveling in place in response to nearby sounds. <b>You now have a pair of kangaroo ears!</b>";
            }
            else
            {
                desc += "Your ears twist painfully as though being yanked upwards and you clap your hands to your head. Feeling them out, you discover them growing!	They stretch upwards, reaching past your fingertips, and then the tugging stops. You cautiously feel along their lengths; they're long and stiff, but pointed outwards now, and they swivel around as you listen. <b>You now have a pair of kangaroo ears!</b>";
            }
    ...
    public var EarsRaiju(default, never) : Transformation = new SimpleTransformation("Raiju Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsSquirrel(default, never) : Transformation = new SimpleTransformation("Squirrel Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsRaccoon(default, never) : Transformation = new SimpleTransformation("Raccoon Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            
            if (player.ears.type == Ears.DOG || player.ears.type == Ears.BUNNY || player.ears.type == Ears.KANGAROO)
            {
                desc += "Your ears compress, constricting your ear canal momentarily. You shake your head to get sound back, and reach up to touch the auricles, to find a pair of stubby egg-shaped ears in their place. <b>You now have raccoon ears!</b>";
            }
            else if (player.ears.type == Ears.HORSE || player.ears.type == Ears.COW || player.ears.type == Ears.CAT)
            {
                desc += "Your ears tingle. Huh. Do they feel a bit rounder at the tip now?	<b>Looks like you have raccoon ears.</b>";
            }
            else
            {
                desc += "Your ears prick and stretch uncomfortably, poking up through your [hair]. Covering them with your hands, you feel them shaping into little eggdrop ornaments resting atop your head. <b>You have raccoon ears!</b>";
            }
    ...
    public var EarsMouse(default, never) : Transformation = new SimpleTransformation("Mouse Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            desc += "Your ears ";
            if (player.ears.type == Ears.HORSE || player.ears.type == Ears.COW || player.ears.type == Ears.DOG || player.ears.type == Ears.BUNNY || player.ears.type == Ears.KANGAROO)
            {
                desc += "shrink suddenly";
            }
            else
            {
                desc += "pull away from your head";
            }
    ...
    public var EarsFerret(default, never) : Transformation = new SimpleTransformation("Ferret Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsYeti(default, never) : Transformation = new SimpleTransformation("Yeti Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsBear(default, never) : Transformation = new SimpleTransformation("Bear Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsPanda(default, never) : Transformation = new SimpleTransformation("Panda Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsMelkie(default, never) : Transformation = new SimpleTransformation("Melkie Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsDeer(default, never) : Transformation = new SimpleTransformation("Deer Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.ears.type == -1)
            {
                desc += "Two painful lumps sprout on the top of your head, forming into teardrop shaped ears, covered with short fur.  ";
            }
            if (player.ears.type == Ears.HUMAN)
            {
                desc += "Your ears tug painfully on your face as they begin shifting, moving upwards to the top of your head and transforming into upright animalistic ears.  ";
            }
            if (player.ears.type == Ears.DOG)
            {
                desc += "Your ears change shape, morphing into from their doglike shape into deer-like ears!  ";
            }
            if (player.ears.type > Ears.DOG)
            {
                desc += "Your ears change shape, morphing into teardrop-shaped deer ears!  ";
            }
    ...
    public var EarsBig(default, never) : Transformation = new SimpleTransformation("Big Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsFennecFox(default, never) : Transformation = new SimpleTransformation("Fennec Fox Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.ears.type == Ears.HUMAN || player.ears.type == Ears.ELFIN || player.ears.type == Ears.LIZARD)
            {
                desc += "The sides of your face painfully stretch as your ears elongate and begin to push past your hairline, toward the top of your head. They elongate, becoming large and oversized vulpine triangles covered in bushy fur. <b>You now have fennec fox ears.</b>";
            }
            else
            {
                desc += "Your ears change, shifting from their current shape to become vulpine in nature. <b>You now have fennec fox ears.</b>";
            }
    ...
    public var EarsJackal(default, never) : Transformation = new SimpleTransformation("Jackal Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsTroll(default, never) : Transformation = new SimpleTransformation("Troll Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EarsGlacialTroll(default, never) : Transformation = new SimpleTransformation("Glacial Troll Ears", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
