 ...
 */
class WingsTransformations extends MutationsHelper
{
    /*
    *    ██       ██ ██ ███    ██  ██████  ███████
    *    ██       ██ ██ ████   ██ ██       ██
    ...
    */
    ...
    /*
      */
    public var WingsNone(default, never) : Transformation = new SimpleTransformation("No Wings", 
        // apply effect
    ...
    public var WingsFeatheredSphinx(default, never) : Transformation = new SimpleTransformation("Feathered Sphinx Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsManticoreLarge(default, never) : Transformation = new SimpleTransformation("Manticore Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsManticoreSmall(default, never) : Transformation = new SimpleTransformation("Manticore Small Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsNightmare(default, never) : Transformation = new SimpleTransformation("Nightmare Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsFeatheredAlicorn(default, never) : Transformation = new SimpleTransformation("Feathered Alicorn Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsThunderousAura(default, never) : Transformation = new SimpleTransformation("Thunderous Aura (Wings)", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsMantisLarge(default, never) : Transformation = new SimpleTransformation("Mantis Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsMantisSmall(default, never) : Transformation = new SimpleTransformation("Mantis Small Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsDraconicHuge(default, never) : Transformation = new SimpleTransformation("Draconic Huge Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsDraconicLarge(default, never) : Transformation = new SimpleTransformation("Draconic Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsDraconicSmall(default, never) : Transformation = new SimpleTransformation("Draconic Small Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "You double over as waves of pain suddenly fill your shoulderblades; your back feels like it's swelling, flesh and muscles ballooning. A sudden sound of tearing brings with it relief and you straighten up. Upon your back now sit small, leathery wings, not unlike a bat's. " +
                "<b>You now have small dragon wings. They're not big enough to fly with, but they look adorable.</b>";
            }
            else
            {
                desc += "A sensation of numbness suddenly fills your wings. When it dies away, they feel... different. Looking back, you realize that they have been replaced by new, small wings, ones that you can only describe as draconic. <b>Your wings have changed into dragon wings.</b>";
            }
    ...
    public var WingsFeatheredPhoenix(default, never) : Transformation = new SimpleTransformation("Feathered Phoenix Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsFeatheredLarge(default, never) : Transformation = new SimpleTransformation("Feathered Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.wings.type > Wings.NONE)
            {
                desc += "Sensation fades from your " + player.wings.desc + " wings slowly but surely, leaving them dried out husks that break off to fall on the ground. Your back closes up to conceal the loss, as smooth and unbroken as the day you entered the portal.";
            }
            desc += "Pain lances through your back, the muscles knotting oddly and pressing up to bulge your [skin.type]. It hurts, oh gods does it hurt, but you can't get a good angle to feel at the source of your agony. A loud crack splits the air, and then your body is forcing a pair of narrow limbs through a gap in your [armor]. Blood pumps through the new appendages, easing the pain as they fill out and grow. " +
            "Tentatively, you find yourself flexing muscles you didn't know you had, and <b>you're able to curve the new growths far enough around to behold your brand new, [haircolor] wings.</b>";
    ...
    public var WingsCouatl(default, never) : Transformation = new SimpleTransformation("Coualt wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsBeeLarge(default, never) : Transformation = new SimpleTransformation("Bee Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsBeeSmall(default, never) : Transformation = new SimpleTransformation("Bee Small Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsDemonicLarge(default, never) : Transformation = new SimpleTransformation("Demonic Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsDemonicTiny(default, never) : Transformation = new SimpleTransformation("Demonic Tiny Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsVampire(default, never) : Transformation = new SimpleTransformation("Vampire Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsFeatheredAvian(default, never) : Transformation = new SimpleTransformation("Feathered Avian Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsEthereal(default, never) : Transformation = new SimpleTransformation("Ethereal Wings Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsLevitation(default, never) : Transformation = new SimpleTransformation("Levitation Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsWindyAura(default, never) : Transformation = new SimpleTransformation("Windy Aura Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsGiantDragonfly(default, never) : Transformation = new SimpleTransformation("Giant Dragonfly Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsSeaDragon(default, never) : Transformation = new SimpleTransformation("Sea Dragon Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsDevilfeather(default, never) : Transformation = new SimpleTransformation("Devilfeather Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsPureDevilfeather(default, never) : Transformation = new SimpleTransformation("Purified Devilfeather Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsFeyDragon(default, never) : Transformation = new SimpleTransformation("Fey Dragon Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsFairy(default, never) : Transformation = new SimpleTransformation("Fairy Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsJabberwocky(default, never) : Transformation = new SimpleTransformation("Jabberwocky Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsPlant(default, never) : Transformation = new SimpleTransformation("Plant Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsAntLarge(default, never) : Transformation = new SimpleTransformation("Ant Large Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "You wince as you feel your wings tearing in half, but after a short moment, they start to tingle and grow longer. <b>You now have four large ant wings</b>.";
            }
            else
            {
    ...
    public var WingsAntSmall(default, never) : Transformation = new SimpleTransformation("Ant Small Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            
            if (player.wings.type == Wings.BEE_SMALL)
            {
                desc += "You wince as you feel your wings tearing in half, but after a short moment, they start to tingle as they grow into four small ant wings. You still can't fly with them, but <b>you now have small ant wings</b>.";
            }
            else
            {
    ...
    public var WingsYggdrasilQuadrupleHuge(default, never) : Transformation = new SimpleTransformation("Huge Quadruple Yggdrasil Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsYggdrasilHuge(default, never) : Transformation = new SimpleTransformation("Huge Yggdrasil Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsYggdrasilLarge(default, never) : Transformation = new SimpleTransformation("Large Yggdrasil Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsMothSmall(default, never) : Transformation = new SimpleTransformation("Small Moth Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var WingsMothLarge(default, never) : Transformation = new SimpleTransformation("Large Moth Wings", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
