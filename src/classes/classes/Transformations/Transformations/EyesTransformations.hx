 ...
 */
class EyesTransformations extends MutationsHelper
{
    /*
*		███████ ██	  ██ ███████ ███████
*		██		 ██  ██	 ██		 ██
...
*/
    ...
    /*
      */
    public var EyesHuman(default, never) : Transformation = new SimpleTransformation("Human Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            ...
            else
            {
                ...
                {
                    desc += " Your multiple, arachnid eyes are gone!</b>";
                }
    ...
    public var EyesJiangshi(default, never) : Transformation = new SimpleTransformation("Jiangshi Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesManticore(default, never) : Transformation = new SimpleTransformation("Manticore Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesInfernal(default, never) : Transformation = new SimpleTransformation("Infernal Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesDisplacer(default, never) : Transformation = new SimpleTransformation("Displacer Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesCat(default, never) : Transformation = new SimpleTransformation("Cat Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesOrc(default, never) : Transformation = new SimpleTransformation("Orc Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesVampire(default, never) : Transformation = new SimpleTransformation("Vampire Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesRaiju(default, never) : Transformation = new SimpleTransformation("Raiju Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesWeasel(default, never) : Transformation = new SimpleTransformation("Weasel Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesOni(default, never) : Transformation = new SimpleTransformation("Oni Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesElf(default, never) : Transformation = new SimpleTransformation("Elf Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFairy(default, never) : Transformation = new SimpleTransformation("Fairy Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesDevil(default, never) : Transformation = new SimpleTransformation("Devil Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesDraconic(default, never) : Transformation = new SimpleTransformation("Draconic Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesGorgon(default, never) : Transformation = new SimpleTransformation("Gorgon Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesSnake(default, never) : Transformation = new SimpleTransformation("Snake Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesSnakeFiendish(default, never) : Transformation = new SimpleTransformation("Fiendish Snake Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesSpider(default, never) : Transformation = new SimpleTransformation("Spider Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesLizard(default, never) : Transformation = new SimpleTransformation("Lizard Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFox(default, never) : Transformation = new SimpleTransformation("Fox Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesMonoeye(default, never) : Transformation = new SimpleTransformation("Monoeye Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesRatatoskr(default, never) : Transformation = new SimpleTransformation("Ratatoskr Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesKraken(default, never) : Transformation = new SimpleTransformation("Kraken Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFireSnail(default, never) : Transformation = new SimpleTransformation("Fire Snail Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFenrir(default, never) : Transformation = new SimpleTransformation("Fenrir Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesDead(default, never) : Transformation = new SimpleTransformation("Dead Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesCaveWyrm(default, never) : Transformation = new SimpleTransformation("Cave Wyrm Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesGryphon(default, never) : Transformation = new SimpleTransformation("Gryphon Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesSandTrap(default, never) : Transformation = new SimpleTransformation("Sand Trap Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesHinezumi(default, never) : Transformation = new SimpleTransformation("Hinezumi Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFrostwyrm(default, never) : Transformation = new SimpleTransformation("Frostwyrm Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesGoat(default, never) : Transformation = new SimpleTransformation("Goat Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesBear(default, never) : Transformation = new SimpleTransformation("Bear Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesCancer(default, never) : Transformation = new SimpleTransformation("Cancer Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesCentipede(default, never) : Transformation = new SimpleTransformation("Centipede Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesGhost(default, never) : Transformation = new SimpleTransformation("Ghost Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFiendish(default, never) : Transformation = new SimpleTransformation("Fiendish Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesFeral(default, never) : Transformation = new SimpleTransformation("Feral Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesArigean(default, never) : Transformation = new SimpleTransformation("Arigean Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesDemon(default, never) : Transformation = new SimpleTransformation("Demon Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesMoth(default, never) : Transformation = new SimpleTransformation("Moth Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesGremlin(default, never) : Transformation = new SimpleTransformation("Gremlin Eyes", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var EyesOniColors(default, never) : Transformation = new SimpleTransformation("Oni Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesPlantColors(default, never) : Transformation = new SimpleTransformation("Plant Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesGoblinColors(default, never) : Transformation = new SimpleTransformation("Goblin Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesGremlinColors(default, never) : Transformation = new SimpleTransformation("Gremlin Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesRaijuColors(default, never) : Transformation = new SimpleTransformation("Raiju Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesKirinColors(default, never) : Transformation = new SimpleTransformation("Kirin Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesKamaitachiColors(default, never) : Transformation = new SimpleTransformation("Kamaitachi Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesRatatoskrColors(default, never) : Transformation = new SimpleTransformation("Ratatoskr Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesRaccoonColors(default, never) : Transformation = new SimpleTransformation("Raccoon Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            transformations.EyesChangeColor(["golden"]).applyEffect(doOutput);
    ...
    public var EyesKrakenColors(default, never) : Transformation = new SimpleTransformation("Kraken Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesSeadragonColors(default, never) : Transformation = new SimpleTransformation("Seadragon Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesFireSnailColors(default, never) : Transformation = new SimpleTransformation("Fire Snail Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesSpiderAndMutagenInt(default, never) : Transformation = EyesSpider.copyWithExtraEffect(
    ...
    public var EyesAlrauneColors(default, never) : Transformation = new SimpleTransformation("Alraune Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            transformations.EyesChangeColor(["light purple", "green", "light green"]).applyEffect(doOutput);
    ...
    public var EyesAlicornColors(default, never) : Transformation = new SimpleTransformation("Alicorn Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesAtlachColors(default, never) : Transformation = new SimpleTransformation("Atlach Nacha Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesFenrirColor(default, never) : Transformation = new SimpleTransformation("Fenrir Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var EyesDemonColors(default, never) : Transformation = new SimpleTransformation("Demon Eye Colors", 
        // apply effect
        function(doOutput : Bool) : Void
        {
