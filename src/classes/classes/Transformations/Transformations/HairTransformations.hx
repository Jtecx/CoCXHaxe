 ...
 */
class HairTransformations extends MutationsHelper
{
    ...
    /*
      */
    public var HairHuman(default, never) : Transformation = new SimpleTransformation("Human Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var _sw4_ = (player.hairType);            
    ...
    public var HairFeather(default, never) : Transformation = new SimpleTransformation("Feather Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
    ...
    public var HairGorgon(default, never) : Transformation = new SimpleTransformation("Gorgon Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairSilky(default, never) : Transformation = new SimpleTransformation("Silky Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairStorm(default, never) : Transformation = new SimpleTransformation("Storm Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairBurning(default, never) : Transformation = new SimpleTransformation("Burning Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HairSnowy(default, never) : Transformation = new SimpleTransformation("Snowy Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HairLeaf(default, never) : Transformation = new SimpleTransformation("Leaf Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairGrass(default, never) : Transformation = new SimpleTransformation("Grass Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairGoo(default, never) : Transformation = new SimpleTransformation("Goo Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HairGhost(default, never) : Transformation = new SimpleTransformation("Ghost Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairRatatoskr(default, never) : Transformation = new SimpleTransformation("Ratatoskr Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairWindswept(default, never) : Transformation = new SimpleTransformation("Windswept Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairWild(default, never) : Transformation = new SimpleTransformation("Wild Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairAnemone(default, never) : Transformation = new SimpleTransformation("Anemone Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairFluffy(default, never) : Transformation = new SimpleTransformation("Fluffy Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairCrazy(default, never) : Transformation = new SimpleTransformation("Crazy Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairPrismatic(default, never) : Transformation = new SimpleTransformation("Prismatic Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairQuill(default, never) : Transformation = new SimpleTransformation("Quill Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairFairy(default, never) : Transformation = new SimpleTransformation("Fairy Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HairCow(default, never) : Transformation = new SimpleTransformation("Cow Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
    ...
    public var HairDripping(default, never) : Transformation = new SimpleTransformation("Driping Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HairPeafowlFeather(default, never) : Transformation = new SimpleTransformation("Peafowl Feather Hair", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
