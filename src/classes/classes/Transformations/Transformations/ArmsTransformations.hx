 ...
 */
class ArmsTransformations extends MutationsHelper
{
    /*
    *		 █████	██████	███		 ███ ███████
    *		██	 ██ ██	 ██ ████	████ ██
    ...
    */
    ...
    /*
      */
    public var ArmsHuman(default, never) : Transformation = new SimpleTransformation("Human Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            
            var _sw0_ = (player.arms.type);            

            switch (_sw0_)
            {
                case Arms.WOLF, Arms.FOX, Arms.LION, Arms.YETI, Arms.DEVIL, Arms.CAT, Arms.BOAR, Arms.BEAR, Arms.RACCOON, Arms.RAIJU_PAWS, Arms.CANINE:
                ...
                case Arms.ELF, Arms.DEMON, Arms.KITSUNE, Arms.ONI, Arms.ORC, Arms.RAIJU, Arms.PIG, Arms.YUKI_ONNA:
                ...
                case Arms.SALAMANDER, Arms.LIZARD, Arms.DRACONIC, Arms.HYDRA:
                ...
                case Arms.SPIDER, Arms.USHI_ONI:
                ...
                case Arms.HARPY, Arms.PHOENIX, Arms.AVIAN:
                ...
                case Arms.ANT:
                    ...
                    {
                        desc += " Because you are shocked over your lower arms going away, you don't even notice the carapace of your primary arms softening into [skin coat].";
                    }
                case Arms.MOTH:
                    desc += "You double over, a sudden pain just below your shoulders. Finding you cannot reach your lower arms to feel at each other, you look down and realize that they're shrinking back into your torso.";
                default:
    ...
    public var ArmsSphinx(default, never) : Transformation = new SimpleTransformation("Sphinx Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsLion(default, never) : Transformation = new SimpleTransformation("Lion Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsDisplacer(default, never) : Transformation = new SimpleTransformation("Displacer Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsCat(default, never) : Transformation = new SimpleTransformation("Cat Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsRedPanda(default, never) : Transformation = new SimpleTransformation("Red Panda Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsOrc(default, never) : Transformation = new SimpleTransformation("Orc Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsBoar(default, never) : Transformation = new SimpleTransformation("Boar Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsPig(default, never) : Transformation = new SimpleTransformation("Pig Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsBatWing(default, never) : Transformation = new SimpleTransformation("Bat Wing Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsRaijuPaws(default, never) : Transformation = new SimpleTransformation("Raiju Paws Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsRaiju(default, never) : Transformation = new SimpleTransformation("Raiju Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            else
            {
                ...
                if (player.cor >= 50)
                {
                    desc += "You give a lusty smile, thinking that it wouldn't be so bad...";
                }
                else
                {
                    desc += "You scowl, shaking away the impure thoughts.";
                }
            }
    ...
    public var ArmsOni(default, never) : Transformation = new SimpleTransformation("Oni Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsElf(default, never) : Transformation = new SimpleTransformation("Elf Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsMantis(default, never) : Transformation = new SimpleTransformation("Mantis Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsDevil(default, never) : Transformation = new SimpleTransformation("Devil Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsDraconic(default, never) : Transformation = new SimpleTransformation("Draconic Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsFeyDraconic(default, never) : Transformation = new SimpleTransformation("Fey Draconic Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsOrca(default, never) : Transformation = new SimpleTransformation("Orca Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsPhoenix(default, never) : Transformation = new SimpleTransformation("Phoenix Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsSalamander(default, never) : Transformation = new SimpleTransformation("Salamander Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsShark(default, never) : Transformation = new SimpleTransformation("Shark Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsSpider(default, never) : Transformation = new SimpleTransformation("Spider Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "The feathers covering your arms fall away, leaving them to return to a far more human appearance. You watch, spellbound, while your forearms gradually become shiny. The entire outer structure of your arms tingles while it divides into segments, <b>turning the [skinfurscales] into a shiny black carapace</b>. You touch the onyx exoskeleton and discover to your delight that you can still feel through it as naturally as your own skin.";
            }
            else if (player.arms.type == Arms.BEE)
            {
                desc += "The fizz covering your upper arms starting to fall down leaving only shiny black chitin clad arms.";
            }
            else if (player.arms.type == Arms.SALAMANDER || player.arms.type == Arms.LIZARD || player.arms.type == Arms.DRACONIC)
            {
                desc += "The scales covering your upper arms starting to fall down leaving only shiny black chitin clad arms.";
            }
            else if (player.arms.type == Arms.MANTIS)
            {
                desc += "The long scythe extending from your wrist crumbling, while chitin covering your mantis arms slowly starting to change colors, <b>turning the [skinfurscales] into a shiny black carapace</b>.";
            }
            else
            {
                TransformationUtils.applyTFIfNotPresent(transformations.ArmsHuman, doOutput);
    ...
    public var ArmsHarpy(default, never) : Transformation = new SimpleTransformation("Harpy Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsBee(default, never) : Transformation = new SimpleTransformation("Bee Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "On your upper arms slowly starting to grown yellow fuzz making them looks more like those of bee.";
            }
            else if (player.arms.type == Arms.MANTIS)
            {
                desc += "The long scythe extending from your wrist crumbling, while chitin covering your mantis arms slowly starting to change colors, <b>turning the " + player.skinFurScales() + " into a shiny black carapace</b>. Additionaly on your upper arms appear yellow fuzz.";
            }
            else
            {
                if (player.arms.type == Arms.HARPY)
                {
                    desc += "The feathers covering your arms fall away, leaving them to return to a far more human appearance. ";
                }
    ...
    public var ArmsLizard(default, never) : Transformation = new SimpleTransformation("Lizard Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsKitsune(default, never) : Transformation = new SimpleTransformation("Kitsune Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsFox(default, never) : Transformation = new SimpleTransformation("Fox Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsPlant(default, never) : Transformation = new SimpleTransformation("Plant Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsPlant2(default, never) : Transformation = new SimpleTransformation("Plant Arms 2", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsCentipede(default, never) : Transformation = new SimpleTransformation("Centipede Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsWendigo(default, never) : Transformation = new SimpleTransformation("Wendigo Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsYukiOnna(default, never) : Transformation = new SimpleTransformation("Yuki Onna Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsJiangshi(default, never) : Transformation = new SimpleTransformation("Jiangshi Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsWolf(default, never) : Transformation = new SimpleTransformation("Wolf Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsHound(default, never) : Transformation = new SimpleTransformation("Hound Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsGoo(default, never) : Transformation = new SimpleTransformation("Goo Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsHydra(default, never) : Transformation = new SimpleTransformation("Hydra Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsCaveWyrm(default, never) : Transformation = new SimpleTransformation("Cave Wyrm Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsAvian(default, never) : Transformation = new SimpleTransformation("Avian Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsGryphon(default, never) : Transformation = new SimpleTransformation("Gryphon Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsGhost(default, never) : Transformation = new SimpleTransformation("Ghost Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsGazer(default, never) : Transformation = new SimpleTransformation("Gazer Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsSquirrel(default, never) : Transformation = new SimpleTransformation("Squirrel Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsWeasel(default, never) : Transformation = new SimpleTransformation("Weasel Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsKamaitachi(default, never) : Transformation = new SimpleTransformation("Kamaitachi Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsRaccoon(default, never) : Transformation = new SimpleTransformation("Raccoon Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsHinezumi(default, never) : Transformation = new SimpleTransformation("Hinezumi Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsKraken(default, never) : Transformation = new SimpleTransformation("Kraken Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsYeti(default, never) : Transformation = new SimpleTransformation("Yeti Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsSeaDragon(default, never) : Transformation = new SimpleTransformation("Sea Dragon Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsFrostwyrm(default, never) : Transformation = new SimpleTransformation("Frostwyrm Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsJabberwocky(default, never) : Transformation = new SimpleTransformation("Jabberwocky Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsBear(default, never) : Transformation = new SimpleTransformation("Bear Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsUshiOni(default, never) : Transformation = new SimpleTransformation("Ushi-Oni Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsMelkie(default, never) : Transformation = new SimpleTransformation("Melkie Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsAtlach(default, never) : Transformation = new SimpleTransformation("Spider arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "The fizz covering your upper arms starting to fall down leaving only midnight purple chitin clad arms.";
            }
            else if (player.arms.type == Arms.SALAMANDER || player.arms.type == Arms.LIZARD || player.arms.type == Arms.DRACONIC)
            {
                desc += "The scales covering your upper arms starting to fall down leaving only midnight purple chitin clad arms.";
            }
            else if (player.arms.type == Arms.MANTIS)
            {
                desc += "The long scythe extending from your wrist crumbling, while chitin covering your mantis arms slowly starting to change colors, <b>turning the [skinfurscales] into a midnight purple carapace</b>.";
            }
            else
            {
                desc += "You watch, spellbound, while your forearms gradually become shiny. The entire outer structure of your arms tingles while it divides into segments, <b>turning the [skinfurscales] into a midnight purple carapace</b>. You touch the onyx exoskeleton and discover to your delight that you can still feel through it as naturally as your own skin.";
    ...
    public var ArmsAnt(default, never) : Transformation = new SimpleTransformation("Ant Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "A second pair of arms starts sprouting underneath your original pair, and the fizz covering your upper arms starting to fall down leaving only four shiny chitin clad arms.";
            }
            else if (player.arms.type == Arms.SALAMANDER || player.arms.type == Arms.LIZARD || player.arms.type == Arms.DRACONIC)
            {
                desc += "A second pair of arms starts sprouting underneath your original pair, and the scales covering your upper arms starting to fall down leaving only four shiny chitin clad arms.";
            }
            else if (player.arms.type == Arms.MANTIS)
            {
                desc += "The long scythe extending from your wrist crumbling, leaving you with shiny, chitonous but humanoid arms. A second pair then starts to sprout out below";
            }
            else if (player.arms.type == Arms.SPIDER)
            {
                desc += "There's a sudden swelling below your armpits, and you look to see a second pair of chitinous arms sprouting below your main pair.";
            }
            else
            {
                TransformationUtils.applyTFIfNotPresent(transformations.ArmsHuman, doOutput);
    ...
    public var ArmsTiny(default, never) : Transformation = new SimpleTransformation("Tiny Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsCanine(default, never) : Transformation = new SimpleTransformation("Canine Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsAbyssalShark(default, never) : Transformation = new SimpleTransformation("Abyssal Shark Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.isNaked())
            {
                desc += " Perhaps that's not as big of an issue as it could be.";
            }
    ...
    public var ArmsArigean(default, never) : Transformation = new SimpleTransformation("Arigean Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsDemon(default, never) : Transformation = new SimpleTransformation("Demon Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsDeer(default, never) : Transformation = new SimpleTransformation("Deer Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsReindeer(default, never) : Transformation = new SimpleTransformation("Reindeer Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsMoth(default, never) : Transformation = new SimpleTransformation("Moth Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsSatyr(default, never) : Transformation = new SimpleTransformation("Satyr Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsTroll(default, never) : Transformation = new SimpleTransformation("Troll Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ArmsGlacialTroll(default, never) : Transformation = new SimpleTransformation("Glacial Troll Arms", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
