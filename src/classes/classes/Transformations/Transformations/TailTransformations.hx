 ...
 */
class TailTransformations extends MutationsHelper
{
    /*
    *    ████████  █████  ██ ██
    *       ██    ██   ██ ██ ██
    ...
    */
    ...
    /*
      */
    public var TailNone(default, never) : Transformation = new SimpleTransformation("No Tail", 
        // apply effect
    ...
    public var TailScorpion(default, never) : Transformation = new SimpleTransformation("Scorpion Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailManticore(default, never) : Transformation = new SimpleTransformation("Manticore Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailBurning(default, never) : Transformation = new SimpleTransformation("Burning Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailTwinkasha(default, never) : Transformation = new SimpleTransformation("Twinkasha Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailCat(default, never) : Transformation = new SimpleTransformation("Cat Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                ...
                if (choice == 1)
                {
                    desc += "You feel your backside shift and change, flesh molding and displacing into a long, flexible tail! <b>You now have a cat tail.</b>";
                }
                if (choice == 2)
                {
                    desc += "You feel an odd tingling in your spine and your tail bone starts to throb and then swell. Within a few moments it begins to grow, adding new bones to your spine. Before you know it, you have a tail. Just before you think it's over, the tail begins to sprout soft, glossy [fur color] fur. <b>You now have a cat tail.</b>";
                }
            }
            else
            {
                desc += "You pause and tilt your head... something feels different. Ah, that's what it is; you turn around and look down at your tail as it starts to change shape, narrowing and sprouting glossy fur. <b>You now have a cat tail.</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailNekomataOneThirdForked(default, never) : Transformation = new SimpleTransformation("Forked 1/3 Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailNekomataTwoThirdsForked(default, never) : Transformation = new SimpleTransformation("Forked 2/3 Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailCat2nd(default, never) : Transformation = new SimpleTransformation("Cat2nd Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailRedPanda(default, never) : Transformation = new SimpleTransformation("RedPanda Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailHorse(default, never) : Transformation = new SimpleTransformation("Horse Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailKirin(default, never) : Transformation = new SimpleTransformation("Kirin Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "You yelp as a huge lightning bolt bursts out the area just above your ass. You watch in amazement as it twist and curls, slowly becoming thicker and thicker before it fizzles out, <b>leaving you with a short but silky kirin tail!</b>";
            }
            else
            {
                desc += "You nearly jump out of your skin as your tail burst into a huge lightning bolt. You watch as it curls and twist around before it fizzles out. <b>You now have a short but silky kirin tail!</b>";
            }
    ...
    public var TailPig(default, never) : Transformation = new SimpleTransformation("Pig Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "You feel a tug at the base of your spine as it lengthens ever so slightly. Looking over your shoulder, <b>you find that you have sprouted a small, curly pig tail.</b>";
            }
            else
            {
                desc += "You feel a pinching sensation in your [tail] as it begins to warp in change. When the sensation dissipates, <b>you are left with a small, curly pig tail.</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailRaiju(default, never) : Transformation = new SimpleTransformation("Raiju Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "You yelp as a huge lightning bolt bursts out the area just above your ass. You watch in amazement as it twist and curls, slowly becoming thicker and thicker before it fizzles out, <b>leaving you with a silky Raiju tail!</b>";
            }
            else
            {
                desc += "You nearly jump out of your skin as your tail burst into a huge lightning bolt. You watch as it curls and twist around before it fizzles out. <b>You now have a silky Raiju tail!</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailMantis(default, never) : Transformation = new SimpleTransformation("Mantis Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailGoat(default, never) : Transformation = new SimpleTransformation("Goat Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailCow(default, never) : Transformation = new SimpleTransformation("Cow Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "You feel the flesh above your [butt] knotting and growing. It twists and writhes around itself before flopping straight down, now shaped into a distinctly bovine form. You have a <b>cow tail</b>.";
            }
            else if (!InCollection(player.tailType, Tail.SPIDER_ADBOMEN, Tail.BEE_ABDOMEN, Tail.SCORPION, Tail.MANTIS_ABDOMEN, Tail.ANT_ABDOMEN))
            {
    ...
    public var TailDraconic(default, never) : Transformation = new SimpleTransformation("Draconic Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "A sudden dull, throbbing pain in your [butt] forces your hands to it; you can feel an ominous lump over your tail bone, swelling bigger and bigger with every heartbeat. All of a sudden, it seems to explode, jutting out and around until it hovers near your ankles, the skin under your flesh hard and scaly. <b>You now have a dragon tail flicking at your back, flexible as a whip.</b>";
            }
            else
            {
                desc += "An icy sensation fills your behind as your tail suddenly goes curiously numb. Twisting your head around, you watch as it melts and transforms into a reptilian appendage, long and flexible, its tip adorned with wicked spikes. <b>You now have a dragon tail.</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailFeyDraconic(default, never) : Transformation = new SimpleTransformation("Fey Draconic Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "A sudden dull, throbbing pain in your [butt] forces your hands to it; you can feel an ominous lump over your tail bone, swelling bigger and bigger with every heartbeat. All of a sudden, it seems to explode, jutting out and around until it hovers near your ankles, the skin under your flesh hard and scaly. <b>You now have a fey dragon tail flicking at your back, flexible as a whip.</b>";
            }
            else
            {
                desc += "An icy sensation fills your behind as your tail suddenly goes curiously numb. Twisting your head around, you watch as it melts and transforms into a reptilian appendage, long and flexible. <b>You now have a fey dragon tail.</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailOrca(default, never) : Transformation = new SimpleTransformation("Orca Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailSalamander(default, never) : Transformation = new SimpleTransformation("Salamander Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailHydra(default, never) : Transformation = new SimpleTransformation("Hydra Tails", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailShark(default, never) : Transformation = new SimpleTransformation("Shark Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailAbyssalShark(default, never) : Transformation = new SimpleTransformation("Abyssal Shark Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailSpider(default, never) : Transformation = new SimpleTransformation("Spider Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailHarpy(default, never) : Transformation = new SimpleTransformation("Harpy Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType != Tail.NONE)
            {
                desc += "Your tail shortens, folding into the crack of your [butt] before it disappears. A moment later, a fan of feathers erupts in its place, fluffing up and down instinctively every time the breeze shifts. <b>You have a feathery harpy tail!</b>";
            }
            else
            {
                desc += "A tingling tickles the base of your spine, making you squirm in place. A moment later, it fades, but a fan of feathers erupts from your [skin.type] in its place. The new tail fluffs up and down instinctively with every shift of the breeze. <b>You have a feathery harpy tail!</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailBee(default, never) : Transformation = new SimpleTransformation("Bee Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailLizard(default, never) : Transformation = new SimpleTransformation("Lizard Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "You drop onto the ground as your spine twists and grows, forcing the flesh above your [ass] to bulge out. New bones form, one after another, building a tapered, prehensile tail onto the back of your body. <b>You now have a reptilian tail!</b>";
            }
            else
            {
                desc += "You drop to the ground as your tail twists and grows, changing its shape in order to gradually taper to a point. It flicks back and forth, prehensile and totally under your control. <b>You now have a reptilian tail.</b>";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailDemonic(default, never) : Transformation = new SimpleTransformation("Demonic Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "";
                if (player.tailType == Tail.SPIDER_ADBOMEN || player.tailType == Tail.BEE_ABDOMEN || player.tailType == Tail.SCORPION || player.tailType == Tail.ANT_ABDOMEN || player.tailType == Tail.MANTIS_ABDOMEN)
                {
                    desc += "You feel a tingling in your insectile abdomen as it stretches, narrowing, the exoskeleton flaking off as it transforms into a flexible demon-tail, complete with a round spaded tip. ";
                }
                else
                {
                    desc += "You feel a tingling in your tail. You are amazed to discover it has shifted into a flexible demon-tail, complete with a round spaded tip. ";
                }
                desc += "<b>Your tail is now demonic in appearance.</b>";
            }
            else
            {
                desc += "A pain builds in your backside... growing more and more pronounced. The pressure suddenly disappears with a loud ripping and tearing noise. <b>You realize you now have a demon tail</b>... complete with a cute little spade.";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailAzazel(default, never) : Transformation = new SimpleTransformation("Demonic Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType != Tail.NONE)
            {
                ...
                if (player.tailType == Tail.SPIDER_ADBOMEN || player.tailType == Tail.BEE_ABDOMEN || player.tailType == Tail.SCORPION || player.tailType == Tail.ANT_ABDOMEN || player.tailType == Tail.MANTIS_ABDOMEN)
                {
                    desc += "You feel a tingling in your insectile abdomen as it stretches, narrowing, the exoskeleton flaking off as it transforms into a  ";
                }
                else
                {
                    desc += "You feel a tingling in your tail. You are amazed to discover it has shifted into a ";
                }
            ...
            {
                desc += "A pain builds in your backside... growing more and more pronounced. The pressure suddenly disappears with a loud ripping and tearing noise. <b>You realize you now have an azazel tail</b>... it looks thin, scaly, prehensile reptilian tail almost as long as you are tall and covered in [fur color] fur, swings behind you like a living bullwhip. The end of its tip is tapered and thin like the end of a whip.";
            }
            player.tailVenom = 0;
            player.tailRecharge = 0;
    ...
    public var TailWolf(default, never) : Transformation = new SimpleTransformation("Wolf Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "You feel a tightness in your rump, matched by the tightness with which the strands of your tail clump together.  In seconds they fuse into a single tail, rapidly sprouting thick fur. ";
            }
            else if (player.tailType == Tail.DEMONIC)
            {
                desc += "The tip of your tail feels strange.  As you pull it around to check on it, the spaded tip disappears, quickly replaced by a thick coat of fur over the entire surface of your tail. ";
            }
            else
            {
                desc += "You feel your backside shift and change, flesh molding and displacing into a long puffy tail! ";
            }
    ...
    public var TailDog(default, never) : Transformation = new SimpleTransformation("Dog Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailCaveWyrm(default, never) : Transformation = new SimpleTransformation("Cave Wyrm Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailRabbit(default, never) : Transformation = new SimpleTransformation("Rabbit Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailAvian(default, never) : Transformation = new SimpleTransformation("Avian Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailGriffin(default, never) : Transformation = new SimpleTransformation("Griffin Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailKangaroo(default, never) : Transformation = new SimpleTransformation("Kangaroo Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            else if (player.tailType == Tail.SPIDER_ADBOMEN || player.tailType == Tail.BEE_ABDOMEN || player.tailType == Tail.SCORPION || player.tailType == Tail.MANTIS_ABDOMEN || player.tailType == Tail.ANT_ABDOMEN)
            {
                ...
                {
                    desc += "hollow stinger drops out of the end, taking the venom organ with it.";
                }
                else
                {
                    desc += "spinnerets drop out of the end, taking the last of your webbing with it. By the time you're back to yourself, the insectile carapace has fallen off completely, leaving you with a long, thick, fleshy tail in place of your proud, insectile abdomen.  <b>You now have a kangaroo tail!</b>";
                }
            }
            else
            {
    ...
    public var TailThunderbird(default, never) : Transformation = new SimpleTransformation("Thunderbird Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType == Tail.NONE)
            {
                desc += "You yelp as a huge lightning bolt bursts out the area just above your ass. You watch in amazement as it twist and curls, slowly becoming still before it fully fizzles out, <b>leaving you with a long sinuous bolt shaped thunderbird tail!</b>";
            }
            else
            {
                desc += "You nearly jump out of your skin as your tail burst into a huge lightning bolt. You watch as it curls and twist around before it fizzles out. <b>You now have a long sinuous bolt shaped thunderbird tail!</b>";
            }
    ...
    public var TailSquirrel(default, never) : Transformation = new SimpleTransformation("Squirrel Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Something weird happens with your tail as it begins to change into something else. Within seconds the shape and coverage becomes closer to what you would expect of a squirrel tail. <b>You now have a squirrel tail!</b>";
            }
    ...
    public var TailWeasel(default, never) : Transformation = new SimpleTransformation("Weasel Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Something weird happens with your tail as it begins to change into something else. Within seconds the shape and coverage becomes closer to what you would expect of a weasel tail. <b>You now have a silky weasel tail!</b>";
            }
    ...
    public var TailRaccoon(default, never) : Transformation = new SimpleTransformation("Raccoon Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailMouse(default, never) : Transformation = new SimpleTransformation("Mouse Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailHinezumi(default, never) : Transformation = new SimpleTransformation("Hinezumi Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailFerret(default, never) : Transformation = new SimpleTransformation("Ferret Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            else if (player.tailType == Tail.HORSE && player.isTaur())
            {
                desc += "You shiver as the wind gets to your tail, all of its shiny bristles having fallen out.  Your tail then begins to lengthen, warming back up as it sprouts a new, shaggier coat of fur.  This new, mismatched tail looks a bit odd on your horse lower body.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.HARPY)
            {
                desc += "You feel a soft tingle as your tail feathers fall out one by one.  The little stump that once held the feathers down begins to twist and lengthen before sprouting soft, fluffy fur.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.RABBIT)
            {
                desc += "You feel a pressure at the base of your tiny, poofy bunny tail as it begins to lengthen, gaining at least another foot in length.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.DRACONIC || player.tailType == Tail.LIZARD)
            {
                desc += "You reach a hand behind yourself to rub at your backside as your tail begins to twist and warp, becoming much thinner than before.  It then sprouts a thick coat of fur.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.COW)
            {
                desc += "Your tail begins to itch slightly as the poof at the end of your tail begins to spread across its entire surface, making all of its fur much more dense than it was before. It also loses a tiny bit of its former length. <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.CAT)
            {
                desc += "Your tail begins to itch as its fur becomes much denser than it was before.  It also loses a tiny bit of its former length.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.DOG)
            {
                desc += "Something about your tail feels... different.  You reach behind yourself, feeling it.  It feels a bit floppier than it was before, and the fur seems to have become a little more dense.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.KANGAROO)
            {
                desc += "Your tail becomes uncomfortably tight as the entirety of its length begins to lose a lot of its former thickness.  The general shape remains tapered, but its fur has become much more dense and shaggy.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.FOX)
            {
                desc += "Your tail begins to itch as its fur loses a lot of its former density.  It also appears to have lost a bit of length.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.RACCOON)
            {
                desc += "Your tail begins to itch as its fur loses a lot of its former density, losing its trademark ring pattern as well.  It also appears to have lost a bit of length.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.HORSE)
            {
                desc += "You shiver as the wind gets to your tail, all of its shiny bristles having fallen out.  Your tail then begins to lengthen, warming back up as it sprouts a new, shaggier coat of fur.  <b>You now have a ferret tail!</b>";
            }
            else if (player.tailType == Tail.MOUSE)
            {
                desc += "Your tail begins to itch as its bald surface begins to sprout a thick layer of fur.  It also appears to have lost a bit of its former length.  <b>You now have a ferret tail!</b>";
            }
            else
            {
                desc += "Your tail begins to itch a moment before it starts writhing, your back muscles spasming as it changes shape. Before you know it, <b>your tail has reformed into a narrow, ferret's tail.</b>";
            }
    ...
    public var TailBear(default, never) : Transformation = new SimpleTransformation("Bear Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType != Tail.NONE)
            {
                desc += "You feel something shifting in your backside. Then something detaches from your backside and it falls onto the ground. ";
            }
            desc += "You groan in surprise as you feel your spine lengthening and twisting, sprouting fur as it finishes growing. ";
            if (!player.isNaked())
            {
                desc += "Luckily the new growth does not seem to have ruined your [armor]. ";
            }
    ...
    public var TailUshiOni(default, never) : Transformation = new SimpleTransformation("Ushi-Oni Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailWendigo(default, never) : Transformation = new SimpleTransformation("Wendigo Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public function TailFox(tailCount : Int = 1, magnitude : Int = 9, canRemove : Bool = true) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            {
                var newTails : Int = Math.min(tailCount - player.tailCount, magnitude);
                tailCount = as3hx.Compat.parseInt(player.tailCount + newTails);
            ...
            {
                var removedTails : Int = Math.min(player.tailCount - tailCount, magnitude);
                tailCount = as3hx.Compat.parseInt(player.tailCount - removedTails);
    ...
    public function TailKitshoo(tailCount : Int = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.tailCount < tailCount)
            {
                var newTails : Int = as3hx.Compat.parseInt(tailCount - player.tailCount);
            ...
            {
                var removedTails : Int = as3hx.Compat.parseInt(tailCount - player.tailCount);
    ...
    public var TailSpinneretAtlach(default, never) : Transformation = new SimpleTransformation("Spinneret Atlach Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailAnt(default, never) : Transformation = new SimpleTransformation("Ant Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailDeer(default, never) : Transformation = new SimpleTransformation("Deer Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailYgddrasil(default, never) : Transformation = new SimpleTransformation("Ygddrasil Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.tailType > Tail.NONE)
            {
                desc += "it begins to twist and writhe as the odd sensation intensifies.  Before your eyes, it twists into a reptilian appendage";
            }
            else
            {
                desc += "your tailbone erupts and elongates into a new limb, your new tail";
            }
    ...
    public var TailArigeanGreen(default, never) : Transformation = new SimpleTransformation("Arigean Tail (Green)", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailArigeanRed(default, never) : Transformation = new SimpleTransformation("Arigean Tail (Red)", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailArigeanYellow(default, never) : Transformation = new SimpleTransformation("Arigean Tail (Yellow)", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailMoth(default, never) : Transformation = new SimpleTransformation("Moth Abdomen", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailTroll(default, never) : Transformation = new SimpleTransformation("Troll Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var TailGlacialTroll(default, never) : Transformation = new SimpleTransformation("Glacial Troll Tail", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
