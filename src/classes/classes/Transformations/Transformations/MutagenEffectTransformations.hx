...
class MutagenEffectTransformations extends MutationsHelper
{
    /***
     *    ███████ ███████ ███████ ███████  ██████ ████████ ███████
     *    ██      ██      ██      ██      ██         ██    ██
    ...
    */
    ...
    /*
    */
    public var MutagenSpeSpider(default, never) : PossibleEffect = new MutagenEffect("Mutagen Bonus SPE (spider)", 
        "spe", 
        1.5, 
    ...
    public var MutagenCurseSpeSpider(default, never) : PossibleEffect = new MutagenCurse("Mutagen Curse SPE (spider)", 
        "spe", 
        2, 
    ...
    public var MutagenTouSpider(default, never) : PossibleEffect = new MutagenEffect("Mutagen Bonus TOU (spider)", 
        "tou", 
        1, 
    ...
    public var MutagenCurseStrSpider(default, never) : PossibleEffect = new StatChangeEffect("Mutagen Curse STR (spider)", 
        function(doOutput : Bool) : Void
        {
            ...
            {
                desc += "Wait, you're not a spider, that doesn't make any sense!";
            }
    ...
    public var MutagenLibSpider(default, never) : PossibleEffect = new MutagenEffect("Mutagen Bonus LIB (spider)", 
        "lib", 
        1, 
    ...
    public var SensUpSpider(default, never) : PossibleEffect = new DynstatEffect("Spider sens up", 
        "sen", 
        +1, 
    ...
    public var VenomRechargeSpider(default, never) : PossibleEffect = new SimpleEffect("Recharge spider venom", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var MutagenSpdCat(default, never) : PossibleEffect = new StatChangeEffect("Mutagen Spd Cat", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var MutagenStrCat(default, never) : PossibleEffect = new StatChangeEffect("Mutagen Str Cat", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (rand(2) == 0)
            {
                desc += "Your muscles feel taut, like a coiled spring, and a bit more on edge.";
            }
            else
            {
                desc += "You arch your back as your muscles clench painfully. The cramp passes swiftly, leaving you feeling like you've gotten a bit stronger.";
            }
    ...
    public var MutagenIntCat(default, never) : PossibleEffect = new MutagenEffect("Mutagen Bonus INT (cat)", 
        "int", 
        2, 
        "You suddenly feel more cunning and by far way smarter.");
    
    public var MutagenCurseTouCat(default, never) : PossibleEffect = new MutagenCurse("Mutagen Curse TOU (cat)", 
        "tou", 
        2, 
    ...
    public var MutagenLibSensCat(default, never) : PossibleEffect = new StatChangeEffect("Mutagen Bonus LIB & SENS (cat)", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.catCocks() > 0)
            {
                ...
                if (player.cor < 33)
                {
                    desc += "You need to control yourself better.";
                }
                else if (player.cor < 66)
                {
                    desc += "You're not sure how you feel about the fantasy.";
                }
                else
                {
                    desc += "You hope to find a willing partner to make this a reality.";
                }
            }
            //Else –
            else
    ...
    public var MutagenSpeKanga(default, never) : PossibleEffect = new MutagenEffect("Mutagen Bonus SPE (kanga)", 
        "spe", 
        1, 
    ...
    public var MutagenCurseIntKanga(default, never) : PossibleEffect = new StatChangeEffect("Mutagen Curse Inte (Kanga)", 
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "You feel... antsy. You momentarily forget your other concerns as you look around you, trying to decide which direction you'd be most likely to find more food in.  You're about to set out on the search when your mind refocuses and you realize you already have some stored at camp.";
            }
            if (player.inte100 > 10)
            {
                desc += "Your mind wanders as you eat; you think of what it would be like to run forever, bounding across the wastes of Mareth in the simple joy of movement.  You bring the kanga fruit to your mouth one last time, only to realize there's nothing edible left on it.  The thought brings you back to yourself with a start.";
            }
            else
            {
    ...
    public var VaginaTightenAndMutagenLib(default, never) : PossibleEffect = new SimpleEffect("Tighten vagina + Mutagen Bonus LIB", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var AssholeTightenAndMutagenLib(default, never) : PossibleEffect = new SimpleEffect("Tighten asshole + Mutagen Bonus LIB", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var CocksThickenAll(default, never) : PossibleEffect = new SimpleEffect("Thicken all cocks", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            var thickened : Bool = false;
    ...
    public var ShrinkClit(default, never) : PossibleEffect = new SimpleEffect("Shrink Clit to half size", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var ShrinkBalls(default, never) : Transformation = new SimpleTransformation("Shrink balls", 
        // apply
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
