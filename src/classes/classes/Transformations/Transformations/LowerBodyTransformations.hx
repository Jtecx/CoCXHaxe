 ...
 */
class LowerBodyTransformations extends MutationsHelper
{
    /*
    *      ████████  █████  ██    ██  ██████     ██       ██████  ██       ██ ███████ ██████      ██████   ██████  ██████  ██    ██
    *         ██    ██   ██ ██    ██  ██   ██    ██      ██    ██ ██       ██ ██      ██   ██     ██   ██ ██    ██ ██   ██  ██  ██
    ...
    */
    ...
    public function LowerBodyTaur(lowerBodyType : Int = null) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (lowerBodyType == 0)
            {
                lowerBodyType = player.lowerBody;
            }
            else
            {
                player.lowerBody = lowerBodyType;
            }
            ...
            if (player.hasStatusEffect(StatusEffects.HydraTailsPlayer))
            {
    ...
    public function LowerBodyHoofed(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            if (legCount == 0)
            {
                legCount = player.legCount;
            }
            var desc : String = "";
            if (Metamorph.checkTaurUnlock() && player.lowerBody == LowerBody.HOOFED)
            {
                if (toggleTaur && legCount == 2)
                {
                    legCount = 4;
                }
                else if (toggleTaur && legCount >= 4)
                {
                    legCount = 2;
                }
                else if (legCount == 1)
    ...
    public function LowerBodyKirin(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyCat(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyLizard(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyFox(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyDraconic(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyFeyDraconic(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
        return new SimpleTransformation("Draconic Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
    ...
    public function LowerBodyClovenHoofed(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodySalamander(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyMantis(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyShark(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyLion(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyOrca(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyRaiju(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyDog(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyWolf(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyWeasel(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyBear(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodySeaDragon(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyGryphon(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    public function LowerBodyReindeer(legCount : Int = null, toggleTaur : Bool = false) : Transformation
    {
    ...
    */
    ...
    /*
      */
    public var LowerBodyBipedal(default, never) : Transformation = new SimpleTransformation("Bipedal Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.isTaur())
            {
                desc += "Your quadrupedal hind-quarters seize, overbalancing your surprised front-end and causing you to stagger and fall to your side. Pain lances throughout, contorting your body into a tightly clenched ball of pain while tendons melt and bones break, melt, and regrow. When it finally stops, <b>you look down to see that you only have two legs</b>! You don't waste time before getting up to test them, confirming that they're working completely fine.";
            }
            else if (player.lowerBody == LowerBody.MELKIE)
            {
                desc += "You scream in agony as a horrible pain racks the entire length of your seal-like tail. Unable to take it anymore, you pass out. When you wake up, you’re shocked to find that you no longer have the lower body of a seal. Instead, you only have two human legs. <b>You now have a pair of human legs!</b>";
            }
            else if (player.lowerBody == LowerBody.NAGA)
            {
                desc += "You scream in agony as a horrible pain racks the entire length of your snake-like coils. Unable to take it anymore, you pass out. When you wake up, you’re shocked to find that you no longer have the lower body of a snake. Instead, you only have two human legs. <b>You now have a pair of human legs!</b>";
            }
            else
            {
                transformations.LowerBodyHuman.applyEffect(doOutput);
            }
            ...
            player.legCount = 2;
            if (player.lowerBody == LowerBody.MELKIE || player.lowerBody == LowerBody.NAGA)
            {
    ...
    public var LowerBodyHuman(default, never) : Transformation = new SimpleTransformation("Human Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Your lower body rushes inward, molding into two leg-like shapes that gradually stiffen up. In moments they solidify into normal-looking legs, complete with regular, human feet. <b>You now have normal legs!</b>";
            }
            else if (player.isNaga())
            {
                desc += "You collapse as your sinuous snake-tail tears in half, shifting into legs. The pain is immense, particularly where your new feet are forming. <b>You have human legs again.</b>";
            }
            else if (player.isScylla())
            {
                desc += "You collapse as your tentacle legs starts to merge. The pain is immense, particularly where your new feet are forming. <b>You have human legs again.</b>";
            }
            else if (player.isAlraune())
            {
            ...
            {
                desc += "You collapse as your legs shift and twist. By the time the pain subsides, you notice that you have normal legs and normal feet. <b>You now have normal legs!</b>";
            }
            else
            {
                desc += "Your lower body seizes, causing you to stagger and fall to your side. Pain lances throughout, contorting your body into a tightly clenched ball of pain while tendons melt and bones break, melt, and regrow. When it finally stops, <b>you look down to behold your new pair of human legs</b>!\n";
            }
    ...
    public var LowerBodySnake(default, never) : Transformation = new SimpleTransformation("Snake Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyDemonHighHeels(default, never) : Transformation = new SimpleTransformation("Demon High Heels Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyDemonClawed(default, never) : Transformation = new SimpleTransformation("Demon Clawed Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyBee(default, never) : Transformation = new SimpleTransformation("Bee Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyHarpy(default, never) : Transformation = new SimpleTransformation("Harpy Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodySpider(default, never) : Transformation = new SimpleTransformation("Spider Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.lowerBody == LowerBody.ANT)
            {
                ...
                if (!player.chitinColor2 == "black")
                {
                    desc += "You also realize that the color changes to black. ";
                }
    ...
    public var LowerBodyDrider(default, never) : Transformation = new SimpleTransformation("Drider Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyOni(default, never) : Transformation = new SimpleTransformation("Oni Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyElf(default, never) : Transformation = new SimpleTransformation("Elf Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyRedPanda(default, never) : Transformation = new SimpleTransformation("Red Panda Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyOrc(default, never) : Transformation = new SimpleTransformation("Orc Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyCentipede(default, never) : Transformation = new SimpleTransformation("Centipede Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        //TODO Metamorph
        {
    ...
    public var LowerBodyWendigo(default, never) : Transformation = new SimpleTransformation("Wendigo Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyYukiOnna(default, never) : Transformation = new SimpleTransformation("Yuki Onna Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyPlantRootClaws(default, never) : Transformation = new SimpleTransformation("Plant Root Claws Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyPlantHighHeels(default, never) : Transformation = new SimpleTransformation("Plant High Heels Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyPlantFlower(default, never) : Transformation = new SimpleTransformation("PlantFlower Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyGoo(default, never) : Transformation = new SimpleTransformation("Goo Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyFerret(default, never) : Transformation = new SimpleTransformation("Ferret Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyScylla(default, never) : Transformation = new SimpleTransformation("Scylla Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += " Looking for your privates you notice your pussy is right under your 8 legs just like the center of a fleshy flower and became huge like a mouth ready to engulf anything.";
            }
            else if (player.gender == Gender.GENDER_HERM)
            {
                desc += " Looking for your privates you notice your pussy is right under your 8 legs just like the center of a fleshy flower and became huge like a mouth ready to engulf anything and your cock is right between your 2 front 'legs' looking almost like another tentacle.";
            }
            else if (player.gender == Gender.GENDER_MALE)
            {
                desc += " Looking for your privates you notice your cock is right between your 2 front 'legs' looking almost like another tentacle.";
            }
    ...
    public var LowerBodyKraken(default, never) : Transformation = new SimpleTransformation("Kraken Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyHydra(default, never) : Transformation = new SimpleTransformation("Hydra Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                player.createPerk(PerkLib.HydraRegeneration, 0, 0, 0, 0);
            }
    ...
    public var LowerBodyAvian(default, never) : Transformation = new SimpleTransformation("Avian Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        //TODO Metamorph
        {
    ...
    public var LowerBodyMelkie(default, never) : Transformation = new SimpleTransformation("Melkie Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyUshiOni(default, never) : Transformation = new SimpleTransformation("Ushi-Oni Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyMouse(default, never) : Transformation = new SimpleTransformation("Mouse Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyHinezumi(default, never) : Transformation = new SimpleTransformation("Hinezumi Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyYeti(default, never) : Transformation = new SimpleTransformation("Yeti Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyGhost(default, never) : Transformation = new SimpleTransformation("Ghost Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyJiangshi(default, never) : Transformation = new SimpleTransformation("Jiangshi Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyGhost2(default, never) : Transformation = new SimpleTransformation("Ghost 2 Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyGazer(default, never) : Transformation = new SimpleTransformation("Gazer Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyFireSnail(default, never) : Transformation = new SimpleTransformation("Fire Snail Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyFrostwyrm(default, never) : Transformation = new SimpleTransformation("Frostwyrm Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            
            var wyrmCoatColor : Array<Dynamic> = ["bluish black", "dark gray", "black", "midnight black", "midnight"];
    ...
    public var LowerBodyRaccoon(default, never) : Transformation = new SimpleTransformation("Raccoon Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            else if (player.lowerBody == LowerBody.HOOFED || player.lowerBody == LowerBody.BEE || player.lowerBody == LowerBody.PONY || player.lowerBody == LowerBody.CHITINOUS_SPIDER_LEGS || player.isTaur())
            {
                ...
                if (player.lowerBody == LowerBody.HOOFED || player.lowerBody == LowerBody.PONY)
                {
                    desc += "pops right out of its hoof just in time";
                }
                else
                {
                    desc += "comes loose inside its long boot, and you pull it free with irritation only";
                }
            ...
            else
            {
                ...
                if ((player.lowerBody == LowerBody.HUMAN || player.lowerBody == LowerBody.DEMONIC_HIGH_HEELS || player.lowerBody == LowerBody.DEMONIC_CLAWS || player.lowerBody == LowerBody.DEMONIC_CLAWS || player.lowerBody == LowerBody.PLANT_HIGH_HEELS) && !player.isFurCovered())
                {
                    desc += "The sensation of walking around on what feels like a second pair of hands is so weird that you miss noticing the itchy fur growing in over your legs... <b>You now have raccoon paws!</b>";
                }
            }
    ...
    public var LowerBodySquirrel(default, never) : Transformation = new SimpleTransformation("Squirrel Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyKangaroo(default, never) : Transformation = new SimpleTransformation("Kangaroo Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyCaveWyrm(default, never) : Transformation = new SimpleTransformation("Cave Wyrm Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Your lower body is wracked by pain!  Once it passes, you discover that you're standing on digitigrade legs with cave wyrm-like claws.";
            }
            //feet types -
            else if (player.lowerBody == LowerBody.HUMAN || player.lowerBody == LowerBody.DOG || player.lowerBody == LowerBody.DEMONIC_HIGH_HEELS || player.lowerBody == LowerBody.DEMONIC_CLAWS || player.lowerBody == LowerBody.DEMONIC_CLAWS || player.lowerBody == LowerBody.PLANT_HIGH_HEELS || player.lowerBody == LowerBody.BEE || player.lowerBody == LowerBody.CAT || player.lowerBody == LowerBody.LIZARD)
            {
    ...
    public var LowerBodyBunny(default, never) : Transformation = new SimpleTransformation("Bunny Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.isTaur())
            {
                desc += "Your quadrupedal hind-quarters seizes, overbalancing your surprised front-end and causing you to stagger and fall to your side.  Pain lances throughout, contorting your body into a tightly clenched ball of pain while tendons melt and bones break, melt, and regrow.  When it finally stops, <b>you look down to behold your new pair of fur-covered rabbit feet</b>!";
            }
            //Non-taurs
            else
            {
                ...
                {
                    desc += ", nearly smashing your tail flat";
                }
                else
                {
                    desc += " hard enough to sting";
                }
    ...
    public var LowerBodyJabberwocky(default, never) : Transformation = new SimpleTransformation("Jabberwocky Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyCrab(default, never) : Transformation = new SimpleTransformation("Crab Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyCancer(default, never) : Transformation = new SimpleTransformation("Cancer Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyAtlach(default, never) : Transformation = new SimpleTransformation("Chitinous spider legs", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyAtlachNacha(default, never) : Transformation = new SimpleTransformation("Atlach Nacha lower body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
    ...
    public var LowerBodyAnt(default, never) : Transformation = new SimpleTransformation("Ant Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyTiny(default, never) : Transformation = new SimpleTransformation("Tiny Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyWorm(default, never) : Transformation = new SimpleTransformation("Worm Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyYgddrasilRootClaws(default, never) : Transformation = new SimpleTransformation("Ygddrasil Root Claws Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyAbyssalShark(default, never) : Transformation = new SimpleTransformation("Abyssal Shark Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.isNaked())
            {
                desc += " Though, perhaps that's the least of your concerns.";
            }
    ...
    public var LowerBodyWereshark(default, never) : Transformation = new SimpleTransformation("Wereshark Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyArigean(default, never) : Transformation = new SimpleTransformation("Arigean lower body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
    ...
    public var LowerBodyDemonGracefulFeet(default, never) : Transformation = new SimpleTransformation("Demon Graceful Feet Lower Body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var LowerBodyMoth(default, never) : Transformation = new SimpleTransformation("Moth lower body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
    ...
    public var LowerBodyTroll(default, never) : Transformation = new SimpleTransformation("Troll lower body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
    ...
    public var LowerBodyGlacialTroll(default, never) : Transformation = new SimpleTransformation("Glacial Troll lower body", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            if (doOutput)
