 ...
 */
class HornsTransformations extends MutationsHelper
{
    ...
    */
    ...
    /*
      */
    public var HornsNone(default, never) : Transformation = new SimpleTransformation("No Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            ...
            {
                desc += "Your orchid flowers crumble, falling apart";
            }
            else
            {
                desc += "Your horns crumble, falling apart in large chunks";
            }
    ...
    public var HornsBicorn(default, never) : Transformation = new SimpleTransformation("Bicorn Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "With painful pressure, the skin on your forehead splits around two tiny nub-like horn, a little bit similar to that you would see on the cattle back in your homeland. ";
            }
            else if (player.horns.type == Horns.UNICORN)
            {
                desc += "A sudden wave of pleasure strike you, making you moan as your horn begins to split in two.";
            }
            else if (player.horns.type == Horns.BICORN)
            {
                desc += "A splitting pain on your forehead heralds your bicorn horns gaining a few inches.";
            }
            else
            {
                desc += "Your horns vibrate and shift as if made of clay, reforming into a bicorn-like shape.";
            }
    ...
    public var HornsUnicorn(default, never) : Transformation = new SimpleTransformation("Unicorn Horn", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.horns.type == Horns.NONE)
            {
                desc += "With painful pressure, the skin on your forehead splits around a tiny nub-like horn, a little bit similar to that you would see on the cattle back in your homeland.";
            }
            else if (player.horns.type == Horns.BICORN)
            {
                desc += "One of your horns crumble to dust, leaving you with a single pure unicorn horn.";
            }
            else if (player.horns.type == Horns.UNICORN)
            {
                desc += "A splitting pain on your forehead heralds your unicorn horn gaining a few inches.";
            }
            else
            {
                desc += "Your horns vibrate and shift as if made of clay, reforming into horn with a unicorn-like shape.";
            }
            if (player.horns.type != Horns.BICORN && player.horns.type != Horns.UNICORN && player.horns.type != Horns.KIRIN)
            {
    ...
    public var HornsKirin(default, never) : Transformation = new SimpleTransformation("Kirin Horn", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            else if (player.horns.type == Horns.KIRIN)
            {
                desc += "A splitting pain on your forehead heralds your horn gaining a few inches.";
            }
            else
            {
                desc += "Your horns vibrate and shift as if made of clay, reforming into horn with a kirin-like shape.";
            }
            if (player.horns.type != Horns.BICORN && player.horns.type != Horns.UNICORN && player.horns.type != Horns.KIRIN)
            {
                player.horns.count = 1;
    ...
    public var HornsOniDual(default, never) : Transformation = new SimpleTransformation("Oni Dual Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.horns.type == Horns.NONE)
            {
                desc += "You moan in pleasure as a pair of bony horns push forward out of your forehead,";
            }
            else
            {
                desc += "You begin to feel an odd itching sensation as you feel your horns repositioning,";
            }
            desc += " the things are actually surprisingly sensitive and you reach orgasm just from them reaching full size,";
            if (player.gender == 1 || player.gender == 3)
            {
                desc += " your [cock] splattering cum on the ground";
            }
            if (player.gender == 3)
            {
                desc += " and";
            ...
            {
                desc += " your pussy gushing with a copious amount of juice";
            }
    ...
    public var HornsOni(default, never) : Transformation = new SimpleTransformation("Oni Horn", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.horns.type == Horns.NONE)
            {
                desc += "You moan in pleasure as a single bony horns push forward out of your forehead,";
            }
            else
            {
                desc += "You begin to feel an odd itching sensation as you feel your horns repositioning and merging into one,";
            }
    ...
    public var HornsGoat(default, never) : Transformation = new SimpleTransformation("Goat Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "You begin to feel an odd itching sensation as you feel your horns repositioning. Once it's over, you reach up and find a pair of hard stubs. <b>You now have a pair of goat horns.</b>";
            }
    ...
    public var HornsGoatQuadruple(default, never) : Transformation = new SimpleTransformation("Goat Quadruple Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsDraconicQuadruple(default, never) : Transformation = new SimpleTransformation("Draconic Quadruple Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsDraconicDual(default, never) : Transformation = new SimpleTransformation("Draconic Dual Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsCowMinotaur(default, never) : Transformation = new SimpleTransformation("Cow Minotaur Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsDemonic(default, never) : Transformation = new SimpleTransformation("Demonic Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.horns.count < 12 && (player.horns.type == Horns.NONE || player.horns.type == Horns.DEMON))
            {
                ...
                {
                    desc += "Another pair of demon horns, larger than the last, forms behind the first row.";
                }
                player.horns.count += 2;
    ...
    public var HornsAntlers(default, never) : Transformation = new SimpleTransformation("Antlers Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsAntlersWendigo(default, never) : Transformation = new SimpleTransformation("Wendigo Antlers Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsGhostlyWisps(default, never) : Transformation = new SimpleTransformation("Ghostly Wisps Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsOak(default, never) : Transformation = new SimpleTransformation("Oak Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsOrchid(default, never) : Transformation = new SimpleTransformation("Orchid Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsKraken(default, never) : Transformation = new SimpleTransformation("Kraken Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsSeadragon(default, never) : Transformation = new SimpleTransformation("Seadragon Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            else if (player.horns.type == Horns.DEMON && player.horns.count > 4)
            {
    ...
    public var HornsFrostwyrm(default, never) : Transformation = new SimpleTransformation("Frostwyrm Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsJabberwocky(default, never) : Transformation = new SimpleTransformation("Jabberwocky Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
    ...
    public var HornsUshiOni(default, never) : Transformation = new SimpleTransformation("Ushi-Oni Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsJiangshi(default, never) : Transformation = new SimpleTransformation("Jiangshi Spell Tag Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var HornsArchImp(default, never) : Transformation = new SimpleTransformation("Arch-Imp Horns", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
