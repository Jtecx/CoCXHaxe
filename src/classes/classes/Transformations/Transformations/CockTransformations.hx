 ...
 */
class CockTransformations extends MutationsHelper
{
    /*
    *	  ██████  ██████   ██████ ██    ██
    *	 ██      ██    ██ ██      ██  ██
    ...
    */
    ...
    public function GrowCockGenericText() : String
    {
        ...
        if (player.isTaur())
        {
            desc += "You feel a sudden stabbing pain between your back legs" + ((player.hasVagina()) ? " just below your [vagina]" : "") + " and bend over, moaning in agony. falling on your back so you can get a stare at your hindquarters you are presented with the shocking site of once-smooth flesh swelling and flowing like self-animate clay, resculpting itself into the form of male genitalia! When the pain dies down, ";
        }
        else if (!player.hasVagina() && !player.hasCock())
        {
            desc += "You feel a sudden stabbing pain in your groin and bend over, moaning in agony. Your hands clasp protectively over the surface - which is swelling in an alarming fashion under your fingers! Stripping off your clothes, you are presented with the shocking site of once-smooth flesh swelling and flowing like self-animate clay, resculpting itself into the form of male genitalia! When the pain dies down, ";
        }
        else if (player.hasCock())
        {
            desc += "You feel a sudden stabbing pain above your [cocks] and bend over, moaning in agony. Your hands clasp protectively over the surface - which is swelling in an alarming fashion under your fingers! Stripping off your clothes, you are presented with the shocking site of once-smooth flesh swelling and flowing like self-animate clay, resculpting itself into the form of male genitalia! When the pain dies down, ";
        }
        else
        {
            desc += "You feel a sudden stabbing pain just above your [vagina] and bend over, moaning in agony. Your hands clasp protectively over the surface - which is swelling in an alarming fashion under your fingers! Stripping off your clothes, you are presented with the shocking site of once-smooth flesh swelling and flowing like self-animate clay, resculpting itself into the form of male genitalia! When the pain dies down, ";
        }
        return desc;
    }
    ...
    private function cockIndex(cock : Int, type : CockTypesEnum) : Int
    {
        ...
        for (cock in 0...player.cocks.length)
        {
            if (player.cocks[cock].cockType != type)
            {
                return cock;
            }
        }
    ...
    private function isPresentCock(index : Int, type : CockTypesEnum) : Bool
    {
    ...
    public function CockHuman(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockHorse(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cockTotal() > cock)
            {
                ...
                //Text for dogdicks
                if (player.hasKnot(cock))
                {
                    desc += "  You notice your knot vanishing, the extra flesh pushing more fresh horsecock out from your sheath.";
                }
                else
                {
                    desc += "  The skin is mottled brown and black and feels more sensitive than normal.";
                }
            }
            else
            {
            ...
            if (doOutput)
            {
                outputText("<b>  Your hands are drawn to the strange new [cock " + (cock + 1) + "]</b>, and you jerk yourself off, splattering thick ropes of cum with intense force.");
            }
    ...
    public function CockKirin(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cockTotal() > cock)
            {
                ...
                {
                    desc += "  The skin is pale blue and feels more sensitive than normal.";
                }
            }
            else
            {
            ...
            if (doOutput)
            {
                outputText("<b>  Unable to hold the flow of pleasure back you spontaneously cum from your [cock " + (cock + 1) + "], splattering thick ropes of plasma with intense force.</b>");
            }
    ...
    public function CockDog(index : Int = 0, length : Float = 5.5, thickness : Float = 1, knot : Float = 1.4) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks.length > cock)
            {
                if (player.cocks[cock].cockType == CockTypesEnum.HORSE)
                {
                    ...
                    if (player.cocks[cock].cockLength > 6)
                    {
                        player.cocks[cock].cockLength -= 2;
                    }
                    else
                    {
                        player.cocks[cock].cockLength -= .5;
                    }
                    player.cocks[cock].cockThickness += .5;
                }
                else if (Lambda.indexOf(["tentacle", "plant"], player.cocks[cock].cockType.Group) >= 0)
                {
                ...
                if (player.cocks[cock].knotMultiplier <= 1)
                {
                ...
                else if (player.cocks[cock].knotMultiplier < knot)
                {
                    desc += "The knot on your new red pecker grows extremely sensitive as it grows thicker than before. ";
                }
            ...
            if (player.cocks[cock].knotMultiplier < knot)
            {
    ...
    public function CockDemon(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            else
            {
                ...
                {
                    desc += "A sudden pressure builds in your groin ";
                }
                else if (player.hasCock())
                {
                    desc += "A sudden pressure builds above your [cocks] ";
                }
                else
                {
                    desc += "A sudden pressure builds just above your [vagina] ";
                }
    ...
    public function CockTentacle(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks[cock].knotMultiplier < 1.3)
            {
                player.cocks[cock].knotMultiplier = 1.3;
            }
    ...
    public function CockScylla(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockCat(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks.length > cock)
            {
                ...
                if (player.hasSheath())
                {
                    desc += "  Your sheath tingles and begins growing larger as the cock's base shifts to lie inside it.";
                }
                else
                {
                    ...
                    if (player.hasBalls())
                    {
                        desc += "  Thankfully, your balls appear untouched.";
                    }
                }
            }
            else
    ...
    public function CockCancer(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockLizard(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
            ...
            if (player.cocks.length > cock)
            {
                if (player.lizardCocks() > 0)
                {
                    ...
                    if (player.hasSheath())
                    {
                        ...
                        if (!player.hasSheath())
                        {
                            desc += ("[pg]Your sheath tightens and starts to smooth out, revealing ever greater amounts of your " + cockDescript(cock) + "'s lower portions.  After a few moments <b>your groin is no longer so animalistic – the sheath is gone.</b>");
                        }
                    }
                }
                else
                {
                    ...
                    if (player.hasVagina())
                    {
                        desc += "Maybe you could find someone else with one to ride?";
                    }
                    else
                    {
                        desc += "Maybe you should test it out on someone and ask them exactly how it feels?";
                    }
    ...
    public function CockCaveWyrm(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockAnemone(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks.length > cock)
            {
                ...
                {
                    desc += "; you feel a pressure build below the shaft, near your asshole";
                }
                ...
                {
                    desc += allBreastsDescript() + " and ";
                }
                desc += "stomach";
                //[(dick1 exists)
                if (player.cockTotal() > 1)
                {
                    desc += ", followed in short order by white squirts from [eachcock] remaining";
                }
                if (player.hasVagina())
                {
                    desc += ".  Your [vag] quivers and pulses as well, adding ";
                    if (player.wetness() < VaginaClass.WETNESS_SLICK)
                    {
                        desc += "a trickle";
                    }
                    else if (player.wetness() < VaginaClass.WETNESS_SLAVERING)
                    {
                        desc += "a squirt";
                    }
                    else
                    {
                        desc += "nearly a cupful of fluid";
                    }
            ...
            else
            {
                ...
                {
                    desc += " below your " + player.multiCockDescriptLight();
                }
                ...
                if (player.cockTotal() > 0)
                {
                    desc += "  The tentacles writhe around, rubbing against your " + player.multiCockDescriptLight();
                }
                //(doesn't exist)
                else
                {
                    desc += "  The tentacles curl inwards, rubbing on the head of your new blue pecker";
                }
    ...
    public function CockKangaroo(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks.length > cock)
            {
                ...
                {
                    desc += "a sheath that forms at the base of it";
                }
    ...
    public function CockDragon(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks.length > cock)
            {
                ...
                if (player.sens >= 50)
                {
                    desc += "however, it's not until you press on your" + ((player.cocks[cock].hasKnot()) ? "" : " new,") + " sensitive knot that you manage to blow your load and enjoy the last few spasms of pleasure as it finally finishes changing.";
                }
                else
                {
                    desc += "but you sternly rein in your hands and tuck them into your armpits as the arousing changes run their course.";
                }
                if (player.cocks[cock].knotMultiplier < 1.3 && player.cocks[cock].knotMultiplier > 1)
                {
            ...
            else
            {
                ...
                if (player.sens >= 50)
                {
                    desc += "however, it's not until you press on your new, sensitive knot that you manage to blow your load and enjoy the last few spasms of pleasure as it finally finishes changing.";
                }
                else
                {
                    desc += "but you sternly rein in your hands and tuck them into your armpits as the arousing changes run their course.";
    ...
    public function CockDisplacer(index : Int = 0, length : Float = 5.5, thickness : Float = 1, knot : Float = 1.5) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks.length > cock)
            {
                ...
                if (!player.hasSheath())
                {
                    desc += "  Wait... did you have a sheath before? Well you do now.";
                }
                if (player.cocks[cock].knotMultiplier < knot && player.cocks[cock].knotMultiplier > 1)
                {
                    desc += "The knot on your cock grows extremely sensitive as it grows thicker than before. ";
                }
    ...
    public function CockFox(index : Int = 0, length : Float = 5.5, thickness : Float = 1, knot : Float = 1.25) : Transformation
    {
    ...
    public function CockBee(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockPig(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockAvian(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockRhino(index : Int = 0, length : Float = 5.5, thickness : Float = 1, inBlackCock : Bool = false) : Transformation
    {
    ...
    public function CockEchidna(index : Int = 0, length : Float = 5.5, thickness : Float = 1, inBlackCock : Bool = false) : Transformation
    {
    ...
    public function CockWolf(index : Int = 0, length : Float = 5.5, thickness : Float = 1, knot : Float = 1.1) : Transformation
    {
    ...
    public function CockStamen(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockRedPanda(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            else
            {
                if (!player.hasVagina() && !player.hasCock())
                {
                    desc += "You feel a sudden stabbing pain in your groin and bend over, moaning in agony. Your hands clasp protectively over the surface - which is swelling in an alarming fashion under your fingers! Stripping off your clothes, you are presented with the shocking site of once-smooth flesh swelling and flowing like self-animate clay, resculpting itself into the form of male genitalia! ";
                }
                else if (player.hasCock())
                {
                    desc += "You feel a sudden stabbing pain above your [cocks] and bend over, moaning in agony. Your hands clasp protectively over the surface - which is swelling in an alarming fashion under your fingers! Stripping off your clothes, you are presented with the shocking site of once-smooth flesh swelling and flowing like self-animate clay, resculpting itself into the form of male genitalia! ";
                }
                else
                {
    ...
    public function CockGryphon(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockCentipede(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockRaiju(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            if (player.cocks[cock].knotMultiplier < 1.25)
            {
                player.cocks[cock].knotMultiplier = 1.25;
            }
    ...
    public function CockUshiOni(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockArigean(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    public function CockInsect(index : Int = 0, length : Float = 5.5, thickness : Float = 1) : Transformation
    {
    ...
    {
        return new SimpleTransformation("Grow knot of cock", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
            ...
            //choose smallest dog knot if not specified{
                ...
                {
                    choice--;
                    if (player.isDogCock(choice) && player.cocks[choice].knotMultiplier < player.cocks[cock].knotMultiplier)
                    {
                        cock = choice;
                    }
                }
            ...
            var knot : Float = (rand(2) + mod) / div * crit;
            if (player.cocks[cock].knotMultiplier >= 1.5)
            {
                knot /= 2;
            }
            if (player.cocks[cock].knotMultiplier >= 1.75)
            {
                knot /= 2;
            }
            if (player.cocks[cock].knotMultiplier >= 2)
            {
                knot /= 5;
            }
            player.cocks[cock].knotMultiplier += (knot);
            if (knot < .06)
            {
                desc += "Your " + cockDescript(cock) + " feels unusually tight in your sheath as your knot grows.";
            }
            else if (knot <= .12)
            {
                desc += "Your " + cockDescript(cock) + " pops free of your sheath, thickening nicely into a bigger knot.";
            }
            else
            {
                desc += "Your " + cockDescript(cock) + " surges free of your sheath, swelling thicker with each passing second.  Your knot bulges out at the base, growing far beyond normal.";
            }
    ...
    public function CockChangeType(type : CockTypesEnum, grow : Bool, oneByOne : Bool = false) : Transformation
    {
        ...
        function(doOutput : Bool) : Void
        {
            ...
            for (i in 0...n)
            {
                ...
                if (cock == null || cock.cockType != type)
                {
                    switch (type)
                    {
