 ...
 */
class BreastsTransformations extends MutationsHelper
{
    /*
    *    ██████  ██████  ███████  █████  ███████ ████████ ███████
    *    ██   ██ ██   ██ ██      ██   ██ ██         ██    ██
    ...
    */
    ...
    //noinspection FallThroughInSwitchStatementJS	// Fallthrough is intended for retroactively unlocking in Metamorph after getting GeneticMemory
    {
        ...
        switch (player.bRows())
        {
            case 4, 3, 2, 1:
                ...
                }Metamorph.unlockMetamorphEx(BreastMem.getMemory(BreastMem.BREAST1));
            default:
        }
    }
    
    public var BreastsGrowUpToDD(default, never) : Transformation = new SimpleTransformation("Grow breasts up to DD", 
        // apply effect
    ...
    public var BreastsShrinkToNothing(default, never) : Transformation = new SimpleTransformation("Shrink breasts to nothing", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "Somehow, you know that the milk you had been producing is gone, reabsorbed by your body.  ";
            }
    ...
    public var BreastRowsRemoveToOne(default, never) : Transformation = new SimpleTransformation("One pair of breasts", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var BreastRowsOne(default, never) : Transformation = new SimpleTransformation("One pair of breasts ONLY", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var BreastRowsTwo(default, never) : Transformation = new SimpleTransformation("Two pairs of breasts ONLY", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var BreastRowsThree(default, never) : Transformation = new SimpleTransformation("Three pairs of breasts ONLY", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var BreastRowsFour(default, never) : Transformation = new SimpleTransformation("Four pairs of breasts ONLY", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    {
        return new SimpleTransformation("Create a breast row", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
            ...
            {
                desc += "Your abdomen tingles and twitches as a new row of breasts sprouts below the others.";
            }
            else
            {
                desc += "Your abdomen tingles and twitches as a new row of " + breastSize(size) + " " + breastDescript(player.bRows() - 1) + " sprouts below your others.";
            }
            if (player.bRows() == 0)
            {
    ...
    {
        return new SimpleTransformation("Copy last breast row but shrink 1 size", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
            ...
            {
                var size : Float = player.breastRows[player.bRows() - 1].breastRating;
                if (!keepSize)
                {
                    size--;
                }
                ...
                {
                    desc += "it's difficult to see past the wall of tits obscuring your view.";
                }
                else
                {
                    desc += "it's hard to get a good look at.";
                }
                ...
                if (player.breastRows[player.bRows() - 1].nipplesPerBreast > 1)
                {
                    desc += ", not to mention number";
                }
                else if (player.hasFuckableNipples())
                {
                    desc += ", not to mention penetrability";
                }
                if (size > 0)
                {
                    ...
                    if (keepSize)
                    {
                        desc += "catch up to the pair above.";
                    }
                    else
                    {
                        desc += "stop just short of the ones above.";
                    }
                    desc += "  They stop at " + breastSize(size) + "s.";
                }
                else
                {
                    desc += "  Your new breasts stay flat and masculine, not growing any larger.";
                }
            ...
            {
                transformations.CreateBreastRow(2).applyEffect(doOutput);
            }
            transformations.UnlockBreasts();
        }, 
        // is present
    ...
    public var NipplesPerBreastOne(default, never) : Transformation = new SimpleTransformation("One nipple per breast", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var NipplesPerBreastFour(default, never) : Transformation = new SimpleTransformation("Four nipples per breast", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            if (player.breastRows.length >= 3 && player.breastRows[2].nipplesPerBreast == 1)
            {
                ...
                if (player.bRows() == 3)
                {
                    desc += "third row of " + breastDescript(2) + " mutates along with its sisters, sprouting into a wonderland of nipples.";
                }
                else
                {
                    desc += "everything from the third row down mutates, sprouting into a wonderland of nipples.";
                }
            }
            if (doOutput)
            {
    ...
    public var NipplesFuckableForce(default, never) : Transformation = new SimpleTransformation("Increase Nipple size >= 2", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var NipplesFuckable(default, never) : Transformation = new SimpleTransformation("Fuckable nipples", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var NipplesUnfuck(default, never) : Transformation = new SimpleTransformation("Unfuck nipples", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var StartLactation(default, never) : Transformation = new SimpleTransformation("Start lactating", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "[pg]";
    ...
    public var RemoveLactation(default, never) : Transformation = new SimpleTransformation("Stop lactating", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
            ...
            {
                desc += "[pg]Both of your";
            }
            else
            {
                desc += "[pg]All of your many";
            }
    ...
    public var NipplesNoColor(default, never) : Transformation = new SimpleTransformation("Black nipples", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var NipplesBlack(default, never) : Transformation = new SimpleTransformation("Black nipples", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
    ...
    public var NipplesGlowing(default, never) : Transformation = new SimpleTransformation("Glowing nipples", 
        // apply effect
        function(doOutput : Bool) : Void
        {
            var desc : String = "";
