...
class BloodSwipeSkill extends AbstractBloodSoulSkill
{
    public function new(sfInfusion : Bool = false)
    {
        super(
                "Blood Swipe", 
                (sfInfusion) ? "(Soulforce infused) Blood Swipe, infused by a small amount of soulforce. This skill will fire three red lines of blood energy from your hand.  " : "Blood Swipe will fire three red lines of blood energy from your hand.  ", 
                TARGET_ENEMY, 
                TIMING_INSTANT, 
    ...
    override public function doEffect(display : Bool = true) : Void
    {
        ...
        if (display)
        {
            outputText("You concentrate, focusing on the power of your blood. " + additionalSFLine + "Three trails of blood pour from your fingertips, condensing into thin crimson blades. You point your clawlike blades at your foe, and they detach with a small crunch, flying toward [themonster].\n\n");
        }
