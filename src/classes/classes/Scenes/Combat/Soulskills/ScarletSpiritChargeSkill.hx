...
class ScarletSpiritChargeSkill extends AbstractBloodSoulSkill
{
    private static var ScarletSpiritChargeABC : Dynamic = FnHelpers.FN.buildLogScaleABC(10, 100, 1000, 10, 100);
    public function new()
    {
        super(
    ...
    override public function doEffect(display : Bool = true) : Void
    {
        ...
        var ScarletSpiritChargeBoost : Float = 10;
        ScarletSpiritChargeBoost += player.wisStat.core.value;
        ScarletSpiritChargeBoost *= spellModBlood();
        if (ScarletSpiritChargeBoost < 10)
        {
            ScarletSpiritChargeBoost = 10;
        }
        ...
        player.buff("ScarletSpiritCharge").addStats({
                                    ...
                                    wis.mult : (ScarletSpiritChargeBoost * 0.01)
                                }).withText("Scarlet Spirit Charge").combatPermanent();
    }
}
