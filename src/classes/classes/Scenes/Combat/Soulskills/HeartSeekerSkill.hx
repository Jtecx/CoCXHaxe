...
class HeartSeekerSkill extends AbstractBloodSoulSkill
{
    public function new(sfInfusion : Bool = false)
    {
        super(
                "Heart Seeker", 
                (sfInfusion) ? "(Soulforce infused) Heart Seeker, infused by a small amount of soulforce. This skill will hit the vital points of your foe.  " : "Heart Seeker will strike the vital points of your enemy, dealing true damage.  ", 
                TARGET_ENEMY, 
                TIMING_INSTANT, 
    ...
    override public function doEffect(display : Bool = true) : Void
    {
        ...
        if (display)
        {
            outputText("You concentrate, focusing on the power of your blood. " + additionalSFLine + "Within an instant, a large blood dripping spear forms in your hand. You motion, sending the spear flying toward [themonster]'s vitals.\n\n");
        }
