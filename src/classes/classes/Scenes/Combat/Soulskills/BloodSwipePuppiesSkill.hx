...
class BloodSwipePuppiesSkill extends AbstractBloodSoulSkill
{
    ...
    override public function doEffect(display : Bool = true) : Void
    {
        if (display)
        {
            outputText("Giving command to your blood puppies, they start focusing the power of blood. Within an instant, many red claw-like lines coalesce briefly before being shot from their paws, flying toward [themonster]! ");
        }
