...
class CombatFollowersActions extends BaseCombatContent
{
    ...
    public function increasedEfficiencyOfAttacks() : Float
    {
        var IEoA : Float = 0;
    ...
    private function pointsToHouseMareth() : Float
    {
        var points : Float = 0;
        if (player.hasPerk(PerkLib.Motivation))
        {
    ...
    private function downTo01Idle() : Bool
    {
        if (pointsToHouseMareth() >= 2)
        {
            return true;
        }
        else
    ...
    private function downTo20Idle() : Bool
    {
        if (pointsToHouseMareth() >= 1)
        {
            return true;
        }
        else
    ...
    public function neisaCombatActions() : Void
    {
        if (player.statusEffectv4(StatusEffects.CombatFollowerNeisa) > 0)
        {
            ...
            if (downTo01Idle())
            {
                ...
                else
                {
                    ...
                    if (choice1 >= 5 && choice1 < 10)
                    {
                        neisaCombatActions2();
                    }
                    if (choice1 >= 10 && choice1 < 15)
                    {
                        neisaCombatActions3();
                    }
                    if (choice1 >= 15)
            ...
            else if (downTo20Idle())
            {
                ...
                if (choice1 >= 4 && choice1 < 11)
                {
                    neisaCombatActions1();
                }
                if (choice1 >= 11 && choice1 < 16)
                {
                    neisaCombatActions2();
                }
                if (choice1 >= 16 && choice1 < 19)
                {
                    neisaCombatActions3();
                }
                if (choice1 == 19)
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Neisa" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Neisa" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Neisa" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
    ...
    {
        var dmg1 : Float = player.statusEffectv1(StatusEffects.CombatFollowerNeisa);
        var weaponNeisa : Float = player.statusEffectv2(StatusEffects.CombatFollowerNeisa);
        dmg1 += scalingBonusStrengthCompanion() * 0.5;
        if (weaponNeisa < 51)
        {
            dmg1 *= (1 + (weaponNeisa * 0.03));
        }
        else if (weaponNeisa >= 51 && weaponNeisa < 101)
        {
            dmg1 *= (2.5 + ((weaponNeisa - 50) * 0.025));
        }
        else if (weaponNeisa >= 101 && weaponNeisa < 151)
        {
            dmg1 *= (3.75 + ((weaponNeisa - 100) * 0.02));
        }
        else if (weaponNeisa >= 151 && weaponNeisa < 201)
        {
            dmg1 *= (4.75 + ((weaponNeisa - 150) * 0.015));
        }
        else
        {
            dmg1 *= (5.5 + ((weaponNeisa - 200) * 0.01));
        }
    ...
    public function dianaCombatActions() : Void
    {
        ...
        if (player.statusEffectv4(StatusEffects.CombatFollowerDiana) > 0)
        {
            ...
            if (choice2 >= 14 && choice2 < 17)
            {
                outputText("\n\n");
            }
            if (choice2 == 17 || choice2 == 18)
            {
                outputText("\n\n");
            }
            if (choice2 == 19)
    ...
    public function etnaCombatActions() : Void
    {
        if (player.statusEffectv4(StatusEffects.CombatFollowerEtna) > 0)
        {
            ...
            else if (downTo20Idle())
            {
                ...
                if (choice3 >= 4 && choice3 < 10)
                {
                    etnaCombatActions1();
                }
                if (choice3 >= 10 && choice3 < 16)
                {
                    etnaCombatActions2();
                }
                if (choice3 >= 16)
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Etna" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Etna" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Etna" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var lustDmg : Float = Math.round((player.statusEffectv2(StatusEffects.CombatFollowerEtna) / 6) * increasedEfficiencyOfAttacks());
    ...
    {
        var dmg2 : Float = player.statusEffectv1(StatusEffects.CombatFollowerEtna);
    ...
    public function auroraCombatActions() : Void
    {
        ...
        {
            var choice4 : Float = rand(20);
            if (downTo01Idle())
            {
                if (rand(100) == 0)
                {
                    auroraCombatActions0();
                }
                else
                {
                    if (choice4 < 5)
                    {
                        auroraCombatActions1();
                    }
                    if (choice4 >= 5 && choice4 < 10)
                    {
                        auroraCombatActions2();
                    }
                    if (choice4 >= 10 && choice4 < 15)
                    {
                        auroraCombatActions3();
                    }
                    if (choice4 >= 15)
                    {
                        auroraCombatActions4();
                    }
                }
            }
            else if (downTo20Idle())
            {
                ...
                if (choice4 >= 4 && choice4 < 11)
                {
                    auroraCombatActions1();
                }
                if (choice4 >= 11 && choice4 < 15)
                {
                    auroraCombatActions2();
                }
                if (choice4 >= 15 && choice4 < 18)
                {
                    auroraCombatActions3();
                }
                if (choice4 >= 18)
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Aurora" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Aurora" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Aurora" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg01 : Float = player.statusEffectv1(StatusEffects.CombatFollowerAurora);
        var weaponAurora1 : Float = player.statusEffectv3(StatusEffects.CombatFollowerAurora);
        dmg01 += scalingBonusStrengthCompanion() * 0.5;
        if (weaponAurora1 < 51)
        {
            dmg01 *= (1 + (weaponAurora1 * 0.03));
        }
        else if (weaponAurora1 >= 51 && weaponAurora1 < 101)
        {
            dmg01 *= (2.5 + ((weaponAurora1 - 50) * 0.025));
        }
        else if (weaponAurora1 >= 101 && weaponAurora1 < 151)
        {
            dmg01 *= (3.75 + ((weaponAurora1 - 100) * 0.02));
        }
        else if (weaponAurora1 >= 151 && weaponAurora1 < 201)
        {
            dmg01 *= (4.75 + ((weaponAurora1 - 150) * 0.015));
        }
        else
        {
            dmg01 *= (5.5 + ((weaponAurora1 - 200) * 0.01));
        }
    ...
    {
        var dmg3 : Float = player.statusEffectv1(StatusEffects.CombatFollowerAurora);
        var weaponAurora : Float = player.statusEffectv3(StatusEffects.CombatFollowerAurora);
        dmg3 += scalingBonusStrengthCompanion();
        if (weaponAurora < 51)
        {
            dmg3 *= (1 + (weaponAurora * 0.03));
        }
        else if (weaponAurora >= 51 && weaponAurora < 101)
        {
            dmg3 *= (2.5 + ((weaponAurora - 50) * 0.025));
        }
        else if (weaponAurora >= 101 && weaponAurora < 151)
        {
            dmg3 *= (3.75 + ((weaponAurora - 100) * 0.02));
        }
        else if (weaponAurora >= 151 && weaponAurora < 201)
        {
            dmg3 *= (4.75 + ((weaponAurora - 150) * 0.015));
        }
        else
        {
            dmg3 *= (5.5 + ((weaponAurora - 200) * 0.01));
        }
        dmg3 *= 3;
    ...
    {
        var dmg3a : Float = (scalingBonusStrengthCompanion() + scalingBonusToughnessCompanion()) / 6;
    ...
    public function ghoulishVampServCombatActions() : Void
    {
        ...
        {
            var choice5 : Float = rand(3);
            if (choice5 == 0)
            {
                ghoulishVampServCombatActions1();
            }
            if (choice5 == 1)
            {
                ghoulishVampServCombatActions2();
            }
            if (choice5 == 2)
            {
                ghoulishVampServCombatActions3();
            }
        }
        else
        {
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "" + flags[kFLAGS.GHOULISH_VAMPIRE_SERVANT_NAME] + "" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "" + flags[kFLAGS.GHOULISH_VAMPIRE_SERVANT_NAME] + "" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "" + flags[kFLAGS.GHOULISH_VAMPIRE_SERVANT_NAME] + "" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg02 : Float = player.statusEffectv1(StatusEffects.CombatFollowerGVampServ);
        var weaponGhoul1 : Float = player.statusEffectv2(StatusEffects.CombatFollowerGVampServ);
        ...
        if (player.racialScore(Races.VAMPIRE) >= 20 || player.racialScore(Races.DRACULA) >= 22)
        {
            ...
            HPChange(dmg02, true);
            var thirst : VampireThirstEffect = try cast(player.statusEffectByType(StatusEffects.VampireThirst), VampireThirstEffect) catch(e:Dynamic) null;
            var drinked : Float = 1;
            if (player.perkv1(IMutationsLib.HollowFangsIM) >= 3)
            {
                drinked += 1;
            }
            if (player.perkv1(IMutationsLib.HollowFangsIM) >= 4)
            {
                drinked += 3;
            }
    ...
    public function ghoulishVampServCombatActions2() : Void
    {
        ...
        if (rand(3) > 0)
        {
            var dmg03 : Float = scalingBonusStrengthCompanion() * 0.4;
        ...
        {
            outputText("[Themonster] manages to shove your servant back!");
        }
        outputText("\n\n");
    }
    public function ghoulishVampServCombatActions3() : Void
    {
        var dmg04 : Float = scalingBonusStrengthCompanion() * 0.4;
        var weaponGhoul2 : Float = player.statusEffectv2(StatusEffects.CombatFollowerGVampServ);
    ...
    public function ayaneCombatActions() : Void
    {
            ...
            if (downTo01Idle())
            {
                ...
                else
                {
                    if (choice5 < 7)
                    {
                        ...
                        {
                            if (player.statusEffectv4(StatusEffects.CombatFollowerAyane) > 1)
                            {
                                ayaneCombatActions3();
                            }
                            else
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Ayane" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Ayane" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Ayane" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    public function ayaneCombatActions1() : Void
    {
        ...
        var heal1 : Float = player.statusEffectv1(StatusEffects.CombatFollowerAyane);
    ...
    public function ayaneCombatActions3() : Void
    {
        ...
        var damageFF : Float = player.statusEffectv1(StatusEffects.CombatFollowerAyane) + player.statusEffectv2(StatusEffects.CombatFollowerAyane);
        ...
        {
            damageFF = Math.round(damageFF * 1.5);
        }
        damageFF *= 4;
        ...
        var lustDmg : Float = monster.lustVuln * ((player.statusEffectv1(StatusEffects.CombatFollowerAyane) / 12 + player.statusEffectv2(StatusEffects.CombatFollowerAyane) / 8) * (((player.statusEffectv3(StatusEffects.CombatFollowerAyane) * 2) / 2) + rand(monster.lib + monster.cor) / 5));
        if (monster.lust < (monster.maxLust() * 0.3))
        {
            outputText("[Themonster] squirms as the magic affects [monster him].  ");
        }
        if (monster.lust >= (monster.maxLust() * 0.3) && monster.lust < (monster.maxLust() * 0.6))
        {
            if (monster.plural)
            {
                outputText("[Themonster] stagger, suddenly weak and having trouble focusing on staying upright.  ");
            }
            else
            {
                outputText("[Themonster] staggers, suddenly weak and having trouble focusing on staying upright.  ");
            }
        }
    ...
    public function divaCombatActions() : Void
    {
        ...
        {
            var choice6 : Float = rand(20);
            if (choice6 < 10)
            {
                outputText("\n\n");
            }
            if (choice6 >= 10 && choice6 < 14)
            {
                outputText("\n\n");
            }
            if (choice6 >= 14 && choice6 < 17)
            {
                outputText("\n\n");
            }
            if (choice6 == 17 || choice6 == 18)
            {
                outputText("\n\n");
            }
            if (choice6 == 19)
    ...
    public function alvinaCombatActions() : Void
    {
        ...
        {
            var choice8 : Float = rand(20);
            if (downTo01Idle())
            {
                if (rand(100) == 0)
                {
                    alvinaCombatActions0();
                }
                else
                {
                    if (choice8 < 9)
                    {
                        alvinaCombatActions1();
                    }
                    if (choice8 >= 9 && choice8 < 12)
                    {
                        alvinaCombatActions2();
                    }
                    if (choice8 >= 12 && choice8 < 16)
                    {
                        alvinaCombatActions3();
                    }
                    if (choice8 >= 16 && choice8 < 19)
                    {
                        alvinaCombatActions4();
                    }
                    if (choice8 == 19)
                    {
                        alvinaCombatActions5();
                    }
                }
            }
            else if (downTo20Idle())
            {
                ...
                if (choice8 >= 4 && choice8 < 11)
                {
                    alvinaCombatActions1();
                }
                if (choice8 >= 11 && choice8 < 14)
                {
                    alvinaCombatActions2();
                }
                if (choice8 >= 14 && choice8 < 17)
                {
                    alvinaCombatActions3();
                }
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Alvina" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Alvina" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Alvina" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var damage1 : Float = player.statusEffectv2(StatusEffects.CombatFollowerAlvina);
    ...
    {
        var lustDmg : Float = Math.round(player.statusEffectv2(StatusEffects.CombatFollowerAlvina) / 3);
    ...
    {
        var dmg1 : Float = player.statusEffectv1(StatusEffects.CombatFollowerAlvina);
        var weaponAlvina : Float = 25;
        dmg1 += scalingBonusStrengthCompanion() * 0.5;
        if (weaponAlvina < 51)
        {
            dmg1 *= (1 + (weaponAlvina * 0.03));
        }
        else if (weaponAlvina >= 51 && weaponAlvina < 101)
        {
            dmg1 *= (2.5 + ((weaponAlvina - 50) * 0.025));
        }
        else if (weaponAlvina >= 101 && weaponAlvina < 151)
        {
            dmg1 *= (3.75 + ((weaponAlvina - 100) * 0.02));
        }
        else if (weaponAlvina >= 151 && weaponAlvina < 201)
        {
            dmg1 *= (4.75 + ((weaponAlvina - 150) * 0.015));
        }
        else
        {
            dmg1 *= (5.5 + ((weaponAlvina - 200) * 0.01));
        }
        dmg1 = Math.round(dmg1 * increasedEfficiencyOfAttacks());
        ...
        {
            if (monster.hasStatusEffect(StatusEffects.Hemorrhage2))
            {
                monster.addStatusValue(StatusEffects.Hemorrhage2, 1, 1);
            }
            else
            {
    ...
    {
        var damage2 : Float = player.statusEffectv2(StatusEffects.CombatFollowerAlvina);
    ...
    {
        var dmg : Float = player.statusEffectv2(StatusEffects.CombatFollowerAlvina);
    ...
    public function mitziCombatActions() : Void
    {
        if (player.statusEffectv4(StatusEffects.CombatFollowerMitzi) > 0)
        {
            ...
            if (downTo01Idle())
            {
                ...
                else
                {
                    ...
                    if (choice9 >= 9 && choice9 < 14)
                    {
                        mitziCombatActions2();
                    }
                    if (choice9 >= 14 && choice9 < 17)
                    {
                        mitziCombatActions3();
                    }
                    if (choice9 >= 17)
            ...
            else if (downTo20Idle())
            {
                ...
                if (choice9 >= 4 && choice9 < 12)
                {
                    mitziCombatActions1();
                }
                if (choice9 >= 12 && choice9 < 15)
                {
                    mitziCombatActions2();
                }
                if (choice9 >= 15 && choice9 < 18)
                {
                    mitziCombatActions3();
                }
                if (choice9 == 18 || choice9 == 19)
                {
                    mitziCombatActions4();
                }
            }
            else
            {
                ...
                if (choice9 >= 10 && choice9 < 14)
                {
                    mitziCombatActions1();
                }
                if (choice9 == 14 || choice9 == 15)
                {
                    mitziCombatActions2();
                }
                if (choice9 == 16 || choice9 == 17)
                {
                    mitziCombatActions3();
                }
                if (choice9 == 18 || choice9 == 19)
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Mitzi" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Mitzi" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Mitzi" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg4 : Float = player.statusEffectv1(StatusEffects.CombatFollowerMitzi);
    ...
    public function mitziCombatActions2() : Void
    {
        ...
        if (!monster.hasPerk(PerkLib.EnemyConstructType) || !monster.hasPerk(PerkLib.EnemyGhostType))
        {
            ...
            outputText("\n\n");
            if (monster.hasStatusEffect(StatusEffects.PoisonDoTH))
            {
                monster.addStatusValue(StatusEffects.PoisonDoTH, 1, 1);
            }
            else
            {
                monster.createStatusEffect(StatusEffects.PoisonDoTH, 4, 0.02, 0, 0);
            }
        }
    }
    public function mitziCombatActions3() : Void
    {
        var lustDmg : Float = Math.round((player.statusEffectv3(StatusEffects.CombatFollowerMitzi) / 6) * increasedEfficiencyOfAttacks());
    ...
    public function mitziCombatActions4() : Void
    {
        ...
        outputText("\n\n");
        if (monster.hasStatusEffect(StatusEffects.LustDoTH))
        {
            monster.addStatusValue(StatusEffects.LustDoTH, 1, 1);
        }
        else
        {
            monster.createStatusEffect(StatusEffects.LustDoTH, 4, 0.02, 0, 0);
        }
    }
    ...
    public function excelliaCombatActions() : Void
    {
        if (player.statusEffectv4(StatusEffects.CombatFollowerExcellia) > 0)
        {
            ...
            {
                excelliaCombatActions5();
            }
            else
            {
                var choice10 : Float = rand(20);
                if (downTo01Idle())
                {
                    if (rand(100) == 0)
                    {
                        excelliaCombatActions0();
                    }
                    else
                    {
                        if (choice10 < 9)
                        {
                            excelliaCombatActions1();
                        }
                        if (choice10 >= 9 && choice10 < 14)
                        {
                            excelliaCombatActions2();
                        }
                        if (choice10 >= 14 && choice10 < 17)
                        {
                            excelliaCombatActions3();
                        }
                        if (choice10 >= 17)
                        {
                            excelliaCombatActions4();
                        }
                    }
                }
                else if (downTo20Idle())
                {
                    ...
                    if (choice10 >= 4 && choice10 < 12)
                    {
                        excelliaCombatActions1();
                    }
                    if (choice10 >= 12 && choice10 < 15)
                    {
                        excelliaCombatActions2();
                    }
                    if (choice10 >= 15 && choice10 < 18)
                    {
                        excelliaCombatActions3();
                    }
                    if (choice10 == 18 || choice10 == 19)
                    {
                        excelliaCombatActions4();
                    }
                }
                else
                {
                    ...
                    if (choice10 >= 10 && choice10 < 14)
                    {
                        excelliaCombatActions1();
                    }
                    if (choice10 == 14 || choice10 == 15)
                    {
                        excelliaCombatActions2();
                    }
                    if (choice10 == 16 || choice10 == 17)
                    {
                        excelliaCombatActions3();
                    }
                    if (choice10 == 18 || choice10 == 19)
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Excellia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Excellia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Excellia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg7 : Float = player.statusEffectv1(StatusEffects.CombatFollowerExcellia);
    ...
    {
        var dmg8 : Float = player.statusEffectv1(StatusEffects.CombatFollowerExcellia);
    ...
    {
        var dmg9 : Float = Math.round(player.statusEffectv2(StatusEffects.CombatFollowerExcellia) * increasedEfficiencyOfAttacks());
        ...
        outputText("\n\n");
        if (!monster.hasStatusEffect(StatusEffects.LoweredAccuracy))
        {
            monster.createStatusEffect(StatusEffects.LoweredAccuracy, 40, 0, 0, 0);
        }
    }
    public function excelliaCombatActions4() : Void
    {
        var dmg10 : Float = player.statusEffectv1(StatusEffects.CombatFollowerExcellia);
        var unarmedExcellia : Float = player.statusEffectv2(StatusEffects.CombatFollowerExcellia);
    ...
    public function amilyCombatActions() : Void
    {
        if (player.statusEffectv4(StatusEffects.CombatFollowerAmily) > 0)
        {
            ...
            if (downTo01Idle())
            {
                ...
                else
                {
                    ...
                    if (choice11 >= 9 && choice11 < 14)
                    {
                        amilyCombatActions2();
                    }
                    if (choice11 >= 14 && choice11 < 17)
                    {
                        amilyCombatActions3();
                    }
                    if (choice11 >= 17)
            ...
            else if (downTo20Idle())
            {
                ...
                if (choice11 >= 4 && choice11 < 12)
                {
                    amilyCombatActions1();
                }
                if (choice11 >= 12 && choice11 < 15)
                {
                    amilyCombatActions2();
                }
                if (choice11 >= 15 && choice11 < 18)
                {
                    amilyCombatActions3();
                }
                if (choice11 == 18 || choice11 == 19)
                {
                    amilyCombatActions4();
                }
            }
            else
            {
                ...
                if (choice11 >= 10 && choice11 < 14)
                {
                    amilyCombatActions1();
                }
                if (choice11 == 14 || choice11 == 15)
                {
                    amilyCombatActions2();
                }
                if (choice11 == 16 || choice11 == 17)
                {
                    amilyCombatActions3();
                }
                if (choice11 == 18 || choice11 == 19)
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Amily" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Amily" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Amily" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg5 : Float = player.statusEffectv1(StatusEffects.CombatFollowerAmily);
    ...
    public function amilyCombatActions2() : Void
    {
        ...
        if (rand(3) == 0 || monster.hasPerk(PerkLib.Resolute))
        {
            outputText("[Themonster] shakes off the blow, but they’re still blinded from the impact.\n\n");
        }
        else
        {
    ...
    public function amilyCombatActions3() : Void
    {
        ...
        if (monster.hasStatusEffect(StatusEffects.EnemyLoweredDamageH))
        {
            monster.addStatusValue(StatusEffects.EnemyLoweredDamageH, 1, 1);
        }
        else
        {
            monster.createStatusEffect(StatusEffects.EnemyLoweredDamageH, 3, 40, 0, 0);
        }
    }
    public function amilyCombatActions4() : Void
    {
        var dmg6 : Float = player.statusEffectv1(StatusEffects.CombatFollowerAmily);
    ...
    public function siegweirdCombatActions() : Void
    {
        ...
        {
            var choice12 : Float = rand(20);
            if (choice12 < 10)
            {
                outputText("\n\n");
            }
            if (choice12 >= 10 && choice12 < 14)
            {
                outputText("\n\n");
            }
            if (choice12 >= 14 && choice12 < 17)
            {
                outputText("\n\n");
            }
            if (choice12 == 17 || choice12 == 18)
            {
                outputText("\n\n");
            }
            if (choice12 == 19)
    ...
    public function zenjiCombatActions() : Void
    {
        ...
        {
            if ((player.HP < player.maxHP() * 0.35) && player.statusEffectv3(StatusEffects.CombatFollowerZenji) < 4 && rand(10) > 1)
            {
                zenjiCombatActions5();
            }
            else
            {
                var choice13 : Float = rand(20);
                if (downTo01Idle())
                {
                    if (rand(100) == 0)
                    {
                ...
                else if (downTo20Idle())
                {
                    ...
                    if (choice13 >= 4 && choice13 < 10)
                    {
                        zenjiCombatActions1();
                    }
                    if (choice13 >= 10 && choice13 < 16)
                    {
                        zenjiCombatActions2();
                    }
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Zenji" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Zenji" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Zenji" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg11 : Float = player.statusEffectv1(StatusEffects.CombatFollowerZenji);
        var weaponZenji : Float = player.statusEffectv2(StatusEffects.CombatFollowerZenji);
        dmg11 += scalingBonusStrengthCompanion();
        if (weaponZenji < 51)
        {
            dmg11 *= (1 + (weaponZenji * 0.03));
        }
        else if (weaponZenji >= 51 && weaponZenji < 101)
        {
            dmg11 *= (2.5 + ((weaponZenji - 50) * 0.025));
        }
        else if (weaponZenji >= 101 && weaponZenji < 151)
        {
            dmg11 *= (3.75 + ((weaponZenji - 100) * 0.02));
        }
        else if (weaponZenji >= 151 && weaponZenji < 201)
        {
            dmg11 *= (4.75 + ((weaponZenji - 150) * 0.015));
        }
        else
        {
            dmg11 *= (5.5 + ((weaponZenji - 200) * 0.01));
        }
    ...
    {
        var dmg12 : Float = player.statusEffectv1(StatusEffects.CombatFollowerZenji);
        var weaponZenji : Float = player.statusEffectv2(StatusEffects.CombatFollowerZenji);
        dmg12 += scalingBonusStrengthCompanion() * 0.7;
        if (weaponZenji < 51)
        {
            dmg12 *= (1 + (weaponZenji * 0.03));
        }
        else if (weaponZenji >= 51 && weaponZenji < 101)
        {
            dmg12 *= (2.5 + ((weaponZenji - 50) * 0.025));
        }
        else if (weaponZenji >= 101 && weaponZenji < 151)
        {
            dmg12 *= (3.75 + ((weaponZenji - 100) * 0.02));
        }
        else if (weaponZenji >= 151 && weaponZenji < 201)
        {
            dmg12 *= (4.75 + ((weaponZenji - 150) * 0.015));
        }
        else
        {
            dmg12 *= (5.5 + ((weaponZenji - 200) * 0.01));
        }
        ...
        outputText(" [Themonster]");
        if (monster.hasPerk(PerkLib.Resolute) || rand(4) == 0)
        {
            outputText(" remains focused despite Zenji’s brutal strikes");
        }
        else
        {
            monster.createStatusEffect(StatusEffects.Stunned, 1, 0, 0, 0);
    ...
    public function zenjiCombatActions3() : Void
    {
        ...
        if (silly())
        {
            outputText("If you keep dis up, no more sex after dis fight! I mean it dis time");
        }
        else
        {
            outputText("Remained focused, don’t give in");
        }
        outputText("!</i>\"\n\n");
    ...
    {
        var dmg13 : Float = player.statusEffectv1(StatusEffects.CombatFollowerZenji);
        var weaponZenji : Float = player.statusEffectv2(StatusEffects.CombatFollowerZenji);
        dmg13 += scalingBonusStrengthCompanion() * 0.4;
        if (weaponZenji < 51)
        {
            dmg13 *= (1 + (weaponZenji * 0.03));
        }
        else if (weaponZenji >= 51 && weaponZenji < 101)
        {
            dmg13 *= (2.5 + ((weaponZenji - 50) * 0.025));
        }
        else if (weaponZenji >= 101 && weaponZenji < 151)
        {
            dmg13 *= (3.75 + ((weaponZenji - 100) * 0.02));
        }
        else if (weaponZenji >= 151 && weaponZenji < 201)
        {
            dmg13 *= (4.75 + ((weaponZenji - 150) * 0.015));
        }
        else
        {
            dmg13 *= (5.5 + ((weaponZenji - 200) * 0.01));
        }
    ...
    public function zenjiCombatActions5() : Void
    {
        ...
        if (player.statusEffectv3(StatusEffects.CombatFollowerZenji) == 1)
        {
            outputText(" Zenji remains weary, but he stands as if he were completely unaffected by the physical trauma he just endured.");
        }
        else
        {
            outputText("Zenji seems much worse for wear after protecting you, \"<i>I’m fine.</i>\" he mumbles, but it’s apparent that he’s sustained heavy damage.");
        }
    }
    ...
    public function tyrantiaCombatActions() : Void
    {
        ...
        //if (TyrantiaFollower.TyraniaPostFinalKissScene) tyrantiaCombatActions5();{
            ...
            if (monster.hasStatusEffect(StatusEffects.PouncedByCompanion))
            {
                tyrantiaCombatActions1();
            }
            else
            {
                var choice1 : Float = rand(20);
                if (downTo01Idle())
                {
                    ...
                    else
                    {
                        ...
                        if (choice1 >= 5 && choice1 < 10)
                        {
                            tyrantiaCombatActions2();
                        }
                        if (choice1 >= 10 && choice1 < 15)
                        {
                            tyrantiaCombatActions3();
                        }
                        if (choice1 >= 15)
                        {
                            tyrantiaCombatActions4();
                        }
                    }
                }
                else if (downTo20Idle())
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_0] == "Tyrantia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_0_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_0_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Tyrantia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Tyrantia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Tyrantia" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    public function tyrantiaCombatActions1() : Void
    {
        ...
        var dmg14 : Float = player.statusEffectv1(StatusEffects.CombatFollowerTyrantia);
        var weaponTyrantia : Float = player.statusEffectv2(StatusEffects.CombatFollowerTyrantia);
        var lustDmg : Float = Math.round(25 + monster.lib / 5 + monster.sens / 5 + monster.cor / 5);
        dmg14 += scalingBonusStrengthCompanion() * 1.5;
        weaponTyrantia *= 3;
        if (weaponTyrantia < 51)
        {
            dmg14 *= (1 + (weaponTyrantia * 0.03));
        }
        else if (weaponTyrantia >= 51 && weaponTyrantia < 101)
        {
            dmg14 *= (2.5 + ((weaponTyrantia - 50) * 0.025));
        }
        else if (weaponTyrantia >= 101 && weaponTyrantia < 151)
        {
            dmg14 *= (3.75 + ((weaponTyrantia - 100) * 0.02));
        }
        else if (weaponTyrantia >= 151 && weaponTyrantia < 201)
        {
            dmg14 *= (4.75 + ((weaponTyrantia - 150) * 0.015));
        }
        else
        {
            dmg14 *= (5.5 + ((weaponTyrantia - 200) * 0.01));
        }
    ...
    {
        var dmg15 : Float = player.statusEffectv1(StatusEffects.CombatFollowerTyrantia);
        ...
        {
            outputText("To your surprise, Tyrantia flinches, backing off from [themonster]. They fight their way to their feet, and take a fighting stance.");
        }
        if (!monster.isImmuneToBleed())
        {
            if (monster.hasStatusEffect(StatusEffects.Hemorrhage2))
    ...
    {
        var dmg16 : Float = player.statusEffectv3(StatusEffects.CombatFollowerTyrantia);
    ...
    {
        var lustDmg : Float = Math.round((25 + monster.lib / 5 + monster.sens / 5 + monster.cor / 5) * 4);
    ...
    public function kihaCombatActions() : Void
    {
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_0] == "Kiha" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_0_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_0_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Kiha" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Kiha" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Kiha" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg17 : Float = player.statusEffectv1(StatusEffects.CombatFollowerKiha);
        var weaponKiha : Float = player.statusEffectv2(StatusEffects.CombatFollowerKiha);
        dmg17 += scalingBonusStrengthCompanion();
        if (weaponKiha < 51)
        {
            dmg17 *= (1 + (weaponKiha * 0.03));
        }
        else if (weaponKiha >= 51 && weaponKiha < 101)
        {
            dmg17 *= (2.5 + ((weaponKiha - 50) * 0.025));
        }
        else if (weaponKiha >= 101 && weaponKiha < 151)
        {
            dmg17 *= (3.75 + ((weaponKiha - 100) * 0.02));
        }
        else if (weaponKiha >= 151 && weaponKiha < 201)
        {
            dmg17 *= (4.75 + ((weaponKiha - 150) * 0.015));
        }
        else
        {
            dmg17 *= (5.5 + ((weaponKiha - 200) * 0.01));
        }
    ...
    {
        var dmg18 : Float = player.statusEffectv1(StatusEffects.CombatFollowerKiha);
    ...
    public function kihaCombatActions3() : Void
    {
        ...
        var dmg19 : Float = player.statusEffectv1(StatusEffects.CombatFollowerKiha);
    ...
    public function midokaCombatActions() : Void
    {
        if (player.statusEffectv4(StatusEffects.CombatFollowerMidoka) > 0)
        {
            ...
            if (downTo01Idle())
            {
                if (rand(100) == 0)
                {
                    midokaCombatActions0();
                }
                else
                {
                    if (choice11 < 9)
                    {
                        midokaCombatActions1();
                    }
                    if (choice11 >= 9 && choice11 < 14)
                    {
                        midokaCombatActions2();
                    }
                    if (choice11 >= 14 && choice11 < 17)
                    {
                        midokaCombatActions3();
                    }
                    if (choice11 >= 17)
                    {
                        midokaCombatActions4();
                    }
                }
            }
            else if (downTo20Idle())
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_0] == "Midoka" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_0_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_0_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Midoka" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_1_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_2] == "Midoka" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_2_ACTION] = 1;
        }
        if (flags[kFLAGS.PLAYER_COMPANION_3] == "Midoka" && flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] != 1)
        {
            flags[kFLAGS.IN_COMBAT_PLAYER_COMPANION_3_ACTION] = 1;
        }
        if (monster.HP <= monster.minHP() || monster.lust >= monster.maxOverLust())
    ...
    {
        var dmg17 : Float = player.statusEffectv1(StatusEffects.CombatFollowerMidoka);
        var weaponMidoka : Float = player.statusEffectv2(StatusEffects.CombatFollowerMidoka);
        dmg17 += scalingBonusStrengthCompanion();
        if (weaponMidoka < 51)
        {
            dmg17 *= (1 + (weaponMidoka * 0.03));
        }
        else if (weaponMidoka >= 51 && weaponMidoka < 101)
        {
            dmg17 *= (2.5 + ((weaponMidoka - 50) * 0.025));
        }
        else if (weaponMidoka >= 101 && weaponMidoka < 151)
        {
            dmg17 *= (3.75 + ((weaponMidoka - 100) * 0.02));
        }
        else if (weaponMidoka >= 151 && weaponMidoka < 201)
        {
            dmg17 *= (4.75 + ((weaponMidoka - 150) * 0.015));
        }
        else
        {
            dmg17 *= (5.5 + ((weaponMidoka - 200) * 0.01));
        }
        dmg17 = Math.round(dmg17 * increasedEfficiencyOfAttacks());
    ...
    {
        var dmg18 : Float = player.statusEffectv1(StatusEffects.CombatFollowerMidoka);
        dmg18 += scalingBonusStrengthCompanion() * 0.5;
        dmg18 = Math.round(dmg18 * increasedEfficiencyOfAttacks());
    ...
    public function midokaCombatActions3() : Void
    {
        ...
        var dmg19 : Float = player.statusEffectv1(StatusEffects.CombatFollowerMidoka);
        dmg19 += scalingBonusStrengthCompanion();
        dmg19 = Math.round(dmg19 * increasedEfficiencyOfAttacks());
