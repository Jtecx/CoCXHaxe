...
class WillOfTheWispSkill extends AbstractGeneral
{
    ...
    {
        var willothewispDamage : Float = 10;
        ...
        {
            willothewispDamage *= combat.historyTacticianBonus();
        }
        
        var willothewispamplification : Float = 1;
        if (player.weapon == weapons.SCECOMM)
        {
            willothewispamplification += 0.5;
        }
        if (player.hasPerk(PerkLib.CommandingTone))
        {
            willothewispamplification += 0.1;
        }
        ...
        {
            willothewispamplification += 0.15;
        }
        if (player.hasPerk(PerkLib.WispLieutenant))
        {
            willothewispamplification += 1;
        }
