 ...
 */
class CombatAbility extends BaseCombatContent
{
    public var name(get, never) : String;
    public var description(get, never) : String;
    public var buttonName(get, never) : String;
    public var category(get, never) : Int;
    public var catObject(get, never) : Dynamic;
    public var isKnown(get, never) : Bool;
    public var isUsable(get, never) : Bool;
    public var isKnownAndUsable(get, never) : Bool;
    public var currentCooldown(get, never) : Int;
    public var currentDuration(get, never) : Int;

    /**
	 * Array of all abilities.
	 */
    public static var Registry : Array<Dynamic> = [];
    private static var idCounter : Int = 0;
    
    /**
	 * This ability targets player only.
	 */
    public static inline var TARGET_SELF : Int = 0;
    /**
	 * This ability targets enemy (or player and enemy).
	 */
    public static inline var TARGET_ENEMY : Int = 1;
    
    /**
	 * This ability is executed instantly.
	 * OR it is a lasting/toggle ability not using default mechanism.
	 */
    public static inline var TIMING_INSTANT : Int = 0;
    /**
	 * This ability adds an unstackable lasting effect.
	 * Stacked lasting abilities go under TIMING_INSTANT type.
	 */
    public static inline var TIMING_LASTING : Int = 1;
    /**
	 * This ability adds an unstackable lasting effect that could be toggled off by caster
	 */
    public static inline var TIMING_TOGGLE : Int = 2;
    // TODO @aimozg Channeling (precast) timing type
    // TODO @aimozg Reactive (cast automatically on some condition) timing type?
    
    public static var AllCategories : Array<Dynamic> = [];
    
    public static var CAT_UNIVERSAL : Int = EnumValue.add(AllCategories, 0, "UNIVERSAL", {
                    name : "Universal",
                    group : "general"
                });
    public static var CAT_PHYSICAL_SPECIAL : Int = EnumValue.add(AllCategories, 1, "PHYSICAL_SPECIAL", {
                    name : "Physical Special",
                    group : "special"
                });
    public static var CAT_MAGICAL_SPECIAL : Int = EnumValue.add(AllCategories, 2, "MAGICAL_SPECIAL", {
                    name : "Magical Special",
                    group : "special"
                });
    public static var CAT_SOULSKILL : Int = EnumValue.add(AllCategories, 3, "SOULSKILL", {
                    name : "Soulskill",
                    group : "soulskill"
                });
    public static var CAT_SPELL_WHITE : Int = EnumValue.add(AllCategories, 4, "SPELL_WHITE", {
                    name : "White Spell",
                    group : "spell"
                });
    public static var CAT_SPELL_BLACK : Int = EnumValue.add(AllCategories, 5, "SPELL_BLACK", {
                    name : "Black Spell",
                    group : "spell"
                });
    public static var CAT_SPELL_GREY : Int = EnumValue.add(AllCategories, 6, "SPELL_GREY", {
                    name : "Grey Spell",
                    group : "spell"
                });
    public static var CAT_SPELL_HEX : Int = EnumValue.add(AllCategories, 7, "SPELL_HEX", {
                    name : "Hex",
                    group : "spell"
                });
    public static var CAT_SPELL_NECRO : Int = EnumValue.add(AllCategories, 8, "SPELL_NECRO", {
                    name : "Necromancy Spell",
                    group : "spell"
                });
    public static var CAT_SPELL_BLOOD : Int = EnumValue.add(AllCategories, 9, "SPELL_BLOOD", {
                    name : "Blood Spell",
                    group : "spell"
                });
    public static var CAT_SPELL_DIVINE : Int = EnumValue.add(AllCategories, 10, "SPELL_DIVINE", {
                    name : "Divine Spell",
                    group : "spell"
                });
    public static var CAT_SPELL_GREEN : Int = EnumValue.add(AllCategories, 11, "SPELL_GREEN", {
                    name : "Green Spell",
                    group : "spell"
                });
    public static var CAT_BLOOD_SOULSKILL : Int = EnumValue.add(AllCategories, 12, "BLOOD_SOULSKILL", {
                    name : "Blood Soulskill",
                    group : "soulskill"
                });
    public static var CAT_MONSTER_SUMMON : Int = EnumValue.add(AllCategories, 13, "MONSTER_SUMMON", {
                    name : "Monster Summon",
                    group : "monstersummon"
                });
    
    public static var AllTags : Array<Dynamic> = [];
    public static var TAG_DAMAGING : Int = EnumValue.add(AllTags, 0, "DAMAGING", {
                    name : "Damaging",
                    desc : "This ability deals damage."
                });
    public static var TAG_BUFF : Int = EnumValue.add(AllTags, 1, "BUFF", {
                    name : "Buff",
                    desc : "This ability increases stats or otherwise buffs target."
                });
    public static var TAG_DEBUFF : Int = EnumValue.add(AllTags, 2, "DEBUFF", {
                    name : "Debuff",
                    desc : "This ability decreases stats or otherwise debuffs target."
                });
    public static var TAG_AOE : Int = EnumValue.add(AllTags, 3, "AOE", {
                    name : "AoE",
                    desc : "This ability has area-of-effect. x5 damage to groups."
                });
    public static var TAG_FIRE : Int = EnumValue.add(AllTags, 4, "FIRE", {
                    name : "Fire",
                    desc : "This ability's primary element is Fire"
                });
    public static var TAG_LIGHTNING : Int = EnumValue.add(AllTags, 5, "LIGHTNING", {
                    name : "Lightning",
                    desc : "This ability's primary element is Lightning"
                });
    public static var TAG_ICE : Int = EnumValue.add(AllTags, 6, "ICE", {
                    name : "Ice",
                    desc : "This ability's primary element is Ice"
                });
    public static var TAG_DARKNESS : Int = EnumValue.add(AllTags, 7, "DARKNESS", {
                    name : "Darkness",
                    desc : "This ability's primary element is Darkness"
                });
    public static var TAG_HEALING : Int = EnumValue.add(AllTags, 8, "HEALING", {
                    name : "Healing",
                    desc : "This ability heals player."
                });
    public static var TAG_RECOVERY : Int = EnumValue.add(AllTags, 9, "RECOVERY", {
                    name : "Recovery",
                    desc : "This ability recovers player's stats (other than HP) and statuses."
                });
    public static var TAG_LUSTDMG : Int = EnumValue.add(AllTags, 10, "LUSTDMG", {
                    name : "Arousing",
                    desc : "This ability deals lust damage."
                });
    public static var TAG_WATER : Int = EnumValue.add(AllTags, 11, "WATER", {
                    name : "Water",
                    desc : "This ability's primary element is Water"
                });
    public static var TAG_WIND : Int = EnumValue.add(AllTags, 12, "WIND", {
                    name : "Wind",
                    desc : "This ability's primary element is Wind"
                });
    public static var TAG_EARTH : Int = EnumValue.add(AllTags, 13, "EARTH", {
                    name : "Earth",
                    desc : "This ability's primary element is Earth"
                });
    public static var TAG_ACID : Int = EnumValue.add(AllTags, 14, "ACID", {
                    name : "Acid",
                    desc : "This ability's primary element is Acid"
                });
    public static var TAG_TIER1 : Int = EnumValue.add(AllTags, 15, "TIER1", {
                    name : "Tier1",
                    desc : "This ability is tier 1"
                });
    public static var TAG_TIER2 : Int = EnumValue.add(AllTags, 16, "TIER2", {
                    name : "Tier2",
                    desc : "This ability is tier 2"
                });
    public static var TAG_TIER3 : Int = EnumValue.add(AllTags, 17, "TIER3", {
                    name : "Tier3",
                    desc : "This ability is tier 3"
                });
    public static var TAG_PHYSICAL : Int = EnumValue.add(AllTags, 18, "PHYSICAL", {
                    name : "Physical",
                    desc : "This ability deals physical damage"
                });
    public static var TAG_MAGICAL : Int = EnumValue.add(AllTags, 19, "MAGICAL", {
                    name : "Magical",
                    desc : "This ability deals magical damage"
                });
    public static var TAG_POISON : Int = EnumValue.add(AllTags, 20, "POISON", {
                    name : "Poison",
                    desc : "This ability's primary element is Poison"
                });
    public static var TAG_PLASMA : Int = EnumValue.add(AllTags, 21, "PLASMA", {
                    name : "Plasma",
    ...
    public var baseManaCost : Float = 0;
    public var baseWrathCost : Float = 0;
    public var baseSFCost : Float = 0;
    public var baseFatigueCost : Float = 0;
    public var processPostCallback : Bool = true;
    //Used to tell the system the type of damage the last used ability inflicted
    private var lastAttackType : Int = 0;
    //Custom toggle to allow an ability to hit an invisible enemy
    private var affectsInvisible : Bool = false;
            ...
            tags : Array<Dynamic>)
    {
        ...
        this._tags = [];
        for (tag in 0...AllTags.length)
        {
            this._tags[tag] = Lambda.indexOf(tags, tag) >= 0;
        }
    }
    ...
    private function get_category() : Int
    {
        throw new Error("Method category() is not implemented for ability " + name);
    }
    
    private function get_catObject() : Dynamic
    {
        return AllCategories[category];
    }
    
    public function presentTags() : Array<Dynamic>
    {
        var result : Array<Dynamic> = [];
        for (tag in 0..._tags.length)
        {
            if (_tags[tag] != null)
            {
                result.push(tag);
    ...
    public function hasTag(tag : Int) : Bool
    {
        return _tags[tag];
    }
    
    private function addTag(tag : Int) : Bool
    {
        if (tag >= 0 && tag <= _tags.length && _tags[tag] == null)
        {
    ...
    private function removeTag(tag : Int) : Bool
    {
        if (tag >= 0 && tag <= _tags.length && _tags[tag] != null)
        {
    ...
    {
        if (timingType == TIMING_INSTANT)
        {
            return false;
        }
        if (timingType == TIMING_LASTING)
        {
            return (player.durations[id] > 0);
        }
        if (timingType == TIMING_TOGGLE)
        {
            return (player.durations[id] == -1);
        }
	 ...
	 */
    public function advance(display : Bool) : Void
	 ...
	 */
    public function costDescription() : Array<Dynamic>
    {
        var costs : Array<Dynamic> = [];
        if (manaCost() > 0)
        {
    ...
    public function fullDescription(target : Monster) : String
    {
        ...
        var costs : Array<Dynamic> = costDescription();
        if (costs.length > 0)
        {
            fullDesc += "\n<b>" + costs.join(", ") + "</b>";
        }
        
        var tags : Array<Dynamic> = presentTags();
        if (tags.length > 0)
        {
            fullDesc += "\nTags: " + tags.map(function(tag : Int, index : Int, array : Array<Dynamic>) : String
                            {
    ...
    {
        var bd : ButtonData = new ButtonData(buttonName, buttonCallback);
	 ...
	 */
    private function get_isUsable() : Bool
    {
        return usabilityCheck() == "";
    }
    
    private function get_isKnownAndUsable() : Bool
    {
	 ...
	 */
    public function perform(output : Bool = true, free : Bool = false, interceptable : Bool = true, doRevenge : Bool = false) : Void
    {
        if (doRevenge)
        {
            revenge();
    ...
    public function toggleOff(display : Bool = true) : Void
    {
        if (timingType != TIMING_TOGGLE)
        {
            throw new Error("Cannot deactivate non-toggle ability " + name);
        }
        if (player.durations[id] == -1)
        {
            player.durations[id] = 0;
        }
    }
    
    public function ensureToggledOff(display : Bool = true) : Void
    {
        if (timingType == TIMING_TOGGLE && isActive())
        {
            toggleOff(display);
	 ...
	 */
    public function doEffect(display : Bool = true) : Void
    {
        throw new Error("Method doEffect() not implemented for ability " + name);
    }
    
    public function revenge(display : Bool = true) : Void
    {
    ...
    public function wrathCost() : Float
    {
        return baseWrathCost;
    }
    
    public function hpCost() : Float
    {
        return 0;
    }
    ...
    {
        return as3hx.Compat.parseInt(baseSFCost);
    }
    
    public function fatigueCost() : Int
    {
        return as3hx.Compat.parseInt(baseFatigueCost);
    }
    
    /**
	 * Current cooldown (number of rounds left before it could be used again)
	 */
    private function get_currentCooldown() : Int
    {
	 ...
	 */
    private function get_currentDuration() : Int
    {
	 ...
	 */
    private function usabilityCheck() : String
	 ...
	 */
    private function toggleOffUsabilityCheck() : String
    {
        return "";
    }
	 ...
	 */
    private function advanceDuration(statusEffect : StatusEffectType, endFunction : Function = null, display : Bool = true) : Void
    {
	 ...
	 */
    public function durationEnd(display : Bool = true) : Void
    {
    }
	 ...
	 */
    public function numberFormat(damage : Float) : String
    {
