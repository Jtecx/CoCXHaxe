...
class Dreams
{
    ...
    public function dreamSelect() : Bool
    {
        ...
        for (score in scores)
        {
            var i : Int = Reflect.field(score, Std.string(0));
            while (i > 0)
            {
                choices.push(Reflect.field(score, Std.string(1)));
                i--;
            }
        }
        ...
        {
            if (CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 10)
            {
                choices[choices.length] = 7;
            }
            if (CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 13)
            {
                choices[choices.length] = 7;
            }
            if (CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 15)
            {
                choices[choices.length] = 7;
            }
            if (CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 18)
            {
                choices[choices.length] = 7;
            }
            choices[choices.length] = 7;
        ...
        if (dreamLust > 0)
        {
            player.dynStats("lus", dreamLust, "scale", false);
        }
        ...
        //Roll for dream!{
            ...
            //Male-ish dreams{
                ...
                if (player.gender <= 1 || (player.gender == 3 && Utils.rand(2) == 0))
                {
                    ...
                    {
                        EngineCore.outputText("stroking a knotted doggie-prick, gently stroking and squeezing it, yipping in pleasure as your pointed dog-cock leaks steady streams of fluids.  ");
                    }
                }
                //female
                else
            ...
            else if (daydream == 3)
            {
                ...
                {
                    EngineCore.outputText("roaming the mountain-sides while you hunt for a mate, your turgid shaft and swelling balls aching with the need for release.  ");
                }
            }
            //cat
            else if (daydream == 4)
            ...
            else if (daydream == 16)
            {
                if (player.gender <= 1)
                {
                    ...
                    else
                    {
                        ...
                        if (player.hasCock())
                        {
                            EngineCore.outputText("  [EachCock] is fully erect and throbbing.");
                        }
                        else if (player.hasVagina())
                        {
                            EngineCore.outputText("  Your [vagina] dripping wet with need.");
                        }
    ...
    public function dayTenDreams() : Void
    {
        ...
        else if (CoC.instance.player.cor < 50)
        {
            EngineCore.outputText("Your task completed, you return through the portal to your home.  Exhausted but happy, the sight of your village fills you with a surge of emotions.  Most prominently, and perhaps most enjoyably: pride.  You did it.\n\n");
        ...
        if (CoC.instance.player.cor < 50)
        {
            CoC.instance.player.dynStats("lus", 10, "scale", false);
        }
        else
        {
