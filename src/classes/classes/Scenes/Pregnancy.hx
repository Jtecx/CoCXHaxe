...
class Pregnancy extends NPCAwareContent
{
    public function new()
    {
        super();
    ...
    {
        var displayedUpdate : Bool = false;
        var pregText : String = "";
        ...
        {
            player.knockUpForce(player.pregnancyType, 1, 0, 1);
        }
        if (player.pregnancy2Incubation < 2)
        {
            player.knockUpForce(player.pregnancy2Type, 1, 1, 1);
        }
        if (player.buttPregnancyIncubation < 2)
        {
            player.buttKnockUpForce(player.buttPregnancyType, 1, 1);
        }
        //Cancel Heat
        if (player.inHeat)
        {
        ...
        {
            var wombs : Array<Dynamic> = [];
            var womb : Dynamic;
            if (player.pregnancyIncubation > 1)
            {
                womb = { };
                Reflect.setField(womb, "womb", 0);
                Reflect.setField(womb, "type", player.pregnancyType);
                Reflect.setField(womb, "incubation", player.pregnancyIncubation);
                wombs.push(womb);
            }
            if (player.pregnancy2Incubation > 1)
            {
                womb = { };
                Reflect.setField(womb, "womb", 1);
                Reflect.setField(womb, "type", player.pregnancy2Type);
                Reflect.setField(womb, "incubation", player.pregnancy2Incubation);
                wombs.push(womb);
            }
            for (womb in wombs)
            {
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_FAERIE)
                {
                    displayedUpdate = SceneLib.bog.phoukaScene.phoukaPregUpdate(womb);
                }
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_SAND_WITCH)
                {
                    displayedUpdate = SceneLib.dungeons.desertcave.sandPregUpdate(womb);
                }
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_URTA)
                {
                    displayedUpdate = urtaPregs.urtaPregooUpdates(womb);
                }
                //Cotton Pregnancy! - 350 days long
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_COTTON)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(320, Reflect.field(womb, "type")))
                    {
                    ...
                    else if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(280, Reflect.field(womb, "type")))
                    {
                    ...
                    else if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(225, Reflect.field(womb, "type")))
                    {
                    ...
                    else if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(165, Reflect.field(womb, "type")))
                    {
                    ...
                    else if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(105, Reflect.field(womb, "type")))
                    {
                    ...
                    else if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(80, Reflect.field(womb, "type")))
                    {
                    ...
                    else if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(50, Reflect.field(womb, "type")))
                    {
                    ...
                    //Tits
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(32, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(64, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(85, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(150, Reflect.field(womb, "type")))
                    {
                        displayedUpdate = true;
                        //Increase lactation!
                ...
                //Imp Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_IMP)
                {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(216, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor < 40)
                        {
                            EngineCore.outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>");
                        }
                        if (player.cor >= 40 && player.cor < 75)
                        {
                            EngineCore.outputText("Considering the size of the creatures you've fucked, you hope it doesn't hurt when it comes out.</b>");
                        }
                        if (player.cor >= 75)
                        {
                            EngineCore.outputText("You think dreamily about the monstrous cocks that have recently been fucking you, and hope that your offspring inherit such a pleasure tool.</b>");
                        }
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor < 40)
                        {
                            EngineCore.outputText("making it difficult to function.</b>");
                        }
                        if (player.cor >= 40 && player.cor < 75)
                        {
                            EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
                        }
                        if (player.cor >= 75)
                        {
                            EngineCore.outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>");
                        }
                        EngineCore.outputText("\n");
                ...
                //Minotaur Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_MINOTAUR)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(336, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n");
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor >= 75)
                        {
                            EngineCore.outputText("and you're eager to give birth, so you can get impregnated again by monstrous cocks unloading their corrupted seed directly into your eager womb.</b>");
                        }
                        EngineCore.outputText("\n");
                        player.dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
                        displayedUpdate = true;
                ...
                //Centaur Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_CENTAUR || Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_KELT)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(350, Reflect.field(womb, "type")))
                    {
                ...
                //Goblin Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_GOBLIN)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(150, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>You realize your belly has gotten bigger. Maybe you should cut back on all the strange food.</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(125, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>Your belly is getting more noticeably distended. You are probably pregnant which for you, is great news.</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(100, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(75, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(50, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(25, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(12, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(24, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(36, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(48, Reflect.field(womb, "type")))
                    {
                        displayedUpdate = true;
                        //Increase lactation!
                        if (player.biggestTitSize() >= 3 && player.mostBreastsPerRow() > 1 && player.biggestLactation() >= 1 && player.biggestLactation() < 2)
                ...
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_CELESS)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(696, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.hasPerk(PerkLib.UnicornBlessing))
                        {
                            EngineCore.outputText("Seems like she did actually manage to impregnate you without taking your virginity, doesn’t it?");
                        }
                        if (player.hasPerk(PerkLib.BicornBlessing))
                        {
                            ...
                            if (player.cor <= 10)
                            {
                                EngineCore.outputText(" Perhaps you could actualy raise her as a pure being?");
                            }
                        }
                        EngineCore.outputText("</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(480, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(240, Reflect.field(womb, "type")))
                    {
                ...
                //Bunny tf preggoz
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_BUNNY || Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_LOPPE)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(800, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\nYour womb gurgles strangely.\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(785, Reflect.field(womb, "type")))
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(776, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\nYour womb feels full and bloated.\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(765, Reflect.field(womb, "type")))
                    ...
                    if (Reflect.field(womb, "incubation") <= sceneHunter.adjustPregEventTimer(745, Reflect.field(womb, "type")) && Reflect.field(womb, "incubation") > sceneHunter.adjustPregEventTimer(400, Reflect.field(womb, "type")))
                    {
                        ...
                        displayedUpdate = true;
                        player.knockUpForce(0, 0, Reflect.field(womb, "womb"));
                    }
                    //BREAK - REAL PREGNANCY BELOW THIS:
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(198, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>You realize your belly has gotten slightly larger.  " +
                                ((Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_LOPPE) ? "" : "Maybe there's some truth to what the bunny-girl said.") + "</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(178, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>Your belly is getting more noticeably distended.   You are probably pregnant.</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(156, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>The unmistakable bulge of pregnancy is visible in your tummy.  ");
                        if (Reflect.field(womb, "type") != PregnancyStore.PREGNANCY_LOPPE)
                        {
                            if (player.cor < 40)
                            {
                                EngineCore.outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>");
                            ...
                            if (player.cor >= 40 && player.cor < 75)
                            {
                                EngineCore.outputText("You find yourself wondering what giving birth to bunny-girls is like.</b>");
                            }
                            if (player.cor >= 75)
                            {
                                EngineCore.outputText("You dreamily wonder if you could find a bunny willing to put more than two eggs inside you at once.</b>");
                            }
                        }
                        else
                        {
                            outputText("You find yourself wondering what giving birth to bunny-girls is like.</b>");
                        }
                        player.dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
                        EngineCore.outputText("\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(140, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor >= 75)
                        {
                            EngineCore.outputText("and you're eager to give birth so you'll be able to get pregnant again.</b>");
                        }
                        EngineCore.outputText("\n");
                        player.dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
                        displayedUpdate = true;
                ...
                //Marblz Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_MARBLE)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(336, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n");
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor >= 75)
                        {
                            EngineCore.outputText("and you're eager to give birth, so you can get fill your womb with a new charge.</b>");
                        }
                        EngineCore.outputText("\n");
                        player.dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
                        displayedUpdate = true;
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(32, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(150, Reflect.field(womb, "type")))
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(85, Reflect.field(womb, "type")))
                ...
                //Jojo Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_MOUSE || Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_JOJO)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(336, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n");
                    ...
                    {
                        EngineCore.outputText("\n<b>Your belly is getting more noticeably distended and squirming around.  You are probably pregnant.</b>\n");
                        if (flags[kFLAGS.JOJO_BIMBO_STATE] == 3 && Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_JOJO)
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(120, Reflect.field(womb, "type")))
                    {
                        ...
                        //Bimbo Jojo, stage 5{
                            ...
                            {
                                EngineCore.outputText("You grin at Joy's idea, but you can't simply mash her against your breasts and nurse her without some teasing first.");
                            }
                ...
                //Amily Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_AMILY)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(336, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(216, Reflect.field(womb, "type")))
                    {
                        ...
                        {
                            EngineCore.outputText("  Amily smiles at you reassuringly. \"<i>We do have litters, dear, this is normal.</i>\"");
                        }
                        EngineCore.outputText("</b>");
                        EngineCore.outputText("\n");
                        player.dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
                ...
                //Shark Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_IZMA)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(275, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(250, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>Your belly is getting more noticeably distended and squirming around.  You are probably pregnant.</b>\n");
                        displayedUpdate = true;
                    }
                ...
                //SPOIDAH Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_SPIDER || Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_DRIDER_EGGS)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(399, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(250, Reflect.field(womb, "type")))
                    {
                        ...
                        {
                            EngineCore.outputText(" even for you");
                        }
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(180, Reflect.field(womb, "type")))
                    {
                        ...
                        if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_SPIDER)
                        {
                            EngineCore.outputText("spider-morphs ");
                        }
                        else
                        {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor < 50)
                        {
                            EngineCore.outputText("  You shudder and shake your head, wondering why you're thinking such unusual things.");
                        }
                        EngineCore.outputText("</b>\n");
                        displayedUpdate = true;
                    }
                ...
                //Goo Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_GOO_GIRL)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(32, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(64, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(82, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(16, Reflect.field(womb, "type")))
                ...
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_EMBER)
                
                //Pregnancy notes: Egg Laying{
                    
                    if (flags[kFLAGS.EMBER_OVIPOSITION] > 0)
                    {
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(330, Reflect.field(womb, "type")))
                        {
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(250, Reflect.field(womb, "type")))
                        {
                            pregText = "Your belly grows ever bigger, making your pregnancy noticeable; your belly also feels somewhat solid.  Ember casts pleased glances in your direction, whenever " + emberScene.emberMF("he", "she") + " thinks you're not looking.";
                        }
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(170, Reflect.field(womb, "type")))
                        {
                            ...
                            if (player.cor < 40)
                            {
                                pregText += "  Part of you didn't really want to get knocked up, but it's for a good cause.  Besides, Ember looks very cute, trying to hide " + emberScene.emberMF("his", "her") + " happiness whenever " + emberScene.emberMF("he", "she") + " glances at your belly...";
                            }
                            //(If Corruption >= 40)
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(90, Reflect.field(womb, "type")))
                        {
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(60, Reflect.field(womb, "type")))
                        {
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(30, Reflect.field(womb, "type")))
                        {
                            ...
                            {
                                pregText += "You find yourself daydreaming about giving birth, your belly swollen huge - bigger than it currently is - and the orgasmic sensation of many large, round eggs sliding out of your " + player.vaginaDescript(Reflect.field(womb, "womb")) + ".\n\nYou start to absently rub yourself as you envision eggs by the dozens coming from within you; you shall be mothergod for a whole new race of dragons...";
                    ...
                    else
                    {
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(170, Reflect.field(womb, "type")))
                        {
                            ...
                            if (player.cor < 40)
                            {
                                pregText += "Part of you didn't really want to get knocked up.  However, Ember's look of satisfaction whenever " + emberScene.emberMF("he", "she") + " gazes your way is rewarding despite that.  Plus, it is for a good cause.  You smirk in satisfaction - with a couple of dragons at your beck and call, things will look very different indeed.";
                            }
                            //If Corruption >= 40
                            else if (player.cor < 75)
                            {
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(120, Reflect.field(womb, "type")))
                        {
                            ...
                            {
                                pregText += ", blush at " + emberScene.emberMF("his", "her") + " own over-enthusiastic reply";
                            }
                        ...
                        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(90, Reflect.field(womb, "type")))
                        {
                            ...
                            if (player.cor <= 33)
                            {
                                pregText += "There really isn't anything you feel like you need right now... maybe some water?  Or maybe you could have Ember help you to your " + camp.homeDesc() + " for a quick rest?";
                            }
                            //(Medium Corruption)
                            else if (player.cor <= 66)
                            {
                                pregText += "You wonder if you should take advantage of Ember - you've certainly been feeling a little on edge lately, and besides " + emberScene.emberMF("he", "she") + " did say 'anything'.  You ponder this for a while longer.";
                            }
                            //High Corruptio
                            else
                            {
                                pregText += "You  already thought up a perfect way for this sexy dragon to help you, but it's best not to rush.  It's not everyday that Ember says " + emberScene.emberMF("he", "she") + "'ll do 'anything' for you.  A quick jab on your belly from your unborn child makes you recoil a bit though.  Maybe it would be better to wait until this little one is out of you, just so you can have another.  You ponder what to ask of " + emberScene.emberMF("him", "her") + " a while longer.";
                            }
                ...
                //Pregnancy 4 Satyrs
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_SATYR)
                ...
                //BASILISK Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_BASILISK || Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_BENOIT)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(185, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>Your belly grumbles as if empty, even though you ate not long ago.  Perhaps with all the exercise you're getting you just need to eat a little bit more.</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(160, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>Your belly looks a little pudgy");
                        if (player.thickness > 60 && player.tone < 40)
                        {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(110, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>Your belly has gotten nice and big, perhaps as big as you remember the bellies of the pregnant women back home being.  The elders always did insist on everyone doing their part to keep the population high enough to sustain the loss of a champion every year.  You give yourself a little hug, getting a surge of happiness from your hormone-addled body.  Pregnancy sure is great!</b>\n");
                        displayedUpdate = true;
                    }
                ...
                //Anemone Pregnancy
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_ANEMONE)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(240, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(210, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(185, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor >= 40 && player.cor < 75)
                        {
                            EngineCore.outputText("Considering the possible fathers, you hope it isn't that big.</b>");
                        }
                        if (player.cor >= 75)
                        {
                            EngineCore.outputText("You think dreamily about the cocks that have recently been fucking you, and hope that your offspring inherit such a divine pleasure tool.</b>");
                        }
                        player.dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
                        EngineCore.outputText("\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(154, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(120, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.hasVagina())
                        {
                            EngineCore.outputText(" and keeps your " + vaginaDescript(Reflect.field(womb, "womb")) + " aroused from the constant tingling in your womb");
                        }
                        EngineCore.outputText(".</b>\n");
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
                    {
                        ...
                        if (player.cor < 40)
                        {
                            EngineCore.outputText("and constantly shifts and wriggles.  What manner of beast are you bringing into the world?</b>");
                        }
                        if (player.cor >= 40 && player.cor < 75)
                        {
                            EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
                ...
                //Hellhound Pregnancy!
                if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_HELL_HOUND)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(290, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n");
                        displayedUpdate = true;
                    }
                ...
                //Frog Eggs
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_FROG_GIRL)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(8, Reflect.field(womb, "type")))
                    
                    //Egg Maturing{
                        
                        if (player.hasVagina())
                        {
                            EngineCore.outputText("\nYour gut churns, and with a squelching noise, a torrent of transparent slime gushes from your " + player.vaginaDescript(Reflect.field(womb, "womb")) + ".  You immediately fall to your knees, landing wetly amidst the slime.  The world around briefly flashes with unbelievable colors, and you hear someone giggling.\n\nAfter a moment, you realize that it’s you.");
                            //pussy:
                            if (player.hasVagina())
                            {
                                EngineCore.outputText("  Against your " + player.vaginaDescript(Reflect.field(womb, "womb")) + ", the slime feels warm and cold at the same time, coaxing delightful tremors from your [clit].");
                            }
                            //[balls:
                            ...
                            {
                                EngineCore.outputText("  Your " + player.vaginaDescript(Reflect.field(womb, "womb")) + " begins twitching, aching for something to push through it over and over again.");
                            }
                ...
                //Minerva Pregnancy
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_MINERVA)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(216, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(144, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(24, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("<b>Your belly is as big as it can get.  You have a feeling that you'll give birth to a twin soon.</b>");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(144, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(85, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(150, Reflect.field(womb, "type")))
                ...
                //Alraune Pregnancy
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_ALRAUNE)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(120, Reflect.field(womb, "type")))
                    {
                        if (player.isAlraune())
                        {
                            EngineCore.outputText("<b>You suddenly feel a change in the pitcher below your feet. It feels heavier than before.</b>");
                        }
                        else
                        {
                            EngineCore.outputText("<b>Your belly increase in size as something not unlike pollen or nectar slowly drip out of your pussy.</b>");
                        }
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(80, Reflect.field(womb, "type")))
                    {
                        if (player.isAlraune())
                        {
                            EngineCore.outputText("<b>A delicious feeling of fullness originate from the bottom of your pitcher as you begin daydreaming about children.</b>");
                        }
                        else
                        {
                            EngineCore.outputText("<b>Some fluids not unlike pollen or nectar flow out of your vagina and you can’t help but pat your inflating belly with motherly delight. Whatever is in there is growing nicely.</b>");
                        }
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(40, Reflect.field(womb, "type")))
                    {
                        if (player.isAlraune())
                        {
                            EngineCore.outputText("<b>Somehow due to the weight and delicious feeling in your pitcher you are certain you are pregnant with seeds. A soothing warmth fills you as you smile in delight of your motherhood.</b>");
                        }
                        else
                        {
                            EngineCore.outputText("<b>Some fluids not unlike pollen or nectar flow out of your vagina and you can’t help but pat your inflating belly with motherly delight. Whatever is in there is growing nicely. Something tells you you will be giving birth soon.</b>");
                        }
                        displayedUpdate = true;
                    }
                }
                //Zenji Pregnancy
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_ZENJI)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(700, Reflect.field(womb, "type")))
                    {
                ...
                //Behemoth Pregnancy
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_BEHEMOTH)
                {
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(1152, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(864, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("<b>Your distended belly shows obvious signs of pregnancy.</b>");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(576, Reflect.field(womb, "type")))
                    {
                        EngineCore.outputText("<b>Your belly is getting larger.</b>");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(288, Reflect.field(womb, "type")))
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(1024, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(768, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(512, Reflect.field(womb, "type")) || Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(256, Reflect.field(womb, "type")))
                ...
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_COCKATRICE)
                {
                    if (Reflect.field(womb, "incubation") == 185)
                    {
                        outputText("\n<b>Your belly grumbles as if empty, even though you ate not long ago.  Perhaps with all the exercise you're getting you just need to eat a little bit more.</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == 160)
                    {
                        outputText("\n<b>Your belly looks a little pudgy");
                        if (player.thickness > 60 && player.tone < 40)
                        {
                    ...
                    if (Reflect.field(womb, "incubation") == 140)
                    {
                        outputText("\n<b>Your belly is definitely getting bigger, and no matter what you do, you can't seem to stop yourself from eating at the merest twinge of hunger.  The only explanation you can come up with is that you've gotten pregnant during your travels.  Hopefully it won't inconvenience your adventuring.</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == 110)
                    {
                        outputText("\n<b>Your belly has gotten nice and big, perhaps as big as you remember the bellies of the pregnant women back home being.  The elders always did insist on everyone doing their part to keep the population high enough to sustain the loss of a champion every year.  You give yourself a little hug, getting a surge of happiness from your hormone-addled body.  Pregnancy sure is great!</b>\n");
                        displayedUpdate = true;
                    }
                    if (Reflect.field(womb, "incubation") == 72)
                    {
                        outputText("\n<b>The huge size of your pregnant belly constantly impedes your movement, but the constant squirming and shaking of your unborn offspring makes you pretty sure you won't have to carry them much longer.  A sense of motherly pride wells up in your breast - you just know you'll have such wonderful babies.");
                        if (player.cor < 50)
                        {
                    ...
                    if (Reflect.field(womb, "incubation") == 32 || Reflect.field(womb, "incubation") == 64 || Reflect.field(womb, "incubation") == 85 || Reflect.field(womb, "incubation") == 150)
                ...
                else if (Reflect.field(womb, "type") == PregnancyStore.PREGNANCY_QUASI_PHOENIX)
                {
                    if (Reflect.field(womb, "incubation") == 168)
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == 120)
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == 24)
                    {
                    ...
                    if (Reflect.field(womb, "incubation") == 16 || Reflect.field(womb, "incubation") == 48 || Reflect.field(womb, "incubation") == 86)
        ...
        if (player.pregnancyIncubation == 1 && player.pregnancyType != PregnancyStore.PREGNANCY_BENOIT && player.pregnancyType != PregnancyStore.PREGNANCY_HARPY_HATCHING)
        {
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_BUNNY)
            {
                ...
                {
                    EngineCore.outputText("It hurts a little as your cervix starts to stretch wide");
                }
                else
                {
                    EngineCore.outputText("It actually feels kind of nice as your cervix is stretched wide");
                }
                ...
                {
                    EngineCore.outputText(", growing fat from all the milk");
                }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_ANEMONE)
            {
                ...
                else if (player.cockTotal() < 10)
                {
                    ...
                    {
                        EngineCore.outputText(" below your " + player.multiCockDescriptLight());
                    }
                    ...
                    if (player.cockTotal() > 0)
                    {
                        EngineCore.outputText("  The tentacles writhe around, rubbing against your " + player.multiCockDescriptLight());
                    }
                    //(doesn't exist)
                    else
                    {
                        EngineCore.outputText("  The tentacles curl inwards, rubbing on the head of your new blue pecker");
                    }
                    ...
                    if (player.cockTotal() == 1 && player.balls == 0)
                    {
                        EngineCore.outputText("; you feel a pressure build below the shaft, near your asshole");
                    }
                    EngineCore.outputText(".  As the venom and the rubbing work you to the edge of climax, your muscles clench and a ");
                    if (player.cumQ() < 100)
                    {
                        EngineCore.outputText("glob");
                    }
                    ...
                    {
                        EngineCore.outputText(allBreastsDescript() + " and ");
                    }
                    EngineCore.outputText("stomach");
                    //[(dick1 exists)
                    if (player.cockTotal() > 1)
                    {
                        EngineCore.outputText(", followed in short order by white squirts from [eachcock] remaining");
                    }
                    ...
                    {
                        EngineCore.outputText("a trickle");
                    }
                    else if (player.vaginas[0].vaginalWetness < VaginaClass.WETNESS_SLAVERING)
                    {
                        EngineCore.outputText("a squirt");
                    }
                    else
                    {
                        EngineCore.outputText("nearly a cupful of fluid");
                    }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_HARPY_EGGS)
            {
                ...
                {
                    EngineCore.outputText("stretching your tight cunt painfully, the lips opening wide ");
                }
                ...
                {
                    EngineCore.outputText("temporarily stretching your cunt-lips wide-open ");
                }
                if (player.vaginas[0].vaginalLooseness > VaginaClass.LOOSENESS_GAPING_WIDE)
                {
                    EngineCore.outputText("parting your already gaping lips wide ");
                }
                ...
                {
                    EngineCore.outputText("your massive cock-like clit, jacking it off with the slimy birthing fluids as lube.   It pulses and twitches in time with your heartbeats, its sensitive surface overloading your fragile mind with pleasure.  ");
                }
                if (player.clitLength > 2 && player.clitLength <= 5)
                {
                    EngineCore.outputText("your large clit like a tiny cock, stroking it up and down between your slime-lubed thumb and fore-finger.  It twitches and pulses with your heartbeats, the incredible sensitivity of it overloading your fragile mind with waves of pleasure.  ");
                }
                if (player.clitLength <= 2)
                {
                    EngineCore.outputText("your " + vaginaDescript(0) + " by pulling your folds wide and playing with your clit.  Another egg pops free from your diminishing belly, accompanied by an audible burst of relief.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself.  ");
                }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_IMP)
            {
                ...
                if (player.cor < 50)
                {
                    EngineCore.outputText("You rue the day you encountered that hateful imp.  ");
                }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_MINOTAUR)
            {
                ...
                if (player.hasMutation(IMutationsLib.GoblinOvariesIM))
                {
                    flags[kFLAGS.MINOTAUR_SONS_CHILDREN] += 2;
                }
                else
                {
                ...
                {
                    flags[kFLAGS.MINOTAUR_SONS_GROW_COUNTDOWN] = 150;
                }
            }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_MOUSE || player.pregnancyType == PregnancyStore.PREGNANCY_JOJO)
            {
                ...
                if (player.pregnancyType == PregnancyStore.PREGNANCY_JOJO && (monk < 0 || flags[kFLAGS.JOJO_BIMBO_STATE] == 3))
                {
                    ...
                    {
                        SceneLib.jojoScene.giveBirthToPureJojoBabies();
                    }
                }
                else
                {
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_MINERVA)
            {
                ...
                {
                    SceneLib.mountain.minervaScene.minervaCorruption.corruptPlayerBirth();
                }
                else
                {
                    SceneLib.mountain.minervaScene.minervaPurification.playerGivesBirth();
                }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_ALRAUNE)
            {
                ...
                if (player.hasMutation(IMutationsLib.GoblinOvariesIM))
                {
                    flags[kFLAGS.ALRAUNE_SEEDS] += 10;
                }
                else
                {
                    flags[kFLAGS.ALRAUNE_SEEDS] += 5;
                }
                if (flags[kFLAGS.ALRAUNE_GROWING] < 1)
                {
                    flags[kFLAGS.ALRAUNE_GROWING] = 1;
                }
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_OVIELIXIR_EGGS)
            {
                ...
                //light quantity{
                    ...
                    else
                    {
                        ...
                        if (player.clitLength > 5)
                        {
                            EngineCore.outputText("jerking on your huge clitty as if it were a cock, moaning and panting as each egg slides free of your diminishing belly.  You lubricate it with a mix of your juices and the slime until ");
                        }
                        if (player.clitLength > 2 && player.clitLength <= 5)
                        {
                            EngineCore.outputText("playing with your over-large clit as if it were a small cock, moaning and panting as the eggs slide free of your diminishing belly.  You spread the slime and cunt juice over it as you tease and stroke until ");
                        }
                        if (player.clitLength <= 2)
                        {
                            EngineCore.outputText("pulling your folds wide and playing with your clit as another egg pops free from your diminishing belly.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself until ");
                        }
        ...
        if (player.pregnancy2Incubation == 1 && player.pregnancy2Type != PregnancyStore.PREGNANCY_BENOIT && player.pregnancy2Type != PregnancyStore.PREGNANCY_HARPY_HATCHING)
        {
            ...
            if (player.pregnancy2Type == PregnancyStore.PREGNANCY_ANEMONE)
            {
                ...
                else if (player.cockTotal() < 10)
                {
                    ...
                    if (player.vaginas[1].vaginalWetness < VaginaClass.WETNESS_SLICK)
                    {
                        EngineCore.outputText("a trickle");
                    }
                    else if (player.vaginas[1].vaginalWetness < VaginaClass.WETNESS_SLAVERING)
                    {
                        EngineCore.outputText("a squirt");
                    }
                    else
            ...
            if (player.pregnancy2Type == PregnancyStore.PREGNANCY_HARPY_EGGS)
            {
                ...
                //Large egg scene
                EngineCore.outputText("A sudden shift in the weight of your pregnant belly staggers you, dropping you to your knees.  You realize something is about to be birthed, and you shed your [armor] before it can be ruined by what's coming.  A contraction pushes violently through your midsection, ");
                if (player.vaginas[1].vaginalLooseness < VaginaClass.LOOSENESS_LOOSE)
                {
                    EngineCore.outputText("stretching your tight cunt painfully, the lips opening wide ");
                }
                if (player.vaginas[1].vaginalLooseness >= VaginaClass.LOOSENESS_LOOSE && player.vaginas[1].vaginalLooseness <= VaginaClass.LOOSENESS_GAPING_WIDE)
                {
                    EngineCore.outputText("temporarily stretching your cunt-lips wide-open ");
                }
                if (player.vaginas[1].vaginalLooseness > VaginaClass.LOOSENESS_GAPING_WIDE)
                {
                    EngineCore.outputText("parting your already gaping lips wide ");
                }
                EngineCore.outputText("as something begins sliding down your passage.  A burst of green slime soaks the ground below as the birthing begins in earnest, and the rounded surface of a strangely colored egg peaks between your lips.  You push hard and the large egg pops free at last, making you sigh with relief as it drops into the pool of slime.  The experience definitely turns you on, and you feel your clit growing free of its hood as another big egg starts working its way down your birth canal, rubbing your sensitive vaginal walls pleasurably.   You pant and moan as the contractions stretch you tightly around the next, slowly forcing it out between your nether-lips.  The sound of a gasp startles you as it pops free, until you realize it was your own voice responding to the sudden pressure and pleasure.  Aroused beyond reasonable measure, you begin to masturbate ");
                ...
                if (player.clitLength <= 2)
                {
                    EngineCore.outputText("your " + vaginaDescript(1) + " by pulling your folds wide and playing with your clit.  Another egg pops free from your diminishing belly, accompanied by an audible burst of relief.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself.  ");
                }
                EngineCore.outputText("You cum hard, the big eggs each making your cunt gape wide just before popping free.  You slump down, exhausted and barely conscious from the force of the orgasm.  ");
                if (player.statusEffectv3(StatusEffects.Eggs) >= 11)
                {
            ...
            if (player.pregnancy2Type == PregnancyStore.PREGNANCY_IMP)
            {
                ...
                if (player.vaginas[1].vaginalLooseness == VaginaClass.LOOSENESS_TIGHT)
                {
                ...
                if (player.vaginas[1].vaginalWetness == VaginaClass.WETNESS_DRY)
                {
                    player.vaginas[1].vaginalWetness++;
                }
                player.orgasm();
                player.dynStats("tou", -2, "spe", 2, "lib", 1, "sen", .5, "cor", 7);
                if (player.butt.type < 10 && rand(2) == 0)
            ...
            if (player.pregnancy2Type == PregnancyStore.PREGNANCY_MINERVA)
            {
                if (flags[kFLAGS.MINERVA_CORRUPTION_PROGRESS] >= 10)
                {
                    SceneLib.mountain.minervaScene.minervaCorruption.corruptPlayerBirth(1);
                }
                else
                {
                    SceneLib.mountain.minervaScene.minervaPurification.playerGivesBirth(1);
                }
            ...
            if (player.pregnancy2Type == PregnancyStore.PREGNANCY_OVIELIXIR_EGGS)
            {
                ...
                else
                {
                    ...
                    else if (player.vaginas[1].vaginalLooseness <= VaginaClass.LOOSENESS_GAPING_WIDE)
                    {
                        EngineCore.outputText("temporarily stretching your cunt-lips wide-open ");
                    }
                    else
        ...
        if (player.buttPregnancyIncubation > 1)
        {
            if (player.buttPregnancyType == PregnancyStore.PREGNANCY_FROG_GIRL)
            {
                ...
                //Egg Maturing{
                    ...
                    {
                        EngineCore.outputText("  Splashing against the underside of your [cocks], the slime leaves a warm, oozy sensation that makes you just want to rub [eachCock] over and over and over again.");
                    }
                    //genderless:
                    else
                    {
            ...
            if (player.buttPregnancyType == PregnancyStore.PREGNANCY_BEE_EGGS)
            {
                ...
                if (player.buttPregnancyIncubation == sceneHunter.adjustPregEventTimer(20, player.buttPregnancyType))
                {
                    ...
                    if (player.cockTotal() > 0)
                    {
                        EngineCore.outputText("The aroma seems to permeate your very being, slowly congregating in your ");
                    }
                    if (player.cockTotal() == 1)
                    {
                        ...
                        {
                            EngineCore.outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air, until your [cock] is twitching and dripping, the flare swollen and purple.  ");
                        }
                        if (player.dogCocks() == 1)
                        {
                            EngineCore.outputText(", each inhalation making it thicker, harder, and firmer.  You suck in huge lungfuls of air, desperate for more, until your [cock] is twitching and dripping, its knot swollen to the max.  ");
                        }
                        if (player.normalCocks() == 1)
                        {
                            EngineCore.outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air, until your [cock] is twitching and dripping, the head swollen and purple.  ");
                        }
                        //FAILSAFE FOR NEW COCKS
                        if (player.normalCocks() == 0 && player.dogCocks() == 0 && player.horseCocks() == 0)
                        {
                            EngineCore.outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air until your [cock] is twitching and dripping.  ");
                        }
                    }
                    if (player.cockTotal() > 1)
                    {
                        EngineCore.outputText("groin.  Your [cocks] fill and grow with every lungful of the stuff you breathe in.  You suck in great lungfuls of the tainted air, desperate for more, your cocks twitching and dripping with need.  ");
                    }
        ...
        if (player.buttPregnancyIncubation == sceneHunter.adjustPregEventTimer(1, player.buttPregnancyType))
        {
            ...
            if (player.buttPregnancyType == PregnancyStore.PREGNANCY_BEE_EGGS)
            {
                ...
                if (player.cockTotal() > 0)
                {
                    EngineCore.outputText("The muzzy feeling that fills your head seems to seep downwards, making your equipment hard and tight.  ");
                }
                if (player.vaginas.length > 0)
                {
                    EngineCore.outputText("Your " + vaginaDescript(0) + " becomes engorged and sensitive.  ");
                }
                ...
                {
                    EngineCore.outputText("Seeking even greater sensation, your hands gather the honey and massage it into your " + breastDescript(0) + ", slowly working up to your nipples.  Milk immediately begins pouring out from the attention, flooding your chest with warmth.  ");
                }
                ...
                if (player.cor < 35)
                {
                    EngineCore.outputText("You are disgusted, but glad you were not stung during the ordeal.  You stagger away and find a brook to wash out your mouth with.");
                }
                if (player.cor >= 35 && player.cor < 65)
                {
                    EngineCore.outputText("You are amazed you could lay so many eggs, and while the act was strange there was something definitely arousing about it.");
                }
                if (player.cor >= 65 && player.cor < 90)
                {
                    EngineCore.outputText("You stretch languidly, noting that most of the drugged honey is gone.  Maybe you can find the Bee again and remember to bottle it next time.");
                }
                if (player.cor >= 90)
                {
        ...
        if (player.pregnancyType == PregnancyStore.PREGNANCY_BENOIT && player.pregnancyIncubation <= 2)
        {
            ...
            {
                player.knockUpForce(player.pregnancyType, 3);
            }
            else
            {
                player.knockUpForce();  //Clear Pregnancy  
        ...
        if (player.pregnancy2Type == PregnancyStore.PREGNANCY_BENOIT && player.pregnancy2Incubation <= 2)
        {
            if (model.time.hours != 5 && model.time.hours != 6)
            {
                player.knockUpForce(player.pregnancy2Type, 3, 1);
            }
            else
            {
                player.knockUpForce(0, 0, 1);  //Clear Pregnancy  
            ...
            (player.pregnancy2Type == PregnancyStore.PREGNANCY_HARPY_HATCHING && player.pregnancy2Incubation <= 2))
        {
            ...
            else if (SophieFollowerScene.HarpyEggReady)
            {
                ...
                if (SophieFollowerScene.HarpyKids > 1)
                {
                    outputText(" with your other daughters");
                }
    ...
    public function eggDescript(plural : Bool = true) : String
    {
        var descript : String = "";
        if (player.hasStatusEffect(StatusEffects.Eggs))
        {
            ...
            5 - rubbery black -
            */
            var eggDesc : Array<Dynamic> = ["brown", "purple", "blue", "pink", "white", "rubbery black"];
