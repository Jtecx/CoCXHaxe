...
class UrtaQuest extends NPCAwareContent
{
    /**
 * Urta's Quest
 * @Author:
 */
    ...
    public function infertilityQuestions() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("you have nothing to complain about there.  Your sexual romps with Urta are always a delight.");
        }
        else if (player.cor < 66)
        {
            outputText("she's definitely a handful in the sack, you've got to give her that.");
        }
        else
        {
            outputText("she's a willing fuck, so no complaints there.  Now if she would just get on with it - if you wanted to flirt, you would've instigated it.");
        }
    ...
    public function resetToPC() : Void
    {
        ...
        {
            if (player.statusEffectv1(StatusEffects.UrtaQuestAdjusted) > 0)
            {
                flags[kFLAGS.PRIMARY_DIFFICULTY] = player.statusEffectv1(StatusEffects.UrtaQuestAdjusted);
            }
            if (player.statusEffectv2(StatusEffects.UrtaQuestAdjusted) > 0)
            {
                flags[kFLAGS.SECONDARY_STATS_SCALING] = player.statusEffectv2(StatusEffects.UrtaQuestAdjusted);
            }
            if (player.statusEffectv3(StatusEffects.UrtaQuestAdjusted) > 0)
            {
                flags[kFLAGS.NEW_GAME_PLUS_LEVEL] = player.statusEffectv3(StatusEffects.UrtaQuestAdjusted);
            }
            if (player.statusEffectv4(StatusEffects.UrtaQuestAdjusted) > 0)
            {
                flags[kFLAGS.BOSS_CHAMPION_ELITE_SCALING] = player.statusEffectv4(StatusEffects.UrtaQuestAdjusted);
            }
    ...
    public function startUrtaQuest() : Void
    {
        ...
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.ImprovedSelfControl, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.HalfStepToAdvancedSelfControl, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.AdvancedSelfControl, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.HalfStepToSuperiorSelfControl, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.ResistanceI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.ResistanceII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.ResistanceIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.ResistanceIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.ResistanceV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.ResistanceVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.InhumanDesireI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.InhumanDesireII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.InhumanDesireIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.InhumanDesireIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.InhumanDesireV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.InhumanDesireVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.DemonicDesireI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.DemonicDesireII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.DemonicDesireIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.DemonicDesireIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.DemonicDesireV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.DemonicDesireVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.RefinedBodyI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.RefinedBodyII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.RefinedBodyIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.RefinedBodyIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.RefinedBodyV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.RefinedBodyVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.TankI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.TankII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.TankIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.TankIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.TankV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.TankVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.GoliathI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.GoliathII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.GoliathIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.GoliathIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.GoliathV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.GoliathVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.CheetahI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.CheetahII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.CheetahIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.CheetahIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.CheetahV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.CheetahVI, 0, 0, 0, 0);
        }
        player.createPerk(PerkLib.DancersVitalityI, 0, 0, 0, 0);
        if (player.newGamePlusMod() >= 1)
        {
            player.createPerk(PerkLib.DancersVitalityII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 2)
        {
            player.createPerk(PerkLib.DancersVitalityIII, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 3)
        {
            player.createPerk(PerkLib.DancersVitalityIV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 4)
        {
            player.createPerk(PerkLib.DancersVitalityV, 0, 0, 0, 0);
        }
        if (player.newGamePlusMod() >= 5)
        {
            player.createPerk(PerkLib.DancersVitalityVI, 0, 0, 0, 0);
        }
        ...
        //otherwise used only to swap the players, buttons in recallScenes{
    ...
    private function towerOfTheCovenantII() : Void
    {
        ...
        addButton(0, "Stop4ADrink", getHelBangedAsUrta).disableIf(!flags[kFLAGS.HEL_FUCKBUDDY], "You could visit a bar if [name] knew one salamander a little closer.", "???");
    ...
    private function getHelBangedAsUrta() : Void
    {
        ...
        {
            outputText(", and even how they worked together to bring down an evil sorceress and save her father. Your heart swells with pride as she recounts " + player2.short + " doing so a noble thing, and for a moment you know you made the right pick in a lover..");
        }
    ...
    private function fuckHelAndKitsunesAsUrta() : Void
    {
        ...
        if (player2.hasCock())
        {
            ...
            if (helFollower.followerHel() && !player.hasStatusEffect(StatusEffects.HeliaOff))
            {
                outputText("at home");
            }
            else
            {
                outputText("at my beck and call");
            }
    ...
    private function visitPCPreUrtaQuest(truth : Bool) : Void
    {
        clearOutput();
        ...
        {
            outputText("There are a number of people in the camp, but you avoid them as you head towards " + player2.short + "'s bunk.  ");
        }
        ...
        {
            outputText(", no matter why " + player2.mf("he", "she") + " was sent here");
        }
        ...
        if (truth)
        {
            ...
            if (player2.cor < 33)
            {
                outputText(player2.mf("he", "she") + " argues that " + player2.mf("he", "she") + " should come anyway.  You tell " + player2.mf("him", "her") + " no, firmly, even though it breaks your heart.");
            }
            else if (player2.cor < 66)
            {
                outputText(player2.mf("he", "she") + " nods understandingly, not surprised that you have to handle this quest alone.  The two of you are alike in that way - each with their own burden to bear.");
            }
            else
            {
                outputText(player2.mf("he", "she") + " nods dismissively, trusting you to handle it alone you suppose.  " + player2.short + " always was hard like that, even though " + player2.mf("he", "she") + " clearly likes you.");
            }
            ...
            if (flags[kFLAGS.SLEEP_WITH] != "" && flags[kFLAGS.SLEEP_WITH] != 0)
            {
                outputText("  " + player2.short + " suggests the two of you move off, so as not to wake " + flags[kFLAGS.SLEEP_WITH] + " in the night.");
            }
        }
        //{LIE}
        else
        ...
        addButton(1, "Fuck" + player2.mf("His", "Her") + "Vag", putUrtasWangInPCsCunt, truth).disableIf(!player2.hasVagina(), "[name2] would need a vagina for this!");
        //Put a PC dick in Urta's vag(C)*
        addButton(2, "Ride Dick", putAPCDickInUrtaCoochies, truth).disableIf(player2.cockThatFits(urta.urtaCapacity()) < 0, "[name2] would need a cock fitting " + urta.urtaCapacity() + " area for this!");
        //Put Urta dick in the PC's asshole [Cocked PCs](C)*
        addButton(3, "Fuck Ass", urtaPutsHerDickInPCsWithDicks, truth).disableIf(!player2.hasCock(), "[name2] would need a cock for this!");
        //PC blows Urta(C)*
    ...
    //Put Urta dick in the PC's asshole [Cocked PCs](C)*
    private function urtaPutsHerDickInPCsWithDicks(truth : Bool) : Void
    {
        clearOutput();
        ...
        if (player2.tallness < 60)
        {
            outputText(" and let your tits hang over " + player2.mf("his", "her") + " " + player2.face());
        }
        else if (player2.tallness < 76)
        {
            outputText(" and let your tits swing between you");
        }
        else if (player2.tallness < 84)
        {
            outputText(" and let your tits smash into " + player2.mf("his", "her"));
        }
        else
        {
            outputText(" and let your tits sway over " + player2.mf("his", "her") + " belly");
        }
        ...
        {
            outputText(", past " + player2.mf("his", "her") + " pussy,");
        }
        ...
        if (player2.analCapacity() > 70)
        {
            outputText("  Thankfully, " + player2.mf("he", "she") + "'s nice and stretched from all the butt-fucking " + player2.mf("he", "she") + "'s had to take, and you easily pop inside.  It feels so good that your flare grows wider, pulling you deeper into that welcoming, tight anal heat.");
        }
        else if (player2.analCapacity() > 50)
        {
            outputText("  Thankfully, " + player2.mf("he", "she") + "'s got plenty of give in " + player2.mf("his", "her") + " back-door, and you pop inside after applying a little more pressure.  It feels so good that your flare grows wider, slowing your descent into that tight, anal heat.");
        }
        else
        {
            outputText("  Unfortunately, there's not much give in " + player2.mf("his", "her") + " back-door, and you have to sit there smearing pre over it, again and again, each time pushing a little harder.  After what feels like the fiftieth try, you finally pop your fat flare into " + player2.mf("his", "her") + " rectum, the tight anal heat causing you to flare from the force of " + player2.mf("his", "her") + " pressure.  Slowly, you push inch after throbbing inch of your swollen, stallion-like erection into " + player2.mf("his", "her") + " asshole.");
        }
        ...
        if (player2.hasVagina())
        {
            outputText("  You don't notice the female fluids that drip from " + player2.mf("his", "her") + " sodden slit - they soak into your big balls, already forgotten.");
        }
        ...
        if (player2.cumQ() >= 500)
        {
            ...
            if (player2.cumQ() < 1000)
            {
                outputText("puddly");
            }
            else if (player2.cumQ() < 2500)
            {
                outputText("small lake-sized");
            }
            else
            {
                outputText("massive, lake-sized");
            }
    ...
    //PC blows Urta(C)*
    private function pcBlowsUrtasDong(truth : Bool) : Void
    {
        clearOutput();
    ...
    //Put a PC dick in Urta's vag(C)*
    private function putAPCDickInUrtaCoochies(truth : Bool) : Void
    {
        clearOutput();
        ...
        if (player2.hasVagina())
        {
            outputText(", " + player2.mf("his", "her") + " cunt dripping wetly onto the ground from the stimulus");
        }
        ...
        if (player2.isTaur() || player2.isDrider())
        {
            ...
            if (!player2.isDrider())
            {
                outputText("quadrapedal");
            }
            else
            {
                outputText("octapedal");
            }
            ...
            if (player2.hasVagina())
            {
                outputText(", " + player2.mf("his", "her") + " female jizz spattering unnoticed onto the ground behind the pair of you");
            }
            outputText(".");
            ...
            if (player2.cumQ() < 1000)
            {
                outputText("falling face-first into the jizz-mud");
            }
            else
            {
                outputText("not even bothering trying to move your swollen bulk");
            }
        ...
        else
        {
            ...
            if (player2.hasVagina())
            {
                outputText(", " + player2.mf("his", "her") + " female jizz spattering unnoticed onto the ground beneath the pair of you");
            }
            outputText(".");
            //(PC Cum=Normal or lower:
            if (player2.cumQ() < 500)
            ...
            if (player2.cumQ() >= 1000)
            {
                outputText(" not to mention the weight of your overstuffed belly");
            }
    ...
    private function putUrtasWangInPCsCunt(truth : Bool) : Void
    {
        clearOutput();
        ...
        if (player2.pregnancyIncubation > 0 && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.buttPregnancyType))
        {
            outputText("the curve of " + player2.mf("his", "her") + " pregnant belly");
        }
        else if (player2.tone >= 65)
        {
            outputText("" + player2.mf("his", "her") + " toned abdomen");
        }
        else if (player2.tone < 30)
        {
            outputText("" + player2.mf("his", "her") + " soft, forgiving middle");
        }
        else
        {
            outputText("" + player2.mf("his", "her") + " belly");
        }
        ...
        if (player2.isTaur())
        {
            ...
            if (player2.tailType > Tail.NONE)
            {
                outputText("  You stroke " + player2.mf("his", "her") + " tail as you shift it aside");
            }
            else
            {
                outputText("  You stroke " + player2.mf("his", "her") + " swollen sex as you admire it");
            }
            ...
            if (player2.wetness() >= 4)
            {
                outputText("  Fuck, " + player2.mf("he", "she") + "'s wetter than Edryn!  Just look at those heavy trails of slick moisture as they run down " + player2.mf("his", "her") + " rump and hindlegs.");
            }
            else if (player2.wetness() >= 2)
            {
                outputText("  Fuck, " + player2.mf("he", "she") + "'s as wet as Edryn!  Beads of moisture are forming on " + player2.mf("his", "her") + " clit, ready to drop to the ground.");
            }
            else
            {
                outputText("  Fuck, " + player2.mf("he", "she") + "'s almost as wet as Edryn!  Just getting a sniff of " + player2.mf("his", "her") + " horny horse-snatch has your head swimming!");
            }
            outputText("  You give it a lick and shudder, taking in a few deep lungfuls of " + player2.mf("his", "her") + " scent.");
            if (player2.tallness >= 84)
            {
                outputText("  Before you know what you're doing, you've pulled " + player2.mf("his", "her") + " back to a rock and climbed atop it, bringing your cock level with that heavenly hole.");
            }
            else
            {
                outputText("  Before you know what you're doing, you've raised yourself up to your full height, bringing your cock level with that heavenly hole.");
            }
        }
        //{goo}
        else if (player2.isGoo())
        {
            ...
            if (player2.clitLength < .5)
            {
                outputText("tiny ");
            }
            else if (player2.clitLength >= 2.5)
            {
                outputText("massive ");
            }
        ...
        else if (player2.isNaga())
        {
            ...
            if (player2.wetness() >= 3)
            {
                outputText("  " + player2.mf("His", "Her") + " moisture drizzles from that wanton slit, basting you with " + player2.mf("his", "her") + " fragrant femininity, and you have a hard time not taking " + player2.mf("him", "her") + " here and now.");
            }
        ...
        else
        {
            ...
            if (player2.wetness() < 3)
            {
                outputText("every drop of nectar that " + player2.mf("he", "she") + " gives up");
            }
            else if (player2.wetness() < 4)
            {
                outputText("the copious drops of nectar " + player2.mf("he", "she") + " gives up");
            }
            else if (player2.wetness() < 5)
            {
                outputText("the drizzling moisture that oozes from " + player2.mf("his", "her") + " twat");
            }
            else
            {
                outputText("the rivers of girl-lube that run unimpeded from " + player2.mf("his", "her") + " sopping twat");
            }
        ...
        if (player2.vaginalCapacity() >= 200)
        {
            outputText(", though you know " + player2.mf("he", "she") + " can handle cocks with Edryn's ease");
        }
        ...
        if (player2.pregnancyIncubation > 0 && player2.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.buttPregnancyType))
        {
            outputText(" (more than it already is)");
        }
        ...
        if (player2.hasCock())
        {
            ...
            if (player2.cumQ() < 50)
            {
                outputText("Ropes of seed shoot from " + player2.mf("his", "her") + " prick.  After a few shots of cum, " + player2.mf("his", "her") + " cock stops leaking at once.");
            }
            else if (player2.cumQ() < 250)
            {
                outputText("Thick ropes of seed shoot from " + player2.mf("his", "her") + " prick.  " + player2.mf("He", "She") + " definitely made a bit of mess. ");
            }
            else if (player2.cumQ() < 1000)
            {
                outputText("Thick ropes of seed shoot from " + player2.mf("his", "her") + " prick.  This continues for a while and eventually, " + player2.mf("he", "she") + " stops after " + player2.mf("he", "she") + " made a large puddle of cum.");
            }
            else if (player2.cumQ() < 2500)
            {
                outputText("Torrents of cum blast from " + player2.mf("his", "her") + " prick.  This continues for a while and eventually, " + player2.mf("he", "she") + " stops after " + player2.mf("he", "she") + " made a large puddle of cum.");
            }
            else
            {
                outputText("Torrents of cum blast from " + player2.mf("his", "her") + " prick.  This continues for a few minutes and eventually, " + player2.mf("he", "she") + " stops after " + player2.mf("he", "she") + " made a huge puddle of cum.");
            }
        }
    ...
    //Snuggle(C)*
    private function snuggleWithUrta(truth : Bool) : Void
    {
        clearOutput();
        ...
        if (player2.isTaur() || player2.isDrider())
        {
            ...
            if (player2.isTaur())
            {
                outputText("forehoofs");
            }
            else
            {
                outputText("first two pairs of spidery limbs");
            }
            outputText(".");
        }
        //[if PC Naga:]
        ...
        {
            outputText("  " + player2.mf("His", "Her") + " serpentine coils loop snugly around your waist, curling around your legs and holding you gently in place.");
        }
        //[if PC Goo:
        else if (player.isGoo())
        {
            outputText("  " + player2.mf("His", "Her") + " soft, squishy goo-body eagerly accepts you, the gelatinous mass of " + player2.mf("his", "her") + " lower torso reaching out to softly envelop you in its cool, wet embrace.");
        }
        //[Else:
        else
        {
            outputText("  Knees to knees, it takes you a few moments to figure out how to properly position your legs, but you eventually manage it.");
        }
        ...
        if (player2.cor < 33)
        {
            outputText("playful pat");
        }
        else if (player2.cor < 66)
        {
            outputText("gentle stroke");
        }
        else
        {
            outputText("lascivious caress");
        }
    ...
    //Embark(C)*
    private function morningAfterCampVisitEmbark(truth : Bool) : Void
    {
        clearOutput();
        if (!recalling)
        {
    ...
    //Goblin Encounter(C)*
    //Intro(C)*
    public function runIntoAGoblin(camped : Bool = false) : Void
    {
        clearOutput();
        if (camped)
        {
    ...
    public function winFuckAGoblinBroodmotherAsUrta() : Void
    {
        ...
        {
            outputText("feverishly masturbating");
        }
    ...
    private function urtaComboAttack() : Void
    {
        ...
        if (!player.hasStatusEffect(StatusEffects.Attacks))
        {
            player.createStatusEffect(StatusEffects.Attacks, 4, 0, 0, 0);
        }
        else
        {
        ...
        if (!monster.hasStatusEffect(StatusEffects.Blind) && (rand(3) == 0 || (player.hasStatusEffect(StatusEffects.Blind) && rand(2) == 0) || (monster.getEvasionRoll(false, player.spe))))
        {
            ...
            {
                outputText(monster.capitalA + monster.short + " narrowly avoids your attack!");
            }
            if (monster.spe - player.spe >= 8 && monster.spe - player.spe < 20)
            {
                outputText(monster.capitalA + monster.short + " dodges your attack with superior quickness!");
            }
            if (monster.spe - player.spe >= 20)
            {
                outputText(monster.capitalA + monster.short + " deftly avoids your slow attack.");
            }
            outputText("\n");
            if (player.hasStatusEffect(StatusEffects.Attacks))
            {
        ...
        //Basic damage stuff
        var damage : Float = player.str;
        damage += combat.scalingBonusStrength();
        damage *= 1.5;
        //Weapon addition!
        if (player.weaponAttack < 51)
        {
            damage *= (1 + (player.weaponAttack * 0.05));
        }
        else
        {
            damage *= (3.5 + ((player.weaponAttack - 50) * 0.04));
        }
    ...
    private function urtaDirtKick() : Void
    {
        ...
        {
            outputText("Spinning about, you drag your footpaw through the dirt, kicking a wave of debris towards [themonster]!  ");
        }
        //Dodged!
    ...
    private function urtaSidewinder() : Void
    {
        ...
        {
            outputText("You make a wide swing to the side, hoping to stun your foe!  ");
        }
        //Determine if dodged!
    ...
    private function urtaVaultAttack() : Void
    {
        ...
        {
            outputText("You leap into the air, intent on slamming your [weapon] into your foe!  ");
        }
        //Determine if dodged!
        if ((player.hasStatusEffect(StatusEffects.Blind) && rand(2) == 0) || (monster.getEvasionRoll(false, player.spe)))
        {
    ...
    public function urtaLosesToSirriusSnakeRadio() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("You cry out in pain as the bruises and buffets you've taken overwhelm you.  You struggle to stay upright, but to no avail; your injured body has reached its limits and you collapse, helpless and at the mercy of your assailant.");
        }
        //Loss by Lust:
        else
        {
            outputText("With a hollow moan of anguish, you cast aside your halberd and fall to your knees, tears stinging your eyes as you desperately jerk and maul at your huge horse-prick.  The cursed thing has betrayed you again, and now you're too addled by lust and need to defend yourself from whatever this naga has in store for you.");
        }
    ...
    public function winRapeHyenaPrincess() : Void
    {
        ...
        if (monster.HP <= monster.minHP())
        {
            outputText(".  In spite of her wounded state, she seems to be quite excited by the situation");
        }
        outputText(".");
    ...
    public function useSuccubiMilkOnGnollPrincesses() : Void
    {
        ...
        if (flags[kFLAGS.URTA_FUCKED_HEL] == 1)
        {
            outputText("that salamander slut's cunt");
        }
        else
        {
            outputText("a mino-cum addicted whore's sodden cunt");
        }
    ...
    private function loseToGnollAsUrtaEpilogue() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("Ouch... what happened to you?  You blink a few times, ignoring the buzzing throb of pain that rises up like a dormant monster in the back of your head.");
        }
        //[Lust]
        else
        {
            outputText("Oh, gods... what happened to you?  You blink a few times, ignoring the gentle throb coming from your well-used member.");
        }
        ...
        if (player.HP < 1)
        {
            outputText("I hope I wasn't too rough on you");
        }
        else
        {
            outputText("I hope you enjoyed the journey here");
        }
        outputText(".</i>\"");
        ...
        if (player.HP >= 1)
        {
            outputText("You shudder at the memory of your meeting, leaking a little more lubricant.  ");
        }
    ...
    public function urtaSubmitsToMinotaurBadEnd() : Void
    {
        ...
        {
            outputText("   Seeing the fire in your eyes change from a determined glare to a lusty look, the minotaur pulls you over, carefully unwinding the chain from around you, so as not to damage you.");
        }
    ...
    public function urtaLosesToMinotaurRoughVersion() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("battered and bruised");
        }
        else
        {
            outputText("weak from lust");
        }
        outputText(" to continue fighting.  The hulking bull-man snorts as he approaches you, ");
        if (monster.lust < 70)
        {
            outputText("barely deigning to give your far smaller cock a contemptuous look, ");
        }
    ...
    public function milkyUrtaTic() : Void
    {
        ...
        if (player.lust < 50)
        {
            outputText("Thankfully it hasn't become too distracting yet.");
        }
        else if (player.lust < 75)
        {
            outputText("You don't know how much longer you'll be able to withstand the effects of the milk.");
        }
        else
        {
            outputText("Those orbs full of milky goodness are starting to look more attractive by the minute... if you don't finish this quickly you might end up giving up!");
        }
        outputText("\n\n");
        player.addStatusValue(StatusEffects.MilkyUrta, 1, -1);
        if (player.statusEffectv1(StatusEffects.MilkyUrta) <= 0)
        {
            player.removeStatusEffect(StatusEffects.MilkyUrta);
        }
        dynStats("lus", 10, "scale", false);
    }
    ...
    public function urtaLosesToCowCubi() : Void
    {
        ...
        {
            outputText(" and healing your wounds");
        }
    ...
    public function urtaArrivesAtCampForFukks() : Void
    {
        ...
        if (player.gender == 0)
        {
            outputText("seeing as how you can't make babies");
        }
        else
        {
            outputText("if you'd rather not");
        }
        ...
        if (player.gender > 0)
        {
            outputText(" fuck the horny fox and help her out of her predicament, or");
        }
        outputText(" send her to Tel'Adre to find a suitable partner, like Edryn?");
        if (player.hasCock() && !urta.cockFits())
        {
            outputText("  A shame you're too big to fit inside her.");
        }
        //Genderless PCs auto-select the Edryn option, KnockUrta requires PC has penis, KnockMe requires PC has vagina
        menu();
        addButton(0, "KnockUrta", knockUpUrtaWithGodChild).disableIf(!urta.cockFits(), urta.nofitMsg);
        if (player.hasVagina())
        {
            addButton(1, "KnockMe", getKnockedUpWithGodChild).disableIf(!player.hasVagina(), "Req. a vagina!");
        }
    ...
    private function knockUpUrtaWithGodChild() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText(", the mess made worse by your multiple-cocked virility.  There's so much that the clear juices roll off you to either side, puddling in your blankets below");
        }
        ...
        {
            outputText(", shooting tingling excitement through your nubs as you grind against each other");
        }
        ...
        if (player.cumQ() > 1000)
        {
            outputText(", belly rounded with wobbly, womb-packing spunk");
        }
        outputText(".");
    ...
    private function postFuckUrtaUp() : Void
    {
        ...
        if (flags[kFLAGS.FACTORY_SHUTDOWN] > 0)
        {
            outputText(" - besides, given you know that you're nothing but a sacrifice the demons are too lazy to collect, it's not like they'll really send an invasion through");
        }
        ...
        if (camp.followersCount() >= 2)
        {
            outputText("leave instructions to your fellow camp-dwellers to look after the place, ");
        }
    ...
    private function preggedUrtaWithGodChildEpilogue() : Void
    {
        ...
        if (player.cor > 66)
        {
            outputText(", what do you care, anyway?");
        }
        else
        {
            outputText(".");
    ...
    private function getKnockedUpWithGodChild() : Void
    {
        ...
        if (player.isPregnant() && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.pregnancyType))
        {
            outputText(" already filled");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" and lifting your balls");
        }
        ...
        if (player.pregnancyIncubation > 0 && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.buttPregnancyType))
        {
            outputText("rounded ");
        }
        ...
        {
            outputText("soft curve");
        }
        else
        {
            outputText("flat muscles");
        }
        outputText(" until she hits your [nipple].  ");
        if (player.hasFuckableNipples())
        {
            outputText("Her tongue plunges inside, savoring the feminine lubricants");
        }
        else
        {
            outputText("Her tongue plays across the surface, the heat of her breath shooting tingles up your spine");
        }
        ...
        {
            outputText(", the slippery wetness of your [vagina] and the sheer hardness of your [clit] overwhelming.");
        }
        ...
        var ballWorship : Array<Dynamic> = [];
        if ((amilyScene.amilyFollower() && flags[kFLAGS.AMILY_FOLLOWER] == 2) && jojoScene.campCorruptJojo())
        {
            ballWorship[ballWorship.length] = 0;
        }
        if (xor(amilyScene.amilyFollower() && flags[kFLAGS.AMILY_FOLLOWER] == 2, jojoScene.campCorruptJojo()))
        {
            ballWorship[ballWorship.length] = 1;
        }
        if (sophieBimbo.bimboSophie() && !player.hasStatusEffect(StatusEffects.SophieOff))
        {
        ...
        {
            choice = ballWorship[rand(ballWorship.length)];
        }
        else
        {
            choice = -1;
        ...
        //{Both mouse pets}
        if (choice == 0 || sceneHunter.other && Lambda.indexOf(ballWorship, 0) != -1)
        {
        ...
        //{If Jojo/Amily pet}
        if (choice == 1 || sceneHunter.other && Lambda.indexOf(ballWorship, 1) != -1)
        {
        ...
        if (choice == 2 || sceneHunter.other && Lambda.indexOf(ballWorship, 2) != -1)
        {
        ...
        if (choice == 3 || sceneHunter.other && Lambda.indexOf(ballWorship, 3) != -1)
        {
            ...
            if (player.hasBalls())
            {
                outputText("  She does the same to your own [balls], even giving your [asshole] a happy, sloppy kiss before returning to polishing the supple, skin-shrouded spheres just ahead.");
            }
        ...
        //{Latexy}
        if (choice == 4 || sceneHunter.other && Lambda.indexOf(ballWorship, 4) != -1)
        {
        ...
        //{Valeria}
        if (choice == 5 || sceneHunter.other && Lambda.indexOf(ballWorship, 5) != -1)
        {
        ...
        {
            outputText(", though getting your tail angled right to allow her entrance is a bit of a challenge");
        }
        else if (player.isTaur())
        {
            outputText(", though getting down on your hands and forelegs is a bit challenging for you");
        }
        else
        {
            outputText(", [face] buried in your blankets soaked with Urta's musky fluid");
        }
        outputText(".");
        ...
        if (player.wetness() >= 5)
        {
            outputText("Lady-spunk showers out of your spasming twat, glazing Urta's bouncy ballsack with your lusty liquid.");
        }
        else if (player.wetness() >= 3)
        {
            outputText("Lady-spunk drools out of your spasming twat in thick streams, glazing Urta's bouncy ballsack with your liquid lust.");
        }
        else if (player.wetness() >= 1)
        {
            outputText("Lady-spunk drips from your spasming twat in steady trickles, glazing Urta's bouncy ballsack with your liquid lust.");
        }
    ...
    private function getKnockedUpUrtaEpilogue() : Void
    {
        ...
        if (player.pregnancyIncubation > 0 && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.buttPregnancyType))
        {
            outputText("much more ");
        }
        outputText("pregnant ");
        if (player.pregnancyIncubation > 0 && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.buttPregnancyType))
        {
            outputText("than before");
        }
        else
        {
            outputText("- very pregnant");
        }
    ...
    private function getKnockedUpByUrtaEpilogueII() : Void
    {
        ...
        if (player.pregnancyIncubation > 0 && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.buttPregnancyType))
        {
            outputText("  Somehow, you're still just as pregnant with something as you were before.");
        }
    ...
    private function urtaAndEdrynGodChild() : Void
    {
        ...
        {
            doNext(urtaAndEdrynGodChildEpilogue);
        }
    }
    ...
    private function urtaAndEdrynGodChildEpilogueII() : Void
    {
        ...
        {
            outputText("  Just how did she get pregnant again when she was already knocked up?  ...Magic, maybe.");
        }
        ...
        if (SceneLib.telAdre.edryn.pregnancy.isPregnant)
        {
            outputText("  The centaur guardswoman is still just as pregnant with your offspring as before.  Your child is unharmed by whatever just transpired.");
        }
