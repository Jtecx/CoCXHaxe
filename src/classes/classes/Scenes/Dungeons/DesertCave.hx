...
class DesertCave extends DungeonAbstractContent
{
    public function new()
    {
        super();
    ...
    public function openZeDoorToParadize() : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.SAS))
        {
    ...
    private function checkPharmacyDoorUnlocked() : Bool
    {
    ...
    private function checkExit() : Bool
    {
    ...
    public function loseToSammitchMob() : Void
    {
        ...
        else if (player.hasCock() && player.biggestCockArea() >= 6)
        {
    ...
    public function getMockedForSmallDongBySammitchMob() : Void
    {
        ...
        if (player.cumQ() < 250)
        {
            outputText("  A little squirt of spooge dirties the witch's two fingers, creating a small web of spunk between them.  \"<i>Heh, knew it</i>\" the witch smugly says, giving you a pathetic look.");
        }
        else if (player.cumQ() < 500)
        {
            outputText("  Spurts of sweet release shoot from your [cock smallest], glopping the bitch-witch's hand.  \"<i>Nothing too impressive</i>\" she snidely remarks as she rubs your spunk off on the dirt floor.");
        }
        else
        {
            outputText("  Your [cock smallest] shoots out a barrage of cum onto the bitch's face, caking her disbelieving features into a thick layer of slimy goop as her fellow sisters laugh, pointing at her spunk-covered face.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] didn't have enough time to make another full batch.");
        }
        ...
        {
            outputText("  She even cups your [balls] but moves to touch your [vagina] when she feels its wetness dripping off the testes.");
        }
        else if (player.hasBalls())
        {
            outputText("  She even cups your tender [balls] and lightly massages them.");
        }
        else if (player.hasVagina())
        {
            outputText("  She even lightly caresses the lips of your pussy.");
        }
    ...
    public function femaleGirlsLoseToSammitches() : Void
    {
        ...
        if (player.hasMuzzle())
        {
            outputText("  She fucks your muzzle like a cock as it goes into one cunt while she plays with the other one.");
        }
        else
        {
            outputText("  She grinds her dampening pussies against your lips while her clits are pressed up against your nose.");
        }
        ...
        if (!player.hasMuzzle())
        {
            outputText("grinding on your face");
        }
        else
        {
            outputText("fucking your muzzle while she plays with herself");
        }
        ...
        if (flags[kFLAGS.SAND_WITCHES_FRIENDLY] > 0)
        {
            addButton(0, "Next", sandWitchMobNotBadEnd);
        }
        else
        {
            addButton(0, "Next", sandWitchMobBadEnd);
        }
    }
    ...
    public function memeberedFolksFindTrueWuv() : Void
    {
        ...
        if (player.HP < 1)
        {
            ...
            {
                outputText(", fondled, and fucked");
            }
            else
            {
                outputText(" and fondled");
            }
            outputText(".");
            if (player.hasVagina())
            {
                outputText("  Your [vagina] even gets in on the action, converting your undergarments into a swampy mess of female pheromones and dripping lubricant.");
            }
        }
        //Lust
        else
        ...
        {
            outputText(" while another grabs your other one");
        }
        else if (player.cockTotal() > 2)
        {
            outputText(" while others latch onto the rest");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" while your [balls] start to work, clenching and relaxing as they brew a thick load of fuckbatter thanks to the chemical jump-start.");
        }
        else
        {
            outputText(" while your body starts to work, clenching and relaxing as it rushes to brew a thick load of fuckbatter thanks to the chemical jump-start.");
        }
    ...
    public function memeberedFolksFindTrueWuv2() : Void
    {
        ...
        if (player.cockTotal() == 1)
        {
            outputText("fighting over your cock");
        }
        else
        {
            outputText("milking your cocks");
        }
    ...
    public function yoYouBeatUpSomeSandWitchesYOUMONSTER() : Void
    {
        ...
        {
            outputText("nursing their wounds");
        }
        else
        {
            outputText("frantically making out with each other, huddling into a squirming orgy on the floor");
        }
        ...
        {
            outputText("You're not aroused enough to rape them.");
        }
    ...
    public function dicksHaveSexWithAWitch() : Void
    {
        ...
        {
            outputText("masturbating companions");
        }
        else
        {
            outputText("groaning companions");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("  Judging by the omnipresent flush on her cheeks and the scent of female honey inundating the air, she's more than ready to help you with your problem.");
        }
        else
        {
            outputText("  Her cheekbones slowly color at the thought, turning almost entirely beet-red.  At the same time, her nipples seem to tighten beneath her robes, signalling her body's acceptance of your intent.");
        }
        ...
        {
            outputText("through her buttcheeks");
        }
        else
        {
            outputText("along her arched spine");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("well-soaked");
        }
        else
        {
            outputText("rapidly-moistening");
        }
        ...
        function fitF() : Void
        {
            ...
            if (y >= 0)
            {
                outputText(" and your " + cockDescript(y) + " aimed at her other one");
            }
            ...
            if (y < 0)
            {
                outputText("pussy clings tight to you");
            }
            else
            {
                outputText("pussies cling tightly to you");
            }
            ...
            if (player.cumQ() >= 400)
            {
                ...
                if (player.cumQ() < 2000)
                {
                    outputText("  You do manage to gift her with a nice little cum-paunch for her efforts, though.");
                }
                else
                {
                    outputText("  You're cumming so fast that that venting doesn't help her much.  Slowly, her belly begins to bulge outward.  It stretches and wobbles as it fills with spunk, not stopping until she looks months pregnant.  The liquid way that it jiggles with every movement will reveal the contents of her middle to any who dares look at her.");
                }
            }
            outputText("\n\nSetting her down in front of her sisters, you let her slide off your ");
            if (y >= 0)
            {
                outputText("twin cocks");
            }
            else
            {
                outputText(cockDescript(x));
        ...
        var nofitF : Void->Void = function() : Void
        {
            ...
            if (player.cumQ() >= 500)
            {
                outputText("struggling to swallow it");
            }
            else
            {
                outputText("swallowing it");
            }
            ...
            if (player.cumQ() < 250)
            {
                outputText("The cute woman swallows every single drop.  She even gives up a satisfied moan when she finishes.");
            }
            else if (player.cumQ() < 1000)
            {
                outputText("The cute woman's cheeks balloon as she tries to contain it all.  She swallows admirably in spite of your heavy jizz-flow, only losing a few white trickles out the corners of her stretched mouth.");
            }
            else
            {
                outputText("The cute woman's cheeks flood with your obscene cum-flow.  She tries to swallow it down, but no matter how fast her fevered gulps are, the stuff still floods in with such force that it squirts from the corners of her mouth.  She just gives up after a few moments and lets it run down her chin in a waterfall.  Most of the jism puddles on the floor below her, soaking into her ponytail and matting it with salty spunk.");
            }
    ...
    public function forceCunnilingusRimjobClitAndNipple() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText(" through their torn-up robes, noting many large, dripping breasts and more than a few pairs of supple cunt-lips");
        }
        else
        {
            outputText(" through their squirming, orgiastic motions, noting their many large, dripping breasts and gushing multi-cunts");
        }
        outputText(".  They may ");
        if (player.cor < 33)
        {
            outputText("be misguided in fighting you");
        }
        else if (player.cor < 66)
        {
            outputText("be a little over-zealous in defending their home");
        }
        else
        {
            outputText("be crappy fighters");
        }
        ...
        if (player.wetness() >= 4)
        {
            outputText(", spraying your musky girl-goo across the pretty faces at your groin, soaking them all the way to their first rows of tits.  Your juices mix with the milk dripping from their nipples into a sticky alabaster treat that makes you lick your lips and shudder in delight. The seductress on your [vagina] gurgles and sighs as she tries to keep up with your copious lady-spunk, but the way you squirt, she seems doomed to failure.");
        }
        else if (player.wetness() >= 2)
        {
            outputText(", sluicing secretions down the lips of your would-be pussy-slave, forcing her to work her throat in order to try and keep up with it.  You're so goddamned wet, and the way your channel is clenching and undulating around her tongue just forces out more of your juice.");
        }
        else
        {
            outputText(", dribbling your slippery girl-cum straight into your would-be pussy-slave, forcing her to swallow your tangy flavor.  It's hard not to turn into a dripping mess with the way her tongue works your spasming pussy, but neither of you seems to mind.");
        }
        if (player.hasCock())
        {
            ...
            if (player.cumQ() >= 500)
            {
                ...
                if (player.cumQ() >= 1500)
                {
                    outputText(", each of which begins pooling into a puddle");
                }
                if (player.cumQ() >= 2500)
                {
                    outputText(".  Those puddles combine to form a lake of jism beneath these lusty slaves bodies, putting their combined milky tits to shame");
                }
                outputText(".");
            }
        }
        ...
        {
            outputText(" drink their fill");
        }
        if (player.lactationQ() >= 1000)
        {
            outputText(", or at least as much as they can handle of your lactic capacity,");
        }
        else if (player.lactationQ() < 200)
        {
            outputText(" slowly suckle you");
        }
    ...
    public function turnIntoASammitch(volunteered : Bool = false) : Void
    {
        clearOutput();
        ...
        if (!volunteered)
        {
            ...
            if (player.lust >= player.maxOverLust())
            {
                if (player.hasVagina())
                {
                    outputText("dig your hands into your loins, frigging your hungry cunt so hard your juices splatter the Witch's robe.");
                }
                else
                {
                    outputText("dig your finger into your [asshole], frigging it like your life depended on it.");
                }
            }
            else
            {
                outputText("try to rise, but all you manage to do is slip back down to the ground.");
            }
        ...
        {
            outputText("let's go ahead and get your first daughter inside you, shall we?");
        }
        else
        {
            outputText("let's go ahead and have some fun, shall we?  We'll have to wait until you pop out whatever's in your womb before I give you your first witch child.");
        }
        ...
        if (monster.lust < 65)
        {
            outputText(" herself to full hardness, smiling when thick strings of cum begin to drizzle from her swollen cock-tip.");
        }
        else if (monster.lust < 85)
        {
            outputText(" herself until cum begins to drizzle from her swollen cock-tip.");
        }
        else
        {
            outputText(" herself, gathering up the constantly-dripping cum and smearing it all over her shaft.");
        }
        ...
        if (player.lust >= player.maxOverLust())
        {
            outputText(", even though your hand is knuckle-deep in your twat");
        }
        outputText(".");
        ...
        if (player.bRows() < 2)
        {
            outputText("get four big, milky tits");
        }
        else if (player.lactationQ() < 200)
        {
            outputText("have your tits made into perfect milkers");
        }
        else
        {
            outputText("get your four, big tits milked");
        }
        ...
        {
            outputText("  It seems you've somehow managed to forget that you're already pregnant, and the Cum Witch doesn't seem keen to remind you.");
        }
        ...
        if (player.hasCock())
        {
            outputText("  [EachCock] throbs beneath you, hard as rock and crushed between your belly and the slippery-smooth wood.  It seems unimportant compared to what's going on above it.");
        }
    ...
    public function cumWitchCumPumpBadEnd(volunteered : Bool = false) : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_cumWitch);
        if (!volunteered)
        {
            ...
            if (player.HP < 1)
            {
                outputText("your wounds");
            }
            else
            {
                outputText("by the lust coursing through your veins");
            }
            outputText(", you slump over against a desk, leaning heavily on it for support while ");
            if (player.HP < 1)
            {
                outputText("you struggle to rise");
            }
            else
            {
                outputText("you struggle to get your crotch");
            }
            outputText(".");
        }
        else
        ...
        if (player.cumQ() > 1000)
        {
            if (player.hasBalls())
            {
                outputText(" and such virile, cum-swollen testes.  An excellent breeder for sure!");
            }
            else
            {
                outputText(" and such a virile body!  An excellent breeder for sure!");
            }
        }
        else
        {
            outputText("but with such a pathetic virility.");
        }
        ...
        if (player.HP < 1)
        {
            outputText("grunt and strain in response, still trying to fight, even though you know it's hopeless.");
        }
        else
        {
            outputText("groan and touch yourself, trying to show her just how 'in the mood' you are.");
        }
    ...
    public function beACumPumpPartII() : Void
    {
        ...
        if (player.balls == 0)
        {
            outputText("Wait a moment, you don't - didn't - have balls! Turning your accusing stare towards the busty witch, you watch in wonder as the newly grown sack slowly turns taut, stretched by the burgeoning size of your cum-stuffed spunk-factories.  She pats your newly-stuffed nutsack and remarks, \"<i>I had to make sure you were suitably virile...  Besides, I needed to make sure you'd only sire daughters for us.  We don't need that many like you, my loyal " + player.mf("stud", "cum donor") + ".</i>\"");
        }
        else if (player.cumQ() < 3000)
        {
            outputText("The cum witch gives them a gentle shake, smiling as they grow and swell, burgeoning with full, ripe seed.  She remarks, \"<i>Nothing like the virility of a bull and enough seed to father an army of females to make a useless intruder a contributing member of society, eh breeder?</i>\"");
        }
        else
        {
            outputText("The cum witch gives them a gentle pat and remarks, \"<i>No sense messing with perfection... at least not beyond necessary.  We wouldn't want you fathering any boys, would we?</i>\"");
        }
        ...
        if (player.smallestCockArea() >= 100)
        {
            outputText("  The penetration is eased somewhat by your shrinking dick.  You glance at the sand witch in awe, noting her glowing hands.  She gives you a knowing wink and turns, her spell complete, leaving you to enjoy yourself.");
        }
        ...
        if (player.cockTotal() > 1)
        {
            outputText("Her voluminous butt is thoroughly smeared by the goo from the rest of your [cocks], shining with white from your magical virility.  ");
        }
    ...
    public function cumWitchMaleLoss_start() : Void
    {
        ...
        if (player.HP < 1)
        {
            ...
            {
                outputText("semi-flaccid");
            }
            else if (player.lust < 70)
            {
                outputText("semi-hard");
            }
            else
            {
                outputText("turgid");
        ...
        else
        {
            ...
            if (player.hasBalls())
            {
                outputText(", and your [balls] are practically quaking with need");
            }
    ...
    public function cumWitchMaleLoss_tooBig() : Void
    {
        ...
        if (player.biggestCockLength() < player.tallness / 2)
        {
            outputText("[chest]");
        }
        else if (player.biggestCockLength() < player.tallness / 1.6)
        {
            outputText(player.face());
        }
        else
        {
        ...
        if (player.hasFuckableNipples())
        {
            outputText(", sinking inside your moist tit-holes almost immediately");
        }
        ...
        {
            outputText("[vagina], slipping a few toes through your folds while a big toe diddles your [clit].");
        }
        else
        {
            outputText("taint, softly stroking the sensitive skin between your groin and [asshole].");
        }
    ...
    public function cumWitchMaleLoss_fits() : Void
    {
        ...
        {
            outputText(" from her bouncing, ebony erection");
        }
    ...
    public function tooBigCumWitchLossFacial() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("  You shudder at the knowledge of what's going to happen to you.  Just why did you agree to this?");
        }
        else if (player.cor < 66)
        {
            outputText("  You catch yourself licking your lips as the knowledge of what is about to happen to you sinks in. Despite hastily stopping yourself, the Cum Witch still saw, and she smiles.");
        }
        else
        {
            outputText("  You give her a lewd look and lick your tongue across your lips as you anticipate the big, fat load she's going to feed you, hungry for wet, decadent pleasure regardless of inhibitions.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("[balls], compressing them slightly as a tingle of magic lances into you, fattening them under her ministrations");
        }
        else if (player.hasVagina())
        {
            outputText("[vagina], digging into the slippery slit as a tingle of magic spreads through it and into your core, thickening some organ inside you");
        }
        else
        {
            outputText("taint, rubbing it as a tingle of electric need phases through your " + player.skinFurScales() + " to assault your swelling prostate and seminal vesicles");
        }
        ...
        if (player.biggestCockLength() >= player.tallness / 1.6)
        {
            outputText("  The Cum Witch smiles as she holds it, bending it to make sure the overlong shaft deposits its thick load on your [face] where it belongs.");
        }
    ...
    public function tooBigCumWitchLossNoFacial() : Void
    {
        ...
        {
            player.ballSize -= Math.round(player.ballSize * 0.333);
        }
    ...
    public function TDMsLoseToCumWitchScene() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText("your other phallus.");
            }
            //[if (cocks > 2)
            else
            {
                outputText("the rest of your [cocks].");
            }
        ...
        if (player.hasBalls())
        {
            outputText("the one part of your manhood that you can still feel, your [sack].");
        }
        else
        {
            outputText("a part of your body just behind and above the base of [eachCock], probably your prostate.");
        }
        ...
        if (player.sens < 70)
        {
            outputText("It's more sensitive than yours, for one thing, and");
        }
        else
        {
            outputText("It isn't as sensitive as yours {are/is}, for one thing, but");
        }
        ...
        if (silly())
        {
            outputText("in both body and in [balls].");
        }
        else
        {
            outputText("in both body, and in spirit.");
        }
    ...
    public function defeatedByCumWitch() : Void
    {
        ...
        {
            var fits : Bool = player.findCock(1, -1, monster.vaginalCapacity()) >= 0;
            var fitMsg : String = "Req. a cock with area smaller than " + monster.vaginalCapacity();
            var tooBig : Bool = player.findCock(1, monster.vaginalCapacity(), -1) >= 0;
    ...
    public function menFuckUpSomeCumWitch() : Void
    {
        ...
        function mFUSCW_herm() : Void
        {
            ...
            if (player.hasBalls())
            {
                outputText("Your sweaty nutsacks slide over each other while you fuck, compressing together into a mass of sweaty orbs twitching against each other in a competition to disgorge their frothy load before the other.");
            }
            else
            {
                outputText("Her sweaty nutsack glides over your " + player.skinFurScales() + " as you fuck, compressing and twitching against you as it begs to discharge its frothy load.");
            }
            ...
            if (player.cumQ() > 2000)
            {
                outputText("  Of course, you outlast even the jizz-witch's magics, plugging her so full of semen that her belly rounds into a gravid orb while yours remains only slightly bloated.");
            }
            else if (player.cumQ() > 1000)
            {
                outputText("  Of course, you both manage to bulge each other's bellies with sexual discharge.");
            }
            else
            {
                outputText("  Of course, she cums far longer and harder than you, plugging your belly full of semen until it has a slightly fecund curve to it.");
            }
        ...
        var mFUSCW_single : Void->Void = function() : Void
        {
            var x : Int = player.cockThatFits(monster.vaginalCapacity());
            ...
            if (player.cor < 50)
            {
                outputText("and a hint of compassion");
            }
            else
            {
                outputText("and finally deign to let her have some pleasure");
            }
            ...
            if (player.cumQ() < 700)
            {
                outputText(", spurting with unceasing quantity until she's absolutely flooded with jizz and a little bulgy around the middle.");
            }
            else
            {
                outputText(", spooging up her cunny until it's completely flooded, her belly bloated into a rounded dome.");
            }
            if (player.cumQ() >= 1500)
            {
                outputText("  You keep going beyond that, but there's just no room, and spouts of semen spurt from the woman's poor, over-filled twat.");
            }
            ...
            if (player.cor < 33)
            {
                outputText("  You hope she learned something from the experience, but knowing most people in this strange land, she'll go right back to her rotten ways.");
            }
            else if (player.cor < 66)
            {
                outputText("  You wonder if she'll learn anything from this and shrug nonchalantly.  Who cares?");
            }
            else
            {
                outputText("  You smirk as you wonder if she'll learn anything from this.  You hope not - it's a fun lesson to teach.");
            }
            mFUSCW_end();
        }
        
        var mFUSCW_DP : Void->Void = function() : Void
        {
            var x : Int = player.cockThatFits(monster.vaginalCapacity());
            var y : Int = player.cockThatFits2(monster.vaginalCapacity());
            ...
            if (player.cumQ() < 250)
            {
                outputText("pours out of your dual cum-slits, making a sloppy mess of both holes.");
            }
            else if (player.cumQ() < 500)
            {
                outputText("gushes out of your dual cum-slits, soaking both holes in and out with pearly white.");
            }
            else if (player.cumQ() < 1000)
            {
                outputText("gushes out with incredible force from your dual cum-slits, quickly plugging both holes so full of seed that the witch's belly slowly rises, cum-inflated.");
            }
            else
            {
                outputText("washes out of your dual cum-slits in a tidal wave, flooding the hungry holes with your virile seed.  You cum and cum, spunking up the witch's belly.  First it bulges slightly, but all too soon you have it rounded into a pregnant dome.");
            }
        ...
        var mFUSCW_end : Void->Void = function() : Void
        {
            player.sexReward("vaginalFluids", "Dick");
            if (CoC.instance.inCombat)
            {
    ...
    public function maleTooBigVictorySex() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(" or fondle your [balls]");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" along with your [balls] growing tight");
        }
    ...
    public function ladyVictorySex() : Void
    {
        ...
        if (player.wetness() >= 5)
        {
            outputText("  It gushes out of you in a soaking river, utterly drenching the futa's stomach, hips, and butt.");
        }
        if (player.lactationQ() >= 50)
        {
            outputText("  At the same time, milk spouts from your bosom to wash over your hermaphrodite.");
        }
    ...
    public function tentacleVictoryGangbangCumWitch() : Void
    {
        ...
        if (player.tentacleCocks() >= 4 || player.stamenCocks() > 3)
        {
            outputText(", splatting over your frotting cock-tip in wild abandon");
        }
        ...
        if (player.tentacleCocks() >= 4 || player.stamenCocks() > 3)
        {
            outputText("  Of course, your fourth prick is not to be outdone, and blasts a gooey coating of cream across the witch's own pulsating prick, wreathing it in drizzles of syrupy white.");
        }
        if (player.cumQ() >= 500)
        {
            outputText("  Wave after wave of spunk washes into the tight holes and toned form of your foe, turning her into a complete mess.");
        }
        if (player.cumQ() >= 1000)
        {
            outputText("  A few more virile splurts see to her utterly inundated state, bloating her belly into a tightly-stretched dome.");
        }
    ...
    public function savinMakesAwesomeFemdom() : Void
    {
        ...
        if (player.bRows() > 1)
        {
            ...
            if (player.lactationQ() >= 200)
            {
                outputText(" until milk streams down your chest, much to her delight");
            }
            outputText(".");
        }
        else if (player.lactationQ() >= 200)
        {
            outputText("Her fingers deftly work across your [nipples], caressing out a trickle of milk, which she laps up with a long, languid motion that electrifies your sun-kissed skin.");
        }
        else
        {
            outputText("She tweaks your [nipples] between her dexterous fingers, sending shivers of pleasure up your spine, but seems oddly discontent...  \"<i>No milk for me? We'll have to do something about that...</i>\"");
        }
        ...
        if (player.hasCock())
        {
            ...
            {
                outputText("overshadowing your comparatively tiny little rod");
            }
            else if (player.longestCockLength() < 15)
            {
                outputText("nearly equal to your own [cock]");
            }
            else
            {
                outputText("seeming tiny compared to your monstrous shaft");
            }
        ...
        if (player.isGoo() || player.isNaga() || player.isDrider() || player.isTaur())
        {
            outputText("shifts down your inhuman body");
        }
        else
        {
            outputText("spreads your legs, hiking them over her shoulders so that your feet dangle behind her");
        }
    ...
    public function lionpaws(skipped : Bool = false) : Void
    {
        clearOutput();
        ...
        {
            //[if event occurrence == 0]if (flags[kFLAGS.PAWJOBS] == 0)
            {
            ...
            else
            {
                ...
                {
                    outputText("  It's not as if there's all that much else I can do for that monster of yours anyways.");
                }
        ...
        if (player.lust < 50 && flags[kFLAGS.PAWJOBS] == 0)
        {
            outputText("  You raise your eyebrows in surprise, but you're not in much of a position to do anything about her foot's advance.");
        }
        ...
        if (player.smallestCockArea() < 100)
        {
            outputText("  As she pushes onto you just a bit more forcefully, your member slips between two of her digits.  She continues her slow, rhythmic movements with just a bit more grip, and you're made quite thankful that her claws are so retractable as she brushes against your belly.");
        }
        ...
        if (!skipped && flags[kFLAGS.PAWJOBS] == 0)
        {
            outputText("It feels wonderful in a peculiar sort of way; though it's certainly not the treatment you expected to receive, you can definitely feel your arousal being pushed along and built up by her foot.  ");
        }
        //[if PC has 2+ dicks]
        if (player.cockTotal() > 1)
        {
            outputText("Not content to leave your other cocks neglected, the sphinx leans in and starts to lick and suckle once again at the pricks not beneath her paw.  You shudder at the feeling of her tongue darting from shaft to shaft and teasing your heads, sharper sensations punctuating her foot's more constant pleasuring.  ");
        }
        ...
        if (flags[kFLAGS.PAWJOBS] > 0)
        {
            outputText(" as always");
        }
        ...
        {
            outputText(" stained-white fur in a futile attempt to get some of your cum off.");
        }
    ...
    private var riddles : Array<Dynamic> = [riddleOne, riddleTwo, riddleThree, riddleFour, riddleFive, riddleSix, riddleSeven, riddleEight, riddleNine, riddleTen, riddleEleven, riddleTwelve];
    private var selectedRiddles : Array<Dynamic> = [];
    ...
    public function riddlePicker() : Void
    {
        ...
        while (Lambda.indexOf(selectedRiddles, randRiddle) != -1)
    ...
    public function riddleOne() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(3, "Stilts", answerWrong);
        }
    ...
    public function riddleTwo() : Void
    {
        ...
        if (player.inte < 50)
        {
            addButton(2, "A Nail", answerWrong);
        }
        if (player.inte < 35)
        {
            addButton(3, "A Bunny-Girl", answerWrong);
        }
        addButton(4, "Uh, ATTACK!", fuckItAttack);
    }
    ...
    public function riddleThree() : Void
    {
        ...
        if (player.inte < 50)
        {
            addButton(1, "A Condom", answerWrong);
        }
        if (player.inte < 35)
        {
            addButton(2, "Arrows", answerWrong);
        }
    ...
    public function riddleFour() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(0, "A Fairy", answerWrong);
        }
        addButton(1, "Fire", answerCorrect);
        addButton(2, "A Dog", answerWrong);
        if (player.inte < 50)
        {
            addButton(3, "Disease", answerWrong);
        }
        addButton(4, "Uh, ATTACK!", fuckItAttack);
    }
    ...
    public function riddleFive() : Void
    {
        ...
        if (player.inte < 50)
        {
            addButton(0, "Men", answerWrong);
        }
        if (player.inte < 35)
        {
            addButton(1, "Women", answerWrong);
        }
    ...
    public function riddleSix() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(0, "A Goblin", answerWrong);
        }
        addButton(1, "A Candle", answerCorrect);
        if (player.inte < 50)
        {
            addButton(2, "A Boat", answerWrong);
        }
    ...
    public function riddleSeven() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(2, "Water", answerWrong);
        }
        if (player.inte < 50)
        {
            addButton(3, "The Breeze", answerWrong);
        }
        addButton(4, "Uh, ATTACK!", fuckItAttack);
    }
    ...
    public function riddleEight() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(0, "A Demon", answerWrong);
        }
        if (player.inte < 50)
        {
            addButton(1, "Religion", answerWrong);
        }
    ...
    public function riddleTen() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(2, "Piss In A River", answerWrong);
        }
        if (player.inte < 50)
        {
            addButton(3, "Tattered Scrolls", answerWrong);
        }
        addButton(4, "Uh, ATTACK!", fuckItAttack);
    }
    ...
    public function riddleEleven() : Void
    {
        ...
        if (player.inte < 35)
        {
            addButton(0, "Teasure Chest", answerWrong);
        }
        if (player.inte < 50)
        {
            addButton(1, "Pure Honey", answerWrong);
        }
    ...
    public function riddleTwelve() : Void
    {
        ...
        if (player.inte < 50)
        {
            addButton(0, "Fallen Stars", answerWrong);
        }
        if (player.inte < 35)
        {
            addButton(1, "Angels", answerWrong);
        }
    ...
    private function afterSanuraFuck(submit : Bool = false) : Void
    {
        menu();
        if (submit)
        {
    ...
    public function getBlown(submit : Bool = false) : Void
    {
        clearOutput();
        ...
        if (player.hasBalls())
        {
            outputText(", one hand slipping down to cup your [balls], rolling them in her palm until a white trickle escapes your [cockHead biggest]");
        }
        ...
        if (player.hasBalls())
        {
            outputText("balls empty");
        }
        else
        {
            outputText("body empties");
        }
        ...
        if (player.hasBalls())
        {
            outputText("[balls] churn");
        }
        else
        {
            outputText("body churns");
        }
    ...
    public function forceDildos() : Void
    {
        ...
        if (player.lactationQ() >= 200)
        {
            outputText(" until a gentle trickle of your motherly fluids pours out across her hands.  With a girlish giggle, the sphinx slips her head under your arm, lapping at your milky teats.  A throaty purr escapes her lips before you give her a little push, getting her back to the task at hand");
        }
        outputText(".");
    ...
    public function fuckDatLionPussah() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("damp cunt, which suddenly tightens up and practically gushes with slick juices.");
        }
        else
        {
            outputText("asshole, which reflexively tightens, sending a shiver up your spine.");
        }
        ...
        {
            outputText(", your knot slipping into place with a moist <b>pop</b>, ensuring you'll be locked together for the foreseeable future");
        }
        ...
        if (player.hasKnot(player.biggestCockIndex()))
        {
            outputText("which proves somewhat uncomfortable, given your knot is still lodged firmly within her, ");
        }
        outputText("panting wildly.  It takes you several minutes to recover, the sphinx even longer, ");
        if (player.hasKnot(player.biggestCockIndex()))
        {
            outputText("and even longer still for your knot to deflate enough to slip out of her, ");
        }
    ...
    public function fenPutsHisShittyFetishInYoSphinx() : Void
    {
        ...
        {
            outputText("you expose your [butt], allowing it to redden");
        }
        ...
        {
            outputText("  Pre-cum oozes from [eachCock] in steady strings that dangle onto the dirt, painting a swirled pattern beneath you as your prostate is pushed hard enough to squeeze trickles of your salty 'milk' from you.");
        }
        ...
        if (player.cockTotal() > 0)
        {
            outputText("  Whenever her flare slides past your prostate, the wide, blunt head squeezes it hard enough to express a huge strand of pre.");
        }
        ...
        if (player.cockTotal() > 0)
        {
            outputText("  When she crosses the lump that is your well-used prostate, you lose control and shudder with a nice, long cum of your own, your arms giving out and dumping you face-down on the ground while you spurt milky whiteness onto your chest, chin, and then the ground.");
        }
        else
        {
            outputText("  When she's almost out, you give in and cum, quivering around her magical breeding tool while it finishes inseminating your guts.");
        }
        ...
        if (player.cockTotal() > 0)
        {
            outputText(" and dragging you through your fresh, milky puddle");
        }
    ...
    private function canFreeEssy() : Bool
    {
        return flags[kFLAGS.ESSY_MET_IN_DUNGEON] > 0 && flags[kFLAGS.TOLD_MOTHER_TO_RELEASE_ESSY] == 0;
    }
    private function canFreeMilkSlave() : Bool
    {
        return flags[kFLAGS.MET_MILK_SLAVE] > 0 && Std.is(flags[kFLAGS.MILK_NAME], Float);
    }
    ...
    //	startCombat(new SandMother(),true);
    {
        ...
        {
            addButton(0, "StopAttacking", leaveAloneSendLackeysToggle).hint("You've had enough with the Sand Witches. They should leave you alone.", "Talk: Stop Attacking");
        }
        else
        {
            addButton(0, "StartAttacking", leaveAloneSendLackeysToggle).hint("Tell the Sand Mother that you want to encounter the Sand Witches again.", "Talk: Start Attacking");
        }
    ...
    public function slavesDiscussion() : Void
    {
        ...
        if (canFreeEssy())
        {
            addButton(0, "Essrayle", SceneLib.forest.essrayle.askMotherToReleaseEssy).hint("Request the Sand Mother to release Essrayle.");
        }
        if (canFreeMilkSlave())
        {
            addButton(1, "Milk-Slave", freeSlaves).hint("Request the Sand Mother to release the milk slave you've found in the bathroom.");
        }
    }
    ...
    private function buyMilkGirlIdealist() : Void
    {
        ...
        if (player.gems >= 2000)
        {
            addButton(1, "Buy Her", BuyHer).hint("Buy the Milk Slave for 2000 gems?");
        }
    }
    ...
    public function sexWithFriendlySandMother() : Void
    {
        ...
        menu();
        //friendly cunt fuck:
        addButton(0, "GetMilkFill", lesboMilkFilling).hint("Get into female sex with the Sand Mother and get your vagina stuffed with milk!").disableIf(!player.hasVagina(), "Req. a vagina");
        addButton(1, "Vaginal", friendlySandMotherFuck).hint("Penetrate her pussy with your penis.").disableIf(player.cockThatFits(monster.vaginalCapacity()) < 0, "Req. a cock with area smaller than " + monster.vaginalCapacity());
    ...
    //fix monster (for sex)
    {
        ...
        if (flags[kFLAGS.SAND_WITCH_LEAVE_ME_ALONE] == 0)
        {
            addButton(0, "StopAttacking", unfriendlyWitchToggle).hint("You've had enough with the Sand Witches. They should leave you alone.", "Talk: Stop Attacking");
        }
        else
        {
            addButton(0, "StartAttacking", unfriendlyWitchToggle).hint("Tell the Sand Mother that you want to encounter the Sand Witches again.", "Talk: Start Attacking");
        }
        if (flags[kFLAGS.MORE_CUM_WITCHES] == 0)
        {
            addButton(1, "Cum Witches", talkToEnemySMaboutCW).hint("Request Sand Mother to send some Cum Witches to the desert. Maybe you'll be able to encounter and fuck one?");
        }
        else
        {
            addButtonDisabled(1, "Cum Witches", "You can toggle Cum Witch encounters simultaneously with regular Sand Witches.", "Cum Witches");
        }
        ...
        if (canFreeEssy())
        {
            addButton(5, "Essrayle", SceneLib.forest.essrayle.askMotherToReleaseEssy).hint("Request the Sand Mother to release Essrayle.");
        }
        if (canFreeMilkSlave())
        {
            addButton(6, "Milk-Slave", talkToEnemySMaboutMilk).hint("Request the Sand Mother to release the milk slave you've found in the bathroom.");
        }
        addButton(14, "Leave", playerMenu);
    }
    ...
    public function sexWithEnemyMother() : Void
    {
        ...
        addButton(4, "Back", (flags[kFLAGS.SAND_WITCHES_COWED] != null) ? sandMotherPOMenu : sandMotherChoice);
    }
    ...
    public function sandMotherStuffGOA() : Void
    {
        ...
        else if (flags[kFLAGS.SAND_WITCHES_COWED] > 0)
        {
            ...
            if (flags[kFLAGS.SAND_WITCH_LOOT_TAKEN] >= 10)
            {
                outputText(", though right now it sits empty.  You'll need to wait for them to restock it");
            }
            else
            {
                outputText(", and noone could stop you from taking them");
            }
            outputText(".");
            sandMotherPOMenu();
        }
        ...
        else
        {
            ...
            if (player.cor >= 66)
            {
                outputText("You stink of corruption, but I still sense a soul within you.  You are not a demon... yet.");
            }
            else
            {
                outputText("You do not stink of corruption over-much, like many in this land, but that does not mean you are not an agent of the Lethice's.");
            }
    ...
    public function defeatTheSandMother() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("in exhaustion");
        }
        else
        {
            outputText("with lust");
        }
    ...
    public function talkDownTheMother() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("a champion");
        }
        else if (player.cor < 66)
        {
            outputText("beholden to no-one");
        }
        else
        {
            outputText("unstoppable");
        }
    ...
    public function tentacleGangBang() : Void
    {
        ...
        if (flags[kFLAGS.TIMES_TENTACLED_SAND_MOTHER] == 0)
        {
            outputText("it can't be like this!  W-we were going to free Mareth!");
        }
        else
        {
            outputText("not again!");
        }
        outputText("</i>\"");
        ...
        if (tentaCnt >= 6)
        {
            ...
            if (tentaCnt >= 7)
            {
                outputText("untended serpentine shafts to please");
            }
            else
            {
                outputText("an untended serpentine shaft to please");
            }
            outputText(", but all the holes are full!  You take the ");
            if (tentaCnt == 6)
            {
                outputText("leftover one and thread it");
            }
            else
            {
                outputText("leftover ones and thread them");
            }
            ...
            if (tentaCnt == 6)
            {
                outputText(" held still is the one getting a hand job, and you only hold it still");
            }
            else
            {
                outputText("s held still are the two getting hand jobs, and you only hold them still");
            }
        ...
        {
            sceneHunter.print("Check failed: 10 cocks!");
        }
        ...
        if (tentaCnt >= 6)
        {
            outputText("  Bubbling seed soaks her frantically jerking hands.");
        }
    ...
    public function fuckTheSandMothersCunt() : Void
    {
        ...
        if (y < 0)
        {
            sceneHunter.print("Check failed: second fitting dick.");
        }
        ...
        if (silly())
        {
            outputText("  Dat booty be poppin', yo!");
        }
        ...
        {
            outputText("at the nape of her neck,");
        }
        else
        {
            outputText("on her stomach,");
        }
        ...
        if (y >= 0)
        {
            outputText(", grabbing a second cock as well, intent on penetrating both of her sopping entrances");
        }
        outputText(".  The moment her labia caress your ");
        if (y >= 0)
        {
            outputText("cockheads");
        }
        else
        {
            outputText(player.cockHead(x));
        }
        ...
        if (y < 0)
        {
            outputText("it clamps down");
        }
        else
        {
            outputText("they clamp down");
        }
        ...
        if (player.cumQ() >= 500)
        {
            ...
            if (player.cumQ() >= 2000)
            {
                outputText("  They fall faster and faster as you cum, the witch's belly bloating, rounding out to a ridiculous degree.  Her legs are drenched with the leaking spooge.");
            }
        }
    ...
    public function scissorAndDrink() : Void
    {
        ...
        if (player.tallness < 85)
        {
            outputText(" larger");
        }
        else if (player.tallness > 105)
        {
            outputText(" smaller");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("explodes out in a cunt-shattering spray");
        }
        else if (player.wetness() >= 4)
        {
            outputText("gushes out in a heavy spray");
        }
        else if (player.wetness() >= 3)
        {
            outputText("pours out in a thick, wet river");
        }
        else if (player.wetness() >= 2)
        {
            outputText("drools out in a steady trickles");
        }
        else
        {
            outputText("drips out during the cunt-shattering convulsions");
        }
    ...
    public function loseToSandMotherBadEnd() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("battered body aloft, but your wounds are too great, robbing you of strength.");
        }
        else
        {
            outputText("rebellious body aloft, but your lust is too great, turning your body into a quivering wreck.");
        }
        outputText("  You ");
        if (player.HP < 1)
        {
            outputText("spitefully watch the Sand Mother approach, only able to admire her sculpted form as she towers over your prone form.");
        }
        else
        {
            outputText("hungrily watch the Sand Mother approach, only able to touch yourself as you gaze up at her sculpted form");
        }
        ...
        if (player.HP < 1)
        {
            outputText("rapidly-swelling erection");
        }
        else
        {
            outputText("turgid, pre-cum slathered boner");
        }
        if (player.cockTotal() > 1)
        {
            outputText("s");
        ...
        if (player.cor < 66)
        {
            outputText("aren't corrupt");
        }
        else
        {
            outputText("don't serve the demons");
        }
        outputText(", looking up at her pleadingly ");
        if (player.cockTotal() == 1)
        {
            outputText("while she gleefully pumps you, smearing your leaky juices all over your shaft.");
        }
        else
        {
            outputText("while she gleefully moves to your second cock, smearing it with your first dick's pre-cum, messing your [cocks] with each peni's leaky drippings.");
        }
        ...
        if (player.hasVagina())
        {
            outputText(" and ignored womanhood");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText("  Wave after wave of jism washes across you, thoroughly drenching you with your spooge, the alabaster spunk soaking you from crown to waist with sticky slickness.");
        }
        if (player.cumQ() >= 3000)
        {
            outputText("  A puddle pools around you, deepening nicely as your boundless virility does its work, inching up your body until you feel as if you'll float away in your own pearly jism.");
        }
        ...
        {
            outputText("The Cum Witch is here, and she seems to have recovered from her defeat!");
        }
        else
        {
            outputText("This must be the Cum Witch!");
        }
        ...
        if (!player.hasVagina())
        {
            player.buttChange(12, true, true);
        }
        else
        {
    ...
    public function menLoseToQueenMotherVolI() : Void
    {
        ...
        {
            outputText("Their harpy and phoenix allies allowed them to approach Lethice's fortress unhindered, and i");
        }
        else
        {
            outputText("I");
    ...
    public function loseToSandMother() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("heavily punished and aching body is filled with too much agony to continue.");
        }
        else
        {
            outputText("hot and aroused body fills with unbearable urges that finally distract you from fighting any further.");
        }
        outputText("  Instead, you fall backwards against the wall ");
        if (player.HP < 1)
        {
            outputText("and grit your teeth in anger as the Sand Mother approaches.");
        }
        else
        {
            outputText("panting deeply, and your blood races as the Sand Mother approaches.");
        }
        ...
        if (player.wetness() <= 2)
        {
            outputText("grows moist.");
        }
        else if (player.wetness() <= 4)
        {
            outputText("drips with arousal.");
        }
        else
        {
            outputText("drools obscenely.");
        }
        ...
        if (player.HP < 1)
        {
            outputText("the pain of your abused body");
        }
        else
        {
            outputText("lustful urges fill your senses and");
        }
        ...
        else if (player.bRows() == 2)
        {
            outputText("  Thankfully you're already endowed with enough breasts to begin immediate production of milk.");
        }
        //if player has six breasts
        else
        {
            outputText("  Hmmm. We've never had a sister blessed with more than four breasts. I wonder if perhaps we can use your unusual anatomy to our advantage.");
        }
        ...
        {
            outputText("  \"<i>Of course we'll have to grow them a bit to suit our needs.</i>\"");
        }
        //if breasts are larger than a normal sand witch's
        else if (player.biggestTitSize() >= 14)
        {
            outputText("  \"<i>Mmmm, and with such massive ones I'm sure we can expect you to produce more than most of our sisters could.</i>\"");
        }
        ...
        if (player.lactationQ() >= 50)
        {
            outputText("  Streams of milk are already starting to pour down the swells of your tits.");
        }
        ...
        if (flags[kFLAGS.CUM_WITCH_DEFEATED] == 1)
        {
            outputText("  It is obviously the Cum Witch you encountered, and she has clearly regained her strength!");
        }
        else
        {
            outputText("This must be the Cum Witch the Sand Mother sent for!");
        }
        ...
        if (player.bRows() <= 2)
        {
            outputText(", admiring the extra set of breasts you already possess");
        }
        else
        {
            outputText(", admiring how you've managed to grow " + num2Text(player.bRows()) + " rows of breasts instead of just two on your panting torso");
        }
        outputText(".");
    ...
    public function sandMotherBadEndsLadiesEpilogue() : Void
    {
        ...
        if (player.bRows() > 2)
        {
            outputText("  Although unlike the other Sand Witches, this one sported extra breasts, which she used to her utmost advantage.");
        }
        //if player had gigantic breasts
        if (player.biggestTitSize() >= 22)
        {
            outputText("  She was unrivaled in her ability to produce milk thanks to the natural enormity of her breasts that her other sisters couldn't come close to.  They were so large that they often impeded her movement, which she admittedly didn't mind so much.");
        }
        ...
        {
            outputText("  She'd immediately shown a unique propensity for rapid pregnancies, birthing new sisters at twice the rate of any other Sand Witch.  Her surprisingly fertile wombs helped give an extra edge to the Sand Mother's plans.");
        }
        
        //if player had broodmother and gigantic breasts
        if (player.hasPerk(PerkLib.BroodMother) && player.biggestTitSize() >= 22)
        {
    ...
    public function friendlySandMotherFuck() : Void
    {
        ...
        if (y < 0)
        {
            sceneHunter.print("Check failed: second dick");
        }
        //First Time:
        ...
        if (!player.isTaur())
        {
            ...
            if (y >= 0)
            {
                outputText(" and another in the other");
            }
        ...
        else
        {
            ...
            {
                outputText("they nose");
            }
            outputText(" up against the twin, wet pussies.");
        }
        if (player.tallness >= 90)
        {
            outputText("  You have to kneel down to make it work, tall as you are.  ");
        }
        else if (player.tallness <= 48)
        {
            outputText("  You can barely reach her cunt standing, short as you are.  ");
        }
        outputText("Her lube-glossed gates spread around your " + player.cockHead(x));
        if (y >= 0)
        {
            outputText(" and other cock-tip");
        }
        ...
        if (player.isTaur())
        {
            ...
            {
                outputText("her shoulders");
            }
            else
            {
                outputText("the top of her throne");
            }
        ...
        else
        {
            ...
            {
                outputText("you kiss her to silence her, tongue pumping to the same timing that drives your hips.");
            }
            else
            {
                outputText("you suckle one of the heavy, milk-laden tits to enhance her pleasure");
            }
        ...
        if (player.cockTotal() > 2 || (player.cockTotal() == 2 && y < 0))
        {
            ...
            if (player.cockTotal() > 3 || (player.cockTotal() == 3 && y < 0))
            {
                outputText("es");
            }
        ...
        if (player.cumQ() < 250)
        {
            ...
            if (y < 0)
            {
                outputText("a fat white drop that's squeezed from your tip");
            }
            else
            {
                outputText("fat white drops that are squeezed from your tips");
            }
            outputText(".");
        }
        //medium ejaculate
    ...
    public function lesboMilkFilling() : Void
    {
        ...
        {
            outputText(", [fullChest] swaying enticingly as you strike your seductive pose");
        }
        ...
        {
            outputText("cup your mammaries");
        }
        else
        {
            outputText("run your hands down your chest");
        }
        ...
        else
        {
            ...
            {
                outputText(", though judging by the glow around her hands, she used some magic to help");
            }
        ...
        if (player.isTaur())
        {
            outputText("squeeze your own [nipples]");
        }
        else
        {
            outputText("grab hold of her head");
        }
        ...
        if (!player.isTaur())
        {
            outputText("  Somehow, she's able to pull her hand away from your hip while still holding you aloft.  A glowing, arm-shaped silhouette remains, even as she diverts her attention elsewhere.");
        }
        ...
        if (player.canGetPregnant())
        {
            outputText("Your poor womb is flooding with the stuff.  It's getting so full that you're starting to feel like you should be labelled 'cream-filled', and a tiny bump has begun to swell on your midsection in response.");
        }
        else
        {
            outputText("Your poor pregnant womb is battered with the stuff, but since you're already full, jets of hot cream are spraying out from your [vagina] around nipple-shaped milk-injectors.");
        }
        //CuntChange 6
        ...
        if (player.isTaur())
        {
            outputText("wishing you could rub your swollen belly");
        }
        else
        {
            outputText("rubbing your swollen belly");
        }
        ...
        if (player.canGetPregnant() && !player.hasVisiblePregnancy())
        {
            outputText("You can feel your midsection going round, wobbling wildly.  POP!  Your belly-button has turned into an outie, accompanied by a wobbling, comforting weight inside you.  Four months... five, no - six... you give up on counting, but with every second that passes, you're getting bigger and bigger, visually matching any of the pregnant women you saw growing up.");
        }
        else
        {
            outputText("You can feel it fountaining out of you, backwashing out to splatter the witch with wetness, her skin going glossy under the tide of white.  If you weren't already pregnant, you'd probably be ballooning up with her lactic cargo, a rounded, milk-filled cream-balloon.");
        }
    ...
    public function currentStateOfInterwebs() : Void
    {
        ...
        if (flags[kFLAGS.HEL_HARPY_QUEEN_DEFEATED] == 0)
        {
            outputText("All that remains is to ready those still maturing and wait on our allies to finish growing their numbers.  We shall be carried into the Demon Queen's fortress on the wings of phoenixes, to fight as glorious a battle as has ever been fought!");
        }
        else
        {
            outputText("All that remains is for us to find new aerial allies or a method of easy, sustained flight.  The phoenixes were smashed apart by fiery demons, their lair raided and destroyed by an interloper.  If only things had been different... Calais was so close.");
        }
        outputText("</i>\"");
        ...
        if (flags[kFLAGS.HEL_HARPY_QUEEN_DEFEATED] > 0)
        {
            outputText("  Of course, this is all contingent on us finding an ally that can breach the mountaintop citadel's walls.");
        }
    ...
    public function discussCumWitches() : Void
    {
        ...
        if (player.cor + player.lib > 100)
        {
            outputText(", though potentially fun");
        }
    ...
    public function askHowSandMothersAreChosen() : Void
    {
        ...
        {
            outputText("'re a human");
        }
        else
        {
            outputText(" were a human");
        }
    ...
    public function getLactaidFromWitches() : Void
    {
        ...
        {
            outputText("none-too-politely request");
        }
    ...
    public function getLaBova() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText(" with a blush");
        }
        else if (player.cor < 66)
        {
            outputText(" a little uncertainly");
        }
        else
        {
            outputText(" with a knowing smile");
        }
        outputText(".");
        ...
        if (player.cor > 66)
        {
            outputText(", though the idea does seem to nestle into your imagination quite alluringly");
        }
        outputText(".");
    ...
    public function unfriendlyWitchToggle() : Void
    {
        ...
        if (flags[kFLAGS.SAND_WITCH_LEAVE_ME_ALONE] == 0)
        {
            ...
            if (player.cor < 50)
            {
                outputText("  You probably wouldn't do something like that, at least not without provocation!/  You could see how she would think that.");
            }
            else
            {
                outputText("  As if that would stop you.");
            }
            ...
            flags[kFLAGS.SAND_WITCH_LEAVE_ME_ALONE] = 1;
            if (flags[kFLAGS.MORE_CUM_WITCHES] != null)
            {
                flags[kFLAGS.CUM_WITCHES_FIGHTABLE] = 0;
            }
        }
    ...
    //*Raid LaBova/Lactaid
    public function takeLaBovaOrLactaid(lactaid : Bool = true) : Void
    {
        clearOutput();
    ...
    public function takeFertilePills() : Void
    {
        ...
        {
            outputText("You aren't under the effects of a contraceptive, so taking a pink pill would do nothing.");
        }
        //{Contraceptives}
        else
        {
            ...
            if (!player.hasVagina())
            {
                outputText(", should you ever grow a vagina");
            }
            outputText(".");
    ...
    public function takeBarrenPills() : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.Contraceptives))
        {
            outputText("You're already under the effects of contraceptives.  Taking one of the brown pills wouldn't do anything.");
        }
        //{TAKE DAT SHIT YO}
        else
        {
            ...
            if (player.isPregnant())
            {
                outputText("  Of course, you're already pregnant, and this doesn't seem to be doing anything about THAT.");
            }
            outputText("  You do feel an emptiness in your midsection, reassuring you that the pill did its job.");
            if (!player.hasVagina())
            {
                outputText("  Now if you ever re-grow a vagina, you should be fine.");
            }
    ...
    public function friendlyCumWitchBlessing() : Void
    {
        ...
        if (player.hasCock())
        {
            addButton(0, "Virility", cumWitchBlessed, true, null, null, "Receive the blessing of virility. This will increase your cum production and virility rating.");
        }
        if (player.hasVagina())
        {
            addButton(1, "Fertility", cumWitchBlessed, false, null, null, "Receive the blessing of fertility. This will increase your pregnancy speed and fertility rating.");
        }
    ...
    //*Virility/Fertility
    public function cumWitchBlessed(virility : Bool = true) : Void
    {
        clearOutput();
        ...
        {
            outputText("  Your inhuman tongue slides further and further out, following the witch's bulging, pre-cum filled urethra towards her balls where it can curl around them, embracing them with slick, slippery saliva.  You can taste her unique flavor on her skin, and it makes you shudder with arousal.");
        }
        ...
        if (virility)
        {
            outputText("[eachCock] drip and drool your own seed onto the floor.  The heat inside you is so hot that you can't keep your ardor penned up, and it's slowly boiling out of your [balls] in a pleasure-filled orgasm that provides everything but relief.  You're sure that touching yourself would give you a proper orgasm, but you keep your hands where they belong - on her balls.");
        }
        else
        {
            outputText("your [vagina] ");
        ...
        else if (!player.hasPerk(PerkLib.MagicalFertility))
        {
    ...
    public function fuckOneSandWitch() : Void
    {
        ...
        var tentaArr : Array<Dynamic> = [];
        if (tentaCnt >= 1)
        {
            tentaArr.push(player.findCockWithType(CockTypesEnum.TENTACLE, 1, 20));
        }
        if (tentaCnt >= 2)
        {
            tentaArr.push(player.findCockWithType(CockTypesEnum.TENTACLE, 2, 20));
        }
        ...
        //find non-tentacles{
            ...
            if (x < 0)
            {
                x = player.findCockNotIn(tentaArr, 1, -1, 50);
            }
            if (x >= 0)
            {
                sceneType = 3;
        ...
        //find non-tentacles{
            ...
            if (y < 0)
            {
                y = player.findCockNotIn(tentaArr, 1, -1, 50);
            }
            if (y >= 0)
            {
                sceneType = 4;
        ...
        {
            sceneHunter.print("Check failed: two or three 20-inch long tentacocks.");
        }
        //{if player does not have a tentacle cock}
        if (sceneType == 0)
        {
            outputText("You grab the tanned shoulders of the closest pregnant witch and flip her over on to her back, trapping her beneath the weight of her belly and breasts while you grab both of her ankles.  Her dirty blonde, sweat-soaked hair lies in waves around her head on the floor as she pants heavily in sexual desperation.");
        }
        //{else if player has a tentacle cock}
        else
        {
            outputText("Your tentacle cock lashes outwards, extending as it goes, and wraps around the ankle of the closest girl. It flips her over on to her back, trapping her own torso beneath the weight of her heavy pregnancy and her own four massive leaking breasts.");
        }
        //{if player has two tentacle cocks}
        if (sceneType >= 2)
        {
            outputText("  Another tentacle cock reaches out for the girl's other ankle, and together your cocks spread her tanned legs wide, revealing her large double pussy bloated from her pregnancy.");
        }
        else
        {
            outputText("  You reach forward with a hand to grab her other ankle and with your cock and arm you spread her tanned legs wide to reveal her large double pussy, bloated from her pregnancy.");
        }
        ...
        if (sceneType >= 3)
        {
            outputText("s constantly pound");
        }
        else
        {
            outputText(" constantly pounds");
        }
        ...
        if (player.biggestTitSize() >= 4 && player.biggestTitSize() < 15)
        {
            ...
            {
                outputText("  Each time it does so your own breasts slap against your swollen midsection.");
            }
            //{if player has four or more large breasts and is not pregnant}
            else if (player.bRows() >= 2)
            {
                outputText("  Your lower pair of breasts slap against the pregnant girl's belly with each thrust.");
            }
        }
        ...
        else if (player.biggestTitSize() >= 15)
        {
            ...
            if (player.bRows() == 1)
            {
                outputText("  Your two heavy milk sacs sway and at times you must rest them on top of the poor witch's belly to keep from prematurely exhausting yourself.");
            }
            else if (player.bRows() >= 2)
            {
                outputText("  Resting on top of each other and on top of the witch's legs, your giant globes of tit flesh quake each time you hips move.");
            }
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] tense with the anticipation of releasing the fruit of your loins into her waiting womb.");
        }
        ...
        {
            outputText("  The weight of your own tits bears heavily against your arms as you try to keep the motion of your hips constant while pulling on your lover's milk knobs.");
        }
        //{if player's tits can lactate}
        else
        {
            outputText("  Each of your [nipples] begin spraying milk over the witch as your body begins its crescendo.");
        }
        ...
        if (player.hasVagina())
        {
            ...
            if (player.wetness() >= 4)
            {
                outputText("  Gobs of pussy juice splash against yours and the witch's legs as your orgasm forces your cunt to squirt over and over again.");
            }
            if (player.hasBalls())
            {
                outputText("  Your [sack] is soaking wet by the time your pussy finishes cumming.");
            }
        }
    ...
    public function fuckTwoPregWitches() : Void
    {
        ...
        if (player.countCocksWithType(CockTypesEnum.TENTACLE, 20) >= 2)
        {
            outputText("Almost of their own accord your tentacle cocks lash out, wrapping around the arms of the two closest girls, lifting them to their knees only to roll them backwards and on to their sides with their backs to each other.  ");
        }
        else
        {
            outputText("It takes little effort to grab the closest two witches and pull them up only to push them down again and on to their sides with their backs pressed against each other.  ");
        }
        ...
        if (!player.isNaga())
        {
            outputText("You straddle ");
        }
        else
        {
            outputText("You entwine your serpentine tail around ");
        }
        outputText("their two legs that remain on the floor while allowing their raised legs to ");
        if (player.biggestTitSize() >= 15)
        {
            outputText("slide between your cleavage");
        }
        //{for small or non-breasted characters}
        else
        {
            outputText("rest against your torso and shoulders");
        }
        outputText(".");
        if (player.hasVisiblePregnancy())
        {
            outputText("  Each of these raised legs carefully bend at the knee to accomodate your own pregnant belly that looms over their prone figures.");
        }
        ...
        if (player.lactationQ() >= 200)
        {
            outputText("  Your own breasts begin spraying down the two pregnant sluts with your own dairy fluids.");
        }
        //{if player has large but not huge breasts}
        if (player.biggestTitSize() >= 5 && player.biggestTitSize() < 20)
        {
            outputText("  Each thrust in to the eager cunts causes your breasts to bounce up and down.");
        }
        else if (player.biggestTitSize() >= 20)
        {
            outputText("  Each thrust in to the eager cunts causes your massive breasts to sway back and forth, slapping against your own sides.");
        }
        //{if player has six huge breasts}
        if (player.bRows() >= 3)
        {
            if (player.breastRows[2].breastRating >= 20)
            {
                outputText("  Your lower beach ball sized breasts are large enough to rest on the floor to either side as you fuck, and both witches eventually lower the legs they've had raised so as to hook them around your massive mammaries and hug your flesh even closer to their thighs.");
            }
        }
        if (player.hasBalls())
        {
            outputText("  The closer your shafts come to their climax the more tense your balls become, preparing to pump their loads through your cocks.");
        }
        ...
        if (player.cumQ() < 500)
        {
            outputText("  The pair of girls yelp as they feel the hot seed splash forth inside them.  Millions of sperm swim in to their fertile wombs, seeking to turn them into doubly pregnant sluts.");
        }
        //{else if cumHigh}
        else if (player.cumQ() < 1000)
        {
            outputText("  The slutty pair of milk bags cry out in sensual surprise as they feel extraordinary amounts of cum pumping directly into their baby makers, knocking them up with the double pregnancy they've desperately wanted. Their bellies bulge with all of the cum you've deposited within them.");
        }
        //{else if cumVeryHigh}
        else if (player.cumQ() < 3000)
        {
            outputText("  The two piles of tits and bellies scream in pleasured insanity as their empty wombs are assaulted with a surging torrent of jizz.  You can feel the heavy blasts of cum surging within your shafts as they flood forth in to slutty orifices that have swallowed your manhoods.  Your brain burns with ecstasy as your genitals pump each womb over and over again, forcing them to swell far beyond what they're intended to take from cum alone.  By the time your cocks feel satisfied each witch looks as if she's already full term with a second child, the cum filled womb creating a distinct second orb next to the first pregnancy.");
        }
        //{else if cumExtreme}
        else
        {
            outputText("  The eyes of every witch in the room open wide in shock as they watch their sister's bellies swell obscenely.  Your cocks feel as if they're trying to wrest control of your body from you as liters of hot sperm pump forcefully directly in to the extra fertile wombs of each slutty witch.  The two quad-breasted whores convulse in brain damaging pleasure, causing their huge milk filled tits to quake and bounce everywhere. A white flood of ejaculate erupts from their pussies around your cocks as their overfilled wombs fail to contain your bounty of baby batter.");
        }
        //{if player has 4+ cocks ie; did anal}
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) >= 4 || player.countCocks(-1, 50) >= 4)
        {
            outputText("  Streams of cum drip from their abused anuses as you finish them off.");
        }
    ...
    public function fuckAllThePregWitches() : Void
    {
        ...
        if (fitCnt == 1)
        {
            outputText("belly sways");
        }
        else
        {
            outputText("bellies sway");
        }
        ...
        {
            outputText("their bodies");
        }
        outputText(" to the limit.");
        //{if player has non-huge tits}
        if (player.biggestTitSize() > 3 && player.biggestTitSize() < 10)
        {
            outputText("  Your tits bounce as you enthusiastically grind away.");
        }
        //{else if player has huge tits}
        else if (player.biggestTitSize() >= 10 && player.biggestTitSize() < 20)
        {
            outputText("  The heavy weight of your huge tits causes them to sway with every thrust of your hips.");
        }
        //{if player has really huge tits}
        else if (player.biggestTitSize() >= 20)
        {
            outputText("  The immense swells of your mammaries press down upon the ass of the girl in front of you.");
        }
        //{if player has four non-huge tits}
        if (player.bRows() >= 2)
        {
            if (player.breastRows[1].breastRating >= 3)
            {
                outputText("  Your second row of breasts slap against the ass cheeks of the girl in front of you.");
            }
        }
        ...
        if (player.lactationQ() >= 200)
        {
            ...
            if (fitCnt == 1)
            {
                outputText("the witch's tanned backside");
            }
            else
            {
                outputText("the collective tanned bodies you're impaling");
            }
        ...
        if (fitCnt == 1)
        {
            outputText("girl's cunt on your cock");
        }
        else
        {
            outputText("the girls' cunts on your cocks");
        }
        ...
        if (fitCnt == 1)
        {
            outputText("it craves");
        }
        else
        {
            outputText("they crave");
        }
        ...
        if (fitCnt == 1)
        {
            outputText("it the load of baby batter it craves");
        }
        else
        {
            outputText("them the loads of baby batter they crave");
        }
        outputText(".");
        ...
        if (fitCnt == 1)
        {
            outputText("underside of your shaft swells");
        }
        else
        {
            outputText("undersides of your shafts swell");
        }
        outputText(" as your bounty of man-seed floods your full length and stretches the ");
        if (fitCnt == 1)
        {
            outputText("witch's cunt");
        }
        else
        {
            outputText("witches' cunts");
        }
        outputText(" even wider.  Pressing as far forwards as possible you align the ");
        if (fitCnt == 1)
        {
            outputText("tip of your tool against her abused cervix");
        }
        else
        {
            outputText("tips of your tools against their weakened cervixes");
        }
        ...
        else
        {
            ...
            if (fitCnt == 1)
            {
                outputText("whorish witch's back");
            }
            else
            {
                outputText("collective grouping of the witches' asses");
            }
            outputText(".");
        }
    ...
    public function milkBathsAhoy() : Void
    {
        ...
        if (player.gender > 0)
        {
            addButton(1, "DrinkNFap", drinkNFap).hint("Drink some milk and masturbate.", "Drink & Masturbate");
        }
    ...
    public function grabTheMilkGirl() : Void
    {
        ...
        {
            outputText(", pressing deep into your own huge rack, your nipples flicking across her own leaky tits");
        }
        outputText(".");
        ...
        {
            outputText("sexless crotch, still burning hotly with your desires");
        }
        ...
        if (player.cor < 70)
        {
            outputText("and you're quick to pull back, not wanting to force her, but to your surprise and delight, she reaches back and takes your hand in hers, moving you back to finger her");
        }
        // if Corrupt> 70:
        else
        {
            outputText("and grinning with lusty fervor, you push harder, slipping your fingers into her with ease, her milk providing the perfect lubricant to penetrate her.  The slave girl trembles at your sexual advance, but either does not want to stop you out of well-trained fear, or just doesn't want you to stop");
        }
        ...
        if (player.hasCock())
        {
            ...
            if (player.hasBalls())
            {
                outputText(", her other hand cupping your [balls], rolling the " + num2Text(player.balls) + " orbs in her palm with surprising dexterity");
            }
        ...
        if (player.hasVagina())
        {
            ...
            if (player.lactationQ() >= 200)
            {
                outputText("  A spurt of milk escapes your own full jugs, joining the pool-full of your new friend's.  She gasps with surprise and delight, quickly nuzzling herself into your back and going to work, milking you just as she would herself, letting the hefty flow of your motherly fluids pour into the pool, odd trickles smearing down your chest, staining your chest as white as her own.");
            }
        }
    ...
    public function fuckMilkbabeWithPenor() : Void
    {
        ...
        {
            outputText("hilting her in one long stroke");
        }
        else if (player.cockArea(x) < 50)
        {
            outputText("pushing your many inches into her until your hips join, her nice and loose cunt easily taking your length");
        }
        else
        {
            outputText("your cock gaining as much entrance as your massive member can, the excess dickmeat embraced in cream between you");
        }
    ...
    public function ladyFucks() : Void
    {
        ...
        if (player.lactationQ() >= 200)
        {
            outputText(", drawing out a trickle of milk from your motherly reserves.  She gulps deeply, smiling up at you as a trickle of your milk runs down her chin, dripping into the pool of her own");
        }
        ...
        if (player.lactationQ() >= 200)
        {
            outputText(", milking you with skill beyond anything you've ever experienced before; and why not, when her entire existence revolves around that self-same skill?");
        }
        else
        {
            outputText(".");
        ...
        if (player.lactationQ() >= 200)
        {
            outputText(", spraying milk all over yourself and the milkmaid who caused your explosive pleasure");
        }
    ...
    public function drinkNFap() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("[vagina] and idly stroke your puffy, lust-engorged vulva");
        }
        else
        {
        ...
        if (player.hasCock())
        {
            outputText(", but it does little to hide the swelling of [eachCock] - you have the milk for that");
        }
        outputText(".");
        ...
        if (player.gender == 3)
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText("  You make sure to fondle each of your members equally, caressing, squeezing, and stroking to the tempo of your swelling passion.");
            }
        ...
        else
        {
            ...
            {
                outputText("  With your offhand, you cradle your [sack], hefting your [balls] as you feel your desire churning to new levels.");
            }
        }
        //(TOGETHER)
        ...
        if (player.hasCock())
        {
            ...
            if (player.cumQ() >= 500)
            {
                outputText("  With every torrent of seed you release, you can see it lift partway out of the tub, propelled by your incredible virility towards the nearest female specimen.");
            }
            if (player.cumQ() >= 3000)
            {
                outputText("  Soon, the tub's fluid contents break out of their confines to stain your companion's dusky flesh white, an alabaster glaze that would entice you to further feats of debauchery were it not for the pleased contentment your maleness now radiates.");
            }
        }
        if (player.hasVagina())
        {
    ...
    public function sandPregUpdate(womb : Dynamic) : Bool
    //1:
    {
        
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(336, Reflect.field(womb, "type")))
        {
        ...
        //2:
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(280, Reflect.field(womb, "type")))
        {
            ...
            {
                outputText("starting to lactate");
            }
            else
            {
                outputText("lactating more");
            }
            ...
            while (i > 0)
            {
                ...
                {
                    player.breastRows[i].breastRating = 1;
                }
            }
        ...
        //3:
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(216, Reflect.field(womb, "type")))
        {
            ...
            {
                i--;
                if (player.breastRows[i].breastRating < 20)
                {
                    player.breastRows[i].breastRating++;
                }
                else
                {
                    player.breastRows[i].breastRating += 0.5;
                }
            }
            while (player.biggestLactation() < 1.5)
            {
        ...
        //4:
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(180, Reflect.field(womb, "type")))
        {
        ...
        //5:
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(120, Reflect.field(womb, "type")))
        {
        ...
        //6:
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(72, Reflect.field(womb, "type")))
        {
        ...
        //7:
        if (Reflect.field(womb, "incubation") == sceneHunter.adjustPregEventTimer(48, Reflect.field(womb, "type")))
        {
    ...
    public function roomEntrance() : Void
    {
        ...
        else if (flags[kFLAGS.TIMES_SUBMITTED_TO_SANURA] + flags[kFLAGS.TIMES_WINFUCKED_SANURA] > 0)
        {
            ...
            if (flags[kFLAGS.BEATEN_SANURA_COUNT] > 0)
            {
                outputText("  Or would you rather skip the formalities?  We both know who's got the sharper wit, I should think.");
            }
            outputText("</i>\"");
            //(Display Options: [Riddle Game] [Fight] [Leave])
            addButton(0, "Riddle Game", riddleGameGo).hint("Start the riddle game.");
        ...
        if (flags[kFLAGS.BEATEN_SANURA_COUNT] + flags[kFLAGS.SANURA_DISABLED] == 0)
        {
            removeButton(6);
        }  //Locks north.  
    ...
    public function roomCaveCommons() : Void
    {
        ...
        {
            outputText("The women you defeated before have returned to their tasks, casting wary glances your way from time to time but no longer threatening.");
        }
    ...
    public function roomLustRoom() : Void
    {
        ...
        if (silly())
        {
            outputText("  Clearly, if you wanted to, you could put some extra meat in a sand witch.");
        }
    ...
    public function roomBathroom() : Void
    {
        ...
        if (Std.is(flags[kFLAGS.MILK_NAME], Float))
        {
    ...
    public function roomCumWitchOffice() : Void
    {
        ...
        else
        {
            ...
            if (flags[kFLAGS.CUM_WITCH_DEFEATED] == 0)
            {
                ...
                if (player.hasVagina())
                {
                    outputText("but then, maybe you can come to serve us as a mother.  Our tribe is not wasteful.");
                }
                else if (player.hasCock())
                {
                    outputText("but perhaps, once you have been disabused of your notions of freedom, you could serve as my loyal cum-pump.  It does get so tiring inseminating all these girls alone.");
                }
                else
                {
                    outputText("but then, perhaps you could be made to serve in other ways.");
                }
                outputText("</i>\"");
