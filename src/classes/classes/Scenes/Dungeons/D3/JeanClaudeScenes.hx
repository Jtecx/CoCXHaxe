...
/**
	 ...
	 * @author Gedan
	 */
class JeanClaudeScenes extends BaseContent
{
    ...
    public function gogoFuckTheseBasilisks() : Void
    {
        ...
        {
            outputText("  You can’t be mistaken for anything but a demon, after all.");
        }
        ...
        if (player.isNaga())
        {
            outputText("  You’re probably imagining things, but the passage of your sinuous form over the wire surface seems absurdly loud, an endless rubbing of sandpaper which seems to fill the hall.");
        }
        else if (player.isGoo())
        {
            outputText("  Godsdamn this form... you try not to think as you slide across the wire surface, intensely aware of the slimy sound you make as you go, of the steady drip of your fluids through the mesh, trying not to think of it splashing down on curious, blunt heads.");
        }
        else
        {
            outputText("  Clack, clack, clack. You are intensely aware of the sound of your [feet] on the wire surface. You close your eyes and tell yourself you’re only imagining that it’s loud, that it echoes around the hall, that the basilisks would have to be deaf not to hear you.");
        }
    ...
    public function capturedByBasilisks() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText(" [eachCock] stiffening");
        }
        ...
        if (player.hasVagina())
        {
            outputText(" your [vagina] beading with excitement");
        }
        if (!player.hasCock() && !player.hasVagina())
        {
            outputText(" your loins aflame with excitement");
        }
    ...
    public function beatDaFuckhugeBasilisk(hpVictory : Bool) : Void
    {
        clearOutput();
        ...
        if (player.mf("m", "f") == "f" && silly())
        {
            outputText("  You raise your fists in glee and crow \"<i>I AM THE LIZARD QUEEN!</i>\" at the ceiling.");
        }
    ...
    public function fuckhugeBasiliskFuckedYouUp(hpVictory : Bool) : Void
    {
        clearOutput();
    ...
    private function regularBadEnd() : Void
    {
        ...
        else
        {
            ...
            if (player.hasVagina())
            {
                outputText(" your [vagina] beads with excitement");
            }
            if (player.hasCock() && player.hasVagina())
            {
                outputText(" and");
            ...
            {
                outputText("  You realize vaguely you already have taken your clothes off, undoubtedly your own subconscious preparing you for this moment.");
            }
            else
            {
                outputText("  You really are uncomfortably hot underneath the glare of those eyes. Hardly even aware you’re doing it, you begin to take off your [armor]. Piece after piece falls to the floor until you are naked before him.");
            }
            ...
            if (player.skinAdj != "smooth" || player.skinAdj != "latex" || player.skinAdj != "rubber")
            {
                ...
                {
                    outputText("  Your fur drops away in ragged clumps as you drink.");
                }
            ...
            if (player.hasVagina())
            {
                outputText(" your [vagina] dribbling excitement");
            }
            ...
            if (player.hasCock())
            {
                outputText(" your [cock] straining helplessly");
            }
            ...
            if (player.isBiped())
            {
                outputText("  The transformation isn’t quite complete; your mouth opens as a will not your own forces your arms and legs to open, leaving you completely exposed. It takes you a few seconds to realize that your mouth opening wasn’t your doing, either. It won’t close.");
            }
            else
            {
                outputText("  The transformation isn’t quite complete; your mouth opens as a will not your own forces your arms to open and your monstrous bottom half to take on a stance as close to complete submission as it will allow, your [hips] flared to the world. It takes you a few seconds to realize that your mouth opening wasn’t your doing, either. It won’t close.");
            }
    ...
    private function bwombBadEnd() : Void
    {
        ...
        else
        {
            ...
            if (player.hasStatusEffect(StatusEffects.RemovedArmor))
            {
                ...
                if (player.isBiped())
                {
                    outputText(" spread your [hips]");
                }
                else
                {
                    outputText(" position yourself");
                }
            ...
            if (!player.hasCock())
            {
                outputText("  His other dick bats into your stomach, thrusting upwards towards your [chest] as he speaks, his eyes transfixing you, drawing you further into his savage, potent, golden dreams of lust and conquest as he speaks.");
            }
            else
            {
                outputText("  His other dick thrusts against your own [cock], hardening it with incessant rubbing as he speaks, his eyes transfixing you, drawing you further into his savage, potent, golden dreams of lust and conquest as he speaks.");
            }
