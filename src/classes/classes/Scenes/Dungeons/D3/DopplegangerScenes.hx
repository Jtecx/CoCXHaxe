...
/**
	 ...
	 * @author Gedan
	 */
class DopplegangerScenes extends BaseContent
{
    ...
    public function getDemGlasses() : Void
    {
        ...
        {
            outputText("  It is honestly surprising, given everything you have encountered since you stepped through that portal what seems years ago, that you are still recognizably human. You wonder if your parents would be able to recognize the battle-hardened " + player.mf("man", "woman") + " clad in " + player.mf("his", "her") + " [armor] standing in front of you to be the wide-eyed youth they bade their heartfelt goodbyes to all that time ago, though.");
        }
        else
        {
            outputText("  The last time you looked into such a sharp reflection you were human; a pang of regret steals through you as you consider probably not even your parents would be able to recognize the strange [race] clad in " + player.mf("his", "her") + " [armor] standing in front of you now.");
        }
    ...
    public function fuckYourself() : Void
    {
        ...
        {
            outputText("  You smile widely at your clone as you undress. Now neither of you will be virgins.");
        }
        else
        {
            outputText("  You smile widely at your clone as you begin to shake off your [armor].");
        }
        ...
        function dickF() : Void
        {
            if (!player.hasVagina())
            {
                ...
                if (player.isNaga())
                {
                    outputText("  You sigh at the smooth, pleasurable feeling of your scales rubbing over each other as you sensuously wind yourself around [his] tail until you are tightly bound together. Twin lithe snake boys wound around each other- all you really need is a paying audience. Or a stick and a hospital. You laugh with a similar tinge of madness that your partner did a short while ago and [he] groans raggedly in response.");
                }
                else if (player.isDrider())
                {
                    outputText("  The tangle of spindly legs in front of you initially puts you off, but then your arachnid instincts take over, and you find yourself eagerly clambering onto [his] bulging back before you know it, your hardening dick pressing against the human softness which rises above the gleaming chitin as your monstrous body presses heavily down onto its mirror counterpart, making [him] groan raggedly.");
                }
                else if (!player.isFurCovered() && player.tailType != Tail.NONE)
                {
                    outputText("  You clamber on top of [him], the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your hardening dick presses against [his] [tail] and [he] groans raggedly in response.");
                }
                else
                {
                    outputText("  You clamber on top of [him], enjoying the give and take of [his] " + ((player.isGoo()) ? "gooey" : "smooth") + " flesh as you lock your [hips] around their mirror counterparts, making [him] groan raggedly in response.");
                }
                ...
                if (player.ass.analWetness > 3)
                {
                    outputText("  No problem for a clone of you, though. You sigh as you push your bulging head against [his] rose, easily opening [him] and pushing deep into [his] oily, pliable depths.");
                }
                else
                {
                    outputText("  Well, tough. [He] is a demon, after all. You sigh as you push your bulging head against [his] rose, slowly working it loose with the repetitive, pleasurable motion until [he] finally relaxes enough for you to push into [his] warm, tight depths.");
                }
                ...
                if (player.hasPerk(PerkLib.Buttslut) || player.hasPerk(PerkLib.MaraesGiftButtslut))
                {
                    outputText("  You glory in your own decision to transform into an eager butt slut; the doppelganger’s back passage is tight, warm butter, accepting and clenching around your bulging prick like the perfect little boypussy you know it to be.");
                }
                ...
                if (player.cumQ() >= 1000)
                {
                    outputText(" You know exactly what to expect; [his] over-clocked physiology makes [him] a veritable cum fountain. As you ride your high, pumping [his] guts full of your warm seed [he] spurts geysers of jizz the length of [his] body onto the floor, wailing at the sheer size of the high owning your body forces [him] to feel. You sit astride [him], admiring and exulting in it at the same time.");
                }
                else
                {
                    outputText("  You ride your high, pumping [his] guts full of your warm seed as you force [him] along with you, guttering jizz on the floor in front of you.");
                }
            ...
            else if (player.hasCock() && player.hasVagina())
            {
                ...
                if (player.isDrider())
                {
                    outputText("  For a moment you consider mounting [him] from behind, allowing your monstrous instincts to take over and fuck [his] ovipositor in a deathly arachnid craze, but the tangle of spindly legs in front of you puts you off. Better to do it face-to-face. You want to drink in your mirror image’s every reaction. Your prick pressing against the human softness, which rises above [his] gleaming chitin as your body presses heavily down onto its mirror counterpart, making [him] groan raggedly.");
                }
                if (player.isFurCovered())
                {
                    outputText("  You clamber on top of [him], the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your dick presses into [his] digitigrade thigh and [he] groans raggedly in response.");
                }
                else
                {
                    outputText(" You clamber on top of [him], enjoying the give and take of [his] " + ((player.isGoo()) ? "gooey" : "smooth") + " flesh as you lock your [hips] around their mirror counterparts, making [him] groan raggedly in response.");
                ...
                if (player.averageVaginalWetness() < 3)
                {
                    outputText(" gleaming invitingly");
                }
                else
                {
                    outputText(" drooling lubricant eagerly");
                }
                ...
                if (player.cumQ() >= 1000)
                {
                    outputText("  You know exactly what to expect; [his] over-clocked physiology makes [him] a veritable cum fountain. As you ride your high, pumping [him] full of your warm seed [he] spurts streams of jizz the length of [his] body on the floor, wailing at the sheer size of the high owning your body forces [him] to feel. You sit astride [him], exulting in and enjoying the sight of it at the same time.");
                }
                else
                {
                    outputText("  You ride your high, pumping [him] full of your warm seed as you force [him] along with you, guttering jizz on the floor in front of you.");
                }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            if (player.isNaga())
            {
                outputText("  You sigh at the smooth, pleasurable feeling of scales rubbing over each other as you sensuously wind yourself around her tail until you are tightly bound together. Twin lithe snake girls wound around each other- all you really need is a paying audience. Or a stick and a hospital. You laugh with a similar tinge of madness that your partner did a short while ago, and she groans raggedly in response.");
            }
            else if (player.isDrider())
            {
                outputText("  You are momentarily thrown by your sixteen spindly legs tangling together, a creepy twitching maze devolving across the floor- but this is definitely the way to do it. Face-to-face. You want to drink in your mirror image’s every reaction. Your [vagina] presses against the human softness which rises above her gleaming chitin as your body presses heavily into its mirror counterpart, eliciting a ragged groan.");
            }
            else if (player.hasFullCoatOfType(Skin.FUR))
            {
                outputText("  You clamber on top of her, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your [vagina] presses into her digitigrade thigh, and she groans raggedly in response.");
            }
            else
            {
                outputText("  You clamber on top of her, enjoying the give and take of her " + ((player.isGoo()) ? "gooey" : "smooth") + " flesh as you lock your [hips] around their mirror counterparts, making her groan raggedly in response.");
            }
            ...
            if (player.thickness > 75 || player.tone < 25)
            {
                outputText(" sending your shared jiggly flesh rippling in separate directions");
            }
            else
            {
                outputText(" your shared, muscled flesh barely moving");
            }
            ...
            if (player.cumQ() > 1000)
            {
                outputText("  You know exactly what to expect; her over-clocked physiology makes her a veritable fem-cum fountain. Your vaginas spurt and spatter against each other, rivulets of shared delirium dribbling onto the floor and dousing your abdomens, the doppelganger wailing at the sheer size of the high owning your body forces her to feel. You sit astride her, exulting in and enjoy the sight of it at the same time.");
            }
            else
            {
                outputText("  You ride your high, shared female delirium wetting your thighs as you force her to ride her high locked deep into you.");
            }
    ...
    public function inSovietCoCSelfFucksYou() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText(", the way your turgid [cock] feels when you grasp it at the base.");
        }
        else if (player.hasVagina())
        {
            outputText(", the way your [vagina] feels when you slide your fingers along its lips.");
        }
        else
        {
        ...
        if (player.hasCock() && !player.hasVagina())
        {
            ...
            if (player.cocks.length > 1)
            {
                outputText("  Your other cocks deliriously tighten and spurt their own loads at the same time, an uncontrollable storm of a high.");
            }
        }
        else if (player.hasCock() && player.hasVagina())
        {
