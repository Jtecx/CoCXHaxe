...
/**
	 ...
	 * @author Gedan
	 */
class LivingStatueScenes extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function encounter() : Void
    {
        ...
        if (silly())
        {
            outputText(" On the plus side, it seems to lack knees. That should make dodging its attacks a bit easier.");
        }
    ...
    public function beatUpDaStatue(hpVictory : Bool) : Void
    {
        clearOutput();
    ...
    private function takeTheStone() : Void
    {
        ...
        {
            outputText(" easily as big as Marae's.");
        }
        else
        {
            outputText(" like the purple crystals in the factory, only this one is three times as big.");
        }
    ...
    public function fuckinMarbleOP(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        clearOutput();
