...
class HelDungeon extends DungeonAbstractContent
{
    public function new()
    {
        super();
    ...
    public function heliaDiscovery() : Void
    {
        ...
        if (flags[kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] == 0)
        {
            ...
            if (player.cor < 50)
            {
                outputText("quickly rush over and stop Hel before she loses a leg to one of your traps");
            }
            //(dick)
            else
            {
                outputText("lazily point out your traps to the not-quite-intruder");
            }
        ...
        if (!player.isTaur())
        {
            outputText("  Her hand slides over to rest on your thigh.");
        }
        else
        {
            outputText("  \"<i>She gives your flank a slow, affectionate stroke.</i>\"");
        }
    ...
    public function agreeToHelpHeliaDungeon() : Void
    {
        ...
        if (!player.isTaur())
        {
            outputText(" and cuddling up in your lap");
        }
    ...
    public function morningAfterHeliaDungeonAgreements() : Void
    {
        ...
        {
            outputText("her head nestled between your soft tits and ");
        }
    ...
    public function gooArmorBeatsUpPC() : Void
    {
        ...
        function vagF() : Void
        {
            ...
            if (player.biggestTitSize() > 1)
            {
                ...
                {
                    outputText("  To her delight, a spray of warm milk jets out of your sore nipples, milky white mixing into blue goo like oil in water. \"<i>Mmm, tasty!</i>\" she teases, massaging more and more from you.</i>\"");
                }
            }
    ...
    public function beatUpGooArmor() : Void
    {
        ...
        {
            outputText("erotic abilities");
        }
        else
        {
            outputText("skill in battle");
        }
    ...
    public function takeGooArmorAndWearIt() : Void
    {
        ...
        cleanupAfterCombat();
        if (player.racialScore(Races.JIANGSHI) >= 15 && player.hasPerk(PerkLib.Rigidity))
        
        //Needs a better explanation, cause why can't jiangshi wear armour again?{
        ...
        else
        {
            ...
            else if (flags[kFLAGS.VALERIA_FOUND_IN_GLACIAL_RIFT] == 0)
            {
                inventory.takeItem(item, roomGuardHall);
            }
            else
            {
    ...
    public function pcLosesToHarpyHorde() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("brutal assault");
        }
        else
        {
            outputText("raw sexuality");
        }
    ...
    public function kiriSexIntro() : Void
    {
        ...
        if (player.gender == 0)
        {
            outputText("Unfortunately, there's not much she can do for you...");
        }
        //find fitting dick
    ...
    public function kiriSexAnal() : Void
    {
        ...
        {
            outputText("you can fit no more in");
        }
        else
        {
            outputText("you are buried to the hilt");
        }
        ...
        if (player.cockArea(x) > 60)
        {
            outputText("as far in as you can manage");
        }
        else
        {
            outputText("filling her completely");
        }
        ...
        if (player.cumQ() > 500)
        {
            outputText("until your cream squelches back out around your cock and onto the floor");
        }
    ...
    public function tortureGear() : Void
    {
        ...
        if (flags[kFLAGS.HEL_DUNGEON_TAKEN_WHIP] == 0 || flags[kFLAGS.HEL_DUNGEON_TAKEN_STRAPS] == 0 || flags[kFLAGS.HEL_DUNGEON_TAKEN_DAGGER] == 0)
        {
            ...
            {
                if (flags[kFLAGS.HEL_DUNGEON_TAKEN_STRAPS] == 0 || flags[kFLAGS.HEL_DUNGEON_TAKEN_WHIP] == 0)
                {
                    outputText(", ");
                }
    ...
    public function helDungeonPrisonerTalk() : Void
    {
        ...
        {
            //[IF PC HAS HARPY KEY A & B]if (player.hasKeyItem("Harpy Key A") >= 0 && player.hasKeyItem("Harpy Key B") >= 0)
            {
    ...
    public function checkOutDemBirdBitches() : Void
    {
        ...
        {
            outputText("You're not aroused enough to rape any of them.");
        }
        addButton(4, "Back", playerMenu);
    }
    ...
    public function phoenixMissionary() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText(" and the tight ring of her pucker");
        }
        outputText(".  You grasp her wide flanks and, lining your [cock " + y + "]");
        if (player.cockTotal() > 1)
        {
            outputText(" and extra boner up with her holes");
        }
        else
        {
            outputText(" up with her hole");
        }
    ...
    public function harpyQueenBeatsUpPCBadEnd() : Void
    {
        ...
        else
        {
            ...
            if (player.hasCock())
            {
                outputText("sperm bank");
            }
            else
            {
                outputText("incubator");
            }
            ...
            if (!player.hasCock())
            {
                outputText(", even if the sudden new sensations nearly broke your mind when the harpies used their magics to grow these huge male implements on your body");
            }
            ...
            {
                addButton(1, "Retry", retryDungeonFromBadEndPrompt);
            }
        }
    }
    ...
    public function HeliaThroneRoom() : Void
    {
        ...
        if (flags[kFLAGS.HEL_PC_TALKED_WITH_HAKON] > 0)
        {
            addButton(0, "Hakon", heliaHakonTalk).hint("Ask Helia about Hakon, the salamander you've found in the dungeon.");
        }
        addButton(1, "Kiri", heliaKiriTalk).hint("Ask Helia about Kiri, the half-breed girl.");
        if (flags[kFLAGS.HARPY_QUEEN_EXECUTED] == 0)
        {
            addButton(2, "Queen", heliaQueenTalk).hint("Ask Helia about the Harpy Queen.");
        }
        addButton(4, "Back", playerMenu);
    }
    ...
    public function heliaHakonTalk() : Void
    {
        ...
        if (flags[kFLAGS.HARPY_QUEEN_EXECUTED] == 0)
        {
            outputText("  \"<i>You're going to pay for what you did to my father, you bitch.  I promise you that.</i>\"");
        }
    ...
    public function heliaQueenTalk() : Void
    {
        ...
        {
            outputText("  \"<i>Maybe snap her neck afterwards.</i>\"");
        }
        doNext(playerMenu);
    }
    ...
    public function harpyQueenLetHerGoForgive() : Void
    {
        ...
        {
            outputText("that poor salamander ");
        }
    ...
    public function harpyQueenSexAnal() : Void
    {
        ...
        {
            outputText("until your hips sink into her pillowy ass");
        }
        else
        {
            outputText("until your massive [cock] can go no further inside her");
        }
    ...
    public function vaginalHarpyQueenSex() : Void
    {
        ...
        if (player.biggestCockArea() < 48)
        {
            outputText("  Not to be outdone, you slam your hips forward, ramming your [cock] into the queen's depths until you catch up with Hel, pounding the entrance to her womb.");
        }
    ...
    public function roomGuardHall() : Void
    {
        ...
        if (flags[kFLAGS.WON_GOO_ARMOR_FIGHT] + flags[kFLAGS.LOST_GOO_ARMOR_FIGHT] == 0)
        {
            ...
            {
                outputText("  You recall there was a suit of half-plate armor.  The rack appears to be empty.");
            }
        }
    ...
    public function roomCellar() : Void
    {
        ...
        {
            outputText("just enough room to stand up in");
        }
        else
        {
            outputText("a ceiling so low you have to crouch");
        }
    ...
    public function roomStairwell() : Void
    {
        ...
        else
        {
            if (flags[kFLAGS.HEL_HARPY_QUEEN_DEFEATED] == 0)
            {
                ...
                {
                    addButton(1, "Valeria", talkToValeria).hint("Talk to Valeria about the current situation.");
                }
                addButton(0, "Kiri", kiriInteraction).hint("Approach Kiri, the half-breed girl.");
            }
            else if (dungeons.checkPhoenixTowerClear())
            {
    ...
    public function roomDungeon() : Void
    {
        ...
        else
        {
            if (flags[kFLAGS.CLEARED_HEL_TOWER] == 0)
            {
                ...
                outputText(".");
                if (player.hasKeyItem("Harpy Key A") >= 0 && player.hasKeyItem("Harpy Key B") >= 0)
                {
    ...
    public function roomMezzanine() : Void
    {
        ...
        else
        {
            ...
            {
                outputText("You're standing in the Mezzanine of the tower, a small terrace with a magnificent view of the High Mountains and the valleys below.  There are stairs leading up and down from here.");
            }
            ...
            if (flags[kFLAGS.CLEARED_HEL_TOWER] == 0)
            {
                addButton(0, "Phoenixes", checkOutDemBirdBitches).hint("Examine the phoenixes and possibly sate your baser needs.");
            }
        }
    }
