...
class SandMother extends Monster
{
    ...
    override private function performCombatAction() : Void
    {
        ...
        {
            choices[choices.length] = getWhispered;
        }
    ...
    //Begins focusing into her staff, which floats in front of her.  PC disrupt attack by attacking.  Attack hits at half strength if disrupted.
    {
        ...
        if (player.inte > 40)
        {
            outputText("  She's not even looking at you and seems steeled against lusty interruptions.  Perhaps you can hit her hard enough to shatter her concentration.");
        }
        createStatusEffect(StatusEffects.Gigafire, 0, 0, 0, 0);
    }
    public function gigaFire2() : Void
    {
        var damage : Int = as3hx.Compat.parseInt(40 + rand(11));
        //Not interrupted:
    ...
    public function sandMotherTelekinesis() : Void
    {
        ...
        var sizeMod : Float = 100;
        var thickMod : Float = player.thickness / 100 + 0.5;
        sizeMod += player.tallness * thickMod;
        if (sizeMod < 140)
        {
            outputText("  You immediately wish you weren't so small, as you're sure she couldn't have flung a heavier champion nearly as easily. ");
        }
        else if (sizeMod >= 200)
        {
            outputText("  You're glad for your size, as she couldn't seem to accelerate you into the stone as fast as she'd like.  Sometimes eating plenty pays off. ");
        }
        ...
        var multiplier : Float = sizeMod / 170;
        var damage : Float = 20;
    ...
    public function eatALightningBolt() : Void
    {
        ...
        var damage : Int = as3hx.Compat.parseInt(60 + rand(20));
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        ...
        {
            SceneLib.dungeons.desertcave.gargoyleBadEndSandWitches();
        }
        else
        {
