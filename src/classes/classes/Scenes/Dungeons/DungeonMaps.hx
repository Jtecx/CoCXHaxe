...
class DungeonMaps extends DungeonAbstractContent
{
    public function new()
    {
        super();
    ...
    private var maps : Array<Dynamic> = [
    ...
    ], 
        {
            ...
            r : DUNGEON_RIVER_FLOOR_03_ROOM_18,
    ...
    ], 
        {
            ...
            r : DUNGEON_RIVER_FLOOR_04_ROOM_19,
    ...
    public function chooseRoomToDisplay(location : Dynamic) : Void
    {
        for (map in maps)
        {
