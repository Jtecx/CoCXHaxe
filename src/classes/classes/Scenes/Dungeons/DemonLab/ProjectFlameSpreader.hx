 ...
 */
class ProjectFlameSpreader extends Monster
{
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        ...
        if (flags[kFLAGS.PLAYER_COMPANION_1] == "Kiha" || flags[kFLAGS.PLAYER_COMPANION_2] == "Kiha" || flags[kFLAGS.PLAYER_COMPANION_3] == "Kiha")
        {
            outputText(" Kiha roars, swinging her axe at the slutty dragoness, but she too is weakened from the fight, and the flamespreader easily parries. She knocks Kiha out with a single strike, and looms over you.");
        }
        ...
        {
            outputText("She dives towards your groin, but to her displeasure, finds no cock there. She scoffs, shaking her head. “<i>Useless cunt</i>” , she mutters. You try to stand, but she ruthlessly kicks you across the face. You lie back, dazed, only to see the rapidly approaching shadow of her taloned foot again.[pg]");
        }
        cleanupAfterCombat();
    }
