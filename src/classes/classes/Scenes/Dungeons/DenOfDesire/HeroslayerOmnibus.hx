...
class HeroslayerOmnibus extends Monster
{
    ...
    private function singleWhipStrike() : Void
    {
        ...
        else
        {
            ...
            damage = as3hx.Compat.parseInt((eBaseDamage() * 1.5) - Math.random() * (player.tou + player.armorDef));
            if (damage > 0)
            {
            ...
            {
                outputText("<b>([font-miss]" + damage + "[/font])</b>");
            }
        }
        statScreenRefresh();
        outputText("\n");
    ...
    public function moveShadowfire() : Void
    {
        ...
        else
        {
            ...
            if (statusEffectv1(StatusEffects.Uber) == 0)
            {
                ...
                if (rand(2) == 0)
                {
                    outputText("The demonic hermaphrodite begins forging demonic symbols in the air before her, each glowing brilliant purple before they blur away in a haze.");
                }
                else
                {
                    outputText("The demonette makes obscene motions with her hands, as if masturbating an imaginary cock or vagina while her hands are wreathed in purple flames.");
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        outputText("  Too horny and pleasured to resist, you lie down and tremble, occasionally rubbing yourself to enhance the bliss.");
                    }
                }
            }
        }
