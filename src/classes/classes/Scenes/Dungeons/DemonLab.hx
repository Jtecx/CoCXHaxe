...
//Enemies
//
class DemonLab extends DungeonAbstractContent implements SaveableState
{
    public static var MainAreaComplete : Float;  //goes up by one for each of the main areas you complete, 1-3 for each ballroom section, 4 for dungeon complete  
    ...
    public static var EnteredBefore : Bool;  // False for first time entering the dungeon  
    public static var TyrantFollower : Bool;
    public static var DivaFollower : Bool;
    public static var KihaFollower : Bool;
    public static var Followercount : Int;
    public static var DragonLabEntry : Int;  //0 for first time, 1 once you've entered before  
    public static var NightwalkerEntry : Bool;
    public static var NightwalkerLabstate : Int;  //0 for unopened, 1 for entered, 2 for finished, 3 for tank used  
    public static var NightCodec : Bool;  //whether or not you've taken the Codec  
    public static var FSpreaderCodec : Bool;  //whether or not you've taken the Codec  
    public static var WayOutBlocked : Bool;  //true for blocked, false for not  
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            SexlessLabState = Reflect.field(o, "SexlessLabState");
            TyrantLabEntry = Reflect.field(o, "TyrantLabEntry");
            TyrantLabState = Reflect.field(o, "TyrantLabState");
            DridersState = Reflect.field(o, "DridersState");
            EnteredBefore = Reflect.field(o, "EnteredBefore");
            TyrantFollower = Reflect.field(o, "TyrantFollower");
            DivaFollower = Reflect.field(o, "DivaFollower");
            KihaFollower = Reflect.field(o, "KihaFollower");
            Followercount = Reflect.field(o, "Followercount");
            DragonLabEntry = Reflect.field(o, "DragonLabEntry");
            NightwalkerEntry = Reflect.field(o, "NightwalkerEntry");
            NightwalkerLabstate = Reflect.field(o, "NightwalkerLabstate");
            NightCodec = Reflect.field(o, "NightCodec");
            FSpreaderCodec = Reflect.field(o, "FSpreaderCodec");
            MainAreaComplete = Reflect.field(o, "MainAreaComplete");
            WayOutBlocked = Reflect.field(o, "WayOutBlocked");
            FSpreaderState = Reflect.field(o, "FSpreaderState");
        }
    ...
    public var dungeonEnabled : Bool = false;  //allows entering the dungeon in not  
    public function canFindLethice() : Bool
    //allows finding Lethice after completion
    {
    ...
    {
        return player.hasKeyItem("Zetaz's Map") >= 0;
    }
    //================================================================================
    ...
    public function canEnterPanic() : Bool
    {
    ...
    public function roomEntrance() : Void
    {
        ...
        if (!EnteredBefore)
        {
            ...
            if (silly())
            {
                outputText("“<i>No, but nobody cares about Lethice or any of her demons. Some angel ladies are taking over right now - and they care much more about science. One was slightly weird and obsessed with rabbits, another took notes constantly. They are weird.</i>”");
            }
    ...
    public function Ballroom1() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("Your stomach churns");
        }
        else if (player.cor < 66)
        {
            outputText("You wince slightly");
        }
        else
        {
            outputText("You feel a surge of arousal");
        }
    ...
    public function Ballroom2() : Void
    {
        ...
        {
            outputText("The groans of the beaten and abused fill the hall, and you struggle to keep your eyes off of the naked forms. You shiver, knowing in your heart that if you fail, you could easily end up here yourself.");
        }
        else
        {
        ...
        if (SexlessLabState > 0 && MainAreaComplete < 3)
        {
            outputText("<b>You still hear the sounds from the eastern door. Maybe check it after you're done clearing this lab?</b>");
        }
    ...
    public function afterNightwalkerFight() : Void
    {
        ...
        if (DivaFollower)
        {
            outputText("A torch is lit, and you see your draculina carrying it, lighting the way.");
        }
        else
        {
            outputText("You fumble around in the darkness until you happen on a sconce. Lighting it, you look back at your foe, taking a torch from the wall for light.");
        }
        outputText("\n"
    ...
    private function NightwalkerLabTank() : Void
    {
        ...
        if (NightwalkerLabstate == 2)
        {
            ...
            {
                outputText("You have no idea what this device is used for... but the blood down below makes you uneasy. The white shards... You think they might be bone... Only one way to find out what this thing does, right? \n"
                        + "\n"
        ...
        {
            outputText("The blood-blender has been destroyed, shattered glass and bent metal, a dark reminder of what happened here. The metallic scent of blood is still in the air.");
        }
        doNext(NightwalkerLab2);
    }
    ...
    public function TyrantLab1() : Void
    {
        ...
        function getTyrantEntry() : Void
        {
            ...
            {
                flags[kFLAGS.CODEX_ENTRY_TYRANT] = 2;
            }  //overriding default behavior, adding info to codex flag.  
            doNext(TyrantLab1);
        };
    }
    ...
    public function panicRoom() : Void
    {
        ...
        if (player.hasKeyItem("Map to the Lethice’s Fortress") < 0)
        {
    ...
    public function TelAdreBring() : Void
    {
        ...
        {
            outputText("sneers slightly, setting her jaw");
        }
        else if (flags[kFLAGS.URTA_PC_AFFECTION_COUNTER] >= 30 && flags[kFLAGS.URTA_PC_LOVE_COUNTER] == 0)
        {
            outputText("grins widely at the sight of you");
        }
        else
        {
            outputText("blinks in surprise");
        }
        if (flags[kFLAGS.URTA_INCUBATION] > 0)
        {
            outputText(". She breaks decorum entirely, walking up to you and giving you a big hug before returning to her more serious role");
        }
        outputText(".\n\n");
        ...
        {
            outputText("“<i>[name] here literally helped me bring an uncorrupted God back into play. If that isn’t contributing to Tel’Adre’s safety, I don’t know what is.</i>” This from Urta, who gives you a warm smile.\n\n");
        }
        if (SceneLib.urtaPregs.urtaKids() > 0 && flags[kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0)
        {
            outputText(" The pig-morph gives both women a glare. “<i>Ah, so this is the one you’ve both been sleeping with.</i>” The two ladies look at each other, grinning. Brag rolls his eyes.\n\n");
        }
