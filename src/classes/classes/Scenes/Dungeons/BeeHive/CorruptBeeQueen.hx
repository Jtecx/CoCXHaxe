...
class CorruptBeeQueen extends Monster
{
    ...
    public function corruptBeeQueenEggCannon() : Void
    {
        ...
        else
        {
            ...
            player.buff("Corrupted Queen Bee Honey").addStats({
                                        spe : -10
                                    }).withText("Corrupted Queen Bee Honey").combatPermanent();
        }
    }
    ...
    override private function performCombatAction() : Void
    {
        ...
        if (choice == 0)
        {
            corruptBeeQueenEggCannon();
        }
        if (choice == 1)
        {
            corruptBeeQueenCommandingVoice();
        }
        if (choice == 2)
        {
            corruptBeeQueenCrush();
        }
    }
