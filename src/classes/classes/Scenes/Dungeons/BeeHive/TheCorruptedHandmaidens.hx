...
class TheCorruptedHandmaidens extends Monster
{
    ...
    public function corruptedHandmaidensCompellingAria() : Void
    {
        if (hasStatusEffect(StatusEffects.CHCompellingAria))
        {
            ...
            var CHCA1 : Float = statusEffectv1(StatusEffects.CHCompellingAria);
    ...
    override private function performCombatAction() : Void
    {
        if (monsterIsStunned())
        {
            removeStatusEffect(StatusEffects.CHCompellingAria);
        }
        else if (hasStatusEffect(StatusEffects.CHCompellingAria))
        {
            corruptedHandmaidensCompellingAria();
        }
        else if (rand(2) == 0 && !hasStatusEffect(StatusEffects.AbilityCooldown1) && !hasStatusEffect(StatusEffects.AbilityCooldown2))
        {
