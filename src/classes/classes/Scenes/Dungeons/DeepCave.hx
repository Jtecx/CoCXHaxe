...
class DeepCave extends DungeonAbstractContent
{
    public function new()
    {
        super();
    ...
    private function buyItem(item : Float = 0) : Void
    {
        spriteSelect(SpriteDb.s_sean);
        if (item == 0)
        {
        ...
        if (item == 3)
        {
            incubusBuy(consumables.AGILI_E);
        }
        if (item == 4)
        {
            incubusBuy(consumables.VIXEN_T);
        }
        if (item == 5)
        {
            incubusBuy(consumables.CFISHS);
        }
        if (item == 6)
        {
            incubusBuy(weaponsrange.SSKETCH);
        }
        if (item == 7)
        {
        ...
        if (item == 8)
        {
            incubusBuy(weapons.L_CLAWS);
        }
        //9
        if (item == 10)
        {
            incubusBuy(weapons.LRAPIER);
        }
        if (item == 11)
        {
            incubusBuy(weapons.H_GAUNT);
        }
    }
    ...
    public function getSwordAndGetTrapped() : Void
    {
        ...
        if (player.spe < 50)
        {
            outputText("fall flat on your [ass], slipping on the slick, shifting surface.");
        }
        else
        {
            outputText("stumble and nearly fall, slipping on the shifting, slick surface.");
        }
    ...
    public function loseToValaAsMale() : Void
    {
        ...
        {
            sceneHunter.print("Check failed: tight ass.");
        }
        if (player.ass.analLooseness < 2)
        {
    ...
    public function impGangVICTORY() : Void
    {
        ...
        if (!recalling && monster.HP <= monster.minHP())
        {
    ...
    public function loseToImpMob() : Void
    {
        ...
        if (player.biggestTitSize() > 1)
        {
            ...
            {
                outputText("  Milk starts to squirt from the pressure being applied to your " + breastDescript(0) + ", which only encourages the imp to squeeze even harder.");
            }
            outputText("\n\n");
        }
        //(NIPPLECUNTS!)
        ...
        if (!player.hasVagina())
        {
            outputText(" and forced to start drinking bottle after bottle of succubi milk");
        }
    ...
    public function defeatZetaz() : Void
    {
        ...
        if (!recalling && monster.HP <= monster.minHP())
        {
            outputText("Zetaz sinks down on his knees, too wounded to continue.  He looks up at you with helpless rage in his eyes and asks, \"<i>Are you satisfied now?  Go ahead then, kill me.  My life hasn't been worth living since I met you anyway.</i>\"\n\n");
        }
        //[VICTORY LUST]
        else
        {
            outputText("Zetaz sinks down on his knees and fishes his massive, pre-drooling member from under his loincloth.  He looks up at you, nearly crying and moans, \"<i>Why? Ruining my life wasn't enough?  You had to make me jerk off at your feet too?  Just kill me, I don't want to live anymore.</i>\"\n\n");
        }
        //[Both]
    ...
    public function sexualTortureReleaseZetaz() : Void
    {
        ...
        if (player.lust > 60 || player.lib > 60 || player.cor > 60)
        {
            outputText(", or perhaps perversion,");
        }
    ...
    public function femaleZetazOver() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("beaten out of you");
        }
        else
        {
            outputText("moistening the delta of your legs");
        }
        ...
        {
            outputText("even more wet ");
        }
        else
        {
            outputText("a little wet ");
        }
        outputText("from the masculine scent the aroused penises are producing.  ");
        if (player.cor < 33)
        {
            outputText("How could you be turned on by such a repulsive situation?  You're going to be raped, brainwashed, and either kept as a pet or tossed in a milking tube for the rest of your life and your body is acting like some horny slut!");
        }
        else if (player.cor < 66)
        {
            outputText("You marvel at just how turned on you're getting from the strange situation.  You know you'll be raped, drugged, and used as a toy or milk cow, but your loins are thrumming with warm, wet desire.");
        }
        else
        {
            outputText("How did you wind up in such an arousing situation?  You're going to be raped, drugged, and probably milked in a factory for the rest of your life.  Your body is so fucking turned on that you know you'll love every second of it, but your desire to triumph and dominate mourns the loss of your freedom.");
        }
        ...
        {
            outputText("Unbidden, Scylla's face comes to mind, and you realize the drugs coursing through your veins must be doing something similar to you!  Her visage changes to your own, though the thick, cock-sucking lips remain behind, eager to be penetrated.");
        }
        else
        {
            outputText("Unbidden, you imagine yourself with thick, cock-sucking lips, so swollen and bloated that they're slightly pursed and ready to be penetrated.");
        }
        ...
        if (player.vaginas[0].vaginalWetness >= VaginaClass.WETNESS_DROOLING)
        {
            outputText("gushes fresh fluids into a puddle on the table");
        }
        else if (player.vaginas[0].vaginalWetness >= VaginaClass.WETNESS_WET)
        {
            outputText("drools a heavy flow of liquid arousal onto the hardwood table");
        }
        else
        {
            outputText("begins to dribble a steady flow of liquid on to the table's girl-slicked boards");
        }
        outputText(".  ");
        if (player.inHeat)
        {
    ...
    public function femaleZetazOverPtII() : Void
    {
        ...
        if (player.biggestTitSize() < 1)
        {
            outputText("tweak your " + nippleDescript(0) + "s roughly, pulling and yanking on them as");
        }
        else
        {
            outputText("maul at your [allbreasts], slapping and squeezing them as");
        }
    ...
    //H-fed incubi and succubi potions repeatedly until demonic and even more over-endowed, knocked up while dick is milked by factory like milker + MC?
    {
        ...
        if (player.cor < 33)
        {
            outputText("Are you really being turned on by such lewd, debased thoughts?");
        }
        else if (player.cor < 66)
        {
            outputText("Are you this much of a pervert?  Yes, it'll feel good, but you're a little ashamed of your body's immediate and lewd reaction.");
        }
        else
        {
            outputText("Are you really this much of a submissive?  Yeah, sucking down drinks like this is hot as hell, but you'd like to be doing it on your own terms.  At least you'll probably start cumming after a few bottles worth of the stuff.");
        }
        outputText("\n\n");
        ...
        {
            outputText(" and adding to your existing pair");
        }
        else
        {
            outputText(" and giving you an exotic, tainted appearance");
        }
        outputText(".  ");
        if (player.lowerBody != LowerBody.DEMONIC_HIGH_HEELS)
        {
            outputText("Your [feet] have been changing throughout the ordeal, but you didn't notice your [legs] becoming such lissom, lengthy legs, or your heels growing long, high-heel-like spikes.  ");
        }
        if (player.tailType != Tail.DEMONIC)
        {
            outputText("A tail snakes around your leg and begins to caress your " + vaginaDescript(0) + ", then plunges in to fuck the squirting orifice while you drink.  ");
        }
        else
        {
            outputText("Your tail snakes around your leg and begins to caress your " + vaginaDescript(0) + ", then plunges in to fuck the squirting orifice while you drink.  ");
        }
    ...
    public function hermZetazOverPtII() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("gently shifts your  " + ballsDescript() + " out of the way and ");
        }
    ...
    public function malesZetazOver() : Void
    {
        ...
        {
            outputText("worried he'll try to force the mammoth between his thighs into your backdoor");
        }
        else
        {
            outputText("worried he'll take advantage of your well-stretched backdoor");
        }
    ...
    public function malesZetazOverPtII() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(", and your balls have completely vanished");
        }
        ...
        if (player.cockTotal() == 1)
        {
            outputText("it until it's");
        }
        else
        {
            outputText("them until they're");
        }
        ...
        {
            outputText("It doesn't look right without a decent rack, but boss said no tits for the new breeding bitch.  Sure makes it hard to get excited about fucking that new twat of yours though...");
        }
        else
        {
            outputText("With a rack like that and a nice, wet cunt, you'll have the other guys lining up for their turn in no time...");
        }
    ...
    public function badEndValaNumber2Pt2() : Void
    {
        ...
        else
        {
            ...
            if (player.biggestTitSize() < 1)
            {
                outputText("You shudder and your chest feels like it's being flooded by the spooge floating at your tonsils. Before your eyes, the girdle around your chest is pushed down and a pair of swelling breasts fills your vision, filling heavily with milk just aching to be sucked from your distended nipples.  ");
            }
    ...
    {
        var canEscapeCum : Bool = player.cumQ() > 3500;
        var canEscapeMilk : Bool = player.lactationQ() > 3500 || player.lactationQ() + player.cumQ() > 4500;
        ...
        //good{
            ...
            if (player.gender == 0)
            {
                addButton(2, "Surrender?", escapeGless);
            }
            //bad
            else
            {
        ...
        else if (canEscapeCum)
        {
            escapeCum();
        }
        else if (canEscapeMilk)
        {
            escapeMilk();
        }
        ...
        var surrenderFemale : Void->Void = function() : Void
        {
    ...
    public function zetazBadEndEpilogue_herm() : Void
    {
        ...
        if (player.wings.type != Wings.BAT_LIKE_TINY || player.wings.type != Wings.BAT_LIKE_LARGE)
        {
            outputText("Zetaz gave her one of the weaker imps to penetrate and taught her to fly with her new, demonic wings.  ");
        }
        else
        {
            outputText("Zetaz gave her one of the weaker imps to penetrate during the journey.  ");
        }
    ...
    public function zetazBadEndEpilogue_male() : Void
    {
        ...
        if (player.biggestTitSize() < 1)
        {
            outputText("created a decent set of chest-bumps.");
        }
        else
        {
            outputText("swelled her already impressive rack with milk.");
        }
    ...
    public function roomFungusCavern() : Void
    {
        ...
        if (player.isAlraune() && flags[kFLAGS.ZETAZ_FUNGUS_ROOM_DEFEATED] == 0)
        {
            addButton(0, "Get Sword", getSwordAlrauneSkipsEverything);
        }
        else if (flags[kFLAGS.ZETAZ_FUNGUS_ROOM_DEFEATED] == 0)
        {
    ...
    public function roomTortureRoom() : Void
    {
        ...
        if (flags[kFLAGS.FREED_VALA] == 0)
        {
            ...
            //Intro:{
                ...
                {
                    addButtonDisabled(1, "???", "Req. to have a certain ghostly follower with you.");
                }
            }
            //Zetaz defeated
            else
        ...
        {
            outputText("In the far corner, there are a set of empty manacles, originally set up to contain Vala, who you've long since freed.");
        }
    }
    ...
    public function roomSecretPassage() : Void
    {
        ...
        if (flags[kFLAGS.DEFEATED_ZETAZ] == 0)
        {
            outputText("You're going to find Zetaz and pay him back for drugging you on your first day here.  ");
        }
    ...
    public function roomZetazChamber() : Void
    {
        ...
        else
        {
            ...
            {
                addButton(1, "Drawer", ZetazsBedroomDrawer);
            }
        }
    }
