...
class YourCabin extends DungeonAbstractContent
{
    ...
    public function enterCabin() : Void
    {
        ...
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_NIGHTSTAND] > 0)
        {
            ...
            if (player.hasKeyItem("Equipment Storage - Jewelry Box") >= 0 && flags[kFLAGS.CAMP_CABIN_FURNITURE_DRESSER] <= 0)
            {
        ...
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_TABLE] > 0)
        {
            ...
            if (flags[kFLAGS.CAMP_CABIN_FURNITURE_CHAIR1] > 0 && flags[kFLAGS.CAMP_CABIN_FURNITURE_CHAIR2] <= 0)
            {
        ...
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_DESK] > 0)
        {
            if (flags[kFLAGS.CAMP_CABIN_FURNITURE_BOOKSHELF] > 0)
            {
                outputText("A desk is located right next to your bookshelf. ");
            }
            else
            {
                outputText("Located at the corner opposite the door is a desk. ");
            }
            outputText("It has a drawer to store supplies for writing and studying.  ");
            if (flags[kFLAGS.CAMP_CABIN_FURNITURE_DESKCHAIR] > 0)
            {
                outputText("A nicely constructed chair is tucked under the desk. It provides a place for you to sit on and study.");
            }
            outputText("\n\n");
        }
        ...
        {
            addButton(0, "Study", menuStudy);
        }
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_NIGHTSTAND] > 0 && flags[kFLAGS.BENOIT_CLOCK_BOUGHT] > 0)
        {
            addButton(1, "Set Alarm", menuAlarm);
        }
    ...
    private function menuStudy() : Void
    {
        ...
        if (player.hasKeyItem("Izma's Book - Porn") >= 0)
        {
            addButton(1, "Porn", studyPorn).hint("Libido++");
        }
        if (player.hasKeyItem("Izma's Book - Etiquette Guide") >= 0)
        {
            addButton(2, "E.Guide", studyEtiquetteGuide).hint("Libido--");
        }
        if (player.hasKeyItem("Izma's Book - Combat Manual") >= 0)
        {
    ...
    private function menuFurniture() : Void
    {
        ...
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_NIGHTSTAND] <= 0 && flags[kFLAGS.CAMP_CABIN_FURNITURE_BED] > 0)
        {
            addButton(1, "Nightstand", constructFurnitureNightstandPrompt);
        }
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_DRESSER] <= 0 && flags[kFLAGS.CAMP_CABIN_FURNITURE_BED] > 0)
        {
        ...
        if ((flags[kFLAGS.CAMP_CABIN_FURNITURE_CHAIR1] <= 0 || flags[kFLAGS.CAMP_CABIN_FURNITURE_CHAIR2] <= 0) && flags[kFLAGS.CAMP_CABIN_FURNITURE_TABLE] > 0)
        {
        ...
        if (flags[kFLAGS.CAMP_CABIN_FURNITURE_DESKCHAIR] <= 0 && flags[kFLAGS.CAMP_CABIN_FURNITURE_DESK] > 0)
        {
            addButton(7, "Chair 4 Desk", constructFurnitureChairForDeskPrompt);
        }
        addButton(14, "Back", enterCabin);
    }
