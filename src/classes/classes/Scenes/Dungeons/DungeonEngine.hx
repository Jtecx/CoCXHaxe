...
class DungeonEngine extends DungeonAbstractContent
{
    //Register dungeons
    ...
    public function checkDemonLaboratoryClear() : Bool
    {
    ...
    public function checkHiddenCaveClear() : Bool
    {
    ...
    public function checkHiddenCaveHiddenStageClear() : Bool
    {
    ...
    public function checkDenOfDesireClear() : Bool
    {
        return (flags[kFLAGS.DEN_OF_DESIRE_BOSSES] > 2);
    }
    public function checkBeeHiveClear() : Bool
    {
        return (flags[kFLAGS.TIFA_FOLLOWER] > 5);
    }
    public function checkTwilightGroveClear() : Bool
    {
        return (flags[kFLAGS.TWILIGHT_GROVE_PURIFICATION] > 3);
    }
    public function checkRiverDungeon1stFloorClear() : Bool
    {
        return (flags[kFLAGS.RIVER_DUNGEON_FLOORS_PROGRESS] > 1);
    }
    public function checkRiverDungeon2ndFloorClear() : Bool
    {
        return (flags[kFLAGS.RIVER_DUNGEON_FLOORS_PROGRESS] > 6);
    }
    public function checkRiverDungeon3rdFloorClear() : Bool
    {
        return (flags[kFLAGS.RIVER_DUNGEON_FLOORS_PROGRESS] > 8);
    }
    public function checkRiverDungeon4thFloorClear() : Bool
    {
        return (flags[kFLAGS.RIVER_DUNGEON_FLOORS_PROGRESS] > 10);
    }
    public function checkRiverDungeon5thFloorClear() : Bool
    {
        return (flags[kFLAGS.RIVER_DUNGEON_FLOORS_PROGRESS] > 12);
    }
    ...
    //Using the original award pattern - for first 50 and each 150 rooms.
    {
        ...
        {
            return as3hx.Compat.parseInt((as3hx.Compat.parseInt(flags[kFLAGS.EBON_LABYRINTH] / 150) + 1) * 150);
        }
    }
    public function checkEbonLabyrinthClear() : Bool
    ...
    public function checkEbonLabyrinthNotAwarded() : Bool
    {
    ...
    public function canFindDenOfDesire() : Bool
    {
    ...
    public function setDungeonButtons(northFunction : Function = null, southFunction : Function = null, westFunction : Function = null, eastFunction : Function = null) : Void
    {
        ...
        spriteSelect(null);
        menu();
        if (northFunction != null)
        {
            addButton(6, "North", navigateToRoom, northFunction);
        }
        if (southFunction != null)
        {
            addButton(11, "South", navigateToRoom, southFunction);
        }
        if (westFunction != null)
        {
            addButton(10, "West", navigateToRoom, westFunction);
        }
        if (eastFunction != null)
        {
            addButton(12, "East", navigateToRoom, eastFunction);
        }
    ...
    public function setDungeonButtonsRD(northFunction : Function = null, southFunction : Function = null, westFunction : Function = null, eastFunction : Function = null) : Void
    {
        ...
        addButton(14, "Map", map.displayMapOnlyOne).hint("View the map of this dungeon.");
    }
}
