...
class ImpHorde extends Monster
{
    ...
    public function impGangUber() : Void
    {
        ...
        else
        {
            ...
            {
                outputText(" as they begin to drip milk");
            }
            ...
            if (player.cockTotal() > 0)
            {
                ...
                if (player.hasVagina())
                {
                    outputText(", and in addition, the clothes around your groin ");
                }
            }
            if (player.hasVagina())
            {
                ...
                {
                    outputText(" as your clit swells up in a more sensitive imitation of a cock");
                }
            }
            if (player.gender == 0)
            {
                outputText("rub the sensitive skin of your thighs and featureless groin in a way that makes you wish you had a sex of some sort");
            }
            outputText(".\n");
    ...
    public function impGangBukkake() : Void
    {
        ...
        //+30% chance to avoid attack for evade{
            ...
            if (player.getEvasionRoll())
            {
                ...
                if (damage == 0)
                {
                    outputText("A wad of cum spatters into the floor as you narrowly sidestep it.\n");
                }
                else if (damage == 1)
                {
                    outputText("One of the imps launches his seed so hard it passes clean over you, painting the wall white.\n");
                }
                else if (damage == 2)
                {
                    outputText("You duck a glob of spooge and it passes harmlessly by.  A muffled grunt of disgust can be heard from behind you.\n");
                }
                else if (damage == 3)
                {
                    outputText("You easily evade a blast of white fluid.\n");
                }
            }
            ...
            else
            {
                ...
                if (damage == 0)
                {
                    outputText("A squirt of hot demonic cum splatters into your face!\n");
                }
                if (damage == 1)
                {
                    outputText("Your [allbreasts] are coated with thick demonic spunk!\n");
                }
                if (damage == 2)
                {
                    outputText("Some of the fluid splatters into your midriff and drools down to your waist, making your [armor] slimy and wet.\n");
                }
                if (damage == 3)
                {
                    outputText("Seed lands in your [hair], slicking you with demonic fluid.\n");
                }
                if (damage == 4)
                {
                    outputText("Another blast of jizz splatters against your face, coating your lips and forcing a slight taste of it into your mouth.\n");
                }
                if (damage == 5)
                {
                    outputText("The last eruption of cum soaks your thighs and the lower portions of your [armor], turning it a sticky white.\n");
                }
                player.takeLustDamage(7 + as3hx.Compat.parseInt(player.lib / 40 + player.cor / 40), true);
            }
            lust -= 5;
            hits--;
        }
    ...
    //Multiattack:
    {
        ...
        {
            outputText("The imps come at you in a wave, tearing at you with claws!\n");
        }
        //(ALT BLINDED TEXT)
        else
        {
            outputText("In spite of their blindness, most of them manage to find you, aided by the clutching claws of their brothers.\n");
        }
        ...
        //Clear damage from last loop{
            ...
            else
            {
                if (hits == 6)
                {
                    outputText("You're clawed viciously by an imp!");
                }
                if (hits == 5)
                {
                    outputText("One bites your ankle!");
                }
                if (hits == 4)
                {
                    outputText("An imp rakes his claws down your back.");
                }
                if (hits == 3)
                {
                    outputText("One of the little bastards manages to scratch up your legs!");
                }
                if (hits == 2)
                {
                    outputText("Another imp punches you in the gut, hard!");
                }
                if (hits == 1)
                {
                    outputText("Your arm is mauled by the clawing!");
                }
