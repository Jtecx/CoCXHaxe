...
class ValaScene extends BaseContent implements SaveableState
{
    ...
    public static inline var QUEST_STAGE_STARTED : Int = 1;
    public static inline var QUEST_STAGE_ITEM_GATHERED : Int = 2;
    public static inline var QUEST_STAGE_ITEM_TURNEDIN : Int = 3;
    //public static const QUEST_STAGE_ITEM_SCEPTER_REPAIRED:int = 4; // unused
    public static inline var QUEST_STAGE_PCDECLINED : Int = 5;
    public static inline var QUEST_STAGE_PCDACCEPTED : Int = 6;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            ValaFairyQueenQuest = Reflect.field(o, "stage");
        }
    ...
    public function ValaGetsSexed() : Void
    {
        ...
        var dickF_2 : Int->Void = function(x : Int) : Void
        {
            clearOutput();
            ...
            else
            {
                ...
                if (player.hasVagina())
                {
                    outputText("nuzzling your joy buzzer");
                }
                else
                {
                    outputText("tickling your prostate");
                }
        ...
        var vagF_2 : Void->Void = function() : Void
        {
            clearOutput();
    ...
    public function leftValaAlone() : Void
    {
        ...
        {
            addButtonDisabled(2, "???", "Req. to have a certain ghostly follower with you.");
        }
        //heal
        var honey : Bool = player.hasItem(consumables.PURHONY, 1) || recalling;
        var pearl : Bool = player.hasItem(consumables.P_PEARL, 1) || recalling;
        if (!honey && !pearl)
        {
    ...
    public function useVala() : Void
    {
        ...
        var dickF_2 : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var hermF_2 : Void->Void = function() : Void
        {
            clearOutput();
    ...
    public function wakeValaUpBeforeYouGoGo() : Void
    {
        ...
        var hermF_2 : Void->Void = function() : Void
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText("The " + cockDescript(1) + " inside the fairy girl's ass erupts first, pumping your seed into her bowels, her hips distorting with the bursting flow of your cum, her sphincters clenching powerless to stop your alabaster flood.  ");
            }
    ...
    public function rejectFuckingVala() : Void
    {
        ...
        else
        {
            ...
            if (flags[kFLAGS.TIMES_PC_DEFEATED_VALA_AND_RAEPED] > 0)
            {
                outputText("  You smirk in wonder at the horny little slut.  You guess you'll have to put her back into her place and give her another dose of 'love'.");
            }
            outputText("\n\n");
    ...
    public function valaFightVictoryFuck() : Void
    {
        ...
        function vagF() : Void
        {
            ...
            {
                outputText("You decide to give her a hand, and flap your " + player.wings.desc + " as hard as you can, the added thrust giving her the start she needs.  ");
            }
        ...
        var hermF_2 : Void->Void = function() : Void
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText("Your [cock] inside the fairy girl's ass erupts first, pumping your seed into her bowls, her hips distorting with the bursting flow of your cum, sphincter's clenching powerless to stop your alabaster flood.  ");
            }
    ...
    //Purified Fairy
    public function purifiedFaerieBitchBar() : Bool
    ...
    public function chooseValaInBar() : Void
    {
        ...
        else
        {
            ...
            if (ValaFairyQueenQuest == QUEST_STAGE_ITEM_TURNEDIN)
            
            //Temporary until I work in a timer{
            ...
            if (player.hasCock())
            {
                addButtonDisabled(5, "Date", (model.time.hours == 20) ? "Another time, perhaps?" : "Try visiting the bar in the late evening. :)");
            }
        }
        ...
        if (SceneLib.shouldraFollower.followerShouldra() && !player.hasStatusEffect(StatusEffects.ShouldraOff))
        {
            ...
            {
                addButtonDisabled(3, "???", "Vala is small. Very small. Maybe talk to Shouldra about her, even though she prefers <i>big</i> things?");
            }
        }
        else
        {
            addButtonDisabled(3, "???", "Req. spending more time with <i>ghosts</i>.");
        }
    ...
    public function cleansedFirstRemeet() : Void
    {
        ...
        //(NAGA/CENTAUR
        if (player.isTaur() || player.isNaga() || player.isDrider())
        {
            outputText("You eye the stool doubtfully, but she seems insistent, so you lower your body onto the wooden seat and are surprised when it manages to support your upper torso with only a small groan of protest. You fold the rest of your lower body behind you.  ");
        }
    ...
    public function cleansedValaFuckHerBrainsOut() : Void
    {
        ...
        function vagF() : Void
        {
            ...
            {
                outputText("  The pressure is enough to draw your milk to the surface, tiny jets splashing between the two of you as the fairy milks you with two incredibly agile fingers.");
            }
            outputText("\n\n");
    ...
    public function faerieOrgyFuck() : Void
    {
        ...
        {
            doNext(faerieOrgyFuckFemaleContinue);
        }
        else if (player.gender == 1)
        {
            doNext(faerieOrgyFuckMaleContinue);
        }
    }
    //[Worries]
    ...
    public function Accept() : Void
    {
        ...
        var growth : Int = as3hx.Compat.parseInt(1 + rand(3));
        if (player.breastRows.length > 0)
        {
            ...
            if (player.breastRows[0].breastRating < 3 && rand(2) == 0)
            {
                growth++;
            }
            if (player.breastRows[0].breastRating < 4 && rand(3) == 0)
            {
                growth++;
            }
        }
    ...
    public function faerieOrgyFuckMaleContinue() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("Vala's tongue caresses your [balls], slurping hungrily, eager to get every drop out of your overburdened sac.  ");
        }
        ...
        if (player.cumQ() > 2000)
        {
            outputText("  Even after driving the condom off of you, your cock continues its gushing orgasm, spurting thick bubbles of jizz into the air, raining down in creamy torrents. The small fairies gleefully dive after the cum globs, making a game of it, trying to catch the gooey globs before they splatter on the bed or carpet.");
        }
        outputText("\n\n");
    ...
    public function faerieOrgyFuckFemaleContinue() : Void
    {
        ...
        if (flags[kFLAGS.TIMES_SCYLLA_ADDICT_GROUP_EXPLOITED] + flags[kFLAGS.SCYLLA_TIMES_SHARED_IN_ADDICT_GROUP] + flags[kFLAGS.SCYLLA_MILK_THERAPY_TIMES] + flags[kFLAGS.SCYLLA_CUM_THERAPY_TIMES] + flags[kFLAGS.SCYLLA_SEX_THERAPY_TIMES] > 0)
        {
            outputText("Another fairy flies toward Vala and you blink through the building lusty haze when you recognize the little girl. Wearing a slightly slutty crystalline gown of translucent gossamer, you recognize Pastie, the fairy from Scylla's addiction counseling meeting. When you call out to her, she bashfully waves back. \"<i>Hey, uh, [name]. It's kinda weird seeing you outside of the meetings. How are you? How have things been?</i>\" She looks at your naked, reclined form on the bed and blushes. \"<i>Oh, right, right. Um. I'm just helping out Vala, you know. Sisters and all. Uh. I'm... I'm going to just give her this petal and get something to drink, okay? All this sobriety is making this really uncomfortable for me.</i>\" The other fairies laugh and Pastie hands off her blossom before zipping out of the room, probably to steal someone's drink downstairs.\n\n");
        }
    ...
    public function valaCumBath() : Void
    {
        ...
        if (flags[kFLAGS.VALA_CUMBATH_TIMES] == 0)
        {
            ...
            if (player.cumQ() < 2000)
            {
                ...
                if (player.hasBalls())
                {
                    outputText("  Your balls react immediately, filling with a cold weight that nearly knocks you to your ass.  Your [armor] bulges obscenely as the sack hanging between your legs fills with liquid pressure that squeezes your bloating flesh.");
                }
        ...
        else
        {
            ...
            if (player.cumQ() < 2000)
            {
                outputText("Retrieving a vial of glistening oil, she offers the concoction to you with a laugh.  \"<i>The gal who makes these is so silly.  She always giggles when I pay her a visit and blushes when I call her 'bunny girl'.  She's so cute I just want to give her a squeeze!</i>\" You chuckle and down the draft, a thrill of cold weight filling your gut.  ");
            }
    ...
    public function valaBigYou() : Void
    {
        ...
        else
        {
            ...
            if (silly())
            {
                outputText("The last thing you need is a bunch of winged archers taking potshots at Vala while she clings to a tower with you in her hand...  ");
            }
    ...
    public function bigValaDomsPC() : Void
    {
        ...
        if (flags[kFLAGS.VALA_HEALED_HONEY] == 0)
        {
            outputText("\"<i>If you do a good job, I'll let you taste a pure pearl of my own,</i>\" she giggles.");
        }
        ...
        if (player.gender == 1)
        {
            ...
            if (player.lust >= 70)
            {
                outputText(", already hard, begins to bead with pre-cum, mixing with the slut-leakings that have found their way under your equipment.");
            }
            else
            {
                outputText(" stiffens immediately to a full, throbbing hardness.");
            }
            ...
            {
                outputText("  If only you weren't so big - you can't expand to your full size, and the tightness is almost emasculating at how it constrains your size, keeping you small enough to fit inside your [armor] but still hard as a stone, only this stone is having the pre squeezed out of it.");
            }
        }
        //{Female:}
        else if (player.gender == 2)
        {
            ...
            if (player.wetness() >= 3)
            {
                outputText("Your [vagina] seems to always be wet, but now, with this sight before you, your girl-cum is running in rivers down your [legs] to mix into the puddling lady-spunk below.  ");
            }
        ...
        else if (player.gender == 3)
        {
            ...
            if (player.lust >= 70)
            {
                outputText("You may have already been uncomfortably hard, but you start leaking pre-cum all over the inside of your [armor].  Of course, the copious fem-jizz that's already seeped inside your gear absorbs the extra fluid with little to no complaint.");
            }
            else
            {
                outputText("You get hard with alarming rapidity.  Being so close to such a gloriously large quim seems to overpower your better sense, and you're forced to give in to your body's imperative.");
            }
            ...
            if (player.biggestCockArea() >= 150)
            {
                outputText("  If only you weren't so big!  You're compressed so tightly by your enclosing [armor], and even though you're rock-hard, you're a fraction of your full size.  If only you could get out of your gear and fuck her!");
            }
        }
        //{Genderless}
        else
    ...
    public function bigValaLicksOffDudes() : Void
    {
        ...
        {
            outputText("  It even pauses at one to slip a tiny bit inside, too big to penetrate your nipplecunt properly but teasing it all the same.");
        }
        ...
        if (player.cockTotal() == 1)
        {
            outputText("it slides");
        }
        else
        {
            outputText("they slide");
        }
        outputText(" inside her");
        if (player.biggestCockArea() >= 200)
        {
            outputText(", the immense length sucked in by a surprising burst of suction");
        }
        outputText(".");
        ...
        if (player.biggestCockArea() < 200)
        {
            outputText("smothering your relatively tiny pecker");
        }
        else
        {
            outputText("wrapping up your immense pecker");
        }
        if (player.biggestCockArea() >= 400)
        {
            outputText(", even as it hangs partway down her throat");
        }
        ...
        if (player.biggestCockArea() >= 400)
        {
            outputText(", cock partway down her throat");
        }
        ...
        if (player.hasBalls())
        {
            outputText(", [balls] clenching against Vala's tongue");
        }
        ...
        if (player.cumQ() < 250)
        {
            outputText("  She barely notices the spunk you shoot against her tongue, her drooling saliva washing it away almost immediately, but you're sure she got a nice, salty thrill from it regardless.");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("  She has to noisily gulp down the liquid deposit you leave in her mouth, but with her enhanced size, it's still no more than a creamy morsel.");
        }
        else if (player.cumQ() < 4000)
        {
            outputText("  You slowly flood her mouth with spooge until her cheeks bulge.  The spooge inundates her maw until your lower body floats in it, forcing the girl to swallow hard or risk having the teeming seed spill out around you.");
        }
        else
        {
            outputText("  You immediately flood her mouth, bulging her cheeks with obscene amounts of spunk.  She noisily gulps, mouth working futilely to handle it all, but it's not enough, and jizz begins to burst from the corners of her mouth, almost pushing you out with it.");
        }
    ...
    public function valaDommyVapula3Some() : Void
    {
        ...
        if (!player.hasCock())
        {
            outputText("buckling on your demonic strap-on");
        }
        else
        {
            outputText("stroking [oneCock] eagerly");
        }
        ...
        {
            outputText("fake seed");
        }
        outputText(" without meaning to, the lustiness of the situation just far beyond your ability to bear.");
        if (player.cumQ() > 500)
        {
            outputText("  The demon's purple belly balloons with cum, swelling against your own");
        }
        if (player.cumQ() >= 1500)
        {
            outputText(" as her midriff turns taut and dome-like");
        }
        if (player.cumQ() > 500)
        {
            outputText(".");
        ...
        if (player.cumQ() > 1000)
        {
            outputText("  Waves of spunk pour out from Vapula's lust-swollen lips thanks to your exceedingly potent orgasm.");
        }
    ...
    public function valaLoveyVapula3Some() : Void
    {
        ...
        if (!player.hasCock())
        {
            outputText(", and you buckle on your demonic strap-on, just in case");
        }
        ...
        if (!player.hasCock())
        {
            outputText("that exotic dildo");
        }
        else
        {
            outputText("your [cock smallest]");
        }
    ...
    public function kinathisValaStuff() : Void
    {
        ...
        {
            outputText("  She looks up at you as you seem to tower over her, a");
        }
        else
        {
            outputText("  A");
        ...
        if (player.cockTotal() > 1)
        {
            outputText("most appealing phallus");
        }
        else
        {
        ...
        {
            outputText("Her tongue licks around the throbbing glands, the heady animal musk filling her nose and mind with sweet lust.  ");
        }
        else if (player.cocks[x].cockType == CockTypesEnum.DOG)
        {
            outputText("Her tongue licks around the hot building knot that gently throbs at your base.  ");
        }
        //[anemone cock:
        else if (player.cocks[x].cockType == CockTypesEnum.ANEMONE)
        {
            outputText("Her tongue plays with the squirming tentacles that line the drone of your throbbing phallus.  She shivers and groans as the tentacles sting her full of pleasurable aphrodisiac.  ");
        }
        ...
        if (player.cockArea(x) < 17)
        {
            outputText("Despite her size, you slide in easily, her wet, slippery pussy taking you in and squeezing you in a velvety embrace.  \"<i>Yessss, it's in, it's in!  Mmmm, come to me hero, come to Vala,</i>\" she croons to you, beckoning  you to take her.");
        }
        else if (player.cockArea(x) < 30)
        {
            outputText("\"<i>Ahhh...  yesss, it's in!  Ohh...  come to me hero, come to Vala and fill her with your love!</i>\" she croons to you, beckoning  you to take her.");
        }
        else
        {
            outputText("Ohhh! Ahhh...  Y-Yessss...  Vala’s big strong hero, oh you feel so good inside me!</i>\" she moans and groans as you stretch her tight little fairy cunt with your pulsing prick.  Her stretchy flesh distends as more and more of your cock is fed into her hungry pussy.");
        }
        ...
        if (player.cockArea(x) > 17)
        {
            outputText("  Her hot little body stretches around your girthy prick, distending her belly as you sheath your throbbing arousal into her.");
        }
        ...
        //if ballsize <3:{
            ...
            {
                outputText("  With each hard quaking thrust your balls slap against Vala’s expansive ass.  Your nuts ache under their pent-up load and demand you to shoot it into the sweet fey-girl soon.");
            }
            else if (player.ballSize < 6)
            {
                outputText("  With each hard quaking thrust, your balls smack against Vala’s cushiony ass.  Your hefty, cum-bloated sack, so full, aches for the sweet release into your tender fairy lover.");
            }
            else
            {
                outputText("  With each hard quaking thrust, your fat balls slam against Vala’s pale squeezable ass.  The huge, virile spunk-factories go into overtime, their already taut skin growing tighter as they swell and bloat with your pent-up load.  Your body's natural instincts demand you do your duty as the breeder you are and pack your small lover’s womb full of your spunk until her belly is swollen and seeded with your young.");
            }
        }
