...
class Vala extends Monster
{
    ...
    public function valaCombatDialogue() : Void
    {
        ...
        else
        {
            ...
            {
                outputText("\"<i>If you won't fuck Bitch, you must not be a master,</i>\" she realizes, the fight invigorating her lust-deadened brain. \"<i>You get to be a pet for the masters, too!</i>\"");
            }
            else if (statusEffectv1(StatusEffects.Vala) == 2)
            {
                outputText("\"<i>If the masters like you, maybe they will let Bitch keep you for herself! Won't you like that?</i>\"");
            }
            else if (statusEffectv1(StatusEffects.Vala) == 3)
            {
                outputText("\"<i>We obey the masters. They fed Bitch until she became big enough to please them. The masters love their pets so much, you'll see.</i>\"");
            }
            else if (statusEffectv1(StatusEffects.Vala) == 4)
            {
                outputText("\"<i>Thoughts are so hard. Much easier to be a toy slut. Won't you like being a toy? All that nasty memory fucked out of your head.</i>\"");
            }
            else if (statusEffectv1(StatusEffects.Vala) == 5)
            {
                outputText("\"<i>Bitch has given birth to many of the masters' children. She will teach you to please the masters. Maybe you can birth more masters for us to fuck?</i>\"");
            }
            else
            {
                outputText("\"<i>Bitch loves when her children use her as their fathers did. Sluts belong to them. Slut love them. You will love them too!</i>\"");
            }
        }
    }
    ...
    public function new()
    {
        ...
        var lust : Float = 30 + game.flags[kFLAGS.TIMES_PC_DEFEATED_VALA] * 10;
        if (lust > 80)
        {
            lust = 80;
        }
