...
class MistAngelMR extends AbstractAngel
{
    ...
    {
        var damage : Float = eBaseWisdomDamage() * 0.65;
    ...
    override private function get_long() : String
    {
        ...
        if (hasStatusEffect(StatusEffects.TrueFormAngel))
        {
            str += " purple irises each. Around each of their bodies are three circles each with pair of eyes looking the same as the main eye and above angel head hoover halo.";
        }
        else
        {
