...
class QuatroElementalBoss extends Monster
{
    public function baseElementalAttack() : Void
    {
        ...
        {
            outputText(" You slide underneath the surprise punch!");
        }
        else
        {
    ...
    public function fluffyOfPunches() : Void
    {
        ...
        if (damage <= 0 || (player.getEvasionRoll()))
        {
            outputText(" You slide underneath it avoiding all punches!");
        }
        else
        {
            if (hasStatusEffect(StatusEffects.Provoke))
    ...
    public function subbossSpecial1() : Void
    {
        ...
        {
            outputText(" You slide underneath the barrage. Talk about Pyromania!");
        }
        else
        {
            var damage : Float = inte + wis;
    ...
    public function subbossSpecial2() : Void
    {
        ...
        if (player.getEvasionRoll())
        {
            outputText(" You slide underneath the barrage!");
        }
        else
        {
            var damage : Float = inte + wis;
    ...
    override private function performCombatAction() : Void
    {
        if (_fightPhase == 1)
        {
            ...
            {
                var choice11 : Float = rand(6);
                if (choice11 < 2)
                {
                    fluffyOfPunches();
                }
                if (choice11 == 2 || choice11 == 3)
                {
                    baseElementalAttack();
                }
                if (choice11 > 3)
        ...
        if (_fightPhase == 2)
        {
            ...
            {
                var choice12 : Float = rand(6);
                if (choice12 < 2)
                {
                    fluffyOfPunches();
                }
                if (choice12 == 2 || choice12 == 3)
                {
                    baseElementalAttack();
                }
                if (choice12 > 3)
        ...
        if (_fightPhase == 3)
        {
            ...
            {
                var choice13 : Float = rand(6);
                if (choice13 < 2)
                {
                    fluffyOfPunches();
                }
                if (choice13 == 2 || choice13 == 3)
                {
                    subbossSpecial3();
                }
                if (choice13 > 3)
    ...
    override private function get_long() : String
    {
        ...
        if (_fightPhase == 1)
        {
            str += "You're currently fighting mutated elemental. It's ten feet tall, it body covered with fire and it's using bare fists to fight.";
        }
        else if (_fightPhase == 2)
        {
            str += "You're currently fighting mutated elemental. It's ten feet tall, it body covered with fire and earth, it's using bare fists to fight.";
        }
        else if (_fightPhase == 3)
        {
            str += "You're currently fighting mutated elemental. It's ten feet tall, it body covered with earth armor and surrounded by thick steam layer, it's using bare fists to fight.";
        }
        else if (_fightPhase == 4)
        {
            str += "You're currently fighting mutated elemental. It's ten feet tall, it body covered with mix of four elements and it's using bare fists to fight.";
        }
        return str;
    }
    ...
    public function new()
    {
        ...
        this.bonusHP = 1750;
        this.lustVuln = 0.01;
        this.drop = new ChainedDrop().add(useables.EL_CORE, 1);
        this.level = 18;
