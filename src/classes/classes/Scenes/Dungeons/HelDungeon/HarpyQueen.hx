...
class HarpyQueen extends Monster
{
    ...
    public function eldritchRopes() : Void
    {
        ...
        var damage : Int = as3hx.Compat.parseInt(25 + rand(this.inte / 5));
        player.takeMagicDamage(damage, true);
        player.createStatusEffect(StatusEffects.QueenBind, 0, 0, 0, 0);
    }
    
    public function ropeStruggles(wait : Bool = false) : Void
    {
        clearOutput();
        //Struggle Fail:
        if (rand(10) > 0 && player.str / 5 + rand(20) < 23 || wait)
        {
            ...
            {
                var damage : Int = as3hx.Compat.parseInt(25 + rand(10));
                player.takeMagicDamage(damage, true);
            }
        }
        else
    ...
    public function windSlamAttack() : Void
    {
        ...
        //(Effect; Heavy Damage)
        var damage : Float = 100 + rand(this.wis);
    ...
    public function whitefire() : Void
    {
        ...
        var damage : Int = as3hx.Compat.parseInt(inte + rand(50) * SpellMod());
    ...
    public function new()
    {
        ...
        this.abilities = [
                ...
                }, 
                {
                    ...
                    {
                        return mana >= spellCostWhitefire;
                    }
                }
        ];
