...
class Factory extends DungeonAbstractContent
{
    public function new()
    {
        super();
    ...
    public function enterDungeon() : Void
    {
        ...
        {
            outputText("If you go inside there will undoubtedly be many demons to fight and little chance to escape. Death or worse awaits should you fall into their hands.");
        }
    ...
    private function checkStairs() : Bool
    {
    ...
    private function takeWardTome() : Void
    {
        ...
        else
        {
            ...
            {
                outputText(" However, this does little for your already considerable intellect.");
            }
            ...
            {
                outputText(" As interesting as the theory is, you already have mastered the practical applications");
            }
            ...
            {
                outputText("  Sort of like Tel’Adre’s defences in miniature.");
            }
            ...
            else
            {
                ...
                if (player.cocks.length > 0)
                {
                    ...
                    if (player.averageCockLength() >= 9 && player.averageCockThickness() < 2)
                    {
                        ...
                        {
                            i--;
                            if (player.cocks[i].cockThickness < 2)
                            {
                                player.cocks[i].cockThickness++;
                            }
                        }
                    }
                    else if (player.averageCockLength() >= 15 && player.averageCockThickness() < 3)
                    {
                        ...
                        {
                            i--;
                            if (player.cocks[i].cockThickness < 3)
                            {
                                player.cocks[i].cockThickness++;
                            }
                        }
    ...
    private function goDemon() : Void
    {
        ...
        function dickF() : Void
        {
            ...
            {
                singleF();
            }  // yes, it's repeating. Don't wanna refactor anyway.  
            ...
            function multiF() : Void
            {
                ...
                {
                    outputText("  You resolve to gather some yourself at the next opportunity...");
                }
                else if (player.keyItemvX("Marae's Lethicite", 1) > 0)
                {
                    outputText("  You resolve to devour Marae's as soon as you get a chance.");
                }
            ...
            var singleF : Void->Void = function() : Void
            {
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            {
                outputText("Your " + clitDescript() + " pushes free, nuzzling against her hairless cunt and slipping inside, as if drawn in by its desire.  She openly moans, and begins rocking on top of you.  You gasp in delight as she rides your " + clitDescript() + ", fucking and grinding against it.  ");
            }
            else
            {
                outputText("She lowers herself down, rubbing smooth hairless netherlips over you, smearing you with her fragrant demon-honey.  You feel her clit grinding on your own, drawing out gasps of delight from both of your mouths as she relentlessly scissors against you.  ");
            }
            ...
            if (player.hasFuckableNipples() && player.biggestTitSize() > 2)
            {
                outputText("You gasp as the tongue slides inside each of your breasts, violating them in turn thanks to your strange anatomy.\n\n");
            }
            else
            {
                outputText("You gasp as it curls around each of your " + nippleDescript(0) + "s in turn, tugging them lewdly.\n\n");
            }
        ...
        //Buh.  Zombie fen need brains.
        {
            ...
            if (player.clitLength >= 2)
            {
                outputText("Your " + clitDescript() + " pushes free, nuzzling against her tight asshole and slipping inside, as if drawn in by its desire.  She openly moans, and begins rocking on top of you.  You gasp in delight as she rides your " + clitDescript() + ", fucking her ass and grinding against it.");
            }
            else
            {
                outputText("She lowers herself down, rubbing smooth hairless netherlips over your crotch and vulva, smearing you with her fragrant demon-honey.  You feel her clit grinding on your belly, drawing out gasps of delight from both of your mouths as she relentlessly works her body against your own.");
            }
    ...
    public function doRapeSuccubus() : Void
    {
        ...
        function dickF(x : Int) : Void
        {
            ...
            if (player.hairLength > monster.hairLength)
            {
                outputText("lengthens");
            }
            else
            {
                outputText("shortens");
            ...
            if (player.cockArea(x) > monster.vaginalCapacity())
            {
                ...
                if (player.cumQ() >= 50 && player.cumQ() < 500)
                {
                    ...
                    if (player.hasBalls())
                    {
                        outputText("Your [balls] practically glow with relief as they begin contracting.  Their entire surface is covered with black veins that radiate from your demonic prick, sharing the corruption with your sperm factories.  ");
                    }
                ...
                if (player.cumQ() >= 500)
                {
                    ...
                    if (player.hasBalls())
                    {
                        outputText("Your " + ballsDescript() + " twitch and shake, the veiny surface of your sack darkening as the corruption begins to fill them.  ");
                    }
            ...
            else
            {
                ...
                if (player.hasBalls())
                {
                    outputText("Looking down, you even see the veins on your sack darkening to solid black as the corruption begins tainting your sperm-factories.  ");
                }
                ...
                {
                    outputText("Your female double reaches down to pinch your nipple, spurring you on, \"<i>Please, could you like, cum for me?</i>\"");
                }
                //New PG
                outputText("\n\n");
                if (!recalling)
                ...
                if (player.hasBalls())
                {
                    outputText(" as your balls empty their load queue");
                }
                outputText(".  ");
                //Big cum
                if (player.cumQ() >= 50 && player.cumQ() < 400)
                {
                    outputText("You inhale as black cum spatters from her entrance, her belly distending slightly as you empty what feels like a gallon inside her.  ");
                }
                //((Ginormohuge))
                if (player.cumQ() >= 400)
                {
                    outputText("Gasping in pleasure and surprise, you marvel as her belly visibly expands with each eruption of your dark load.  At first, it looks like a tiny belly, but by the time the orgasm finishes, your girlish double looks like a woman in her ninth month of pregnancy – with twins.");
                }
    ...
    public function doScissorSuccubus() : Void
    {
        ...
        {
            outputText("You groan with wanton desire as your " + clitDescript() + " continues to grow and grow until reaching full size and slipping inside the defeated slut's sloppy pleasure-hole.  ");
        }
    ...
    public function doForcefeedSuccubus() : Void
    {
        ...
        {
            outputText(", nearly smothering the succubus with the swell of tit-flesh");
        }
        ...
        {
            outputText("Her flexible tongue easily curls around one of your " + nippleDescript(0) + "'s, letting her pull and tug on it as she increases the suction from her lips.  Your body rewards her efforts with a faster flow of milk that she sucks down as if she were starving.\n\n");
        }
        ...
        {
            outputText("As your first nipple drains, you move her to your other breast, being sure to motivate her cunt by grinding it with your [foot].  She squeals and sucks harder, emptying the last of your milk with a cute burp.  ");
        }
        if (player.totalNipples() > 2 && player.totalNipples() < 6)
        {
        ...
        if (player.averageLactation() * player.totalBreasts() < 6)
        {
            outputText("Her belly bulges slightly from all the breast-milk she's consumed.\n\n");
        }
        else
        {
            outputText("The succubus looks bloated and pregnant from all the milk you've forced into her.  She sloshes and moans incoherently from the strain of it all.\n\n");
        }
        outputText("Despite the relief your [allbreasts] now feel, your " + vaginaDescript(0));
        if (player.cocks.length > 0)
        {
            outputText(" and [cocks] feel hungrier than ever.  ");
        }
        else
        {
            outputText(" feels hungrier than ever.  ");
        }
        ...
        if (player.cocks.length == 0)
        {
            if (player.vaginas[0].vaginalWetness >= VaginaClass.WETNESS_SLAVERING)
            {
                outputText(", soaking her with girl-cum.");
            }
            else if (player.vaginas[0].vaginalWetness <= VaginaClass.WETNESS_WET)
            {
                outputText(", slicking her face with girlish cum.");
            }
            else
            {
                outputText(", drenching her with a deluge of girlcum.");
            }
        }
        else
        {
            outputText(", and unloading a wave of hot spunk into her hair.");
        }
        ...
        if (player.cocks.length > 0)
        {
            outputText(" and a thick layer of spunk");
        }
        outputText(".");
        outputText("\n\nYou turn away with a bemused sigh.  When you glance back, she has vanished!");
        if (!recalling)
    ...
    public function dildoSuccubus() : Void
    {
        ...
        if (player.cor > 75)
        {
            outputText("giving it a long lick to taste the succubi's delicious flavor ");
        }
    ...
    public function doLossSuccubus(secretary : Bool = true) : Void
    {
        clearOutput();
        ...
        var dickF : Void->Void = function() : Void
        {
            ...
            {
                outputText("Driven half mad with lust, you drop to your knees. Your fingers fly over your body as you pry off every last piece of your [armor], displaying just how hard your alluring opponent has gotten you.  The succubus saunters over, every sinuous step radiating the inhuman sexuality that pours off her skin like heat from a bonfire.\n\n");
            }
            else
            {
            ...
            //[[balls]]{
                ...
                if (player.ballSize < 6)
                {
                    outputText("Your sultry captor leans low over you, her luscious tits wobbling enticingly as she reaches down and caresses your [balls] with soft touches.  Almost immediately you feel them clench with boiling heat, growing heavy and churning with a load big enough to satisfy a thirsty succubus.");
                }
                //[[huge balls]]
                else
                {
                    outputText("Your sultry captor leans low, marveling at the size of your [balls] as she reaches down to caress them.  Her tits swing lewdly above you, bouncing in hypnotic motions. Her hands work gently, taking each one of your [balls] and hefting it gently.  Almost immediately you feel them fill with an unnatural heat that spreads everywhere her slender fingers touch.  They begin to feel full and heavy, practically sloshing as the pent-up need inside you is channeled into liquid form.  \"<i>So ripe... and full,</i>\" she whispers to herself as she caresses them, her foot still sliding all over your [cock], pumping stroke after stroke of pleasure into your lust-weakened form.");
                }
            }
            //[[no balls no pussy]]
            else
        ...
        var clitF : Void->Void = function() : Void
        {
            if (player.lust >= player.maxOverLust())
            {
            ...
            if (player.vaginas.length > 0)
            {
                outputText("your " + clitDescript() + " parts your folds, growing harder.");
            }
            else
            {
                outputText("a fleshy growth erupts from your pale flesh, growing harder.");
            }
            ...
            dynStats("cor", 5);
            dynStats("lib", 3);
            if ((player.hasPerk(PerkLib.BigClit) && player.clitLength < 6) || player.clitLength < 3)
            
            //all this code is copied from succubusmilk (except description){
    ...
    public function doLossIncubus(mechanic : Bool = true) : Void
    {
        clearOutput();
        sceneHunter.selectLossMenu([
        ...
        function nippleF() : Void
        {
            ...
            if (player.totalNipples() > 2)
            {
                outputText("  Each of those divides again, splitting into four prehensile penises.");
            }
            if (player.totalNipples() > 4)
            {
                outputText("  They continue dividing until his wriggling mass is sufficient to penetrate every single nipple and then some.");
            }
            outputText("\n\n");
            ...
            if (player.biggestLactation() > 1)
            {
                outputText("splattering milk and pre everywhere.\n\n");
            }
            else
            {
                outputText("splattering your tits with escaped sexual fluids.\n\n");
            }
        ...
        var otherF : Bool->Void = function(useVag : Bool) : Void
        {
            if (player.lust >= player.maxOverLust())
            {
                outputText("Molten arousal pumps through your veins, burning away your reason with an unquenchable desire to mate. You drop your top, exposing your [allbreasts] to your foe in a submissive display, ");
            }
            else
            {
                outputText("You lower your top, exposing your nubile form to your foe in a submissive display, ");
            }
            ...
            if (player.cor < 80)
            {
                outputText("In a disgusting display");
            }
            else
            {
                outputText("As you grope yourself noisily with your hand into your undergarments, a salacious smile on your lips");
            }
            ...
            if (player.cor >= 80)
            {
                outputText("As you realize their size and number, you open your eyes wide and smile broadly, reflexively spreading your legs wide, practically begging [monster him] to fuck you.  ");
            }
            ...
            {
                outputText("They make sure to rub each of your breasts, spending a few seconds smearing slick pre-cum into your " + nippleDescript(0) + ".  ");
            }
            ...
            if (player.cor < 80)
            {
                outputText("You wriggle and whine, ");
            }
            else
            {
                outputText("You grab the thick tentacle-cock working on your cunt with both hands, as you can barely grab it with one. Then,  while letting out moans fit for a bitch in heat, which you are, you begin ");
            }
            if (player.vaginas.length > 0)
            {
                outputText("squeezing your legs around them and grinding your " + clitDescript() + " against the oddly textured demon-cock.");
            }
            else
            {
                if (player.hasBalls())
                {
                    outputText("grinding down against the ribbed and textured demonic cock as it slides between your [balls].");
                }
                else if (player.cocks.length > 0)
                {
                    outputText("squeezing your legs around the thick demonic flesh as a steady dribble of pre-cum drips from your [cock].");
                }
                if (player.gender == 0)
                {
                    outputText("grinding suggestively on your captor's rods, barely noticing as the last of your [armor] falls away.");
                }
            }
            outputText("\n\n");
            //FUCKKKING
            ...
            if (useVag)
            {
                ...
                if (player.cor < 80)
                {
                    outputText("You feel your [legs] lifted and pulled tight as countless demonic cocks encircle your body, binding and constraining you further.  You whimper as a demonic tentacle probes your back door while a thicker one lines itself up just below your " + clitDescript() + ".  ");
                }
                else
                {
                ...
                if (player.cor < 80)
                {
                    outputText("squeezed and caressed by the writhing tentacle-pricks in and around your body, lost in the pleasure and taste of demonic pre-cum.\n\n");
                }
                else
                {
                    outputText("getting roughly fucked by the two tentacle-cocks at the same time.  Taking the tentacle-cock in your mouth with both hands, you eagerly swallow every bit of demonic pre-cum, then suckle on the huge cock-slit. \n\n");
                }
                
                //FemCum
                if (player.clitLength > 3)
                {
                    outputText("You nearly cum on the spot when the cock fucking your pussy loops its length around your " + clitDescript() + ", the cum-slickened coils driving you mad with pleasure as they coil, slide, and jerk around your clit as if it was a cock.  ");
                }
                else
                {
                    outputText("You nearly cum on the spot when the cock fucking your pussy curves up to rub its textured nodules against your " + clitDescript() + ".  ");
                }
                player.cuntChange(player.vaginalCapacity() * .8, true);
                if (player.cor >= 80)
                {
                    outputText("You cum more times than you are able to count, each time causing a tightening of your fuckholes, which increases the rubbing against the demonic nodules and sends another wave of pleasure to your dazed brain.  You begin to drool freely, reveling in this most unholy mating.  ");
                }
            ...
            else
            {
                ...
                if (player.hasBalls())
                {
                    outputText("  You groan around the dick plugging your throat as another tentacle-like appendage wraps around your " + sackDescript() + ", pulling your [balls] down and gently squeezing them.");
                }
                outputText("\n\n");
                //Genderless Orgasm
                if (player.gender == 0)
                {
                    outputText("The tainted cum mixed with the sensation of fullness provide you with pleasures beyond what your genderless body could accomplish on its own.  You writhe as the demon face-fucks you with one tendril while another continues to bury itself ever-deeper into your abused " + assholeDescript() + ".  ");
                }
                if (player.cocks.length > 0)
                {
                    outputText("The cock-tentacle around your [cock]  increases the pace of its stimulation as it begins to spurt hot wet cum over you, giving it lubrication as it jacks you off while staying tight around your base to prevent you from an orgasming.  ");
                }
                ...
                if (player.cocks.length > 0)
                {
                    ...
                    if (player.cumQ() < 50)
                    {
                        outputText("You groan and orgasm with enough force to splatter a few ropes of cum into the sea of demon-spunk that soaks you from head to toe.  ");
                    }
                    //Big cum
                    if (player.cumQ() >= 50 && player.cumQ() < 400)
                    {
                ...
                player.sexReward("cum", "Anal");
                if (player.isGargoyle() && player.hasPerk(PerkLib.GargoyleCorrupted))
                {
                    player.refillGargoyleHunger(30);
                }
                if (player.isRace(Races.JIANGSHI, 1, false) && player.hasPerk(PerkLib.EnergyDependent))
                {
    ...
    public function incubusButtfuck() : Void
    {
        ...
        if (player.gender == 3)
        {
            if (player.hasBalls())
            {
                outputText(multiCockDescriptLight() + ", [balls], and " + vaginaDescript(0));
            }
            else
            {
                outputText(multiCockDescriptLight() + " and " + vaginaDescript(0));
            }
        }
        else if (player.hasBalls())
        {
            outputText(multiCockDescriptLight() + " and " + ballsDescriptLight());
        }
        else
        {
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] swing freely, smacking into the demon's own and making both of you squeal and dribble more pre-cum.");
        }
        outputText("\n\n");
        //(CUM)
        if (player.hasBalls())
        {
            outputText("You feel your [balls] draw up tight against your body.  ");
        }
        ...
        if (player.cumQ() > 200)
        {
            outputText("You groan as you feel your urethra being stretched by the sheer volume of fluid beginning to shoot through it.  ");
        }
        ...
        if (player.cumQ() < 50)
        {
            outputText("A few thick spurts later and y");
        }
        if (player.cumQ() >= 50 && player.cumQ() < 400)
        {
            outputText("Thick jets of cum pump into the demon's plump backside, soon building up a wave of pressure that pushes back against you.  Y");
        }
        if (player.cumQ() >= 400)
        {
    ...
    public function incubusGetVaginal() : Void
    {
        ...
        {
            outputText("In no time flat your drooling fluids soak him in slippery wetness.  ");
        }
        if (player.vaginas[0].vaginalWetness < VaginaClass.WETNESS_SLICK && player.vaginas[0].vaginalWetness != VaginaClass.WETNESS_DRY)
        {
            outputText("Before long, you've lubricated a fair portion of his tool with wetness.  ");
        }
        if (player.vaginas[0].vaginalWetness == VaginaClass.WETNESS_DRY)
        {
            outputText("Despite your usual light lubrication, you manage to moisten the top-half of his tool with wetness.  ");
        }
    ...
    public function doOralIncubus() : Void
    {
        ...
        {
            outputText("and brushing a strand of [haircolor] out of the way ");
        }
    ...
    public function winAgainstOmnibus() : Void
    {
        ...
        if (player.inte + player.wis + player.cor > 100)
        {
            addButton(10, "Valuable", demonicLethicite).hint("Ask if the demon has anything valuable she can give you, like lethicite.\n\nWho knows what might happen?");
        }
    }
    ...
    private function chooseBreasts() : Void
    {
        ...
        else
        {
            ...
            if (player.breastRows.length >= 4)
            {
                ...
                {
                    player.breastRows[4].breastRating = player.breastRows[3].breastRating - 1;
                }
            }
            if (player.nippleLength < .75)
            {
    ...
    private function normalLegs() : Void
    {
        ...
        {
            outputText("You collapse as your [legs] are unable to support you.  The sounds of bones breaking and reshaping fills the room, but oddly you feel no pain, only mild arousal.  You blink your eyes and sigh, and when you look down again <b>you have normal human legs</b>!");
        }
    ...
    private function postOmnibusBoon(willing : Bool = false) : Void
    {
        if (willing)
        {
            clearOutput();
    ...
    private function doBadEndGeneric() : Void
    {
        ...
        else
        {
            ...
            if (player.cocks.length == 0 || player.biggestTitSize() <= 1)
            {
                ...
                if (player.biggestTitSize() <= 1)
                {
                    outputText("any adornments on your chest");
                }
            ...
            {
                outputText("A small inner voice tries to warn you of something, only to be swept away in the feelings of perfect pleasure and rightness that wash away the last remnants of your sleep.\n\n");
            }
            ...
            {
                outputText("multitude of ");
            }
            outputText(" clear hoses coming away from your cow-like chest udders.  ");
            if (player.biggestLactation() <= 1.5)
            {
                outputText("Creamy white milk is flowing in a steady stream up the tubes and away from you.  ");
            }
            else
            {
                outputText("The hoses bulge obscenely as they struggle to keep up with the torrents of creamy-white milk you're producing.  ");
            }
    ...
    public function doBadEndSuccubusPart1() : Void
    {
        ...
        if (player.biggestLactation() < 1)
        {
            outputText("Your " + nippleDescript(0) + "s begin prodding painfully against your [armor], every touch serving to make them harder and more erect.  ");
        }
        //Tits – lactating
        if (player.biggestLactation() >= 1 && player.biggestLactation() < 3)
        {
            outputText("Your " + nippleDescript(0) + "s get painfully hard as you feel milk begin backing up inside your [allbreasts].   The succubus glances down mischieviously as her hands begin to grope you through your [armor], squeezing out a few drops of milk.  ");
        }
        //Tits – megalactating
        if (player.biggestLactation() >= 3)
        {
            outputText("Your " + nippleDescript(0) + "s get painfully hard as milk begins drooling down your over-productive chest, making your [armor] slide across your leaky milk-spouts in an agonizingly pleasurable way.  ");
        }
        //Cock – single
        if (player.cocks.length == 1)
        {
            ...
            {
                outputText("Swooning from sudden blood loss, you struggle to maintain the kiss as your body takes your [cock] to full hardness in seconds.  ");
            }
            //Cock – single big
            if (player.cockArea(0) >= 30 && player.cockArea(0) < 100)
            {
            ...
            //Cock -megahuge
            if (player.cockArea(0) >= 100)
            {
                outputText("As you struggle not to lose consciousness, you realize your over-aroused body had pumped most of your blood to your over-sized " + Appearance.cockNoun(CockTypesEnum.HUMAN) + ", which now droops to the floor, pulsing hotly.  ");
            }
        }
        //DO MULTIZ
        if (player.cocks.length > 1)
        {
            outputText("The feeling of light-headedness nearly robs you of consciousness as your " + multiCockDescript() + " fill with blood, pulsating with arousal as they reach full size.  ");
        }
        //Vagooooz
        if (player.vaginas.length > 0)
        ...
        //'uge clit{
            ...
            //big clit
            if (player.clitLength > 1 && player.clitLength < 4.5)
            {
            ...
            {
                outputText("Groaning softly, you feel yourself getting wetter and wetter with arousal.  You wish your sticky bottoms were off so you could let something into your " + vaginaDescript(0) + ".  ");
            }
        }
        outputText("\n\n");
        //New PG
        ...
        {
            outputText("a vacuum pump to your clit, and a pump many times bigger than your [cock] to it.  ");
        }
        else
        {
            outputText("and a pump many times bigger than your [cock] to it.  ");
        }
        ...
        {
            outputText(" and an ever larger dildo against your " + vaginaDescript(0) + ".  It seems to pulse and wiggle with a life of its own rubbing the bumps of its lumpy head against your lips.");
        }
    ...
    private function doBadEndSuccubusPart2() : Void
    {
        ...
        if (player.cocks.length > 0)
        {
            ...
            {
                outputText("the suction and drugs make it so easy to just keep cumming and cumming.  ");
            }
            //either or:
        ...
        if (player.vaginas.length > 0)
        {
            outputText("Clenching tightly, your " + vaginaDescript(0) + " squeezes tightly on it's intruder as it's repeatedly violated by the machines.  ");
        }
        //End
        ...
        {
            outputText("Later on, in a moment of clarity, you look around and realize you aren't alone.  ");
        }
        ...
        if (player.statusEffectv3(StatusEffects.Marble) == 1 || player.hasStatusEffect(StatusEffects.CampMarble))
        {
            outputText("  With Marble here too, you'll be around for a long time.");
        }
        EventParser.gameOver();
    }
    ...
    private function doBadEndOmnibusPart1() : Void
    {
        if (player.HP < 1)
        {
            outputText("You stagger into the desk, clutching tightly just to stay upright.  ");
        }
        else
        {
            outputText("Forgetting about the fight, you lean on the desk and slide your free hand under your [armor], seeking any pleasure you can get.  ");
        }
    ...
    private function doBadEndOmnibusPart2() : Void
    {
        ...
        function multiF() : Void
        {
            ...
            if (player.cumQ() >= 50 && player.cumQ() < 300)
            {
                outputText("cantaloupes ");
            }
            if (player.cumQ() >= 300)
            {
                outputText("watermelons ");
            }
            ...
            if (player.breastRows.length == 1)
            {
                outputText("They reach the lower curve of your breasts.\n\n");
            }
            if (player.breastRows.length > 1)
            {
                outputText("They slide over your lowest pair of breasts, encapsulating them in wriggling tightness.\n\n");
            }
            outputText("*FLASH* \"<i>You love cumming for anything and anyone.</i>\"\n\n");
            if (player.breastRows.length == 3)
            {
                outputText("Your middle breasts tingle with absolute pleasure as they too become engulfed in tightness.\n\n");
            }
            if (player.breastRows.length == 2)
            {
                outputText("You groan as the plant grows up the summit of your top breasts, coating the bottom half of your aureola.\n\n");
            }
            if (player.breastRows.length == 1)
            {
                outputText("Your " + nippleDescript(0) + "s become hard as steel as the wave of slick pleasure washes over them.\n\n");
            }
            outputText("*FLASH* \"<i>You love being told to orgasm.</i>\"\n\n");
            if (player.breastRows.length == 1)
            {
                outputText("The wriggling mass slides up the top-most parts of your breasts, narrowing into two tiny tendrils that loop around your neck.\n\n");
            }
            if (player.breastRows.length >= 2)
            {
                outputText("The wriggling mass climbs your top pair of breasts with ease, wrapping your diamond-hard nipples in slime and sensation.  It continues climbing upward, narrowing into two bands that loop around the back of your neck.\n\n");
            }
            ...
            {
                outputText("Your mistress looks down with approval and speaks, \"<i>Very good.  ");
            }
        ...
        function singleF() : Void
        {
            ...
            if (player.averageCockLength() < 15)
            {
                outputText("With one swift motion, the beast engulfs your [cock] in its slimy maw.  ");
            }
            else
            {
                outputText("Distending obscenely, the beast starts engulfing your [cock] in its slimy maw, progressing along its entire length until you can no longer see your pleasure tool.  ");
            }
            ...
            if (player.hasBalls())
            {
                outputText(" smothers your balls, entrapping them in sticky sensation as it continues across your taint between your butt-cheeks.  ");
            }
            else
            {
                outputText(" journeys over your taint before travelling between your butt-cheeks.  ");
            }
            ...
            if (player.hasBalls())
            {
                outputText(" and teasing your balls");
            }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            {
                outputText("The demoness smiles with wicked intent and yanks your [armor]'s bottom the rest of the way off.  She leans close, smiling and inhaling the scent of your sex, savoring it like a aroma of a fine wine.  Licking her perfect lips with anticipation, she inverts the panties and holds them up for you to see.\n\n");
            }
            ...
            {
                outputText("drip on the chair ");
            }
            else
            {
                outputText("soak the chair ");
            }
            ...
            else if (player.nippleLength < 3)
            {
                outputText("bullets ");
            }
            else
            {
                outputText("tiny cocks ");
            }
            outputText("in moments");
            if (player.biggestLactation() > 2)
            {
                outputText(" and start to drip with milk");
            }
            ...
            if (player.breastRows.length <= 1)
            {
                outputText("your " + nippleDescript(0));
            }
            if (player.breastRows.length > 1)
            {
                outputText("your top " + nippleDescript(0));
            }
            ...
            if (player.biggestLactation() > 1)
            {
                outputText("Your milk erupts, spraying out from a tiny hole in the center of the star.  In response the creature increases the force of its sucking action, making you fountain milk constantly.  ");
            }
            if (player.breastRows.length > 1)
            {
                outputText("While you continue to fuck that meat pole and watch the creatures squirming on your nipples, more are affixed to each of your remaining " + nippleDescript(0) + "s, until every single one is covered with its own tiny pleasure-creature.\n\n");
            }
    ...
    private function doBadEndTension() : Void
    {
        ...
        if (player.vaginas.length > 0)
        {
            outputText("Your pussy is instantaneously soaked, filling the air with the scent of sex.  ");
        }
    ...
    private function goDemonSharedEnd() : Void
    {
        ...
        player.skin.setBaseOnly({
                    type : Skin.PLAIN,
                    color1 : "blue",
                    pattern : Skin.PATTERN_DEMONIC_PLEASURE_RUNE
                });
        ...
        if (player.level < 25)
        {
            inventory.takeItem(consumables.LETHITE, playerMenu);
        }
        else if (player.level < 50)
        {
            inventory.takeItem(consumables.LETH1TE, playerMenu);
        }
        else if (player.level < 75)
        {
            inventory.takeItem(consumables.LETH2TE, playerMenu);
        }
        else
        {
            inventory.takeItem(consumables.LETH3TE, playerMenu);
        }
    }
    ...
    public function roomBreakRoom() : Void
    {
        ...
        else
        {
            ...
            if (!player.isRace(Races.HUMAN, 1, false))
            {
                ...
                {
                    outputText("give you the blowjob of a lifetime");
                }
                else if (player.hasVagina())
                {
                    outputText("lick your honeypot 'til you soak my face");
                }
                else
                {
                    outputText("give you a new addition and show you how to use it");
                }
    ...
    public function roomRepairCloset() : Void
    {
        ...
        if (flags[kFLAGS.FACTORY_MILKER_BUILT] > 0)
        {
            outputText("The shelves are empty.  ");
        }
        else
        {
    ...
    public function roomMainChamber() : Void
    {
        ...
        if (flags[kFLAGS.FACTORY_SHUTDOWN] <= 0)
        {
            ...
            if (player.cor < 50)
            {
                outputText("You wish you could free them, but it would take the better part of a day to get them all free.  It'd be better to find the control room and shut down the infernal machinery.  ");
            }
            else
            {
                outputText("You wish you had some machinery like this for yourself.  It looks so fun!  Still, you suppose you should find the control panel to shut this down and free these people.  ");
            }
    ...
    public function roomForemanOffice() : Void
    {
        ...
        else if (player.hasKeyItem("Supervisor's Key") < 0)
        {
            addButton(1, "Key", takeSupervisorKey).hint("Check the desk for something.");
        }
        if (flags[kFLAGS.FACTORY_OMNIBUS_DEFEATED] > 0)
        {
            addButton(0, "Desk", readTheLetter).hint("Check the desk.");
        }
    }
    ...
    public function roomControlRoom() : Void
    {
        ...
        if (flags[kFLAGS.FACTORY_SHUTDOWN] <= 0)
        {
            ...
            if (flags[kFLAGS.MARAE_QUEST_START] == 0.5)
            {
                addButtonDisabled(1, "Shutdown", "She kicked you out of her island and you still as corrupted as you're still save her? BLASPHEMY!!! HERESY!!!");
            }
            else
            {
    ...
    public function roomPremiumStorage() : Void
    {
        ...
        {
            addButton(2, "Search", takeWardTome);
        }
        if (flags[kFLAGS.FACTORY_TAKEN_DEMONIZE_ME] < 1)
        {
            addButton(3, "Potion", takeDemonizeMe);
        }
    }
    ...
    public function secretarialSuccubusDefeated(hpVictory : Bool = false) : Void
    {
    ...
    public function incubusMechanicDefeated(hpVictory : Bool = false) : Void
    {
        clearOutput();
        if (!recalling)
        {
        ...
        {
            outputText("You smile in satisfaction as the [monster name] collapses, masturbating happily.");
        }
        if (flags[kFLAGS.NEW_GAME_PLUS_LEVEL] >= 2 && flags[kFLAGS.FACTORY_INCUBUS_BRIBED] == 0)
        {
            outputText("\n\n<b>You swear you can hear a clicking sound coming from the west.</b>");
        }
