...
class Bazaar extends BaseContent
{
    ...
    private function approachBazaarGuard() : Void
    {
        ...
        {
            outputText("Leave at once.  You are not yet ready for the wonders of the Bazaar.");
        }
        else
        {
        ...
        if (player.cor < 33 - player.corruptionTolerance)
        {
            addButton(1, "FIGHT!", initiateFightGuard);
        }
        else
        {
            addButton(1, "Enter", enterTheBazaar);
        }
    ...
    public function enterTheBazaar() : Void
    {
        ...
        if (model.time.hours == 19 || model.time.hours == 20)
        {
            ...
            if (flags[kFLAGS.COUNTDOWN_TO_NIGHT_RAPE] % 4 == 0 && (player.gender == 1 || (player.gender == 3 && player.mf("m", "f") == "m")) || flags[kFLAGS.LOW_STANDARDS_FOR_ALL] != null)
            {
                nightBazaarButtfuck();
                return;
            }
    ...
    //[Enter]
    public function enterTheBazaarAndMenu(demons : Bool = true) : Void
    {
        clearOutput();
        spriteSelect(null);
        ...
        if (flags[kFLAGS.THE_TRENCH_ENTERED] == 13)
        {
            eventLiquidDiamond();
        }
        else
        {
            ...
            //Cinnabar
            if (model.time.hours >= 15 && model.time.hours <= 20)
            {
            ...
            {
                if (flags[kFLAGS.JINX_LVL_UP] > 0)
                {
                    addButton(10, "Minx", SceneLib.jinxFollower.bazaarEncounters);
                }
                else
                {
                    addButton(10, "???", SceneLib.jinxFollower.bazaarEncounters);
                }
            }
    ...
    private function theSlipperySqueeze() : Void
    {
        ...
        if (isEaster())
        {
            ...
            if (player.gems < 20)
            {
                outputText("  You can't afford it.");
            }
            else
            {
                addButton(3, "SweetMassage", joeySweetMassage);
            }
        }
    ...
    private function joeyAndrogyny() : Void
    {
        ...
        if (player.gender == 1)
        {
            outputText("you'll be able to be as cute as me!");
        }
        else if (player.gender == 2)
        {
            outputText("you'll be able to be as masculine as you want!");
        }
        else
        {
            outputText("you'll be able to be as cute as me or as masculine as you want!");
        }
    ...
    private function joeysMassageWifNoExtraJizzScene(useCock : Bool) : Void
    {
        clearOutput();
        //(Continue as NoWang)
        ...
        {
            outputText("tweaks and teases");
        }
        else
        {
            outputText("sinks a finger deep inside");
        }
        ...
        if (useCock)
        {
            ...
            if (player.cockTotal() > 1)
            {
                ...
                if (player.cockTotal() > 2)
                {
                    ...
                    {
                        outputText(" as necessary until " + sMultiCockDesc() + " is coated with dick-drenching bunny spit.");
                    }
                    else
                    {
                        outputText(", coating your " + cockDescript(2) + " with dick-drenching bunny spit.");
                    }
                }
            }
            ...
            if (player.hasBalls())
            {
                outputText("his hand firmly rubs your " + sackDescript() + ", and ");
            }
        ...
        else
        {
            if (player.hasVagina())
            {
                outputText("presses his ruby lips into the glistening delta of your mons");
            }
            else
            {
                outputText("presses a finger against the semen-soaked ring of your " + assholeDescript());
            }
        ...
        //(Genderless orgasm){
            ...
            else
            {
                ...
                {
                    outputText("like a practiced whore fellating a john.");
                }
                else
                {
                    outputText("like a professional pussy-licker.");
                }
        ...
        else
        {
            ...
            if (player.cumQ() >= 700)
            {
                ...
                if (player.cumQ() >= 2000)
                {
                    outputText("massive, jiggling belly you've given him.");
                }
                else
                {
                    outputText("little paunch on his belly jiggle.");
                }
    ...
    private function joeysMassageWithEXTRASpooge() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("  They even feel a little bigger.");
        }
        outputText("\n\n");
        ...
        if (player.cockTotal() > 1)
        {
            outputText("s like fiddles");
        }
        else
        {
            outputText(" like a fiddle");
        }
        ...
        if (player.hasBalls())
        {
            outputText("Your balls pull and relax and pull tight, bouncing below you over and over, all while working hard to produce more juice for you to gush.  ");
        }
        ...
        if (player.cumQ() >= 1500)
        {
            outputText(".  The sound of your rivers of spooge splattering against the floor barely registers, but a part of you is proud to be so incredibly fertile");
        }
        outputText(".\n\n");
        ...
        if (player.cumQ() >= 1500)
        {
            outputText("  Joey's jaw drops from the unexpectedly large volume you're producing, and he watches in awe as each huge globule of cum rolls off you towards the floor.");
        }
        outputText("\n\n");
        ...
        {
            outputText("through your fur");
        }
        else
        {
            outputText("over your [skin]");
        }
        outputText(".\n\n");
        ...
        if (!player.hasFuckableNipples())
        {
            outputText("squeezing and tugging on them");
        }
        else
        {
            outputText("sliding cum-coated fingers into their slippery depths");
        }
        ...
        if (player.cumQ() >= 1500)
        {
            outputText("  You really flooded the room though, so you'd best walk on your tip-toes until we can get a succubi or a goblin in here to clean up.");
        }
    ...
    private function joeyBigBalls() : Void
    {
        ...
        if (flags[kFLAGS.JOEY_BIG_BALLS_COUNT] == 0)
        {
            ...
            if (player.cor > 60)
            {
                outputText(", with no more than a bit of wishful thinking,");
            }
            ...
            if (player.cor > 70)
            {
                outputText("; you won't get to watch him fountaining all that pearly spunk like a perverted statue");
            }
    ...
    private function suckOffJoeysGardenHose() : Void
    {
        ...
        {
            outputText(" and find yourself wishing you had one of these potions to use on a minotaur.  It would be divine!");
        }
        else
        {
            outputText(" and keep at it.  The knowledge that you're helping a friend is almost as filling as his delicious cum.");
        }
        ...
        if (player.cor < 33)
        {
            outputText("all for a good cause, right?");
        }
        else if (player.cor < 66)
        {
            outputText("also kind of fun, in a naughty way.");
        }
        else
        {
            outputText("exactly the kind of nasty stuff that gets your blood pumping.");
        }
    ...
    private function gretasGarments() : Void
    {
        ...
        if (flags[kFLAGS.FOUND_SOCKS] < 2)
        {
            ...
            if (flags[kFLAGS.OWN_MAIDEN_BIKINI] == 0)
            {
                outputText(", except maybe a super-skimpy chain bikini that's chased with white and gold highlights");
            }
        }
        else
        {
        ...
        menu();
        if (flags[kFLAGS.FOUND_SOCKS] == 0)
        {
            addButton(4, "Low Stock", askGretaAboutInventory);
        }
        else
        {
            if (flags[kFLAGS.FOUND_SOCKS] == 2 && player.cocks.length > 0 && player.hasSockRoom())
            {
                addButton(1, "Browse Socks", browseDemSocksSon);
            }
            if (player.hasSock())
            {
                addButton(2, "Remove Sock", takeOffDatSock);
            }
        }
        if (flags[kFLAGS.OWN_MAIDEN_BIKINI] == 0)
        {
            addButton(0, "Bikini", askGretaAboutZeBikini);
        }
    ...
    private function askGretaAboutZeBikini() : Void
    {
        ...
        {
            addButton(0, "Buy Bikini", buyGretasBikini);
        }
        addButton(4, "Back", gretasGarments);
    }
    ...
    private function browseDemSocksSon() : Void
    {
        ...
        var cockSocksVariant : Array<Dynamic> = ["wool", "alabaster", "viridian", "scarlet", "cobalt", "gilded", "amaranthine", "green", "red", "blue", "cockring"];
        ...
        var cockSockType : Int->Void = function(cocksock_type : Int) : Void
        {
            var cost : Int = 0;
            clearOutput();
        ...
        var prePurchase : Int->Int->Void = function(cocksock_type : Int, cost : Int) : Void
        {
            menu();
            if (player.gems >= cost)
            {
                addButton(0, "Buy it!", pickACockForSock, cocksock_type, cost);
            }
            else
            {
                addButtonDisabled(0, "Buy It!", "You can't afford it!");
            }
            addButton(4, "Back", browseDemSocksSon);
        }
        
        var pickACockForSock : Int->Int->Void = function(cocksock_type : Int, cost : Int) : Void
        //Buy Cock-sock
        {
            ...
            else
            {
                ...
                {
                    if (player.cocks[button].sock == "")
                    {
                        addButton(button, Std.string(button + 1), lastchance2backout, cocksock_type, cost, button);
                    }
                    button++;
                }
            }
        ...
        var lastchance2backout : Int->Int->Int->Void = function(cocksock_type : Int, cost : Int, cockChosen : Int = 0) : Void
        {
        ...
        var cockSockInstall : Int->Int->Int->Void = function(cocksock_type : Int, cost : Int, cockChosen : Int = 0) : Void
        {
            ...
            if (cockSocksVariant[cocksock_type] == "cockring")
            {
                ...
                {
                    player.createPerk(PerkLib.PentUp, 10, 0, 0, 0);
                }
                else
                {
                    player.addPerkValue(PerkLib.PentUp, 1, 5);
                }
        ...
        var noCockSock : Void->Void = function() : Void
        {
            clearOutput();
    ...
    private function takeOffDatSock() : Void
    {
        ...
        while (button < player.cockTotal())
        {
            if (player.cocks[button].sock != "")
            {
                addButton(button, Std.string(button + 1), removeTargettedSock, button);
            }
            button++;
        }
    ...
    private function removeTargettedSock(index : Int) : Void
    {
        ...
        if (player.cockArea(index) >= 100)
        {
            outputText(", almost knocking Greta over in the process");
        }
        ...
        {
            if (player.perkv1(PerkLib.PentUp) >= 10)
            {
                player.addPerkValue(PerkLib.PentUp, 1, -5);
            }
            else
            {
                player.setPerkValue(PerkLib.PentUp, 1, 10);
            }
...
*/
    ...
    private function eggsInButtStart(eggButt : Bool) : Void
    {
        if (eggButt)
        {
    ...
    private function eggsInButt(dickVagAss : Int) : Void
    {
        ...
        else if (dickVagAss == 1)
        {
            outputText("cunt");
        }
        else
        {
            outputText("pitifully empty mound");
        }
        ...
        if (dickVagAss != 0 == 0)
        {
            outputText(", in and out");
        }
        outputText(", removing all that pent-up tension from inside you.  ");
        if (dickVagAss == 0)
        {
            outputText("[EachCock] begins leaking pre-cum, mixing with Joey's on your belly to create what looks like a chocolate-white chocolate marbled confection.");
        }
        else if (dickVagAss == 1)
        {
            outputText("Your cunt grows ever wetter, and not just because of the new chocolate coating.  Despite Joey's femboy appearance, you've got to hand it to him, he does know his way around a pussy.");
        }
        else
        {
            outputText("Your asshole winks and clenches, aching for release that Joey is kind, and skilled, enough to give.");
        }
        ...
        if (dickVagAss == 0)
        {
            outputText("takes hold of [oneCock] and strokes gently, rubbing his thumb against the head");
        }
        else if (dickVagAss == 1)
        {
            outputText("reaches between his legs, slipping two fingers inside you while his thumb gently rubs your clit");
        }
        else
        {
            outputText("reaches between his legs, slipping two fingers inside your ass while his thumb rubs against your perineum");
        }
        ...
        if (dickVagAss == 0)
        {
            outputText("[eachCock] pulses and spasms, loosing rope after rope of white jizz through the air, splattering against the wall and floor messily");
        }
        else if (dickVagAss == 1)
        {
            outputText("your pussy tightens around his fingers, suddenly releasing a flood of femcum that splatters messily against the table");
        }
        else
        {
            outputText("your asshole twitches and spasms, unable to do much more than grant you a vague half-orgasm");
        }
        ...
        if (dickVagAss == 0)
        {
            ...
            {
                outputText(", especially compared to you.");
            }
            else if (player.smallestCockArea() < 6)
            {
                outputText(", of course, if he's considered tiny, what does that make you?");
            }
        }
        else
        {
    ...
    private function assaultYoRapistYo() : Void
    {
        ...
        {
            //Strength Check  //[(If strength is 50 or more)  {
                ...
                {
                    addButton(0, "Abuse Ass", abuseHisAss);
                }
            }
        }
    }
    ...
    private function abuseHisAss() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText("  Your hand strokes along your [cocks] and press them to the warm cheeks exposed before you.");
        }
        else
        {
            outputText("  You pump your [cocks] and milk a pearl of pre-cum out to drip onto the enticing ass before you.");
        }
        ...
        if (player.smallestCockLength() >= 16)
        {
            ...
            if (player.cockTotal() == 1)
            {
                outputText("  You squeeze your [cocks] between his warm ass cheeks, stroking yourself with his exposed bottom.  The tiger whimpers meekly under you.");
            }
            else
            {
                outputText("  Your fattest cock grinds between the tiger man's rear, dripping spunk over his back and clothing while your other cocks make a sloppy mess of his ass.");
            }
        ...
        else
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText("  One of your cocks slips into his hot, constricting confines, the remaining lengths pressed fast to the tiger man's rear and leaving glistening trails of eager fluids like markings on a bitch's ass.");
            }
            else
            {
                outputText("  Your [cocks] pushes in, your pre-cum-slicked length sliding in with a wet noise.");
            }
            ...
            if (player.hasBalls())
            {
                outputText(" swatting your [balls] against him,");
            }
            outputText(" making him shout out in discomfort.  Your [cocks] stretching him out");
            if (player.cockTotal() > 1)
            {
                outputText(" while beating his rear");
            }
    ...
    private function collectSomeButtSmex() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("  Your " + vaginaDescript(0) + " grows slick in your excitement.");
        }
        if (player.gender == 0)
        {
            outputText("  Your skin heats and tingles, sweat wetting its surface.");
        }
        ...
        if (player.hasCock())
        {
            outputText(" wrap around your [cocks].");
        }
        else
        {
            outputText(" rub over your " + assholeDescript() + ".");
        }
        ...
        if (player.cockTotal() > 1)
        {
            outputText(" and your [cocks] wetly slaps your stomach with need");
        }
        ...
        if (player.isBiped())
        {
            outputText("  The bear shifts where he stands, grabbing your ankles and spreading your limbs almost painfully wide.  You wince from the sting of the strain on your leg muscles.");
        }
        ...
        if (player.hasCock())
        {
            outputText(" while [eachCock] twitches and leaks generously over your " + player.skinFurScales());
        }
        outputText(".");
    ...
    private function finalGayFinallee(road : Int = 0) : Void
    {
        ...
        if (road == 0)
        {
            ...
            if (player.hasCock())
            {
                outputText("His hand dips down to play with your [cocks], stroking you off as he gives a few more brutal pounds of his hips.  ");
            }
            else if (player.hasVagina())
            {
                outputText("Fingers ram into your " + vaginaDescript(0) + ", thrusting into you as he fucks your other hole.  ");
            }
            ...
            if (player.gender > 0)
            {
                outputText("  Your lips part as you moan, feeling your climax building before coating the tiger's hand and your lower body in your sex.  The tiger man just brings his hand up to his lips to taste your juices before hilting into you one last time.");
            }
        ...
        else if (road == 1)
        {
            ...
            if (player.gender > 0)
            {
                outputText("  Your lips part as you moan, feeling your climax building before coating the bear's hand and your lower body in your sex.  The bear just brings his hand up to his lips to taste your honey before hilting into you one last time.");
            }
        ...
        else
        {
            ...
            if (player.hasCock())
            {
                outputText("  His hand drips down to clumsily play with your [cocks], stroking you off as he gives you a few more brutal pounds of his hips.");
            }
            else if (player.hasVagina())
            {
                outputText("  Fingers dip into your " + vaginaDescript(0) + ", ramming into you as he fucks your other hole.");
            }
            if (player.gender > 0)
            {
                outputText("  Your lips part as you feel your climax building, and soon you coat the orc's hand and your lower body in your lust.  The orc just brings his hand up to taste your juices before hilting into you one last time.");
            }
