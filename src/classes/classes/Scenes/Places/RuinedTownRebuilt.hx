...
class RuinedTownRebuilt extends BaseContent implements SaveableState
{
    ...
    public static var YourHouse : Bool;  //whether or not the mouselets have built you a house  
    public static var WellBuilt : Bool;
    public static var ShopBuilt : Int;
    public static var SmithBuilt : Bool;
    public static var TrainingGroundsBuilt : Bool;
    ...
    public static var JojoyLitters : Bool;  //whether or not Jojo/Joy has children living in the town. Affects Growth rate.  
    public static var ChiChiSeenHere : Bool;
    public static var ChiChiLitters : Bool;  //same as above, but Chi Chi.  
    ...
    public static var logbuilt : Bool;
    public static var AmilyAtWetBitch : Bool;
    ...
    public static var OwcaSeen : Bool;
    public static var FarmSeen : Bool;
    ...
    public static var TelAdreSuppliesBought : Bool;
    public static var ReapercheepBought : Bool;
    public static var SeenBakery : Bool;
    public static var SeenMatShop : Bool;
    public static var SeenQuarryCorps : Bool;
    public static var SeenStreaker : Bool;
    public static var SeenMMelee : Bool;
    public static var SeenAArmors : Bool;
    public static var Intown : Bool;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            RebuildState = Reflect.field(o, "RebuildState");
            ShouldraSeenTown = Reflect.field(o, "ShouldraSeenTown");
            HouseNumber = Reflect.field(o, "HouseNumber");
            Housecap = Reflect.field(o, "Housecap");
            YourHouse = Reflect.field(o, "YourHouse");
            WellBuilt = Reflect.field(o, "WellBuilt");
            ShopBuilt = Reflect.field(o, "ShopBuilt");
            SmithBuilt = Reflect.field(o, "SmithBuilt");
            TrainingGroundsBuilt = Reflect.field(o, "TrainingGroundsBuilt");
            MousetownPopulation = Reflect.field(o, "MousetownPopulation");
            TelAdreScouts = Reflect.field(o, "TelAdreScouts");
            InvasionCounter = Reflect.field(o, "InvasionCounter");
            JojoyLitters = Reflect.field(o, "JojoyLitters");
            ChiChiSeenHere = Reflect.field(o, " ChiChiSeenHere");
            ChiChiLitters = Reflect.field(o, "ChiChiLitters");
            GrowthRate = Reflect.field(o, "GrowthRate");
            MouseTownPopCap = Reflect.field(o, "MouseTownPopCap");
            WallNumber = Reflect.field(o, "WallNumber");
            MiceArcherySessions = Reflect.field(o, "MiceArcherySessions");
            logbuilt = Reflect.field(o, "logbuilt");
            AmilyAtWetBitch = Reflect.field(o, "AmilyAtWetBitch");
            AmilyAngerCooldown = Reflect.field(o, "AmilyAngerCooldown");
            WeeklyGemTax = valueOr(Reflect.field(o, "WeeklyGemTax"), 0);
            WeeklyWoodGain = valueOr(Reflect.field(o, "WeeklyWoodGain"), 0);
            prosperityvar = valueOr(Reflect.field(o, "prosperityvar"), 1);
            OwcaSeen = valueOr(Reflect.field(o, "OwcaSeen"), false);
            FarmSeen = valueOr(Reflect.field(o, "FarmSeen"), false);
            EdrynTownState = valueOr(Reflect.field(o, "EdrynTownState"), 0);
            TelAdreSuppliesBought = valueOr(Reflect.field(o, "TelAdreSuppliesBought"), false);
            ReapercheepBought = valueOr(Reflect.field(o, "ReapercheepBought"), false);
            SeenBakery = valueOr(Reflect.field(o, "SeenBakery"), false);
            SeenMatShop = valueOr(Reflect.field(o, "SeenMatShop"), false);
            SeenQuarryCorps = valueOr(Reflect.field(o, "SeenQuarryCorps"), false);
            SeenStreaker = valueOr(Reflect.field(o, "SeenStreaker"), false);
            SeenMMelee = valueOr(Reflect.field(o, "SeenMMelee"), false);
            SeenAArmors = valueOr(Reflect.field(o, "SeenAArmors"), false);
            Intown = valueOr(Reflect.field(o, "Intown"), false);
        }
    ...
    public function weeklyPopAdjustment() : Void
    {
        ...
        GrowthRate = as3hx.Compat.parseInt(MousetownPopulation / divide);
        MousetownPopulation = as3hx.Compat.parseInt(MousetownPopulation + GrowthRate);
        prosperityvar = 0;
        ...
        prosperityvar += as3hx.Compat.parseInt(MousetownPopulation / 10);
        if (WellBuilt)
        {
            prosperityvar += 1;
        }
        ...
        WeeklyGemTax = as3hx.Compat.parseInt((MousetownPopulation * prosperityvar) / 2);
        ...
        WeeklyWoodGain *= as3hx.Compat.parseInt((MousetownPopulation / 50) * (prosperityvar / 2));
    ...
    public function MouseTownWeeklyUpdate() : Void
    {
        ...
        if (logbuilt)
        {
            WeeklyWoodGain = as3hx.Compat.parseInt(prosperityvar / 2);
        }
    ...
    public function MouseTownRareGoods() : Void
    {
        ...
        //Add the qualifier, must complete the demon lab dungeon.{
    ...
    public function DoStoneRun() : Void
    {
        ...
        switch (choice0)
        {
            case 0:
                ...
                if (flags[kFLAGS.CAMP_CABIN_STONE_RESOURCES] > 1200 && flags[kFLAGS.MATERIALS_STORAGE_UPGRADES] >= 3)
                {
                    flags[kFLAGS.CAMP_CABIN_STONE_RESOURCES] = 1200;
                }
                else if (flags[kFLAGS.CAMP_CABIN_STONE_RESOURCES] > 400 && flags[kFLAGS.MATERIALS_STORAGE_UPGRADES] < 3)
                {
    ...
    public function DoScrapRun() : Void
    {
        ...
        switch (choice0)
        {
            case 0:
                ...
                if (flags[kFLAGS.CAMP_CABIN_METAL_PIECES_RESOURCES] > 1200 && flags[kFLAGS.MATERIALS_STORAGE_UPGRADES] >= 3)
                {
                    flags[kFLAGS.CAMP_CABIN_METAL_PIECES_RESOURCES] = 1200;
                }
                else if (flags[kFLAGS.CAMP_CABIN_METAL_PIECES_RESOURCES] > 400 && flags[kFLAGS.MATERIALS_STORAGE_UPGRADES] < 3)
                {
                    flags[kFLAGS.CAMP_CABIN_METAL_PIECES_RESOURCES] = 400;
                }
    ...
    public function MouseBuyWeapon(itype : ItemType, cost : Float) : Void
    {
        clearOutput();
    ...
    public function MouseBuyArmor(itype : ItemType, cost : Float) : Void
    {
        clearOutput();
        outputText("You gesture at " + itype.longName + ".\n\n");
    ...
    public function StayTheNight() : Void
    {
        ...
        if ((flags[kFLAGS.AMILY_WANG_LENGTH] > 0) && (player.gender >= 2))
        {
            ...
            if (player.gender >= 3)
            {
                outputText("<i>“Don’t worry, [name]. I’ll give you some time to recover before the main event.</i>”  \n\n");
            }
