...
class IngramTavern extends BaseContent implements SaveableState
{
    
    public static var IngramRumors : Float;
    public static var IngramEarFreakout : Float;
    public static var IngramTailFreakout : Float;
    public function new()
    {
        super();
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            IngramRumors = Reflect.field(o, "IngramRumors");
            IngramEarFreakout = Reflect.field(o, "IngramEarFreakout");
            IngramTailFreakout = Reflect.field(o, "IngramTailFreakout");
        }
        else
        {
            resetState();
    ...
    public function hearRumors() : Void
    //Hear rumors. Will be altered after defeating Lethice so he will say "Welcome back".
    {
    ...
    public function menuTavern() : Void
    {
        ...
        if (IngramRumors < 3)
        {
            addButton(2, "Stories", hearRumors).hint("Hear the stories the innkeeper has to offer.");
        }
    ...
    public function welcomeBack() : Void
    {
        ...
        if (flags[kFLAGS.TIMES_TRANSFORMED] <= 0)
        {
            outputText("The innkeeper looks at you in awe and says, \"<i>Wow, you haven't changed at all! How did you manage to stay in that strange realm for years and still be normal?</i>\"");
        }
        ...
        if (player.wings.type > 0)
        {
            ...
            if (player.canFly())
            {
                outputText("You tell him that you can fly. To demonstrate, you guide the innkeeper outside and you grit your teeth with effort as you flap your wings and you finally launch off from the ground and fly around the town! The people of Ingnam, including your family and friends, look at you in shock and some even say, \"<i>[He] can fly!</i>\"");
            }
        }
        outputText("\n\nPLACEHOLDER.");
    ...
    public function appearanceFreakout() : Void
    {
        ...
        if (player.ears.type > 0 && player.tailType > 0 && player.hasLongTail())
        {
            outputText("Next, he walks behind you, taking a glance at your tail.");
        }
    ...
    public function buyBeer() : Void
    {
        ...
        else
        {
            ...
            if (player.statusEffectv2(StatusEffects.Drunk) >= 3)
            {
                ...
                {
                    outputText("You open up your [armor] and squat down while you release your pressure onto the ground. ");
                }
                else
                {
                    outputText("You open up your [armor] and lean against the wall using one of your arms for support while you release your pressure onto the wall. ");
                }
    ...
    //Order food, because you need to be able to fill hunger.
    {
    ...
    public function buySandwich() : Void
    //Eat sandwich, refill hunger. The reason it's ambiguous is to let you imagine what sandwich you're eating.
    {
    ...
    public function buySoup() : Void
    //Eat soup. Again, it's vague to let you imagine what soup you're eating.
    {
