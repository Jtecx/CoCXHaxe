...
class IgnisArenaSeerScene extends HeXinDaoAbstractContent
{
    ...
    public function ignisTalkHim() : Void
    {
        ...
        {
            outputText("I also sometimes take contracts for the sand covens. It might not look the case, but I have enough corruption in me to pose as a demon, with the right kind of glamor. I can operate better outside the desert than those floozies can. ");
        }
