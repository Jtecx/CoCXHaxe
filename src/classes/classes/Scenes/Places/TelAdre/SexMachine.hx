...
class SexMachine extends TelAdreAbstractContent
{
    public function totalUses() : Int
    {
        return as3hx.Compat.parseInt(flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_EUNUCH]
    ...
    private function useTheSexMachine() : Void
    {
        ...
        {
            outputText("Near the bench you see a rough scribbling - \"<i>SexMachine 2.0</i>\" - and several buttons, corresponding to different parts of the body - \"Dick\", \"Vagina\" and \"Ass\". The last one looks jammed - you couldn't disable it even if you wanted to... Will you go all-in and enable all the possible buttons?");
        }
        ...
        function dickF() : Void
        {
            ...
            if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_MALE] == 0 || recalling)
            {
                ...
                if (player.hasBalls())
                {
                    outputText("your [balls] pulling up tightly ");
                }
                else
                {
                    outputText("prostate pulsing madly ");
                }
        ...
        function vagF() : Void
        {
            ...
            if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_FEMALE] == 0 || recalling)
            {
                ...
                {
                    outputText("  It slips a fourth cock between your " + chestDesc() + ", using two arms to press them together and fuck your tits as well, splashing a burst of mysterious cum on your face with every thrust.");
                }
                outputText("\n\n");
                ...
                if (player.biggestTitSize() >= 2)
                {
                    outputText("your breasts covered in cum and ");
                }
            ...
            else
            {
                ...
                if (player.biggestTitSize() >= 2)
                {
                    outputText(", and it doesn't take long for the machine to slip a cock between your breasts as well, starting to tit fuck you as it rotates you in your restraints to optimize your position");
                }
                else
                {
                    outputText(" while the machine rotates you in place to optimized your positioning.");
                }
                outputText(".\n\n");
        ...
        var hermF : Void->Void = function() : Void
        {
            ...
            if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_HERM] == 0 || recalling)
            {
                ...
                if (player.biggestTitSize() >= 2)
                {
                    outputText("  Well, not every part of you, but that is rapidly fixed as a final cock rubs against your " + chestDesc() + ", starting to stimulate your chest as well.");
                }
                outputText("\n\n");
                ...
                if (player.biggestTitSize() >= 2)
                {
                    outputText("  The cock on your chest pumps cum onto your " + chestDesc() + ", as y");
                }
                else
                {
                    outputText("  Y");
