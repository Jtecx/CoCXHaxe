...
/**
	 ...
	 */
class UmasShop extends TelAdreAbstractContent
{
    private var _loppeTalks : Array<Dynamic>;
    ...
    /**
		 ...
		 */
    public function enterClinic(returnedTo : Bool = false) : Void
    {
        clearOutput();
        ...
        else if (player.femininity >= UMA_CONSIDER_PC_FEM)
        {
    ...
    /**
		 ...
		 */
    private function buildCoreMenu(noSex : Bool = false) : Void
    {
        if (noSex)
        {
    ...
    /**
		 ...
		 * Edit Status: 100%
		 */
    public static inline var MASSAGE_RELIEF : Int = 0;
    public static inline var MASSAGE_RELIEF_BONUS : Float = 0.9;  // Multiplicative bonus to Lust gains  
    private static inline var MASSAGE_RELIEF_BONUS_TEXT : String = "<b>(10% Reduction to all Lust gains whilst active!)</b>";
    ...
    /**
		 ...
		 * Edit Status: 95%
		 */
    public static inline var MASSAGE_LUST : Int = 1;
    public static inline var MASSAGE_LUST_BONUS : Float = 1.1;  // Multiplicative bonus to Lust gains  
    private static inline var MASSAGE_LUST_BONUS_TEXT : String = "<b>(10% Increase to all Lust gains whilst active!)</b>";
    ...
    /**
		 ...
		 * Edit Status: 90%
		 */
    public static inline var MASSAGE_MODELLING : Int = 2;
    public static inline var MASSAGE_MODELLING_BONUS : Int = 10;  // Flat bonus applied to femininity stat  
    private static inline var MASSAGE_MODELLING_BONUS_TEXT : String = "<b>(+10 Bonus Femininity whilst active!)</b>";
    ...
    /**
		 ...
		 * Edit Status: 95%
		 */
    public static inline var MASSAGE_RELAXATION : Int = 3;
    public static inline var MASSAGE_RELAXATION_BONUS : Float = 0.1;  // Multiplicative bonus to damage taken -- these seem a little op with current values  
    private static inline var MASSAGE_RELAXATION_BONUS_TEXT : String = "<b>(10% Reduction to all Damage taken whilst active!)</b>";
    ...
    /**
		 ...
		 * Edit Status: 95%
		 */
    public static inline var MASSAGE_POWER : Int = 4;
    public static inline var MASSAGE_POWER_BONUS : Float = 1.1;  // Multiplicative bonus to damage done -- these seem a little op with current values  
    private static inline var MASSAGE_POWER_BONUS_TEXT : String = "<b>(10% Increase to all Damage inflicted whilst active!)</b>";
    ...
    public static inline var MAX_MASSAGE_BONUS_DURATION : Int = 24;  // Duration of the bonus  
    /**
    ...
    public static inline var NEEDLEWORK_SPEED : Int = 0;
    public static inline var NEEDLEWORK_LUST : Int = 1;
    public static inline var NEEDLEWORK_DEFENSE : Int = 2;
    public static inline var NEEDLEWORK_MAGIC : Int = 3;
    public static inline var NEEDLEWORK_ATTACK : Int = 4;
    
    public static inline var NEEDLEWORK_SPEED_PERK_DESC : String = "Uma's Acupuncture Needlework has gifted you with the 'Chi Reflow - Speed' perk. As a result your strength is capped but speed reductions are halved.";
    public static inline var NEEDLEWORK_SPEED_STRENGTH_CAP : Int = 60;
    
    public static inline var NEEDLEWORK_LUST_PERK_DESC : String = "Uma's Acupuncture Needlework has gifted you with the 'Chi Reflow - Lust' perk. As a result your Lust resistance and Tease attack are enhanced, but Libido and Sensitivity gains are increased.";
    public static inline var NEEDLEWORK_LUST_LUST_RESIST : Int = 10;
    public static inline var NEEDLEWORK_LUST_TEASE_MULTI : Float = 10;
    public static inline var NEEDLEWORK_LUST_TEASE_DAMAGE_MULTI : Float = 1.1;
    public static inline var NEEDLEWORK_LUST_LIBSENSE_MULTI : Float = 1.1;
    
    public static inline var NEEDLEWORK_DEFENSE_PERK_DESC : String = "Uma's Acupuncture Needlework has gifted you with the 'Chi Reflow - Defense' perk. As a result your body has gained passive damage resistance and extra health, but speed is capped.";
    public static inline var NEEDLEWORK_DEFENSE_DEFENSE_MULTI : Float = 1.1;
    public static inline var NEEDLEWORK_DEFENSE_EXTRA_HP : Int = 50;
    public static inline var NEEDLEWORK_DEFENSE_SPEED_CAP : Int = 60;
    
    public static inline var NEEDLEWORK_MAGIC_PERK_DESC : String = "Uma's Acupuncture Needlework has gifted you with the 'Chi Reflow - Magic' perk. As a result your spells are now more powerful, but regular attacks are weaker.";
    public static inline var NEEDLEWORK_MAGIC_SPELL_MULTI : Float = 0.25;  // Additive bonus to the other magic damage bonuses  
    public static inline var NEEDLEWORK_MAGIC_REGULAR_MULTI : Float = 0.75;  // Multiplier tagged onto the end of damage calculations for the player.  
    
    public static inline var NEEDLEWORK_ATTACK_PERK_DESC : String = "Uma's Acupuncture Needlework has gifted you with the 'Chi Reflow - Attack' perk. As a result your regular attacks are more powerful, but your damage reduction is decreased.";
    public static inline var NEEDLEWORK_ATTACK_REGULAR_MULTI : Float = 1.1;
    public static inline var NEEDLEWORK_ATTACK_DEFENSE_MULTI : Float = 0.9;
    ...
    public function needleworkUndoCost() : Int
    {
        ...
        // 25 per undo?{
            ...
            baseCost += as3hx.Compat.parseInt(25 * flags[kFLAGS.UMA_TIMES_ACUPUNCTURE_UNDO]);
        }
        if (baseCost > 1000)
        {
            baseCost = 1000;
    ...
    /**
		 ...
		 */
    public function hasNeedleworkPerk() : Bool
    {
    ...
    public function acupunctureMenu() : Void
    {
        ...
        if (hasNeedleworkPerk())
        {
            ...
            outputText("The mare takes a moment to inspect you carefully, seeming to look through rather than at you.  \"<i>This could be quite a challenge, even for my skills... but, seeing as you're my little hoppers special someone, just for you I will have to ask for " + Std.string(sessionCost) + " gems.  That's half the price of what I'd usually charge for work this difficult.</i>\"\n\n");
        ...
        else
        {
            ...
            outputText("The mare tries to remember any other types of needlework that might be useful to you, but ultimately, she can't think of anything else.  \"<i>That's all you might use, I think...</i>\"  She then pauses.  \"<i>As for a price, given you're my little Loppe's special someone, shall we say " + Std.string(sessionCost) + " gems?  That's half-price of what I'd usually charge.</i>\"\n\n");
    ...
    /**
		 * SEXY TIMES
		 */
    private static inline var UMA_CONSIDER_PC_FEM : Int = 70;  // Femininity value that Uma considers "girly"  
    private static inline var UMA_CONSIDER_PC_AND : Int = 50;  // Femininity value that Uma considers "androgynous"  
    ...
    public function sexMenu() : Void
    {
        ...
        // Check femininity
        if (player.femininity >= UMA_CONSIDER_PC_FEM || flags[kFLAGS.LOW_STANDARDS_FOR_ALL] != null)
        {
    ...
    private function sexEroticMassage() : Void
    {
        ...
        {
            outputText("something that makes you wonder if Urta would like to come and take a spin here, ");
        }
        ...
        if (flags[kFLAGS.PC_FETISH] >= 1)
        {
            outputText("unable to resist either the tingle of lust that runs through you at being naked in front of Uma, nor the urge to flaunt your feminine physique for her own gratification, ");
        }
    ...
    public function sexGetFingered() : Void
    {
        ...
        {
            outputText("feeling very much like a child sat on the lap of her mother.  ");
        }
        if (player.tallness > 84)
        {
            outputText("carefully settling down for fear of squashing her.  ");
        }
        ...
        if (player.thickness < 10 && player.tone > 90)
        {
            outputText("her fingertips trailing against your chiseled, muscular abdomen, ");
        }
        else if (player.thickness < 30 && player.tone > 70)
        {
            outputText("her fingertips gliding across your toned midriff, ");
        }
        else if (player.thickness > 90 && player.tone < 10)
        {
            outputText("her fingertips stealing a grope of your chubby belly as they travel lower, ");
        }
        else if (player.thickness > 70 && player.tone < 30)
        {
            outputText("her fingertips sinking into paunch of your belly, ");
        }
        
        
        if (player.hasCock())
        {
            outputText("past [eachCock], and ");
        }
        ...
        if (player.hasVagina())
        {
            ...
            if (player.isNaga())
            {
                outputText("on your [legs].  ");
            }
            else
            {
                outputText("nestled between your [legs].  ");
            }
        ...
        if (player.hasVirginVagina())
        {
            ...
            if (player.hasCock())
            {
                outputText(", your forgotten cock spraying cum in a pearlescent arc to splatter onto the floor");
            }
            outputText(".\n\n");
    ...
    private function sexHandjob() : Void
    {
        ...
        if (player.cumQ() >= 500)
        {
            outputText(", audibly sloshing through the cum covering the floor, ");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            outputText(", careful to avoid getting them soaked in your prodigious quantity of spunk");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText(", as well as the room");
        }
    ...
    //Aim for something right around the biggest she can take, otherwise just take smallest.
    {
        ...
        {
            outputText(", gathering your clothes up in your arms as you do so.");
        }
        ...
        {
            outputText("It’s clear that she doesn’t really enjoy the notion that much, considering the way she’s looking at you.  \"<i>All right, let’s get this over with.</i>\"  ");
        }
        else if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 5)
        {
            outputText("She actually seems to be smiling a little as she looks at you.  \"<i>All right, time to see if I can handle this brutish thing.</i>\"  ");
        }
        else
        {
            outputText("It's clear that she doesn't mind doing this for you at all. In fact, she's even smiling down at you as she fondles you one-handed.  \"<i>Time to see if I can make you squirm as hard as Loppe does.</i>\"  ");
        }
        ...
        if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] >= 2)
        {
            outputText(", but I guess you're changing that, aren't you?");
        }
        else
        {
            outputText(".");
        ...
        if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 2)
        {
            outputText("You don't taste bad, all things considered.");
        }
        else if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 5)
        {
            outputText("I think I'm starting to get used to your taste, [name].");
        }
        else
        {
            outputText("Mmmm...  Don't tell anyone, but I think I'm starting to like helping you like this.");
        }
        outputText("</i>\"");
        ...
        {
            outputText(" until she hits your [sheath]");
        }
        else
        {
            outputText(" until she has her mouth as full as she can handle");
        }
        ...
        if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 2)
        {
            outputText("Girls taste better.");
        }
        else if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 5)
        {
            outputText("Not too bad.");
        }
        else
        {
            outputText("Hmmm, give me more, [name].");
        }
        outputText("</i>\"");
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 3)
            {
                outputText("perhaps thinking it will end this sooner");
            }
            else
            {
                outputText("perhaps encouraged by the way you swell in her mouth");
            }
            outputText(", she wraps ");
            if (player.cockTotal() == 2)
            {
                outputText("one hand around your girthy tool and starts pumping");
            }
            else
            {
                outputText("both hands around your girthy tools and starts pumping");
            }
        ...
        {
            outputText("harshly explain");
        }
        outputText(".  ");
        if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 2)
        {
            outputText("You can feel her nod in agreement through your pole, and soon after, she's plunging rhythmically up and down.");
        }
        else
        {
            outputText("Before you can even finish, she's plunging up and down along your length, letting you know that she's learned this particular song and dance quite well under your tutelage.");
        }
        ...
        if (flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 5)
        {
            ...
            if (player.cumQ() >= 500)
            {
                outputText("  She gets out of the way after that, leaving you to lie there, spraying your seed like a perverted sprinkler.");
            }
            if (player.cumQ() >= 1500)
            {
                outputText("  The massive cumsprays that land on you slowly slough off down towards the drains.  It's hard not to bliss at the sound of your loud noisily draining away.");
            }
        }
        ...
        else
        {
            ...
            if (player.cumQ() <= 25)
            {
                outputText("She dutifully swallows every drop of your average-sized load, her long tongue slipping and sliding around your shaft as she ensures it is completely cleaned.");
            }
            else if (player.cumQ() <= 100)
            {
                ...
                if (player.hasBalls())
                {
                    outputText("  It rolls down to your [sack], coating it in warm, wet cum-shine.");
                }
            }
            else
            {
                ...
                if (player.cumQ() >= 1000)
                {
                    ...
                    else if (player.cumQ() <= 30000)
                    {
                        outputText("bathtub worth");
                    }
                    else
                    {
                        outputText("lake");
            ...
            if (player.cockTotal() > 1)
            {
                ...
                if (player.cockTotal() == 2)
                {
                    outputText("It's ropes");
                }
                else
                {
                    outputText("Their ropes");
                }
    ...
    private function sexEatHerOut() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("Blood engorges [eachCock],  ");
        }
        if (player.hasVagina())
        {
            outputText("moisture gathers on your netherlips, drops of your arousal sliding out of your [pussy] and down towards your [feet].  ");
        }
        ...
        if (player.ears.type == 2 || player.ears.type == 9 || player.ears.type == 5 || player.ears.type == 7)
        {
            outputText("between your ");
        }
        
        if (player.ears.type == 2)
        {
            outputText("canine ");
        }
        if (player.ears.type == 9)
        {
            outputText("vulpine ");
        }
        if (player.ears.type == 5)
        {
            outputText("feline ");
        }
        if (player.ears.type == 7)
        {
            outputText("loporid ");
        }
