...
class YaraPiercingStudio extends TelAdreAbstractContent
{
    /**
     * 3 variables that define bonuses for piercing.
     */
    public var LOC_CLIT(default, never) : Int = 0;
    public var LOC_DICK(default, never) : Int = 1;
    public var LOC_EARS(default, never) : Int = 2;
    public var LOC_EYEBROW(default, never) : Int = 3;
    public var LOC_LIP(default, never) : Int = 4;
    public var LOC_NIPPLES(default, never) : Int = 5;
    public var LOC_NOSE(default, never) : Int = 6;
    public var LOC_TONGUE(default, never) : Int = 7;
    public var LOC_VULVA(default, never) : Int = 8;
    ...
    //6) **Nose (+.5 attack)
    //7) **Tongue (+1 sens)
    public var MAT_AMETHYST(default, never) : Int = 1;
    public var MAT_DIAMOND(default, never) : Int = 2;
    public var MAT_GOLD(default, never) : Int = 3;
    public var MAT_EMERALD(default, never) : Int = 4;
    public var MAT_JADE(default, never) : Int = 5;
    public var MAT_ONYX(default, never) : Int = 6;
    public var MAT_RUBY(default, never) : Int = 7;
    public var MAT_STEEL(default, never) : Int = 8;
    public var MAT_LETHITE(default, never) : Int = 9;
    public var MAT_FERRITE(default, never) : Int = 10;
    public var MAT_FURRITE(default, never) : Int = 11;
    public var MAT_CRIMSTONE(default, never) : Int = 12;
    public var MAT_ICESTONE(default, never) : Int = 13;
    public var TYPE_NONE(default, never) : Int = 0;
    ...
    private function locChoicesArray(pierce : Bool, fun : Function) : ButtonDataList
    {
        var pDesc : Array<Dynamic>;
        var bdArray : Array<Dynamic> = [];
        var bd : ButtonDataList = new ButtonDataList();
        if (pierce)
        {
            pDesc = ["Add Piercing", "You can't have a piercing here!", "You already have a piercing here!"];
        }
        else
        {
        ...
        for (i in bdArray)
        {
            if (pierce)
            {
                if (Reflect.field(i, Std.string(2)) != null)
                {
                    bd.add(Reflect.field(i, Std.string(0)), Reflect.field(i, Std.string(1)), pDesc[0]);
                }
                else if (Reflect.field(i, Std.string(2)) != null)
                {
                    bd.add(Reflect.field(i, Std.string(0))).hint(pDesc[2]);
                }
                else
                {
                    bd.add(Reflect.field(i, Std.string(0))).hint(pDesc[1]);
                }
            }
            else if (Reflect.field(i, Std.string(2)) != null && Reflect.field(i, Std.string(2)) == null)
            {
                bd.add(Reflect.field(i, Std.string(0)), Reflect.field(i, Std.string(1)), pDesc[0]);
            }
            else
    ...
    private function normalPierceAssemble(loc : Int, type : Int, mat : Int) : Void
    {
        ...
        //Dudes
        else if (loc == 1 && (player.cockThatFits(36) >= 0 || flags[kFLAGS.HYPER_HAPPY] != null))
        {
            yaraSex(false);
            return;
        }
    ...
    private function yaraSex(girl : Bool = true) : Void
    {
        spriteSelect(SpriteDb.s_yara);
        clearOutput();
    ...
    private function letsDoYaraSex(girl : Bool = true) : Void
    {
        spriteSelect(SpriteDb.s_yara);
        clearOutput();
