...
class KatherineThreesome extends TelAdreAbstractContent
{
    public var edryn(get, never) : Edryn;
    public var katherine(get, never) : Katherine;
    public var urta(get, never) : Urta;
    ...
    private function get_edryn() : Edryn
    {
        return telAdre.edryn;
    }
    
    private function get_katherine() : Katherine
    {
        return telAdre.katherine;
    }
    ...
    //Not available if Kath has no cock
    {
        ...
        if (Lambda.indexOf([Face.ANIMAL_TOOTHS, Face.BEAR, Face.CAT, Face.CAT_CANINES, Face.DEVIL_FANGS, Face.DOG, Face.DRAGON, Face.DRAGON_FANGS, Face.JABBERWOCKY, Face.SALAMANDER_FANGS, Face.SHARK_TEETH, Face.FOX, Face.SNAKE_FANGS, Face.SPIDER_FANGS, Face.VAMPIRE, Face.WOLF, Face.WOLF_FANGS], player.faceType) != -1)
        {
        ...
        if (player.hasCock())
        {
            outputText("; [eachCock] erects, nice and ready for what’s to come");
        }
        else if (player.hasVagina())
        {
            outputText("; your pussy is drenched with your juices, some of it dripping on Urta’s tail");
        }
        outputText(".");
        ...
        if (player.hasVagina())
        {
            outputText("gently teasing around your cunt");
        }
        ...
        if (player.hasCock())
        {
            outputText("   Her hand teases your [cock] with the soft pads on the tips of her fingers; every once in awhile, she reaches up to collect a dollop of pre and smear it along your shaft, making it easier for her to tease you into defeat.");
        }
        if (player.hasVagina())
        {
            outputText("   Her " + ((player.hasCock()) ? "other " : "") + "hand teases your labia by gently circling it, the fur tickling your entrance so deliciously, you can’t help but buck against her wandering finger, trying to capture it within your moist walls.");
        }
        ...
        {
            outputText("utterly covers her from head to toe with her massive eruption of spooge");
        }
        ...
        if (player.hasCock())
        {
            outputText(" and especially against your " + player.cockDescript());
        }
        ...
        {
            outputText("her huge balls dredging up a load so massive it washes Urta’s cum right off your body");
        }
        ...
        {
            if (model.time.hours >= 13)
            {
                flags[kFLAGS.KATHERINE_LOCATION] = Katherine.KLOC_URTAS_APT;
            }  //Katherine.timeChange will sort out whether Kath actually stays with Urta  
    ...
    public function threeSixtyNine() : Void
    {
        ...
        {
            outputText("Urta grabs Kath from behind");
        }
        ...
        {
            outputText("Katherine's hips and buries her tongue in that wet pussy.\n\n");
        }
        ...
        {
            outputText(" and traps Kath's clit between her thumbs, forcing it to stand proud so she can suck on it");
        }
        ...
        {
            outputText("starts slurping and sucking on Kath's pussy like she's dying of thirst.\n\n");
        }
        ...
        {
            outputText(" Even her pregnancy is eclipsed by the volume of cum Urta pumps out.");
        }
        ...
        {
            outputText("locks her legs around Urta's head.  A vacant, pleased expression crosses Kath's face as she tongues Urta's balls, coaxing out every last drop.  Now");
        }
        outputText(" after that display you’re desperate to add your contribution.\n\n");
        var canImpregUrta : Bool = (flags[kFLAGS.URTA_FERTILE] == 1) && (!urta.pregnancy.isPregnant);
        var doKath : Bool;
        ...
        if (doKath)
        {
            outputText("You pull out and switch back to Kath.  She’s so relaxed and so wet that your cock slides back inside easily.  You only need to give her a few strokes before you feel her tunnel clenching as Katherine starts into a second orgasm.  ");
        }
        ...
        {
            outputText("Your overpowered " + ((player.hasBalls()) ? "balls produce" : "prostate produces") + " jet after boiling jet of cum.  ");
        }
        if (doKath || katherine.hasCock())
        {
            outputText("You feel a bit of resistance - after all there’s little space left for " + ((doKath) ? "Katherine" : "Urta") + "’s belly to expand.  ");
        }
    ...
    //Not available if Kath has no cock
    {
        ...
        else
        {
            ...
            {
                outputText(katherine.cockMultiple("your pussy", "both your pussy and your ass"));
            }
        ...
        {
            outputText("plays with your asshole");
        }
        ...
        {
            outputText(" of her cock presses firmly against your " + ((player.hasVagina()) ? "cunt" : "ass"));
        }
        ...
        {
            outputText("her " + katherine.cockType() + "  cocks into your body, caring little that your ass wasn’t built to take her twin " + katherine.cockLength + " inch shafts");
        }
        ...
        var wasButtStretched : Bool = false;
        if (katherine.cockNumber > 1)
        {
            if (player.hasVagina())
            {
        ...
        if (player.hasVagina())
        {
            if (player.cuntChange(katherine.cockArea(), true))
            {
                outputText("\n\n");
            }
        }
        ...
        {
            outputText("Mmmm, your prostate is just so hot and swollen");
        }
    ...
    //Works for all except genderless characters
    {
        ...
        clearOutput();
        var atBar : Bool = katherine.isAt(Katherine.KLOC_BAR) || katherine.isAt(Katherine.KLOC_BAR_DRUNK);
        if (atBar)
        {
        ...
        if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] <= 15)
        ...
        if (katherine.hasCock())
        {
            outputText("A hot spray of cum lands on and around your " + ((player.isTaur()) ? "rear " : "") + ((player.isNaga()) ? "tail" : "feet") + ".  ");
        }
    ...
    //Kath is sober, Urta is drunk //Not available if Kath has no cock
    {
        ...
        {
            outputText((player.isNaga()) ? "quickly coil your tail over" : "kneel atop");
        }
    ...
    private function pinAndFuckMountUrta() : Void
    //Plays for anyone without a cock and for herms who select this option
    {
        ...
        else
        {
            ...
            if (player.isPregnant())
            {
                ...
                else if (player.pregnancyType == PregnancyStore.PREGNANCY_URTA || player.pregnancyType == PregnancyStore.PREGNANCY_URTA)
    ...
    private function pinAndFuckStuffKath() : Void
    ...
    public function watch(urtaIsDrunk : Bool) : Void
    ...
    public function watchNoIntro(urtaIsDrunk : Bool) : Void
    //Kath is sober (or drunk), Urta is drunk
    {
    ...
    private function watchMainBody(urtaIsDrunk : Bool) : Void
    //Kath is sober, Urta is drunk
    {
        ...
        {
            outputText("Kath's dripping slit.\n\n");
        }
    ...
    //Kath is drunk, Urta is sober //Not available if Kath has no cock
    {
        ...
        {
            outputText((player.isNaga()) ? "slither in front of" : "kneel in front of");
        }
        ...
        {
            outputText("your pussy. Kath presses her face to your crotch,");
        }
    ...
    private function sandwichGetFucked() : Void
    {
        ...
        {
            outputText((player.isNaga()) ? "slide across the floor, tensing your tail so as to bring your [vagOrAss] level with her flared shaft" : "turn around and bend over, presenting your ass");
        }
    ...
    private function sandwichGetLicked() : Void
    {
        ...
        {
            outputText("her cock into Urta’s willing " + ((urta.pregnancy.isPregnant) ? "ass" : "pussy"));
        }
    ...
    private function sandwichMaleCentaurLicked() : Void
    {
        ...
        {
            outputText((urta.pregnancy.isPregnant) ? "ass" : "pussy");
        }
    ...
    private function sandwichCommonEnd() : Void
    {
        ...
        {
            outputText("the base of her " + katherine.cockMultiple("", "lower ") + "cock");
        }
        outputText(".\n\n");
    ...
    //Both Kath and Urta are drunk
    {
        ...
        {
            outputText((player.hasBreasts()) ? "breasts" : "ass");
        }
        ...
        var valaHere : Bool = flags[kFLAGS.FREED_VALA] > 0 && model.time.hours >= 12 && model.time.hours <= 21;
        if (valaHere)
        {
        ...
        {
            sceneHunter.print("Check failed: Vala!");
        }
        ...
        {
            outputText((player.hasVagina()) ? "licked you out" : "fisted your ass");
        }
    ...
    //Both Kath and Urta are drunk
    {
        ...
        var urtaHasHouse : Bool = player.hasKeyItem("Spare Key to Urta's House") >= 0;
        ...
        var bothF : Void->Void = function() : Void
        {
            ...
            if (player.cumQ() < 500)
            {
                ...
                {
                    outputText("  Your other cock" + ((player.cockTotal() > 3) ? "s" : "") + " produce a few squirts which coat both Kath and Urta’s bodies.");
                }
            ...
            else if (player.cumQ() < 1500)
            {
                ...
                {
                    outputText("Urta swallows your load with ease; Kath, her tummy already brimming thanks to Urta's efforts, has more trouble.  They gulp it all down but afterwards Kath cradles her overstuffed belly and Urta massages her sides, trying to reduce the pressure.");
                }
                if (player.cockTotal() > 2)
                {
                    outputText("  You realize that your free cock" + ((player.cockTotal() > 3) ? "s" : "") + " fired their streams all over the room, adding to the mess Urta will have to clean up later.");
                }
            ...
            else
            {
                ...
                {
                    outputText("Urta’s gut starts to expand, your deposit soon rounding her belly just as much as Kath's.  Kath’s belly swells a little too, but under the added pressure quite a bit of Urta’s cum starts to leak out.");
                }
                if (player.cockTotal() > 2)
                {
                    outputText("  Your other cock" + ((player.cockTotal() > 3) ? "s" : "") + " release a torrent of cum, coating Kath, Urta, the floor and a few of the walls.  Though it’s messy you’re sure both your lovers are happy that at least some of your sperm didn’t wind up inside them.");
                }
        ...
        var urtaF : Void->Void = function() : Void
        //Urta takes it
        {
        ...
        var kathF : Void->Void = function() : Void
        //Kath takes it
        {
        ...
        var sharedEnd : Void->Void = function() : Void
        {
            ...
            else
            {
                ...
                {
                    outputText((player.cor < 66) ? ".  Despite having just cum you feel a little twitch from your cock." : ".  It's sickly sweet, but who cares as long as they keep fucking like that.");
                }
            }
            player.sexReward("saliva", "Dick");
            katherine.orgasm();
    ...
    //Both Kath and Urta are drunk
    {
        ...
        {
            outputText("breasts are manhandled.  You watch as " + ((katherine.breasts.lactating()) ? "cream runs down her front and" : "some of her") + " femcum dribbles down her thigh.\n\n");
        }
        if (katherine.hasCock())
        {
        ...
        {
            outputText("Urta props the tip of her huge horsecock against Kath’s clit and tells her, \"<i>No teasing today kitty.  Today I am gonna use this monster on you.</i>\"  Kath looks down between her breasts and then over at you.\n\n");
        }
        ...
        {
            outputText("pussy releasing a flood of girl cum that " + katherine.catGirl("wets her skin", "mats her fur") + " all the way to her feet and soaks into the floor beneath you.\n\n");
        }
        ...
        {
            outputText("weakly grinding against Urta's cock as her body begs for more.\n\n");
        }
        ...
        else
        {
            ...
            {
                outputText("Secretly you try to force even more sperm from your " + ((player.hasBalls()) ? "heavy balls" : "monstrous prostate") + ".  You want to see just how far you can stretch out your cat " + katherine.catGirl("girl", "morph") + "’s belly.  Even more, you want to see if you can get her addicted to the feeling of being overfilled.");
            }
        ...
        if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] == 1)
        ...
        else if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] < 32)
    ...
    private function valaCommonStart() : Void
    {
        ...
        if (katherine.hasCock())
        {
            outputText("  Her cock" + katherine.cockMultiple(" is hard enough that it's", "s are hard enough that they're") + " jutting out horizontally.");
        }
        outputText("\n\n");
    }
    
    private function valaCommonPostSex(theyWereFucking : Bool) : Void
