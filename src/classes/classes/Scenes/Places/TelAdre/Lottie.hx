...
class Lottie extends TelAdreAbstractContent
{
    
    //[INITIAL INTRO – Requires Male/Herm, visits at 5pm – 7pm]
    public function lottieAppearance(display : Bool = true) : Function
    {
        if (!player.hasCock())
        {
            return null;
            ...
            else
            {
                ...
                //[RANDOM INTROS]{
                    ...
                    if (flags[kFLAGS.LOTTIE_CONFIDENCE] < 30 && rand(6) == 0)
                    {
                        ...
                        if (silly())
                        {
                            outputText("  What can you say? You love making bacon.");
                        }
                    }
                    //[Encouragement 0 – 30]
                    else if (flags[kFLAGS.LOTTIE_CONFIDENCE] < 30 && rand(5) == 0)
                    {
                        ...
                        if (silly())
                        {
                            outputText("  What can you say? Her pork buns are the best.");
                        }
                    }
                    //[REPEAT INTROS]
                    else if (rand(2) == 0)
                    {
                        ...
                        if (flags[kFLAGS.LOTTIE_TONE] <= 33)
                        {
                            outputText("voluptuous");
                        }
                        else if (flags[kFLAGS.LOTTIE_TONE] <= 66)
                        {
                            outputText("plump");
                        }
                        else
    ...
    //(d/e/f/g)
    {
        ...
        if (flags[kFLAGS.LOTTIE_TONE] >= 75)
        {
            return "D";
        }
        else if (flags[kFLAGS.LOTTIE_TONE] >= 50)
        {
            return "E";
        }
        else if (flags[kFLAGS.LOTTIE_TONE] >= 25)
        {
            return "F";
        }
        else
    ...
    private function encounterLottieCharge() : Void
    {
        encounterLottie(true);
    }
    
    public function encounterLottie(charge : Bool = false) : Void
    {
        ...
        {
            //279 - LOTTIES FIGURE - HIGHER = LIGHTER  //280 - Encouragement Value - higher = happier    //281 - times met lottie    //297 - lottie love her body?    //298 - times porked lottie    //[REPEAT ENCOUNTER]  {
                outputText("You approach the pig girl ");
                if (flags[kFLAGS.LOTTIE_CONFIDENCE] >= 50)
                {
                    outputText("relaxing");
                }
                else
                {
                    outputText("sitting timidly");
                }
                outputText(" at a table, wearing her low-cut top and booty shorts that accentuate her ");
                if (flags[kFLAGS.LOTTIE_TONE] <= 50)
                {
                    outputText("plump");
                }
                else
                ...
                outputText(" figure.  ");
                if (flags[kFLAGS.LOTTIE_BIGGER_IS_BETTER_BUGFLAG] == 0)
                {
                    outputText("Lightly sipping");
                }
                else
                {
                    outputText("Slurping down");
                }
                outputText(" what appears to be ");
                if (flags[kFLAGS.LOTTIE_BIGGER_IS_BETTER_BUGFLAG] == 0)
                {
                    outputText("some juice");
                }
                else
                {
                    outputText("a milkshake");
                }
                outputText(", her eyes wander over the room when she spots you and waves");
                if (flags[kFLAGS.LOTTIE_CONFIDENCE] >= 70)
                {
                    outputText(" excitedly");
                }
                ...
                else if (flags[kFLAGS.LOTTIE_TRAINER_ACCEPTED] == 0)
                {
                    ...
                    //[Yes][No][God No]
                    if (silly() && player.cor >= 80)
                    {
                        comedy1 = gotInShapeComedyDeclineLottie;
                    }
                ...
                //[Figure 0 – 20]{
                    ...
                    if (flags[kFLAGS.LOTTIE_TONE] <= 20 && flags[kFLAGS.LOTTIE_BIGGER_IS_BETTER_BUGFLAG] == 0)
                    {
                        outputText("\"<i>Oh, [name]! Let's do our best today, I really wanna lose those pounds! I know I can do my best when I'm with you!</i>\" Lottie beams, her massive tits pushed against the table. She seems to be excited for what you've got in store today.");
                    }
                    //[Figure 0 - 20, convinced her to accept body]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 20)
                    {
                        outputText("\"<i>Hey, " + player.mf("stud", "cutie") + "! You shouldn't keep a big girl like me waiting; unless you wanna get crushed by these!</i>\" Lottie grins and grabs her luscious breasts firmly, giggling when she notices you're at full attention now. She seems to be excited for what you've got in store today.");
                    }
                    //Figure 20 - 40, haven't convinced her to accept body]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 40 && flags[kFLAGS.LOTTIE_BIGGER_IS_BETTER_BUGFLAG] == 0)
                    {
                        outputText("\"<i>Ah, [name]! We should probably get started soon; I'm gonna push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems to be excited for what you've got in store today.");
                    }
                    //[Figure 20 - 40, convinced her to accept body]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 40)
                    {
                        outputText("\"<i>Hey, " + player.mf("stud", "cutie") + "! You shouldn't keep me waiting; the only thing I'm losing right now is my patience!</i>\" Lottie grins and punches your arm playfully, squealing when you try to get her back. She seems to be excited for what you've got in store today.");
                    }
                    //[Figure 40 - 60]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 60)
                    {
                        outputText("\"<i>Hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks happy that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems to be excited for what you've got in store today.");
                    }
                    //[Figure 60 - 80]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 80)
                    {
                        outputText("\"<i>Yo, " + player.mf("big guy", "babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
                    }
                    //[Figure 80 - 100]
                    else
                    {
                        outputText("\"<i>Hey, " + player.mf("stud", "cutie") + "! You shouldn't keep me waiting, or I'll put you through the burn twice as hard! You ready?</i>\" Lottie winks at you and punches your arm playfully. She seems to be excited for what you've got in store today.");
                    }
                }
                ...
                //[Figure 0 - 20]{
                    ...
                    if (flags[kFLAGS.LOTTIE_TONE] <= 20)
                    {
                        outputText("\"<i>Oh, [name], hey. I think we should try and get into it today. I don't think I tried hard enough last time, y'know?</i>\" Lottie leans over to grab her beverage, her massive tits pushed against the table. She seems to be intent on trying her best today.");
                    }
                    //[Figure 20 - 40]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 40)
                    {
                        outputText("\"<i>A-ah, [name]! We should probably get started soon; I... I want to push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems curious as to what you both plan to do today.");
                    }
                    //[Figure 40 - 60]
                    else if (flags[kFLAGS.LOTTIE_TONE] <= 60)
                    {
                        outputText("\"<i>H-hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks at ease now that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems curious as to what you both plan to do today.");
                    }
                    //[Figure 60 - 80]
                    else
                    {
                        outputText("\"<i>Hello [name]! I've... I've been waiting for you, so you better be ready, hey! Don't hold back!</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
                    }
                }
        ...
        {
            addButton(6, "SpecialTalk", oneTimeTalks).disableIf(lottieMorale() > 0 && lottieMorale() < 100 || lottieTone() > 0 && lottieTone() < 100, 
    ...
    private function acceptBeingLottiesHamSandwich() : Void
    {
        ...
        {
            outputText("and shorter than you");
        }
        else if (player.tallness > 53)
        {
            outputText("but you can't judge, being roughly the same height");
        }
        else
        {
            outputText("taller than you");
        }
    ...
    private function drinkWaterWithYourHamhock() : Void
    {
        ...
        {
            outputText("You've never had any experience with the yoga classes first hand, but you tell ");
        }
        else
        {
            outputText("You've had experience with the yoga classes, so you tell ");
        }
    ...
    private function drinkLustWithYourHamhock() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(" while her fingers nervously trace around your balls");
        }
    ...
    public function analLottieMilkshake() : Void
    {
        ...
        {
            outputText(", managing to squeeze in your other cock along with it");
        }
        else if (player.cockTotal() > 2)
        {
            outputText(", the rest of your dicks poking and prodding against her soft flesh");
        }
        ...
        if (player.hasBalls())
        {
            outputText(", her soaked pussy rubbing against your balls");
        }
        outputText(".\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("Your " + sackDescript() + " begins to swell");
        }
        else
        {
            outputText("You feel yourself about to explode");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText(", a heavy amount leaking from her ass");
        }
        ...
        lottieTone(1);
        if (flags[kFLAGS.LOTTIE_ANAL_TALK] == 0)
        {
            flags[kFLAGS.LOTTIE_ANAL_TALK] = 1;
        }
    ...
    public function getSuckedOffByAHamSandwich() : Void
    {
        ...
        else if (player.cocks[x].cockLength <= 12)
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText(" biggest head lightly");
            }
            else
            {
                outputText(" head lightly");
            }
            ...
            if (player.cockTotal() > 1)
            {
                outputText(", jerking off your " + cockDescript(player.biggestCockIndex2()) + " with both hands");
            }
        ...
        else
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText(" - using her hands to massage your leftover " + cockDescript(player.biggestCockIndex2()));
            }
        ...
        if (player.hasBalls())
        {
            outputText(", your sack slapping against her chin ");
        }
        else if (player.biggestTitSize() > 2)
        {
            outputText(" while you play with your " + biggestBreastSizeDescript());
        }
        ...
        if (player.cockTotal() > 1)
        {
            if (player.cockTotal() == 2)
            {
                outputText("  Your extra cock flails wildly, slapping against her cheeks.");
            }
            else if (player.cockTotal() > 2)
            {
                outputText("  Your extra cocks flail wildly, slapping against her cheeks.");
            }
        }
        ...
        if (player.cockTotal() > 1)
        {
            outputText(" stops rubbing your " + cockDescript(x) + " to ");
        }
        //(Otherwise)
        else
        {
            outputText(" reaches down towards her dripping pussy; plunging two fingers into her wetness while using the other hand to ");
        }
        //If Balls]
        if (player.hasBalls())
        {
            outputText("knead your " + ballsDescriptLight());
        }
        else
        {
            outputText("reach around and squeeze your " + buttDescript());
        }
        ...
        {
            outputText("your sensitive tip brushing against her eager mouth");
        }
        //Otherwise]
        else
        {
            outputText("resting comfortably in between her cushiony fuckpillows");
        }
        ...
        if (player.cockTotal() > 1)
        {
            outputText(" and chokes on your meat");
        }
        ...
        if (player.cumQ() < 500)
        {
            outputText("thick ropes of cum splattering all over her face and pooling in between her tits");
        }
        else
        {
            outputText("massive globules of cum splattering all over her face and painting her tits");
        }
        ...
        if (player.cumQ() > 500)
        {
            outputText("incredible amounts of ");
        }
        ...
        //LOTTIE FIGURE -1, MUSCLE TONE +1, DRAINS PC'S LUST.
        lottieTone(-1);
        if (flags[kFLAGS.LOTTIE_ORAL_TALK] == 0)
        {
            flags[kFLAGS.LOTTIE_ORAL_TALK] = 1;
        }
        outputText(player.modTone(player.maxToneCap(), 1));
    ...
    public function lottieTone(dif : Float = 0) : Float
    {
        if (dif == 0)
        {
        ...
        if (flags[kFLAGS.LOTTIE_TONE] > 100)
        {
            flags[kFLAGS.LOTTIE_TONE] = 100;
        }
        else if (flags[kFLAGS.LOTTIE_TONE] < 0)
        {
            flags[kFLAGS.LOTTIE_TONE] = 0;
        }
        //Clear blowjob/anal change talk flags in case tone is getting out of whack.
        if (flags[kFLAGS.LOTTIE_ORAL_TALK] == 1)
        {
            flags[kFLAGS.LOTTIE_ORAL_TALK] = 0;
        }
        if (flags[kFLAGS.LOTTIE_ANAL_TALK] == 1)
        {
            flags[kFLAGS.LOTTIE_ANAL_TALK] = 0;
        }
        return flags[kFLAGS.LOTTIE_TONE];
    }
    public function lottieMorale(dif : Float = 0) : Float
    {
        if (dif == 0)
        {
        ...
        if (flags[kFLAGS.LOTTIE_CONFIDENCE] > 100)
        {
            flags[kFLAGS.LOTTIE_CONFIDENCE] = 100;
        }
        else if (flags[kFLAGS.LOTTIE_CONFIDENCE] < 0)
        {
            flags[kFLAGS.LOTTIE_CONFIDENCE] = 0;
        }
        return flags[kFLAGS.LOTTIE_CONFIDENCE];
    }
    ...
    private function talkToPigSlut() : Void
    {
        ...
        {
            //[If Gained Weight since Last Encounter, Encouragement 0 - 30]if (lottieMorale() <= 30 && flags[kFLAGS.LOTTIE_LAST_TONE] - 5 > lottieTone())
            {
            ...
            {
                //[If Lost Weight since Last Encounter, Encouragement 0 - 30]if (lottieMorale() <= 30 && flags[kFLAGS.LOTTIE_LAST_TONE] < lottieTone() - 5)
                {
                ...
                else if (!oneTimeTalks())
                {
                    genericTalks();
                }
            }
        }  //check one-time events, and if nothing is triggered do something generic  
        flags[kFLAGS.LOTTIE_LAST_TONE] = lottieTone();
    }
    
    //Returns true if any talk is triggered, false otherwise
    private function oneTimeTalks(fromSH : Bool = false) : Bool
    {
        var comedy1 : Function = null;
        ...
        if (lottieMorale() == 0 && lottieTone() == 0 && (flags[kFLAGS.LOTTIE_FAT_SAD_TRIGGERED] == 0 || fromSH))
        {
            ...
            if (silly())
            {
                comedy1 = lottieFatLoserCulminationLeaveComedyChoice;
            }
        ...
        else if (lottieMorale() == 0 && lottieTone() == 100 && (flags[kFLAGS.LOTTIE_SLIM_SAD_TRIGGERED] == 0 || fromSH))
        {
            ...
            if (silly())
            {
                comedy1 = charlottesWebComedyBullshit;
            }
    ...
    private function lottieFatLoserCulminationFuckChoice() : Void
    {
        ...
        if (silly())
        {
            outputText("  You fucking love bacon shakes.");
        }
    ...
    private function lottieFatLoserCulminationHumiliationChoice() : Void
    {
        ...
        if (silly())
        {
            outputText("BACON BACON BACON BACON BACON BACON! GOTTA HAVE BACON!");
        }
        else
        {
            outputText("Heyyy *hic* buddy, is she like your *hic* shex-slave or sumthin?");
        }
    ...
    private function lottieHighMoraleFatLoveSelfOneTimeEvent() : Void
    {
        ...
        {
            outputText("her ample cheeks resting on your groin as you bottom out in her");
        }
        else
        {
            outputText("though you only reach so far before you've filled her up entirely with your length");
        }
        ...
        if (silly())
        {
            outputText(" Before you leave, you make sure to head out to the cafe to buy yourself a bacon shake. You love bacon shakes.\n\n");
        }
        else
        {
            outputText("\n\n");
    ...
    private function lottieHighMoraleFatYoullGetThereOneTimeEvent() : Void
    {
        ...
        if (silly())
        {
            outputText("  They're fucking delicious.");
        }
        outputText("\n\n");
        //[Unlocks Quickie]
    ...
    private function lottieElleThreesomeFirstTime() : Void
    {
        ...
        if (silly())
        {
            outputText("  You only need one of those to satisfy you.");
        }
        player.sexReward("vaginalFluids", "Dick");
        dynStats("sen", -2);
        //[Unlocks Threesome]
    ...
    private function fuckElleInsteadOfThatFatSlutFirstTime() : Void
    {
        ...
        if (player.cockTotal() == 1)
        {
            ...
            if (player.hasBalls())
            {
                outputText("massaging your balls");
            }
            else if (player.hasVagina())
            {
                outputText("massaging your pussy");
            }
            else
            {
                outputText("massaging your ass");
            }
        }
        else
        {
            outputText("uses all four of her hands to handle your [cocks], jerking each one with ease");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText(" throbs, spilling out its essence along the floor and onto Lottie.");
            }
            else
            {
                outputText("s throb, spilling out their essence along the floor and onto Lottie.");
            }
        }
        ...
        if (silly())
        {
            outputText(", making sure to grab a bacon shake on the way out. You only need one of those to satisfy you");
        }
        outputText(".");
        //[Unlocks Netorare]
    ...
    private function lottieSuccessOneShot() : Void
    {
        ...
        else
        {
            ...
            if (player.cumQ() < 500)
            {
                ...
                if (silly())
                {
                    outputText(" You buy a bacon shake before deciding to head home. You fucking love bacon shakes.\n\n");
                }
                else
                {
                    outputText("\n\n");
    ...
    private function lottieExercise() : Void
    {
        ...
        if (lottieMorale() >= 66)
        {
            outputText("with an enthusiastic nod");
        }
        else if (lottieMorale() >= 33)
        {
            outputText("with a nod in agreement");
        }
        else
        {
            outputText("by slowly looking up at you and nodding her head");
        }
    ...
    private function lottieWeights() : Void
    {
        ...
        {
            sceneHunter.print("Special scene is available when:"
    ...
    private function boastAtLottie() : Void
    {
        ...
        if (silly())
        {
            outputText("large *pomf =3*");
        }
        else
        {
            outputText("loud clonk");
        }
    ...
    private function waitAndShowLottieYourPoolBoner() : Void
    {
        ...
        {
            outputText("pride and joy");
        }
        else if (player.biggestCockArea() < 5)
        {
            outputText("secret shame");
        }
        else
        {
            outputText("painfully average prick");
        }
    ...
    public function giveLottieAnItem() : Void
    {
        ...
        if (silly())
        {
            addButton(3, "HamSandwich", hamSammitchTimeBIATCH);
        }
    ...
    public function hamSammitchTimeBIATCH() : Void
    {
        ...
        if (flags[kFLAGS.LOTTIE_HAM_SAMMICH] == 0)
        {
            ...
            if (silly())
            {
                outputText(", mumbling something about lifetime members receiving free pig-related food items");
            }
    ...
    public function lottieFuck() : Void
    {
        ...
        if (silly())
        {
            addButton(3, "30 Minute", lottiesThirtyMinutePigGasm).disableIf(!player.hasCock(), "You must have a cock.");
        }
        //fill the place with hint buttons
        for (i in [5, 6, 7, 8, 10, 11, 12, 13])
        {
        ...
        {
            addButton(5, "Doggystyle", lottieRepeatDoggieStyle).disableIf(!sceneHunter.other && !(lottieMorale() <= 30 && lottieTone() <= 30), "Lottie must have low morale and low tone.");
        }
        if (flags[kFLAGS.LOTTIE_WALKIES_UNLOCKED] > 0)
        {
            addButton(6, "Walkies", lottieRepeatWalkies).disableIf(!sceneHunter.other && !(lottieMorale() <= 30 && lottieTone() <= 30), "Lottie must have low morale and low tone.");
        }
        //0-100
        if (flags[kFLAGS.LOTTIE_THREESOME_UNLOCKED] > 0)
        {
            addButton(7, "Threesome", lottieRepeatThreesome).disableIf(!sceneHunter.other && !(lottieMorale() <= 30 && lottieTone() >= 70), "Lottie must have low morale and high tone.");
        }
        if (flags[kFLAGS.LOTTIE_NTR_UNLOCKED] > 0)
        {
            addButton(8, "Netorare", lottieRepeatSUPERNEATORARES).disableIf(!sceneHunter.other && !(lottieMorale() <= 30 && lottieTone() >= 70), "Lottie must have low morale and high tone.");
        }
        //100-0
        if (flags[kFLAGS.LOTTIE_QUICKIE_UNLOCKED] > 0)
        {
            addButton(10, "Quickie", lottieRepeatQuickie).disableIf(!sceneHunter.other && !(lottieMorale() >= 70 && lottieTone() <= 30), "Lottie must have high morale and low tone.");
        }
        if (flags[kFLAGS.LOTTIE_COWGIRL_UNLOCKED] > 0)
        {
            addButton(11, "Cowgirl", lottieRepeatCowGirl).disableIf(!sceneHunter.other && !(lottieMorale() >= 70 && lottieTone() <= 30), "Lottie must have high morale and low tone.");
        }
        if (flags[kFLAGS.LOTTIE_REVERSECOW_UNLOCKED] > 0)
        {
            addButton(12, "R.Cowgirl", lottieRepeatBackwardsAssCowgirl).disableIf(!sceneHunter.other && !(lottieMorale() >= 70 && lottieTone() <= 30 && !(player.tone <= 30 && player.thickness >= 70)), 
        ...
        {
            addButton(13, "Femdom", lottieRepeatFEMDOMFEMFDOM).disableIf(!sceneHunter.other && !(lottieMorale() >= 70 && lottieTone() <= 30 && player.tone <= 30 && player.thickness >= 70), 
    ...
    public function lottieRepeatWalkies() : Void
    {
        ...
        if (!silly())
        {
            outputText("Heyyy, is she like *hic* your shex slave er shumthin?");
        }
        else
        {
            outputText("Heyyy, do I shmell bacon?  I fucking love bacon!  BACON BACON BACON!");
        }
        ...
        if (silly())
        {
            outputText("  You sure do love spit roasting a pig, but nothing can beat a bacon shake.");
        }
        player.orgasm();
    ...
    public function lottieRepeatCowGirl() : Void
    {
        ...
        if (silly())
        {
            outputText("  You love bacon shakes.");
        }
        player.sexReward("vaginalFluids", "Dick");
        dynStats("sen", -2);
    ...
    public function lottieRepeatSUPERNEATORARES() : Void
    {
        ...
        {
            outputText("uses all four of her hands to handle " + sMultiCockDesc() + ", jerking each one with ease");
        }
    ...
    public function tentaDickLottie() : Void
    {
        ...
        }  //fill the array with cocks or -1's  
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) < 10)
        {
            sceneHunter.print("You can fit more tentacocks in this scene!");
        }
        //scene
        clearOutput();
        ...
        if (lottieMorale() <= 30)
        {
            outputText("  She gives you a gloomy stare, before turning her head back down and plunging it into the mattress, already accepting her defeat");
        }
        else
        {
            outputText("  She raises an eyebrow, though doesn't probe any further");
        }
        outputText(".\n\n");
        ...
        if (x[1] >= 0)
        {
            ...
            if (player.cockArea(x[1]) <= 80)
            {
                outputText("the entirety of your " + cockDescript(x[1]));
            }
            else
            {
                outputText("as many inches of your " + cockDescript(x[1]));
            }
            ...
            if (x[2] >= 0)
            {
                ...
                if (lottieMorale() < 40)
                {
                    outputText("  This pig slut really loves to be used like that!");
                }
                else
                {
                    outputText("  Your pig lover really loves what you're doing to her!");
                }
                    ...
                    if (x[4] >= 0)
                    {
                        ...
                        if (x[5] >= 0)
                        {
                            ...
                            if (x[6] >= 0)
                            {
                                ...
                                if (x[7] >= 0)
                                {
                                    outputText("  Seeing the effect your junk had on her, you move your " + cockDescript(x[7]) + " to her remaining hand and she grips it likewise.");
                                }
        ...
        if (lottieMorale() >= 99)
        {
            ...
            if (silly())
            {
                outputText("  Before you leave, you make sure to grab a bacon shake from the clerk, high-fiving her as you backflip back to camp.");
            }
            outputText("\n\n");
        }
        //[if enc. 0]
    ...
    public function ifrisAndLottieGetsNTRedLiftingWeights() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("  Your pace doesn't slow, even when your swollen balls smack loudly against her chin.");
        }
        outputText("  You let out a deranged chuckle at the sight of Ifris being thrown about");
        if (player.hasBalls())
        {
            outputText(", sweaty gonads colliding into her");
        }
    ...
    private function lottieAndIfrisNTREpilogue() : Void
    {
        ...
        {
            outputText("I had to make a show of fining you for public indecency, but you'll note your money is all still there.  Pay me back sometime, okay, hun?\n\n-Always up for you, Urta");
        }
        outputText("</i>\"\n\n");
        ...
        if (silly())
        {
            outputText("  You'll make damn sure to buy Urta a bacon shake tomorrow.");
        }
        doNext(camp.returnToCampUseOneHour);
    }
