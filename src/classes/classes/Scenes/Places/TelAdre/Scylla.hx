...
class Scylla extends TelAdreAbstractContent
{
    public var action(get, never) : Int;

    
    public static inline var SCYLLA_NOT_PRESENT : Int = 0;
    public static inline var SCYLLA_ACTION_FIRST_TALK : Int = 1;
    public static inline var SCYLLA_ACTION_ROUND_TWO : Int = 2;
    public static inline var SCYLLA_ACTION_ROUND_THREE : Int = 3;
    public static inline var SCYLLA_ACTION_ROUND_FOUR : Int = 4;
    public static inline var SCYLLA_ACTION_MEET_CATS : Int = 5;
    public static inline var SCYLLA_ACTION_ADICTS_ANON : Int = 6;
    public static inline var SCYLLA_ACTION_FLYING_SOLO : Int = 7;
    public static inline var SCYLLA_ACTION_FUCKING_URTA : Int = 8;
    public static inline var SCYLLA_ACTION_FURRY_FOURSOME : Int = 9;
    ...
    private function scyllaSprite() : Void
    {
        ...
        {
            spriteSelect(SpriteDb.s_scyllaAndBear);
        }
        else
        {
            spriteSelect(SpriteDb.s_scylla);
        }
    }
    ...
    //This allows Scylla's activity at the bar to be determined before any description of what Kath and Urta be doing.
    {
        ...
        if (model.time.totalTime == scyllaLastActionSelectionTime)
        {
            return;
        ...
        {
            return;
        }  //Factory still running? NoScylla4U  
        ...
        if (player.cocks.length > 0)
        {
            ...
            {
                return;
            }  //Minimum Scylla meetings for Urta to fuck her  
            if (flags[kFLAGS.URTA_NO_MORE_SCYLLA] == 1 && flags[kFLAGS.URTA_TALKED_ABOUT_SCYLLA] == 1)
            {
                return;
            }  //Together these are the 'No more Scylla' flag  
            if (!SceneLib.urta.urtaAtBar() || flags[kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] > 0)
            {
                return;
            }
            if (flags[kFLAGS.URTA_TIME_SINCE_LAST_CAME] > 0 || flags[kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] <= 2 || flags[kFLAGS.TIMES_FUCKED_URTA] == 0)
            {
                return;
            }
            ...
            else if (SceneLib.urta.urtaDrunk() && player.balls == 0)
            {
                return;
            }  //Otherwise she has to be sober and you need to have balls (I'm not sure why, but it is so)  
            if (telAdre.katherine.needIntroductionFromScylla())
            {
                return;
            }
            if (rand(3) == 0)
            {
                scyllaAction = SCYLLA_ACTION_FUCKING_URTA;
            }  //And after all that there's still just a 1/3 chance it will happen  
            //Yay, Foursomes! - unless you're Scylla special
            if (rand(2) == 0 && flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] >= 3 && player.hasKeyItem("Opal Ring") < 0 && SceneLib.urta.urtaAtBar() && player.longestCockLength() >= 8 && flags[kFLAGS.URTA_SCYLLA_TIMES_CAUGHT] > 0)
            {
                scyllaAction = SCYLLA_ACTION_FURRY_FOURSOME;
            }
        }
    }
    ...
    public function talkToScylla() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-first-meeting"));
        ...
        outputText("Scylla runs her fingertips along the rounded horns, embarrassed, \"<i>I did not escape unscathed, I fear. Even the slightest taste of that foul brew was enough to change my body. I grew taller and... filled out in most impure ways. You have seen the horns but the worst is how it changed my mouth</i>.\"\n\nHer fingers run along her plump, crimson lips. She gasps as they tremble at the touch, her chest rising and falling in a motion that puts a terrible strain on her too-small robe. She looks at you with pure, blue eyes that shimmer on the edge of tears.\n\n\"<i>I can't eat. I can't drink. Everything tastes like ashes in my mouth. Even wine might as well be salt water. My thirst is just... so...</i>\" she trails off to stare at the shattered remains of the cream saucer, seemingly forgetting you as she runs a hand up her side, cups her breast, and tweaks her nipple through the fabric.\n\n");
        
        //(If the player has a penis and balls)
        outputText("You're pretty sure you know what the demon drink did to Scylla.\n\n");
        
        outputText("She's clearly addicted to semen, and if you don't help her she'll probably disappear with someone else forever.  Then again - whatever has tainted her might have an effect on you.  Do you help her quench her thirst?");
    ...
    public function helpScylla() : Void
    {
        ...
        var x : Float = player.biggestCockIndex();
        clearOutput();
        outputText(images.showImage("scylla-first-help"));
        outputText("You explain that you've run into this sort of thing before and ask her to follow you upstairs to a room. Shyly, she accompanies you and sits down on the bed next to you. In the light, you get a better look at her. She's nearly 7 feet tall, though terribly thin from her demonic starvation. Her breasts have not lost any weight, however, and the D-cups push against her dress with every breath. She shakes her curly black hair from the hood and it spills down her back in surprisingly long locks- it's at least four feet and forms a billowing curtain around her shoulders, hips, and waist. She looks innocently at you, patiently waiting for your diagnosis. The hopeful trust in her eyes almost makes you blush as you explain that the demons have given her a powerful addiction. Considering the nature of her tormenters, she is almost certainly addicted to cum.\n\n");
        
        outputText("Scylla squeaks in shock and crosses her legs tightly. \"<i>I can't...! I've never had... you know...</i>\" she mouths the word \"<i>sex,</i>\" not daring to say it aloud. You assure her that it need not come to that. If she drank some, you explain, it would ease the thirst pains and preserve her chastity. She shakes her head, as if to drive the thought away, but you notice that her eyes are now locked onto your bulge and her fingers are curling her hair in self-doubt. Just once, you say. Nobody has to know. You can practically feel the heat of her breath. You stroke her hair to put her at ease and promise that she can go at her own pace.\n\n");
        
        outputText("Reluctantly, Scylla accepts your idea and slides off the bed to kneel before you. With unsteady fingers, she pulls off your [armor] and her eyes widen at the sight of your hardening length. She looks up one last time, as if uttering a silent prayer, then guides her head over your tip. Parting her succulent lips, she plants the faintest of kisses on the head of your " + cockDescript(x) + ". Embarrassedly inexperienced, she kisses up and down your dick, slowly at first, then slightly more confidently. Even though it is just her puckered lips, you feel warm moisture and an electric tingle at every contact. A small drop of pre rises to the tip of your head. Scylla shivers so intensely that her hair falls in front of her eyes again. Without parting it, she leans in and places the very tip of her tongue at the base of your tip and laps up the tiny drop of cum.\n\n");
        
        outputText("Scylla's whole body tenses and her fingers dig into your legs like they're trying to dig trenches in the earth. She pants and soft whimpers rise from her shrouded face. She plants her head helplessly in your lap and you realize she came from a single drop of your jizz. She pulls the hair from her eyes, and you see that her pupils have contracted into an addict's pin-pricks. The blue of her irises rage with an inner fire and her already puffy lips look positively swollen. A stream of drool leaks from her mouth and wets her blood-red lips as she bends over you again. The thirst seems to have unseated her inhibitions because this time she slides her lips around the crown of your dick and her tongue whirls around it. As she pushes inches into the furnace of her mouth, you marvel at how tight her lips have become. It is almost as if the bulging hole was sealing around your member. With the tightness you've rarely felt in pussies, she slides up and down your shaft, drool lubricating better than any oil.\n\n");
        outputText("She swallows more inches and you can feel the tip of your penis against the back of her throat. If she had a gag-reflex, the demon-draught must've eliminated it because you can feel the flexing ripples of her throat engulf your head. Scylla makes a moan that can only be called a yummy noise");
        if (player.hasBalls())
        {
            outputText(" and you feel your balls tightening");
        }
    ...
    private function scyllaRoundIIPartII() : Void
    {
        ...
        if (player.hasKnot(0))
        {
            outputText("Frustrated, you try to pull back, but your bloated knot is far too large for her tight mouth, keeping the two of you hooked together.  ");
        }
        else
        {
            outputText("Trying to pull the ring off, you find that your swollen head is too full to pull back through her esophagus and out of her stomach.  ");
        }
        outputText("Without a release, the two of you are sealed, face to groin.\n\n");
        if (!recalling)
        {
            dynStats("lib", 1, "lus=", 100);
    ...
    private function scyllaRoundIIPartIII() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-two-part-three"));
        if (player.hasBalls())
        {
    ...
    public function scyllaRoundThreeCUM() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-two-jizz"));
        flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA]++;
        //Standard
        if (player.hasKeyItem("Opal Ring") < 0 || flags[kFLAGS.FED_SCYLLA_TODAY] == 1)
        {
            ...
            outputText("After seeing that display, you've got a few questions for her. What would you like to discuss?");
        ...
        else
        {
            ...
            outputText("You step into the Wet Bitch and step up to the bar, taking a moment to relax and unwind.  After enjoying yourself for a while, you glance around and notice that Scylla, your ever-thirsty nun is nowhere to be found.  Deciding to go look for her, you head upstairs and toward the maiden's regular lodgings.  She appears to be at home, but unaware that her door is ajar, giving you a chance to look in on her.\r\r");
    ...
    //[Her Belly]-
    private function scyllaIIIBellyChat() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText("Offhandedly, you ask how her thirst has been. She seemed to be, ahem, retaining a lot of fluid when you last left her, but now...\n\n");
        
        outputText("Scylla's stomach moans audibly and she blushes, putting a hand over it. \"<i>Ah ha, yes. It has been a trial. Thankfully, awfully kind people like yourself have been helping me when the hunger becomes unbearable. I can't really stomach normal food or drink anymore, but it's okay.</i>\" She bites the side of her plump lip and glances aside. \"<i>Besides... I really... like... the taste,</i>\" she whispers, half to herself.\n\n");
        
        outputText("The nun shakes her head. \"<i>But it hasn't been the same lately. The thirst comes back almost immediately. I can't keep it in my body long enough before digestion kicks in.</i>\"\n\n");
        
        outputText("You look at her closer and you think you can guess where all the extra protein has been going lately.  Her always lustrous hair is practically alive, sparkling twinkles of light reflecting off her long, jet curls. Her skin looks even softer than before, flush and creamy with an ageless smoothness. A thin but sturdy layer of muscle has taken definition under her buxom flesh, making her back straighter and her lean arms more graceful.\n\n");
        
        outputText("Knowing you're unlikely to discover any more on that topic, you turn the subject to her breathing...");
        doNext(scyllaIIIHOWZUBREETH);
    }
    
    //[Her Breathing] –
    private function scyllaIIIHOWZUBREETH() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    private function scyllaLevelIIIRoundIIIFIGHT() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    private function scyllaIIIFinisher() : Void
    {
        scyllaSprite();
        clearOutput();
        ...
        outputText("\"<i>Thank you so much,</i>\" she gushes. \"<i>Once again, you come to my rescue and teach me how to overcome my trials. You truly are my guardian angel. One of these days, I hope I'll be able to return the favor.</i>\" She favors you with a moist kiss on the forehead and springs from bed, energized and ready to do some good. You groan, roll over, and go back to sleep.");
        doNext((recalling) ? recallWakeUp : camp.returnToCampUseFourHours);
    }
    ...
    public function scyllaRoundIVGo() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-four"));
        if (!recalling)
        {
            flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA]++;
        }
    ...
    private function scyllaRoundIVPtIII() : Void
    {
        scyllaSprite();
        hideUpDown();
        clearOutput();
        outputText(images.showImage("scylla-help-round-four-pt-three"));
        ...
        outputText("\"<i>Weak-minded Champion,</i>\" he taunts with a voice like oil on water, \"<i>you are already beaten. My agent inside your wretched city caught you at the height of your power.  What hope do you have now? Submit to your new lord and I promise you will grow to enjoy your treatment in time.</i>\"\n\n");
        
        outputText("Before you can reply, Scylla interposes herself between you and the imp Lord, stretching her arms out protectively. \"<i>I won't allow you to harm this child, Demon!</i>\"\n\n");
        
        outputText("The Imp Lord coyly plays with a wisp of fire between his fingers. \"<i>You are already corrupted, Nun; soiled and unclean. What inconvenience could you pose to me, other than the threat of having to own another slave?</i>\"\n\n");
        
        outputText("Scylla looks stung by the imp's observation, but her spine stiffens and her expression sets into righteous indignation. \"<i>How dare you! How DARE you! Call me whatever you will, but no one enslaves children! You poison my friend, you defile this temple, and you forget that even with my curse, all virtuous people can do good.</i>\" Her voice picks up, magnified three times. \"<i>They can also SMITE EVIL!</i>\" Scylla slaps the imp with every bit of virtuous fury her seven-foot body can muster, and a bolt of brilliant white light crashes into the room. Its power burns away the brimstone stench, and leaves the imp Lord twitching and paralyzed on the floor.\n\n");
    ...
    private function scyllaPtIVKissPtII() : Void
    {
        scyllaSprite();
        hideUpDown();
        var x : Float = player.biggestCockIndex();
        clearOutput();
        outputText("When you break your second kiss, tummy full of Scylla's cream, you find yourself entrapped by her mammoth chest. The stimulation of your nursing seems to have caused her tits to overcompensate, inflating with milk far in excess to what your small stomach could drain. You are literally encased between her breasts, the pliant but firm flesh engulfing everything from your shoulders down in her snug cleavage. You shift uncomfortably for a moment, until you realize not all of your body has shrunk. You shift, no longer able to resist your erection's pressure, and shed your [armor]. With your shrunken body's child-like dimensions, " + sMultiCockDesc() + " is virtually as thick as your torso. The weight would knock you flat on your back if Scylla's tits weren't wrapped around you in their tight embrace.  " + SMultiCockDesc() + " strains just under her nose, pulsing at the tightness around you.\n\n");
        
        outputText("Scylla strokes " + sMultiCockDesc() + " with her palms and cheeks, reveling in the heat of your panting chest between her tits. \"<i>We still have to get that nasty poison out of your precious body, little one. Don't worry; let Scylla kiss it all better.</i>\" She purses her lips and plants kisses from shaft to head, pausing at your crown. Blushing, she lowers her mouth to the shaft again and pokes out her tongue.\n\n");
        
        outputText("Scylla's tongue is as crimson as her lips and moist with the hungry drool in her mouth. She strokes your " + cockDescript(x) + " with her delicately pointed tip, tracing the swell of your cock-head bashfully. She smiles as she opens her mouth broadly and stretches her tongue out further. You've felt it curl around your " + cockDescript(x) + " before, but having not seen it until now, you never appreciated how long it must be to fit all the way around. At its base, the nun's tongue is three inches wide and a serpentine eight inches long. She giggles in delight at the look of shock on your adolescent face. Scylla dips her tongue into her cleavage and draws it up along your [cocks], moving in long, slow motions, soft, wet muscle curling around you and drinking in the flavor of your sex. She presses her arms on either side of her love-pillows as she laps at your " + cockDescript(x) + ", and her tits squeeze " + sMultiCockDesc() + " with liquid tightness. Her tongue wraps around your cock, spiraling up and around, corkscrewing your head as the pressure from her mountainous breasts redoubles and squishes the breath from your chest.\n\n");
    ...
    private function scyllaPtIVKissPtIII() : Void
    {
        scyllaSprite();
        hideUpDown();
        if (!recalling)
        ...
        clearOutput();
        var x : Float = player.biggestCockIndex();
        outputText("Scrambling up and out of your titty cocoon, you pull your tiny body onto the top of her jiggling mounds. Scylla laughs at the feeling of having you crawl over her body, and watches your progress with amusement as she lazily slurps down your slowing loads. With an expression of ecstatic agony, you buck your hips in an attempt to fuck the nun's face without any leverage. The cum on her body makes your perch slippery, however, and you begin to slide backward before she catches you with sure hands and draws you closer. Each time you thrust, she pulls you a little closer, a few more inches of your " + cockDescript(x) + " jamming into her mouth. In your state, your strength is nothing next to hers, but she plays along, making surprised gasps and moans as you \"ram\" yourself deeper. When you get close enough for your short arms to reach her head, you grab onto her palm-sized horn nubs. She gives you complete control of her head as you jerk her back and forth, lips, mouth, and throat sliding along your length.\n\n");
        
        if (player.hasBalls())
        {
            outputText("Scylla's long, winding tongue seeks out your " + sackDescript() + " and licks it ravenously, rolling each testicle around to reignite your flagging orgasm. She looks up and meets your eyes. Drinking in your adolescent expression of helpless pleasure, she blushes a vivid pink, shivering in her own orgasm. She can't stop herself from letting her tongue travel up your taint to your " + assholeDescript() + ". You gasp in juvenile surprise as she digs her fingers into her nipple lips, masturbating furiously at your cute expression. Without preamble, she thrusts her tongue into your ass and presses against your immature prostate, making you squeak in another helpless orgasm. You pull weakly at her horns and she complies hungrily, swallowing the rest of your " + cockDescript(x) + " in one gulp just in time for your renewed balls to flood her throat with your seed. You tremble uncontrollably, eyes clamped shut, sitting atop Scylla's tits with her head buried in your crotch.  Her arms curl around your back, hugging you as she drinks deeply. As the nun's thirst drains you, a cold sensation works its way through your ball sack and down your cock. When it finally bursts into her stomach, you gasp as blazing warmth fills you.\n\n");
            outputText("Your [balls] pump out the last of your cum, and Scylla gulps it happily before she puts her hands under each of your arms and pulls you up, " + sMultiCockDesc() + " flopping sloppily against her face. She's smiling with puffed-out cheeks when she sets you down gently on the bed and strokes your young face with her fingertips. She winks at you and stoops down to the unconscious imp. She pins his mouth open with her forefinger and thumb, and she purses her bloated lips into a narrow opening. A thick stream of your cum slowly drips down toward the imp Lord's waiting gullet.  In the cum you can see thin streaks of a greenish fluid which you realize must be the venom he'd injected you with!  Indeed, you begin to feel pinpricks along your fingertips and toes as your strength ebbs back into your limbs. As you gradually start to regain your size, the agonizingly long stream of cum from Scylla's mouth reaches the imp's own. He begins to choke as it touches his throat, and Scylla swiftly lunges forward to plant a kiss on the demon, holding his mouth open with hers. The nun's cheeks empty, and the imp swallows in reflex at the flood filling his throat. Scylla breaks the kiss with a loud, wet, \"<i>Muah!</i>\" and grins mischievously at you. The imp coughs and gags, but the cum-coated poison swiftly courses through his system and he shrinks on the spot. He diminishes from four feet down to one, his aura of infernal power broken as his strength is siphoned away. Scylla picks him up like a doll and thrusts him into her cleavage for safe-keeping.  His struggles are so pathetic that they barely make her love-pillows jiggle at all.");
        }
        else
        {
            outputText("Scylla's long, winding tongue seeks out the base of your shaft and licks it ravenously, pumping your rod to reignite your flagging orgasm. She looks up and meets your eyes. Drinking in your adolescent expression of helpless pleasure, she blushes a vivid pink, shivering in her own orgasm. She can't stop herself from letting her tongue travel up your taint to your " + assholeDescript() + ". You gasp in juvenile surprise as she digs her fingers into her nipple lips, masturbating furiously at your cute expression. Without preamble, she thrusts her tongue into your ass and presses against your immature prostate, making you squeak in another helpless orgasm. You pull weakly at her horns and she complies hungrily, swallowing the rest of your " + cockDescript(x) + " in one gulp just in time for you to flood her throat with your seed. You tremble uncontrollably, eyes clamped shut, sitting atop Scylla's tits with her head buried in your crotch.  Her arms curl around your back, hugging you as she drinks deeply. As the nun's thirst drains you, a cold sensation works its way through your cock. When it finally bursts into her stomach, you gasp as blazing warmth fills you.\n\n");
            outputText("Your loins pump out the last of your cum, and Scylla gulps it happily before she puts her hands under each of your arms and pulls you up, " + sMultiCockDesc() + " flopping sloppily against her face. She's smiling with puffed-out cheeks when she sets you down gently on the bed and strokes your young face with her fingertips. She winks at you and stoops down to the unconscious imp. She pins his mouth open with her forefinger and thumb, and she purses her bloated lips into a narrow opening. A thick stream of your cum slowly drips down toward the imp Lord's waiting gullet.  In the cum you can see thin streaks of a greenish fluid which you realize must be the venom he'd injected you with!  Indeed, you begin to feel pinpricks along your fingertips and toes as your strength ebbs back into your limbs. As you gradually start to regain your size, the agonizingly long stream of cum from Scylla's mouth reaches the imp's own. He begins to choke as it touches his throat, and Scylla swiftly lunges forward to plant a kiss on the demon, holding his mouth open with hers. The nun's cheeks empty, and the imp swallows in reflex at the flood filling his throat. Scylla breaks the kiss with a loud, wet, \"<i>Muah!</i>\" and grins mischievously at you. The imp coughs and gags, but the cum-coated poison swiftly courses through his system and he shrinks on the spot. He diminishes from four feet down to one, his aura of infernal power broken as his strength is siphoned away. Scylla picks him up like a doll and thrusts him into her cleavage for safe-keeping.  His struggles are so pathetic that they barely make her love-pillows jiggle at all.");
        }
        if (!recalling)
        {
            player.sexReward("saliva", "Dick");
    ...
    private function scyllaPtIVEpilogue() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    public function scyllaAdictsAnonV() : Void
    {
        scyllaSprite();
        doNext(camp.returnToCampUseOneHour);
        if (flags[kFLAGS.TIMES_MET_SCYLLA_IN_ADDICTION_GROUP] == 0)
        {
            scyllaPtVFirstTime();
        }
        else
        ...
        if (flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] < 5)
        {
            flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] = 5;
        }
    }
    //[Nun]
    private function scyllaPtVFirstTime() : Void
    {
        scyllaSprite();
        //(First time)
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-firt-time"));
    ...
    private function scyllaPtVTakeAdvantage() : Void
    {
        ...
        {
            scyllaPtVTakeAdvantageNormal();
        }
    }
    
    private function scyllaPtVTakeAdvantageNormal() : Void
    {
        var x : Float = player.biggestCockIndex();
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-take-advantage"));
        outputText("You decide this is too good to pass up, so you step away and duck into an empty room. You whip out your " + cockDescript(x) + " and begin masturbating, careful to stop before you cum. You take a dollop of pre from the tip and dab it behind your ears, to make sure the musky scent will be obvious. Then, you slip back into your clothes and adjust your package to make the bulge unmistakable. Suitably prepared, you go to the ladies' door and knock crisply.\n\n");
        
        if (player.hasBalls())
        {
            outputText("Scylla opens the door curiously and smiles when she sees you. \"<i>Oh, [name], what a pleasant surprise! I'm sorry, but do you mind waiting a bit? I'd love to talk with you, but I'm in the middle of a... the middle of...</i>\" she trails off, the smell of your pre-cum floating into her nostrils and starting to shut off the nun's higher brain functions. Her eyes drop to your crotch and her stomach rumbles loudly as she stares at the outline of your " + cockDescript(x) + "  and [balls]. You grin and gently push her backwards, stepping into the room. Scylla follows after like a lost puppy, licking her lips without realizing it. \"<i>This... um, this is [name], a friend of, uh, mine,</i>\" she explains, stumbling through the introduction. Abylon regards you distrustfully but she bites her lips and rubs her legs together through her armor when your musk hits her. Pastie is too drunk to notice the sudden pressure in the room.\n\n");
            outputText("No sense in playing coy when you're the drug in a room full of addicts. You brazenly whip out your " + cockDescript(x) + " and spread your arms. \"<i>Ladies,</i>\" you grin, in invitation. The nun shakes her head, trying to clear her mind and failing, giggling involuntarily. The goblin trembles, her fists balled into pale knuckles, but then she slumps, defeated.  \"<i>Can't fight nature,</i>\" she grumbles, weakly. \"<i>Like mother, like daughter.</i>\" Pastie hiccups, trying to figure out what's happening.\n\n");
            outputText("Scylla reaches out for your shaft and wraps long, thin fingers around it, almost worshipfully. This provokes an indignant cry from Abby, who crosses the distance between you faster than you would've believed. \"<i>Hands off, ya big bitch. That's my baby-batter.</i>\" She grabs your [balls] possessively, a little harder than you'd like. \"<i>You'll just waste it in yer fat mouth anyway. Dumb humans don't even know where ta take a cream pie- it's amazin' ya ever get knocked up!</i>\"\n\n");
            ...
            outputText("\"<i>Like fuck yer goin' first,</i>\" Abby shoots back, her grip on your balls so painful now that you hiss through your teeth. The goblin grabs a beer bottle and smashes it on the table, brandishing it at Scylla. \"<i>Go ahead, cunt, put those bimbo cocksucking lips on my baby-daddy's dick. See what happens.</i>\" The jagged glass is perilously close to your shaft, and you don't dare to move while the two have a tug of war with your junk. Maybe this wasn't the best idea you've ever had.\n\n");
        ...
        {
            outputText("Scylla opens the door curiously and smiles when she sees you. \"<i>Oh, [name], what a pleasant surprise! I'm sorry, but do you mind waiting a bit? I'd love to talk with you, but I'm in the middle of a... the middle of...</i>\" she trails off, the smell of your pre-cum floating into her nostrils and starting to shut off the nun's higher brain functions. Her eyes drop to your crotch and her stomach rumbles loudly as she stares at the outline of your " + cockDescript(x) + ". You grin and gently push her backwards, stepping into the room. Scylla follows after like a lost puppy, licking her lips without realizing it. \"<i>This... um, this is [name], a friend of, uh, mine,</i>\" she explains, stumbling through the introduction. Abylon regards you distrustfully but she bites her lips and rubs her legs together through her armor when your musk hits her. Pastie is too drunk to notice the sudden pressure in the room.\n\n");
            outputText("No sense in playing coy when you're the drug in a room full of addicts. You brazenly whip out your " + cockDescript(x) + " and spread your arms. \"<i>Ladies,</i>\" you grin, in invitation. The nun shakes her head, trying to clear her mind and failing, giggling involuntarily. The goblin trembles, her fists balled into pale knuckles, but then she slumps, defeated.  \"<i>Can't fight nature,</i>\" she grumbles, weakly. \"<i>Like mother, like daughter.</i>\" Pastie hiccups, trying to figure out what's happening.\n\n");
            outputText("Scylla reaches out for your shaft almost worshipfully with her long, thin fingers. This provokes an indignant cry from Abby, who crosses the distance between you faster than you would've believed. \"<i>Hands off, ya big bitch. That's my baby-batter.</i>\" She grabs your " + cockDescript(x) + " possessively, a little harder than you'd like. \"<i>You'll just waste it in yer fat mouth anyway. Dumb humans don't even know where ta take a cream pie- it's amazin' ya ever get knocked up!</i>\"\n\n");
            outputText("\"<i>You don't understand, I need this,</i>\" the nun pleads, her hands tightening on your cock, nails starting to dig in as she jerks you, groin-first closer to her. \"<i>You can have some after, I promise, but I need it in my mouth. I'm just... so... hungry.</i>\" Under her robes, her nipples bulge, lip-shaped against the black velvet.\n\n");
            outputText("\"<i>Like fuck yer goin' first,</i>\" Abby shoots back, her grip on your base so painful now that you hiss through your teeth. The goblin grabs a beer bottle and smashes it on the table, brandishing it at Scylla. \"<i>Go ahead, cunt, put those bimbo cocksucking lips on my baby-daddy's dick. See what happens.</i>\" The jagged glass is perilously close to your shaft, and you don't dare to move while the two have a tug of war with your junk. Maybe this wasn't the best idea you've ever had.\n\n");
            outputText("Pastie finally figures out what's going on through her stupor and flies between the three of you, settling atop your " + cockDescript(x) + ", tiny stiletto heels digging into soft flesh like pins. \"<i>Don't fight, you two, this thing's gross,</i>\" she argues. Pouting, she stomps her foot down and the heel punches into your cockhead, drawing a scream from you that only makes Scylla and Abby tug all the harder.\n\n");
    ...
    private function scyllaVTakeAdvantageWithExgartuan() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-take-advantage-with-exgartuan-one"));
    ...
    private function scyllaVTakeAdvantageWithExgartuan2() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-take-advantage-with-exgartuan-two"));
    ...
    private function scyllaVTakeAdvantageWithExgartuan4() : Void
    {
        ...
        if (player.cockTotal() < 3)
        {
            outputText("  The demon has withdrawn from the girls, reforming your cocks into their pre-orgy state, slimy cum-slick fluids notwithstanding.");
        }
    ...
    //[Share]	(First time)
    private function scyllaPtVShare() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-share"));
        //FIRST TIEM
        if (flags[kFLAGS.SCYLLA_TIMES_SHARED_IN_ADDICT_GROUP] == 0)
        {
            outputText("With a blush of embarrassment, you push the door open and step inside. \"<i>I'm [name] and I'm an addict,</i>\" you admit, keeping your eyes cast down.\n\n");
            
            outputText("The girls look surprised by your entry, but Scylla is welcoming all the same. \"<i>Oh, [name], I'm so glad you could join us after all,</i>\" she fibs, covering up for the fact that you were obviously spying on them. \"<i>Pastie, Abby, this is my dear friend. Please, take a seat here,</i>\" she offers you her chair and daintily takes a place on the edge of the room's bed. \"<i>Please, tell us more about yourself.</i>\"\n\n");
        }
        //[Share]	(Repeat)
        else
        {
            outputText("You knock on the door and poke your head in. As they look up, you see an empty chair's been pulled up to the table this time. It seems they were expecting - or perhaps hoping - you'd come again. Abylon still wears her carefully crafted mask of mocking apathy, but you think you catch a glimmer in her eyes that even she's not fully aware of. She scratches the tip of her nose and tosses you a curt 'hey' gesture with her wrist. Pastie is already wasted, but only on liquor. Is it just your imagination, or are the fairy's crystalline clothes a little sluttier than they were last time? Scylla seems happy to see you, though there are little crinkles of need at the edges of her smile.\n\n");
        ...
        flags[kFLAGS.SCYLLA_TIMES_SHARED_IN_ADDICT_GROUP]++;
        outputText("What addiction would you like to discuss?");
        //Set choices
        menu();
        addButton(0, "Cum", scyllaPtVCum).disableIf(flags[kFLAGS.MINOTAUR_CUM_ADDICTION_TRACKER] < 50 && !player.hasPerk(PerkLib.MinotaurCumAddict), 
                "You're not addicted to the minotaur cum."
        );
        //Now, this MAY HAVE BEEN a spoiler... if other mentions had been properly hidden.
        addButton(1, "Milk", scyllaPtVMilk).disableIf((!player.hasPerk(PerkLib.MarblesMilk) && !player.statusEffectv3(StatusEffects.Marble) == 0) || player.hasPerk(PerkLib.MarbleResistant) || player.fiendishMetabolismNFER(), 
                "Req. to be addicted to the lacta bovine milk."
        );
        addButton(2, "Sex", scyllaPtVSex).disableIf(player.lib < 85 && player.minLust() < 20, 
                "Req. to have high libido (85) or raised minimum lust (20)."
        );
        addButton(3, "Tentacles", shareTentaclesWithScylla).disableIf(player.countCocksWithType(CockTypesEnum.TENTACLE) < 2, 
                "Req. at least 2 tentacle/stamen cocks."
        );
        addButton(4, "None", scyllaPtVNoDiscussion);
    }
    private function scyllaPtVNoDiscussion() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText("You fail to come up with a suitable explanation for your presence and politely excuse yourself.  AWKWARD!");
        doNext(camp.returnToCampUseOneHour);
    }
    ...
    private function scyllaPtVMilk() : Void
    {
        ...
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-with-milk-one"));
    ...
    private function scyllaPtVMilkII() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-with-milk-two"));
    ...
    private function scyllaPtVMilkIII() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-with-milk-three"));
    ...
    private function scyllaPtVCum() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-jizz-pt-one"));
        flags[kFLAGS.SCYLLA_CUM_THERAPY_TIMES]++;
    ...
    private function scyllaPtVCumII() : Void
    {
        ...
        outputText("While she's hanging in the air, she kicks off her boots and bends a foot back - against your groin. With surprisingly dexterous toes, she strokes the bulge of your shaft. You harden under her caress and let out a moan. She elbows you in the ribs and looks back over her shoulder, annoyed. \"<i>Yer a minotaur, remember? Ya gotta snort an grunt an stuff.</i>\" You roar and shake her up and down, making her clench her foot around your swelling cock through your clothes. \"<i>B-b-better,</i>\" she admits as you jostle her like a ragdoll. Like stubby fingers, her toes work around your [armor] and manage to free your " + cockDescript(x) + ", which springs up, invigorated by her bouncing ass and wobbling against it with every shake. She squirms free of her oiled leather pants and squeezes her emerald thighs against the monster growing between the two of you. \"<i>D-d-don't take all day, d-d-dummy - what do minotaurs d-d-do next?</i>\" she giggles in excitement.\n\n");
    ...
    private function scyllaPtVCumIII() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-jizz-pt-three"));
        var x : Float = player.biggestCockIndex();
        ...
        if (player.hasBalls())
        {
            outputText("Abylon lets out a ragged, delicious shudder and looks back at you.  Over her shoulder, a wicked smile shows off every blood-lined tooth. \"<i>Tha Champion's got tha minotaur right where she wants 'em,</i>\" she gloats in her nasal tone. \"<i>He can't fuck you, if ya fuck 'em first!</i>\" She pulls a knee up and drives her foot down, into your " + sackDescript() + ", heel-first. Your world explodes into shards of light and pain, the green cocksleeve forgotten to the mind-shattering, gut-wrenching agony that shoots through your body. Your legs give out and you fall backwards, landing on your back, stunned. Abby uses this opportunity to spin in place, still penetrated like a duck on a spit.  She wraps her legs around your " + hipDescript() + " and [butt]. Leaning in, she licks the blood from her teeth. \"<i>Gotta keep the minotaur from softenin'. Gotta claim the Champion's prize.</i>\"\n\n");
        }
        else
        {
    ...
    private function scyllaPtVSex() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    private function scyllaPtVSexIII() : Void
    {
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-sex-pt-three"));
        scyllaSprite();
        var x : Float = player.biggestCockIndex();
        ...
        else
        {
            ...
            outputText("Scylla releases the vacuum-like suction of her scarlet-lacquored lips and rises to nurse the last few loads out of you, suckling serenely, satisfied at the restraint you and Abby showed. The goblin merely laughs her ass off at Pastie's plastered form, writhing on the table, soaked inside and out, sloppy like a used condom. Abyon slaps the nun on the back and chuckles, \"<i>Gotta give it to ya, fatty, ya know a good time.</i>\" Scylla fills her cheeks with your final load and spins around, grabbing the goblin's shoulders and pressing a deep kiss onto her, bulbous lips sealing around the lower half of the green girl's face. Abby tries to speak and Scylla empties her cheeks, snowballing your cum and her saliva into the unsuspecting goblin's mouth. Surprised, she swallows reflexively and almost chokes on the volume of gooey cum that pours down her throat. The nun ends the kiss with a wet \"<i>muah!</i>\" and smiles.\n\n");
        }
        outputText("\"<i>Please stop calling me fat,</i>\" she asks, innocently. \"<i>You know, if that's all right with you.</i>\"\n\n");
        player.sexReward("saliva", "Dick");
        //[Next]
        doNext(scyllaPtVSexIV);
    }
    private function scyllaPtVSexIV() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-sex-pt-four"));
    ...
    private function addictionAdvantageMultiDickGreatTimeParty() : Void
    {
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-multi-cock-one"));
        scyllaSprite();
        //[First time]
        if (flags[kFLAGS.SCYLLA_ADVANTAGE_MULTICOCK] == 0)
        {
            flags[kFLAGS.SCYLLA_ADVANTAGE_MULTICOCK]++;
            outputText("You decide this is too good to pass by, so you step up to the ladies' room and knock crisply. Scylla opens the door curiously and smiles when she sees you. \"<i>Oh, [name], what a pleasant surprise! We were just in the middle of a... the middle of...</i>\" she trails off, noticing the look of wicked relish on your face and you push the seven-foot girl aside, stepping inside confidently. Her eyes drop to your crotch and her stomach rumbles loudly as she stares at the over-stuffed mass of cocks straining against your [armor]. Licking her lips without realizing it, the nun keeps trying to stay focused. \"<i>This... um... what was I...</i>?\" she mutters, unable to keep her thoughts together. Abylon regards you distrustfully but she bites her lips and rubs her legs together through her armor when your musk hits her. Pastie is too drunk to notice the sudden pressure in the room.\n\n");
            ...
            outputText("Scylla sinks to her knees and reaches out for your [cock], wrapping long, thin fingers around it, almost worshipfully. Abby, meanwhile, crosses the distance between you faster than you would've believed. \"<i>If this is how it's gotta be, might as well do it right, ya dummies!</i>\" she announces in her nasally tone, producing several vials from a small pouch. \"<i>Normally use these at weapons, but we might as well get wasted on 'em.</i>\" She waves Pastie over and the three girls line up in front of your tools, the fairy looking confused, the nun panting, and the complaining goblin a little too helpful for how much she protests.\n\n");
            //[Next]
    ...
    private function addictionScyllaTakeAdvantageDicksIII() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("Your [balls] quiver with the building load and the bubble-brained goblin girl notices the swelling pulses tightening in her throat. She pops her head off your " + cockDescript(1) + " and turns to her competitor with a grin. \"<i>I'm winnnn-ing!</i>\" she taunts, just in time to see Scylla's cheeks bloat with the first load of your orgasm, [cock] erupting in her lewd mouth, her obscene tongue suckling with a vacuum-like pressure. Abby drops her jaw in disappointment and whines \"<i>Aw, why isn't mine working?</i>\" as she swings back to your " + cockDescript(1) + " just in time for your urethra to dilate. A blast of jizz catches her directly in her unsuspecting face, hot streams lancing into her pug nose's large nostrils hard enough to spill back out of her still-open mouth. You grab her dumb-founded head and jam her onto your shaft in time to pump another load into her slut-shifted body before tossing her back on her ass, discarding the loser of the contest.\n\n");
            outputText("Scylla casts her nun's habit aside as your churning cum causes her tiny demonic nubs to grow into large, curving horns. Pulling the front of her dress down, she bears her huge breasts, the mouth nipples hungrily opening as she scoops the mountainous tit-flesh in both arms and brings her mammary mouths level with your [cock] and " + cockDescript(1) + ". You push into her chest just as your orgasm begins to flag and Scylla's perverse body rekindles your climax as the thirsty mouths seal around your shafts, drinking your seed gratefully, swelling with the meal of spunk you're feeding them. Grabbing the lips of Scylla's tit-mouths you squeeze tight enough to make the pink skin bright red and she gasps as you attempt to sate her endless cum thirst. She shakes her head back and forth rapidly, hair wildly thrashing in the air, her breasts growing heavier under the orgasmic glee of her overstimulation. Milk begins to leak and squirt at each wet thrust you give her chest and the nun's back arches in rapture as she babbles incoherently, putty in your hands. Your balls churn one final time and you bottom out in the nun's body to spray a long, toe-curling gush of creamy lather into her profane mammaries before pulling out and letting her fall backward, mindlessly climaxing, while milk and cum spurt out of her clit-sensitive lipples with each heartbeat.\n\n");
        }
        else
        {
            outputText("Your hips quiver with the building load and the bubble-brained goblin girl notices the swelling pulses tightening in her throat. She pops her head off your " + cockDescript(1) + " and turns to her competitor with a grin. \"<i>I'm winnnn-ing!</i>\" she taunts, just in time to see Scylla's cheeks bloat with the first load of your orgasm, [cock] erupting in her lewd mouth, her obscene tongue suckling with a vacuum-like pressure. Abby drops her jaw in disappointment and whines \"<i>Aw, why isn't mine working?</i>\" as she swings back to your " + cockDescript(1) + " just in time for your urethra to dilate. A blast of jizz catches her directly in her unsuspecting face, hot streams lancing into her pug nose's large nostrils hard enough to spill back out of her still-open mouth. You grab her dumb-founded head and jam her onto your shaft in time to pump another load into her slut-shifted body before tossing her back on her ass, discarding the loser of the contest.\n\n");
        ...
        outputText("Your " + cockDescript(2) + " pulses, unsatisfied, and you stoop to grab the inebriated, encapsulated fairy from the ground. You try to shake her loose, but the drunk seems to have finished off half a bottle of goblin ale and her belly is overburdened with the liquid weight. Her lower torso slides out of the neck of the glass, but her bloated belly gets stuck in the neck, pinning the girl in place. Shrugging, you position the trapped girl over your cockhead and push at the tiny slit between her delicate legs. To your considerable surprise, she slides open, fairy pussy stretching like elastic around the tip of your " + cockDescript(2) + ". Apparently her overdose of Goblin Ale has made her considerably deeper and wider than her fey frame would suggest. The fairy is yelling something, but the glass drowns out her voice, so you go ahead and push deeper, delighting in the feel of Pastie's pussy sucking down inch after inch of your cock. Her body distorts wildly until she's little more than a flesh-colored condom from the neck down. She's just too tight to hold on long, however, and your " + cockDescript(2) + " erupts inside her, seed overflowing even the renewed elastic capacity of her womb. The pressure pops the girl back into the bottle and you jam your cockhead into the neck of the glass as your spunk splatters over the trapped, semen-stuffed girl. Before long, your shuddering orgasm has begun to fill the bottle and Pastie floats to the narrow top, buoyed by her liquid-fat body. When your ejaculate slows to a trickle, you let the bottle drop, the sperm-bubble of a fairy utterly blitzed and swimming helplessly inside the sea of spunk.\n\n");
        //[Next]
        player.sexReward("saliva", "Dick");
        doNext(addictionScyllaTakeAdvantageDicksBonusAndEpilogue);
    }
    
    private function addictionScyllaTakeAdvantageDicksBonusAndEpilogue() : Void
    {
        scyllaSprite();
        clearOutput();
        outputText(images.showImage("scylla-help-round-five-multi-cock-four"));
        if (sceneHunter.dickSelect)
        
        //for my bois{
            
            outputText("Will you consider yourself done here, or maybe you have some <i>unusual quality</i> to prolong the fun a bit more?");
            menu();
            addButton(0, "4 Cocks", fourF).disableIf(player.cockTotal() < 4, "Maybe grow another one?");
            addButton(1, "Tenta Cock", fourF).disableIf(player.countCocksWithType(CockTypesEnum.TENTACLE) == 0, "You need a tentacle. Or a cock. Or a tentacock.");
            addButton(2, "Demon Cock", demonF).disableIf(player.demonCocks() == 0, "Not demonic enough.");
            addButton(4, "Done", sharedEnd);
        }
        //Array of all possible scenes
        else
        {
            
            var ends : Array<Dynamic> = new Array<Dynamic>(0);
            if (player.cockTotal() >= 4)
            {
                ends.push(fourF);
            }
            if (player.countCocksWithType(CockTypesEnum.TENTACLE) > 0)
            {
                ends.push(tentaF);
            }
    ...
    public function Scylla6() : Void
    {
        ...
        if (!recalling)
        {
            flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] = 6;
        }
        clearOutput();
        ...
        if (player.spe >= 85 && player.inte >= 60)
        {
            addButton(1, "Duck!", Scylla6DUCK);
        }
    }
    ...
    private function Scylla6StupidEnds() : Void
    {
        if (!recalling)
        {
            sceneHunter.print("Congrats, you've won! You're the best. Have a cookie. But are you <i>really</i> sure you're not missing out on anything?");
        }
    ...
    private function Scylla6SLOW() : Void
    {
        ...
        if (flags[kFLAGS.KATHERINE_UNLOCKED] < 1 || recalling && flags[kFLAGS.SCYLLA_CATS_RECALL_TRACKER] == 2)
        {
            outputText(", but the last thing you remember is the soft jingling of a small bell");
        }
        outputText(".\n\n");
        if (!recalling)
        {
        ...
        else
        {
            ...
            menu();
            addButton(0, "Get Help", Scylla6NoMilkGetHelp);
            if (flags[kFLAGS.KATHERINE_UNLOCKED] < 1 || recalling && flags[kFLAGS.SCYLLA_CATS_RECALL_TRACKER] == 2)
            {
                addButton(1, "Submit", Scylla6NoMilkSubmit).disableIf(!player.hasVagina(), "Req. a vagina.");
                addButton(2, "Rape", Scylla6NoMilkRAPETHEWORLD);
            }
            else
            {
                addButtonDisabled(1, "???", "You can't do that since the cats are already missing <b>someone</b>.");
                addButtonDisabled(2, "???", "You can't do that since the cats are already missing <b>someone</b>.");
            }
        }
    }
    //[Kick Ass]
    ...
    private function Scylla6MilkyWait() : Void
    {
        ...
        if (!recalling)
        {
            flags[kFLAGS.SCYLLA_CATS_RECALL_TRACKER] = 1;  //without Kath  
            outputText("<b>New scene is unlocked in 'Recall' menu!</b>\n\n");
            if (flags[kFLAGS.KATHERINE_UNLOCKED] < 1 && !recalling)
            {
                sceneHunter.print("Look, I'll be honest with you. You've just got very unlucky - cattos decided to milk you instead of Scylla. Maybe if you reload and try again, it will be better? You can miss something important otherwise.");
            }
        }
    ...
    //[Get Help]
    private function Scylla6NoMilkGetHelp() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    private function Scylla6NoMilkSubmit() : Void
    {
        ...
        if (!recalling)
        {
            flags[kFLAGS.SCYLLA_CATS_RECALL_TRACKER] = 2;
            outputText("<b>New scene is unlocked in 'Recall' menu!</b>\n\n");
        }
        ...
        outputText("You manage a vain protest as they pull off your [armor], their furry bodies brushing yours, the soldering fervor in their gazes rising goose bumps to your skin.");
        //[BREASTS ONLY –
        if (player.biggestTitSize() >= 1 && player.biggestLactation() < 1)
        {
            outputText("  Some of the felines cup your tits, nuzzling your nipples playfully. They run sandpapery tongues along the nubs of your teats, lapping slowly at first, then faster, until your chest feels like it's being churned into buttery smoothness and you can't help but moan. When their efforts produce no milk, they hiss unhappily and leave your flush, aching, saliva-soaked breasts alone. A trill of disappointment bunches in your gut, your budding orgasm left unclaimed.");
            if (!recalling)
            {
                player.boostLactation(.25);
            }
        }
        outputText("  You can feel the moist excitement pouring off of the females while the males paw at the bulges under their ragged clothes. Hands grab you all over and lift you to your feet, knees still unable to stand on their own.\n\n");
        
        outputText("To your surprise, they carry you to Scylla and force you down, in front of her. The strung-up nun looks at you with big, blue eyes full of concern for your safety, mingled with an embarrassed excitement for her situation. The cats jerk your head to Scylla's exposed breast, heaving right at eye-level. They thrust your face against the plump lips of the nun's nipple and instruct you to drink. The felines seem to be using you to check the safety of the nun's milk. Even the destitute refugees of Tel'Adre fear demonic corruption, it seems. You open your mouth to protest again and your captor pushes you into a kiss with the crimson pinkness of the cream-laden tit.\n\n");
    ...
    private function Scylla6NoMilkSubmitIII() : Void
    {
        ...
        {
            outputText("Your spot in the middle of the nun-and-cat sandwich is too much, however, and your thighs slap against Scylla's face with each thrust the cat-morph makes. She must be able to feel the cum churning in your groin because her throat milks your shaft, her tongue and lips coaxing your swollen pecker as her stomach sucks on your head like a fertile womb, hungry for your seed to the point of hysteria. You finally cum and your body clenches down, muscles tight as your strength deserts you. Your body is putty as the blobs of cum are forced past the suckling lips tightly wrapped against your groin and up the nun's gulping throat, fighting past the intense pressure of her neck. When they get up into her chest, you can feel the bulbs of spunk rushing toward your cockhead with urgent desire and Scylla's stomach rumbles in anticipation. Just as the first dollop bursts free, the herm behind you slaps your ass and gives you one last thrust before cumming herself. Her balloon of flesh flares lewdly and hot jizz pours into your body, painting your womb white with the kitty's dog-seed. The sensation is invigorating and you feel renewed strength as you buck against Scylla's face, fucking her stomach with your cock, even as it squirts its first load into her suspended body. You flex your vaginal walls as best you can, ass clenching, milking the black cat for every drop as she collapses against your back, breast slick with sweat and weakly panting as the orgasm takes its toll, her soft balls straining to make the most of what feels like a long-delayed fucking.\n\n");
        }
        //selection
        ...
        //check all cocks{
            ...
            while (c-- > 0)
            {
                if (player.cocks[c].cockType == CockTypesEnum.HORSE)
                {
                    horse = c;
                }
                else if (player.cocks[c].cockType == CockTypesEnum.CAT)
                {
                    cat = c;
                }
                else if (player.hasKnot(c))
                {
                    knot = c;
                }
                else
            ...
            menu();
            outputText("Which cock are you fucking Scylla with?");
            addButton(0, "Horse", scene, horse).disableIf(horse < 0, "Req. to have a horsecock");
            addButton(1, "Cat", scene, cat).disableIf(cat < 0, "Req. to have a cat-cock");
            addButton(2, "Knotted", scene, knot).disableIf(knot < 0, "Req. to have a knotted cock");
            addButton(3, "Other", scene, other).disableIf(other < 0, "Req. to have a cock (not horse or cat) without a knot.");
        }
        else
        {
            scene(0);
    ...
    //ALL - [Next]
    private function Scylla6NoMilkSubmitIV() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    private function Scylla6NoMilkRapeIV() : Void
    {
        scyllaSprite();
        clearOutput();
    ...
    //-------------------------------------------------------------------------------------------------
    private function shareTentaclesWithScylla() : Void
    {
        clearOutput();
        outputText(images.showImage("scylla-share-tentacle-addiction-one"));
    ...
    private function shareTentaclesWithScylla2() : Void
    {
        ...
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) >= 6)
        {
            outputText("  Another encircles Pastie, thick flesh lifting the limp fairy off the carpet while a sixth rubs the underside of its crest against her squirming face.");
        }
        ...
        doNext(shareTentaclesWithScylla3);
    }
    
    private function shareTentaclesWithScylla3() : Void
    {
        clearOutput();
        outputText(images.showImage("scylla-share-tentacle-addiction-three"));
        ...
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) >= 4)
        {
            outputText("  Abylon's hips roll as she struggles for breath, transfixed atop your shafts, stiletto-heeled boots uselessly kicking air while her mouth works silently, speechless at the strength of your sinuous poles.");
        }
        //[Six cocks:
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) >= 6)
        {
            outputText("  Pastie, wriggling in her twin sheathes, shudders with ecstatic bliss, her every sensation overwhelmed by the pressing confines of your voracious cocks.");
        }
        outputText(" Just getting your writhing host into place has ignited the fuse of your crescendo, globs of pre-cum leaking down every shaft in anticipation. Flesh throbbing, you curl a lip and abandon all restraint.");
        ...
        doNext(shareTentaclesWithScylla4);
    }
    
    //[Next]
    private function shareTentaclesWithScylla4() : Void
    {
        clearOutput();
        ...
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) >= 4)
        {
            outputText("  Lowering the goblin girl into the nun's pillowy cleavage, she tries to make a snide remark, but can't find the strength and simply snuggles into the ample flesh of Scylla's inflated bosom. Thick, creamy milk leaks from the nun's well-nourished nipple-lips, warm drool glazing Abby's beryl skin.");
        }
        //[six cocks:
        if (player.countCocksWithType(CockTypesEnum.TENTACLE) >= 6)
        {
            outputText("  Scooping Pastie from the ground, you rest her atop the room's table, her body wobbling like an overfilled water balloon. It's just as well that she's filled with a half gallon of spunk – she's far too drunk and high to fly without hurting herself.");
        }
    ...
    public function scyllasFlyingSolo() : Void
    {
        ...
        outputText(images.showImage("scylla-feed-bar-intro"));
        if (flags[kFLAGS.TIMES_SOLO_FED_NUN] == 0)
        {
    ...
    //[Feed]
    private function feedScyllaSomeJizzDatJunkieNeedsIt() : Void
    {
        clearOutput();
        outputText(images.showImage("scylla-feed-jizz-solo-one"));
        scyllaSprite();
        flags[kFLAGS.TIMES_SOLO_FED_NUN]++;
        flags[kFLAGS.FED_SCYLLA_TODAY] = 1;
        if (flags[kFLAGS.TIMES_SOLO_FED_NUN] == 1)
        {
            outputText("You can't just leave her here like this; the girl's desperate and it'd be too easy for somebody to take advantage of her.  Besides, judging by the tightness in your [armor], whatever strange force her appetite exerts on your body has already begun to creep into your flesh.  The cold tickle of liquid weight swells in your abdomen and your breath catches in your throat.");
            //[Balls:
            if (player.hasBalls())
            {
                outputText("  The seething sensation in your loins begins to empty into your [balls], your cum factories lurching to life with a heavy, sinking sensation.  Your gear bulges as they grow, filling with your potent seed.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("  Your scrotum inflates ever larger until the pressure of your [armor] becomes unbearable.");
            }
            outputText("  You hastily strip and guide the pliant, hunger-dazed woman to the bed.  She proves to be further gone than you would've guessed, sinking down sluggishly and laying on her back with a hot, breathless sigh.  Her head droops over the edge of the bed, a dreamy smile playing across her bimbo-thick lips as voluminous ebony curls spill from her habit.  Your abdomen clenches in icy tightness as your loins thicken with a need nearly as great as the one dominating the overwrought maiden on the bed.");
            if (player.hasBalls())
            {
                outputText("  The orbs swinging beneath your [cocks] continue their growth, threatening to immobilize you if you don't find release quickly.  Every motion sends your spunk-laden reservoirs sloshing and wobbling, the ponderous ballsac now hanging mere inches from the floor.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("  The churning burden heaving in your testes has grown large enough to put you off-balance, forcing you to adjust your stance to accommodate their barrel-sized girth.");
            }
        ...
        else
        {
            ...
            outputText("Suggesting the two of you retire to her room, she leads you up the stairs, closing the door behind you.  As the door clicks shut, you embrace the nun with a kiss, the sweet warmth of her pliant lips echoing through your bones as a tightness forms in your [armor].  The embrace turns impassioned, your tongue sweeping into her eager mouth as the swelling force of her silent prayers creep into your flesh.  Her long, mischievous tongue curls around you while a cold tickle of liquid weight swells in your abdomen.");
            //[Balls:
            if (player.hasBalls())
            {
                outputText("  The seething sensation in your loins begins to empty into your [balls], your cum factories lurching to life with a heavy, sinking sensation.  Your [armor] bulge as they grow, filling with your potent seed.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("  Your scrotum inflates ever larger until the pressure of your [armor] becomes delicious.");
            }
            outputText("  She helps you strip and guides you to her bed with a coy smile.  Sinking down eagerly, she lays on her back with a hot, breathless sigh, just as before.  Her head droops over the edge of the bed, a dreamy smile playing across her bimbo-thick lips as voluminous ebony curls spill from her habit.  Your abdomen clenches in icy tightness as your loins thicken with a need nearly as great as her own.");
            if (player.hasBalls())
            {
                outputText("  The orbs swinging beneath your [cocks] continue their growth, every motion sending your spunk-laden reservoirs sloshing and wobbling.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("  The churning burden heaving in your testes has grown large enough to put you off-balance, forcing you to adjust your stance to accommodate their swelling girth.");
            }
    ...
    private function feedingScyllaCumStepTwo() : Void
    {
        clearOutput();
        outputText(images.showImage("scylla-feed-jizz-solo-two"));
        scyllaSprite();
        if (flags[kFLAGS.TIMES_SOLO_FED_NUN] == 1)
        {
            ...
            if (player.hasBalls())
            {
                ...
                outputText(" deities hung from your loins.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("  Discharging their pressurized bounty in an unbound release, your over-inflated balls finally cease their incapacitating growth and begin to deflate by inches at a time.  When you take a shuddering breath, it's as if you had been underwater and finally broken the surface - gulping cool air into your lungs with heaving gasps of blessed relief.");
            }
        }
        else
        {
            outputText("Like a bolstering surge, the nun's virile magic pours into you, a flux of hot and cold stimulating your prostate into an intoxicating overdrive.  ");
            //[balls:
            if (player.hasBalls())
            {
                outputText("The pressure on your corpulent balls is tremendous, the over-burdened globes hanging from you literally vibrating under the tension of your imminent orgasm.  ");
            }
            outputText("Needing no further coaxing, you begin sliding your meat deeper into the nun's mouth, feeding inch after inch until you hit the back of her throat and push further.  Reaching out, you grab the sides of the nun's head, tilting her jaw back to ease the relentless journey of your tremulous hydrant.  Her throat clenches down around you in muscled pulses, rings of tension milking your [cock biggest] with every gulping gasp the impure nun takes.  Her neck visibly bulges as you grit your teeth and force your girth deeper into her welcoming body.");
            ...
            if (player.hasBalls())
            {
                outputText("  Discharging their pressurized bounty in an unbound release, your over-inflated balls finally cease their incapacitating growth and begin to deflate by inches at a time.");
            }
        }
        player.sexReward("saliva", "Dick");
    ...
    private function cumFeedScyllaShesACoolGirl() : Void
    {
        ...
        //[Low Cum Production (under 250,000 ml)]{
            ...
            else
            {
                ...
                //[Offer][Decline]
                menu();
                addButton(0, "Offer", beScyllasPersonSemenSquirtingMilkMaid);
                addButton(4, "Leave", declineToBeASpunkPumpintJizztrocity);
            }
        }
        //[Low Cum Production (under 250,000 ml)]
        else
        {
            ...
            else
            {
                ...
                if (player.hasKeyItem("Opal Ring") < 0)
                {
                    ...
                    outputText("\n\nWould you like to offer to become Scylla's personal — and only — cum purveyor?");
                    sceneHunter.print("You won't get <b>anything</b> from it, but one good scene will be <b>permanently</b> locked.");
                    player.cumMultiplier += 1 + rand(5);
                    if (player.hasBalls())
                    {
                        player.ballSize++;
    ...
    //[Decline]
    private function declineToBeASpunkPumpintJizztrocity() : Void
    {
        clearOutput();
        scyllaSprite();
    ...
    //[Offer]
    private function beScyllasPersonSemenSquirtingMilkMaid() : Void
    {
        clearOutput();
        scyllaSprite();
    ...
    public function openTheDoorToFoursomeWivScyllaAndFurries() : Void
    {
        ...
        if (flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] == 0)
        {
            outputText("busts her nuts like a champ.");
        }
        else if (flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] <= 1)
        {
            outputText("fills condoms like some kind of balloon-making machine.");
        }
        else if (flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] <= 2)
        {
            outputText("busts condoms just about every other orgasm now.");
        }
        else if (flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] <= 3)
        {
            outputText("busts condoms if she even thinks about using ‘em.");
        }
        else
        {
            outputText("can almost fill a bathtub nowadays. Fuck, I love watching her squirm while I tease those huge loads out of her.");
        }
        outputText("\"</i>");
        ...
        {
            outputText("over a foot");
        }
        else
        {
            outputText("a few feet");
        }
        ...
        outputText("\n\nScylla shakes her head, her eyes abruptly losing their onyx luster, pain and confusion evident on her face. Her horns, however, stay as they are, and you are unable to deny the lust pounding through your veins, grabbing to aid you in wildly humping her face, dumping wad after wad into her expanding belly. Her hands release Snow’s squirting twat and Winter’s hyperinflated nutsack at the same time. Their voices pitch into a chorus of orgiastic delight, filling the air with so much passionate screaming that you can’t even pick your own exultations out of the crowd.");
        ...
        if (player.lib >= 80 || player.minLust() > 50)
        {
            outputText("slapping into your belly, still hard but spent");
        }
        else
        {
            outputText("starting to go limp");
        }
    ...
    private function scyllaFurryFoursomePartDues() : Void
    {
        ...
        if (player.cumMultiplier < 19990)
        {
            player.cumMultiplier += 1 + rand(5);
        }
        if (player.hasBalls() && player.ballSize < 30)
        {
            player.ballSize++;
        }
