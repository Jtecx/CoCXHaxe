...
class VictoriaTailorShop extends Shop
{
    public function new()
    {
        super();
    ...
    {
        localvars.inside = {
                    metVictoria : player.hasStatusEffect(StatusEffects.Victoria)
                };
        super.inside();
    ...
    override private function confirmBuy(itype : ItemType = null, priceOverride : Int = -1, keyItem : String = "", priceRate : Float = 1, useStones : Bool = false, currentQuantity : Int = 1) : Void
    {
        clearOutput();
    ...
    //[Flirt]
    private function flirtWithVictoria(itype : ItemType, priceOverride : Int = -1, keyItem : String = "", priceRate : Float = 1, useStones : Bool = false, currentQuantity : Int = 1) : Void
    {
        clearOutput();
