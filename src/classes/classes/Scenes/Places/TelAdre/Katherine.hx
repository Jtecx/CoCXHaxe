...
class Katherine extends TelAdreAbstractContent implements TimeAwareInterface
{
    public var breasts(get, never) : BreastStore;
    public var ballSize(get, set) : Int;
    public var cockLength(get, set) : Float;
    public var cockNumber(get, set) : Int;
    public var knotSize(get, set) : Int;
    public var fertile(get, set) : Bool;
    public var furry(get, set) : Bool;
    public var hairColor(get, set) : String;
    ...
    public static inline var KBIT_CLOTHES_TATTERED : Int = 0;  //These values are used for the KATHERINE_CLOTHES, KATHERINE_CLOTHES_PREF and KATHERINE_CLOTHES_WORN flags  
    public static inline var KBIT_CLOTHES_UNIFORM : Int = 1;
    public static inline var KBIT_CLOTHES_C_CLOTH : Int = 2;
    public static inline var KBIT_CLOTHES_BODYSUIT : Int = 4;
    public static inline var KBIT_CLOTHES_B_DRESS : Int = 8;
    public static inline var KBIT_CLOTHES_SS_ROBE : Int = 16;
    public static inline var KBIT_CLOTHES_TUBETOP : Int = 32;
    public static inline var KBIT_CLOTHES_NURSECL : Int = 64;
    
    public static inline var KBIT_TRIED_RECEIVE_ANAL : Int = 1;  //Used with the KATHERINE_SEXUAL_EXPERIENCE flag to track some forms of sex Kath has experienced.  
    public static inline var KBIT_TRIED_RECEIVE_SUCK_N_FUCK : Int = 2;  //This way scenes can have special text for the first time.  
    public static inline var KBIT_TRIED_RECEIVE_ORAL : Int = 4;
    public static inline var KBIT_TRIED_GIVE_VAGINAL : Int = 8;
    public static inline var KBIT_TRIED_GIVE_ANAL : Int = 16;
    public static inline var KBIT_TRIED_GIVE_DOUBLE_PEN : Int = 32;
    public static inline var KBIT_TRIED_GIVE_SUCK_N_FUCK : Int = 64;
    public static inline var KBIT_TRIED_DOUBLE_HELIX : Int = 128;
    public static inline var KBIT_TRIED_BATH : Int = 256;
    public static inline var KBIT_TRIED_BEDROOM_BONDAGE : Int = 512;
    
    public static inline var KBIT_MILK_TOLD_PLAYER_SHES_DRY : Int = 1;  //Each time Kath runs out of milk she should only tell the player about it once  
    public static inline var KBIT_MILK_SHARE_WITH_FRIENDS : Int = 2;  //She should share with lovers and any old or new friends or acquaintances (includes all below)  
    public static inline var KBIT_MILK_SHARE_WITH_OLD_GANG : Int = 4;  //Share her milk with the vagrant cats (includes Helena)  
    public static inline var KBIT_MILK_SHARE_WITH_HELENA : Int = 8;  //The young cat morph girl from the vagrant cats  
    public static inline var KBIT_MILK_SHARE_WITH_URTA : Int = 16;
    public static inline var KBIT_MILK_SHARE_WITH_VALA : Int = 32;
    
    public static inline var KBIT_SUB_HIGH_CUM : Int = 1;  //Caused by double penetrate Kath scene  
    ...
    public static inline var KBIT_SUB_BED_BOND : Int = 2;  //Caused by the bedroom bondage scene  
    //Bedroom bondage and roleplaying (No submissiveness requirement)
    public static inline var KBIT_SUB_ORGASM_DENIAL : Int = 4;  //Caused by the bath scene  
    ...
    public static inline var KBIT_SUB_CALL_MASTER : Int = 8;  //This bit is just an indicator, it does not count towards Katherine’s submissiveness  
    //If set Kath will call the player either Master or Mistress (Requires submissiveness 4+)
    public static inline var KBIT_SUB_GROW_KNOT : Int = 16;
    ...
    public static inline var KBIT_SUB_CAT_DICK : Int = 32;
    ...
    public static inline var KBIT_SUB_CAT_GIRL : Int = 256;
    //You have convinced Kath to change into a cat girl at least once (Requires submissiveness of 3 or more)
    public static inline var KBIT_SUB_HIGH_LACTATION : Int = 512;
    ...
    public static inline var KBIT_SUB_REM_BALLS : Int = 1024;
    ...
    public static inline var KBIT_SUB_REM_COCK : Int = 8192;
    //You have convinced Kath to lose her cock and become a woman (Requires submissiveness of 6 or more)
    public static inline var KBIT_SUB_START_LACTATION : Int = 16384;
    ...
    public static inline var KLOC_STREETS : Int = 0;  //Sex happens in a non-descript alleyway, possibly behind the Wet Bitch  
    public static inline var KLOC_KATHS_APT : Int = 1;  //At her own home. After sex she will generally stay there  
    public static inline var KLOC_URTAS_APT : Int = 2;  //Kath may stay here if she and Urta are fuckbuddies or lovers  
    public static inline var KLOC_URTAS_HOME : Int = 3;  //Kath may stay here if she and Urta are fuckbuddies or lovers. They will stay all night.  
    public static inline var KLOC_BAR : Int = 4;  //At the Wet Bitch. Returns here unless it's after 14:00 or you were last at her place, Urta's apt or Urta's home.  
    //During sex scenes this indicates the bar or a backroom at the bar depending on the scene.
    public static inline var KLOC_BAR_DRUNK : Int = 5;  //At the Wet Bitch. You got her to drink a lot of booze.  
    public static inline var KLOC_BAR_URTA_REFUSED : Int = 6;  //At the Wet Bitch. She's drunk and Urta has refused to have sex with her right now.  
    public static inline var KLOC_LAKE : Int = 7;  //You take her out to the lake, either for training or for a date  
    public static inline var KLOC_DESERT : Int = 8;  //You take her out into the desert for training  
    
    public static inline var KDATE_LITTLE : Int = 0;  //Have sex together only in threesomes with you  
    public static inline var KDATE_WHENEVER : Int = 1;  //Have sex together whenever they like  
    public static inline var KDATE_LOTS : Int = 2;  //Have lots of sex together  
    
    private static inline var KBIT_LOVER_AMILY : Int = 1;
    private static inline var KBIT_LOVER_COTTON : Int = 2;
    private static inline var KBIT_LOVER_EDRYN : Int = 4;
    private static inline var KBIT_LOVER_HELIA : Int = 8;
    private static inline var KBIT_LOVER_URTA : Int = 16;
    private static inline var KBIT_LOVER_VALA : Int = 32;
    ...
    public function isValaAtBar() : Bool
    {
    ...
    public function timeChange() : Bool
    {
        ...
        {
            var _sw1_ = (model.time.hours);            

            switch (_sw1_)
            {  //Suckling by all NPCs handled here. The player doesn't see this, but they meet up with Kath at different times of the day.  
                case 8:if (milkOption(KBIT_MILK_SHARE_WITH_FRIENDS) || (milkOption(KBIT_MILK_SHARE_WITH_OLD_GANG) && model.time.days % 2 == 0))
                    {
                        breasts.milked();
                    }  //She shares with friends every day, or shares with the old gang once every two days  
                case 11:if (milkOption(KBIT_MILK_SHARE_WITH_FRIENDS | KBIT_MILK_SHARE_WITH_URTA) && model.time.days % 5 == 0)
                    {
                        breasts.milked();
                    }
                case 14:if (milkOption(KBIT_MILK_SHARE_WITH_FRIENDS) && model.time.days % 4 == 0)
                    {
                        breasts.milked();
                    }
                case 16:if (milkOption(KBIT_MILK_SHARE_WITH_FRIENDS | KBIT_MILK_SHARE_WITH_OLD_GANG | KBIT_MILK_SHARE_WITH_HELENA) && model.time.days % 3 == 0)
                    {
                        breasts.milked();
                    }
                case 17:if (milkOption(KBIT_MILK_SHARE_WITH_FRIENDS | KBIT_MILK_SHARE_WITH_VALA) && model.time.days % 5 == 2)
                    {
                        breasts.milked();
                    }
            }
        ...
        if (model.time.hours == 6)
        {
            ...
            {
                if (model.time.days % 4 == 0)
                {
                    katherineAndUrtaHadSex(false);
                }
            }
            else if (flags[kFLAGS.KATHERINE_URTA_DATE] == KDATE_LOTS)
            {
                katherineAndUrtaHadSex(false);
            }  //They fuck at least once a day  
            ...
            else if (flags[kFLAGS.KATHERINE_VALA_DATE] == KDATE_LOTS)
            {
                katherineAndValaHadSex();
            }
        }
        ...
        //Must select her civilian clothes for the day once her shift is over{
            ...
            var clothesPref : Float = flags[kFLAGS.KATHERINE_CLOTHES_PREF];
            ...
            else if (clothesPref > 0 && rand(3) != 0)
            ...
            else
            {
                ...
                var clothes : Float = flags[kFLAGS.KATHERINE_CLOTHES];
                var clothesArray : Array<Dynamic> = [];
                
                if (clothesPref != KBIT_CLOTHES_C_CLOTH)
                {
                    clothesArray.push(KBIT_CLOTHES_C_CLOTH);
                }  //Always owned  
                if (clothesPref != KBIT_CLOTHES_BODYSUIT && (as3hx.Compat.parseInt(clothes) & KBIT_CLOTHES_BODYSUIT) > 0)
                {
                    clothesArray.push(KBIT_CLOTHES_BODYSUIT);
                }  //Bodysuit  
                if (clothesPref != KBIT_CLOTHES_B_DRESS && (as3hx.Compat.parseInt(clothes) & KBIT_CLOTHES_B_DRESS) > 0)
                {
                    clothesArray.push(KBIT_CLOTHES_B_DRESS);
                }  //Long Dress  
                if (clothesPref != KBIT_CLOTHES_SS_ROBE && (as3hx.Compat.parseInt(clothes) & KBIT_CLOTHES_SS_ROBE) > 0)
                {
                    clothesArray.push(KBIT_CLOTHES_SS_ROBE);
                }  //Spid. Silk Robe  
                if (clothesPref != KBIT_CLOTHES_TUBETOP && (as3hx.Compat.parseInt(clothes) & KBIT_CLOTHES_TUBETOP) > 0)
                {
                    clothesArray.push(KBIT_CLOTHES_TUBETOP);
                }  //Tube Top  
                if (clothesPref != KBIT_CLOTHES_NURSECL && (as3hx.Compat.parseInt(clothes) & KBIT_CLOTHES_NURSECL) > 0)
                {
                    clothesArray.push(KBIT_CLOTHES_NURSECL);
                }  //Nurse’s Outfit  
        ...
        //Once employed Kath goes home from any encounter after 14:00 hours, unless they happened at either Urta’s apartment or Urta’s house.{
            ...
            var _sw2_ = (flags[kFLAGS.KATHERINE_LOCATION]);            

            switch (_sw2_)
            {
                case KLOC_KATHS_APT, KLOC_URTAS_HOME:  //Already at final destination for the night  
                case KLOC_URTAS_APT:
                    if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] > 31)
                    {
                        ...
                        //A three in four chance that Kath will stay with Urta once they've hooked up{
                            ...
                            if (player.hasKeyItem("Spare Key to Urta's House") >= 0)
                            {
                                flags[kFLAGS.KATHERINE_LOCATION] = KLOC_URTAS_HOME;
                            }
                            break;
                        }
                    }
                    ...
                    }flags[kFLAGS.KATHERINE_LOCATION] = KLOC_KATHS_APT;  //else fall through to the default case, Kath goes home  
        ...
        //Any time after 10:00 but before 14:00 Kath returns to the bar after encounters, though she will stay at her home if the encounter happened there.{
            ...
            var _sw3_ = (flags[kFLAGS.KATHERINE_LOCATION]);            

            switch (_sw3_)
            {
                case KLOC_BAR, KLOC_KATHS_APT:
    ...
    private function get_breasts() : BreastStore
    {
        return _breasts;
    }
    ...
    {
        return flags[kFLAGS.KATHERINE_BALL_SIZE];
    }
    
    private function set_ballSize(value : Int) : Int
    {
        flags[kFLAGS.KATHERINE_BALL_SIZE] = value;
        return value;
    }
    ...
    {
        return flags[kFLAGS.KATHERINE_DICK_LENGTH];
    }
    
    private function set_cockLength(value : Float) : Float
    {
        flags[kFLAGS.KATHERINE_DICK_LENGTH] = value;
        return value;
    }
    
    private function get_cockNumber() : Int
    {
        return flags[kFLAGS.KATHERINE_DICK_COUNT];
    }
    
    private function set_cockNumber(value : Int) : Int
    {
        flags[kFLAGS.KATHERINE_DICK_COUNT] = value;
        return value;
    }
    
    private function get_knotSize() : Int
    {
        return flags[kFLAGS.KATHERINE_KNOT_THICKNESS];
    }
    
    private function set_knotSize(value : Int) : Int
    {
        flags[kFLAGS.KATHERINE_KNOT_THICKNESS] = value;
        return value;
    }
    
    private function get_fertile() : Bool
    {
        return false;
    }
    
    private function set_fertile(value : Bool) : Bool
    {
        return value;
    }
    
    private function get_furry() : Bool
    {
        return flags[kFLAGS.KATHERINE_IS_CAT_GIRL] == 0;
    }  //furry == true means she's a cat morph, furry == false means she's a cat girl  
    
    private function set_furry(value : Bool) : Bool
    {
        flags[kFLAGS.KATHERINE_IS_CAT_GIRL] = ((value) ? 0 : 1);
        return value;
    }
    
    private function get_hairColor() : String
    {
        return flags[kFLAGS.KATHERINE_HAIR_COLOR];
    }
    
    private function set_hairColor(value : String) : String
    {
        flags[kFLAGS.KATHERINE_HAIR_COLOR] = value;
        return value;
    }
    
    public function cockWidth() : Float
    {
        return ((hasDogCock()) ? 1.5 : 1);
    }
    
    public function cockArea() : Float
    {
        return cockWidth() * cockLength;
    }
    
    public function hasBalls() : Bool
    {
        return flags[kFLAGS.KATHERINE_BALL_SIZE] > 0;
    }
    
    public function hasCock() : Bool
    {
        return flags[kFLAGS.KATHERINE_DICK_COUNT] > 0;
    }
    
    public function isAt(location : Int) : Bool
    {
        return flags[kFLAGS.KATHERINE_LOCATION] == location;
    }
    
    public function hasClothing(clothing : Int) : Bool
    {
        return (flags[kFLAGS.KATHERINE_CLOTHES] & clothing) > 0;
    }
    
    public function giveClothing(clothing : Int) : Void
    {
        flags[kFLAGS.KATHERINE_CLOTHES] = flags[kFLAGS.KATHERINE_CLOTHES] | clothing;
        flags[kFLAGS.KATHERINE_CLOTHES_WORN] = clothing;
    }
    
    public function cockMultiple(single : String, double : String) : String
    {
        return ((flags[kFLAGS.KATHERINE_DICK_COUNT] <= 1) ? single : double);
    }
    
    public function hasDogCock() : Bool
    {
        return flags[kFLAGS.KATHERINE_DICK_FORM] == 0;
    }
    
    public function cockType(dogText : String = "canine", catText : String = "feline") : String
    {
        return ((flags[kFLAGS.KATHERINE_DICK_FORM] == 0) ? dogText : catText);
    }
    
    public function catGirl(isCatGirl : String, isCatMorph : String) : String
    {
        return ((flags[kFLAGS.KATHERINE_IS_CAT_GIRL] == 0) ? isCatMorph : isCatGirl);
    }
    
    public function hasAlready(sex : Int) : Bool
    {
        return (flags[kFLAGS.KATHERINE_SEXUAL_EXPERIENCE] & sex) > 0;
    }  //If false then it's her first time doing this  
    
    public function experience(sex : Int) : Void
    {
        flags[kFLAGS.KATHERINE_SEXUAL_EXPERIENCE] = flags[kFLAGS.KATHERINE_SEXUAL_EXPERIENCE] | sex;
    }  //Learned a new way to fuck  
    
    public function milkOption(value : Int) : Bool
    {
        return (flags[kFLAGS.KATHERINE_MILK_OPTIONS] & value) > 0;
    }  //Check the status of one of Kath's milk options  
    
    public function milkOptionClear(value : Int) : Void
    {
        flags[kFLAGS.KATHERINE_MILK_OPTIONS] = flags[kFLAGS.KATHERINE_MILK_OPTIONS] & as3hx.Compat.parseInt(~value);
    }  //Set a single bit to zero  
    
    public function milkOptionSet(value : Int) : Void
    {
        flags[kFLAGS.KATHERINE_MILK_OPTIONS] = flags[kFLAGS.KATHERINE_MILK_OPTIONS] | value;
    }  //Set a single bit to one  
    
    public function cumQ() : Float
    {
        var quantity : Float = 40 * Math.min(168, flags[kFLAGS.KATHERINE_HOURS_SINCE_CUM] + 10) / 24;
        if (ballSize <= 0)
        {
            quantity *= 0.75 + 0.25 * (-ballSize);
        }
    ...
    {
        flags[kFLAGS.KATHERINE_HOURS_SINCE_CUM] = 0;
    }
    
    public function fertileText(fertileText : String, infertileText : String) : String
    {
        return ((fertile) ? fertileText : infertileText);
    }
    ...
    {
        var _sw4_ = (flags[kFLAGS.KATHERINE_BALL_SIZE]);        

        switch (_sw4_)
        {
            case 0, 1:return "small";
            case 2, 3:return "large";
            case 4, 5:return "huge";
            case 6, 7:return "massive";
    ...
    {
        var _sw5_ = (flags[kFLAGS.KATHERINE_DICK_LENGTH]);        

        switch (_sw5_)
        {
            case 0, 1, 2, 3, 4, 5:return "little ";
            case 6, 7:return " ";
            case 8, 9, 10:return "sizeable ";
            case 11, 12, 13, 14:return "large ";
            case 15, 16, 17, 18:return "huge ";
            default:return "enormous ";
        }
    }
    ...
    {
        var _sw6_ = (flags[kFLAGS.KATHERINE_KNOT_THICKNESS]);        

        switch (_sw6_)
        {
            case 0, 1, 2, 3:return "small";
            case 4, 5:return "sizeable";
            default:return "huge";
        }
    }
    
    public function isMilky() : Bool
    ...
    {
        var _sw7_ = (breasts.cupSize);        

        switch (_sw7_)
        {
            case BreastCup.FLAT, BreastCup.A, BreastCup.B:outputText("tight enough to showcase even her small breasts");
            case BreastCup.C, BreastCup.D, BreastCup.DD:outputText("just able to hold her bountiful breasts in check");
            default:
        }
        outputText("overflowing with her bountiful titflesh");
    }
    
    public function canWearMiniSkirt() : Bool
    {
        return cockLength <= 8 && ballSize < 3;
    }
    ...
    //Produces a few sentences which describe what Katherine is currently wearing
    {
        ...
        var milky : Bool = isMilky();
        var _sw8_ = (flags[kFLAGS.KATHERINE_CLOTHES_WORN]);        
        ...
        switch (_sw8_)
        {
            ...
            case KBIT_CLOTHES_C_CLOTH:  //Blouse and Skirt  
                ...
                {
                    outputText("strains to hold her bountiful breasts in check.");
                }
                if (milky)
                {
                    outputText("  The blouse is a little damp thanks to leakage from her bountiful bosom.");
                }
            ...
            case KBIT_CLOTHES_BODYSUIT:  //Bodysuit  
                ...
                if (milky)
                {
                    outputText("  The fabric over her chest is a little damp and even more transparent than the rest thanks to leakage from her bountiful bosom.");
                }
            case KBIT_CLOTHES_B_DRESS:  //Elegant Long Dress  
                ...
                if (milky)
                {
                    outputText("  Despite some extra absorbent padding the fabric over her chest is a little damp thanks to leakage from her bountiful bosom.");
                }
            case KBIT_CLOTHES_SS_ROBE:  //Spider Silk Robe  
                ...
                if (milky)
                {
                    outputText("  The fabric over her chest has wicked up a great deal of Kath's cream and the wet silk cleaves to her bosom in a most attractive way.");
                }
            ...
            case KBIT_CLOTHES_NURSECL:  //Nurse’s Outfit  
                ...
                {
                    outputText("From the waist down, she wears a matching white skirt that ends at her knees." + ((hasCock()) ? skirtDescription() : ""));
                }
    ...
    {
        var _sw9_ = (flags[kFLAGS.KATHERINE_CLOTHES_WORN]);        
    ...
    {
        var _sw10_ = (flags[kFLAGS.KATHERINE_CLOTHES_WORN]);        
        ...
        switch (_sw10_)
        {
            ...
            case KBIT_CLOTHES_BODYSUIT:return bodysuitText;
            case KBIT_CLOTHES_B_DRESS:return dressText;
            case KBIT_CLOTHES_SS_ROBE:return robeText;  //Smaller bulge can be concealed in tight pants  
            case KBIT_CLOTHES_TUBETOP, KBIT_CLOTHES_NURSECL:
                ...
                {case KBIT_CLOTHES_TUBETOP:
                        ...
                        {
                            return skirtText;
                        }  //A large package needs a skirt to hide it  
                        break;
                }return skirtText;
            default:
        }
    ...
    public function submissiveness() : Int
    {
        ...
        var subCount : Int = 0;
        if ((subFlags & KBIT_SUB_HIGH_CUM) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_BED_BOND) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_ORGASM_DENIAL) > 0)
        {
            subCount++;
        }
        //KBIT_SUB_CALL_MASTER doesn’t count - it just shows you told her to call you master
        if ((subFlags & KBIT_SUB_GROW_KNOT) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_CAT_DICK) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_GROW_BIG_BOOBS) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_GROW_BIG_DICK) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_CAT_GIRL) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_HIGH_LACTATION) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_REM_BALLS) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_GROW_BIG_BALLS) > 0)
        {
            subCount++;
        }
        if ((subFlags & KBIT_SUB_PUBLIC_EXHIBITION) > 0)
        {
            subCount += 2;
        }  //Worth double  
        if ((subFlags & KBIT_SUB_REM_COCK) > 0)
        {
            subCount++;
        }
        if (subCount < 4 && (subFlags & KBIT_SUB_START_LACTATION) > 0)
        {
            subCount++;
        }
        return subCount;
    ...
    public function addSubmissive(behaviour : Int) : Void
    {
        flags[kFLAGS.KATHERINE_SUB_FLAGS] = flags[kFLAGS.KATHERINE_SUB_FLAGS] | behaviour;
    }
    
    public function doneSubmissive(behaviour : Int) : Bool
    {
        return ((flags[kFLAGS.KATHERINE_SUB_FLAGS] & behaviour) > 0);
    }
    
    public function playerMaster() : Bool
    {
        return (flags[kFLAGS.KATHERINE_SUB_FLAGS] & KBIT_SUB_CALL_MASTER) > 0;
    }
    ...
    public function katherineAndUrtaHadSex(drunkSex : Bool) : Void
    //Every time they have sex they get a little closer, but this is limited to a max of 30
    {
        ...
        if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] == 30 && (drunkSex || flags[kFLAGS.KATHERINE_UNLOCKED] < 4 || flags[kFLAGS.KATHERINE_URTA_DATE] == KDATE_LITTLE))
        {
            return;
        }
    ...
    //Every time they have sex they get a little closer, but this is limited to a max of 11.
    {
        ...
        if (flags[kFLAGS.KATHERINE_VALA_AFFECTION] > 11)
        {
            return;
        }
    ...
    public function needIntroductionFromScylla() : Bool
    {
    ...
    public function visitKatherine() : Void
    {
        ...
        {
            if (telAdre.katherineEmployment.initiateTraining())
            {
                return;
            }
        }
    ...
    public function katherineVisitNormal(checkTraining : Bool = true) : Void
    {
        outputText("Katherine the cat is currently ");
        switch (rand(5))
        {
            case 0:outputText("sitting in a corner");
            case 1:outputText("pacing back and forth");
            case 2:outputText("sipping furtively at a bottle of milk");
            case 3:outputText("yawning and stretching");
        ...
        //Regular menu{
            ...
            if (checkTraining && flags[kFLAGS.KATHERINE_TRAINING] > 2)
        ...
        else
        {
            ...
            {
                telAdre.katherineEmployment.katherineTrainingStage1(false);
            }
        }
    }
    ...
    private function katherineApartmentLeave() : Void
    {
        ...
        {
            outputText("Alright [name] but next time I want to have some fun.</i>\"\n\n");
        }
        doNext(telAdre.telAdreMenu);
    }
        ...
        else
        {
            ...
            switch (rand(4))
            {
                ...
                default:
                    ...
                    {
                        outputText(((kids > 5) ? "a few of your kids" : "a pile of your children") + ".  They're lying all over Kath, playing with her ears and tail while she scratches their heads and gives them little kisses.");
                    }
                    ...
                    {
                        outputText("they race off in different directions");
                    }
    ...
    private function urtaPlusKathCuddle() : Void
    {
        if (player.spe > 75)
        {
            ...
            {
                outputText("dig her " + catGirl("nails", "claws") + " in.</i>\"\n\n");
            }
    ...
    //Special event that happens on entering the bar when KATHERINE_URTA_AFFECTION == 31
    {
        ...
        if (player.hasCock())
        {
            addButton(button++, "369", telAdre.katherineThreesome.threeSixtyNine);
        }
        if (hasCock())
        {
        ...
        {
            addButton(button++, "Watch", telAdre.katherineThreesome.watch, false);
        }  //A non-drunk version of this scene deals with the difficult ones if Kath can't pound you  
        if (player.hasCock() || player.hasVagina())
        {
            addButton(button++, "Spitr Kath", telAdre.katherineThreesome.spitroastKath);
        }
    }
    ...
    private function talkToKatherine() : Void
    {
        ...
        if (isAt(KLOC_STREETS))
        {
            ...
            {
                employmentTalk = telAdre.katherineEmployment.employmentTalk;
            }
        ...
        {
            addButtonDisabled(4, "???", "Requires her to undergo a specific transformation at least once.");
        }
        if (isAt(KLOC_KATHS_APT) && flags[kFLAGS.KATHERINE_CLOTHES] >= 4)
        {
            addButton(5, "Clothes", talkClothes);
        }
        //All the special clothes have a value of 4 or more
        else
        {
            addButtonDisabled(5, "???", "Requires Kath to have more clothes.");
        }
        if (playerLovers() > 0)
        {
        ...
        {
            addButtonDisabled(7, "???", "Requires Kath to be more submissive.");
        }
        ...
        {
            addButtonDisabled(8, "???", "Requires Kath to lactate.");
        }
    ...
    private function askKatherineAboutGang() : Void
    {
        ...
        if (flags[kFLAGS.KATHERINE_UNLOCKED] == 1)
        {
            ...
            if (flags[kFLAGS.KATHERINE_MET_SCYLLA] != null)
            {
    ...
    private function talkWatch() : Void
    {
        ...
        {
            outputText("She gets up, walks slowly around the table and sits " + ((player.isNaga()) ? "atop your tail" : "on your knee") + ". She wraps her arms around your neck, pressing");
        }
    ...
    private function talkHome() : Void
    {
        ...
        {
            outputText("She leans back further and her foot brushes against your " + ((player.isNaga()) ? "tail" : "leg") + ".  \"<i>You know, we could be there right now.  Just say the word and we could start testing how tight the cords under my bed are.</i>\"");
        }
        katSexMenu();
    }
    ...
    private function talkClothesBlouseCompliment() : Void
    {
        ...
        {
            outputText("She grinds her pelvis against your " + ((player.isNaga()) ? "tail" : "leg") + ", her tail curling around your waist.  Clearly your kitten loves compliments.");
        }
        katSexMenu();
    }
    ...
    private function talkClothesDressCompliment() : Void
    {
        ...
        {
            outputText("her nipples rub against you.  She's so turned on they're standing out like the tips of two little hot peppers - and you know they'd taste much sweeter.");
        }
        katSexMenu();
    }
    ...
    private function talkClothesNurseOutfitCompliment() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("  \"<i>I can think of at least one other person I’d love to see in a nurse’s outfit</i>\" she replies, tracing a finger down your back.");
        }
        katSexMenu();
    }
    ...
    //This function exists so that both talkLovers and talkToKatherine can use the same code to determine who else the player is fucking.
    {
        ...
        {
            loverSet = loverSet | KBIT_LOVER_AMILY;
        }  //Not > 0; probably don’t want to admit having corrupt Amily follower to Katherine  
        if (flags[kFLAGS.COTTON_MET_FUCKED] >= 2)
        {
            loverSet = loverSet | KBIT_LOVER_COTTON;
        }
        if ((flags[kFLAGS.EDRYN_NEVER_SEE_AGAIN] == 0) && (player.statusEffectv1(StatusEffects.Edryn) > 3))
        {
            loverSet = loverSet | KBIT_LOVER_EDRYN;
        }
        if ((flags[kFLAGS.HELIA_FOLLOWER_DISABLED] != 1) && SceneLib.helScene.followerHel() && !player.hasStatusEffect(StatusEffects.HeliaOff))
        {
            loverSet = loverSet | KBIT_LOVER_HELIA;
        }
        if (SceneLib.urta.urtaFuckbuddy())
        {
            loverSet = loverSet | KBIT_LOVER_URTA;
        }
        if (flags[kFLAGS.VALA_TIMES_CONSENSUAL_SEX] > 0)
        {
            loverSet = loverSet | KBIT_LOVER_VALA;
        }
        return loverSet;
    }
    ...
    {
        return as3hx.Compat.parseInt(((flags[kFLAGS.KATHERINE_AMILY_AFFECTION] > 0) ? 1 : 0)
    ...
    private function talkLoversAmily() : Void
    {
        ...
        if (flags[kFLAGS.KATHERINE_AMILY_AFFECTION] == 0)
        {
            ...
            {
                outputText("gives you a worried look and asks what this means for the two of you.  When you tell her you have no intention of leaving she jumps into your arms and squeezes most of the air out of your lungs.");
            }
    ...
    private function talkLoversEdryn() : Void
    {
        ...
        if (flags[kFLAGS.KATHERINE_EDRYN_AFFECTION] == 0)
        {
            ...
            if (edrynKids > 0)
            {
                outputText("  You tell Katherine that in fact you’ve fathered " + ((edrynKids > 1) ? edrynKids + " children" : "a child") + " with Edryn.  \"<i>She’s got " + ((edrynKids > 1) ? edrynKids + " kids" : "a kid") + "?</i>\" Kath blurts.  \"<i>Wow - I’d never have guessed.</i>\"");
            }
    ...
    private function talkLoversHelia() : Void
    {
        ...
        if (flags[kFLAGS.KATHERINE_HELIA_AFFECTION] == 0)
        {
            ...
            if (flags[kFLAGS.HELSPAWN_AGE] > 0)
            {
                ...
                {
                    outputText("  Kath thinks the fact you’ve been helping Helia raise her little girl is cute and she shows an interest in meeting them both.");
                }
            }
    ...
    {
        clearOutput();
        if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] == 0)
        ...
        else if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] == 1)
        ...
        else if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] <= 10)
        ...
        else if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] <= 31)
    ...
    private function talkLoversUrtaEncourage() : Void
    {
        ...
        if (hasCock())
        {
            outputText("cock" + cockMultiple("", "s") + " and ");
        }
    ...
    private function talkLoversVala() : Void
    {
        ...
        if (flags[kFLAGS.KATHERINE_VALA_AFFECTION] == 0)
        {
            ...
            if (flags[kFLAGS.TIMES_FUCKED_VALA_IN_DUNGEON] > 0)
            {
                outputText("You decide it would be best not to mention " + ((flags[kFLAGS.TIMES_FUCKED_VALA_IN_DUNGEON] == 1) ? "that time" : "those times") + " you took advantage of Vala, back when she was mindfucked and tied up.\n\n");
            }
            if (isAt(KLOC_KATHS_APT))
            {
    ...
    private function talkMaster() : Void
    {
        ...
        if ((flags[kFLAGS.KATHERINE_SUB_FLAGS] & KBIT_SUB_CALL_MASTER) > 0)
        {
            ...
            flags[kFLAGS.KATHERINE_SUB_FLAGS] = flags[kFLAGS.KATHERINE_SUB_FLAGS] & as3hx.Compat.parseInt(~KBIT_SUB_CALL_MASTER);
        }
        else
        {
            ...
            flags[kFLAGS.KATHERINE_SUB_FLAGS] = flags[kFLAGS.KATHERINE_SUB_FLAGS] | KBIT_SUB_CALL_MASTER;
        }
        katherineMenu();
    }
    ...
    private function talkMilkMenu() : Void
    {
        ...
        var _sw11_ = (breasts.lactationLevel);        
        ...
        var canShareWithUrta : Bool = flags[kFLAGS.KATHERINE_URTA_AFFECTION] > 10;
        var canShareWithVala : Bool = flags[kFLAGS.KATHERINE_VALA_AFFECTION] > 10;
        var sharingWithFriends : Bool = milkOption(KBIT_MILK_SHARE_WITH_FRIENDS);
        ...
        {
            var sharingArray : Array<Dynamic> = ["you"];
            if (milkOption(KBIT_MILK_SHARE_WITH_OLD_GANG))
            {
                sharingArray.push("her old gang");
            }
            //Old gang includes Helena
            else if (milkOption(KBIT_MILK_SHARE_WITH_HELENA))
            {
                sharingArray.push("Helena");
            }
            if (canShareWithUrta && milkOption(KBIT_MILK_SHARE_WITH_URTA))
            {
                sharingArray.push("Urta");
            }
            if (canShareWithVala && milkOption(KBIT_MILK_SHARE_WITH_VALA))
            {
        ...
        menu();
        if (!sharingWithFriends && !milkOption(KBIT_MILK_SHARE_WITH_OLD_GANG))
        {
            addButton(0, "Helena", talkMilkShareWithHelena);
        }
        if (!sharingWithFriends && canShareWithUrta)
        {
            addButton(1, "Urta", talkMilkShareWithUrta);
        }
        if (!sharingWithFriends && canShareWithVala)
        {
            addButton(2, "Vala", talkMilkShareWithVala);
        }
        addButton(4, "Limit", talkMilkLimitation);
        if (!sharingWithFriends)
        {
            addButton(5, "Old Gang", talkMilkShareWithOldGang);
        }
        if (submissiveness() >= 2)
        {
            addButton(6, "Friends", talkMilkShareWithFriends);
        }
        addButton(9, "Back", katherineMenu);
    }
    ...
    private function talkMilkShareWithHelenaAnswer(reallyStop : Bool) : Void
    {
        if (reallyStop)
        {
    ...
    {
        var doneHighLactation : Bool = doneSubmissive(KBIT_SUB_HIGH_LACTATION);
        outputText("\n\n<b>At the moment Kath's been told ");
        var _sw12_ = (breasts.preventLactationIncrease);        
        ...
        menu();
        if (breasts.preventLactationIncrease != BreastStore.LACTATION_LIGHT)
        {
            addButton(0, "Light", talkMilkLimitationChange, BreastStore.LACTATION_LIGHT);
        }
        if (doneHighLactation && breasts.preventLactationIncrease != BreastStore.LACTATION_MODERATE)
        {
            addButton(1, "Moderate", talkMilkLimitationChange, BreastStore.LACTATION_MODERATE);
        }
        if (doneHighLactation && breasts.preventLactationIncrease != BreastStore.LACTATION_STRONG)
        {
            addButton(2, "Strong", talkMilkLimitationChange, BreastStore.LACTATION_STRONG);
        }
        if (doneHighLactation && breasts.preventLactationIncrease != BreastStore.LACTATION_HEAVY)
        {
            addButton(3, "Heavy", talkMilkLimitationChange, BreastStore.LACTATION_HEAVY);
        }
        if (breasts.preventLactationIncrease != 0)
        {
            addButton(4, "Unlimited", talkMilkLimitationChange, 0);
        }
    ...
    private function talkMilkLimitationChange(newLimit : Int) : Void
    {
        ...
        {
            breasts.preventLactationIncrease = BreastStore.LACTATION_MODERATE;
        }
        else
        {
            breasts.preventLactationIncrease = newLimit;
        }
        switch (newLimit)
        {
    ...
    private function takeKathHome() : Void
    ...
    private function takeKathToTheBar() : Void
    ...
    public function dateKathBath() : Void
    {
        ...
        {
            outputText(((isAt(KLOC_KATHS_APT)) ? "She jumps up off the bed" : "She sucks up the last of her drink and hops out of her seat") + " in a way that causes her breasts to bounce.  She");
        }
    ...
    private function katherinesAppearance(clear : Bool = true) : Void
    {
        if (clear)
        {
            clearOutput();
        ...
        if (furry)
        {
            ...
            {
                outputText("Her fur is black, but");
            }
        }
        else
        {
            outputText("girl, standing maybe 5' 2\" tall.  She has a pair of cat ears and a tail, both covered in black fur.  Her skin is milky white and");
        }
        ...
        var _sw13_ = (flags[kFLAGS.KATHERINE_CLOTHES_WORN]);        
        ...
        switch (_sw13_)
        {
            ...
            case KBIT_CLOTHES_C_CLOTH:  //Blouse and Skirt  
            outputText("  Before you can even ask she begins to strip off her clothes to give you a better look");
            case KBIT_CLOTHES_BODYSUIT:  //Bodysuit  
            outputText("  As you watch she begins to wiggle out of the bodysuit in the sexiest way possible");
            case KBIT_CLOTHES_B_DRESS:  //Elegant Long Dress  
            outputText("  She teases you by slowly undoing each button in turn before stepping out of the dress");
            case KBIT_CLOTHES_SS_ROBE:  //Spider Silk Robe  
            outputText("  Kath smiles and steps out of the robes, leaving them to crumple to the floor while she strips off her underwear and poses her naked body for you");
            case KBIT_CLOTHES_TUBETOP:  //Tube Top  
            outputText("  Before you can even ask she begins to peel off her clothes to give you a better look");
            case KBIT_CLOTHES_NURSECL:  //Nurse’s Outfit  
            outputText("  Before you can even ask Kath unbuttons the tight top and slides off her skirt to give you a better look");
            default:  //Tattered Clothes  
        ...
        if (hasCock())
        {
            ...
            {
                outputText("A pair of " + ballSize + "\" wide balls sway below her cock" + cockMultiple("", "s") + ", hanging just above");
            }
        }
        else
        {
            outputText(" and between her legs rests");
        }
    ...
    private function giveKatherineAnItem() : Void
    {
        ...
        var hasJob : Bool = flags[kFLAGS.KATHERINE_UNLOCKED] >= 4;
        menu();
    ...
    {
        var hasJob : Bool = flags[kFLAGS.KATHERINE_UNLOCKED] >= 4;
        var honey : Bool = player.hasItem(consumables.BEEHONY) || player.hasItem(consumables.PURHONY);
        var pinkEgg : Bool = player.hasItem(consumables.PINKEGG) || player.hasItem(consumables.L_PNKEG);
        var button : Int = 0;
        menu();
        ...
        if (hasJob)
        {
            if (furry)
            {
                addButtonIfTrue(button++, "Defur", giveKatDefurFormula, "Req. purified suc. milk, a golden seed and a black egg.", 
            ...
            {
                addButtonIfTrue(button++, "Refuzz", giveKatRefuzzFormula, "Req. any honey, a whisker fruit, hair ext. serum.", 
        ...
        {
            addButtonDisabled(button++, "???", "She doesn't have a job!");
        }
    ...
    private function giveDyes() : Void
    {
        var button : Int = 0;
        menu();
        if (hairColor != "rich auburn")
        {
            addButtonIfTrue(button++, "Auburn Dye", giveKatDyeAuburn, "", player.hasItem(consumables.AUBURND));
        }
        if (hairColor != "jet black")
        {
            addButtonIfTrue(button++, "Black Dye", giveKatDyeBlack, "", player.hasItem(consumables.BLACK_D));
        }
        if (hairColor != "light blonde")
        {
            addButtonIfTrue(button++, "Blonde Dye", giveKatDyeBlonde, "", player.hasItem(consumables.BLOND_D));
        }
        if (hairColor != "bright blue")
        {
            addButtonIfTrue(button++, "Blue Dye", giveKatDyeBlue, "", player.hasItem(consumables.BLUEDYE));
        }
        if (hairColor != "lime green")
        {
            addButtonIfTrue(button++, "Green Dye", giveKatDyeGreen, "", player.hasItem(consumables.GREEN_D));
        }
        if (hairColor != "vibrant orange")
        {
            addButtonIfTrue(button++, "Orange Dye", giveKatDyeOrange, "", player.hasItem(consumables.ORANGDY));
        }
        if (hairColor != "neon pink")
        {
            addButtonIfTrue(button++, "Pink Dye", giveKatDyePink, "", player.hasItem(consumables.PINKDYE));
        }
        if (hairColor != "deep purple")
        {
            addButtonIfTrue(button++, "Purple Dye", giveKatDyePurple, "", player.hasItem(consumables.PURPDYE));
        }
        if (hairColor != "flaming red")
        {
            addButtonIfTrue(button++, "Red Dye", giveKatDyeRed, "", player.hasItem(consumables.RED_DYE));
        }
        if (hairColor != "snow white")
        {
            addButtonIfTrue(button++, "White Dye", giveKatDyeWhite, "", player.hasItem(consumables.WHITEDY));
        }
        addButton(14, "Back", giveKatherineAnItem);
    }
    ...
    private function giveClothes() : Void
    {
        ...
        {
            addButtonIfTrue(button++, "Bodysuit", giveKatClothesBodysuit, "", player.hasItem(armors.T_BSUIT));
        }
        if (!hasClothing(KBIT_CLOTHES_B_DRESS))
        {
            addButtonIfTrue(button++, "Long Dress", giveKatClothesLongDress, "", player.hasItem(armors.B_DRESS));
        }
        if (!hasClothing(KBIT_CLOTHES_NURSECL))
        {
            addButtonIfTrue(button++, "NurseClothes", giveKatClothesNurseOutfit, "", player.hasItem(armors.NURSECL));
        }
        if (!hasClothing(KBIT_CLOTHES_SS_ROBE))
        {
            addButtonIfTrue(button++, "Silk Robe", giveKatClothesSilkRobe, "", player.hasItem(armors.SS_ROBE));
        }
        if (!hasClothing(KBIT_CLOTHES_TUBETOP))
        {
            addButtonIfTrue(button++, "Tube Top", giveKatClothesTubeTop, "", player.hasItem(armors.TUBETOP));
        }
        addButton(14, "Back", giveKatherineAnItem);
    }
    ...
    private function useReductoOnKat() : Void
    {
        ...
        //If min size on all Kat parts reached:{
            ...
            {
                outputText("  Or rather, I should say I don't want to get any smaller than I am now, thank you.</i>\"\n\nYou nod in understanding and put the jar away.  ");
            }
        ...
        else
        {
            ...
            if (player.lib > 50)
            {
                outputText(" with a salacious grin");
            }
            ...
            {
                outputText("and wondering how to begin.");
            }
    ...
    private function useRedoctoOnKatsKnot() : Void
    {
        ...
        {
            outputText("her " + cockType() + " cock, and rubbing one finger across the exposed tip.  The cat wriggles and squirms, and quickly blooms under your care, until all " + cockLength + " inches of her shaft is exposed.  Knot just barely visible as a bulge at the base of her cock, you start to stroke it next.  Katherine coos and moans as your fingers glide up and down, and the responsive flesh starts to swell like a red, hard balloon.  It puffs up and up, swelling to full size, " + knotSize + " inches in diameter.  With the subject prepared, you stop, leaving Katherine hovering at the edge of release.\n\n");
        }
        ...
        if (cockNumber > 1)
        {
            ...
            if (player.lib > 50)
            {
                outputText("joyously attempt to catch in your mouth like rain");
            }
            else
            {
                outputText("narrowly dodge in surprise");
            }
    ...
    private function useReductoOnKatsKock() : Void
    {
        ...
        if (player.lib > 50)
        {
            outputText("allow her to continue until " + ((ballSize > 0) ? "her scrotum tightens up and " : "") + "it looks like she'll blow her load with one more touch, and then ");
        }
        ...
        if (player.lib > 50)
        {
            outputText(", then quivers again as the movement brings her a hair closer to her climax");
        }
        outputText(".\n\n");
        ...
        if (player.lib > 50)
        {
            outputText("staring at Katherine with a lewd smirk as she trembles and tries to maintain control, ");
        }
        ...
        if (player.lib > 50)
        {
            outputText("still pushing out the aftershocks of her climax onto her belly, ");
        }
    ...
    private function reductoBallSize() : Void
    {
        ...
        if (isAt(KLOC_STREETS))
        {
            outputText("With a little help from you, she " + clothesLowerChoice("wriggles out of her shorts", "strips off her panties and raises her skirt", "strips off her bodysuit", "strips off her panties and raises her skirt", "unties her robe") + ", exposing her swollen testes.  ");
        }
    ...
    private function useRreductoOnKatsBreasts() : Void
    {
        ...
        if (breasts.lactating())
        {
            ...
            {
                outputText("Drops of cream fall from her newly shrunken bosom, leaving little trails on her chest.");
            }
        }
        breasts.cupSize--;
        ...
        {
            outputText("\"<i>Yes, I think I’ll get used to these smaller sweater puppies pretty quickly.</i>\"");
        }
    ...
    {
        clearOutput();
        var kathSubEnough : Bool = submissiveness() >= 4 || (submissiveness() >= 2 && flags[kFLAGS.KATHERINE_URTA_TIMES_SEX] > 0);  //May as well test this just once  
        if (!hasCock())
        {
        ...
        else if (cockLength < 16)
        {
            ...
            if (!hasDogCock())
            {
                ...
                {
                    outputText("At the same time it stretches outwards, absorbing its barbs.  In a few moments Kath is once again sporting a " + cockAdj() + " canine cock.  ");
                }
                flags[kFLAGS.KATHERINE_DICK_FORM] = 0;
            }
    ...
    private function giveKatDefurFormula() : Void
    {
        ...
        else
        {
            ...
            {
                outputText("You work to hide how much this is turning you on.  You’re going to get this sweet little kitty to change what she <b>is</b>.  Her own family isn’t going to recognize her and the silly bitch is doing it for ‘luv’.");
            }
        }
    ...
    //Kath can now regrow her knot. At first she’s willing to regrow it to 4", at submissiveness 1 she //will regrow it to its original 6" size.
    {
        ...
        //Original size - it won’t grow any further{
            ...
            else
            {
                ...
                {
                    outputText("Her cock stretches outwards, absorbing its barbs and getting fatter along its whole length.  In a few moments Kath is once again sporting a " + cockAdj() + " canine cock.");
                }
                flags[kFLAGS.KATHERINE_DICK_FORM] = 0;
            }
            dynStats("lus", 10 + player.lib / 20, "scale", false);
        ...
        //Need submissiveness 1+ to grow{
            ...
            outputText("She tries to give the pepper back but you close your hand around hers and tell her to concentrate on the good memories.  She knows you won’t think she’s ugly.  The two of you got along just fine when she had a massive knot.  In a way it’s what brought you two together." + ((flags[kFLAGS.KATHERINE_URTA_AFFECTION > 10] != null) ? "  Besides, wouldn’t it be fun to share it with Urta?" : "") + "\n\n");
            if (submissiveness() < 1)
            {
        ...
        if (cockNumber == 1)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    addSubmissive(KBIT_SUB_REM_COCK);
                }
    ...
    {
        clearOutput();
        var kathSubEnough : Bool = submissiveness() >= 2;
        ...
        //She’s willing to go up to big DD-Cup normally{
            ...
            {
                outputText("I suppose I could try it.  If it’s been purified then there’s no harm in it, right?");
            }
            outputText("</i>\"\n\n");
        ...
        else if (breasts.cupSize < BreastCup.EE && kathSubEnough)
    ...
    private function giveKatTheGiftOFMilk() : Void
    {
        ...
        //Always willing to go up to moderate{
            ...
            else
            {
                ...
                breasts.lactationLevel = BreastStore.LACTATION_NONE;
            }
            ...
            if (breasts.lactationLevel == BreastStore.LACTATION_LIGHT && breasts.preventLactationIncrease == BreastStore.LACTATION_LIGHT)
            {
                breasts.preventLactationIncrease = 0;
            }
            //You're handing her the Lactaid, so obviously you want more milk
            if (!doneSubmissive(KBIT_SUB_HIGH_LACTATION))
            {
                breasts.preventLactationIncrease = BreastStore.LACTATION_MODERATE;
            }
        ...
        {
            var _sw14_ = (breasts.lactationLevel);            

            switch (_sw14_)
            {  //You're handing her the Lactaid, so obviously you want more milk regardless of what you said previously  
                case BreastStore.LACTATION_MODERATE:if (breasts.preventLactationIncrease == BreastStore.LACTATION_MODERATE)
                    {
                        breasts.preventLactationIncrease = 0;
                    }
                case BreastStore.LACTATION_STRONG:if (breasts.preventLactationIncrease == BreastStore.LACTATION_STRONG)
                    {
                        breasts.preventLactationIncrease = 0;
                    }
                case BreastStore.LACTATION_HEAVY:if (breasts.preventLactationIncrease == BreastStore.LACTATION_HEAVY)
                    {
                        breasts.preventLactationIncrease = 0;
                    }
            }
    ...
    private function giveKatRefuzzFormulaChange() : Void
    {
        ...
        if (hasCock())
        {
            outputText(((hasBalls()) ? "balls are" : "prostate's") + " empty and my ");
        }
    ...
    private function useReductoAndPinkEgg() : Void
    {
        ...
        else
        {
            ...
            if (!doneSubmissive(KBIT_SUB_REM_BALLS))
            {
                outputText("I really wasn’t sure, but I guess you were right.  ");
            }
    ...
    private function giveKatWhiskerFruit() : Void
    {
        ...
        {
            outputText("her nipples have grow as hard as diamonds.\n\n");
        }
        ...
        var doneBefore : Bool = doneSubmissive(KBIT_SUB_CAT_DICK);
        ...
        if (submissiveness() >= 1)
        {
            ...
            if (!doneBefore)
            {
                outputText("You remind her that eating any kind of pepper could give her a canine cock again.  ");
            }
            ...
            if (!doneBefore)
            {
                outputText("  Doesn’t she want to try out a kitty cock?  See what sex is like with the cock nature intended her to have?");
            }
    ...
    private function giveKatClothesBodysuit() : Void
    {
        ...
        if (hasCock())
        {
            outputText("A bulge begins to form between her legs.  ");
        }
        ...
        {
            outputText("pussy lips");
        }
        outputText(" but it’s so taut that it outlines every detail" + ((hasCock()) ? "" : ", giving her a highly visible cameltoe") + ".\n\n");
        if (hasCock())
        {
            outputText("Trapped against her body the bulge grows higher and higher, the " + ((pregSize() > 5) ? "tips climbing the curve of her pregnant belly" : "rising tip" + cockMultiple("", "s") + " getting nearer and nearer to her breasts") + ".  ");
        }
    ...
    private function giveKatClothesNurseOutfit() : Void
    {
        ...
        {
            outputText("\"<i>I’m sorry " + playerText() + ", but there’s just no way.  It wouldn’t even cover me when I’m soft.  I think I’ll wear the skirt I’ve already got with this.  Otherwise I’ll expose myself with every step.</i>\"\n\n");
        }
        ...
        {
            outputText("clothes, fetches her skirt from the wardrobe and then puts on all the pieces of her new outfit");
        }
    ...
    private function giveKatClothesRobeWear() : Void
    {
        ...
        {
            outputText("she begins to press her crotch against " + ((player.isNaga()) ? "the front of your tail" : "your legs"));
        }
    ...
    private function giveKatClothesTubeTop() : Void
    {
        ...
        {
            outputText(((flags[kFLAGS.KATHERINE_CLOTHES_WORN] == KBIT_CLOTHES_C_CLOTH) ? "blouse" : "clothes, quickly slips on her knee length skirt") + " and then struggles with the tube top.  When it’s finally on right she starts posing in the mirror, her " + breasts.adj() + " breasts on display in the stretchy, clingy fabric.");
        }
    ...
    private function giveKatDyeBlack() : Void
    {
        ...
        if (furry)
        {
            ...
            {
                outputText("Katherine sinks back into your arms and says, \"<i>I love you so much " + playerText() + ",</i>\" in a deep, happy purr.");
            }
            katSexMenu();
        }
        else
    ...
    private function katSexMenu() : Void
    {
        ...
        if (!isAt(KLOC_BAR_DRUNK))
        
        //If she's drunk she wants sex, not suckling{
        ...
        if (isAt(KLOC_KATHS_APT))
        {
            if (hasAlready(KBIT_TRIED_BEDROOM_BONDAGE))
            {
                addButton(3, "Bed Bondage", bedroomBondage);
            }
            else
            {
                addButtonIfTrue(7, "Bed Bondage", bedroomBondage, "Req. 40 gems.", player.gems >= 40);
            }
        }
        else
        {
            addButtonDisabled(7, "???", "Impossible to do here.");
        }
        //Bar scenes
        ...
        //Urta{
            ...
            {
                addButtonDisabled(8, "???", "You have yet to discover this one.");
            }
            //Vala
            ...
            {
                addButtonDisabled(9, "???", "You have yet to discover this one.");
            }
        }
        else
        {
    ...
    //Scene can happen in the streets, at Kath's apartment or at the lake
    {
        ...
        var x : Float = player.cockThatFits(70);
        clearOutput();
        ...
        {
            outputText((hasBalls()) ? "her balls" : "her thighs");
        }
        outputText(".\n\n");
        ...
        if (player.hasVagina())
        {
            outputText("Your " + vaginaDescript() + " releases its own girl-cum in sympathy, even as y");
        }
        else
        {
            outputText("Y");
        ...
        if (player.cumQ() >= 1500)
        {
            outputText("  Her belly puffs up and out, swelling like an advancing pregnancy, until finally you have finished, leaving her with a barrel-sized balloon of a gut, cum audibly sloshing inside her as her motions churn the liquid.");
        }
        ...
        if (player.cumQ() >= 1500)
        {
            outputText(" - though, honestly, you may not give me much of a choice - ");
        }
    ...
    //Scene can happen in the streets, at Kath's apartment or at the lake
    {
        ...
        {
            outputText("Her eyes widen and she swallows hard, then she nods.  \"<i>O-Okay... if you're into that sort of thing...</i>\"");
        }
        ...
        {
            outputText(catGirl("with inviting pale flesh", "in luxurious-looking fur"));
        }
        ...
        {
            outputText("it's so good back there... so hard, so hot!  Fuck me, fuck me like an animal!</i>\" she screams, starting to jerk her hips, mock-humping");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText(" until her belly begins to bulge from all you've dumped in her");
        }
        if (player.cumQ() >= 1500)
        {
            outputText(", swelling out and out until she looks like she could give birth soon and a part of you wonders if maybe she's going to start spouting your cum from her mouth");
        }
        ...
        if (player.cumQ() >= 1500)
        {
            outputText(", absently cradling her distended belly");
        }
        ...
        if (player.cumQ() >= 1500)
        {
            outputText("  She looks at her gut and shakes her head in disbelief.  \"<i>Sheesh... if they ever figure out a way to let folks get pregnant by taking it up the ass, you're gonna knock up every damn person you meet, aren't you, stud?</i>\"");
        }
        ...
        else
        {
            ...
            if (player.cumQ() >= 1500)
            {
                outputText(" and it will be even longer for Katherine thanks to her sperm stuffed colon.  Still, judging how Kath holds you tight on the trip back to Tel’Adre you don’t think she’d have it any other way");
            }
            outputText(".");
        }
        //lust -100, Player returns to Tel'Adre Menu Screen or to camp, if code insists on it
    ...
    //Scene can happen in the streets, at Kath's apartment or at the lake
    {
        ...
        {
            outputText("Both Kath's holes attempt to crush your cocks, her inner folds pulsing and squeezing in a very pleasant way");
        }
        ...
        var wombShot : Bool = player.cocks[x].cockLength > 14 && pregSize() == 0;  //Only available if you’re huge and she doesn’t have a bun in the oven  
        if (wombShot)
        {
        ...
        {
            outputText(" while at the same time your other cock" + ((player.cocks.length > 3) ? "s " : " ") + ((hasCock()) ? ((player.cocks.length > 3) ? "add" : "adds") + " to the" : "create a") + " mess beneath her");
        }
        if (player.cumQ() < 500)
        {
        ...
        else
        {
            ...
            if (wombShot)
            {
                if (doneSubmissive(KBIT_SUB_HIGH_CUM))
                ...
                if (player.cor >= 75 - player.corruptionTolerance || (player.hasPerk(PerkLib.Pervert) && player.cor >= 33 - player.corruptionTolerance) || player.hasPerk(PerkLib.Sadist))
    ...
    {
        clearOutput();
        var firstTime : Bool = !doneSubmissive(KBIT_SUB_HIGH_CUM);
        if (firstTime)
        {
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        {
            outputText("Recalling how you helped the poor herm shrink down her monster knot" + cockMultiple("", "s") + ", and remembering the flexibility of the cats you've seen, you find a very kinky idea coming to you.  You ask Katherine if she'd be willing to try a suck 'n fuck.\n\n\"<i>Excuse me?</i>\" she asks, raising an eyebrow.  You quickly explain the idea: that you penetrate her vagina at the same time that she performs oral sex on her own cock, at which her eyes light up.  \"<i>Sounds kinky - but also genius!  Sure, I'm game.</i>\"");
        }
        ...
        {
            outputText("  The sight is enough to make your spine wince in sympathy.");
        }
        //(player has Feline Flexibility:
        else
        {
            outputText("  You watch how she does it, resolving to test your body and see if you can bend like that.");
        }
        ...
        var kathCum : Float = cumQ();
        var playerCum : Float = player.cumQ();
        if (kathCum <= 500)
        {
        ...
        {
            outputText("With a frantic look she swallows and swallows, and you can't help the frightening thought she may drown in her own spunk.  But, as her belly swells and she looks verifiably pregnant, her balls stop trembling and she's done, panting and taking deep, grateful breathes through her nose.");
        }
        outputText("\n\n");
        ...
        else if (playerCum <= 750)
        {
            ...
            {
                outputText("  She looks heavily pregnant by the time you are done, her bellybutton beginning to brush against her chin.");
            }
        }
        else if (kathCum <= 500)
        {
        ...
        if (playerCum > 250)
        {
            outputText(", allowing a cascade of jism to flow like a perverse waterfall in miniature from her cunt,");
        }
    ...
    private function letKatKnotYouCommonDialogue(inAlleyBehindBar : Bool) : Void
    {
        if (inAlleyBehindBar)
        {
        ...
        var hasPenetrated : Bool = hasAlready(KBIT_TRIED_GIVE_VAGINAL | KBIT_TRIED_GIVE_ANAL | KBIT_TRIED_GIVE_DOUBLE_PEN | KBIT_TRIED_GIVE_SUCK_N_FUCK);
        ...
        {
            outputText(" had " + cockMultiple("a dog dick", "dog dicks") + " for a long time");
        }
        outputText(", so I'm just doing it the way nature intended,</i>\" she cracks.");
        //(if player has anus & vagina:
        if (player.hasVagina())
        {
            outputText("  \"<i>So, which hole do you want me to use?</i>\"");
        }
    }
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        var cunt : Float = player.vaginas[0].vaginalLooseness;
        ...
        if (cockNumber > 1)
        {
            outputText(", her second cock still slapping wetly against you and smearing trickles of pre-cum that stretch and dangle as it bounces");
        }
        ...
        {
            outputText("  Mmm... yeah, that's it, moan for me, you little slut; who's the alpha, huh?  Katherine's your alpha - go on, say it!</i>\" she yells, pounding herself into you with greater force, her claws extending just far enough to begin biting into your flesh, pinpricks of pain to counter the pleasure.");
        }
        else
        {
            outputText("</i>\"");
        ...
        if (cunt < player.vaginas[0].vaginalLooseness)
        {
            outputText("  The amount of swollen cockmeat she's stuffing inside you is on the border of being painful, but mostly it's pleasure that fills you.");
        }
        else
        {
            outputText("  Thanks to the glovelike fit your pussy has on her knot, it feels nothing but good to be plugged up like this.");
        }
        outputText("\n\n");
        ...
        if (player.hasCock())
        {
            ...
            {
                outputText("a veritable lake of spunk " + ((isAt(KLOC_KATHS_APT)) ? "onto the bed" : "into the alleyway"));
            }
        }
        outputText(".\n\n");
        ...
        if (cockNumber > 1)
        {
            outputText(", with more spurting from her second cock to glaze your belly and the " + ((isAt(KLOC_KATHS_APT)) ? "sheets" : "ground") + " below");
        }
        outputText(".  ");
        ...
        else
        {
            ...
            {
                outputText("some of it actually starts leaking out around her knot.");
            }
        }
        ...
        if (player.vaginalCapacity() < 100)
        {
            outputText("About an hour later, she's deflated and y");
        }
        else
        {
            outputText("Y");
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        var butts : Float = player.ass.analLooseness;
        player.buttChange(cockArea(), true, true, false);
        outputText("\n\n");
        
        if (butts > player.ass.analLooseness)
        {
            outputText("You can't help but yelp in shock and look back over your shoulder at Katherine, who appears genuinely apologetic.  \"<i>Sorry!  But I need to penetrate sooner rather than later - or would you rather wait until my knot's fully swollen?</i>\"  You concede she has a point, but beg her to be more gentle if there's a next time.\n\n");
        }
        ...
        {
            outputText("Thanks to her relatively normal-sized knot, it feels nothing but good to be plugged up like this.");
        }
        outputText("\n\n");
        ...
        if (player.hasVagina())
        {
            outputText(", femcum splashing from your " + vaginaDescript());
        }
        ...
        if (cockNumber > 1)
        {
            outputText(", with more spurting from her second cock to glaze your back and drool off onto the " + ((isAt(KLOC_KATHS_APT)) ? "sheets" : "ground") + " below you");
        }
        outputText(".  ");
        //These cum volumes were previously based on Kath's ball size
        if (cumQ() <= 500)
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        clearOutput();
        var doneBefore : Bool = hasAlready(KBIT_TRIED_GIVE_DOUBLE_PEN);
        ...
        else
        {
            ...
            if (knotSize >= 6)
            {
                outputText("only her huge knots are keeping everything plugged inside you.");
            }
            else
            {
                outputText("some of it actually starts leaking out around her knots.");
            }
        }
        ...
        if (cumQ() > 500)
        {
            outputText("  Her cum sloshes fluidly inside you, adding to the sensations assaulting your cervix and bowels.");
        }
        outputText("\n\n");
        ...
        if (cumQ() > 1500)
        {
            outputText(" to its limit");
        }
        outputText(" as she fills you with a smaller, second load of jizz.");
        if (player.hasCock())
        {
            outputText("  " + SMultiCockDesc() + ((player.cocks.length > 1) ? " celebrate with arcs of their" : " celebrates with arcs of its") + " own semen, spraying them in a patter on her legs and the ground in front of you.");
        }
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        clearOutput();
        var doneBefore : Bool = hasAlready(KBIT_TRIED_GIVE_SUCK_N_FUCK);
        ...
        {
            outputText("between your asscheeks");
        }
        ...
        {
            outputText(player.assholeOrPussy());
        }
        ...
        if (player.hasVagina() && cockNumber > 1)
        {
            outputText("s");
        }
        ...
        if (player.hasBalls())
        {
            outputText("in your " + ballsDescriptLight());
        }
        else
        {
            outputText("at the base of your spine");
        }
        outputText("...\n\n");
        ...
        if (cumQ() > 500)
        {
            outputText(" and it doesn't stop, growing and growing until you look pregnant and ready to deliver");
        }
        if (cumQ() > 1500)
        {
            outputText(" and her " + ((hasBalls()) ? "swollen balls keep on going; by the time they finally run" : "massive prostate keeps on going; by the time it finally runs") + " dry, your belly is so heavy with deposited cum that you look like you're having triplets");
        }
        ...
        if (cumQ() <= 500)
        {
            if (player.cumQ() <= 250)
            {
                outputText(" leaving you lying belly-to-belly");
            }
            else
            {
                outputText(" her cum-bloated belly squishing audibly against your own flat torso");
            }
        }
        else if (player.cumQ() <= 250)
        {
            outputText(" making your cum-swollen gut squelch wetly from the pressure");
        }
        else
        {
            outputText(" your mutually swollen bellies churning and rippling as they cushion the impact");
        }
    ...
    //Scene can happen in the streets, at Kath's apartment or in the Desert
    {
        ...
        clearOutput();
        var doneBefore : Bool = hasAlready(KBIT_TRIED_RECEIVE_ORAL);
        ...
        {
            outputText("\"<i>But... [name], are you sure?  I mean, with the knot" + cockMultiple("", "s... I mean, now that I have two cocks") + ", that's a lot to work with...  And I don't want to leave you with nothing, either...</i>\"\n\n");
        }
        ...
        if (isAt(KLOC_KATHS_APT))
        {
            ...
            {
                outputText("the edge of her bed");
            }
            //Non-centaurs who are 8'6 or shorter
            else
            {
                outputText("top of her dresser");
            }
        }
        else if (isAt(KLOC_DESERT))
        {
            ...
            if (!player.isTaur() && player.tallness < 102)
            {
                outputText("on top of a large sand dune");
            }
            //Non-centaurs who are 8'6 or shorter
            else
            {
                outputText("near the top of a small sand dune");
            }
        }
        //Alleyway
        else
        {
            ...
            if (!player.isTaur() && player.tallness < 102)
            {
                outputText("empty crate");
            }
            //Non-centaurs who are 8'6 or shorter
            else
            {
                outputText("broad stone wall");
            }
        }
        ...
        if (cockNumber == 1)
        {
            ...
            if (player.cor >= 70)
            {
                outputText(" - if only to prove your skill and make the kitten ever more dependent on you for release");
            }
            outputText(".\n\n");
            ...
            {
                outputText("Your hand remains in her pussy, however, adding to the multiple ways with which you please your lover.\n\n");
            }
            
            outputText("After a while of slurping on her cock and ");
            if (player.tongue.type == Tongue.SNAKE)
            {
                outputText("molesting her clit with your tongue");
            }
            else if (player.hasLongTongue())
            {
                outputText("penetrating her with your tongue as you give her head");
            }
            else
            {
                outputText("fingering her");
            }
            if (!hasBalls())
            {
            ...
            else
            {
                ...
                else
                {
                    if (ballSize <= 1)
                    {
                        outputText("You find it pretty easy to slip your tongue out further and gently lick her clit almost all the time while you're doing it.");
                    }
                    else if (ballSize <= 2)
                    {
                        outputText("You can sometimes reach her pussy while toying with her balls, teasing it with your tongue.");
                    }
                    else
                    {
                        outputText("You hoped to play with her pussy too, but the cat-girl's balls are too sizeable to do so with your tongue.  You can almost feel, maybe even hear the semen sloshing inside the big things, ready to shoot out any second.");
                    }
            ...
            if (player.tongue.type == Tongue.SNAKE)
            {
                ...
                if (knotSize >= 6)
                {
                    outputText("  Regrettably, the cat-girl's bulging knot makes it a lot harder to please her pussy with your long tongue in this position than you'd hoped, and you have to give it up once she's completely swollen.");
                }
                //([Player has a naga tail]
                if (player.isNaga())
                {
                    outputText("  You decide to play the part of the snake to the very end and, not content to leave her pussy unattended, you slip the tip of your long tail inside her.  She groans in ecstasy, finally reaching orgasm.");
                }
                else
                {
                    outputText("  Not content to let her pussy remain unattended, you slip two of your fingers inside her while teasing her clit with your knuckle.  She seems greatly pleased at your attention, as she shivers in orgasm moments afterwards.");
                }
                ...
                if (cumQ() <= 500)
                {
                    outputText("its quite a large amount given " + ((hasBalls()) ? "the size of her balls" : "that she doesn't have testicles") + ", substituting for a decent warm drink at least.");
                }
                else if (cumQ() <= 1500)
                {
                    outputText("you can feel thick, generous ropes of her jizz flow into your mouth and down your throat between smaller trickles.  Her orgasm is rather intense and leaves you quite full.");
                }
                else
                {
                    outputText(((hasBalls()) ? "as suggested by the size of her testicles," : "her prostate must have been working overtime, as") + " Katherine cums - a lot.  Wave after wave of semen gushes down your throat, filling your belly to the point of stretching.");
                }
            ...
            else if (player.hasLongTongue())
            {
                ...
                if (knotSize >= 6)
                {
                    outputText(", even making it hard for you to keep your tongue buried all the way inside");
                }
                outputText(".\n\n");
                ...
                if (cumQ() <= 500)
                {
                    outputText("She practically thrashes around in orgasm as you tease her " + ((hasBalls()) ? "balls" : "clit") + " with your tongue, your mouth milking her and devouring the cum she releases quite easily.");
                }
                else if (cumQ() <= 1500)
                {
                    outputText("Your tongue has no problems sliding across and teasing her " + ((hasBalls()) ? "balls" : "clit") + " as your mouth drinks her dick-milk.  There is quite a lot of it, but you don't complain.");
                }
                else
                {
                    outputText("Katherine's " + ((hasBalls()) ? "large testicles quiver on your tongue as they discharge their" : "prostate must have been working overtime to produce such a massive") + " load.  You can feel it seeping inside you, slightly stretching your belly as you struggle to swallow it all.");
                }
            ...
            else
            {
                ...
                if (cumQ() > 1500)
                {
                    outputText("  You can't help but giggle into the cat-girl's pussy as you feel her drench you with her seed, painting you white.");
                }
            }
        }
        //Double Cock Scene
        else
        {
            ...
            {
                outputText("  Said tongue wraps around one erection and then the other, stroking gently with its long, flexible length.");
            }
            outputText("\n\n");
            ...
            if (hasBalls())
            {
                ...
                if (player.tongue.type == Tongue.SNAKE || player.hasLongTongue())
                {
                    outputText("  Your long, flexible tongue once again slides out as you gently lift her testes up, easily dipping inside her wet pussy and stroking her inner walls as you suck.");
                }
            ...
            if (!player.hasLongTongue())
            {
                ...
                if (player.isNaga() || player.tailType == Tail.DEMONIC)
                {
                    outputText("  Wanting to grant her maximum stimulation and complete release, you slip the tip of your tail inside the cat-girl, feeling her pussy gratefully squeeze it.");
                }
                outputText("\n\n");
                ...
                if (cumQ() > 1500)
                {
                    outputText("  There's quite a lot of it, so you manage to get both a kinky bath and a decent warm drink.");
                }
            }
            else
            {
                ...
                if (cumQ() > 1500)
                {
                    outputText("  The two of you are liberally coated with her spunk, your stroking tongue unable to catch all of it as she shoots off.");
                }
            }
        }
        ...
        if (player.hasLongTongue())
        {
            outputText("She runs her fingers along your lips.  \"<i>I think I might be falling in love with the monster inside that pretty cave.</i>\"\n\n");
        }
        else
        {
            outputText("\"<i>I hope that if I ever get to repay the favor, I can do as well as you.</i>\"\n\n");
        }
    ...
    //This version assumes Kath has no cock
    {
        ...
        {
            outputText("You press your tongue against the underside of her clit and rock it from side to side, your tastebuds dragging against her most sensitive flesh.\n\n");
        }
    ...
    private function katherineLicksAllTheBoyPenises() : Void
    {
        ...
        if (player.balls == 0)
        {
            outputText("cock tingling");
        }
        else
        {
            outputText("balls tightening");
        }
        ...
        if (player.cumQ() <= 250)
        {
            outputText("  She drinks every last drop with relief, popping wetly off of your cock and licking her lips, audibly purring with delight.");
        }
        else if (player.cumQ() <= 600)
        {
            outputText("  She gulps it down desperately, stomach swelling with the influx of spunk, but manages to avoid spilling anything, popping her head free and gasping for breath as soon as she thinks you're done.");
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        {
            outputText("Then, recalling you have the same sort of sex arrangement, you feel a kinky idea coming on.  Gently, you ask if Katherine thinks she's flexible enough to use both her parts at the same time.");
        }
        ...
        else
        {
            ...
            if (player.isNaga())
            {
                outputText("curling your naga tail back");
            }
            else if (player.isGoo())
            {
                outputText("shifting your gooey blob");
            }
            else
            {
                outputText("lifting your [leg] up");
            }
        ...
        if (player.cumQ() <= 500)
        {
            outputText("You pay Katherine back in kind though, dumping your considerable load inside the eager cat and giving her a round belly of her own as you spurt thick gobs of semen inside her.");
        }
        //(PC High Cum Amount)
        else if (player.cumQ() <= 1500)
        {
            outputText("You pay Katherine back in kind though, dumping your massive load inside the eager cat, bloating her belly until she looks a few months pregnant and is unable to take any more cum.  Some of it flows back to splatter against you, pooling beneath both of you in a messy pool of hot white jism.");
        }
        //(PC Very High Cum Amount)
        else
        {
            outputText("You pay Katherine back in kind though, dumping your massive load inside the eager cat, bloating her belly until she looks a several months pregnant and is unable to take any more cum.  Some of it flows back to splatter against you, pooling beneath both of you in a messy pool of hot white jism.  Yet it doesn't seem likely to stop anytime soon; if it weren't for Katherine's knot you're pretty sure you'd have sent the cat rocketing straight off of your cock.  Katherine trembles and her pussy walls clench as if to hold more of your cum inside her, and indeed she inflates beyond her capacity for a while, until she relaxes and your load pours out of her.");
        }
        outputText("\n\n");
        ...
        if (cumQ() > 1500)
        {
            outputText(", and not because your swollen stomach is weighing you down, either");
        }
        ...
        if (player.hasBalls())
        {
            outputText(", and even licking your [balls] clean");
        }
        outputText(".  You moan and shudder and buck your hips at her ministrations; your ");
        if (player.hasBalls())
        {
            outputText("balls are still depleted");
        }
        else
        {
            outputText("cock is still almost totally empty");
        }
        ...
        if (player.isNaga() || player.tailType == Tail.DEMONIC)
        {
            outputText("the tip of your tail");
        }
        else
        {
    ...
    //Scene can happen in the streets, in a backroom at the bar or at Kath's apartment
    {
        ...
        if (breasts.lactationLevel == BreastStore.LACTATION_NONE)
        {
            ...
            if (!milkOption(KBIT_MILK_TOLD_PLAYER_SHES_DRY))
            {
                ...
                milkOptionSet(KBIT_MILK_TOLD_PLAYER_SHES_DRY);
            }
        ...
        if (player.cor < 25)
        {
            ...
            else if ((breasts.milkIsOverflowing() && breasts.lactationLevel >= BreastStore.LACTATION_STRONG) || (breasts.milkIsFull() && breasts.lactationLevel >= BreastStore.LACTATION_EPIC))
            {
                ...
                {
                    outputText("  Sure that you'll be unable to drink it all you switch to her other nipple before the first has run dry.");
                }
            }
            else
            {
            ...
            if (breasts.lactationLevel >= BreastStore.LACTATION_LIGHT)
            {
                player.refillHunger(breasts.lactationLevel * 15);
            }
        ...
        else
        {
            ...
            else if ((breasts.milkIsOverflowing() && breasts.lactationLevel >= BreastStore.LACTATION_STRONG) || (breasts.milkIsFull() && breasts.lactationLevel >= BreastStore.LACTATION_EPIC))
            {
                ...
                if (breasts.lactationLevel >= BreastStore.LACTATION_HEAVY)
                {
                    outputText("  You're pleased by Kath's milk production, her overactive mammaries hold more cream than you can handle.  You let the cream run from the corners of your mouth, draining every drop, encouraging Kath's breasts to keep up their good work.");
                }
            }
            else
            {
        ...
        var wasntLactating : Bool = breasts.lactationLevel == BreastStore.LACTATION_NONE;
        ...
        if (breasts.lactationLevel == BreastStore.LACTATION_NONE)
        {
            ...
            if (isAt(KLOC_KATHS_APT))
            {
                outputText("It doesn't take long before her head starts to droop and her whole body follows it toward the mattress.\n\n");
            }
        }
        else if (breasts.milkIsOverflowing())
        {
            ...
            if (isAt(KLOC_BAR) || isAt(KLOC_BAR_DRUNK) || isAt(KLOC_BAR_URTA_REFUSED))
            {
                ...
                {
                    outputText("  You leave her breasts exposed and shift her shoulders so her chest is on display for all to see.  You get a few appreciative smiles and some raised glasses as the patrons commit Kath's " + breasts.adj() + " breasts to memory.");
                }
        ...
        else if (breasts.milkIsFull())
        {
            ...
            if (!isAt(KLOC_KATHS_APT))
            {
                outputText("  After about a minute she remembers her modesty and covers herself up.\n\n");
            }
        }
        else
        {
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        if (!player.hasPerk(PerkLib.Feeder) && player.lactationQ() < 1000)
        {
            outputText("empties");
        }
        else
        {
            outputText("does her best to empty");
        }
        ...
        {
            outputText("so much of your seemingly inexhaustible supply of milk that she's physically incapable of drinking any more");
        }
        ...
        {
            outputText("  She is sporting an unmistakable milk-belly from all she's drunk.");
        }
        else if (player.lactationQ() < 2000)
        {
            outputText("  She looks almost pregnant with how much she's drunk, but she doesn't seem to care.");
        }
        else
        {
            outputText("  Katherine looks more like a balloon than a cat, her belly swollen hugely from her titanic liquid repast.  You can hear her stomach's contents sloshing softly around inside her when she moves and thusly jostles them.");
        }
    ...
    private function interveneWithKittyKats4() : Void
    {
        ...
        if (player.isBiped())
        {
            outputText("holding her tightly between your knees");
        }
        else if (player.isNaga())
        {
            outputText("your snake-like coils wraped around her");
        }
        else
        {
            outputText("holding her tightly");
        }
    ...
    private function helpKathAfterInterruptu() : Void
    {
        ...
        if (player.cor < 25)
        {
            outputText("You feel you just have to do something for her.  She needs food and she’s ashamed of her own body.  That’s rare in this land, but it’s not a good way to live your life.");
        }
        else if (player.cor < 75)
        {
            outputText("Right now she needs food, no question.  If you help her out maybe she’ll be more willing to talk to you in future.  Maybe you can become a friend to her, maybe more.");
        }
        else
        {
            outputText("You could take her here and now, but her ‘friends’ might come back and help her.  Or a member of the Watch might find you.  Better to play the long game with this very fuckable kitty.");
        }
    ...
    public function repeatAmbushKatherineRecruitMent() : Void
    {
        ...
        if (player.cor < 75)
        {
            outputText(" hope she’s here so you can get to know her better.");
        }
        else
        {
            if (player.hasCock() && player.hasVagina())
            {
                outputText("r dick swells and your pussy moistens");
            }
            else if (player.hasCock())
            {
                outputText("r dick swells");
            }
            else if (player.hasVagina())
            {
                outputText("r pussy moistens");
            }
            else
            {
                outputText("r sphincter twitches");
            }
    ...
    private function donateToCatSlutsYouCatSlutPt2() : Void
    {
        ...
        if (player.cor < 25)
        {
            outputText("You tell her that of course you want to.  She seems like a nice person, and you want to get to know her better.");
        }
        else if (player.cor < 75)
        {
            outputText("You say that yes, you would love to take her out on a date.  You don’t say that you’d like even more to press her vulnerable body against the wall and have your way with her.");
        }
        else
        {
            outputText("You promised yourself you’d play the long game with this pussy.  She already defers to you so quickly - with just a little work up front you could have a really submissive little fuck toy.");
        }
        //[Next]
    ...
    private function threatenCatSluts() : Void
    {
        ...
        if (player.cor < 25)
        {
            outputText("The poor girl is desperate for a friend.  You hope you can be a good enough person and help her out.");
        }
        else if (player.cor < 75)
        {
            outputText("It’s a real shame Katherine is so lonely.  She shouldn’t be willing to trust a virtual stranger like you, but here she is and here you are.");
        }
        else
        {
            outputText("You can’t wait to twist this submissive thing around your finger.  She’s got almost no one, and that means almost no one to tell her what a bad influence you will be.  With just a little work up front you could have a really submissive little fuck toy.");
        }
    ...
    //Scene can happen in the streets or at Kath's apartment
    {
        ...
        if (player.cor < 25)
        {
            outputText("slowly caress her tender breasts");
        }
        else if (player.cor < 75)
        {
            outputText("tease her lovely breasts");
        }
        else
        {
            outputText("roughly manhandle her knockers");
        }
        if (flags[kFLAGS.KATHERINE_UNLOCKED] > 0 && breasts.milkIsFull())
        {
            outputText(".  Your fingers are soon coated in her cream and you offer them to Kath, who eagerly licks them clean");
        }
        outputText(".  Her tail, trapped between your body and hers, flicks back and forth");
        if (player.hasCock())
        {
            outputText(", causing your [cocks] to rise to the occasion.");
        }
        else if (player.hasVagina())
        {
            outputText(", teasing your hot little slit.");
        }
        //(genderless)
        else
        {
            outputText("in a seductive manner.");
        }
        ...
        if (hasCock())
        {
            ...
            {
                outputText((isAt(KLOC_KATHS_APT)) ? "plaster" : "brickwork");
            }
        ...
        if (player.cor < 25)
        {
            outputText("You hold her in your arms while she recovers.  You really enjoy seeing the happiness and contentment in her face.");
        }
        else if (player.cor < 75)
        {
            outputText("While you wait for her to recover you pull her shirt up and play with her breasts a bit more.  By the time she can move again her nipples are sticking out like little berries.  She blushes, but clearly enjoys the attention.");
        }
        else
        {
            ...
            {
                outputText("Next you collect some of her femcum on your fingers");
            }
    ...
    private function firstTimeWithKatherinePartTwoUltraChampionshipEditionHyperTurbo() : Void
    {
        ...
        outputText("\n\n\"<i>[name]</i>\" she says");
        if (player.short == "Kath" || player.short == "Katherine" || player.short == "Helena" || player.short == "Evelyn" || player.short == "Oswald")
        {
            outputText(".  \"<i>Well isn’t that a coincidence! All right, ");
        }
        else
        {
            outputText(", rolling the foreign word around in her mouth. \"<i>Well, ");
        }
    ...
    public function bathTime() : Void
    {
        ...
        if (hasCock())
        {
            ...
            {
                outputText("between your " + ((player.isTaur()) ? "front " : "") + " legs");
            }
    ...
    private function bathTimeCentaurRide() : Void
    {
        ...
        {
            outputText("pussy growing wetter");
        }
        ...
        {
            outputText("thigh muscles tighten and her pussy releases a spray of hot femcum");
        }
        ...
        {
            outputText("  In fact she enjoyed this trip so much that you have a feeling these ‘baths’ will become quite popular.");
        }
        player.sexReward("no", "Dick");
        orgasm();
        flags[kFLAGS.KATHERINE_TIMES_SEXED]++;
    ...
    private function bathTimeCentaurPenetrated() : Void
    {
        ...
        {
            outputText("She waits until your legs begin to tremble before gently forcing her fingers deep into your [vagOrAss].\n\n");
        }
        ...
        if (hasCock())
        {
            ...
            else
            {
                ...
                if (cumQ() > 500)
                {
                    outputText("Your belly is soon pressed against the cool stream bed, inflated with your girlfriend’s cum." + ((cumQ() > 1500) ? "  It starts to get painful as Kath’s titanic orbs do their best to fill her mate.  Any more and you’re sure the muscles of your abdomen would give out." : ""));
                }
            }
            if (cockNumber > 1)
            {
                outputText("  Katherine’s other cock, still rubbing between your legs, releases its share of the load, coating your belly with a layer of her hot sperm.");
            }
        }
        ...
        {
            outputText((player.hasVagina()) ? "knucles grinding against the entrance to your womb" : "fingers flexing deep inside your colon");
        }
    ...
    private function bathTimeFrustrated() : Void
    ...
    private function bathTimePenetrated() : Void
    {
        ...
        function assF() : Void
        {
            ...
            if (hasDogCock())
            {
                ...
                if (cockNumber > 1)
                {
                    outputText(" while the other continues to grind " + ((player.isNaga()) ? "against your scales" : "between your legs"));
                }
            }
            //Feline cock
            else
            ...
            if (cumQ() > 500)
            {
                ...
                if (cumQ() > 1500)
                {
                    outputText("  It’s painful and it seems like it takes forever before you feel Kath’s cum starting to leak out around the sides of her shaft.");
                }
            }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            if (flags[kFLAGS.KATHERINE_UNLOCKED] >= 4 && (player.cor >= 75 - player.corruptionTolerance || (player.hasPerk(PerkLib.Pervert) && player.cor >= 33 - player.corruptionTolerance) || player.hasPerk(PerkLib.Sadist) || doneSubmissive(KBIT_SUB_ORGASM_DENIAL)))
            {
    ...
    //If this is the first time then the player needs to have at least 40 gems to buy stuff (10g per scarf)
    {
        ...
        {
            outputText("If Kath doesn’t already have a fetish for getting tied up like this you plan to give her one.\n\n");
        }
        ...
        {
            outputText("Kath just sighs.  Her pupils are fully dilated and you doubt you’re going to hear anything coherent from her until this is over.");
        }
        ...
        flags[kFLAGS.KATHERINE_TIMES_SEXED]++;
        if (!hasCock() && player.cockThatFits(70) < 0)
        ...
        {
            sceneHunter.selectGender(dickF, (hasCock() && player.hasVagina()) ? vagAssF : null, 
        ...
        function dickF() : Void
        {
            ...
            if (pregSize() == 0)
            {
                ...
                {
                    outputText("\"<i>Oh yes!  Fuck me!  Cum inside me, please!  I need it so bad,</i>\" she whines.");
                }
            }
            //Is pregnant
            else
            {
                ...
                {
                    outputText("\"<i>Oh " + playerText() + ", don’t stop now.  I need that cum.  I need your hot love inside me.</i>\"");
                }
            }
            ...
            else if (player.cumQ() <= 3000)
            {
                ...
                {
                    outputText("Since her womb is already filled with a child it’s her vagina that takes the brunt of it.  Before your eyes a small hard bulge forms just above her cock" + cockMultiple("", "s") + " as the upper end of her birth canal is forced wide open by the flood from your " + ((player.hasBalls()) ? "balls" : "prostate"));
                }
            ...
            else
            {
                ...
                if (pregSize() == 0)
                {
                    ...
                    {
                        outputText("You sink into her a bit further as the " + ((pcLen == 15) ? "tip" : "first " + (pcLen - 15) + " inches") + " of your cock slide into her womb");
                    }
        ...
        var vagAssF : Void->Void = function() : Void
        {
            var dPen : Bool = player.hasVagina() && cockNumber > 1;
            outputText("  You sit down astride Kath and ask her why she thinks you’re going to stop?  You’ve only just warmed her up.  Now she’s ready for the main course.  Her eyes go wide and she pulls at the scarves but there’s no escape.\n\n");
            ...
            {
                outputText("\"<i>" + playerText() + ", please don’t.  Not so soon.  I can’t cum anymore.  Just let me recover or my " + ((hasBalls()) ? "balls are" : "prostate is") + " going to turn inside out.</i>\"");
            }
    ...
    private function drunkFuck() : Void
    {
        ...
        if (!player.hasVagina())
        {
            outputText(" and yank her " + ((player.hasCock()) ? "fingers" : "fist") + " from your ass");
        }
        ...
        var dPen : Bool = cockNumber > 1 && player.hasVagina();
        if (dPen)
        {
        ...
        {
            outputText("All the nerves in your rectum start to fire and your sphincter spasms furiously, trying to expel the invader");
        }
        ...
        {
            sceneHunter.print("Check failed - not corrupt enough!");
        }
