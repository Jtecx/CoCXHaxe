...
class LustyDemons extends Monster
{
    
    override private function performCombatAction() : Void
    {
        var storeStr : Float = str;
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(weapons.PSWHIP, 5).add(weapons.SUCWHIP, 4).add(armors.NURSECL, 3).add(armors.BONSTRP, 2).add(consumables.IMPFOOD, 1);
