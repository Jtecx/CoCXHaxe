...
class Kelly extends AbstractFarmContent implements TimeAwareInterface
{
...
Every encounter raises corruption by 5, except the last one that raises corruption by 8. In order to achieve the last encounter your corruption level must not be lower than it was at the third encounter.*/
    ...
    public function timeChange() : Bool
    {
        ...
        {
            if (flags[kFLAGS.KELLY_REWARD_COOLDOWN] > 0 && model.time.days % 3 == 0)
            {
                flags[kFLAGS.KELLY_REWARD_COOLDOWN] = 0;
            }
            if (flags[kFLAGS.KELT_BREAK_LEVEL] >= 4)
            {
                flags[kFLAGS.KELLY_DISOBEYING_COUNTER]++;
            }
        }
    ...
    public function kellySprite() : Void
    {
        if (!pregnancy.isPregnant)
        {
            ...
            {
                spriteSelect(SpriteDb.s_kelly_brst);
            }
        }
        else if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0)
        {
            spriteSelect(SpriteDb.s_kelly_preg);
        }
        else
        {
            spriteSelect(SpriteDb.s_kelly_brst_preg);
        }
    }
    
    private function hasPinkEgg() : Bool
    {
    ...
    public function breakKeltGo() : Void
    {
        ...
        if (!player.isTaur())
        {
            outputText("pulling [eachCock] out of your [armor] and stroking yourself with your free hand");
        }
        else
        {
        ...
        if (!player.isTaur())
        {
            outputText("fully whip out your [cock biggest] and shove it between her busty tits and slowly start grinding");
        }
        else
        {
            outputText("step over her, shoving your [cock biggest] between her busty tits, grinding it through that smooth valley");
        }
        outputText(".");
        ...
        if (player.isTaur())
        {
            outputText("dance your hindlegs about in order to ");
        }
        ...
        if (player.isTaur())
        {
            outputText("step over her, moving your hips back and forth to thrust through her more-than-ample cleavage.");
        }
        else
        {
            outputText("grab her nipples and begin to thrust your pecker against her boob valley.");
        }
        ...
        //consume items for 1x scene.{
            ...
            else if (player.hasItem(consumables.SUCMILK, 15))
            {
    ...
    public function secondKeltBreaking() : Void
    {
        ...
        {
            doNext(defeatKellyNDBREAKHIM);
        }
    }
    
    
    //Defeat Him In Fight #1
    @:allow(classes.scenes.places.farm)
    private function defeatKellyNDBREAKHIM() : Void
    {
        clearOutput();
        if (!recalling)
        {
        ...
        {
            outputText("Kelt moans, mauling at his mantits in his lust before he realizes what's going on");
        }
        else
        {
            outputText("Kelt groans, slumping slightly from all the damage you've done to him");
        }
        ...
        //I'm counting slimes as being fast enough. Player.spe should also probably factor into this.{
        ...
        //(Silly:)
        if (silly() && SceneLib.amilyScene.amilyFollower() && SceneLib.amilyScene.amilyCorrupt())
        {
        ...
        if (player.isTaur())
        {
            outputText("push her underneath you towards");
        }
        else
        {
            outputText("pull her close to");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" and fondling your [balls] with great care");
        }
        ...
        if (player.isTaur())
        {
            outputText("your genitals and equine body back ");
        }
        ...
        //consume items for 1x scene.{
            ...
            else if (player.hasItem(consumables.SUCMILK, 10))
            {
                player.consumeItem(consumables.SUCMILK, 10);
            }
            else
    ...
    public function breakingKeltNumeroThree() : Void
    {
        ...
        if (!player.isTaur())
        {
            outputText(", sometimes with your [cock] -");
        }
        ...
        if (player.isTaur())
        {
            outputText("down, pushing her");
        }
        else
        {
            outputText("forward to grab one of her tits and grope it");
        }
        outputText(" convulsively as you feel your lust rise.  ");
        if (!player.isTaur())
        {
            outputText("Soon one breast isn't enough to contain your lust-driven energy and you reach for the other one with your free hand.  Your constant nipple-teasing has an effect on");
        }
        else
        {
            outputText("Soon, you cannot contain your lust, and you begin to buck against her hands, whinnying with delight.  The rigid, pulsing dick-flesh in her mouth has an effect on");
        }
        ...
        if (!player.isTaur())
        {
            outputText("You squeeze Kelly's boobs so harshly she screams in pain, and y");
        }
        else
        {
            outputText("Y");
    ...
    public function finalKeltBreaking() : Void
    {
        ...
        if (player.isTaur())
        {
            outputText("kneels down");
        }
        else
        {
            outputText("bends over");
        }
        ...
        if (player.hasBalls())
        {
            outputText("Her free hands moves down on your groin and caresses your [balls] with expert care and precision; obviously her previous experience in groping has had an effect on her current skills.  ");
        }
        ...
        if (player.isTaur())
        {
            outputText("back away");
        }
        else
        {
            outputText("push the centaur girl away");
        }
        ...
        if (!player.isTaur())
        {
            outputText("You grope her bountiful tits and pull them closer to you as you fuck them.  ");
        }
    ...
    @:allow(classes.scenes.places.farm)
    private function keltFucksShitUp() : Void
    {
        clearOutput();
    ...
    private function kellyAppearance() : Void
    {
        ...
        if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
        {
            outputText("  Beneath those, she has a second row of jiggly tits, just aching to be squeezed.");
        }
        if (pregnancy.isPregnant)
        {
            outputText("  Drops of milk often dribble from her tits, betraying her potent lactation.");
        }
        //[enter vagina text]
        outputText("\n\nKelly has a ");
        //[virgin]
        ...
        {
            outputText("pink pussy");
        }
        else
        {
            outputText("puffy, black mare-cunt");
        }
        ...
        if (flags[kFLAGS.KELLY_HEAT_TIME] > 0 && !pregnancy.isPregnant)
        {
            outputText("<b>  There is so much leaking from her that you think she might be in heat, rendering her more receptive to impregnation.</b>");
        }
        ...
        if (farm.farmCorruption.hasTattoo("kelly"))
        {
            ...
            {
                if (farm.farmCorruption.numTattoos("kelly") > 1)
                {
                ...
                if (flags[kFLAGS.KELLY_TATTOO_COLLARBONE] != 0)
                {
                    outputText(flags[kFLAGS.KELLY_TATTOO_COLLARBONE] + "\n");
                }
                if (flags[kFLAGS.KELLY_TATTOO_SHOULDERS] != 0)
                {
                    outputText(flags[kFLAGS.KELLY_TATTOO_SHOULDERS] + "\n");
                }
                if (flags[kFLAGS.KELLY_TATTOO_LOWERBACK] != 0)
                {
                    outputText(flags[kFLAGS.KELLY_TATTOO_LOWERBACK] + "\n");
                }
                if (flags[kFLAGS.KELLY_TATTOO_BUTT] != 0)
                {
                    outputText(flags[kFLAGS.KELLY_TATTOO_BUTT] + "\n");
                }
                outputText("\n");
            }
        }
        ...
        if (flags[kFLAGS.KELLY_KIDS] > 0)
        {
            ...
            {
                outputText("\nKelly's ");
                if (flags[kFLAGS.KELLY_FIRST_KID_GENDER] == 1)
                {
                    outputText("son");
                }
                else
                ...
                if (flags[kFLAGS.KELLY_FIRST_KID_GENDER] == 1)
                {
                    outputText("him playing in the distance, lost in his own little world.");
                }
                else
                {
                    outputText("her playing in the distance, lost in her own little world.");
                }
            }
            else if (flags[kFLAGS.KELLY_KIDS] == 2)
            {
    ...
    private function approachKelly() : Void
    {
        ...
        kellySprite();
        //Fix hair color!
        if (flags[kFLAGS.KELLY_HAIR_COLOR] == 0)
        {
        ...
        if (model.time.hours >= 9 && model.time.hours <= 11 && flags[kFLAGS.KELLY_KIDS] >= 2)
        {
            ...
            if (flags[kFLAGS.KELLY_KIDS] > 2)
            {
                outputText("two youngest ");
            }
            outputText("children with ");
            if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
            {
                outputText("the top row of ");
            }
        ...
        if (player.hasItem(consumables.CANINEP))
        {
            ...
            if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0)
            {
                outputText(", but who knows how it will change her");
            }
            outputText(".");
        }
        ...
        {
            addButton(14, "Back", farm.farmCorruption.rootScene);
        }
    }
    ...
    private function kellySexMenu() : Void
    {
        ...
        if (player.hasCock() && player.lust >= 33)
        {
            if (player.cockThatFits(300) >= 0 || flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
            {
                if (flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] == 0)
                {
                    addButton(0, "VirginFuck", takeKellysVirginity);
                }
                else
                {
    ...
    private function fuckKellysCunt() : Void
    {
        ...
        {
            outputText("bottom out inside her");
        }
        else
        {
            outputText("slide as far into her as she can handle");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText("  Her pussy seems like a soggy, cum-soaked sex-toy before you're even halfway done.");
        }
        if (player.cumQ() >= 1200)
        {
            ...
            if (player.cumQ() >= 4000)
            {
                outputText(", until she's so pregnant with spooge that she can barely stand");
            }
            outputText(".  ");
        }
        ...
        if (!pregnancy.isPregnant)
        {
            outputText(" so the cum can turn you into a proper broodmare");
        }
        else
        {
            outputText(", maybe knit some for the kids you're going to be pumping out for me non-stop");
        }
        outputText(".</i>\"");
    ...
    private function taurOnTaurSexKelly() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] tingle pleasantly from the attention, and you groan when she sucks one into her mouth, worshipping it with her lips.");
        }
        ...
        {
            outputText(" before sitting back down (she's too tall to take standing up) and lifting her tail");
        }
        else
        {
            outputText(" before lifting her tail");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            ...
            if (player.cumQ() >= 4000)
            {
                outputText(", and when she grows too full to hold any more, waves of alabaster spooge roll out of her abused nether-lips, adding to the messy sex-puddle below");
            }
            outputText(".  ");
        }
        ...
        if (player.cor < 50)
        {
            outputText("  You feel a little bad for her and help her up - she did just milk your dick in the way that only a centaur can.");
        }
        else
        {
            outputText("  You snicker and walk away - she's already served her purpose.");
        }
        kellyPreggers();
        player.orgasm();
        doNext(camp.returnToCampUseOneHour);
    ...
    private function tentaFuckKelly() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("but also a bit disgusted to watch such shameless, wanton behavior, ");
        }
    ...
    private function punishKelly() : Void
    {
        ...
        {
            addButton(1, "Ride", rideKellyForPunishment);
        }
    ...
    private function getARimjobFromKelly() : Void
    {
        ...
        if (player.isNaga())
        {
            outputText("With reptilian litheness, you slowly lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  ");
        }
        else if (!player.isTaur())
        {
            outputText("You lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  ");
        }
        ...
        if (!player.isTaur())
        {
            outputText("  You smirk and grip her hair, moving her head in rhythm with your own movements.");
        }
        else
        {
            outputText("  You gyrate your [butt] this way and that, moving her head in rhythm with your own movements.");
        }
        ...
        if (player.isNaga())
        {
            outputText("  You clench her almost bone crushingly tight in your coils as rut overtakes you.");
        }
        ...
        if (player.hasVagina())
        {
            outputText("; she slides as many fingers as she can into your [vagina] and frigs you as best she can");
        }
        ...
        if (player.hasVagina())
        {
            outputText("  Your female sex orgasms in tandem, your wet flesh seizing up around Kelly's fingers and spattering her arm and chest with girl juices.");
        }
        ...
        if (flags[kFLAGS.TIMES_RIM_JOBBED_BY_KELLY] == 1)
        {
            ...
            if (player.cumQ() >= 700)
            {
                outputText("You, as ever, have produced a veritable oozing lake of the stuff.  ");
            }
            ...
            if (player.cumQ() >= 1000)
            {
                outputText("  She is, after all, going to be here for a while.");
            }
        }
        //[Repeat:
        else
    ...
    private function rideKellyForPunishment() : Void
    {
        ...
        {
            sceneHunter.print("Fork: taller than 6'5\" or taur body.");
        }
        if (flags[kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 1)
        {
            ...
            if (player.tallness < 78 && !player.isTaur())
            {
                ...
                if (player.isNaga())
                {
                    outputText("  Your reptilian half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long tail wrapped around her barrel-like lower body.");
                }
                //[Drider:]
                else if (player.isDrider())
                {
                    outputText("  Your spider half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long, chitinous legs wrapped carefully around her barrel-like lower body.  You must look utterly bizarre but feel reasonably comfortable.");
                }
                ...
                if (flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
                {
                ...
                {
                    outputText(" hard enough to produce thin arcs of milk");
                }
            ...
            if (player.tallness < 78 && !player.isTaur())
            {
                ...
                if (player.isBiped())
                {
                    outputText(", set your feet into the stirrups");
                }
        ...
        else if (flags[kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 2)
        {
            ...
            if (flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
            {
                outputText("  Just as well there were four of them, eh?");
            }
    ...
    public function takeKellysVirginity() : Void
    {
        ...
        if (flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
        {
            outputText("horse-");
        }
        outputText("cunt.");
        ...
        if (flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
        {
            outputText("lust-swollen, black-lipped fuck-hole");
        }
        else
        {
            outputText("blooming, pink-tinged pussy");
        }
        ...
        if (flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
        {
            outputText(", taking time to squeeze her plush, onyx vulva teasingly.  Kelly whinnies in response, overtaken by her potent equine instincts.");
        }
        else
        {
            outputText(", taking time to fondle her slick labia.  Kelly moans in response, overtaken by the sensations you're forcing through her.");
        }
        ...
        if (!player.isTaur())
        {
            outputText("get down behind her and line your " + cockDescript(x) + " with her dribbling lips.");
        }
        else
        {
            outputText("lie down behind her, sliding your hindlegs behind hers in order to properly align your " + cockDescript(x) + " with her dribbling lips.");
        }
        ...
        if (player.isTaur())
        {
            outputText("breast as you snuggle up behind her, centaur to centaur,");
        }
        else
        {
            outputText("ass");
        ...
        if (player.cockArea(x) <= 300)
        {
            ...
            if (flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
            {
                outputText("plump, equine cunt-lips");
            }
            else
            {
                outputText("slippery, pink cunt-lips");
            }
        }
        else
        {
            outputText(", pressing your " + player.cockHead(x) + " up against the barrier her cervix makes");
        }
        ...
        if (player.cumQ() >= 500)
        {
            ...
            if (player.cumQ() >= 1500)
            {
                outputText("  In no time flat, her belly has begun to round slightly, puffed up with spunk.");
            }
            if (player.cumQ() >= 3500)
            {
                outputText("  That doesn't stop you from seeding it even further, pumping her poor horse-gut until it jiggles and jostles with your spermy cargo.  There's no way she'll forget this.");
            }
        }
        ...
        if (flags[kFLAGS.KELLY_CUNT_TYPE] == 0)
        {
            outputText("the redness of her well-used cunt.");
        }
        else
        {
            outputText("the shining juices that drip from her oh-so-equine entrance, gilding the smooth onyx lips with a slimey sheen.");
        }
    ...
    private function kellyTitJob() : Void
    {
        ...
        if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0)
        {
            x = player.cockThatFits(18, "length");
        }
        else
        {
        ...
        if (pregnancy.isPregnant)
        {
            outputText(", glittering beads of milk flicking here and there as she advances");
        }
    ...
    private function kellyPreggers() : Void
    {
        ...
        if (flags[kFLAGS.KELLY_HEAT_TIME] > 0)
        {
            x += 15;
        }
    ...
    public function kellyPopsOutARunt() : Void
    {
        ...
        var gender : Int = as3hx.Compat.parseInt(rand(2) + 1);
    ...
    private function talkNHandToKelly() : Void
    {
        ...
        if (flags[kFLAGS.KELLY_TALK_N_HAND_TIMES] == 0)
        {
            ...
            if (!player.isTaur())
            {
                ...
                if (player.cockTotal() == 1)
                {
                    outputText("[oneCock], gently tugging it.  It quickly hardens with the pleasing friction she coils around it.");
                }
                else
                {
                    outputText("first your [cock], then your [cock 2], gently tugging until they are both hard from the pleasing friction she coils around them.");
                }
            }
            //Centaur:
            else
            {
                ...
                if (player.cockTotal() == 1)
                {
                    outputText("a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction.");
                }
                else
                {
                    outputText("a warm hand wraps around first your [cock] and then your [cock 2] before beginning to gently tug, both quickly hardening from the pleasing coils of friction.");
                }
            }
        }
        //Repeat:
        ...
        function wives() : Void
        {
            ...
            {
                outputText("  Now I am a woman, I work for another woman, and I spend most days polishing her [cock biggest]!");
            }
            ...
            if (player.cockTotal() > 1)
            {
                outputText("imagining thrusting every single one of your cocks into a wet, willing hole, ");
            }
            //vagina:
            else if (player.hasVagina())
            {
                outputText("imagining one of them tongue-fucking your [vagina] as you buck into another's tight cunt, ");
            }
            ...
            if (player.cor < 70)
            {
                outputText("  Plus, the thought of making Kelt's victims pay the price for his own crimes makes you feel uncomfortable.");
            }
        ...
        function keltaura() : Void
        {
            ...
            if (player.balls == 0)
            {
                outputText("suckles and laps at the very base of your [cock] for a time");
            }
            else
            {
                outputText("suckles and laps at your [balls] for a time");
            }
            ...
            if (flags[kFLAGS.KELLY_KIDS] > 0)
            {
                outputText(" and bearing and raising your children");
            }
        ...
        var whitney : Void->Void = function() : Void
        {
    ...
    private function giveKellyAppleSauce() : Void
    {
        ...
        if (flags[kFLAGS.KELLY_TIMES_APPLESAUCED] == 0)
        {
            ...
            if (!farm.farmCorruption.whitneyCorrupt())
            {
                outputText(" \"<i>I'd like to go and check on it, but... I don't think Whitney likes me much anymore.  I'd hate to cause more trouble than I already have.</i>\"");
            }
            else
            {
                outputText("\"<i>I'd like to go and check on it, but... I’d hate to get into Mistress Whitney’s bad books.  I’ve caused enough trouble already.</i>\"");
            }
            ...
            if (!player.isTaur())
            {
                ...
                if (player.cumQ() >= 750)
                {
                    outputText("  The bowl quickly begins to brim as your [cock] torrents out cum, and eventually you have to turn away, grunting out the last jets of filth into the undergrowth.");
                }
            }
            //[Centaur:]
            else
            {
                ...
                if (player.cumQ() >= 750)
                {
                    outputText("  Your [cock] torrents out cum, and eventually you have to clop away, grunting out the last jets of filth onto the ground to avoid overflowing the bowl.");
                }
            }
        ...
        else
        {
            ...
            if (flags[kFLAGS.KELLY_KIDS] > 1)
            {
                outputText("  Somebody has even cleared an oblong patch of earth alongside the trees- a piece of card stuck into it is scrawled with a childish hand which declares it to be \"CAROTS\".  You marvel at it all.  Who would have imagined your lust for horse pussy would have turned a pointless asshole into a loving mother who gardens with her children?  Really, you deserve a medal for your efforts.");
            }
            ...
            if (!player.isTaur())
            {
                ...
                if (player.hasVagina())
                {
                    outputText("  Your [vagina] quivers and clenches, and once again, gasping with the dual orgasm which is clutching your body, you stand over the bowl and let some of your femcum drip into it.");
                }
                //[High cum:
                if (player.cumQ() >= 750)
                {
            ...
            if (silly())
            {
                outputText("  Parsley, sage, rosemary and c...");
            }
        ...
        if (!player.isTaur())
        {
            ...
            {
                outputText("  Your girth spreads her fuck tunnel wide and you grunt at the delicious tightness of it as you pack her full of cock.");
            }
            ...
            if (player.hasBalls())
            {
                outputText(", your [balls] slapping into her thighs demandingly ");
            }
            ...
            if (y >= 0)
            {
                outputText(" as her anus clenches around your " + cockDescript(x));
            }
        ...
        else
        {
            ...
            if (y >= 0)
            {
                outputText(" as her anus clenches around your " + cockDescript(y));
            }
        ...
        if (player.isBiped())
        {
            outputText("giving at the knees, ");
        }
        ...
        if (player.cor < 60)
        {
            outputText("The taste of cum glazing her apple breath is off-putting but what did you really expect?");
        }
        else
        {
            outputText("You don't like to admit it but you do taste pretty good, even to yourself.  You push your tongue further into Kelly's mouth hungrily, working your jaw as you savage her mouth with your lips and tongue in search of that fruity, horny flavour, making her 'mmm' with delight and respond in kind.");
        }
    ...
    private function kellyBJsAhoy() : Void
    {
        ...
        if (!player.isTaur())
        {
            ...
            if (player.hasVagina())
            {
                outputText("  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the back and work her way up.");
            }
            ...
            if (player.hasBalls() && player.hasVagina())
            {
                ...
                if (player.ballSize <= 8)
                {
                    ...
                    if (player.balls > 2)
                    {
                        outputText(", then the third, then the fourth");
                    }
                ...
                else
                {
                    ...
                    //[Dominika dreams:
                    if (flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0 && flags[kFLAGS.DOMINIKA_MET] > 0)
                    {
                        outputText("  You are gripped by a sudden but thrilling velvet-edged sense of déjà vu.  Has this scene not repeated somewhere else?");
                    }
                }
            }
            //Vagina:
            ...
            {
                outputText("It's a long way up and the effect is like a lift slowly rising, turning on a glow of lights on each level as it goes.  ");
            }
            ...
            if (player.hasBalls())
            {
                outputText(", as you feel your [balls] clench");
            }
            ...
            if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
            {
                outputText(" onto all four of her tits");
            }
        ...
        else
        {
            ...
            {
                outputText("  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the front and work her way down.");
            }
            ...
            if (player.hasVagina())
            {
                outputText("pussy-licking, ");
            }
            if (player.hasBalls())
            {
                outputText("ball-sucking ");
            }
            ...
            if (player.hasVagina())
            {
                outputText("  Your female sex clenches and orgasms in sympathy, and you feel fluid dribble down your [hips] as you continue to paint Kelly.  Your only dim regret is that there's no way of soaking her with that, too.");
            }
            outputText("\n\nFinally you are spent.  You clop around to admire your handiwork.");
            //Low cum:
            if (player.cumQ() < 750)
            {
                outputText("  Kelly has done a sterling job of catching your load; you've frosted her boobs with long strokes quite convincingly.");
            }
            else
            {
        ...
        if (!player.isTaur())
        {
            outputText(", still clutching your pleasantly aching prick");
        }
        ...
        else
        {
            ...
            if (player.hasVagina())
            {
                outputText(", letting her sensually lick you out again until your [vagina] is gleaming with arousal");
            }
            if (player.hasBalls())
            {
                outputText(", letting her needily suckle on your [balls] again until they are inflamed with renewed pressure");
            }
