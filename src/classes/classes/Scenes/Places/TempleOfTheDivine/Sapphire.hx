...
class Sapphire extends BaseContent
{
    ...
    /*
		...
		* */
    public function sapphireAffection(changes : Float = 0) : Float
    {
    ...
    public function sapphiremenu() : Void
    {
        ...
        if (flags[kFLAGS.WEDDINGS_UNLOCKED] == null)
        {
    ...
    public function TalkHer() : Void
    {
        ...
        {
            sapphireAffection(20);
        }  //raise until pre-sex cap  
    ...
    private function talkWeddings() : Void
    {
        ...
        if (flags[kFLAGS.TEMPLE_OF_THE_DIVINE_MARAE] == null)
        {
    ...
    public function TalkSex() : Void
    {
        ...
        {
            outputText(" There’s even running water if we ever need... something slippery.");
        }
        outputText("</i>\"\n\n");
        ...
        if (player.lust > 33)
        {
            ...
            {
                addButtonDisabled(2, "???", "Sapphire needs a friend. Maybe another gargoyle will suffice?");
            }
            addButton(2, "MutualMast.", SapphireMutualMasturbation).hint("Help both you and her soothe that itch.");
            if (player.hasCock())
            {
                addButton(3, "FuckHer", SapphireFuckHer).hint("Let's plunder that stony cavern of hers.");
            }
        }
    ...
    public function SapphireGargoyleDoubleTailfuck() : Void
    {
        ...
        if (player.gender == 3)
        {
            outputText(", maybe even better than a cock");
        }
    ...
    public function SapphireTripleTailOuroboros() : Void
    {
        ...
        {
            outputText("Krystal’s waiting cunt");
        }
        else
        {
            outputText("Onyx’s rock hard dick");
        }
        outputText(". Not to be left unstimulated you welcome [onyx name]’s tail ");
        if (player.gender == 2 || player.gender == 3)
        {
            outputText("in your ready snatch");
        }
        if (player.gender == 3)
        {
            outputText(" and ");
        ...
        {
            outputText("around your throbbing [cock]");
        }
        if (flags[kFLAGS.ONYX_GENDER] == 1 || flags[kFLAGS.ONYX_GENDER] == 2)
        {
            outputText(". Krystal giggle");
        }
        else
        {
            outputText(". Onyx chuckle");
        }
        ...
        if (flags[kFLAGS.ONYX_GENDER] == 1 || flags[kFLAGS.ONYX_GENDER] == 2)
        {
            outputText(" Krystal seems to be locked in a blissful dreamy expression of her own");
        }
        else
        {
            outputText(" Onyx seems to enjoy the feeling of his cock");
        }
        ...
        if (player.gender == 2 || player.gender == 3)
        {
            outputText(" penetrates");
        }
        outputText(" you masterfully. Your ");
        if (player.gender == 2 || player.gender == 3)
        {
            outputText("pussy is alight with pleasure");
        }
        if (player.gender == 3)
        {
            outputText(" and your ");
        ...
        if (!player.isGargoyle())
        {
            outputText("Sapphire and [onyx name] ");
        }
        ...
        if (player.isGargoyle())
        {
            ...
            if (flags[kFLAGS.ONYX_GENDER] == 2 || flags[kFLAGS.ONYX_GENDER] == 3 || player.hasCock())
            {
                outputText("(if a male present) and jerking");
            }
            outputText(" each other.\n\n");
        }
        else
        {
            outputText("You regain your sense faster than your two stony friends. Mainly because you can’t petrify from pleasure like they do.\n\n");
        }
        if (player.isGargoyle())
        {
    ...
    public function SapphireMutualMasturbation() : Void
    {
        ...
        if (player.isGargoyle())
        {
            outputText(" While neither of you actually have saliva, the feeling of her stone rugged tongue against yours is quite good.");
        }
        else
        {
            outputText(" Her mouth lacking fluids is a weird experience at first but once her tongue is slick with your saliva it starts to feel like anyone else’s, albeit her tongue is slightly longer.");
        }
        ...
        if (player.gender == 1 || player.gender == 3)
        {
            outputText(" wrapping her long appendage around your [cock]");
        }
        if (player.gender == 3)
        {
            outputText(" and with the rest of her length");
        }
        if (player.gender == 2 || player.gender == 3)
        {
            outputText(" ramming her long prehensile but flattened macetail into your [cunt]");
        }
        outputText(", slowly masturbating you to satisfaction. Her tail is oddly quite good at");
        if (player.gender == 2 || player.gender == 3)
        {
            outputText(" hitting all of your spot");
        }
        if (player.gender == 3)
        {
            outputText(" and");
        ...
        if (player.gender == 1 || player.gender == 3)
        {
            outputText(" teasing your pillar");
        }
        outputText(". You both work each other off for a moment until you finally orgasm locking into a strong hug. ");
        if (player.isGargoyle())
        {
            outputText("The pleasure is so powerful your form petrify in rigor mortis for a few minute locking with that of Sapphire who also reached her peak.");
        }
        else
        {
            outputText(" Not so surprisingly Sapphire has no fluids of her own, but you give her plenty as your genitals splash her nethers. Sapphire own orgasm cause her to petrify and harden into rigor mortis.");
        }
