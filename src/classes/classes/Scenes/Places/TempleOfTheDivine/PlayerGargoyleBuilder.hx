...
class PlayerGargoyleBuilder extends BaseContent
{
    ...
    public function readStrangeBookOfGolems() : Void
    {
        ...
        if (flags[kFLAGS.GARGOYLE_QUEST] == null)
        {
    ...
    public function currentStateOfStatue() : Void
    {
        ...
        if (Forgefather.statueProgress >= 10)
        {
            outputText("a finished");
        }
        else
        {
            outputText("an incomplete stone gargoyle. This statue looks like ");
        }
        if (Forgefather.gender == 1)
        {
            outputText("it has a gorgeous female face");
        }
        if (Forgefather.gender == 2)
        {
            outputText("it has a handsome male face");
        }
        if (Forgefather.gender == 3)
        {
            outputText("it has a face that would look good on a male or a female");
        }
        if (Forgefather.gender == 0)
        {
            outputText("its face is yet to be finished");
        }
        outputText(" and its ");
        if (Forgefather.hairLength == 1)
        {
            outputText("bald head looks great.");
        }
        if (Forgefather.hairLength == 2)
        {
            outputText("short hair looks great.");
        }
        if (Forgefather.hairLength == 3)
        {
            outputText("moderately long hair looks great.");
        }
        if (Forgefather.hairLength == 4)
        {
            outputText("long hair looks great.");
        }
        if (Forgefather.hairLength == 0)
        {
            outputText("hair is yet to be sculpted.");
        }
        if (Forgefather.chest > 0)
        {
            outputText("\n\nThe statue has ");
            if (Forgefather.chest == 1)
            {
                outputText("a flat chest");
            }
            else
            {
                outputText(Appearance.breastCup(Forgefather.chest - 1) + " breasts");
            }
            outputText(".\n\n");
        }
        if (Forgefather.chest == 0)
        ...
        if ((Forgefather.cock < 1) && ((Forgefather.vagina) < 1 || Forgefather.balls < 1))
        {
            outputText("There's a block where its crotch would be.");
        }
        else
        {
            ...
            {
                outputText("hangs a ");
                outputText(Std.string(4.0 + (Forgefather.cock - 2) * 0.5) + "-inch");
                outputText(" long cock");
                if (Forgefather.balls > 1)
                {
                    outputText(" along with a pair of ");
                    if (Forgefather.balls == 2)
                    {
                        outputText("large");
                    }
                    if (Forgefather.balls == 3)
                    {
                        outputText("baseball-sized");
                    }
                    if (Forgefather.balls == 4)
                    {
                        outputText("apple-sized");
                    }
                    if (Forgefather.balls == 5)
                    {
                        outputText("grapefruit-sized");
                    }
                    outputText(" balls");
                }
                outputText(".");
            ...
            if (Forgefather.vagina > 0)
            {
                if (Forgefather.vagina == 2)
                {
                    if (Forgefather.balls > 1)
                    {
                        outputText(" Beneath them");
                    }
                    else if (Forgefather.cock > 1)
                    {
                        outputText(" Beneath it");
                    }
        ...
        {
            outputText(" feathered");
        }
        outputText(" wings ");
        if (Forgefather.wings >= 1)
        {
            outputText("are completed, and the wings folded behind its back");
        }
        else
        {
            outputText("have yet to be done");
        }
        outputText(".\n\nIt's arms ");
        if (Forgefather.arms == 1)
        {
            outputText("ends with a set of bestial four fingered sharp stone claws");
        }
        if (Forgefather.arms == 2)
        {
            outputText("ends with very human fist");
        }
        if (Forgefather.arms == 0)
        {
            outputText("have yet to be sculpted");
        }
        outputText(". It's legs ");
        if (Forgefather.lowerBody == 1)
        {
            outputText("ends with clawed bestial feets with three toe at the front and one at the back");
        }
        if (Forgefather.lowerBody == 2)
        {
            outputText("are human like");
        }
        if (Forgefather.lowerBody == 0)
        {
            outputText("have yet to be defined");
        }
        outputText(". Its ");
        if (Forgefather.tail == 1)
        {
            outputText("mace like");
        }
        if (Forgefather.tail == 2)
        {
            outputText("axe like");
        }
        if (Forgefather.tail == 0)
        {
            outputText("unfinished");
        }
        ...
        outputText(" body.");
        if (Forgefather.statueProgress >= 1)
        {
        ...
        if (Forgefather.gender < 1)
        {
            addButton(0, "Frame&Face", SculptFrameAndFace);
        }
        else
        {
            addButtonDisabled(0, "Frame&Face", "You already sculpted the Frame and Face.");
        }
        if (Forgefather.wings < 1)
        {
            addButton(1, "Wings", SculptWings);
        }
        else
        {
            addButtonDisabled(1, "Wings", "You already sculpted the Wings.");
        }
        if (Forgefather.tail < 1)
        {
            addButton(2, "Tail", SculptTail);
        }
        else
        {
            addButtonDisabled(2, "Tail", "You already sculpted the Tail.");
        }
        if (Forgefather.lowerBody < 1)
        {
            addButton(3, "Legs", SculptLegs);
        }
        else
        {
            addButtonDisabled(3, "Legs", "You already sculpted the Legs.");
        }
        if (Forgefather.arms < 1)
        {
            addButton(4, "Arms", SculptArms);
        }
        else
        {
            addButtonDisabled(4, "Arms", "You already sculpted the Arms.");
        }
        if (Forgefather.hairLength < 1)
        {
            addButton(5, "Hair", SculptHair);
        }
        else
        {
            addButtonDisabled(5, "Hair", "You already sculpted the Hair.");
        }
        if (Forgefather.chest < 1)
        {
            addButton(6, "Chest", SculptChest);
        }
        else
        {
            addButtonDisabled(6, "Chest", "You already sculpted the Chest.");
        }
        if (Forgefather.vagina < 1)
        {
            addButton(7, "Pussy", SculptPussy);
        }
        else
        {
            addButtonDisabled(7, "Pussy", "You already sculpted the Pussy Area.");
        }
        if (Forgefather.cock < 1)
        {
            addButton(8, "Cock", SculptCock);
        }
        else
        {
            addButtonDisabled(8, "Cock", "You already sculpted the Cock Area.");
        }
        if (Forgefather.balls < 1)
        {
            addButton(9, "Balls", SculptBalls);
        }
        else
        {
            addButtonDisabled(9, "Balls", "You already sculpted the Balls Area.");
        }
        if (!player.isGargoyle())
        {
            addButtonIfTrue(10, "Ritual", becomingGargoyle, 
    ...
    public function SculptPussy() : Void
    {
        ...
        if (Forgefather.cock != 1)
        {
            addButton(0, "No", SculptPussy_chosen, 1).hint("Don't sculpt pussy.");
        }
    ...
    public function SculptCock() : Void
    {
        ...
        if (Forgefather.vagina != 1)
        {
            addButton(0, "None", sculptCockSelected, 1).hint("Don't sculpt cock.");
        }
    ...
    public function becomingGargoyleYes() : Void
    {
        ...
        if (player.hasItem(consumables.MINOBLO, 1))
        {
            addButton(1, "Minotaur", becomingGargoyleYesMinotaurBlood).hint("Your body would need regular intake of sexual fluids.");
        }
        else
        {
            addButtonDisabled(1, "Minotaur", "Need Minotaur Blood vial for this option");
        }
