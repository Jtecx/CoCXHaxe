...
class Yenza extends TrollVillageAbstractContent
{
    public function new()
    {
        super();
    ...
    public function YenzaChecks() : Void
    {
        ...
        if (TrollVillage.YenzaUnlocked == 0)
        {
            ...
            {
                if ((player.femininity > 30 || player.hasBreasts()) && flags[kFLAGS.LOW_STANDARDS_FOR_ALL] == null)
                {
        ...
        else if (player.femininity > 30 && flags[kFLAGS.LOW_STANDARDS_FOR_ALL] == null)
        {
    ...
    public function YenzaHome() : Void
    {
        ...
        else if ((player.hasBreasts() || player.femininity > 30) && flags[kFLAGS.LOW_STANDARDS_FOR_ALL] == null)
        {
    ...
    private function YenzaTalkOptions() : Void
    {
        ...
        {
            addButton(2, "Cowgirl", YenzaCowgirl);
        }
        else
        {
            addButtonDisabled(2, "Cowgirl", "Your dick is too big for her.");
        }
        if (TrollVillage.YenzaUnlocked >= 4)
        {
            addButton(3, "Submit", YenzaSubmit);
        }
        else
        {
            addButtonDisabled(3, "???", "Req. to know her better.");
        }
    }
