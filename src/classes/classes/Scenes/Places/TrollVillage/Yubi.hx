...
class Yubi extends TrollVillageAbstractContent
{
    public function new()
    {
        super();
    ...
    public function TalkWithYubi() : Void
    {
        ...
        var YubiHerself : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var YubiElders : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var YubiPeople : Void->Void = function() : Void
        {
            clearOutput();
