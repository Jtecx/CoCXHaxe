...
class Kalji extends TrollVillageAbstractContent
{
    public function new()
    {
        super();
    ...
    public function TalkWithKalji() : Void
    {
        ...
        var KaljiHimself : Void->Void = function() : Void
        {
        ...
        var KaljiCouncilCheck : Void->Void = function() : Void
        {
            if (!KaljiInteractTrack())
            {
                KaljiCouncil();
        ...
        var KaljiInteractTrack : Void->Bool = function() : Bool
        {
    ...
    private function KaljiSex() : Void
    {
        ...
        else if (player.gender == 1 || !(player.gender == 2) && player.looksMale())
        {
            maleF();
        }
        else
        ...
        var KjBJFY : Bool->Void = function(resist : Bool = false) : Void
        {
            clearOutput();
            ...
            if (resist)
            {
                outputText("\"<i>If you’re gonna do your job, you better do a damn good job, slut.</i>\"\n");
            }
            else
            {
                outputText("\"<i>If you don’t want to disappoint me then you better get to work.</i>\"\n");
            }
            outputText("\n" +
            ...
            if (resist)
            {
                outputText("<i>You’re a good pile of dirt, you’re actually not a complete disappointment.</i>\"");
            }
            else
            {
                outputText("\"<i>Such a good girl, you’re doing well.</i>\"]\n");
            }
            outputText("\n" +
        ...
        var KjBJNF1 : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var KjBJNF2 : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var KjBDG : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var KjBJMY : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var KjBJMN : Void->Void = function() : Void
        {
