...
class Jabala extends TrollVillageAbstractContent
{
    public function new()
    {
        super();
    ...
    public function JabalaDining() : Void
    {
        ...
        var JabalaSelfIntro : Void->Void = function() : Void
        {
        ...
        var JabalaGossip : Void->Void = function() : Void
        {
        ...
        var JabalaLeave : Void->Void = function() : Void
        {
        ...
        var JabalaHomoSexTalks : Void->Void = function() : Void
        {
        ...
        var JabalaSeamstress : Void->Void = function() : Void
        {
        ...
        var JabalaElder : Void->Void = function() : Void
        {
        ...
        var JabalaLoveLife : Void->Void = function() : Void
        {
    ...
    public function JabalaHome() : Void
    {
        ...
        else if (TrollVillage.ZenjiFollowing)
        {
            ...
            function JabalaSexWZenji() : Void
            {
                ...
                if (player.lib < 80)
                {
                    outputText("Zenji looks at you with a disappointed glance, \"<i>No, let’s… not do that…</i>\"\n");
                }
                else
                {
                    outputText("Zenji takes a deep, long sniff. \"<i>Hmm... no, not feeling it right now.</i>\"\n");
                }
        ...
        var JabalaNVM : Void->Void = function() : Void
        {
    ...
    public function JabalaHalkanoTalk(desc : Bool = false) : Void
    {
        clearOutput();
        if (desc)
        {
        ...
        var JabalaHalkanoGossip : Void->Void = function() : Void
        {
    ...
    private function JabalaSelfTalk(desc : Bool = false) : Void
    {
        clearOutput();
        if (desc)
        {
    ...
    private function JabalaSex() : Void
    {
        ...
        {
            addButton(0, "SpitRoast", JabalaSpitroasted);
        }
        else
        {
            addButtonDisabled(0, "SpitRoast", "You don't have anything for Jabala to eat out!");
        }
        addButton(1, "Double Worship", JabalaDWorship);
        addButton(2, "Never mind", JabalaBlueBalls);
        
        var JabalaBlueBalls : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var JabalaSpitroasted : Void->Void = function() : Void
        {
        ...
        var JabalaDWorship : Void->Void = function() : Void
        {
