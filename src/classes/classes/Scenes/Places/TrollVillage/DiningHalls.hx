...
class DiningHalls extends TrollVillageAbstractContent
{
    public function new()
    {
        super();
    ...
    public function GrabABite2Eat() : Void
    {
        ...
        if (rand(10) == 1)
        {
            ...
            if (TrollVillage.KaljiUnlocked)
            {
                outputText("that you recognize him as Kal'ji");
            }
        ...
        var LeaveTheHalls : Void->Void = function() : Void
        {
            clearOutput();
        ...
        var FigJuice : Void->Void = function() : Void
        {
            clearOutput();
            ...
            {
                outputText(" Zenji sits beside you, \"<i>You know, my mother grows de best figs here. It’s been some time since I had any fig juice.</i>\"\n");
            }
            ...
            if (TrollVillage.ZenjiFollowing)
            {
                outputText("You pass the juice to Zenji, he takes a large sip. \"<i>Ah, dat’s de good stuff…</i>\" He sighs as he gives you the rest of the juice.\n\n");
            }
        ...
        var HuntStew : Void->Void = function() : Void
        {
            clearOutput();
            ...
            if (TrollVillage.ZenjiFollowing)
            {
                outputText("Zenji sits beside you, \"<i>I’ve been on a few hunts before, de meat tastes better de sooner you eat it.</i>\"\n");
            }
            ...
            if (TrollVillage.ZenjiFollowing)
            {
                outputText("You pass your fork to Zenji as he takes a large bite, \"<i>De Hunter’s stew were always my favorite ta eat when Fatha gave me some gems ta spend here.</i>\" He states as he passes the fork back to you.\n\n");
            }
            doNext(RandomChatter);
        ...
        var GardenSalad : Void->Void = function() : Void
        {
            clearOutput();
            ...
            if (TrollVillage.ZenjiFollowing)
            {
                outputText("Zenji sits beside you, \"<i>Motha said ta always eat ya greens ta grow big and strong… Father really took dat to de next level…</i>\"\n");
            }
            ...
            if (TrollVillage.ZenjiFollowing)
            {
                outputText("You pass your fork to Zenji as he takes a forkful of salad, \"</i>Fatha would sometimes finish all of de sauce and leave de rest of de salad ta mom,</i>\" Zenji chuckles softly, \"<i>She would get so mad dat he didn’t finish the salad.</i>\" He says as he passes the fork back to you.\n\n");
            }
            doNext(RandomChatter);
        ...
        var ZenjiPaysorPC : Void->Void = function() : Void
        //So I don't have to copy/paste this....
        {
    ...
    private function RandomChatter() : Void
    {
        ...
        switch (rand(6))
        {
            ...
            case 5:
                if (silly())
                {
                    outputText("\"<i>I used ta be a hunter like ya, then I took an arrow to the knee.</i>\"\n" +
                            "\n" +
        ...
        for (i in menuItems)
        {
            var cond : Dynamic = true;
            if (i.length == 4)
            {
                cond = Reflect.field(i, Std.string(3));
            }
            if (rand(4) == 1 && cond != null)
            {
                addButton(iter, Reflect.field(i, Std.string(0)), Reflect.field(i, Std.string(1))).hint(Reflect.field(i, Std.string(2)));
                iter++;
            }
        }
        addButton(14, "Leave", LeaveTheHalls2);
        
        var LeaveTheHalls2 : Void->Void = function() : Void
        {
