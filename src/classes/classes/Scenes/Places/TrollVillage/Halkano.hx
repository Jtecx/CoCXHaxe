...
class Halkano extends TrollVillageAbstractContent
{
    public function new()
    {
        super();
    ...
    public function TalksWithHalkano() : Void
    {
        ...
        var denyThisTime : Void->Void = function() : Void
        {
    ...
    private function HalkanoSpitroast() : Void
    {
        ...
        {
            outputText("He is so much taller than you that your feet don’t even reach the ground as you’re suspended in the air at the mercy of his strong arms.\n\n");
        }
        ...
        {
            outputText("Not that it’s an issue given you’ve fixed that problem.");
        }
        outputText("\n");
    ...
    public function JHalkanoSexScenes() : Void
    {
        ...
        var HalkanoBlown : Void->Void = function() : Void
        {
        ...
        var HalkanoAnal : Void->Void = function() : Void
        {
