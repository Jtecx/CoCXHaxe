...
class AnemoneScene extends BaseContent
{
    ...
    public function mortalAnemoneeeeee() : Void
    {
        ...
        if (flags[kFLAGS.TIMES_MET_ANEMONE] == 0 || player.hasItem(consumables.MINOCUM))
        {
            ...
            {
                sceneHunter.print("Check failed: Minotaur Cum in the inventory.");
            }
    ...
    public function defeatAnemone() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("The anemone's knees buckle and she collapses, planting her hands behind her with a splash.  You stand over her, victorious.\n\n");
        }
        //win by lust:
        else
        {
            outputText("The anemone slumps down and begins masturbating, stroking her cock furiously.  You think you can detect something like desperation in her opaque eyes.  It doesn't look like she'll trouble you anymore.\n\n");
        }
        if (player.lust >= 33)
        {
    ...
    public function sexMenu(defeat : Bool = true) : Void
    {
        menu();
    ...
    private function victoryButtholeRape() : Void
    {
        ...
        //[(dix)
        if (player.cockTotal() > 0 || player.gender == 0)
        {
            outputText("a ");
        }
    ...
    private function rapeAnemoneWithDick() : Void
    {
        ...
        function fitsF() : Void
        {
            var x : Float = player.cockThatFits(36);
            ...
            {
                outputText(", which she's currently diddling with the hand she's not using to stroke her cock");
            }
            ...
            if (monster.HP < 1)
            {
                outputText(" move to the lips of her vagina and");
            }
            ...
            {
                outputText(" in time with your own");
            }
            outputText("; here and there one of the bounces brush her gills away, giving you a tantalizing view of nipple.");
            //[(if balls)
            if (player.hasBalls())
            {
                outputText("  As your thrusts get faster your " + sackDescript() + " starts to slap into the tickly and quite-venomous feelers fringing her pussy, getting hotter and hotter as the aphrodisiac builds in your [balls].  Your body answers with swelling, causing your sack to feel bigger and tighter with every slap.");
            }
            ...
            if (player.cumQ() > 500)
            {
                ...
                if (player.cumQ() > 2000)
                {
                    outputText(" to enormous dimensions.  <i>\"Ohh...\"</i> she moans, as her waist distends to over four times its former slender diameter");
                }
                outputText(".  She looks ");
                if (player.cumQ() < 2000)
                {
                    outputText("thoroughly");
                }
                else
                {
                    outputText("monstrously");
                }
        ...
        var nofitF : Void->Void = function() : Void
        {
            ...
            {
                outputText("  Finally, after having gone so far as to kneel down to bring yourself in line, you begin pushing your way in.");
            }
            outputText("\n\n");
            ...
            //[(cocklength > 60")
            if (player.cocks[x].cockLength > 60)
            {
                outputText("  The imagery and the stimulation inspire you to increase your efforts, and you push even harder into her until your " + cockDescript(x) + " slides its way into her throat, expanding her slender neck to twice the normal width.  The anemone's mouth gapes open reflexively as if to gag as the pressure forces her head back, but she doesn't stop moaning or rubbing herself against you.  This seems to be as deep as you can get; the tip of your cock is now right up against the base of her chin.");
            }
            outputText("\n\n");
            ...
            if (player.cocks[x].cockLength > 60)
            {
                outputText(", despite being unable to look anywhere except over her head thanks to the giant ridge running up the front of her body,");
            }
            ...
            if (player.cumQ() > 500)
            {
                outputText(" until flows past her lips");
            }
            outputText(".");
            //[(mega skeet)
            if (player.cumQ() > 1500)
            {
                outputText("  Eventually, she can't hold in the sheer volume of your ejaculate, and cascades past her lips onto the ground beneath you.  Spurt after spurt goes into and then out of her, pooling into the massive puddle of cum beneath the two of you.");
            }
            ...
            if (player.cumQ() < 500)
            {
                outputText("her hands are still dazedly playing with the space between her breasts where your cock used to rest.");
            }
            //[(mega skeet)
            else
            {
                outputText("she continues to sputter and cough up bubbles of your spunk.");
            }
            //(pass 1 hour, reset lust to min or min+10 if big or greater skeet)
    ...
    private function rapeAnemoneWithPussy() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText(" after brushing hers aside");
        }
        ...
        if (monster.HP < 1)
        {
            outputText("you can feel it harden as ");
        }
        ...
        {
            outputText("  You give special attention to the presentation of your " + breastDescript(0) + ", removing your top with tantalizing slowness, letting each breast slip out and hang between you like fruit ripe to be taken, then making sure to rub them seductively to arouse both of you further.");
        }
        //(hipsize=girly or better)
        if (player.hips.type > 6)
        {
            outputText("  You make good use of your " + hipDescript() + ", too, giving a little shimmy to show off your pronounced curves.");
        }
        ...
        if (player.biggestTitSize() > 2)
        {
            outputText("making sure to let your [allbreasts] rub up against hers, ");
        }
        outputText("then pull apart from her and ");
        //[(goddamn centaur)
        if (player.isTaur())
        {
            outputText("turn away, kneeling down to display your animalistic pussy readily.");
        }
        else
        {
            outputText("recline back on your [legs]. Spreading your thighs, you reach down with two fingers and pull apart your " + vaginaDescript(0) + " welcomingly; it's the last act in your sexual performance.");
        }
        outputText("\n\n");
        ...
        if (!player.isTaur())
        {
            outputText("You take her by the upper arms and pull her on top of you as you lie back in the sun-warmed shallows.  ");
        }
        ...
        if (!player.isTaur())
        {
            ...
            if (player.biggestTitSize() >= 1)
            {
                outputText(breastDescript(0) + " and ");
            }
        ...
        {
            outputText("soaks her crotch with juice and ");
        }
    ...
    public function loseToAnemone() : Void
    {
        ...
        if (player.gender == 0)
        {
            ...
            {
                outputText("  For a moment the examination stops at the dribble of milk leaking from your " + nippleDescript(0) + "s.  With one finger she collects a bit and tastes it, only to grimace and stick her tongue out.");
            }
            ...
            if (player.cor < 33)
            {
                outputText("You reach out instinctively to comfort her, but ");
            }
            //(high cor)
            else
            {
                outputText("You smirk, amused by the turnabout, until ");
            }
        ...
        var fitF : Void->Void = function() : Void
        {
            ...
            {
                outputText(" downwards, onto your hams,");
            }
            ...
            //[(cock2 doesn't exist){
                ...
                if (player.cockTotal() == 2)
                {
                    outputText("Your other dick rubs");
                }
                //(cock2 exists)
                else
                {
                    outputText("The rest of your [cocks] rub");
                }
            ...
            if (player.cumQ() > 500)
            {
                outputText(", bowing out her cheeks");
            }
            //[(cray-cray skeet)
            if (player.cumQ() > 2000)
            {
                outputText(" and squirting out her nose in thick ribbons");
            }
            //[(multi-dix)
            if (player.cockTotal() > 1)
            {
                ...
                if (player.cockTotal() == 2)
                {
                    outputText("your cocks shoot");
                }
                else
                {
                    outputText("the rest of your [cocks] shoot");
                }
                outputText(" all over her face and hair, ");
                //[(small skeet)
                if (player.cumQ() < 500)
                {
                    outputText("drawing a pattern like a musical score on her blue skin");
                }
                //(big skeet)
                else if (player.cumQ() < 2000)
                {
                    outputText("painting her skin white as she flinches and shuts her eyes tightly");
                }
                //(cray-cray skeet)
                else
                {
                    outputText("whitewashing her entire upper body and running off until a fan of milky color spreads through the water around you");
                }
            }
            ...
            if (player.cumQ() >= 500)
            {
                outputText(", her taut blue belly distending as it fills");
            }
            outputText(".\n\n");
            ...
            if (player.cockTotal() > 1)
            {
                if (player.cockTotal() == 2)
                {
                    outputText(" and your other " + cockDescript(1) + " follows suit");
                }
                else
                {
                    outputText(" and your other pricks follow suit");
                }
            }
        ...
        function nofitF() : Void
        {
            ...
            if (!player.isTaur())
            {
                outputText(" and pushes your shoulders down with the other");
            }
            ...
            {
                outputText("forelegs knee-");
            }
            outputText("down in front of you to keep from falling face-first.  ");
            //[(if non-centaur)
            if (!player.isTaur())
            {
                outputText("The head of your [cock biggest] dips into the lukewarm ");
            }
            if (flags[kFLAGS.ANEMONE_OR_SEA_ANEMONE] == 1)
            {
                outputText("lake");
            ...
            if (player.hasBalls())
            {
                outputText(" and your " + sackDescript() + " tightens up");
            }
            ...
            if (!player.isTaur())
            {
                outputText("clawing at your tormentor's tentacles, trying to pry them from " + sMultiCockDesc() + " by main force.");
            }
            //(horse)
            else
            {
                outputText("bucking and stamping the ground, wanting to shake the tentacles loose but unable to reach them with your hands.");
            }
            ...
            if (player.tallness < 48 && !player.isTaur())
            {
                outputText("fly over your head, and turning behind you, you see the anemone trying to catch them with an open mouth and her tongue out.");
            }
            else if (player.tallness < 84 && !player.isTaur())
            {
                outputText("catch the air and rain down on both your faces, splashing quietly where they hit water.");
            }
            else
            {
            ...
            if (player.tallness < 48 && !player.isTaur())
            {
                outputText("She looks you over, then bends down and drinks up as much of the semen floating in the water as she can find nearby.");
            }
            else
            {
                outputText("She leans over you and begins licking the semen off your body, not stopping until you're clean (if slightly sticky).");
            }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            if (player.biggestLactation() > 1)
            {
                outputText("  For a moment it brightens again when she notices the dribble of milk leaking from your " + nippleDescript(0) + "s. With one finger she collects a bit and tastes it, only to grimace and stick her tongue out.");
            }
            ...
            if (player.tallness < 48)
            {
                outputText(", pulling you upright");
            }
            outputText(".\n\n");
    ...
    private function giveMino() : Void
    {
        ...
        if (player.lust < 30)
        {
            ...
            if (player.cockTotal() > 0)
            {
                outputText(cockDescript(0) + " becomes a little erect");
            }
            else if (player.hasVagina())
            {
                outputText(vaginaDescript(0) + " aches a bit with need");
            }
            else
            {
                outputText(assholeDescript() + " begins to tingle with want");
            }
    ...
    //anal
    private function anemoneButtPlugginz(dick : Bool) : Void
    {
        clearOutput();
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText(" as she plays with herself");
        }
        ...
        if (dick)
        {
            if (!player.isTaur())
            {
                outputText("you fish your [cockFit 48] out of your garments and rub it");
            }
            else
            {
                outputText("you rub your [cockFit 48]");
            }
        ...
        else
        {
            if (!player.isTaur())
            {
                outputText("you finger your pussy");
            }
            else
            {
                outputText("you imagine the tightness of her hole");
            }
        ...
        if (dick)
        {
            outputText(" as you smear a dribble of pre-cum into the crack of her ass");
        }
    ...
    private function anemoneQuoteUnquoteAnal(dick : Bool) : Void
    {
        clearOutput();
        var x : Int = 0;
        ...
        else
        {
            ...
            if (!dick)
            {
                outputText(", angling your clit forward along your stomach by pinning it against the anemone's forehead");
            }
        }
        ...
        if (!dick)
        {
            outputText(" that won't come");
        }
        outputText(".  The tightness seems to adjust to the ");
        if (dick)
        {
            outputText("girth of your prick");
        }
        else
        {
            outputText("girl-th of your swollen button");
        }
        ...
        if (player.hasBalls())
        {
            ...
            if (!player.hasCock())
            {
                outputText(".  As your [balls] swell with blood and seed, you can't help but groan; there'll be nowhere for the largess to go, and it will be with you until your body reabsorbs it - or you make an outlet");
            }
        }
        ...
        if (dick)
        {
            ...
            if (player.cumQ() >= 1000)
            {
                outputText("  You push so much cum into her that her belly actually rounds from the volume, transforming from a sleek, flat midriff into a barely-contained ball of sloshing liquid");
            }
            if (player.cumQ() >= 2000)
            {
                outputText("; even when her stomach skin can stretch no further, your body won't stop filling her, and the bulge expands up her esophagus, pushing out her chest and throat until she's full to the brim and rather reminiscent of a big, blue pear");
            }
            if (player.cumQ() >= 1000)
            {
                outputText(".");
            ...
            if (player.cumQ() >= 1000)
            {
                outputText("bobbing roundly in the water as she tries to make her way from the shallows, ");
            }
        ...
        else
        {
            ...
            if (player.wetness() < 4)
            {
                outputText("drools its lube along your length.  ");
            }
            else
            {
                outputText("squirts obscenely, coating your length and her face with your female orgasm.  ");
            }
            outputText("Your body shivers as near-painful sensations wrack you, engulfed in the anemone's questing passage");
            if (player.hasBalls())
            {
                outputText(".  Your lover, hopeful, watches and waits for your testicles to rise into your groin and unload their cargo");
            }
            if (player.cockTotal() == 0)
            {
                outputText("; she even tries to push them up herself with her hands, as if that would make your clit produce the semen inside them");
            }
            outputText(".");
            if (player.hasCock())
            {
                outputText("  Your clit remains unproductive; your male orgasm squirts out uselessly around her head, mingling with the ");
            }
            if (flags[kFLAGS.ANEMONE_OR_SEA_ANEMONE] == 1)
            {
                outputText("lake");
            ...
            if (player.hasCock())
            {
                outputText(", pointing to the squiggles of your seed floating lazily in the ");
            }
            if (flags[kFLAGS.ANEMONE_OR_SEA_ANEMONE] == 1)
            {
                outputText("lake");
    ...
    //[Hotdog!]
    private function hotdogTheAnemone(dick : Bool) : Void
    {
        clearOutput();
        ...
        if (dick)
        {
            outputText("excited by the feel and sight of your pre-cum");
        }
        else
        {
            outputText("looking almost bored");
        }
        ...
        if (dick)
        {
            outputText("your [cockHead " + (x + 1) + "]");
        }
        else
        {
            outputText("the nerve-packed end of your [clit]");
        }
        ...
        if (dick)
        {
            outputText("now-throbbing prick");
        }
        else
        {
            outputText("swollen, red clit");
        }
        ...
        if (dick)
        {
            ...
            if (player.cumQ() >= 500)
            {
                outputText("  When you've finished, not a single place on the anemone's backside is still blue; the giddy girl is shoving your semen into her mouth with her tentacles and hands, swallowing almost as much ");
            }
            if (flags[kFLAGS.ANEMONE_OR_SEA_ANEMONE] == 1)
            {
                outputText("lake");
        ...
        else
        {
            ...
            if (player.wetness() < 4)
            {
                outputText("drooling its lube down your thighs.");
            }
            else
            {
                outputText("squirting cum behind you to rain onto your partner's calves and the surface of the ");
            }
            if (flags[kFLAGS.ANEMONE_OR_SEA_ANEMONE] == 1)
            {
                outputText("lake");
        ...
        if (dick)
        {
            outputText("dares not move from her knees, balancing your freshly-shot load on her back as she tries to push it toward her face with her tentacles.");
        }
        else
        {
            outputText("looks indolently at you as you go.");
        }
    ...
    private function anemoneGetsLayedByBeePositor() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("reclining");
        }
        else
        {
            outputText("vigorously masturbating");
        }
        ...
        if (player.isTaur() || player.lust >= 0.5 * player.maxLust())
        {
            ...
            if (player.hasCock())
            {
                ...
                if (player.cockTotal() == 1)
                {
                    outputText("male part erupts");
                }
                else
                {
                    outputText("male parts erupt");
                }
        ...
        else
        {
            ...
            if (player.eggs() < 20)
            {
                outputText("It doesn't take long before you finish, pushing your cargo down her passageway in a neat, orderly line.");
            }
            else
            {
                ...
                if (player.eggs() >= 40)
                {
                    outputText("; these same bumps multiply upward as your long-suffering abdomen pushes out line upon line of eggs, and soon you can feel them pressing back against the tip of your ovipositor.  You squeeze the girl's head in your hands, holding her against the base, and concentrate; slowly, the deposited eggs give way to their siblings, stretching her elastic stomach and chest wide");
                }
                outputText(".");
            }
            ...
            if (silly() && player.fertilizedEggs() > 1)
            {
                outputText("  You briefly amuse yourself imagining her carrying your eggs to term and having them hatch in her mouth, so that when she talks, she shoots bees.  Nicolas Cage would be proud.");
            }
    ...
    private function spiderOvipositAnAnemone() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("eyes unfocused with fatigue");
        }
        else
        {
            outputText("two fingers plunging eagerly into her pussy");
        }
        ...
        if (player.hasCock())
        {
            outputText(", and your [armor] tightens as [eachCock] swells");
        }
        else if (player.hasVagina())
        {
            outputText(", and the inside of your [armor] dampens with the lube your [vagina] leaves as it clenches around empty air");
        }
        ...
        if (player.cor < 60)
        {
            outputText(", even though her adorable and slightly surreal puppy dog eyes implore you otherwise");
        }
        ...
        if (player.gender > 0)
        {
            outputText("while unfastening your [armor] with one hand, ");
        }
        ...
        if (player.eggs() >= 40)
        {
            outputText("; so many eggs pump into her that she gives a little start when her distended belly touches the lukewarm water below");
        }
