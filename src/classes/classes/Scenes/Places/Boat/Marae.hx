...
class Marae extends Monster
{
    ...
    public function vinesAttack() : Void
    {
        ...
        if (evade == EVASION_SPEED)
        {
            outputText("and you successfully dodge her vines!");
        }
        else if (evade != null)
        {
            outputText("and you successfully dodge her vines thanks to your superior evasion!");
        }
        else
        {
    ...
    public function smiteHit() : Void
    {
        ...
        else
        {
            ...
            if (player.cor >= 50)
            {
                outputText("The intensity of the pain is unbearable. ");
            }
            var damage : Int = as3hx.Compat.parseInt((1100 + rand(150) + eBaseIntelligenceDamage() + eBaseWisdomDamage() + (player.cor * 20)) * 2.5);
            damage = Math.round(damage);
    ...
    public function new()
    {
        ...
        else
        {
            ...
            {
                this.createPerk(PerkLib.MonsterRegeneration, 6, 0, 0, 0);
            }
        }
