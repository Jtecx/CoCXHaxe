...
class SharkGirlScene extends AbstractBoatContent
{
    //[Explore Lake]
    ...
    //Set 'PC met Sharkgirls' for Izma stuff
    {
        ...
        if (flags[kFLAGS.IZMA_ENCOUNTER_COUNTER] == 0)
        {
            flags[kFLAGS.IZMA_ENCOUNTER_COUNTER] = 1;
        }
        if (!player.hasStatusEffect(StatusEffects.SharkGirl))
        {
            player.createStatusEffect(StatusEffects.SharkGirl, 0, 0, 0, 0);
        }
    ...
    //HP Win
    {
        ...
        else
        {
            if (player.gender == 0)
            {
                outputText("You lack the required parts to fuck her.");
            }
            else
            {
    ...
    private function oceanSexMenu() : Void
    {
        ...
        else
        {
            if (player.gender == 0)
            {
                outputText(", but you're not in the mood.");
            }
            else
            {
                outputText(", but you can't figure out how exactly to do that.");
            }
            cleanupAfterCombat();
        }
    }
    ...
    private function sharkgirlDickFuck() : Void
    {
        ...
        if (player.gender == 3)
        {
            outputText("While sucking you off, her hand steadily snakes its way between your legs. Without warning, she shoves three fingers into your " + vaginaDescript(0) + ", pushing in and stretching the moist passage out.\n\n");
        }
        ...
        if (player.gender == 3)
        {
            outputText("  The sensation is incredible, and you find yourself massaging your " + biggestBreastSizeDescript() + " and tweaking your " + nippleDescript(0) + "s in an attempt to bring your pleasure to even greater heights.");
        }
    ...
    private function sharkgirlOceanDickFuck() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("While sucking you off, her hand steadily snakes its way between your legs. Without warning, she shoves three fingers into your loose cunt, pushing in and stretching the moist passage out.\n\n");
        }
    ...
    private function sharkgirlSixtyNine() : Void
    {
        ...
        if (player.gender == 2)
        {
            outputText(", pulling out every few minutes to lick your " + clitDescript() + ".");
        }
        //[if herm]
        if (player.gender == 3)
        {
            outputText(". You remind her not to neglect your [cock], and the shark girl responds by thoroughly licking your hard erection and sucking at your [balls].");
        }
        outputText("\n\n");
        ...
        if (player.gender == 2)
        {
            outputText(", juices spraying from your sex and coating the girl's face.");
        }
        //[if herm]
        else
        {
            outputText(" and stand up, gripping your [cock] and splattering thick jets of cum onto her face.");
        }
    ...
    private function sharkgirlOceanSixtyNine() : Void
    {
        ...
        if (player.gender == 3)
        {
            outputText(" and stand up, gripping your [cock] and splattering thick jets of cum onto her face. The shark slut licks up your fluids hungrily.");
        }
        if (player.gender == 2)
        {
            outputText(", juices spraying from your sex and coating the girl’s face. The shark slut licks up your fluids hungrily.");
        }
    ...
    //Loss Rape scenes:
    @:allow(classes.scenes.places.boat)
    private function sharkLossRape() : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_sharkgirl);
        //Genderless:
        ...
        function vagF() : Void
        {
            ...
            if (player.gender == 3)
            {
                outputText("Seeing your [cock] puts a smile on the shark girl's face as she takes a firm grip on your erection. \"<i>Well, you're just full of surprises, aren't you? Maybe I'll give this bad boy a whirl sometime. For now though...</i>\"  ");
            }
    ...
    public function sharkLossOceanRape() : Void
    {
        ...
        {
            outputText(", forcefully feeding you a strange kelp in the process. Somehow thanks to the aquatic plant you manage to breath underwater");
        }
        ...
        else
        {
            ...
            if (player.hasCock())
            {
                outputText("You’re way too pathetic to get any decent fertilisation from. ");
            }
    ...
    public function sharkspackLossOceanRape() : Void
    {
        ...
        if (player.hasVagina())
        {
            if (player.hasCock())
            {
                outputText("your pussy and hers with");
            }
            else
            {
                outputText("your needy pussy full of her");
            }
        }
        else
        {
            outputText("her pussy with your");
        }
    ...
    private function sharkGirlGetsDildoed() : Void
    {
        ...
        {
            outputText("put away your [weapon] and ");
        }
        ...
        {
            outputText("She holds her legs together defiantly, but you pry them open, tear off her bikini bottom and expose her bald nether-lips.   You hold the dildo over her and squeeze, squirting a gush of pink fluid onto her exposed cunt.  The effect is immediate, and in moments she's humping the air and wet with her own fluids.");
        }
        outputText("\n\n");
