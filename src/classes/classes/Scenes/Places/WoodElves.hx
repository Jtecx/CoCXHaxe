...
class WoodElves extends BaseContent implements SaveableState
{
    
    public static var WoodElvesQuest : Int;
    public static var QUEST_STAGE_METELFSANDEVENBEATSTHEM : Int = -1;
    public static inline var QUEST_STAGE_NOT_STARTED : Int = 0;
    public static inline var QUEST_STAGE_METELF : Int = 1;
    public static inline var QUEST_STAGE_LOSTTOELF : Int = 2;
    public static inline var QUEST_STAGE_TOPICUNLOCKED : Int = 3;
    public static inline var QUEST_STAGE_PCFUCKOFF : Int = 4;
    public static inline var QUEST_STAGE_PCELF : Int = 5;
    public static inline var QUEST_STAGE_PCNOTELF : Int = 6;
    public static inline var QUEST_STAGE_PCCAMEBACK : Int = 7;
    
    public static var WoodElfBowTraining : Int;
    public static inline var QUEST_STAGE_BOWTRAINING0 : Int = 0;
    public static inline var QUEST_STAGE_BOWTRAINING1 : Int = 1;
    public static inline var QUEST_STAGE_BOWTRAINING2 : Int = 2;
    public static inline var QUEST_STAGE_BOWTRAINING3 : Int = 3;
    public static inline var QUEST_STAGE_BOWTRAINING4 : Int = 4;
    public static inline var QUEST_STAGE_BOWTRAINING5 : Int = 5;
    public static inline var QUEST_STAGE_BOWTRAINING6 : Int = 6;
    
    public static var WoodElfSpearTraining : Int;
    public static inline var QUEST_STAGE_SPEARTRAININGFIRST : Int = 0;
    public static inline var QUEST_STAGE_SPEARTRAINING0 : Int = 1;
    public static inline var QUEST_STAGE_SPEARTRAINING1 : Int = 2;
    public static inline var QUEST_STAGE_SPEARTRAINING2 : Int = 3;
    public static inline var QUEST_STAGE_SPEARTRAINING3 : Int = 4;
    public static inline var QUEST_STAGE_SPEARTRAINING4 : Int = 5;
    
    public static var WoodElfMagicTraining : Int;
    public static inline var QUEST_STAGE_MAGICTRAINING0 : Int = 0;
    public static inline var QUEST_STAGE_MAGICTRAINING1 : Int = 1;
    public static inline var QUEST_STAGE_MAGICTRAINING2 : Int = 2;
    public static inline var QUEST_STAGE_MAGICTRAINING3 : Int = 3;
    public static inline var QUEST_STAGE_MAGICTRAINING4 : Int = 4;
    public static inline var QUEST_STAGE_MAGICTRAINING5 : Int = 5;
    public static inline var QUEST_STAGE_MAGICTRAINING6 : Int = 6;
    public static inline var QUEST_STAGE_MAGICTRAINING7 : Int = 7;
    public static var WoodElfMagicTraner : Bool;
    public static var WoodElfMagicTranerSex : Int;
    public static var WoodElfMagicTranerGetLaid : Bool;
    
    public static var WoodElfSeductionTraining : Int;
    public static inline var QUEST_STAGE_SEDUCTIONTRAINING0 : Int = 0;
    public static inline var QUEST_STAGE_SEDUCTIONTRAINING1 : Int = 1;
    public static inline var QUEST_STAGE_SEDUCTIONTRAINING2 : Int = 2;
    public static var hasTrainedToday : Bool;
    
    public static var ConvertedSisters : Int;
    public static var ConvertedHerms : Int;
    public static var CapturedSisters : Array<Dynamic>;
    public static var CapturedHerms : Array<Dynamic>;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            WoodElvesQuest = Reflect.field(o, "stage");
            WoodElfBowTraining = Reflect.field(o, "stageBow");
            WoodElfSpearTraining = Reflect.field(o, "stageSpear");
            hasTrainedToday = Reflect.field(o, "elfHasTrainedToday");
            WoodElfMagicTraining = valueOr(Reflect.field(o, "stageMagic"), 0);
            WoodElfSeductionTraining = valueOr(Reflect.field(o, "stageSeduction"), 0);
            WoodElfMagicTraner = valueOr(Reflect.field(o, "WoodElfMagicTraner"), false);
            WoodElfMagicTranerSex = valueOr(Reflect.field(o, "WoodElfMagicTranerSex"), 0);
            WoodElfMagicTranerGetLaid = valueOr(Reflect.field(o, "WoodElfMagicTranerGetLaid"), false);
            ConvertedSisters = valueOr(Reflect.field(o, "ConvertedSisters"), 0);
            ConvertedHerms = valueOr(Reflect.field(o, "ConvertedHerms"), 0);
            CapturedSisters = valueOr(Reflect.field(o, "CapturedSisters"), []);
            CapturedHerms = valueOr(Reflect.field(o, "CapturedHerms"), []);
        }
    ...
    public function LeaveStartElfFight() : Void
    {
        ...
        if (silly())
        {
            outputText(" Those dastardly ladies! Of all things you're in the midst of a circle of hedonistic elves!");
        }
    ...
    public function YouAreAlreadyElf1() : Void
    {
        ...
        if (player.hasCoat())
        {
            outputText("With a shock you look down at your body to see your [skinfurscales] melting away and washing off, replaced by smooth, silky skin. ");
        }
        if (player.tailType != Tail.NONE || player.wings.type != Wings.NONE || player.legCount != 2)
        {
            outputText("Soon after, your other extra, unneeded appendages begin to shrivel and melt away as well. ");
        }
        if (player.hasCoat() || player.tailType != Tail.NONE || player.wings.type != Wings.NONE || player.legCount != 2)
        {
            outputText("despite the radical changes your form is undergoing, ");
        }
        else
        {
            outputText("Despite being violated in every hole you have, and some you don’t, ");
        }
        ...
        if (player.cocks.length >= 1)
        {
            ...
            {
                outputText("s, and don’t even flinch as it pulls them off as easily as one might pluck a ripe fruit from a tree. You never needed them anyway, ridiculous, ugly things; you’re much better off without them.");
            }
            else
            {
                outputText(", and don’t even flinch as it pulls it off as easily as one might pluck a ripe fruit from a tree. You never needed it anyway, ridiculous, ugly thing; you’re much better off without it.");
            }
            if (!player.hasVagina())
            {
        ...
        {
            player.removeBreastRow(player.breastRows.length - 1, player.breastRows.length - 1);
        }
        if (player.biggestTitSize() <= 4)
        {
            var sizeIncrement : Float = 5 - player.biggestTitSize();
    ...
    public function YouAreAlreadyElf2() : Void
    {
        ...
        {
            outputText(" Wait, didn’t you have some things with you before? Important things…?");
        }
    ...
    public function Ceremony1() : Void
    {
        ...
        {
            outputText(", maybe it's your disillusion toward mankind, after all, the elders of your village sold you into slavery.");
        }
    ...
    public function GroveLayout() : Void
    {
        ...
        if (WoodElvesQuest != QUEST_STAGE_PCCAMEBACK)
        {
            ...
            if (!player.isRace(Races.ELF, 1, false) && !player.isRace(Races.WOODELF, 1, false))
            {
                outputText("<i> Well... you did change a little, but that doesn't matter. You're still, and forever will be family!.</i>");
            }
            outputText("\"" +
            ...
            if (!player.isRace(Races.ELF, 1, false) && !player.isRace(Races.WOODELF, 1, false))
            {
                outputText("<i> Doesn't matter if you've changed, t</i>");
            }
            else
            {
                outputText("<i>T</i>");
    ...
    ///ELF VILLAGE SECTION///
    public function GroveLayout2(isFirstTime : Bool = false) : Void
    {
        spriteSelect(SpriteDb.s_WoodElves);
        if (!isFirstTime)
        {
            outputText("The elven village is at its usual calm today. Your sisters are playfully frolicking around in the grove. Sewing, swimming, playing music, or in some rare cases training with weapons in the small area dedicated to archery and more martial pursuits." +
        ...
        {
            outputText(" Well, what's left of it… it's hard to get any sun with those damn clouds covering the sky.");
        }
        menu();
        addButton(0, "River", River).disableIf(!player.isRace(Races.ELF, 1, false) && !player.isRace(Races.WOODELF, 1, false), "You need to be an elf in order to go bath with the girls.").disableIf(!player.hasVagina(), "You can't seriously go back naked with girls as a guy! Just what were you thinking, You degenerate pervert!?");
        addButton(1, "Tent", Tent).disableIf(!player.isRace(Races.ELF, 1, false) && !player.isRace(Races.WOODELF, 1, false), "You need to be an elf.").disableIf(!player.hasVagina(), "You need to be female or herm in order to use the tents.");
        addButton(2, "Fletching table", Fletching);
        addButton(3, "Elenwen", Elenwen).disableIf(hasTrainedToday, "You need a break from your recent training before you can train again.").disableIf(!player.isElf(), "Elenwen has personal preferences in regards to the people she will train, maybe you should make yourself more elf like.").disableIf(!player.hasVagina(), "Elenwen has personal preferences in regards to the people she will train with... it's not like archery is just for girls, but considering the fact that she's practicing naked... ");
        addButton(4, "Alyssa", Alyssa).disableIf(hasTrainedToday, "You need a break from your recent training before you can train again.").disableIf(!player.isElf(), "Alyssa has personal preferences in regards to the people she will train, maybe you should make yourself more elf like.").disableIf(!player.hasVagina(), "Alyssa has personal preferences in regards to the people she will train with... it's not like the spear is a girl only discipline, but the way she uses it might as well be... ");
        addButton(5, "Lutien", Lutien);
        addButton(6, "Chelsea", Chelsea).disableIf(hasTrainedToday, "You need a break from your recent training before you can train again.");
    ...
    public function River() : Void
    {
        ...
        if (!player.statStore.hasBuff("Sisterly bathing"))
        {
            ...
            player.buff("Sisterly bathing").addStats({
                                        int : 20,
                                        wis : 20
                                    }).withText("Sisterly bathing").forDays(1);
        }
        else
        {
    ...
    public function Fletching() : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_WoodElves);
        if (!player.hasStatusEffect(StatusEffects.FletchingTable))
        {
            player.createStatusEffect(StatusEffects.FletchingTable, 0, 0, 0, 0);
        }
    ...
    public function FletchingCraftArrows() : Void
    {
        ...
        menu();
        if (player.hasItem(useables.IARROWHEAD, 1))
        {
            addButton(0, "Iron", FletchingCraftArrows2, "iron", 1).hint("Use iron arrowheads to craft arrows.");
        }
        if (player.hasItem(useables.MARROWHEAD, 1))
        {
            addButton(1, "Moonstone", FletchingCraftArrows2, "moonstone", 2).hint("Use moonstone arrowheads to craft arrows.");
        }
        if (player.hasItem(useables.SARROWHEAD, 1))
        {
            addButton(2, "Skymetal", FletchingCraftArrows2, "skymetal", 3).hint("Use skymetal arrowheads to craft arrows.");
        }
        if (player.hasItem(useables.EARROWHEAD, 1))
        {
            addButton(3, "Ebonbloom", FletchingCraftArrows2, "ebonbloom", 4).hint("Use ebonbloom arrowheads to craft arrows.");
        }
        //Skymetal(Found in glacial rift) +30% Damage
        addButton(14, "Back", Fletching);
    }
    private function FletchingCraftArrows2(itype : String, type : Float) : Void
    {
        clearOutput();
        ...
        {
            player.createPerk(PerkLib.CraftedArrows, 0, 0, 0, 0);
        }
        switch (type)
        {
            case 1:
    ...
    public function FletchingAdjustString() : Void
    {
        ...
        menu();
        if (player.statusEffectv2(StatusEffects.FletchingTable) > 0)
        {
            addButtonDisabled(0, "SpiderSilk", "You already used this for improving bow string.");
        }
        else if (player.hasItem(useables.T_SSILK, 1))
        {
            addButton(0, "SpiderSilk", FletchingAdjustString2, useables.T_SSILK);
        }
        else
        {
            addButtonDisabled(0, "SpiderSilk", "You need spider silk.");
        }
        if (player.statusEffectv2(StatusEffects.FletchingTable) > 1)
        {
            addButtonDisabled(1, "Ebonbloom", "You already used this for improving bow string.");
        }
        else if (player.hasItem(useables.EBONBLO, 1))
        {
            if (player.statusEffectv2(StatusEffects.FletchingTable) < 1)
            {
                addButtonDisabled(1, "Ebonbloom", "You need to improve string with spider silk first.");
            }
            else
            {
                addButton(1, "Ebonbloom", FletchingAdjustString2, useables.EBONBLO);
            }
        }
        else
        {
            addButtonDisabled(1, "Ebonbloom", "You need ebonbloom.");
        }
        if (player.statusEffectv2(StatusEffects.FletchingTable) > 2)
        {
            addButtonDisabled(2, "UnicornHair", "You already used this for improving bow string.");
        }
        else if (player.hasItem(useables.UNICORNH, 1))
        {
            if (player.statusEffectv2(StatusEffects.FletchingTable) < 2)
            {
                addButtonDisabled(2, "UnicornHair", "You need to improve string with ebonbloom first.");
            }
            else
            {
                addButton(2, "UnicornHair", FletchingAdjustString2, useables.UNICORNH);
            }
        }
        else
        {
            addButtonDisabled(2, "UnicornHair", "You need unicron hair.");
        }
        addButton(14, "Back", Fletching);
    }
    ...
    public function FletchingReinforce() : Void
    {
        ...
        menu();
        if (player.statusEffectv1(StatusEffects.FletchingTable) > 0)
        {
            addButtonDisabled(0, "Bronze", "You already used this for reinforcing bow.");
        }
        else if (player.hasItem(useables.BRONZEB, 1) || Crafting.BagSlot03 > 0)
        {
            addButton(0, "Bronze", FletchingReinforce2, useables.BRONZEB, 1);
        }
        else
        {
            addButtonDisabled(0, "Bronze", "You need bronze bar.");
        }
        if (player.statusEffectv1(StatusEffects.FletchingTable) > 1)
        {
            addButtonDisabled(1, "Iron", "You already used this for reinforcing bow.");
        }
        else if (player.hasItem(useables.IRONORE, 1) || Crafting.BagSlot04 > 0)
        {
            if (player.statusEffectv1(StatusEffects.FletchingTable) < 1)
            {
                addButtonDisabled(1, "Iron", "You need to reinforce bow with bronze first.");
            }
            else
            {
                addButton(1, "Iron", FletchingReinforce2, useables.IRONORE, 2);
            }
        }
        else
        {
            addButtonDisabled(1, "Iron", "You need iron ore.");
        }
        if (player.statusEffectv1(StatusEffects.FletchingTable) > 2)
        {
            addButtonDisabled(2, "Moonstone", "You already used this for reinforcing bow.");
        }
        else if (player.hasItem(useables.MOONSTO, 1) || Crafting.BagSlot07 > 0)
        {
            if (player.statusEffectv1(StatusEffects.FletchingTable) < 2)
            {
                addButtonDisabled(2, "Moonstone", "You need to reinforce bow with iron first.");
            }
            else
            {
                addButton(2, "Moonstone", FletchingReinforce2, useables.MOONSTO, 3);
            }
        }
        else
        {
            addButtonDisabled(2, "Moonstone", "You need moonstone.");
        }
        if (player.statusEffectv1(StatusEffects.FletchingTable) > 3)
        {
            addButtonDisabled(3, "EbonIng", "You already used this for reinforcing bow.");
        }
        else if (player.hasItem(useables.EBONING, 1) || Crafting.BagSlot06 > 0)
        {
            if (player.statusEffectv1(StatusEffects.FletchingTable) < 3)
            {
                addButtonDisabled(3, "EbonIng", "You need to reinforce bow with moonstone first.");
            }
            else
            {
                addButton(3, "EbonIng", FletchingReinforce2, useables.EBONING, 4);
            }
        }
        else
        {
            addButtonDisabled(3, "EbonIng", "You need ebon ingot.");
        }
    ...
    private function FletchingReinforce2(itype : ItemType, type : Float) : Void
    {
        ...
        {
            case 1:
                if (Crafting.BagSlot03 > 0)
                {
                    Crafting.BagSlot03 -= 1;
                }
                else
                {
                    player.destroyItems(itype, 1);
            ...
            case 2:
                if (Crafting.BagSlot04 > 0)
                {
                    Crafting.BagSlot04 -= 1;
                }
                else
                {
                    player.destroyItems(itype, 1);
            ...
            case 3:
                if (Crafting.BagSlot07 > 0)
                {
                    Crafting.BagSlot07 -= 1;
                }
                else
                {
                    player.destroyItems(itype, 1);
            ...
            case 4:
                if (Crafting.BagSlot06 > 0)
                {
                    Crafting.BagSlot06 -= 1;
                }
                else
                {
                    player.destroyItems(itype, 1);
    ...
    private function bowSkill1(diff : Float) : Float
    {
    ...
    private function bowSkill2(diff : Float) : Float
    {
        if (player.statusEffectv1(StatusEffects.Kindra) < 75)
        {
            var gain : Float = diff;
            if (player.statusEffectv1(StatusEffects.Kindra) + diff > 75)
            {
                gain = (75 - player.statusEffectv1(StatusEffects.Kindra));
            }
    ...
    public function Elenwen() : Void
    {
        ...
        if (player.armor.isNothing)
        {
            outputText("down to your glistening slit");
        }
        else
        {
            outputText("under your equipment to your glistening slit");
        }
        ...
        if (player.statusEffectv1(StatusEffects.Kelt) < 100)
        {
            outputText("manage to make a shot Elenwen considers fair for her standards.");
        }
        if (player.statusEffectv1(StatusEffects.Kelt) >= 100)
        {
            outputText("hit a bullseye, and Elenwen praises your efforts before you say your goodbyes.");
        }
        ...
        {
            player.createStatusEffect(StatusEffects.Kelt, 5, 0, 0, 0);
        }
        else if (player.statusEffectv1(StatusEffects.Kelt) >= 100)
        {
            if (!player.hasStatusEffect(StatusEffects.Kindra))
            {
                player.createStatusEffect(StatusEffects.Kindra, 5, 0, 0, 0);
            }
            else
            {
                bowSkill2(5);
    ...
    {
        if (WoodElfMagicTraining == QUEST_STAGE_MAGICTRAINING0)
        {
            Lutien0();
        }
        else if (WoodElfMagicTraining == QUEST_STAGE_MAGICTRAINING1)
        {
            Lutien1();
        }
        else
    ...
    public function Lutien2() : Void
    {
        ...
        if (WoodElfMagicTraining == QUEST_STAGE_MAGICTRAINING0)
        {
            WoodElfMagicTraining = QUEST_STAGE_MAGICTRAINING1;
        }
        endEncounter();
    }
    ...
    public function LutienMain() : Void
    {
        ...
        menu();
        addButton(0, "Train", LutienTrain).disableIf(hasTrainedToday, "You need a break from your recent training before you can train again.");
        if (WoodElfMagicTraining >= QUEST_STAGE_MAGICTRAINING3)
        {
            addButton(1, "Sex", LutienMainSex);
        }
        else
        {
            addButtonDisabled(1, "???", "???");
    ...
    public function LutienMainSex() : Void
    {
        ...
        if (WoodElfMagicTranerSex >= 1)
        {
            addButton(0, "Bondage", LutienBondage).hint("Something about his presence is enthralling… let him take control");
        }
        if (WoodElfMagicTranerSex >= 2)
        {
            addButton(1, "Fuck Bussy", LutienFuckBussy).hint((silly()) ? "Fuck it. A hole is a hole." : "Does it matter if he’s not a girl? He’s still as pretty as any other elf.").disableIf(!player.hasCock(), "You need a penis");
        }
    ...
    private function LutienBondage() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("The vines slowly grope at your erection, causing you to drool precum as they slowly work away at your resistance.[pg]");
        }
        if (player.hasVagina())
        {
            outputText("The vines slowly trace around your labia, prodding at your clit, yet refusing to penetrate you as it works away at your resistance.[pg]");
        }
    ...
    {
        if (WoodElfSeductionTraining == QUEST_STAGE_SEDUCTIONTRAINING0)
        {
            ChelseaIntro();
        }
        else
    ...
    public function ConvertNewSisters() : Bool
    {
        var needNext : Bool;
        var sister : Int = as3hx.Compat.parseInt(CapturedSisters.length - 1);
        while (sister >= 0)
        {
            if (--CapturedSisters[sister] <= 0)
            {
                ConvertedSisters++;
                CapturedSisters.splice(sister, 1)[0];
                outputText("\nYou sense one of your new elf sisters has completed the covenant.\n");
                needNext = true;
            }
            sister--;
        }
        var herm : Int = as3hx.Compat.parseInt(CapturedHerms.length - 1);
        while (herm >= 0)
        {
            if (--CapturedHerms[herm] == 0)
            {
                ConvertedHerms++;
                CapturedHerms.splice(herm, 1)[0];
                outputText("\nYou sense one of your new elf sisters has completed the covenant.\n");
                needNext = true;
            }
            herm--;
