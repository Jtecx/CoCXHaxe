...
class KitsuneAncestor extends Monster
{
    public function kitsunespellMod() : Float
    {
        var kmods : Float = 1;
        var kmods2 : Float = 1;
    ...
    public function kitsunesoulskillMod() : Float
    {
        var kmodss : Float = 1;  //bonusy 3x  
    ...
    override private function performCombatAction() : Void
    {
        ...
        if (choice > 1)
        {
            ...
            else if (mana >= 300 && soulforce >= 108)
            {
                KitsuneCastsFoxFire();
            }
            else
    ...
    {
        var sageBelow40 : Bool = (HP < maxHP() * 0.4);
