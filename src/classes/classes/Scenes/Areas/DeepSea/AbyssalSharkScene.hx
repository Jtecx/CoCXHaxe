...
class AbyssalSharkScene extends BaseContent
{
    ...
    public function oceanJuvenileAbyssalSharkEncounter() : Void
    {
        ...
        {
            player.createStatusEffect(StatusEffects.UnderwaterOutOfAir, 0, 0, 0, 0);
        }
        ...
        {
            player.createStatusEffect(StatusEffects.CombatWounds, 0.05, 0, 0, 0);
        }
    ...
    public function oceanJuvenileAbyssalSharkVictorious() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("your wounds too severe to carry on");
        }
        else
        {
            outputText("arousal taking the best of you");
        }
