...
class FemaleSpiderMorphScene extends BaseContent implements TimeAwareInterface
{
    ...
    public function timeChange() : Bool
    {
        ...
        }  //Silently clear the spider morph's pregnancy if the player doesn't see the egg sac in time  
        return false;
    }
    ...
    public function fSpiderMorphGreeting() : Void
    {
        ...
        {
            outputText("You go exploring in the swamp, and before you get far, a female spider-morph appears!  She's clearly different than the last one you ran into, though many of her features remain the same.  You realize she's no more than a dozen paces away and slowly approaching with a strange glint in her eye.\n\n");
        }
        //Menu for either
    ...
    private function talkToFSpiderMorph() : Void
    {
        ...
        else
        {
            ...
            if (player.cor >= 50)
            {
                outputText("You grin, and likewise prepare to knock some sense into her.");
            }
            //Perhaps this should check wrath instead....
            else
            {
                outputText("You sigh, and prepare for combat as you wonder why everyone's first instinct is just to fight.");
            }
    ...
    private function defeatFemale() : Void
    {
        ...
        if (!CoC.instance.inCombat)
        {
            ...
            {
                outputText("playfully");
            }
            else
            {
                outputText("seductively");
            }
        ...
        else
        {
            ...
            if (player.hasCock())
            {
                outputText(SMultiCockDesc() + " flop about lewdly, leaving trails of pre-cum everywhere that they touch.  ");
            }
        ...
        {
            outputText(" with each draught of milk that she pulls from your lactating breasts");
        }
        else
        {
            outputText(" with each fruitless, nipple-engorging suckle she gives you");
        }
        outputText(".\n\n");
        ...
        {
            outputText("the other side of your chest");
        }
        else if (player.totalBreasts() == 2)
        {
            outputText("your other breast");
        }
        else
        {
            outputText("another one of your many breasts");
        }
        ...
        {
            outputText("the snake-like length the whole way into her womb, slithering right past her cervix.");
        }
        else if (player.tongue.type == Tongue.DEMONIC)
        {
            outputText("the massive, demonic length into her vagina, curling it around the walls and stroking them all with even motions.");
        }
        else if (player.hasLongTongue())
        {
            outputText("the inhuman length into her vagina, curling it around the walls and stroking them all with even motions.");
        }
        else
        {
            outputText("all of your length as deep into her passage as possible, licking and lapping at it in an orgasm-seeking frenzy.");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("erupts like a fountain, spraying over and over");
        }
        else
        {
            outputText("puddles juice on the ground over and over");
        }
    ...
    //*SUMMARY:  PC is tied down and has a web-condom sprayed around their dick, then a webbing cock-ring.  The PC is then ridden hard, bit numerous times, and never able to cum until pain lances through his (balls/cock) from the lack of release.  Finally, she bites PC's neck and the PC cums, inflating web-condom of various size.
    {
        ...
        if (!CoC.instance.inCombat)
        {
            ...
            if (player.lust < 70)
            {
                outputText("twitch and begin to stiffen in anticipation of sex with the beautiful spider-maid.");
            }
            else
            {
                outputText("twitch, already hard and aching for the touch of the beautiful spider-maid.");
            }
        ...
        if (!CoC.instance.inCombat)
        {
            outputText("You shrug and step back to lay down in the soft moss,");
        }
        else if (player.HP < 1)
        {
            outputText("You collapse into the soft moss,");
        }
        else
        {
            outputText("You collapse into the soft moss and begin to masturbate,");
        }
        ...
        {
            outputText("  One of the gossamer strands hits your arm hard enough to rip it away from your groin, and you're left pinned down, unable to touch yourself.");
        }
        ...
        if (CoC.instance.inCombat)
        {
            outputText("victorious arachnid.");
        }
        else
        {
            outputText("arachnid with a dangerous gleam in her eyes.  Why did you agree to this?");
        }
        outputText("\n\n");
        ...
        if (player.lust >= 80)
        {
            outputText("you thrust up as if you could somehow mate with her vagina in spite of your restraints");
        }
        else
        {
            outputText("you grow harder and harder, entranced by the sexy sight");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            {
                outputText("a similar ring");
            }
            else
            {
                outputText("similar rings");
            }
        ...
        {
            outputText("beast's seed");
        }
        else
        {
            outputText("strange, itinerate spider's seed");
        }
        ...
        {
            outputText("dragging over your own " + nippleDescript(0) + "s");
        }
        else
        {
            outputText("hovering just above your chest");
        }
        ...
        if (player.cumQ() < 25)
        {
            outputText("a baseball");
        }
        else if (player.cumQ() < 100)
        {
            outputText("a grapefruit");
        }
        else if (player.cumQ() < 400)
        {
            outputText("a basketball");
        }
        else if (player.cumQ() < 700)
        {
            outputText("a watermelon, dragging your dick down under its massive weight");
        }
        else if (player.cumQ() < 1500)
        {
            outputText("an exercise ball, smothering you under the web-wrapped cum");
        }
        else
        {
            outputText("a person, completely covering you before it finally bursts and drenches everything in the area with your copious cum");
        }
        outputText(".\n\n");
    ...
    private function femaleSpiderMorphTooBigWebRape() : Void
    {
        ...
        if (!CoC.instance.inCombat)
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText(", ignoring the other, smaller members");
            }
        ...
        else
        {
            ...
            if (player.lust >= player.maxOverLust())
            {
                outputText("stick your hands into your groin, fondling " + oMultiCockDesc() + " with need");
            }
            else
            {
                outputText("groan in obvious pain, unable to move");
            }
        ...
        if (player.balls == 0)
        {
            outputText("body is completely empty");
        }
        else
        {
            outputText("balls have completely emptied");
        }
        outputText(".\n\n");
        ...
        if (player.cumQ() < 50)
        {
            outputText("an apple-sized lump of cum on the tip of it, filled full of your submissive seed.");
        }
        else if (player.cumQ() < 300)
        {
            outputText("a grapefruit-sized bubble of cum on the tip of it, filled full of your submissive seed.");
        }
        else if (player.cumQ() < 700)
        {
            outputText("a basketball-sized balloon of cum at the tip of it, weighing you down and filled with a huge amount of your submissive seed.");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("a watermelon-sized balloon of cum at the tip of it, resting heavily atop your belly and sloshing with all the submissive seed you pumped into it.");
        }
        else if (player.cumQ() < 2000)
        {
            outputText("an exercise-ball sized mass of cum hanging from the tip of it, drooping over your body and sloshing wetly with all the submissive seed you pumped into it.");
        }
        else
        {
            ...
            if (player.cumQ() >= 4000)
            {
                outputText("  It pops, too weak to contain all that liquid pressure, soaking both of you with your spunk!");
            }
        }
    ...
    public function defeatASpiderBitch() : Void
    {
        ...
        {
            outputText(", thrusting two of her carapace-covered fingertips deep into her sloppy box as she gives into her lust.  She actually has the temerity to demand, \"<i>Fuck me, fuck me now!</i>\"");
        }
        else
        {
            outputText(", too wounded to fight back or run away.");
        }
        if (player.lust >= 33)
        {
    ...
    private function fSpiderMorphRape() : Void
    {
        ...
        if (player.lust >= player.maxOverLust())
        {
            outputText(", even as her fingers continue to work her slick lips relentlessly");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText(" until she's panting and her tiny clit has emerged, hard as a rock");
        }
        outputText(".\n\n");
        ...
        {
            outputText(", bumping and gliding against the black spider-cooch's sopping lips.");
        }
        else
        {
            outputText(", slowly spearing forward to penetrate the sopping wet spider-cooch with its decidedly unladylike length and girth.");
        }
        ...
        if (player.clitLength >= 4)
        {
            outputText("is seized by her velvet embrace just right, and you cum while fucking her with your 'tiny' nub.");
        }
        else
        {
            outputText("drags over her velvet lips just right, and you cum hard, screaming in ecstasy.");
        }
        outputText("\n\n");
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cumQ() >= 400)
            {
                ...
                if (player.cumQ() >= 400 && player.cumQ() < 1000)
                {
                    outputText("small ");
                }
                else if (player.cumQ() >= 2000)
        ...
        if (player.cor < 33)
        {
            outputText("In a moment of pity, you work to free her from the restraints before you leave.");
        }
        else if (player.cor < 66)
        {
            outputText("You feel a little guilty, and before you go, you untie the bindings around her hands so that she'll be able to free herself.");
        }
        else
        {
            outputText("You leave her there with her hands and feet completely restrained.  Sucks to be her.");
        }
    ...
    private function fSpiderMorphRapeDude() : Void
    {
        ...
        if (monster.lust <= 99)
        {
            outputText("relaxes a bit.  The smell of an aroused female wafts up from her, reminding you that is probably what she wanted from the get-go.");
        }
        else
        {
            outputText("salivates, both holes dripping liquid in anticipation of the coming sex.  The smell of sex fills the air, and you realize you're about to give her exactly what she wants.");
        }
        ...
        if (player.lust < 70)
        {
            outputText("thickening ");
        }
        else
        {
            outputText("pulsating");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText("cock flops about uselessly");
            }
            else
            {
                outputText("cocks flop about uselessly");
            }
        }
        ...
        if (player.cor < 50)
        {
            outputText("teasing the eager twat");
        }
        else
        {
            outputText("punishing the worthless twat");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" and slap your balls into her soaked taint");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() > 2)
            {
                outputText("rest spasm pointlessly");
            }
            else
            {
                outputText("other spasms pointlessly");
            }
        }
        else
        {
            outputText(" happily as it prepares to unload");
        }
        ...
        if (player.cumQ() >= 500)
        {
            ...
            if (player.cumQ() < 1000)
            {
                outputText(", you can tell from the small rounded bump that she's had plenty of baby-batter.");
            }
            else
            {
                outputText(", it's leaking out around the seal of her labia in a steady stream.  You make a puddle underneath her, and her belly is tight and stretched, like a pregnant woman's.");
            }
        }
        outputText("\n\n");
        ...
        if (player.cor < 33)
        {
            outputText("you wipe away her tears and kiss her, explaining that any new untainted life is a blessing.  She brightens at your kind words and returns her attention to her belly, still a bit dazed by it all.");
        }
        else if (player.cor < 66)
        {
            outputText("you shrug and sigh, wiping the tears from her eyes and feeling a slight twinge of guilt.  She still sniffles and rubs her belly, obviously confused about the new development.");
        }
        else
        {
            outputText("you slap her across the face and tell her to toughen up.  She starts to bawl at that, curling into a tight little ball and openly weeping.");
        }
    ...
    private function evilSpiderGirlVictoryAnal() : Void
    {
        ...
        var y : Float = player.cockThatFits2(monster.analCapacity());
        clearOutput();
        spriteSelect(SpriteDb.s_spidergirl);
        outputText("You peel off your [armor] while you gaze disdainfully down at your prize.  ");
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("She's moaning plaintively and happily fingering herself, practically offering her juicy box to you.");
        }
        else
        {
            outputText("She's groaning painfully and struggling to move before falling back down, legs akimbo, inadvertantly displaying her pussy to you.");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("She mewls with disappointment.  ");
        }
        ...
        if (y >= 0)
        {
            outputText(", while your " + cockDescript(y) + " slips into her warmed-up cunt.");
        }
        else
        {
            outputText(", the tight ring of her sphincter clutching feebly at you while you stretch it wider.");
        }
        ...
        if (y >= 0)
        {
            outputText(", but it's still tighter than the sloppy spider-cunt that keeps rhythmically devouring your " + cockDescript(y));
        }
        outputText(".\n\n");
        ...
        if (y == -1)
        {
            outputText("by splattering her fragrant lady-spunk into the dirt");
        }
        else
        {
        ...
        if (y != -1)
        {
            outputText(" and cum-drizzling slit");
        }
        ...
        if (player.hasBalls())
        {
            outputText("with your balls squirming and unloading");
        }
        else
        {
            outputText("prostate unloading");
        }
        ...
        if (player.cumQ() > 500)
        {
            ...
            {
                outputText(" massively, turning into a practically obscene bulge");
            }
        }
        outputText(".\n\n");
        ...
        if (y != 1)
        {
            ...
            pregnancy.knockUpForce(PregnancyStore.PREGNANCY_PLAYER, PregnancyStore.INCUBATION_SPIDER - 200);
        }
        player.sexReward("vaginalFluids", "Dick");
        if (!CoC.instance.inCombat)
        {
