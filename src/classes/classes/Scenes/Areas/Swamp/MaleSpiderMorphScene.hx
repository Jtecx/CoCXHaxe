...
class MaleSpiderMorphScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function defeatSpiderBoy() : Void
    {
        ...
        {
            outputText("masturbating with furious abandon, working his ebon dick with such vigor that the spider's pre-cum-slicked dick-skin noisily slides itself back and forth over his fattened glans; it becomes apparent just how much foreskin he truly has at this point, as even with his frenzied rubbing his glans remains shrouded in the thick excess skin while his fist slaps lewdly against his groin.  Dribbles of pre-cum leak from between his fingers to spill on the ground.");
        }
        else
        {
            outputText("wobbling back and forth as he tries to stay up and fight.  There's no way he can oppose you, as beaten as he is now.");
        }
        if (player.lust >= 33)
        {
            outputText("\n\nWhat do you do?");
    ...
    private function victoryButtFuck() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("He's too distracted by his foreskin fondling to pay much attention to your anal-focused attentions.");
        }
        else
        {
            outputText("He's too busy trying to stay upright to fight off your anal-focused attentions.");
        }
        ...
        {
            outputText("hardens to full size");
        }
        else
        {
            outputText("bobs happily");
        }
        ...
        if (rand(3) == 0)
        {
            outputText("I-I've never had anything in there...");
        }
        else
        {
            outputText("I-I don't want anything in there...");
        }
        outputText("</i>\"\n\n");
        ...
        if (monster.lust < monster.maxOverLust())
        {
            outputText("after he starts touching himself.");
        }
        else
        {
            outputText("while he fondles and caresses the sensitive flesh.");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            {
                outputText(" resting atop the small of his back");
            }
            else
            {
                outputText("es splaying out over his butt");
            }
        }
        outputText(".\n\n");
        ...
        if (player.cockTotal() == 2)
        {
            outputText("  The leftover dick spurts out its half of your load over his ass, making it look more pearly-white than ever before.");
        }
        else if (player.cockTotal() > 2)
        {
            outputText("  The leftover dicks spurt out their portion of your load across his ass-cheeks, making them look more pearl-white than ever before.");
        }
        if (player.cumQ() >= 500)
        {
    ...
    {
        var x1 : Int = as3hx.Compat.parseInt(player.biggestCockIndex() + 1);
        clearOutput();
        spriteSelect(SpriteDb.s_spiderguy);
        ...
        if (player.cockTotal() == 1)
        {
            outputText("Dropping it squarely ");
        }
        else
        {
            outputText("Dropping the largest ");
        }
        outputText("atop his miniature cock, you virtually bury it in a superior male's heavy penile flesh.  ");
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("He pants in surprise and pleasure, clearly enjoying the weighty shaft rubbing against his drooping dick-skin");
        }
        else
        {
            outputText("He gasps in surprise and slowly growing pleasure, clearly enjoying the weighty shaft rubbing against his drooping dick-skin");
        }
    ...
    //*Summary: Throw him on his back and mount up on that throbbing, ebon piece of uncut spidercock as he looks to you meekly, panting, needing something to tend to his foreskinned dick so badly...
    {
        ...
        if (monster.HP < 1)
        {
            outputText("trying to stay upright");
        }
        else
        {
            outputText("trying to drown himself in pleasure");
        }
        ...
        if (monster.HP < 1)
        {
            outputText("dripping dick");
        }
        else
        {
            outputText("gradually stiffening dick");
        }
        ...
        if (monster.HP < 1)
        {
            outputText("resulting in a stiff, pre-cum-dripping spider-cock.");
        }
        else
        {
            outputText("resulting in the spider-cock's hood of excess, sensitive flesh overfilling with sticky, musky pre-cum.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("lifting your balls and ");
        }
        ...
        if (player.cor < 33)
        {
            outputText("taking the time to clean the dripping spunk from your body.");
        }
        else if (player.cor < 66)
        {
            outputText("casually wiping away the worst of the dripping spunk.");
        }
        else
        {
            outputText("paying no heed to the thick flows of spunk that drip down your [legs].");
        }
        player.slimeFeed();
        //Pregnancy Goes Here
    ...
    private function spiderBoyLossMaleButtfuck() : Void
    {
        ...
        if (player.HP < 1)
        {
            ...
            {
                outputText("with worry");
            }
            else
            {
                outputText("in anticipation");
            }
            outputText(" at the male spider.");
        }
        else
        {
            outputText(", utterly overwhelmed by your desire for sex until the only thing that matters is letting the sexy spider have his way with you.");
        }
        ...
        if (player.isTaur())
        {
            outputText("hindquarters slightly");
        }
        else
        {
            outputText(player.legs() + " up and out of the way");
        }
        ...
        if (player.HP < 1)
        {
            outputText("and silently mouth, \"<i>Please, no.</i>\"");
        }
        else
        {
            outputText("and give a little nod, too intoxicated by arousal to decline any form of sex.");
        }
        ...
        {
            outputText(SMultiCockDesc() + " bounces atop your belly, reacting strongly to the tingling sensation radiating from your " + assholeDescript() + ".");
        }
        else
        {
            ...
            if (player.lust < 50)
            {
                outputText("slowly fills with blood");
            }
            else
            {
                outputText("fills completely with blood");
            }
        ...
        {
            outputText("mercifully easy due to the mess of pre-cum and the forgiving foreskin that clings to his shaft.  It rolls further and further back as he pushes in until his glans is exposed to your clenching guts.");
        }
        else
        {
            outputText("quite easy due to how well-stretched your " + assholeDescript() + " is.  Watching his fat little cock disappear into your roomy backside actually brings a smile to your lips.");
        }
        ...
        if (player.cor < 33)
        {
            outputText("You blush shamefully and nod, utterly humiliated by the quick little orgasm.");
        }
        else if (player.cor < 66)
        {
            outputText("You blush shamefully and nod, humiliated and aroused by how quickly you just came.");
        }
        else
        {
            outputText("You blush with arousal and humiliation, shaking your head up and down and hoping he'll hit that spot again.");
        }
        ...
        if (player.analCapacity() >= 40)
        {
            outputText("I just wish you were less loose, but I guess you must let anyone with a nice fat cock plug your ass every chance you get, huh?  ");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText("semen continues to leak out at the same pace");
        }
        else
        {
            outputText("semen trails off as you empty");
        }
        ...
        if (player.cumQ() < 500)
        {
            outputText(SMultiCockDesc() + " bounces on your belly, leaking one last drop from its tip, utterly draining every drop from your [balls].");
        }
        else
        {
            outputText(SMultiCockDesc() + " explodes again, dumping every remaining drop from your [balls] directly onto your " + chestDesc() + " and belly.");
        }
    ...
    private function loseToSpiderBoyVagFucked() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("wounds overwhelm");
        }
        else
        {
            outputText("lust overwhelms");
        }
        outputText(" you, your [legs] grow shaky, then give out entirely.  You flop down on your back");
        if (player.lust >= player.maxOverLust())
        {
            outputText(", caressing yourself with reckless abandon while praying the sexy spider-boy will come violate you with his thick-skinned prick.");
        }
        else
        {
            outputText(", clearly too injured and fatigued by the battle to make more than a few token movements.");
        }
        ...
        if (player.hasFuckableNipples())
        {
            outputText("into his mouth before plunging his tongue into the tit-pussy's passage");
        }
        else
        {
            outputText("into his mouth before circling his tongue around it");
        }
        outputText(".\n\n");
        ...
        if (player.HP < 1)
        {
            outputText("Even though you're injured, his oral attentions make the nub get so hard and sensitive that you quickly forget your own pain.");
        }
        else
        {
            outputText("Even though you tried to fight him, his oral attentions make your nub so hard and your horny body so eager that you quickly forget.");
        }
        ...
        {
            outputText("frotting against him");
        }
        else
        {
            outputText("grinding along the underside of his dick");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("pours out a river of lube");
        }
        else if (player.wetness() >= 3)
        {
            outputText("drools out a steady stream of lube");
        }
        else if (player.wetness() >= 2)
        {
            outputText("dribbles lube");
        }
        else
        {
            outputText("gets soaked");
        }
        outputText(", your " + nippleDescript(0) + "s ");
        if (player.hasFuckableNipples())
        {
            outputText("drip their own slippery juices");
        }
        else if (player.biggestLactation() >= 1)
        {
            outputText("bead drops of milk");
        }
        else
        {
            outputText("fully engorge");
        }
        outputText(", ");
        if (player.hasCock())
        {
            outputText(sMultiCockDesc() + " becomes so full and hard it feels like it could burst, ");
        }
        outputText("and your " + clitDescript() + " ");
        if (player.clitLength >= 4)
        {
            outputText("bounces up and down on your belly with each beat of your heart");
        }
        else
        {
            outputText("seems to pulsate with every beat of your heart");
        }
        outputText(".\n\n");
    ...
    public function spiderPregVagBirth(womb : Int = 0) : Void
    {
        ...
        if (player.gender != 2)
        {
            outputText("spraying your cum all over the ground underneath you, each egg squeezing out and prolonging the intense feeling.\n\n");
        }
        //[if female/genderless]
        else
        {
            outputText("spraying your juices all over the ground and mixing in with the green slime, soaking your legs, each egg you squeeze out only prolonging the intense feeling.\n\n");
        }
