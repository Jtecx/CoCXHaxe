...
class AbstractSpiderMorph extends Monster
{
    public function new()
    {
        super();
    ...
    //-Languid Bite - Inflicted on PC's who have been reduced to 1 speed by webbing, raises arousal by 60.
    {
        ...
        if (player.spe < 2 && player.buff("Web").isPresent())
        {
            ...
            if (player.hasCock())
            {
                ...
                if (player.hasVagina())
                {
                    outputText(" along with your [pussy]");
                }
                outputText(".  ");
            }
            else if (player.hasVagina())
            {
                outputText("Your [vagina] grows wet as hell and so sensitive that every step and movement reminds you of the powerful need for something between your sopping nether-lips.  ");
            }
            ...
            if (hasVagina())
            {
                outputText("The saucy dominatrix exhausts her supply of aphrodisiac toxin for the moment and finally steps back, admiring her work and giving you a lewd wink.  You ");
            }
            else
            {
                outputText("The confident male exhausts his supply of aphrodisiac toxin for the moment and finally steps back, admiring his work and giving you a lewd wink.  You ");
            }
            player.dynStats("lus", 300);
            if (player.lust >= player.maxOverLust())
            {
                outputText("wobble, utterly defeated and about to cave in to your lust.");
            }
            else
            {
                outputText("struggle not to fall down and start masturbating on the spot.");
            }
            outputText("\n");
            return;
        }
        ...
        else if (rand(5) == 0)
        {
            ...
            if (hasVagina())
            {
                outputText("casually cupping her breasts while you watch with venom-dilated eyes, slowly touching yourself.  Once she stops, you shake your head and master yourself, remembering that you're supposed to be fighting this " + mf("boy", "girl") + "!\n");
            }
            else
            {
                outputText("casually tugging on his relatively short, girthy dick as you watch with venom-dilated eyes, slowly touching yourself.  Once he stops, you shake your head and master yourself, remembering that you're supposed to be fighting this " + mf("boy", "girl") + "!\n");
            }
