...
class CorruptedDriderScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function defeatDriderIntro() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("to try to continue the fight, her movements slowed by pain and weakness.");
        }
        else
        {
            outputText("to masturbate her swollen pussy-lips and the thick, juicy demon-cock that's sprouted in place of her clit.  She's so focused on getting off that she utterly gives up on the idea of fighting back, let alone dominating you as she seemed to plan originally.");
        }
    ...
    private function winDriderPCDickInSpiderCunt() : Void
    {
        ...
        else
        {
            ...
            if (monster.nipplesPierced > 0)
            {
                outputText(", the chains jingling loudly as she does so");
            }
        ...
        if (monster.HP < 1)
        {
            outputText("giving up little, lewd moans");
        }
        else
        {
            outputText("breathing out lurid moans");
        }
        outputText(" of pleasure and her ");
        if (monster.nipplesPierced > 0)
        {
            outputText("chain-pierced-");
        }
        ...
        if (monster.nipplesPierced > 0)
        {
            outputText("  The chains binding her nipples make a delightful clinking noise with each squeeze and stroke.");
        }
        outputText("\n\n");
        ...
        if (player.cockTotal() > 1)
        {
            ...
            {
                outputText("es fan out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.");
            }
            else
            {
                outputText(" sticks out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.");
            }
        }
        else
        {
            outputText("Your " + cockDescript(x) + " seems to bulge inside her, giving itself over to the silken caresses of her glorious vagina.");
        }
        ...
        if (player.cumQ() > 1000)
        {
            outputText("  Amazingly, you actually manage to cum enough to fill her massive womb, and after the first few squirts, the cum slowly bubbles out around your shaft with each fresh deposit of jism.");
        }
        outputText("\n\n");
        ...
        if (player.cor > 80 && player.lib > 50)
        {
            outputText("Of course it's the truth, the cunt's clearly got a good grasp on the obvious. Unwilling to lose your grip on dominance, however, you try to keep struggling to get the upper hand.\n\n");
        }
        else
        {
            outputText("No, that's not right.  You're not some rutting beast, you're the champion.  Sure, you've got your " + cockDescript(x) + " locked hilt-deep inside her squirming slit, but that doesn't mean you're some kind of " + player.mf("stud", "slut") + " who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn't been in such a hurry for some sex, you wouldn't be sagging into her tits and feeling so awfully relaxed.\n\n");
        }
        ...
        if (player.cor > 80 && player.lib > 50)
        {
            outputText("You grumble out a denial.  You're not dumb, you just like to take charge and fuck. There's no reason to resist jumping on a nice wet pussy and making it squirt while you pack it full... but you can't quite get your limbs to move.\n\n");
        }
        else
        {
            outputText("You mumble out a denial.  You're not a beast... you just like to take charge and fuck.  It's just so hard to resist jumping on a nice wet pussy and making it squirt while you pack it full... no!  That's not what...\n\n");
        }
        ...
        {
            outputText("  Exgartuan mumbles telepathicaly, \"<i>Fuck yes I do, but I wanna see how this plays out.</i>\"");
        }
        ...
        if (player.cor > 80 && player.lib > 50)
        {
            outputText("that it's because of her own venom paralyzing your muscles so effectively.\n\n");
        }
        else
        {
            outputText("there was something wrong about what she was saying... something important.\n\n");
        }
        ...
        if (player.cor > 80 && player.lib > 50)
        {
            outputText("Gods it was a bad idea not to bind her lips... ");
        }
        else
        {
            outputText("Gods this was a bad idea... ");
        }
        ...
        if (player.cumQ() > 1000)
        {
            outputText(", even though you've packed it full once already");
        }
        ...
        if (player.cumQ() > 1000)
        {
            ...
            if (player.cumQ() > 2000)
            {
                outputText("  The flow thickens into a river, and soon the puddle of cum looks more like a pond, turning the dirt into a soup of muddy cum.");
            }
        }
        outputText("\n\n");
        ...
        if (player.cumQ() <= 1000)
        {
            outputText("splayed across the ground");
        }
        else
        {
            outputText("soaking in the white puddle of spooge");
        }
    ...
    private function winDriderPCDickInSpiderCunt2() : Void
    {
        ...
        if (player.cor > 80 && player.lib > 50)
        {
            outputText("The longer you sit there, the more your strength returns to you, and the more the submissiveness placed into you by her venom recedes. Still, you've tired yourself out too much to leave at the moment.");
        }
        else
        {
            outputText("The longer you sit there, the more you remember of yourself, and the more you forget the animal, the rut-beast that the spider-woman placed inside you.");
        }
    ...
    private function winVSDriderTakeItsCockInCunt() : Void
    {
        ...
        else if (player.vaginalCapacity() < monster.cockArea(0) * 2)
        {
            outputText("fits tightly");
        }
        else
        {
            outputText("barely reaches halfway");
        }
        ...
        if (monster.nipplesPierced > 0)
        {
            outputText("pierced nipples, circling the metallic stud");
        }
        else
        {
            outputText("nipples, circling the moist bud");
        }
        outputText(" with your tongue");
        if (player.tongue.type > Tongue.HUMAN)
        {
            outputText(" as the rest of its demonic length lashes out and wraps around her pillowy bosom");
        }
    ...
    private function victoryVSDriderRideOviVaginal() : Void
    {
        ...
        if (monster.HP < 1)
        {
            ...
            if (player.hasCock())
            {
                outputText(" and " + sMultiCockDesc() + " twitch");
            }
            else
            {
                outputText(" twitches");
    ...
    private function victoryVSDriderRideOviAnal() : Void
    {
        ...
        if (player.hasVagina() && player.clitLength >= 4)
        {
            outputText(", and pressing your monster chick-stick into it; the gooey heat sends a tingle of shock up your spine and your pussy convulses");
        }
        outputText(".");
        ...
        if (!player.hasCock())
        {
            outputText("\"<i>I never would've thought you were an anal-pregnancy slut,</i>\" hisses the spider in pleasure, flexing her organ harder while it curls through your guts, so deep inside you that you wonder how much further she can go.");
        }
        else
        {
            outputText("\"<i>Just because I have an exoskeleton doesn't mean I can't feel you dripping on me.  I thought I was the corrupt bitch here, but you... you take the cake.</i>\"");
        }
        outputText("\n\n");
        ...
        if (player.hasCock())
        {
            outputText(", nearly crushing your prostate from the tight squeeze");
        }
        outputText(".  ");
        if (!player.hasCock() && player.hasVagina())
        {
            outputText("You gasp and dribble a few strands of girl-goo, the contractions of your achingly empty pussy intensifying.  ");
        }
        if (player.hasCock())
        {
            outputText("You gasp and squirt a few weak ropes of cum, having a miniature orgasm on the spot.  ");
        }
        outputText("Writhing happily, you sigh ");
        if (player.hasCock())
        {
            outputText("while your [cocks] dribbles white, wasted goo onto the black and " + monster.hairColor + " striped carapace below");
        }
        else if (player.hasVagina())
        {
            outputText("while your " + vaginaDescript(0) + " dribbles fem-slime onto the black and " + monster.hairColor + " striped carapace below");
        }
        else
        {
            outputText("while your fingers tweak your " + nippleDescript(0) + "s and your starved sphincter sucks at its slimy, squirming stuffing");
        }
        ...
        if (player.hasCock())
        {
            outputText(" and milk your prostate as they push past");
        }
        outputText(".\n\n");
        ...
        if (player.gender > 0)
        {
            ...
            {
                outputText("a siege of spray-scattering spasms from your snatch");
            }
            outputText(" and");
        }
    ...
    private function victoryVSDriderStickDickInSpinneret() : Void
    {
        ...
        if (monster.nipplesPierced > 0)
        {
            outputText("grasp the intersection of her nipple-chains, ");
        }
        else
        {
            outputText("grasp her nipples, ");
        }
        ...
        {
            outputText("  The semi-sticky stuff soaks into the cleavage of your [allbreasts], the feeling surprisingly enjoyable.  You even knead the web in a bit, biting your bottom lip from the sensation.");
        }
        ...
        if (player.hasBalls())
        {
            outputText(", even giggling a little as your [balls] slap against her nose");
        }
        outputText(".\n\n");
        ...
        if (player.cumQ() < 50)
        {
            outputText("  She easily keeps in rhythm with your spurts.");
        }
        else if (player.cumQ() < 350)
        {
            outputText("  She sputters a bit from the amount of semen, but she catches up well enough.");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("  She's hard-pressed to swallow enough of your seed before another waves washes in.");
        }
        else
        {
            outputText("  Her throat bulges from the sheer amount of cum you deposit into her mouth, and she nearly chokes as she attempts to swallow all of it.");
        }
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() > 2)
            {
                outputText("cocks give ");
            }
            else
            {
                outputText("cock gives ");
            }
    ...
    private function loseVSDriderGetAnalledOvi() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("relax in order to reduce the discomfort");
        }
        else
        {
            outputText("calm your racing thoughts and resist showing how eager you are");
        }
        ...
        {
            outputText("in front of you");
        }
        else
        {
            outputText("on your face");
        }
        ...
        if (player.tallness < 66)
        {
            outputText(player.face() + ", sliding down across your cheeks and along your lips");
        }
        else
        {
            outputText("chest, trickling between your " + nippleDescript(0) + "s");
        }
    ...
    private function loseVSDriderAndVaginallyImpreggleOvi() : Void
    {
        ...
        if (player.lust >= player.maxOverLust())
        {
            ...
            if (player.hasCock())
            {
                outputText("jerking your [cock]");
            }
            if (player.gender == 3)
            {
                outputText((player.biggestTitSize() > 0) ? ", " : " and ");
            }
            if (player.hasVagina())
            {
                outputText("grinding your fingers against your [clit]");
            }
            if (player.biggestTitSize() > 0)
            {
                outputText(((player.gender == 3) ? "," : "") + "shamelessly groping your [breasts]");
            }
        ...
        {
            outputText("down onto your back");
        }
        else
        {
            outputText("over, onto your side and then to your back");
        }
        ...
        if (!player.isNaga())
        {
            outputText("pull your own [feet] apart");
        }
        else
        {
            outputText("scrape inquisitively at your scales");
        }
        ...
        {
            outputText("spraying webbing across your tail and weighing it down to pin it against the earth");
        }
        ...
        if (!player.isTaur())
        {
            outputText("Her fingers then move to the sides of your head, lacing webbing through your hair and sticking it firmly to the ground. More vulnerable than ever, you can't lift your head without ripping your hair from your scalp in chunks.");
        }
        else
        {
            ...
            {
                outputText("With pain and then a pop, your [allbreasts] squash out to the sides as she presses your torso into your knees.  ");
            }
        ...
        if (player.hasCock() && monster.nipplesPierced > 0)
        {
            outputText("  Chains brush over " + sMultiCockDesc() + " as her chest passes your crotch.");
        }
        outputText("  Her fangs trail teasingly along your belly, her fingers crawling up your sides.");
        if (player.biggestTitSize() > 3)
        {
            outputText("  Venom dribbles down the cleavage of your " + biggestBreastSizeDescript() + " as she approaches your vulnerable face.  Her own quartet of matronly tits comes to rest on them as her torso appears over their horizon.");
        }
        outputText("\n\n");
        ...
        if (player.hasCock())
        {
            outputText("  Worse still, its blood-swollen protuberance is met with no reaction from the drider.");
        }
        ...
        if (player.hasCock())
        {
            outputText("  Even your [cock] spurts some pre-cum of its own.");
        }
        ...
        if (!player.isTaur())
        {
            outputText(", cutting your head loose from the imposed bondage with sharp, hard fingertips");
        }
        ...
        if (!player.isTaur())
        {
            outputText("land against the ground");
        }
        else
        {
            outputText("strain your neck suddenly with the dead weight of it");
        }
    ...
    private function loseVSDriderAndGetFuckedANDAnalImpreggegity() : Void
    {
        ...
        if (player.lust >= player.maxOverLust())
        {
            outputText("Unable to resist the desire coursing through your body, you strip off your [armor] and start stroking " + sMultiCockDesc() + ", displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.");
        }
        else
        {
        ...
        if (monster.nipplesPierced > 0)
        {
            outputText(", the crossed chains digging into your " + chestDesc());
        }
    ...
    public function birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText(SMultiCockDesc() + " stays limp, but drools a heavy flow of semen, puddling up a nice thick batch of your pleasure alongside your goo-pile.  ");
        }
        if (player.hasVagina())
        {
            ...
            {
                outputText("gives a tiny squirt");
            }
            else
            {
                outputText("gushes a river of lady-spunk");
            }
    ...
    public function driderPregVagBirth() : Void
    {
        ...
        if (player.isNaga())
        {
            outputText("At last, when no more eggs seem to be coming, you flop over onto your back, careful not to crush any of your dormant offspring.");
        }
        else
        {
            outputText("Looking between your legs you can see another slick, green egg slide from your body to join the sizable pile behind you.  At last, when no more seem to be following it, you flop over onto your back, careful not to crush any of your dormant offspring.");
        }
        ...
        {
            outputText("  Suddenly she flops forward, leaning against your eyebrows and causing you to cross your eyes in an attempt to focus on her.  She seems confused by the way your eyes are different to hers.");
        }
        if (player.isNaga())
        {
            outputText("  A few baby driders crawl ponderously across your scaled tail.  You give your tail a little wiggle and suddenly they go wild crawling around it and letting out the faintest, cute little squeals.");
        }
        else
        {
            outputText("  A few baby driders sit on each of your legs, facing each other.  Some gesture and squeak at each other in wonder while others pull faces.");
        }
        outputText("\n\n");
    ...
    private function driderVagSmartFuck() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("parted slightly and glistening with beads of sweat from the adrenaline of battle.");
        }
        else
        {
            outputText("stuffed with her fingers, femcum streaming down the front of her spider-half as she desperately plays with herself.");
        }
    ...
    private function driderTiedUpPartTwo(useItem : Bool) : Void
    {
        spriteSelect(SpriteDb.s_drider);
        var x : Float = player.cockThatFits(monster.vaginalCapacity());
        if (x < 0)
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText(" and away from her quivering snatch");
        }
        ...
        if (!useItem)
        {
            outputText("Shifting yourself, you withdraw your hand from her quivering slit, reaching back to collect another handful of stretchy silk.");
        }
        else
        {
            outputText("Reaching back into your pack, you grab the remainder of the bundle of silk that you tied the girl's hands with.  Looking over the mass of white-grey strands, you smile as you see that there seems to be more than enough left for what you have in mind.");
        }
