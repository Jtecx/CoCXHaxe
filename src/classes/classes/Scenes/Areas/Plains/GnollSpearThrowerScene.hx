...
class GnollSpearThrowerScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function gnoll2Encounter() : Void
    {
        ...
        if (flags[kFLAGS.HAVE_ENCOUNTERED_GNOLL_PLAINS] == 0)
        {
            ...
            {
                outputText("towers over you, ");
            }
            //<If height is equal to or above 6'5\">
            else
            {
                outputText("stands proudly before you, ");
            }
    ...
    public function hyenaSpearLossAnal() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("bruised and battered, unable to do more than lay prone before her.");
        }
        //<Lust Defeat>
        else
        {
            outputText("arousal coursing through your veins, unable to think clearly enough to stand.");
        }
        ...
        {
            outputText("Before you can recover, she tosses your [weapon] into the long grass.  She roughly pulls the [armor] from your body and it, too, is tossed into the high grass, leaving you naked before this amazon.");
        }
        else
        {
            outputText("She roughly pulls the [armor] from your body, and it's tossed into the high grass, leaving you naked before this amazon.");
        }
        outputText("\n\n");
        ...
        else if (!player.isTaur())
        {
            ...
            if (player.hasBalls())
            {
                outputText("clamping onto your " + sackDescript() + " and squeezing until ");
            }
            else if (player.hasVagina())
            {
                outputText("grabbing your " + clitDescript() + " until ");
            }
            else
            {
                outputText("plunging into your " + assholeDescript() + " and pinching until ");
            }
        ...
        {
            outputText("One furred paw wraps around your tail before pulling up sharply, exposing your " + assholeDescript() + " to the hot, savanna air.  Sharp fangs clamp onto the tail, holding it up to rob you of any remaining modesty.");
        }
        //<For characters without tails>
        else
        {
            outputText("One furred paw disappears before a single claw presses roughly against your " + assholeDescript() + " until she hears your breath catch in your throat.");
        }
        ...
        if (player.hasCock())
        {
            outputText("  Each time the shaft slides into you, a jolt of urgent pleasure shoots through you as her thrusts slam against your prostate.");
        }
        //<Others>
        else
        {
            outputText("  Each lunge from the dominant hyena seems to be at a slightly different angle and strength, ensuring that your entrance is constantly stretched and pulled in new ways.");
        }
        ...
        if (player.hasCock())
        {
            outputText("Your cum spurts from your [cocks], spraying your seed over the dry ground, giving life to the savanna.");
        }
        //<Females>
        else if (player.hasVagina())
        {
            outputText("Your own juices flow freely from your " + vaginaDescript() + ", coating your thighs and dripping onto the dry grass below you.");
        }
        ...
        if (player.gender > 0)
        {
            outputText("letting you fall hard into the mess you made on the grass.");
        }
        //<neuters>
        else
        {
            outputText("letting you fall hard into the grass.");
        }
        ...
        {
            outputText("  Even as your eyes slide closed, you see the hyena kicking open the circle of dust.");
        }
    ...
    private function hyenaVictoryRapeFellatio() : Void
    {
        ...
        var y : Float = player.findCockNotIn([x]);
        if (y < 0)
        {
            sceneHunter.print("Check failed: multiple cocks.");
        }
        clearOutput();
        ...
        {
            outputText("The tip of your member presses hard against the back of her mouth for a long moment until she swallows, letting your " + cockDescript(x) + " slide into her tight throat.  ");
        }
        ...
        if (player.cocks[x].cockLength > 7)
        {
            outputText("in the back of her mouth ");
        }
        ...
        {
            outputText("Even as the most incredible sensations flow through you from the feel of her muzzle, you see one of her spotted hands drop from her pendulous breast to grip her own shaft.  Her second hand follows, sliding two furred fingers into the tip of her strange shaft as she starts to move up and down the dark flesh in time to the suckling of her muzzle.  Her dark brown eyes slowly slide closed in bliss as she pleasures herself while servicing the shaft buried deep within her maw.\n\n");
        }
        //<Two Cocks>
        else if (player.cockTotal() == 2)
        {
            ...
            if (player.hasBalls())
            {
                outputText("  Her second paw finally cups your [balls], squeezing and massaging to add to the powerful sensations.");
            }
            outputText("\n\n");
        }
        //Three or More Cocks>
        ...
        if (player.cocks[x].cockLength >= 7)
        {
            outputText("The muzzle starts to pull away from your " + cockDescript(x) + " until the tip finally slips from her throat, letting her gasp for breath.  ");
        }
        ...
        if (player.cocks[x].cockLength >= 7)
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText("  Your second " + cockDescript(y) + " throbs in her hand, spraying her face and throat with thick ropes of cum.");
            }
            //<Three or More Cocks>
            if (player.cockTotal() >= 3)
            {
                outputText("  Your [cocks] throb in her paws, coating her muzzle, neck, and breasts with thick ropes of cum.");
            }
        ...
        else
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText("  Your " + cockDescript(y) + " throbs in her hand, spraying her face and throat with thick ropes of cum.");
            }
            //<Three or More Cocks>
            if (player.cockTotal() >= 3)
            {
