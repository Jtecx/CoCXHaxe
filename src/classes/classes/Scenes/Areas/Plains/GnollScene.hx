...
class GnollScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    //Oh shit get anal raped.
    {
        ...
        {
            outputText("flat, featureless groin.  ");
        }
        ...
        //thickestCockIndex()>2"){
            ...
            //(if cockTotal>1){
                ...
                {
                    outputText("The gnoll fishes into your [cocks] and quickly snaps up the thickest one.  ");
                }
                //(if cockTotal=1)
                else
                {
                    outputText("The gnoll's hands dart down to your crotch and grabs [cock].  ");
                }
            ...
            else
            {
                ...
                if (player.cockTotal() > 1)
                {
                    outputText("\"<i>This will have to do,</i>\" she says with the barest trace of disappointment as she grabs your thickest cock.  ");
                }
                //(if cockTotal=1)
                else
                {
                    outputText("\"<i>This will have to do,</i>\" she says as she grabs your cock.  ");
                }
        ...
        {
            outputText("  Your [allbreasts] bounce up and down as the gnoll grinds her anatomy into yours, slick with sweat under the hot sun.  Your " + nippleDescript(0) + "s tighten and flush as your whole body submits to the rough fuck administered by the hyena girl.");
        }
        //(if cockTotal>0)
        if (player.cockTotal() > 0)
        {
    ...
    public function defeatHyena() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("The hyena girl collapses backwards onto the dusty ground, unable to continue the fight.");
        }
        //Gnoll Defeat (Lust)
        else
        {
            outputText("The hyena girl heaves a giant breath and takes a single step backwards.  Her club thumps to the ground, and her hands fall to her shaft, stroking along its rough length.");
        }
    ...
    private function dickDownGnollClit() : Void
    {
        ...
        {
            outputText("Finally, you can feel your cockhead push free into a deeper, wetter place.  You look down at her strange anatomy, the entire length of her tube bulging thicker to accommodate your " + cockDescript(x) + ".  You've made it all the way to her vagina!\n\n");
        }
        else
        {
            outputText("Soon you feel the end of her clitoral tunnel butting up against your crotch.  You are as far in as you'll get.  You look down the length of her strange anatomy, the tube bulging thicker to accomodate your " + cockDescript(x) + ".  There are still inches between your cockhead and the end of her clit-dick.\n\n");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  It doesn't take long before your [balls] begin twitching, pumping cum down the length of your encased cock.");
        }
        ...
        if (player.cumQ() < 25)
        {
            outputText("Your " + cockDescript(x) + " convulses, pumping down the length of her clitoris.  She squirms and howls beneath you, hissing for more.");
        }
        //(if cumQ()>25 AND cumQ()<500)
        else if (player.cumQ() < 500)
        {
            outputText("Your " + cockDescript(x) + " convulses, pumping cum into her.  Her clitoris bulges even more as the jism backs up.  The warm, wet, sticky insides swirl around your dick.");
        }
        //(if cumQ()>500)
        else
        {
            outputText("Your " + cockDescript(x) + " convulses, pouring cum into her.  Her clitoris bulges even more as the jism backs up, the skin pulling tight and shiny as the pressure builds.  Finally, gouts of cum begin spurting back out the tip of her clitoris, splashing against your crotch.");
        }
    ...
    {
        var usedCocks : Array<Dynamic> = [];
        var capacityLeft : Float = monster.analCapacity();
        var findNext : Void->Bool = function() : Bool
        //find next cock
        {
    ...
    private function dickInGnollAss() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText(" while the remainder of your endowments slide along her bare buttocks");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText(" as your voluminous pre-cum turns her innards into a sloppy fuckhole");
        }
        outputText(".\n\n");
        ...
        else if (player.cumQ() <= 500)
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText(", unleashing a torrent of semen that mats down the short fur on her back and rear as");
            }
        ...
        else
        {
            ...
            if (player.cockTotal() > 1)
            {
                if (player.cockTotal() > 2)
                {
                    outputText(" while your remaining endowments soak her back thoroughly, covering her in a thick blanket of spunk");
                }
                else
                {
                    outputText(" while your remaining endowment soaks her back thoroughly, covering her in a thick blanket of spunk");
                }
            }
    ...
    private function yoDawgIHeardULiekGNollBallzzzdahdakjldh() : Void
    {
        clearOutput();
    ...
    private function yoDawgHyenaBallz2() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("your own " + ballsDescriptLight());
        }
        else
        {
            outputText("your sweat-slick thighs");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" your distended sac, ballooning with the fatigued flood of the prostate-milking the girl is giving you");
        }
        else
        {
            outputText(" your sore loins, soaked with the slimy river of the girl's excitement");
        }
