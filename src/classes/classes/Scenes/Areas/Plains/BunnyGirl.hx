...
class BunnyGirl extends BaseContent
{
    ...
    public function bunnbunbunMeet() : Void
    {
        ...
        if (flags[kFLAGS.MET_BUNBUN] == 0)
        {
            ...
            if (player.lib > 50)
            {
                outputText("and you find yourself wondering what sort of treasures she conceals behind it.");
            }
            else if (player.cor < 40)
            {
                outputText("and you find yourself thankful for her modesty.");
            }
            else
            {
                outputText("and you find yourself considering tearing away the basket so you can see what she's hiding down there.");
            }
            outputText("\n\n");
    ...
    private function bunbunFucksYourVag() : Void
    {
        ...
        {
            outputText(" and " + player.weaponName);
        }
        ...
        {
            outputText("  Moisture leaks in a steady drizzle, mixing with bunny-pre to totally slick the soon-to-be invading member.");
        }
        outputText("\n\n");
        ...
        {
            outputText(", not that you needed it");
        }
        ...
        if (player.vaginalCapacity() < 20)
        {
            outputText("By the time you're getting close to the bottom you have to work to encompass her length and girth within your velvet folds and grunt with discomfort from each new inch of throbbing fuck-stick, but you take it all.  ");
        }
        else if (player.vaginalCapacity() < 50)
        {
            outputText("By the time you get to the bottom you're panting and moaning, delighting in the feeling of being so perfectly impaled on a rigid fuck-stick.   With her entirely inside you, you're ready to fuck her in earnest.  ");
        }
        else
        {
            outputText("It doesn't take long to slide down the more-than footlong meat-pole, and to be honest you wish she was a bit bigger.  Your " + vaginaDescript(0) + " is so ready for big dicks that this disproportionate member is average at best.  Still, you clench your thigh muscles to wring it a little tighter, and swoon from the feeling of warm maleness filling your loins.  ");
        }
        ...
        if (player.tallness >= 72)
        {
            ...
            if (player.cor < 33)
            {
                outputText("You'll have to try to slow your descent next time!  ");
            }
            else
            {
                outputText("If she's going to fuck you like this, she can handle your weight!  ");
            }
        }
        else
        {
            outputText("Your bodies clap together with a loud squish of copious sexual fluids, and another thick burble of pre warms your cunny.  ");
        }
        ...
        {
            outputText("  Your " + clitDescript() + " bounces on her belly, tingling like mad every time it slaps into her tanned, sweat-slicked skin.");
        }
        if (player.biggestLactation() >= 1)
        {
            outputText("  Milk begins to bead on your [allbreasts] from the sensation of the bunny's brutal, almost mechanical fucking.");
        }
        ...
        if (player.clitLength >= 4)
        {
            outputText("fondle your " + clitDescript() + " a moment before wrapping your hand around it and stroking the girl-cock excitedly.");
        }
        else
        {
            outputText("caress your " + clitDescript() + " a moment before you start to circle it with a finger, teasing it expertly.");
        }
        if (player.cockTotal() > 0)
        {
            ...
            {
                outputText("on the bunny's belly");
            }
            else if (player.cocks[0].cockLength < 18)
            {
                outputText("between the bunny's tiny tits");
            }
            else if (player.cocks[0].cockLength < 28)
            {
                outputText("on the bunny's face");
            }
            else
            {
                outputText("past the bunny's head");
            }
            outputText(", and your free hand wastes no time in tending to your male ");
            if (player.cockTotal() == 1)
            {
                outputText("half's needs, slathering it in pre-cum and stroking hard and fast.");
            }
            else
            {
                outputText("halfs' needs, slathering them in pre-cum and stroking hard and fast.");
            }
        }
        ...
        if (player.cockTotal() > 0)
        {
            ...
            if (player.cumQ() > 500)
            {
                outputText("  Not content with that, " + sMultiCockDesc() + " continues to pump until the bunny is coated with a generous layer of seed");
            }
            if (player.cumQ() > 2000)
            {
                outputText(" and the excess is running down the hill in a small river");
            }
            if (player.cumQ() > 500)
            {
                outputText(".");
        ...
        {
            outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it's so much easier to think now that I've gotten rid of those eggs.  Don't worry, you won't be popping out rabbits since you aren't an easter-bun.  Your body will probably absorb them in a few days.  Just don't be surprised if you feel a little bloated or feel a little weird after.</i>\"\n\n");
        }
        //Pregnant already
        else if (!player.canGetPregnant())
        {
            outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it really is a shame you're pregnant.  Your body will destroy the little eggs before they can even do anything!  Well, at least I feel sooo much better...</i>\"\n\n");
        }
        //Preggers
        else
        {
            outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it feels so good to pour my babies into a nice, ready breeder-mom like yourself.  I bet the kids come out so cute!  Oh, I feel so much better.</i>\"\n\n");
        }
    ...
    private function bunbunFucksPCInAss() : Void
    {
        ...
        {
            outputText("it stretches you dangerously wide as you slide down the thick shaft.  The further down it gets, the more you have to work to relax your muscles and push yourself along.  With enough time, patience, and copious bunny-pre, you manage to take it completely inside you.  It twitches happily while you adjust to the intrusion, but you know you're just getting started.");
        }
        else if (player.analCapacity() < 40)
        {
            outputText("you have to keep pausing as you slide down to let more of her pre-cum bubble out and lubricate the fourteen-inch shaft.  It fills you nicely, pressing on your innards in all the right ways as you slowly engulf the bunny-cock with your " + assholeDescript() + ".  After bottoming out, your nervous lover's prick pulsates happily inside you, but you're just getting started.");
        }
        else
        {
        ...
        if (player.cockTotal() > 0)
        {
            outputText("Each time she bumps and slides past your prostate a dollop of your pre-cum spurts from " + sMultiCockDesc() + " onto the ground, and you have a hard time not using your new lover like an anal toy and masturbating yourself.  ");
        }
        ...
        if (player.hasVagina())
        {
            if (player.vaginas[0].vaginalWetness >= VaginaClass.WETNESS_SLICK)
            {
                outputText("Juices begin to run from your " + vaginaDescript(0) + ", but you ignore the empty feeling and focus on the throbbing meat inside your backdoor.  ");
            }
        }
        ...
        {
            outputText("sliding inside them, fucking their cunt-like interiors as you start to lose yourself to the pleasure.");
        }
        ...
        {
            outputText(", and your " + vaginaDescript(0) + " clenching and dripping on the verge of orgasm");
        }
        outputText(".");
        if (player.biggestLactation() >= 1)
        {
        ...
        {
            outputText("and your arousal returns in force.");
        }
        //(BUTT CHANGE HERE)
        ...
        if (player.cockTotal() > 0)
        {
            ...
            if (player.cumQ() > 500)
            {
                outputText("  The splattering of your seed only increases in volume as it makes a rather large puddle");
            }
            if (player.cumQ() > 2000)
            {
                outputText(", but you just keep going until you create a lazily winding river of cum that flows its way through the grasses");
            }
            if (player.cumQ() > 500)
            {
                outputText(".");
        ...
        if (player.hasVagina())
        {
            outputText("  Your " + vaginaDescript(0) + " clenches, empty, drooling, and neglected, wishing it something inside it.");
        }
        outputText("\n\n");
    ...
    private function bunbunGetsFucked() : Void
    {
        ...
        var y : Float = player.cockThatFits2(40);
        ...
        if (y != -1)
        {
            outputText(", taking care to align your " + cockDescript(y) + " with her tightly puckered backdoor as well.");
        }
        else
        {
            outputText(", barely able to restrain yourself as the time for penetration approaches.");
        }
        outputText("\n\n");
        ...
        if (y != -1)
        {
            outputText("She squeaks at the pressure on her tender asshole, but doesn't object as your pre-cum smears over it.  ");
        }
        outputText("At once, her greedy breeding hole relaxes ");
        if (y != -1)
        {
            outputText("along with her anus ");
        }
        outputText("and your " + cockDescript(x));
        if (y != -1)
        {
            outputText(" and " + cockDescript(y) + " sink");
        }
        else
        {
            outputText(" sinks");
        ...
        if (player.cockArea(x) >= 25)
        {
            outputText("Her belly bulges pleasantly, displaying the vaguely cylindrical shape of a cock through her skin in a way that makes you feel utterly dominant over this 'female'.  ");
        }
        ...
        if (y != -1)
        {
            outputText("Her tight asshole slowly loosens around your " + cockDescript(y) + ", and so much lubricant splatters from her cunt with each thrust that the sensations of both your dicks become nigh-identical, save for the tight ring gripping the bottom one.");
        }
        else
        {
            ...
            if (player.hasBalls())
            {
                outputText(", belly, and balls");
            }
            else
            {
                outputText(" and belly");
            }
        ...
        if (y != -1)
        {
            outputText("  Surprisingly, her asshole stays about the same, but it was already a little tighter, and you know you'll be pumping it full of goo in a second.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText(", slapping your balls against her ass");
        }
        outputText(", as your ");
        if (player.hasSheath())
        {
        ...
        if ((player.cockTotal() == 2 && y == -1) || player.cockTotal() > 2)
        {
            outputText("and onto ");
        }
        ...
        if (y != -1)
        {
            ...
            if (player.cumQ() > 500)
            {
                outputText(", and her stomach gains a bit of pudge from the copious jism deluge you pump into her");
            }
            outputText(".");
        }
        if (player.cumQ() > 500)
        {
            outputText("  You keep cumming, slamming blast after blast of spooge into her welcoming nethers, delighted that none seems to leak out.");
        }
        if (player.cumQ() >= 1500)
        {
            outputText("  Somehow her womb never seems to fill or bulge, even though you must be pumpings gallons of fertile baby-batter into her cunt.  By the time your orgasm winds down, you feel a little confused by it all, but sated.");
        }
        outputText("\n\n");
        ...
        if (player.cumQ() > 100)
        {
            outputText("  A few seconds later another rolls in, cramming three into her increasingly obscene looking 'sack'.");
        }
        if (player.cumQ() > 250)
        {
            outputText("  One more follows, giving her quads");
        }
        var z : Float = 8 + rand(player.cumQ() / 100);
        if (z > 50)
        {
            z = 50;
        }
        if (player.cumQ() > 700)
        {
            outputText(", but she's not done.  Her gut rumbles loudly, and then one after another egg after egg pours into the sack, stretching it out until you're sure she has at least " + z + " in there and will have trouble walking.");
        }
        else
        {
            outputText(".");
        ...
        //EASTER CANDY VERSION
        {
            ...
            if (isEaster())
            {
                ...
                //[No Tail:{
                    ...
                    {
                        outputText("  The heat around your lower back clutches at your tail bone, and you feel a fluffy explosion swell around your butt cheeks as <b>a fluffy bunny's tail pops out of your back</b>, twitching excitedly!");
                    }
                    //[Existing tail:
                    else
                    {
                        outputText("  Your tail jiggles and shrinks, slowly sucking back into your body until only a tiny nub remains, which quickly explodes with fluff into <b>your new cuddly, twitching bunny tail!</b>");
                    }
                }
                ...
                if (player.cumQ() < 250)
                {
                    outputText("a slight swell");
                }
                else if (player.cumQ() < 1000)
                {
                    outputText("a noticeable girth");
                }
                else
                {
                    outputText("bloated obscenely");
                }
            ...
            else
            {
                ...
                //[No Tail:{
                    ...
                    if (player.tailType == Tail.NONE)
                    {
                        outputText("  The heat around your lower back clutches at your tail bone, and you feel a fluffy explosion swell around your butt cheeks as a fluffy bunny's tail pops out of your back, twitching excitedly!");
                    }
                    //Existing tail:
                    else
                    {
                        outputText("  Your tail jiggles and shrinks, slowly sucking back into your body until only a tiny nub remains, which quickly explodes with fluff into a cuddly, twitching bunny tail!");
                    }
                }
                if (player.ears.type != Ears.BUNNY && !player.blockingBodyTransformations())
                {
    ...
    public function layEggsInBunbuns() : Void
    {
        ...
        if (player.eggs() < 20)
        {
            outputText("eager egg-tube slips free, ready to show the rabbit you can play the egg game too.");
        }
        else if (player.eggs() < 40)
        {
            outputText("distended bug part quivers in anticipation, the ovipositor pushing into view with a drop of honeyed pre on its tip.");
        }
        else
        {
            outputText("low-hanging bee abdomen drools honey-like ichor down its carapace from the bulge where the thick black organ shows its need to relieve your burden.");
        }
        ...
        if (player.gender == 0)
        {
            outputText(" against the empty place of your crotch.");
        }
        else
        {
            if (player.hasCock())
            {
                outputText(" alongside [eachCock]");
            }
            if (player.hasVagina())
            {
                outputText(" and her hefty oval balls rubbing the [vagina] tucked between your thighs");
            }
            outputText(".");
        }
        ...
        if (player.gender > 0)
        {
            ...
            if (player.hasCock())
            {
                outputText("spraying a long, thick load against the bunny's soft tits from your [eachCock]");
            }
            if (player.gender == 3)
            {
                outputText(" and ");
            ...
            if (player.hasVagina())
            {
                outputText("splashing her balls with your girlcum");
            }
            outputText(".");
        }
    ...
    public function ovipositBunnyEaster() : Void
    {
        ...
        else
        {
            ...
            if (silly())
            {
                outputText("like an energizer bunny");
            }
            else
            {
                outputText("like some kind of endless, pregnancy-inducing fuck-beast");
            }
    ...
    private function adjathaEggsplosions() : Void
    {
        ...
        if (!isEaster())
        {
            outputText("thin, gushing pre-cum");
        }
        else
        {
            outputText("thick, syrupy cream");
        }
        ...
        if (player.hasVagina())
        {
            addButton(1, "Get Egged", getEggflated);
        }
        ...
        if (player.hasCock())
        {
            if (player.cockThatFits(40) >= 0)
            {
                addButton(2, "Fuck Her", fuckTheEggBoundBun);
            }
            else
            {
                outputText("  <b>You're too big to fuck her!</b>");
            }
        }
        addButton(14, "Leave", explorer.done);
    }
    ...
    private function freeHerOhGodWhyDidYouDoThis() : Void
    {
        ...
        if (!isEaster())
        {
            outputText("sheen of sweat");
        }
        else
        {
            outputText("shimmering glaze");
        }
        outputText(", her urgent lust pulsing in every inch of her ");
        if (!isEaster())
        {
            outputText("freckled brown");
        }
        else
        {
            outputText("pudding rich");
        }
        ...
        if (!isEaster())
        {
            outputText("bubbling pearls");
        }
        else
        {
            outputText("gooey marshmallows");
        }
        ...
        if (!isEaster())
        {
            outputText("the carnal fruit of her unwelcome, monstrous couplings");
        }
        else
        {
            outputText("candied plenty, her saccharine treats swimming amid a warm sea of honeyed spunk");
        }
        ...
        if (!isEaster())
        {
            outputText("splattering spoo");
        }
        else
        {
            outputText("climaxing cream");
        }
        ...
        if (!isEaster())
        {
            outputText("bright pink eggs");
        }
        else
        {
            outputText("candy-coated confections");
        }
    ...
    private function fuckTheEggBoundBun() : Void
    {
        ...
        if (!isEaster())
        {
            outputText("supple mounds");
        }
        else
        {
            outputText("taut dough");
        }
        ...
        if (!isEaster())
        {
            outputText("yielding flesh");
        }
        else
        {
            outputText("semi-spongy hotcakes");
        }
        ...
        if (player.cor < 33)
        {
            outputText("grimace at the vulgar goo that washes over your flesh");
        }
        else if (player.cor < 66)
        {
            outputText("swallow a gulp as the lewd spoo squelches around your member");
        }
        else
        {
            outputText("revel in the profane stimulation of bestial batter anointing your length in impure, liquid virility");
        }
        outputText(".");
        ...
        if (!isEaster())
        {
            outputText("darkly freckled thighs ivory");
        }
        else
        {
            outputText("savory, chocolate thighs with pale cream");
        }
        ...
        if (!isEaster())
        {
            outputText("flooding her semen-gorged cunt with fresh issue");
        }
        else
        {
            outputText("glazing her cream-filled center with your silky spunk");
        }
        outputText(".  She bucks helplessly as her gut swells under your load, ");
        if (player.cumQ() < 250)
        {
            outputText("steady streams of cum seeping from her pussy");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("bulging enough that her belly button turns outward as the cum oozing from her pussy gushes between the two of you");
        }
        else
        {
            outputText("growing larger and larger as cum splatters in thick streams from her saturated pussy. Your seemingly endless gallons of flooding cum wash the remnants of her previous partners away, immersing the caramel woman in the fluid wealth of your liquid possession.");
        }
    ...
    private function getEggflated() : Void
    {
        ...
        if (!isEaster())
        {
            outputText("twitching length");
        }
        else
        {
            outputText("succulent delicacy");
        }
        ...
        if (!isEaster())
        {
            outputText("swollen mast");
        }
        else
        {
            outputText("bloated baster");
        }
        ...
        if (!isEaster())
        {
            outputText("well-padded bedding");
        }
        else
        {
            outputText("sponge cakes baked for a giant");
        }
        outputText(".");
        ...
        if (!isEaster())
        {
            outputText("gurgling seed");
        }
        else
        {
            outputText("saccharine seed");
        }
        ...
        if (!isEaster())
        {
            outputText("twitching tuft");
        }
        else
        {
            outputText("cotton candy poof");
        }
        ...
        if (!isEaster())
        {
            outputText("swollen dick");
        }
        else
        {
            outputText("candied cock");
        }
        ...
        if (!isEaster())
        {
            outputText("jizz-burbling");
        }
        else
        {
            outputText("jelly-bubbling");
        }
        ...
        if (!isEaster())
        {
            outputText("tingling, liquid passion");
        }
        else
        {
            outputText("fattening, cream filling");
        }
        ...
        if (!isEaster())
        {
            outputText("advanced pregnancy");
        }
        else
        {
            outputText("gluttonous excess");
        }
        ...
        if (!isEaster())
        {
            outputText("egg-loaded");
        }
        else
        {
            outputText("candy fattened");
        }
        ...
        if (player.hasCock())
        {
            outputText("  The steady movement of the orbs pushing past your prostate drills another, even messier orgasm from your [cocks], cum arcing into the air to shower down on the two of you in pearl beads.");
        }
        
        outputText("\n\nTime seems to flow from one moment to the next, your consciousness fading in and out as a small deluge of ");
        if (!isEaster())
        {
            outputText("bunny seed");
        }
        else
        {
            outputText("marshmallow and chocolate");
        }
