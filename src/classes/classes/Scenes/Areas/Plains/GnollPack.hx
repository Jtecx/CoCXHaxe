...
class GnollPack extends Monster
{
    ...
    public function new()
    {
        ...
        this.level = 42;
        this.gems = 800;
        this.drop = new ChainedDrop().add(consumables.REDUCTO, 1 / 5).add(consumables.SUCMILK, 1 / 4).add(weaponsrange.GTHRSPE, 1 / 2).elseDrop(consumables.BLACK_D);
