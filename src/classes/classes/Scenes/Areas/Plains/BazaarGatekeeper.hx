...
/**
	 ...
	 * @author Kitteh6660
	 */
class BazaarGatekeeper extends Monster
{
    ...
    public function scimitarAttack() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt(str + weaponAttack + 100);
    ...
    public function scimitarCrossAttack() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt(str + weaponAttack + 250);
            player.takePhysDamage(damage, true);
        }
