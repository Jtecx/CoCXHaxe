...
class Gnoll extends Monster
{
    ...
    private function gnollAttackText() : Void
    {
        ...
        //hapies have their own shit{
            ...
            else if (rand(player.armorDef + player.tou) < player.armorDef)
            {
    ...
    private function gnollTease() : Void
    {
        ...
        {
            outputText("\"<i>I love outlanders,</i>\" the gnoll confides in you as she circles.  \"<i>You have such interesting cries when you get fucked in a new way.</i>\"  She laughs, and the sound is far louder than it has any right to be.\n\n");
        }
        //Gnoll Tease #6
        else
        {
    ...
    override private function performCombatAction() : Void
    {
        ...
        if (hasStatusEffect(StatusEffects.Fear))
        {
            ...
            else
            {
                ...
                {
                    outputText(capitalA + short + " is too busy shivering with fear to fight.");
                }
            }
        }
