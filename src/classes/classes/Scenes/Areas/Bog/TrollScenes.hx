...
class TrollScenes extends BaseContent
{
    ...
    public function encounterAdultMaleTrollLost() : Void
    {
        ...
        if (player.hasVagina())
        {
            addButton(1, "Female Rape", encounterAdultMaleTrollLostFemaleRape);
        }
        else
        {
            addButtonDisabled(1, "Female Rape", "You need a vagina for this scene.");
        }
        if (player.hasCock())
        {
            addButton(2, "Anal Rape", encounterAdultMaleTrollLostAnalRape);
        }
        else
        {
    ...
    public function encounterAdultMaleTrollWon() : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.TrollDefeatsCounter))
        {
            player.addStatusValue(StatusEffects.TrollDefeatsCounter, 1, 1);
        }
        else
        {
            player.createStatusEffect(StatusEffects.TrollDefeatsCounter, 1, 0, 0, 0);
        }
        cleanupAfterCombat();
    }
    ...
    public function encounterAdultFemaleTrollLost() : Void
    {
        ...
        if (player.hasVagina())
        {
            addButton(3, "Female Rape", encounterAdultFemaleTrollLostFemaleRape);
        }
        else
        {
            addButtonDisabled(3, "Female Rape", "You need a vagina for this scene.");
        }
    ...
    public function encounterAdultFemaleTrollWon() : Void
    {
        ...
        {
            outputText("She inspects your body, trying to cop a feel from in between your legs. She sighs dejectly when she finds your lack of a penis. She rifles through your gem pouch before leaving you alone in the bog.\n\n");
        }
        cleanupAfterCombat();
    }
    //Glacial Male Troll
    ...
    public function encounterAdultGlacialMaleTrollLost() : Void
    {
        ...
        if (player.hasVagina())
        {
            addButton(1, "Female Rape", encounterAdultGlacialMaleTrollLostFemaleRape);
        }
        else
        {
            addButtonDisabled(1, "Female Rape", "You need a vagina for this scene.");
        ...
        if (player.hasCock())
        {
            addButton(2, "Anal Rape", encounterAdultGlacialMaleTrollLostAnalRape);
        }
        else
        {
            addButtonDisabled(2, "Anal Rape", "You need a penis for this scene.");
    ...
    public function encounterAdultGlacialFemaleTrollWon() : Void
    {
        if (rand(4) == 0)
        {
            ...
            {
                outputText("She inspects your body, trying to cop a feel from in between your legs. She sighs dejectly when she finds your lack of a penis. She rifles through your gem pouch before leaving you alone in the snow.\n\n");
            }
        }
        else
        {
            outputText("\"<i>Don’t come back,</i>\" she snarls before leaving.");
        }
        cleanupAfterCombat();
    }
}
