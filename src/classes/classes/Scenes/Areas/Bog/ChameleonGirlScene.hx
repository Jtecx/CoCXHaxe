...
class ChameleonGirlScene extends BaseContent
{
    ...
    public function loseToChameleonGirl() : Void
    {
        ...
        {
            outputText("Too weak to keep fighting, you stagger back and fall to your knees.");
        }
    ...
    private function loseToChameleonWithCockAnBallsAnCunt() : Void
    {
        ...
        {
            outputText(" and occasionally lifting it to take the shaft between two dexterous toes and work it more delicately");
        }
    ...
    private function dudesLoseToChamChams() : Void
    {
        ...
        if (player.lust >= player.maxOverLust())
        {
            outputText("overwhelmed by lust");
        }
        else
        {
            outputText("battered");
        ...
        {
            outputText("to the base of its shaft");
        }
        else
        {
            outputText("as far as you can go into her");
        }
        ...
        if (player.cumQ() > 500)
        {
            outputText(", filling her with so much cum that it leaks out of her and drips to the water below");
        }
    ...
    public function defeatChameleonGirl() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            ...
            if (player.lust >= 33)
            {
                outputText("  Do you help the horny girl to get you both off?  Or maybe you could punish her bad attitude with something from your bag...");
            }
        }
        //-Win by HP
        else
        {
            ...
            if (player.lust >= 33)
            {
                outputText("  Do you use the girl in her weakened state to get yourself off?  Or maybe you could punish her bad attitude with an item from your bags...");
            }
        }
        ...
        var cgx : Float = monster.vaginalCapacity();
        menu();
    ...
    private function fuckDatChameleonAsACoolGuyGirlHerm() : Void
    {
        ...
        if (player.cor < 50)
        {
            outputText("one to be selfish");
        }
        else
        {
            outputText("feeling quite as selfish as usual");
        }
    ...
    private function manFucksChameleonWithBiggishWang() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("her masturbating even more furiously than before at the thought of having your cock.");
        }
        //[if lost by HP:
        else
        {
            outputText("her starting to work the fingers of her free hand in and out of her own sex.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("your [balls] clench and ");
        }
        ...
        if (player.cumQ() > 750)
        {
            outputText("  The torrent of cum bursting from your cock just doesn't stop, and her eyes roll back into her head as your semen coats her face and runs off her tongue, drenching her breasts and belly in white.  Her head falls back and her tongue goes limp as she's sent into ecstasy by the flood.");
        }
        ...
        if (player.cumQ() > 750)
        {
            outputText("  Even the murky water around her is turned white as the pools of your cum on her body run off into it.");
        }
    ...
    private function femaleHasWinSexWithChamCham() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText(", her moans of pleasure growing more desperate as you approach");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("  She coos lustily at the sensation.");
        }
        else
        {
            outputText("  Her eyes widen, and she looks from your hand to your face and back again.");
        }
        ...
        if (player.cor < 50)
        {
            outputText("and somewhat guiltily ");
        }
    ...
    private function giveTheChameleonASuccubiMilk() : Void
    {
        ...
        {
            outputText(" with your tail,");
        }
        else
        {
            outputText(" by straddling her,");
        }
