...
class ChameleonGirl extends Monster
{
    ...
    //Blind dodge change
    {
        ...
        {
            outputText("The chameleon girl's claws slash towards you, but you lean away from them and they fly by in a harmless blur.");
        }
        //Get hit
        else
        {
            var damage : Float = as3hx.Compat.parseInt((str + weaponAttack) - rand(player.tou));
            if (damage > 0)
            {
            ...
            {
                outputText("The chameleon swings her arm at you, catching you with her claws.  You defend against the razor sharp attack.");
            }
        }
    }
    ...
    //Blind dodge change
    {
        ...
        {
            var damage : Float = as3hx.Compat.parseInt((str + weaponAttack) - rand(player.tou) - player.armorDef) + 25;
            if (damage > 0)
            {
            ...
            {
                outputText("The chameleon rolls in your direction and kicks up at your chest, but you knock her aside without taking any damage..");
            }
        }
    }
    ...
    /**
		 ...
		 */
    private var SKIN_VARIATIONS(default, never) : Array<Dynamic> = [
        ["red", "black"], 
        ["green", "yellowish"], 
        ["blue", "lighter blue"], 
    ...
    {
        super();
        var skinToneAdj : Array<Dynamic> = randomChoice(SKIN_VARIATIONS);
        this.a = "the ";
