...
class HellHoundScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    //Lust or HP loss texts here
    {
        ...
        {
            outputText("Overcome by sexual desire, you submit to the hungry hellhound.\n\n");
        }
        else
        {
            outputText("Too weak to continue fighting, you fall to your knees.\n\n");
        }
        ...
        {
            outputText("slamming his twin dicks into your " + vaginaDescript(0) + " and your " + assholeDescript() + ".  ");
        }
        else
        {
            outputText("slamming his lower dick into your " + assholeDescript() + ", while rubbing the other between the cheeks of your [butt].  ");
        }
        if (player.vaginas.length > 0 && !player.isNaga())
        {
            if (player.vaginalCapacity() < monster.cockArea(0))
            {
                outputText("You feel an intense mixture of sensations in your lower body as your " + assholeDescript() + " feels like it is being torn apart, while your " + vaginaDescript(0) + " is filled with an intense pleasure at being filled with the creature's large member.  ");
            }
            else
            {
                outputText("Your lower body explodes with pain as the hellhound forces himself in too quickly for either your " + assholeDescript() + " or your " + vaginaDescript(0) + " to handle.  ");
            }
            if (player.vaginas[0].virgin)
            {
                outputText("<b>You are no longer a virgin!  </b>");
            }
            if (player.cuntChange(monster.cockArea(0), false))
            {
                outputText("The beast howls as your " + vaginaDescript(0) + " is stretched to accommodate the large shaft.  ");
            }
            ...
            {
                outputText("The pause gives your " + vaginaDescript(0) + " time to moisten, ensuring the next thrust won't be quite as rough.  ");
            }
        ...
        else
        {
            ...
            if (player.cor < 40)
            {
                outputText("You moan while trying to break free to get the heat off your back... but the beast keeps a firm grip on you as more and more of its fiery seed is pumped into and onto your body. After what feels like an eternity, the beast pulls out of you. He gives your " + assholeDescript() + " a single extended lick with his long dog-like tongue before running off out of sight. You are finally able to roll around and get the heat off of your back, but you can do nothing about the tainted warmth inside you. The heat proves to be too much, and you pass out. After some time passes, you wake up to find the fire inside you has thankfully faded away. You're able to stand up again, but the damage is done, and the creature's seed has left you feeling rather weak.");
            }
            else
            {
    ...
    public function hellHoundPostFightOptions(hpVictory : Bool) : Void
    {
        clearOutput();
        menu();
        if (hpVictory)
        {
            outputText("The hellhound's flames dim, and the heads let out a whine before the creature slumps down, defeated and nearly unconscious" + ((Std.is(monster, InfestedHellhound)) ? ", and yet still drooling worms." : "."));
            addButton(12, "Slay", killHellhound);
        }
        else
        {
            outputText("Unable to bear " + ((Std.is(monster, InfestedHellhound)) ? "its unnatural arousal, the infested" : "hurting you anymore, the") + " hellhound's flames dim as he stops his attack. The two heads look at you, whining plaintively.  The hellhound slowly pads over to you and nudges its noses at your crotch.  It seems he wishes to pleasure you.\n\n");
        }
        if (player.lust >= 33)
        {
            if (hpVictory)
    ...
    public function hellHoundGetsRaped() : Void
    {
        ...
        var dickMultiF : Void->Void = function() : Void
        {
    ...
    public function hellHoundPropahRape() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("spring to life, extending rapidly from the sheath. Tentatively you give one of them a gentle lick, being rewarded with a drop of pre-cum.\n\n");
        }
        else
        {
            outputText("still manage to leak plenty of hot, steamy pre-cum all over his belly. Tentatively you give one of them a gentle lick, being rewarded with a dollop of the stuff.\n\n");
        }
        //--- IF CORRUPTION < 20 ---
        ...
        else
        {
            ...
            {
                outputText("  Your " + chestDesc() + " jiggle in exquisite ways along with your bumping, grinding motions.");
            }
            ...
            if (player.hasCock())
            {
                ...
                {
                    outputText("  Soon your own [cock] reacts, quickly growing into a full throbbing erection. You leave your member alone, and it keeps flapping against the hellhound's belly while you ride him.");
                }
                //--- ELSE ---
                else
                {
                    outputText("  Soon " + sMultiCockDesc() + " reacts, quickly growing into a throbbing erection.  You leave your members alone, and they flap against the hellhound's belly while you ride him.");
                }
            }
            //--- IF PC HAS BALLS ---
            if (player.hasBalls())
            {
                outputText("  Whenever you lower your hips to your mates belly, your [balls] touches his. The magical flames fill your scrotum with unnatural heat but no pain. You literally feel the cum in your balls boiling upwards, building up immense pressure.");
            }
            outputText("\n\n");
            ...
            // --- IF ONE PENIS ---{
                ...
                if (player.cockTotal() == 1)
                {
                    outputText("Your [cock] twitches as it ejects its sticky load.");
                }
                //--- ELSE ---
                else
                {
                    outputText("Your [cocks] twitch as they eject their sticky loads.");
                }
    ...
    public function takeBothIn() : Void
    {
        ...
        {
            player.knockUp(PregnancyStore.PREGNANCY_ALRAUNE, PregnancyStore.INCUBATION_ALRAUNE, 101);
        }
        cleanupAfterCombat();
    }
    ...
    public function rapeCerberusStyle() : Void
    {
        ...
        {
            var ptier : Float = player.perkv1(IMutationsLib.HellhoundFireBallsIM);
