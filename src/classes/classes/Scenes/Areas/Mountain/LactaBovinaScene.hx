...
class LactaBovinaScene extends BaseContent
{
    ...
    public function lactaBovinaVictorySittingBoobjob() : Void
    {
        ...
        {
            outputText("The cow eyes go wide in surprise at your [cock], but she gets to work wrapping her pillows like breasts around your towering erection. ");
        }
    ...
    public function lactaBovinaRape() : Void
    {
        ...
        if (player.gender > 0)
        {
            outputText("Just as you work her mammaries you feel a hand reach for " + ((player.hasCock()) ? "your [cock] slowly jerking it to life" : "the folds of your [pussy], parting the lips away in order to insert digits after digits inside") + ".");
        }
