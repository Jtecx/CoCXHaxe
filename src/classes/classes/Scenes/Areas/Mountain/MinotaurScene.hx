...
class MinotaurScene extends BaseContent
{
    ...
    public function minoVictoryRapeChoices() : Void
    {
        ...
        if (player.isRaceCached(Races.CERBERUS))
        {
            ...
            {
                outputText("The minotaur collapses, losing all semblance of defiance as he warily looks up at your throbbing manhood. Now's the time to put this bull in his place.");
            }
        }
        else
        {
        ...
        if (player.lust >= 33)
        {
            var cockFits : Bool = player.cockThatFits(monster.analCapacity()) >= 0;
            ...
            //urethral check
            var urethral : Bool = false;  //dumb check for urethral  
    ...
    private function tentaMadness() : Void
    {
        ...
        if (monster.HP <= 0)
        {
            outputText("The minotaur collapses backwards after your last blow. Defeated and tired, he can barely stand up as you approach.  ");
        }
        else
        {
            ...
            {
                outputText(", letting his axe clatter to the floor");
            }
        ...
        if (player.cor < 25)
        {
            outputText("You cry, petting his hair, smoothing it across his horns, justifying to yourself that you are raping this beast because this is how this world works as you maneuver your " + multiCockDescript() + " towards his tailhole.  ");
        }
        if (player.cor >= 25 && player.cor < 50)
        {
            outputText("You smoothly guide your " + multiCockDescript() + " toward his tailhole.  ");
        }
        if (player.cor >= 50 && player.cor < 80)
        {
            outputText("You roughly grab him, slamming him close to your " + multiCockDescript() + " - just how this beast likes it.  ");
        }
        if (player.cor >= 80)
        {
            outputText("You grin and roughly pull his horns towards your " + multiCockDescript() + ", ready to roughly ride this beast.  ");
        }
        outputText("One of your prehensile dicks coils in on itself as it nears the minotaur's tailhole, readying itself. It then suddenly springs itself into his fleshy orifice, wiggling and writhing in deeper and deeper until all " + num2Text(as3hx.Compat.parseInt(player.cocks[x].cockLength)) + " inches of it have submerged itself inside his intestines. You and he both shudder as your cock starts weaving from side to side, making slithering motions inside him.  ");
        //Vaginassss
        ...
        if (tent > tentUsed++)
        {
            outputText("Your next tentacle dick, saddened by not having anything to writhe around, turns to the minotaurs protruding member. It darts out from your crotch, wrapping around his monstrous meat and constricting, like a snake might around its prey. Your tongue lolls out as you feel that cock twist and grab his dick, pulsing with both your blood and the beast's twitching member.  ");
        }
        if (tent > tentUsed++)
        {
            outputText("Your remaining tentacle dicks wave around the minotaur, tending to his balls, weaving around his limbs, and generally rubbing and throbbing all over him, spreading pre-cum around and through him, leaving both of you moaning in pleasure.  ");
        }
        //Cum
    ...
    private function tentacleDick() : Void
    {
        ...
        function vagF() : Void
        {
            ...
            if (player.cumQ() < 50)
            {
                outputText("Your cock made quite a mess of things, and when you pull him out, your " + vaginaDescript(0) + " makes a wet sucking sound.  ");
            }
            if (player.cumQ() >= 50 && player.cumQ() < 400)
            {
                outputText("Your cock made quite a mess of things inside your " + vaginaDescript(0) + ".  As you pull free, cum drips freely down your thighs.  The heavenly scent of minotaur spunk fills your nose, and begin scooping the mixed jizz up to sample.  ");
            }
            if (player.cumQ() >= 400)
            {
                outputText("Your cock made quite a mess of things inside your " + vaginaDescript(0) + ".  As you pull free, a river of cum pours from betwixt your thighs.  The heavenly scent of minotaur spunk fills your nose, and you begin scooping the mixed jizz up to sample.  ");
            }
        ...
        var assF : Void->Void = function() : Void
        {
            ...
            if (player.cumQ() < 50)
            {
                outputText("Your cock in his ass made a mess of things, and when you pull out, it makes a wet sucking sound, trying to keep you inside.  ");
            }
            if (player.cumQ() >= 50 && player.cumQ() < 400)
            {
                outputText("Your cock in his ass spills forth, creating a puddle, which will mat his fur later.  ");
            }
            if (player.cumQ() >= 400)
            {
                outputText("Your cock is blasted free from his ass by the force of your ejaculation, splattering rivers of spoo over the ground.  A river of the stickiness pours from his violated asshole, sticking in the fur of his thighs.  ");
            }
            player.sexReward("cum", "Anal");
            cleanupAfterCombat();
        }
        var mouthF : Void->Void = function() : Void
        {
            if (player.cumQ() < 25)
            {
                outputText("Eventually, the moment is right... you position yourself accordingly to do what you have in mind.  Your needs are both at their peak, and release will be soon!  Once you're properly set up behind him, you shove his head forward, making him take both your, and his own, dick into his mouth. His tongue trying to shove you out, slipping in between his and your own dick pushes you over the edge, and you release his balls, causing both of your dicks to fill his mouth with cum.");
            }
            //Big Cum
    ...
    private function AddictNagaOnMinotaur() : Void
    {
        ...
        {
            outputText("You slither towards the fallen monster, wishing to taste his addictive semen.  You notice that, despite the beating you just gave him, his huge cock is fully erect.  Delighted, you gently run both of your hands up and down its long shaft.  He exhales loudly, signaling his appreciation.\n\n");
        }
        ...
        if (player.hasCock())
        {
            outputText("furiously stroke your own [cocks]. Your muffled vocalizations of pleaure weakly join his own.\n\n");
        }
        else
        {
            outputText("part the folds of your " + vaginaDescript(0) + ", sliding it inside and masturbating with a furious vigor. Your muffled vocalizations of pleaure weakly join his own.\n\n");
        }
    ...
    private function minoRapeIntro() : Void
    {
        ...
        if (monster.HP <= 0)
        {
            ...
            {
                outputText("  Glancing back at you with hope in his eyes, the minotaur's [monster cockshort] twitches as he lays his gaze upon your " + vaginaDescript(0) + ".");
            }
            else
            {
                outputText("  Glancing back at you with eyes full of despair, the minotaur seems to realize you won't be helping the predicament his " + monster.ballsDescriptLight() + " are in.");
            }
        }
        ...
        else
        {
            ...
            {
                outputText(" and nipples");
            }
            outputText(".");
            //Vagina or not flavor texts
            if (player.vaginas.length > 0)
            {
                outputText("  Glancing back at you with hope in its eyes, the minotaur's [monster cockshort] twitches as he lays his gaze upon your " + vaginaDescript(0) + ".");
            }
            else
            {
                outputText("  Glancing back at you with eyes full of despair, the minotaur doubts you'll help relieve the predicament his " + monster.ballsDescriptLight() + " are in.");
            }
        }
    }
    ...
    private function bumRapeaMinotaur() : Void
    {
        ...
        if (player.cumQ() < 25)
        {
            outputText("dribbling a bit of slick pre-cum into his fur.  ");
        }
        if (player.cumQ() >= 25 && player.cumQ() < 250)
        {
            outputText("leaking thin ropes of pre-cum over his muscular ass.  ");
        }
        if (player.cumQ() >= 250 && player.cumQ() < 500)
        {
    ...
    private function alrauneVineInButtScene() : Void
    {
        ...
        if (player.isLiliraune())
        {
            outputText("ou both giggle as y");
        }
    ...
    private function girlRapeAMinotaur() : Void
    {
        ...
        if (player.isTaur())
        {
            outputText("hindquarters, forcefully grinding your vagina along his length like a toy.  ");
        }
        else
        {
            outputText(hipDescript() + ", forcefully grinding up and down along his length like a cheap sex-toy.  ");
        }
        //Size variants
        //Too small
        if (player.vaginalCapacity() < monster.cockArea(0))
        {
            outputText("Every ridge of his [monster cockshort] presses tightly against your walls, smearing more of his wondrous pre-seed into your body with every stroke.  ");
        }
        //Just right
        if (player.vaginalCapacity() >= monster.cockArea(0) && player.vaginalCapacity() * 1.5 < monster.cockArea(0))
        {
            outputText("Every stroke of his [monster cockshort] deposits a bit more of his wondrous preseed into your body, spreading a relaxing warmth throughout your groin.  ");
        }
        //Too big
        if (player.vaginalCapacity() * 1.5 >= monster.cockArea(0))
        {
            outputText("Every stroke of his [monster cockshort] slides easily into your " + vaginaDescript(0) + ", allowing him to slowly build up a puddle of his wondrous druggy pre-seed into your aching womb.  ");
        }
        //Resume!
    ...
    private function minotaurGetsRapedByHerms() : Void
    {
        ...
        {
            outputText("A small suppressed part of your mind dimly registers that this should be fairly painful, but the lust and drug-like pre-cum wash that thought away with waves of pleasure.  ");
        }
        if (player.vaginas[0].vaginalLooseness >= VaginaClass.LOOSENESS_GAPING)
        {
            outputText("The intense feelings seem to grow more and more powerful as he stays inside you, his drug-like pre-cum making your " + vaginaDescript(0) + " tingle from the inside-out.");
        }
    ...
    public function minoPheromones() : Void
    {
        ...
        {
            doNext(SceneLib.combat.combatMenu);
        }
    }
    ...
    public function minotaurEncounterAsCerberus(isMonoLord : Bool = false) : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_minotaur);
        ...
        if (isMonoLord)
        {
            outputText("carrying a huge axe ");
        }
        ...
        var ignoreMino : Void->Void = function() : Void
        {
        ...
        var fightMino : Void->Void = function() : Void
        {
    ...
    //Normal RAEP
    {
        ...
        if (player.vaginas.length > 0)
        {
            ...
            {
                outputText("You aren't very wet, and fear the damage this beast will inflict on your " + vaginaDescript(0) + ".  ");
            }
            else
            {
                outputText("You're shamefully wet by this point, and your knees are ready to buckle.  ");
            }
            minoCumAddiction(5);
        }
        //BUTTSECKS!
        ...
        if (player.biggestTitSize() > 0 && player.mostBreastsPerRow() > 1 && player.breastRows.length > 0)
        {
            ...
            {
                outputText("He then gives a grunt in what you take to be approval as your milk begins to squirt out. He licks a milk-coated finger in satisfaction.  ");
            }
        }
        if (player.cockTotal() == 1)
        {
            outputText("The bull-man bends forward a little, and grabs your [cock] in a crushing grip. He makes short jerking motions as he keeps thrusting into you.");
        }
        if (player.cockTotal() > 1)
        {
            outputText("The bull-man bends forward a little, and grabs one of your [cock]s in a crushing grip. He makes short jerking motions as he keeps thrusting into you.");
        }
        if (player.vaginas.length > 0)
        {
            if (player.vaginalCapacity() < monster.cockArea(0))
        ...
        if (player.vaginas.length > 0)
        {
            if (player.averageVaginalWetness() >= 2)
            {
                ...
                {
                    outputText("You squirm and quiver, orgasming from the beast's rough usage.  ");
                }
                if (player.averageVaginalWetness() == 4)
                {
                    outputText("You squirm and quiver, orgasming from the beast's rough usage, soaking him with your " + vaginaDescript(0) + ".  ");
                }
                if (player.averageVaginalWetness() == 5)
                {
                    outputText("You orgasm on his massive rod, splattering the beast with girlcum.  ");
                }
        ...
        if (player.cockTotal() > 0 && (player.sens + rand(40) > 50))
        {
            ...
            if (player.cumQ() < 25)
            {
                outputText("spurting your seed helplessly from the brutal rape.  ");
            }
            if (player.cumQ() >= 25 && player.cumQ() < 250)
            {
                outputText("squirting thick ropes of cum over the cave.  ");
            }
            if (player.cumQ() >= 250 && player.cumQ() < 500)
            {
                outputText("erupting potent ropes of seed in thick bursts, splattering the cave walls and floors.  ");
            }
            if (player.cumQ() >= 500)
            {
                outputText("erupting a thick torrent of seed that seems to go on forever, spurred by the constant pressure of the huge minotaur cock.  You paint the cave wall with cum, the beast egging you on as it roughly jacks your [cock].  You are vaguely aware of your orgasm dragging on and on, until eventually your orgasm stops, leaving a sizable puddle of cum on the floor.  ");
            }
            player.sexReward("no", "Dick");
            dynStats("lib", .5, "sen", 1, "cor", 1);
        }
    ...
    private function getOralRapedByMinotaur() : Void
    {
        ...
        {
            outputText("  The bull-man grabs your " + biggestBreastSizeDescript() + ", squeezing and mauling them with his calloused hand.");
        }
        if (player.cockTotal() >= 1)
        {
        ...
        if (player.hasBreasts())
        {
            outputText(", painfully grinding your " + nippleDescript(0) + " against his wiry fur");
        }
        if (player.hasBalls())
        {
            outputText(", and you can feel the minotaur's hot breath on your " + ballsDescriptLight());
        }
    ...
    private function minoGetsTitFucked() : Void
    {
        ...
        {
            outputText("masturbating uncontrollably.  ");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("You push his hands away and y");
        }
        else
        {
            outputText("Y");
        ...
        {
            outputText("  Your [cock] grows harder and more aroused than ever before while your ");
        }
        else
        {
            outputText("  Your body aches with arousal while your ");
        }
        if (player.hasVagina())
        {
            outputText(vaginaDescript(0) + " grows hotter and hotter, begging to be taken.");
        }
        else
        {
            outputText(assholeDescript() + " puckers slightly, as if begging to be taken by another monstrous beast.");
        }
        outputText("\n\n");
    ...
    private function takeMinoCumDirectly() : Void
    {
        ...
        if (monster.HP <= monster.minHP())
        {
            outputText("The beast-man has fallen on his back, comatose and insensate, though his shaft has risen to full erectness, displacing his loincloth.");
        }
        else
        {
            outputText("The beast-man is on his back with his legs splayed, masturbating hopelessly.  His anguished moans tell you all you need to know – he'll never get off alone.");
        }
        ...
        if (!player.buttChange(monster.cockArea(0), true))
        {
            outputText("  ");
        }
    ...
    private static function minoCumAddiction(raw : Float = 10) : Void
    {
        player.minoCumAddiction(raw);
    }
    
    public function minoCumUpdate() : Bool
    {
        ...
        //Clear addiction if addicted!{
            ...
            //Clear addiction text{
                ...
                if (player.cor > 60)
                {
                    outputText("but miss the tingling apathy and fuzziness that filled your head every time one of them was squirting inside you.");
                }
                else
                {
                    outputText("and resolve to give the beasts a wide berth from now on.");
                }
                outputText("</b>\n");
        ...
        if (flags[kFLAGS.MINOTAUR_CUM_REALLY_ADDICTED_STATE] > 0)
        {
            ...
            if (flags[kFLAGS.MINOTAUR_CUM_REALLY_ADDICTED_STATE] < 0)
            {
                flags[kFLAGS.MINOTAUR_CUM_REALLY_ADDICTED_STATE] = 0;
            }
        }
        return output;
    }
    ...
    private function minotaurBlowjob() : Void
    {
        spriteSelect(SpriteDb.s_minotaur);
        clearOutput();
        var x : Float = player.cockThatFits(80);
        outputText("You step towards the minotaur, ");
        if (!player.isTaur())
        {
            outputText("peeling away your [armor] and ");
        }
        ...
        if (!player.isTaur())
        {
            outputText("taking the bull by the horns");
        }
        else
        {
            outputText("pinning his horns in the crook of your forelegs");
        }
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("his own burning lusts");
        }
        else if (player.hasPerk(PerkLib.ArousingAura))
        {
            outputText("the power of your corruption");
        }
        else
        {
            outputText("the salty taste of your pre-cum");
        }
        ...
        if (!player.isTaur())
        {
            outputText("finding your hands leaving his horns for the back of his head ");
        }
        ...
        if (!player.isTaur())
        {
            outputText("your hand");
        }
        else
        {
            outputText("a forehoof");
        }
    ...
    private function layEggsInAMinotaurSpiderLike() : Void
    {
        ...
        if (!silly())
        {
            outputText("his bovine rosebud.");
        }
        else
        {
            outputText("the entrance to his O.K. Corral.");
        }
        ...
        if (player.gender > 0)
        {
            ...
            if (player.hasCock())
            {
                outputText("Forcing [oneCock] between his bound thighs, you frot his flared bull-cock, your mixed pre soaking into the fur of his belly as you thrust against him.");
            }
            if (player.hasVagina())
            {
                outputText("Grasping his bull-cock, you pull it against your pussy, rubbing your juices up and down his impressive length as your lips and clit grind on him, adding to your pleasure.");
            }
        }
        ...
        if (player.hasCock())
        {
            ...
            {
                outputText("nearly drowning");
            }
            outputText(" your helpless prey.  ");
        }
        if (player.hasVagina())
        {
            outputText("Your femcum sprays across his cock.  ");
        }
        ...
        if (player.gender > 0)
        {
            outputText("combination of the scent of your fluids and the ");
        }
    ...
    private function layBeeEggsInCowbutt() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText(", stroking his flared cock desperately");
        }
        ...
        if (!player.isTaur())
        {
            outputText("  Wrapping his tail around one hand, you lift his furred flanks up");
        }
        else
        {
            outputText("  Straddling him with all four legs, you slide forward");
        }
        ...
        if (player.cor < 50)
        {
            outputText("You hesitate, feeling a surge of pity for the once-mighty creature, but your new instincts drive your egg-layer further into his prone body.  ");
        }
        else
        {
            outputText("Grinning cruelly, you grasp him by the horns and haul back with both hands until the minotaur is forced to look you in the eye.  You lean in close to his snout and buzz mockingly, \"<i>Whoz the bitch now?  Iz it you?  Yezz, it izz!</i>\"  ");
        }
        ...
        if (player.hasCock())
        {
            ...
            {
                outputText("back with your cum, with ropes dripping slowly off his horns and down his face");
            }
            else
            {
                outputText("back with your cum, before it covers him and spreads across the floor of his cave.");
            }
        }
        //(if female:
    ...
    {
        var smallMax : Int = as3hx.Compat.parseInt(monster.analCapacity() / 3);
        var bigMin : Int = as3hx.Compat.parseInt(monster.analCapacity() * 2 / 3);
        clearOutput();
        if (flags[kFLAGS.TIMES_MINO_MUTUAL] <= 0)
        ...
        var selected : Int->Void = function(x : Int) : Void
        {
            var x1 : Int = as3hx.Compat.parseInt(x + 1);
            if (player.hasVagina())
            {
                outputText(images.showImage("minotaur-mutual-part1herm"));
            }
            else
            {
                outputText(images.showImage("minotaur-mutual-part1"));
            }
            ...
            if (player.hasBalls())
            {
                ...
                else if (player.ballSize > 1 && player.ballSize <= 4)
            ...
            //normal cum{
                ...
                {
                    outputText("He releases a grunt of triumph as he greedily sucks your spurting cock, noisily gulping your load as he rubs your [legs]. It is almost as if he wants you to cum even more.");
                }
            }
            else if (player.cumQ() > 25 && player.cumQ() <= 250)
            ...
            else if (player.cumQ() > 250 && player.cumQ() < 500)
    ...
    private function minoMutualPt2(x : Int) : Void
    //pt2-1
    {
    ...
    private function minoMutualPt2Frot(x : Int) : Void
    //pt2-2
    {
    ...
    private function minoMutualPt3(x : Int) : Void
    //pt3-1
    {
    ...
    private function minoMutualPt3MoneyShots(x : Int) : Void
    //pt3-2
    {
    ...
    private function getMinoHawtDawged() : Void
    {
        ...
        else if (monster.weaponName == "axe")
        {
        ...
        if (player.hasCock())
        {
            outputText("[eachCock] twitching beneath you, painting the floor with dribbles of your pre.");
        }
        if (player.gender == 3)
        {
            outputText("  You also feel ");
        }
        if (player.hasVagina())
        {
            outputText("your [vagina] clenching and unclenching as your entire hips try to push against the Minotaur's searching tongue, dripping with his spit - along with your own juices.");
        }
    ...
    public static function slimeSateYourself() : Void
    {
        ...
        player.sexReward("cum", "Lips");
        if (Std.is(CoC.instance.monster, Minotaur))
        {
            minoCumAddiction(25);
            player.slimeFeed(5);
        }
