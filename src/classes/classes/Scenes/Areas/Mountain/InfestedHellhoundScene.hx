...
class InfestedHellhoundScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function infestedHellhoundEncounter() : Void
    {
        ...
        {
            outputText("making your jello-like body jiggle");
        }
        else
        {
            outputText("rattling your teeth");
        }
    ...
    public function infestedHellhoundLossRape() : Void
    {
        ...
        //(LUST){
            ...
            if (player.lust >= player.maxOverLust())
            {
                ...
                if (player.cor < 33)
                {
                    outputText("In spite of your revulsion ");
                }
                else if (player.cor < 66)
                {
                    outputText("In spite of your better sense ");
                }
                else
                {
                    outputText("With a perverse sense of anticipation ");
                }
            ...
            {
                outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-sharp teeth easily sink into your [armor] before tearing away the offending armor, exposing your [ass] and [cocks].  A cold mountain breeze blows across your now-exposed [skin.type], reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity. With a brutal lunge it knocks you off your [feet] and onto your back.\n\n");
            }
        ...
        //(LUST){
            ...
            if (player.cockTotal() > 1)
            {
                ...
                if (player.hasBalls())
                {
                    outputText(ballsDescriptLight() + " shiver as hot doggie-cum and wiggling worms are pumped directly into them.  ");
                }
                else
                {
                    outputText("body feels uncomfortably full as hot doggie-cum and wriggling worms are pumped directly into your prostate.  ");
                }
        ...
        //(LUST){
            ...
            if (player.cor < 66)
            {
                outputText("You beg, \"<i>Please, no, no!  I don't want them... in me!</i>\"\n\n");
            }
            else
            {
                outputText("You start to beg it not to put them inside you, but your protests drop off when you realize how good they could feel squirming inside you.\n\n");
            }
            ...
            if (!player.isPregnant())
            {
                ...
                {
                    player.knockUpForce(PregnancyStore.PREGNANCY_WORM_STUFFED, 100 + player.statusEffectv1(StatusEffects.WormPlugged), 1);
                }
            }
        ...
        else
        {
            ...
            if (player.cor < 80)
            {
                outputText("You beg, \"<i>Please, no, no!  I don't want it... in me!</i>\"\n\n");
            }
            else
            {
                outputText("You start to beg it not to put it inside you, but your protests drop off when you realize how good they could feel squirming inside you.\n\n");
            }
