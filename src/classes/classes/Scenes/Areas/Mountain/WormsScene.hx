...
class WormsScene extends BaseContent
{
    ...
    public function wormEncounter() : Void
    {
        ...
        clearOutput();
        if (!player.hasStatusEffect(StatusEffects.MetWorms))
    ...
    public function nightTimeInfestation() : Void
    {
        ...
        {
            outputText("as tight around the girth as you can");
        }
        else
        {
            outputText("tightly around your girth");
        }
