...
class HellHound extends Monster
{
    ...
    private function hellhoundFire() : Void
    //Blind dodge change
    {
    ...
    private function hellhoundScent() : Void
    {
    ...
    override public function defeated(hpVictory : Bool) : Void
    {
        ...
        else if (player.hasStatusEffect(StatusEffects.SoulArenaGaunlet))
        {
            SceneLib.hexindao.gaunletchallange2fight3();
        }
        else
        {
