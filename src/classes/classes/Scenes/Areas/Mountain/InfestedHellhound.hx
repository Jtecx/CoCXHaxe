...
/**
	 ...
	 * @author Fake-Name
	 */
class InfestedHellhound extends HellHound
{
    ...
    private function hellHoundWormCannon() : Void
    {
        ...
        //Get hit – 10+ lust{
            ...
            if (player.hasStatusEffect(StatusEffects.Infested) && player.cockTotal() > 0)
            {
                ...
                if (player.hasBalls())
                {
                    outputText("  Your [balls] grow weightier as the worms settle into their new home, arousing you beyond measure.");
                }
                else
                {
                    outputText("  You can feel them shifting around inside you as they adjust to their new home, arousing you beyond measure.");
                }
            ...
            {
                outputText("  Thankfully, the worms don't seem to want anything to do with you, and rapidly drop down to the ground.");
            }
        }
        //Sidestep
        else
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.CANINEP, 3).addMany(1, consumables.BULBYPP, 
                        consumables.KNOTTYP, 
                        consumables.BLACKPP, 
                        consumables.DBLPEPP, 
                        consumables.LARGEPP
