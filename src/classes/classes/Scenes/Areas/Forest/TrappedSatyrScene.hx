...
class TrappedSatyrScene extends BaseContent
{
    ...
    private function ignoreSatyr() : Void
    {
        ...
        outputText("You shake your head, " +
                (((player.cor < 50)) ? "disgusted by the strange thoughts this place seems to put into your mind" : "not feeling inclined to rape some satyr butt right now") +
    ...
    private function rapeSatyr() : Void
    {
        ...
        {
            outputText("stretching it all out of normal proportion and ruining it for whomever might happen to use it next.");
        }
        else
        {
            outputText("stretching it to fit your [cock biggest] like a condom.");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            outputText(", although his eyes have widened perceptibly along with the stretching of his stomach");
        }
        outputText(".\n\n");
