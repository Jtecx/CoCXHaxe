...
class HornetHuntress extends HornetGirl
{
    ...
    public function hornetJavelinAttack2() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = 0;
            damage += as3hx.Compat.parseInt((str * 12) + rand(240));
    ...
    public function hornetSpearAttack() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = 0;
            damage += as3hx.Compat.parseInt((str * 15) + rand(300));
            player.takePhysDamage(damage, true);
        }
    }
    ...
    public function new()
    {
        ...
        if (player.hasStatusEffect(StatusEffects.RiverDungeonA))
        {
            ...
            this.drop = new ChainedDrop().add(consumables.OVIELIX, 1 / 4).add(consumables.BEEHONY, 1 / 3).add(useables.PCSHARD, 1 / 2).elseDrop(useables.B_CHITN);
        }
        else
        {
