...
class BeeGirlHuntress extends BeeGirl
{
    ...
    public function new()
    {
        ...
        if (player.hasStatusEffect(StatusEffects.RiverDungeonA))
        {
            ...
            initWisLibSensCor(260, 420, 300, -100);
            ...
            this.drop = new ChainedDrop().add(consumables.W__BOOK, 1 / 6).add(consumables.BEEHONY, 1 / 4).add(useables.PCSHARD, 1 / 2).elseDrop(useables.B_CHITN);
        }
        else
        {
            ...
            initWisLibSensCor(50, 140, 115, -100);
