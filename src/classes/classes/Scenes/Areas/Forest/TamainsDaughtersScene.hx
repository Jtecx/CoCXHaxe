...
class TamainsDaughtersScene extends BaseContent implements TimeAwareInterface
{
    ...
    public function timeChange() : Bool
    {
        ...
        {
            if (flags[kFLAGS.TAMANI_DAUGHTERS_LVL_UP] > 0)
            {
    ...
    @:allow(classes.scenes.areas.forest)
    private static var tamaniPresent : Bool = false;  //Used to communicate between this class and TamanisDaughters.as  
    ...
    {
        if (flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] < 20)
        {
            return "C";
        }
        else if (flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] < 30)
        {
            return "D";
        }
        else if (flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] < 40)
        {
            return "DD";
        }
        else if (flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] < 50)
        {
            return "E";
        }
        else if (flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] < 60)
        {
            return "EE";
        }
        return "F";
    ...
    public function encounterTamanisDaughters() : Void
    {
        ...
        {
            tamaniPresent = true;
            outputText("While roaming along, you find your path ahead blocked by " + num2Text(as3hx.Compat.parseInt(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 3)) + " goblins.  At the forefront of the mob is Tamani");
            if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] >= 10)
            {
                outputText(", your wife");
            }
        ...
        outputText(num2Text(as3hx.Compat.parseInt(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 3)) + " goblins.  You ");
        if (player.weaponName == "fists")
        {
            outputText("ready your fists ");
        }
        else
        {
            outputText("draw your weapon ");
        }
    ...
    private function playDumbToTamanisDaughters() : Void
    {
        ...
        if (player.inte / 2 + 25 > rand(75))
        {
            ...
            if (flags[kFLAGS.TIMES_ENCOUNTED_TAMANIS_DAUGHTERS] > 1)
            {
                outputText("They really must not be paying much attention to what you look like.");
            }
            endEncounter();
            return;
        }
    ...
    private function fuckYoDaughtersHomie() : Void
    {
        ...
        var scene : Int->Void = function(x : Int) : Void
        {
            var daughters : Float = as3hx.Compat.parseInt(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] * 0.75);
            ...
            if (player.cockArea(x) <= 50)
            {
                ...
                if (tamaniPresent)
                {
                    ...
                    if (player.hasBalls())
                    {
                        outputText("cups your [balls].");
                    }
                    else
                    {
                        outputText("licks your taint.");
                    }
                }
                outputText("\n\n");
                ...
                if (player.cumQ() >= 500)
                {
                    outputText(", bloating her belly until she gurgles and squishes on top of you");
                }
                ...
                if (tamaniPresent)
                {
                    ...
                    {
                        outputText("scrabbling up enough to ");
                    }
                ...
                {
                    outputText("Tamani's daughter looks up at you, giggling happily while her hips vigorously abuse you.   She asks, \"<i>Do you think my cunt is tighter than mom's is?  Bet you never thought you'd be fucking one of your daughters pregnant, did you?</i>\"\n\n");
                }
                
                outputText("Such perverse thoughts, and coming from your own daughters.  ");
                if (player.cor < 33)
                {
                    outputText("You were supposed to save the village from corruption, not breed tiny sluts to overrun it... y");
                }
                else if (player.cor < 66)
                {
                    outputText("You came here to make things better for everyone... well, at least you're helping these girls. Y");
                }
                else
                {
                    outputText("You came here to make things better, but you know you'll keep knocking up Tamani every chance you get.  It's too much fun to resist adding to the sea of green girls. Y");
                }
                ...
                {
                    outputText("favorite goblin MILF");
                }
                outputText(".\n\n");
                ...
                if (!tamaniPresent)
                {
                    outputText("your goblin daughter");
                }
                else
                {
                    outputText("Tamani");
                ...
                if (daughters > 10)
                {
                    ...
                    if (player.hasBalls())
                    {
                        outputText("Your balls visibly puff up and slosh as one of your daughters plays with them, filling with more seed than ever before.");
                    }
                    else
                    {
                        outputText("Your gut clenches painfully as something inside puffs up.  Pressure builds at the base of your cock and you realize somehow you're more full of cum than ever before.");
                    }
                    outputText("\n\n");
                    if (tamaniPresent)
                    {
                        ...
                        {
                            outputText("She fondles her nipples");
                        }
                    ...
                    if (player.hasBalls())
                    {
                        outputText(ballsDescriptLight() + " empty");
                    }
                    else
                    {
                        outputText("prostate empties");
                    }
                    ...
                    if (daughters > 20)
                    {
                        ...
                        if (tamaniPresent)
                        {
                            outputText(" while Tamani walks away");
                        }
                        ...
                        if (daughters < 50)
                        {
                            outputText("Girlish giggles sooth you to sleep as the crowd slowly disperses.");
                        }
                        else
                        {
                            outputText("Girlish giggles sooth you to sleep as your body caves in to its fatigue.  The last thing you hear is the biggest daughter suggesting, \"<i>We should keep daddy around all the time...</i>\"");
                        }
                    }
                }
                //(Normal end)
                if (daughters <= 20)
                {
                    ...
                    if (tamaniPresent)
                    {
                        outputText(" and Tamani passionately frenches you.");
                    }
                    else
                    {
                        outputText(".");
            ...
            else
            {
                ...
                if (tamaniPresent)
                {
                    ...
                    {
                        outputText("You can hear her climbing up on something behind you, in order to get to the right height.  ");
                    }
                    ...
                    if (player.hasBalls())
                    {
                        outputText("  Your [balls] ache from the strain, but struggle to churn up more sperm.  ");
                    }
                ...
                {
                    sceneHunter.print("Failed check - Tamani is not present.");
                }
                ...
                if (!tamaniPresent)
                {
                    outputText("She presses something against your backdoor and before you have a chance to react, something hot and wet is filling your " + assholeDescript() + ".  You look down as she pulls out a tube of pink residue, and sways with burning desire.\n\n");
                }
                else
                {
                ...
                if (!tamaniPresent)
                {
                    outputText("You're handed another bottle as t");
                }
                else
                {
                    outputText("T");
                ...
                if (!tamaniPresent)
                {
                    outputText("You shrug and drink it, ");
                }
                else
                {
    ...
    private function legTamanisDaughtersRAEPYou() : Void
    {
        ...
        function scene(x : Int) : Void
        {
            ...
            var daughters : Float = as3hx.Compat.parseInt(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 2);
            ...
            if (player.cockArea(x) <= 50)
            {
                ...
                if (cocks == 2)
                {
                    outputText("Another set of hands latches on to your free dick and forces herself down on top it, sitting back to back with the other lucky slut as she takes it to the hilt.  Somehow you know that if you could see beyond the tight body smothering your face, watching your daughters fuck together would push you over the edge.");
                }
                else if (cocks > 2)
                {
                    outputText("More and more hands latch onto the rest of your [cocks], guiding each of them into a tight cunt-hole.   If you could see around the tight body of the slut on your face, you're sure the scene on your crotch would push you over the edge.");
                }
                else
                {
                    outputText("You stiffen as a tongue suddenly presses against your " + assholeOrPussy() + " sliding inside and intensifying the feelings radiating down your fuck-pole until you're unable to hold on.");
                }
                outputText("\n\n");
                ...
                if (cocks > 2)
                {
                    outputText("so many girls impaled on your flesh");
                }
                else if (cocks == 2)
                {
                    outputText("your daughters' whorish expressions of pleasure");
                }
                else
                {
                    outputText("the sultry gaze of Tamani's oldest daughter as she rides your [cock " + (x + 1) + "]");
                }
                outputText(", you can do nothing but cum.  ");
                if (cocks > 1)
                {
                    outputText("Twitching powerfully, your body unloads into the tight, fertile cum-receptacles, giving them exactly what they want.");
                }
                else
                {
                    outputText("Twitching powerfully, your body unloads into the tight, fertile cum-receptacle, giving her exactly what she wants.");
                }
                if (player.cumQ() >= 1000)
                {
                    ...
                    if (cocks == 1)
                    {
                        outputText("her belly until she looks a little pregnant");
                    }
                    else
                    {
                        outputText("each of their uteruses until they look a little pregnant");
                    }
                    outputText(".");
                }
                if (cocks == 1)
                {
                    outputText("  She rises up off of your wilting member, blowing you a kiss and saying, \"<i>I think you got me pregnant Daddy!</i>\"\n\n");
                }
                else
                {
                    outputText("  They rise up off your wilting members.  The eldest daughter blows you a kiss and says, \"<i>I think you got us pregnant Daddy!</i>\"\n\n");
                }
                ...
                if (tamaniPresent)
                {
                    ...
                    if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 10)
                    {
                        outputText("'Wait... wife... mistress?' your mind wonders, rejecting the foreign thoughts.  You look up at Tamani, confused for a moment");
                    }
                    else
                    {
                        outputText("Yes, that sounds so right – Tamani is your wife, and it's your husbandly duty to keep her pregnant.  You dwell on that for a moment");
                    }
                    ...
                    if (daughters < 20)
                    {
                        outputText("the small pack of goblins is upon you, forcing liquids down your throat and making you fill cunt after cunt with sticky seed.");
                    }
                    else if (daughters < 30)
                    {
                        outputText("the pack of goblin daughters is upon you, forcing potent aphrodisiacs down your throat as you're raped for hours, forced to pack cunt after cunt full of jism.");
                    }
                    else
                    {
                        outputText("the massive group of goblins is on top of you, drugging and raping you over and over until you've had dozens of orgasms and licked off nearly as many cream-bloated sluts.");
                    }
                ...
                else
                {
                    ...
                    if (daughters < 40)
                    {
                        sceneHunter.print("Failed check: need more daughters!");
                    }
                    //(SMALL PACK)
                    if (daughters < 20)
                    {
                        ...
                        if (player.cumQ() < 100)
                        {
                            outputText("as you twitch underneath her, emptying the last of your cum inside her.");
                        }
                        else if (player.cumQ() < 500)
                        {
                            outputText("as you twitch underneath her, pumping her full of cum, thoroughly seeding her womb with spunk.");
                        }
                        else
                        {
                            outputText("as you twitch underneath her in powerful spasms, blasting huge gouts of cum into her waiting body until her belly is bloated with seed and it begins to squirt out around you in time with each eruption of spunk.");
                        }
                        ...
                        if (player.cumQ() >= 500)
                        {
                            outputText("  A few enterprising goblins gather around, gathering up the loose spunk and shoveling it into their holes.");
                        }
                        outputText("\n\n");
                    ...
                    else
                    {
                        ...
                        if (player.hasBalls())
                        {
                            outputText("balls begin swelling, trembling as they visibly inflate, preparing a massive load of seed.");
                        }
                        else
                        {
                            outputText("groin shifts uncomfortably, trembling as it begins preparing a massive load of seed.");
                        }
                        ...
                        if (daughters < 40)
                        {
                            ...
                            if (player.hasBalls())
                            {
                                outputText(ballsDescriptLight() + " hurt");
                            }
                            else
                            {
                                outputText("crotch hurts");
                            }
            ...
            else
            {
                ...
                if (!tamaniPresent)
                {
                    ...
                    if (cocks == 2)
                    {
                        outputText("  Another one of the petite sluts climbs aboard your [cock " + (y + 1) + "], squealing happily to her sister as she joins her in riding you.");
                    }
                    if (cocks > 2)
                    {
                        ...
                        if (cocks > 3)
                        {
                            outputText("remaining " + multiCockDescriptLight());
                        }
                        else
                        {
                            outputText(cockDescript(z));
                        }
                        outputText(".");
                    }
                    outputText("\n\n");
                    ...
                    if (cocks == 2)
                    {
                        outputText("Her sister agrees, \"<i>Yeah, I want to feel the hot cum squirting into my cunt.  Fill me full of so many babies that you make Mom jealous!</i>\"\n\n");
                    }
                    else if (cocks > 2)
                    {
                        outputText("Her sisters agree, \"<i>Yeah, we want to feel the hot cum squirting into our cunts!  Fill us up with so many babies that Mom gets jealous!</i>\"\n\n");
                    }
                    ...
                    if (cocks == 1)
                    {
                        ...
                        if (player.cumQ() < 100)
                        {
                            outputText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.");
                        }
                        else if (player.cumQ() < 500)
                        {
                            outputText("your orgasm drags on, pumping the slut up until she looks slightly pregnant.");
                        }
                        else
                        {
                            ...
                            if (player.cumQ() > 1000)
                            {
                                outputText("  Seed gushes out her opening, actually pushing the goblin away as your orgasm splatters cum into the grass.");
                            }
                            if (player.cumQ() > 5000)
                            {
                                outputText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.");
                            }
                        }
                    }
                    //Multi jizz scene
                    else
                    {
                        ...
                        {
                            outputText("your orgasm drags on, pumping the sluts up till they look slightly pregnant.");
                        }
                        else
                        {
                            ...
                            if (player.cumQ() > 1000)
                            {
                                outputText("  Seed gushes out their openings, actually pushing the goblins away as your orgasm splatters cum into the grass.");
                            }
                            if (player.cumQ() > 5000)
                            {
                                outputText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.");
                    ...
                    if (cocks == 1)
                    {
                        outputText("The purple-lipped cock-slut grabs your [cock] and makes a show of smearing the slippery fluid over your shaft, lubricating it as she jacks you off.  Her warm lips form a tight seal on your [cockhead] as the young goblin begins lapping at your pre-cum as she sucks it from your urethra.   It feels heavenly, and your " + hipDescript() + " pump weakly into the air in an instinctive bid to enhance the sensation.");
                    }
                    //(multiple)
                    else
                    {
                        ...
                        if (cocks > 2)
                        {
                            outputText("They spread out until every one of your [cocks] has at least one goblin hanging off it, stroking and touching you.  ");
                        }
                ...
                else
                {
                    ...
                    if (player.cor > 66)
                    {
                        outputText("sigh, actually anticipating what's about to come");
                    }
                    else if (player.cor > 33)
                    {
                        outputText("don't resist, knowing there's no way to stop what's about to happen");
                    }
                    else
                    {
                        outputText("shudder, struggling to pull free");
                    }
                    ...
                    if (daughters < 20)
                    {
                        outputText("there's other girls waiting");
                    }
                    else if (daughters < 35)
                    {
                        outputText("we've got a lot of girls to fill up");
                    }
                    else
                    {
                        outputText("there's a TON of you here so you'll need to move quick if you each want a turn");
                    }
                    ...
                    if (cocks > 2)
                    {
                        ...
                        if (player.biggestLactation() >= 1)
                        {
                            ...
                            else if (player.biggestLactation() < 5)
                            {
                                outputText("spew");
                            }
                            else
                    ...
                    if (daughters < 20)
                    {
                        outputText("The crowd of girls takes their time since there's only around a dozen or so left to fill.  They ride you long and hard, getting their wombs packed full and making a mess while they do it.  Even after all of them has been filled, Tamani's potent chemicals keep you locked in orgasm, dripping unholy amounts of semen everywhere.  A few of the more daring of your offspring take turns sliding the tip into their tight assholes, allowing you to fill them completely as the drugs finally begin to wear off.\n\n");
                    }
                    //(ALT MORE GIRLZ)
                    else if (daughters < 35)
                    {
                        outputText("The crowd of girls seems to take forever to get filled.  Every time one of them gets too into it, her mother pulls her back and guides the next willing hole into place.  In spite of the orderly procession, cum manages to get everywhere, soaking your torso and more than a few goblin thighs with a glaze of whiteness.  The whole time, you're kept in constant orgasm, though by the time you're filling the last girl with cum, the flow is slowing while the chemicals wear off.\n\n");
                    }
                    //(ALT TOO MANY GIRLZ)
                    else
                    {
                        outputText("The massive crowd is forced to carefully ration your semen, bountiful though it is.   Tamani doesn't even let the girls get completely filled, instead forcing each of them to only get a few cunt-filling moments of your orgasm.  Those who've already had a turn hang around, scooping up the sperm-filled fluid that's leaking out and shoveling it into their baby-craving bodies.  The whole time you're kept locked in incredible climax.  If you had any capacity for reason you'd probably feel more like a tool than " + player.mf("man", "woman") + ", but the synapses of your brain are too busy firing off about how good it feels to think.  By the time the last girl gets her turn, your orgasm has trailed off to a weak flow, so she stays on until the drugs finally wear off.\n\n");
                    }
                    ...
                    if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 10)
                    {
                        outputText("She's the best wife ever.  You nuzzle deep into her cleavage, sighing happily.");
                    }
                    else if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 5)
                    {
                        outputText("She really is a great wife... wait, wife? You shrug away the thought and enjoy slowly motorboating her breasts.");
                    }
                    else
                    {
                        outputText("She really isn't that bad to you, is she?  You sigh and nuzzle against her jiggly love-pillows.");
                    }
    ...
    private function tamaniDaughtersCombatLossDrain() : Void
    {
        ...
        if (player.lust >= player.maxOverLust())
        {
            ...
            if (player.hasBalls())
            {
                outputText("fondling your balls and ");
            }
            outputText("stroking your shaft to keep you nice and excited, squirming helplessly with desire.");
        }
        else
        {
            outputText("Your abused body slips in and out of consciousness, but the crowd applies salves as they travel to slowly invigorate your form.  Their hands keep touching and stroking you, and despite your mighty efforts to resist, you find yourself aroused and willing in short order.");
        }
        outputText("\n\n");
        ...
        if (cocks > 1)
        {
            outputText(" things not restrained are your [cocks], standing at attention despite, or perhaps because of, your predicament.\n\n");
        }
        else
        {
            outputText(" thing not restrained is your [cocks], standing at attention despite, or perhaps because of, your predicament.\n\n");
        }
        ...
        {
            outputText("\"<i>Stop worrying.  I invented this while I was waiting on mom to bring me back more of your cum, just in case we ever got our hands on you.  I promise, after you've had a taste of my chair you'll never want to leave.</i>\"\n\n");
        }
        else
        {
            outputText("\"<i>Stop worrying!  We both know you love my little love-seat.  Just lie back and you'll be cumming too hard to care before long.</i>\"\n\n");
        }
        ...
        if (flags[kFLAGS.TAMANI_DAUGHTERS_TIMES_LOST] == 0)
        {
            outputText("Time for your medicine!  We need you to cum enough for each of us, and maybe have a little left over to play with, so suck up the medicine, okay?  Just relax and let it fill you so that you give us all that yummy cummy!</i>\"\n\n");
        }
        else
        {
            outputText("Relax Dad, we're just giving you your cummy medicine.  I know you're a sexy, virile " + player.mf("stud", "slut") + "and all, but take your medicine and you'll have more than enough cum for us!</i>\"\n\n");
        }
        ...
        {
            outputText("unimaginably turned on by being used and abused by such machinery in front of an audience of your own horny children.");
        }
        else if (player.cor > 60)
        {
            outputText("turned on by being milked in such an obscene way.");
        }
        else
        {
            outputText("horrified at the situation but unable to resist arousal as you're constantly sucked and pleasured.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("Your balls tighten inside your sack and swell up like sponges, slowly increasing in size in time with your desire.");
        }
        else
        {
            outputText("Your body feels tight and needy, your gut clenching as your body adjusts to the drugs it's absorbing so readily through your " + assholeDescript() + ".");
        }
        ...
        if (player.hasBalls())
        {
            outputText("Straining and shaking, your [balls] clench against you, feeling tight as your body struggles to pump out the spooge they're producing.");
        }
        else
        {
            outputText("Straining and shaking , your body struggles through the orgasm as it tries to deal with all the cum your prostate and glands are putting out.");
        }
    ...
    private function tamaniDaughtersBadEndChoice() : Void
    {
        ...
        {
            outputText("Exgartuan barks, \"<i>Hell yes I do!</i>\" but the goblin only smirks down for a moment before looking back at you.\n\n");
        }
    ...
    private function tamaniDaughtersYesBadEndMePlease() : Void
    {
        ...
        if (SceneLib.exgartuan.dickPresent())
        {
            outputText("Exgartuan moans, \"<i>Ohhhhhh yeeeeaaaaahhhh...</i>\" before slipping into silence.\n\n");
        }
    ...
    private function loseToDaughtersWithTamaniThere() : Void
    {
        ...
        if (player.HP < 1)
        {
            outputText("Lying in the dirt, too hurt to fight back, you can only tremble in anticipation of what pleasures they're going to force upon you this time.");
        }
        else
        {
        ...
        if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 2)
        {
            outputText("It tastes syrupy-sweet");
        }
        else
        {
            outputText("It has a familiar taste that you can't quite place");
        }
        ...
        if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 10)
        {
            outputText("Your body must remember how much it loves being my pussy-hungry husband.");
        }
        else
        {
            outputText("That's because your body knows how hot and moist Tamani's pussy is and how much you want to service it.");
        }
        outputText("</i>\"\n\n");
        ...
        {
            outputText(", matting your [fur color] fur");
        }
        outputText(" as she continues ");
        if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 10)
        {
            outputText("filling your mind with truths");
        }
        else
        {
            outputText("reinforcing your image of yourself as an obedient husband");
        }
        ...
        if (player.cumQ() < 50)
        {
            outputText("Cum splatters and drips down Tamani's hand, forming a tiny puddle on your chest.");
        }
        //(ALT)
        else if (player.cumQ() < 250)
        {
            outputText("Cum splatters over Tamani's hand and forearm, even hitting her ass and hips as you form a thick puddle over your torso that drips to the ground.");
        }
        //(ALT2)
        else if (player.cumQ() < 600)
        {
            outputText("Cum splatters out in thick waves, soaking Tamani's hand, forearm, and hips with thick puddles of the stuff.  It pools on your belly for a moment, then rolls off you, forming a small pool on the ground as you keep squirting.");
        }
        //(ALT3)
        else
        {
            ...
            if (player.cumQ() >= 2000)
            {
                outputText("  Eventually it stops, but by then the pool is huge and nearly five inches deep.");
            }
        }
        ...
        if (player.cockTotal() == 1)
        {
            outputText("grab your [cocks] and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate your cock-head.\n\n");
        }
        else
        {
            outputText("each grab one of your [cocks] and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate each cock-tip.\n\n");
        }
        ...
        function nofitF() : Void
        {
            ...
            if (player.cockTotal() == 1)
            {
                ...
                if (player.cumQ() > 700)
                {
                    outputText("It gets everywhere as her womb fails to contain your massive load, even after you've bloated her belly with the stuff.");
                }
                if (player.cumQ() > 2000)
                {
                    outputText("After a few more seconds the puddle from before gets even deeper, and your daughters kindly prop up your head to keep you from drowning in the jism pool.");
                }
            }
            else
            {
                ...
                if (player.cumQ() > 700)
                {
                    outputText("It gets everywhere as their wombs fail to contain your massive load, even after you've bloated their bellies with the stuff.");
                }
                if (player.cumQ() > 2000)
                {
                    outputText("After a few more seconds the puddle from before gets even deeper, and your daughters kindly prop up your head to keep you from drowning in the jism pool.");
        ...
        var fitF : Void->Void = function() : Void
        {
            ...
            {
                outputText(" in spite of the large sizes they usually handle.");
            }
            else
            {
                outputText("r large size.");
            }
            if (player.cockTotal() > 1)
            {
    ...
    private function knockUpDaughters() : Void
    {
        ...
        if (cum >= 50 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
        if (cum >= 100 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        ...
        if (cum >= 1000 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
        if (cum >= 1200 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
        if (cum >= 1400 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
        if (cum >= 1600 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
        if (cum >= 1800 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
        if (cum >= 2000 && rand(2) == 0)
        {
            flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        }
    ...
    @:allow(classes.scenes.areas.forest)
    private function combatWinAgainstDaughters() : Void
    {
        spriteSelect(SpriteDb.s_tamani_s_daughters);
        clearOutput();
        if (flags[kFLAGS.SPARRABLE_NPCS_TRAINING] == 2)
        {
            if (flags[kFLAGS.TAMANI_DAUGHTERS_DEFEATS_COUNTER] >= 1)
            {
                flags[kFLAGS.TAMANI_DAUGHTERS_DEFEATS_COUNTER]++;
            }
            else
            {
                flags[kFLAGS.TAMANI_DAUGHTERS_DEFEATS_COUNTER] = 1;
            }
            //level up
    ...
    @:allow(classes.scenes.areas.forest)
    private function loseToDaughters() : Void
    {
        if (player.lust >= player.maxOverLust())
        {
