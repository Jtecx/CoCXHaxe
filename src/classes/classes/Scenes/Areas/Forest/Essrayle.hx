...
class Essrayle extends BaseContent
{
    ...
    public function essrayleMeetingI() : Void
    {
        ...
        if (flags[kFLAGS.MET_ESSY] == 0)
        {
            ...
            if (player.cor < 33)
            {
                outputText("Despite however chivalric you think yourself");
            }
            else if (player.cor < 66)
            {
                outputText("Despite your better sense");
            }
            else
            {
                outputText("Perhaps best of all");
            }
            ...
            if (player.cor < 33)
            {
                outputText("hastily looking away from her nude body");
            }
            else if (player.cor < 66)
            {
                outputText("looking away out of courtesy");
            }
            else
            {
                outputText("letting your eyes roam over her as you search for even more depraved features on her nubile body");
            }
            outputText(".");
    ...
    private function plantsForMe() : Void
    {
        ...
        {
            outputText("Your nipples stiffen, breasts puffing out with a heated breath");
        }
        else
        {
            outputText("You arch your back gently, unconsciously pressing into her slender fingers a bit further");
        }
        ...
        if (player.breastRows[0].breastRating >= 1)
        {
            ...
            if (player.bRows() > 1)
            {
                outputText(" of your uppermost pair");
            }
            ...
            if (player.bRows() > 1)
            {
                outputText(", steadily working over the multitude of fleshy mounds on your body");
            }
            outputText(".");
            if (player.hasFuckableNipples())
            {
                outputText("  Her fingers play with your nipples and press them gently.  She seems quite surprised as they sink in with minimal effort.  A grin spreads over her face as she begins to steadily thrust those digits in and out of your nipples, fingers swirling about the interiors all the while.");
            }
    ...
    private function plantsForMe2(BE : Int = 0) : Void
    {
        ...
        if (BE == 1)
        {
            outputText("Essy grins, nodding.  \"<i>Precisely.  I don't doubt they'll be even more fun given enough exposure here.</i>\"\n\n");
        }
        //If No=
        else if (BE == 2)
        {
            outputText("\"<i>Heh, suit yourself.</i>\"\n\n");
        }
        ...
        {
            outputText("find the dual sexes there.  Another hand joins the first, one gripping and tugging on your hardening cock as the other cups and squeezes over your pussy.");
        }
        ...
        {
            outputText("stroke about the puffy, now-inflamed lips of your own flower, taking the lips between two fingers and stroking up and down across their length fully before switching to your moist core.");
        }
        ...
        if (!player.isTaur())
        {
            outputText("lifting you slowly into the air");
        }
        else
        {
            outputText("forcing you to rear up");
        }
        ...
        if (player.hasCock())
        {
            ...
            if (player.breastRows[0].breastRating >= 1)
            {
                outputText(" and " + player.breastCup(0) + " breasts");
            }
        ...
        if (player.biggestTitSize() >= 1)
        {
            ...
            if (player.lactationQ() >= 400)
            {
                outputText("your milk and ");
            }
        ...
        if (player.cumQ() >= 500 && player.cumQ() < 2000)
        {
            outputText("  It takes some time for her to completely drain your virile reserves, humming happily as splurt after splurt bulges her cheeks and forces her throat to work.  By the time you start to go dry, you can swear the bulb that is her base looks a little bit bigger, and perhaps her breasts as well.");
        }
        else if (player.cumQ() >= 2000)
        {
            outputText("  This is a bit hard, as your virile cum-spout renders her trim belly bloated, and the bulb that forms her base rapidly swells with growth thanks to your fecund deposits.  The seed even trickles out around the corners of her mouth as she greedily attempts to devour it all, sighing around each cheek-stretching ejaculation.");
        }
        ...
        if (BE == 1)
        {
            ...
            if (player.bRows() > 1)
            {
                outputText("  She eventually dislodges with a wet pop, setting your new breasts to wobbling about as she moves down your body, repeating the gestures upon each set of breasts in return.");
            }
            
            outputText("\n\nWeak from the pleasure, the last thing you see is her smiling face before you fall forward into her embrace.  The next thing you know, you're alone in the glade, staring at the canopy above.  There's a heavy weight on your chest and you struggle to sit up.  " + cast((player.bRows() * 2), Num2Text) + " massive breasts jiggle and sway upon your chest, all full and aching to be milked");
            if (player.bRows() > 1)
            {
                outputText(", the top pair being largest, descending in size with each subsequent pair");
            }
            outputText(".");
    ...
    public function approachTrappedEssy() : Void
    {
        ...
        if (player.gender > 0)
        {
            addButton(0, "Feed Her", feedTrappedEssy);
        }
    ...
    //(Cock)
    private function hasCockFeedEssy(newPage : Bool = true) : Void
    {
        if (newPage)
        {
            clearOutput();
        ...
        {
            outputText("her lower pair of wobbling udders");
        }
        else
        {
            outputText("both sets of milk-bloated breasts");
        }
        outputText(" faster and faster, the hot slapping of her bountiful bosom against your [cock]");
        if (player.hasBalls())
        {
            outputText(" and your swollen, heavy balls against her fecund belly");
        }
    ...
    private function hasPussyFeedEssy(newPage : Bool = true) : Void
    {
        if (newPage)
        {
            clearOutput();
        ...
        if (player.looseness() < 2)
        {
            outputText("a gasping grunt of effort");
        }
        else if (player.looseness() < 4)
        {
            outputText("little resistance");
        }
        else
        {
            outputText("virtually no resistance at all");
        }
