...
class AlrauneScene extends BaseContent
{
    ...
    public function alrauneDeepwoods() : Void
    {
        ...
        else if (player.hasPerk(PerkLib.TransformationImmunityBeeHandmaiden))
        {
            beeHandmaidens("forest", "alraune");
        }
        else
        {
            if (isHalloween())
    ...
    public function alrauneVolcanicCrag() : Void
    {
        ...
        {
            beeHandmaidens("crag", "cinderbloom");
        }
        else
        {
            if (isHalloween())
    ...
    public function alrauneDeepwoodsWon() : Void
    {
        ...
        if (isHalloween())
        {
            outputText("The Jack-O-Raune, unable to fight any longer, retreat in her pumpkin in self defence, her vines unwrapping from you. Well, you are free, but the god-damn plant woman left you horny and frustrated, what a tease! Guess it's time to head back to camp.\n\n");
        }
        else
        {
            outputText("The alraune, unable to fight any longer, closes her petals in self defence, her vines unwrapping from you. Well, you are free, but the god-damn plant woman left you horny and frustrated, what a tease! Guess it's time to head back to camp.\n\n");
        }
        cleanupAfterCombat();
    }
    ...
    public function alrauneDeepwoodsLost() : Void
    {
        ...
        if (monster.statusEffectv1(StatusEffects.Level) > 2)
        {
            outputText("Your desire finally breaks your resolve as you stop struggling and make a dopey lust drunk face while the vines bring you to their mistress. ");
        }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            if (isHalloween())
            {
                outputText("Jack-O-Raune");
            }
            else
            {
                outputText("The alraune");
            }
