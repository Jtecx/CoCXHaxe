...
class ValkyrieScene extends BaseContent
{
    ...
    public function loseToValkyrie() : Void
    {
        ...
        if (player.HP <= 0)
        {
            outputText("her onslaught");
        }
        else
        {
            outputText("your rising lust");
        }
    ...
    {
        var gemPenalty : Float = (player.gems / 100) + 10 + rand(20);
        if (gemPenalty > 100)
        {
            gemPenalty = 100;
        }
        if (gemPenalty > player.gems)
        {
            gemPenalty = player.gems;
        }
    ...
    public function winAgainstValkyrie() : Void
    {
        ...
        if (monster.HP <= 0)
        {
            outputText("Beaten and bloodied, the valkyrie stumbles for a moment before dropping her spear and shield.  She kneels before you, head bowed low enough that her long hair brushes the icy ground. ");
        }
        else
        {
            outputText("Unable to contain her arousal, the valkyrie drops her weapons and collapses onto her knees, slipping a hand into her short skirt. ");
        }
    ...
    private function valkyrieAerialFuck() : Void
    {
        ...
        if (player.biggestCockArea() >= 16)
        {
            outputText("she can take no more of you.  ");
        }
        else
        {
            outputText("there is no more of you to take.  ");
        }
        ...
        {
            outputText("You clutch at the valkyrie and brace for the inevitable, cumming more and more inside her despite your impending doom.\n\n");
        }
    ...
    private function valkyrieLicksYou() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText(" as your dick unloads, spraying her hair with your spunk");
        }
        outputText(".\n\n");
