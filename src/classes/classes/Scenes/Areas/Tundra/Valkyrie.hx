...
class Valkyrie extends Monster
{
    public function spearAttack() : Void
    {
        ...
        else
        {
            ...
            var attacks : Int = as3hx.Compat.parseInt(1 + rand(3));
            var damage : Int = 0;
            while (attacks > 0)
            {
                damage += as3hx.Compat.parseInt((str * 1.25) + rand(65));
                attacks--;
            }
    ...
    public function shieldBash() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt(((str * 1.25) + 65) + rand(65));
            player.takePhysDamage(damage, true);
        }
    }
    ...
    public function aerialRave() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt(((str * 1.25) + 300) + rand(150));
            player.takePhysDamage(damage, true);
        }
    }
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(weapons.SPEAR, 1).add(shields.GREATSH, 3).add(consumables.G__BOOK, 5).add(null, 15);
