...
class WinterWolfScene extends BaseContent
{
    ...
    private function getFuckedByWinterWolfDoggyStyle() : Void
    {
        ...
        {
            outputText("Overcome by sexual desire, you submit to the hungry winter wolf.");
        }
        ...
        if (player.hasVagina() && (!sceneHunter.uniHerms || rand(2) == 0))
        {
            ...
            {
                outputText("You are no longer a virgin! Your hymen is torn, robbing you of your virginity. ");
            }
