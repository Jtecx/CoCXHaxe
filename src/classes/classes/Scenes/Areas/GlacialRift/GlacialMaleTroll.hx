...
class GlacialMaleTroll extends Monster
{
    public function glacialTrollGrabs() : Void
    {
        ...
        {
            outputText("You manage to dodge his assault.");
        }
        else
        {
    ...
    public function glacialTrollGoreWithTusks() : Void
    {
        ...
        if (player.getEvasionRoll())
        {
            outputText("You manage to avoid his tusks.");
        }
        else
        {
            var damage : Float = 0;
    ...
    public function glacialTrollPunch() : Void
    {
        ...
        if (player.getEvasionRoll())
        {
            outputText("You react quickly, evading his charge as he tumbles onto the snow.");
        }
        else
        {
            var damage : Float = 0;
    ...
    public function glacialTrollGrabsFinisher() : Void
    {
        ...
        {
            outputText("You quickly spring to your feet, ready to continue fighting. ");
        }
        else
        {
        ...
        var throwDMG : Float = eBaseDamage() * 2;
    ...
    override private function performCombatAction() : Void
    {
        ...
        else
        {
            ...
            if (choice == 2)
            {
                if (!player.hasStatusEffect(StatusEffects.TrollHold) && rand(2) == 0)
                {
                    glacialTrollGrabs();
                }
                else
