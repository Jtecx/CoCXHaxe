...
class Yeti extends Monster
{
    ...
    public function yetiClawAndPunch() : Void
    {
        ...
        else
        {
            if (hasStatusEffect(StatusEffects.Blind) && rand(3) > 0)
            {
                ...
                var yetiDamage : Float = 30 + rand(50);
                HP -= yetiDamage;
            ...
            var damage : Float = ((str + weaponAttack) * 1.25) + 75 + rand(60);
    ...
    public function yetiTackleTumble() : Void
    {
        ...
        //yeti takes moderate damage{
            ...
            var yetiDamage : Float = 50 + rand(80);
            HP -= yetiDamage;
            outputText("The beast takes <b>[font-damage]" + yetiDamage + "[/font]</b> damage.");
        }
        //take heavy damage
        else
        {
            ...
            var damage : Float = ((str + weaponAttack) * 1.4) + 200 + rand(250);
            player.takePhysDamage(damage, true);
        }
    }
    public function yetiSnowball() : Void
    {
        ...
        else
        {
            ...
            var damage : Float = ((str + weaponAttack) * 0.8) + rand(30);
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.RiverDungeonA))
        {
            SceneLib.dungeons.riverdungeon.defeatedByYeti();
        }
        else
        {
    ...
    public function new()
    {
        ...
        this.lust = 10;
        this.lustVuln = 0.4;
        this.drop = new WeightedDrop().add(consumables.YETICUM, 1).add(null, 2);
        ...
        this.abilities = [
                ...
                {
                    call : yetiClawAndPunch,
                    type : ABILITY_PHYSICAL,
                    range : RANGE_MELEE,
                    tags : [TAG_BODY]
                }, 
                {
                    call : yetiTackleTumble,
                    type : ABILITY_PHYSICAL,
                    range : RANGE_MELEE,
                    tags : [TAG_BODY]
                }, 
