...
class YetiScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function FemalePCMeetYeti() : Void
    {
        ...
        if (flags[kFLAGS.MET_YETI_FIRST_TIME] == 1)
        {
            outputText(" Looks like this tough male mistook you for something else and aware of his mistake has already started softening his stance.\n\n");
        }
        else
        {
    ...
    private function getFuckedByYetiDoggyStyle() : Void
    {
        ...
        {
            outputText("tingling your body with arousal.");
        }
        //Gendered PCs
        if (player.hasCock())
        {
            outputText("sending blood swelling to your [cocks]");
        }
        if (player.hasCock() && player.hasVagina())
        {
            outputText(" as well as ");
        }
        if (player.hasVagina())
        {
            outputText("making the lips of your " + vaginaDescript(0) + " begin to drool and grow moist");
        }
        ...
        if (player.hasCock())
        {
            outputText("Your [cocks] is now fully erect, despite being in the cold air.  ");
        }
        ...
        if (player.hasBalls())
        {
            outputText("Your ballsack is slimy with the stuff. ");
        }
        if (player.hasVagina())
        {
            outputText("You can feel it pooling along the lips of your mound. ");
        }
        ...
        if (player.mf("m", "f") == "m")
        {
            outputText("The tip of the beast’s length rams into your prostate, making you cry out in pleasure.");
        }
        outputText("Your moans grow louder and, as the monstrous length pounds away at your hole, you soon reach your limits.");
        if (player.hasCock())
        {
            outputText("Ropes of cum shoot from your [cocks], splashing all over the cavern flooring and steaming against the cold ice. ");
        }
        if (player.hasVagina())
        {
            outputText("Your  " + vaginaDescript(0) + " is drenched in your sex, leaving your legs slick in your pleasure and dripping down to steam on the icy flooring under you. ");
        }
    ...
    public function winAgainstYeti() : Void
    {
        ...
        if (monster.HP <= 0)
        {
            outputText("The yeti's bruised and battered body stares you down, though it’s obvious his muscles are giving out. With a loud thump he falls on his back, and lays there, vulnerable. A bellowed groan of defeat echoes the cavern walls, and the threat passes. What do you do now?");
        }
        else
        {
            outputText("The beast looks at you with a hungry gaze, his hot thick member sliding from the sheath between his legs. Unable to fight it any longer, the yeti wraps his hands around his long hot prick, protecting it from the cold as he pleasures the slick, stiff flesh. You lower your guard as you realize the monster is no longer willing to fight, content to just touch himself while looking warily at you. So, what do you do now?");
        }
        //Options
        menu();
        if (player.lust >= 33)
    ...
    private function fuckYetiInTheAss() : Void
    {
        ...
        {
            outputText("You shove as much into the beast as you can, taking what warmth you can get and moving one hand from the yeti’s hips to stroke along the inches of your length that simply won’t fit. \n\n");
        }
        if (player.biggestCockArea() <= 20 && player.cocks[player.biggestCockIndex()].cockType == CockTypesEnum.DOG)
        {
            outputText("With a final thrust, you pop your knot past the beast’s rim, joining you two together with you as the alpha and him your bitch as you ready to breed him with your seed. You lean forward, hitting your limit as you give out a low groan.\n\n");
        }
        if (player.hasBalls())
        {
            outputText("Your [balls] clench as your body readies to fire. You pump the yeti’s ass full of your spunk, firing out countless ropes of your seed, coating the beasts wall in your musky cum. \n\n");
        }
        if (player.cocks.length > 1)
        {
            outputText("Your other cocks unload and coat his furred rear, drenching his rump in your spunk and messing his white fur with your sticky cream. With a satisfied huff you pull out, trails of your seed following your cock and leaking out across his abused rear. The beast groans as he unloads over his chest, his giant globs of thick spunk matting his fur. \n\n");
        }
    ...
    private function rideYetisCock() : Void
    {
        ...
        if (player.looseness(true) <= 1)
        {
            outputText("You whimper slightly as his thick cock stretches your walls painfully.  ");
        }
        ...
        {
            outputText("his furry belly");
        }
        if (player.tallness >= 60 && player.tallness < 72)
        {
            outputText("the thick, soft fur of his chest");
        }
        if (player.tallness >= 72)
        {
            outputText("the nape of his neck");
        }
