...
class DarkSlimeScene extends BaseContent
{
    ...
    public function tfScene(letzRape : Bool = false) : Void
    {
        clearOutput();
        ...
        if (player.biggestTitSize() >= BreastCup.A)
        {
            outputText("Not one to miss out on any nutrient source, the slime suddenly grabs your breasts, forming a tight goo bikini around your areola as it forces the milk out. ");
        }
        ...
        if (player.biggestTitSize() >= BreastCup.A)
        {
            outputText("even dyeing her goo with your breast milk ");
        }
        ...
        {
            player.createStatusEffect(StatusEffects.SlimeCraving, 0, 0, 0, 1);
        }  //Value four indicates this tracks strength and speed separately  
    ...
    public function beatingDarkSlimeUseHer() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("Something in the slime grabs hold of your penis, slowly and gently massaging it within the confines of the lewd bed. You gasp in pleasure as your cock begins to harden under the slime’s methodical ministration some even going inside your urethra. ");
        }
        if (player.hasVagina())
        {
            outputText("Your pussy begins to drool as slime floods inside, filling you up to and way past the cervix. This is the nice thing about these creatures, no matter how small the orifices they can move right in. Your belly inflates to an overly pregnant size as the slime begins to gently fuck you up to into your womb. ");
        }
        if (player.biggestTitSize() >= 2)
        {
            outputText("The slime gets to tenderly massaging your two mounds of flesh small pressure applying to your nipples in just the right way. ");
        }
