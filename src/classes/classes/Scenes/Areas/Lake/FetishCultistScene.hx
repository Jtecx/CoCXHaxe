...
class FetishCultistScene extends AbstractLakeContent
{
    public function new()
    {
        super();
    ...
    public function cultistRapesYou() : Void
    {
        ...
        //cool selector{
            ...
            {
                addButtonDisabled(2, "???", "Req. Naga/Taur lower body");
            }
            ...
            {
                addButtonDisabled(3, "???", "Req. hoofed (Taur?) lower body, horsecock, balls.");
            }
        ...
        {
            clearOutput();
            var x1 : Int = as3hx.Compat.parseInt(player.findCockWithType(CockTypesEnum.HORSE) + 1);
            ...
            {
                player.modArmorName = "bridle bit and saddle set";
            }
            afterRape();
        };
        
        var zoo : Void->Void = function() : Void
        {
            clearOutput();
            ...
            //The scene for naga's getting their tails raped, start with the greetings{
                ...
                if (player.armor == armors.C_CLOTH)
                {
                    player.modArmorName = "headdress, necklaces, and many body-chains";
                }
            }
            afterRape();
        }
        
        var nurse : Void->Void = function() : Void
        {
            clearOutput();
            ...
            if (player.isTaur())
            {
                ...
                {
                    outputText("  As you see your [cocks], 'incredibly large' is the only qualifier you can think of.");
                }
            }
            outputText("\n\n");
            if (player.armor == armors.C_CLOTH)
            {
                player.modArmorName = "bondage patient clothes";
            }
            outputText("\"<i>Um, ");
            if (player.gender <= 1)
            {
            ...
            if (sceneHunter.lossSelect)
            {
                outputText("Somehow you start to beleive her. The nurse really cares about you. Maybe you shouldn't struggle too much?\n\n");
            ...
            var cock : Void->Void = function() : Void
            {
                clearOutput();
            ...
            var breasts : Void->Void = function() : Void
            {
                clearOutput();
                ...
                {
                    outputText("Once about a quarter of the fluid has been injected into the first breast, she moves on to the second, and you feel a similar sharp pain followed by the glowing pleasure.  She continues this until all of your [allbreasts] have been injected.  ");
                }
                //[if the player has three rows of breasts]
                if (player.breastRows.length > 2)
                {
                    outputText("Once about a sixth of the fluid has been injected into the first breast, she moves on to the second, and you feel a similar sharp pain followed by the glowing pleasure.  She continues this until all of your [allbreasts] have been injected.  ");
                }
                ...
                if (player.biggestLactation() >= 1)
                {
                    outputText(" start lactating even more.  ");
                }
                //[if breasts are not lactating]
                else
                {
                    outputText(" start lactating.  ");
                }
            ...
            var vagina : Void->Void = function() : Void
            {
                clearOutput();
            ...
            var nothing : Void->Void = function() : Void
            {
                clearOutput();
        ...
        var mistress : Void->Void = function() : Void
        {
            clearOutput();
            ...
            function hermF() : Void
            {
                ...
                if (player.armor == armors.C_CLOTH)
                {
                    player.modArmorName = "crotch-revealing clothes";
                }
                ...
                {
                    outputText("Your " + cockDescript(1) + " rubs against her skin pleasantly.  ");
                }
                //[if player has more than 2 dicks]
                if (player.cocks.length > 2)
                {
                    outputText("The rest of your [cocks] rubs against her skin pleasantly.  ");
                }
                ...
                {
                    outputText("  You take special care to make sure that the rest of your cum does not get on your mistress in any way.");
                }
            ...
            var dickF : Void->Void = function() : Void
            {
                ...
                if (player.armor == armors.C_CLOTH)
                {
                    player.modArmorName = "cute servant's clothes";
                }
                ...
                if (player.hasVagina())
                {
                    outputText("You feel desire start to well up in your " + vaginaDescript(0) + ", but you resist the urge to act on it; that's not why your mistress keeps you. ");
                }
                ...
                if (player.cocks.length > 2)
                {
                    outputText("The rest of your [cocks] rub against her skin pleasantly.  ");
                }
            ...
            var vagF : Void->Void = function() : Void
            {
                ...
                if (player.cocks.length > 0)
                {
                    outputText("You feel a desire rising in your erect [cocks], but you ignore it; that's not what your mistress told you to play with.  ");
                }
            ...
            var nothingF : Void->Void = function() : Void
            {
    ...
    //Check for bad-end start!
    {
        ...
        else
        {
            ...
            if (player.armor == armors.C_CLOTH)
            {
                outputText("You find your [armor] back on your body with no sign of the strange clothes you were wearing before.  ");
            }
            else
            {
                outputText("You are still wearing the [armor] that she gave you, and there is no sign of your old clothes.  ");
            }
    ...
    private function plugSwimsuitVag() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("You decline the vibrators; you'd much rather take her incredibly wet pussy.  ");
        }
        else
        {
            outputText("You tell her you're gonna fuck her.  ");
        }
        ...
        {
            outputText("push further and further until you're all the way inside her.");
        }
        else if (player.cockArea(x) < 200)
        {
            outputText("push further and further, until to your great delight, she manages to take all of your massive member without any trouble!");
        }
        else
        {
            outputText("manage to get your monster cock further and further inside her.  To your immense shock, she manages to take the whole thing, without it seeming to warp her body at all!");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            {
                outputText(" lets loose its load");
            }
            else
            {
                outputText("s let loose their loads");
            }
            outputText(" onto her back and legs, ");
            if (player.cumQ() < 50)
            {
                outputText("adding a little white decoration");
            }
            else if (player.cumQ() < 200)
            {
                outputText("adding a liberal coating of white to her body");
            }
            else
            {
                outputText("drenching her in your cum");
            }
            outputText(".");
        }
        outputText("\n\n");
    ...
    private function swimsuitVibrators() : Void
    {
        ...
        else
        {
            ...
            {
                outputText("It takes some effort to get it inside you, but is well worth the effort.");
            }
            else
            {
                outputText("It easily slips inside your well-stretched hole.");
            }
    ...
    private function cultistBadEnd2() : Void
    {
    ...
    public function cultistDefeated() : Void
    {
        if (monster.HP < 1)
        {
            outputText("Hurt too much to continue controlling her powers, the " + cname() + " collapses helplessly.");
        }
        else
        {
            outputText("Overwhelmed by her lusts, the " + cname() + " loses the ability to control herself and collapses.");
        }
        if (player.lust >= 33)
        {
    ...
    public function playerRapesCultist() : Void
    {
        ...
        function nunPlay() : Void
        {
            ...
            if (player.cor < 40)
            {
                outputText("You are rather taken aback by this odd declaration, but in the end you decide: <i>what the hell, I'm horny.</i>\n\n");
            }
            else
            {
                outputText("You nod to yourself thinking: <i>that's right, I am a sex god.</i>\n\n");
            }
            ...
            function dickF() : Void
            {
                ...
                if (player.isTaur())
                {
                    outputText("You command her to get on all fours, then cover her and push ");
                }
                else
                {
                    outputText("You grab hold of and lift her legs, then kneel down and push ");
                }
                if (player.cocks.length > 1)
                {
                    outputText("the first of ");
                }
                outputText("your ");
                ...
                if (player.cumQ() >= 50 && player.cumQ() < 200)
                {
                    outputText(" before streams of cum begin to run down her thighs.");
                }
                if (player.cumQ() >= 200)
                {
                    outputText(" before torrents of cum begin to run down her legs and onto the ground.");
                }
            ...
            var vagTaurF : Void->Void = function() : Void
            {
        ...
        var swimsuitPlay : Void->Void = function() : Void
        //(scene requires that the PC not be genderless)
        {
            ...
            {
                outputText("Given your experience with Ceraph, you can definitely understand why she is having so much fun showing off her body.  In fact, you think you'll start to do the same.");
            }
            else
            {
                outputText("You don't really understand what could be so arousing about showing off your body to others, but you decided you were going to rape her, so you might as well strip down now.");
            }
            ...
            if (player.cor < 33)
            {
                outputText("Well, she obviously wants this, so you guess there isn't anything wrong with enjoying what's on offer, is there?\n\n");
            }
            else if (player.cor < 66)
            {
                outputText("You think to yourself how awesome this is.  It isn't often a defeated foe is so eager.\n\n");
            }
            else
            {
                outputText("You're almost disappointed at how easy she is making this; but hey, a fuck is a fuck, so what do you care?\n\n");
            }
            //end of the foreplay
            ...
            if (player.hasCock())
            {
                ...
                if (player.hasVagina())
                {
                    outputText("Then, she hesitates for some reason, before saying, \"<i>Um, I'm not sure why I'm asking this since you've got a good tool there already, but... I've got some vibrators, if you want to play with them instead...</i>\"\n\n");
                }
                else
                {
                    outputText("\"<i>I want this so damn much!</i>\"\n\n");
                }
            }
        ...
        var regularPlay : Void->Void = function() : Void
        {
            ...
            if (player.cor < 40)
            {
                outputText("You stop, thinking that maybe you should let her go, but she grabs your hand and gives you a look of desperation.  Deciding to finish the job, you push her to her knees, and the look of fear returns to her face.  ");
            }
            else
            {
                outputText("With a wicked smile, you push her to her knees.  ");
            }
            if (player.gender == 0)
            {
            ...
            function dickF() : Void
            {
                ...
                if (player.cor < 40)
                {
                    outputText("Feeling uncomfortable at this, you start to pull away, but her expression turns instantly into a look of pure horror, and her body becomes completely tense.  As you move back to her, her body relaxes, and her expression returns to the tear-stricken face.  Obviously this is an act, and she would be far more bothered by you if you left her without finishing the job.  ");
                }
    ...
    public function fetishCultistHasAMilkFetish() : Void
    {
        ...
        {
            outputText("Your entire body tenses up, like you're approaching an orgasm. The release of this tension flows through your body as she cums into the palm of your hand. You sigh with relief as the phantom orgasm lingers.\n\n");
        }
        ...
        {
            outputText("and everything goes back to normal.  ");
        }
    ...
    private function mindbreakFemaleCultist() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("<i>brother</i>");
        }
        else if (player.hasVagina())
        {
            outputText("<i>sister</i>");
        }
        outputText("<i> [name].</i>\"" +
