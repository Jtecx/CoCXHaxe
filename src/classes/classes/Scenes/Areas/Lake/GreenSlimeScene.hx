...
class GreenSlimeScene extends AbstractLakeContent
{
    ...
    public function defeatGS() : Void
    {
        ...
        if (player.lust < 33 || player.gender == 0)
        {
            ...
            {
                outputText("You can't think of anything to do with it.");
            }
        }
        else
        {
    ...
    private function serviceLowCorruptionHighLust() : Void
    {
        ...
        if (player.tallness >= 82)
        {
            outputText("  You grip the head of the member firmly with one of your large hands and tease the tip with your thumb for a moment before squeezing and sliding your hand to its base.");
        }
        //Short peeps
        else
        {
            outputText("  You run a finger up and down the creature's member a few times before tightly wrapping your hands around the tip and running them to its base.");
        }
        ...
        if (player.vaginas.length > 0)
        {
            ...
            {
                outputText("for that familiar full feeling ");
            }
            outputText("and paranoid about allowing this creature inside of you.");
            //If you be hella tight
            if (player.vaginalCapacity() <= 18)
            {
                outputText("  On top of that, you are unsure if the thick, foot and a half long appendage would even fit inside of you.");
            }
            outputText("\n\n");
        }
        //Penises foreplay
        ...
        //Multicock folk get in their own way{
            ...
            {
                outputText("Your own erect [cocks] rub against the creature's as you work, getting in the way somewhat.  ");
            }
            //Big single cocked folk get in their own way too!
            else if (player.cocks[0].cockThickness >= 36)
            {
                outputText("Your own erect [cock] rubs against the creature's as you work, getting in the way somewhat.  ");
            }
            //Single dick contemplation
            if (player.cockTotal() == 1)
            {
                outputText("You feel your [cock] begin to throb and entertain the idea of trying to penetrate it somehow.  You turn a bit and look around the creature for an orifice, but find nothing.  After a few frustrated moments of searching you give up and decide to handle things yourself.");
            }
            //Multidick contemplation
            else
            {
                outputText("You feel your [cocks] begin to throb and entertain the idea of trying to penetrate it somehow.  You turn a bit and look around the creature for an orifice, but find nothing.  After a few frustrated moments of searching you give up and decide to handle things yourself.");
            }
            outputText("\n\n");
        }
        //Next PG
        ...
        //Hand gets coated in sensitive slime\n
        {
            ...
            function dickF() : Void
            {
                ...
                {
                    var x1 : Int = as3hx.Compat.parseInt(player.findCock(-1, -1, 30, "length") + 1);
                ...
                {
                    var x1 : Int = as3hx.Compat.parseInt(player.findCock(1, 30, -1, "length") + 1);
            ...
            //Foreplay and smearing goo about
            {
                ...
                {
                    outputText("You moan and lean back slightly as you grip your " + clitDescript() + " between your thumb and forefinger, biting your lip at the intense sensations as you rub your thumb over your " + clitDescript() + " and shuddering in anticipation and delight.  ");
                }
                //Small clitties
                else
                {
                    outputText("You moan and lean back slightly as you start to flick your " + clitDescript() + ", the slime's fluid providing excellent lubrication and a luxurious warming feeling as you make small circles around your nub.  ");
                }
                ...
                if (player.breastRows.length > 0 && player.biggestTitSize() > 0)
                {
                    ...
                    {
                        outputText("barely contains them.");
                    }
                    //Middling Boobiliciousness
                    else if (player.biggestTitSize() > 3)
                    {
                        outputText("gently covers them.");
                    }
                    //Tiny ta-tas.
                    else
                    {
                        outputText("easily smothers them.");
                    }
                ...
                //Multicock{
                    ...
                    if (player.cockTotal() > 1)
                    {
                        ...
                        {
                            outputText("You delicately grasp the head of one of your cocks, your hand slick with the fluids of yourself and of the creature.  The combination of the creature's movements and your own quickly overwhelms you.");
                        }
                    }
                    //Single prick
                    else
                    {
                        ...
                        if (player.biggestTitSize() == 0)
                        {
                            outputText("You delicately grasp the head of your [cock], your hand slick with the fluids of yourself and of the creature.  The combination of the creature's movements and your own quickly overwhelms you.");
                        }
                    }
                }
                ...
                //Multidicked herms{
                    ...
                    if (player.cockTotal() > 1)
                    {
                        outputText("You let out a strangled gasp as your body, already straining from exertion, shudders again as your " + multiCockDescript() + " explodes into orgasm, showering both you and the creature in jizz.  ");
                    }
                    //Single cocked herms
                    else
                    {
                        outputText("You let out a strangled gasp as your body, already straining from exertion, shudders again as your [cock] explodes into orgasm, sending a jet of your warm jizz into the air.  ");
                    }
                }
        ...
        var tall : Void->Void = function() : Void
        {
            ...
            //Multicock foreplay
            {
                ...
                else
                {
                    ...
                    {
                        outputText("a near exact replica of your own [cock]!  ");
                    }
                    else
                    {
                        outputText("a distinctly human penis.  ");
                    }
                }
            ...
            function titsF() : Void
            {
                ...
                if (player.biggestTitSize() > 8)
                {
                    outputText("Its hand expands, struggling to cover all of your [allbreasts], ");
                }
                //Middling ta-tas get covered
                else if (player.biggestTitSize() > 3)
                {
                    outputText("Its hand expands and gently covers your [allbreasts], ");
                }
                //Small tits?  Pwned.
                else
                {
                    outputText("Its hand easily smothers your [allbreasts], ");
                }
            ...
            var vagF_part2 : Void->Void = function() : Void
            //Clit engulfed!
            {
                ...
                if (player.cockTotal() > 0)
                {
                    outputText("  Your " + multiCockDescript() + " explodes as well, sending thick ropes of your steaming ejaculate into the air as the monster finishes with you.  ");
                }
    ...
    private function oralRape() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText("Shrugging, you decide to go with the closest thing available and walk towards its head.  You spend a moment deciding which of your organs to ravage the creature with, eventually settling on the largest,  ");
        }
        else
        {
            outputText("Shrugging, you decide to go with the closest thing available and walk towards its head, pulling out your [cock] as you do so.  You kneel over the thing's head and stroke your penis lightly to ensure it is fully ready,  ");
        }
        //Balls ftw
        if (player.balls > 1)
        {
            outputText("anointing the slime's face with your " + sackDescript() + " as you do.  ");
        }
        //Ball-less bitches
        else
        {
            outputText("probing at the 'mouth' of the creature with your free hand.  ");
        }
        //Continue the setup...
        ...
        {
            outputText(", down its throat,");
        }
        if (player.cocks[0].cockLength >= 24)
        {
            outputText(" into its torso,");
        }
        if (player.cocks[0].cockLength >= 48)
        {
            outputText(" and all the way through to its hips,");
        }
        ...
        if (player.cor >= 60)
        {
            outputText("You wonder for a moment if you've broken the creature's membranous skin, then shrug and decide you don't care.");
        }
        //player shows concern for monster
        else
        {
            outputText("You wonder for a moment if you've broken the creature's membranous skin, but the continuing presence of the creature's throbbing erection implies that it's in relatively little distress.");
        }
        //New PG
        outputText("\n\n");
        ...
        if (player.balls > 1)
        {
            outputText(" as your [balls] slap against its face");
        }
        ...
        if (player.vaginas.length > 0)
        {
            outputText("  Your " + vaginaDescript(0) + " begins to grow wet as you repeatedly force yourself into the creature's throat.  You take a single deep stroke and bottom out into the creature, grinding your moist femininity against the soft, sensual material of the creature's face.");
        }
        //New PG for cumming!
        outputText("\n\n");
        ...
        if (player.vaginas.length > 0)
        {
            outputText("  This is quickly followed by a quivering between your nether-lips as your " + vaginaDescript(0) + " quivers in orgasm shortly afterwards.");
        }
    ...
    private function maleRapesOoze() : Void
    {
        ...
        {
            outputText("You shrug at the lack of obvious orifices and decide to go for the most common one, pulling out your [cock] as you grab the slime and roughly try to turn it over.  Surprisingly it maintains its cohesion and flops onto its side, its erection flopping wetly onto the ground.  ");
        }
        ...
        if (player.cocks[0].cockLength >= 24)
        {
            outputText("By the time you finally bottom out, your [cock] is nearly halfway through its torso.");
        }
        else if (player.cocks[0].cockLength >= 48)
        {
            outputText("By the time you finally bottom out, your [cock] reaches nearly into the slime's neck.");
        }
        else if (player.cocks[0].cockLength >= 60)
        {
            outputText("Your penis keeps going deeper and deeper, through the chest, neck, and head, before finally stretching the slime as far as it needs to go to accommodate the full length of your [cock].");
        }
        ...
        if (player.vaginas.length > 0)
        {
            outputText("Your " + vaginaDescript(0) + " grows wet as you work the thing's hole, every slap of your hips against the thing's ass sending a pang of pleasure through your nethers.  ");
        }
        ...
        if (player.cockTotal() > 1)
        {
            outputText("your [cocks] explodes into orgasm, your load filling the space inside the creature and spraying in thick streams across its back.");
        }
        else
        {
            outputText("exploding inside it, your load filling the space around your cock with a white, milky fluid.");
        }
        //vaginal orgasm text
        if (player.vaginas.length > 0)
        {
            outputText("  As you pump your jizz into the creature an almost electrical shock runs through your body, starting from your " + vaginaDescript(0) + " and radiating outwards.");
        }
    ...
    private function oozeButtRapesYou() : Void
    {
        ...
        if (player.vaginas.length > 0)
        {
            outputText(vaginaDescript(0) + " and " + assholeDescript());
        }
        //No coochie
        else
        {
            ...
            if (player.balls >= 2)
            {
                outputText(assholeDescript() + " and " + ballsDescript());
            }
        ...
        //...but this wont necessarily be a turnoff.  id put in some sort of formula that determines the corruption rating needed for this{
            ...
            if (player.cor <= 33)
            {
                outputText("You feel a bit of fear as you tremble under the creature's weight, worried about the damage that its massive size might do to your ass.  ");
            }
            else if (player.cor < 66)
            {
                outputText("In spite of your worries about the creature's size, you can't help but feel a little bit excited at the idea of having this beast take you from behind.  ");
            }
            //and something special for the total whorebags that have somehow not already wrecked their asses.
            else
            {
                outputText("You almost lick your lips in anticipation and push your hips back greedily, eager to feel the monster's cock stretch your asshole wide.  ");
            }
        }
        ...
        if (player.cockTotal() > 0)
        {
            outputText("You feel pangs of pleasure run through your body as its member repeatedly strokes your prostate from the inside, stimulating it.  ");
        }
        ...
        //Single{
            ...
            if (player.cockTotal() == 1)
            {
                outputText("You quickly grow erect under the creature's embrace as it pistons into your ass, and before long you stand at full attention.  You weakly rub yourself with one hand as it pumps you, and quickly approach orgasm.  ");
            }
            //Multi!
            else
            {
                outputText("Your " + multiCockDescript() + " quickly grows erect under the creature's embrace as it pistons into your ass, and before long you stand at full attention.  You weakly rub at a different cock with each hand as it pumps you, and quickly approach an orgasm.  ");
            }
        }
        //Vaginas!
        if (player.vaginas.length > 0)
        ...
        //hermaphrodite orgasm{
            ...
            if (player.cockTotal() > 0)
            {
                outputText("The creature finally plunges a pair of fingers into your " + vaginaDescript(0) + ", and between this and the additional pressure against your prostate you finally come, harder than you ever have before.  Thick ropes of jizm spray onto the ground as the feeling wracks your body.  ");
            }
            //vaginal-only orgasm
            else
            {
                outputText("The creature finally plunges a pair of fingers into your " + vaginaDescript(0) + ", the sudden shock finally pushing you to orgasm.  ");
            }
        }
        //mangasm
        else if (player.cockTotal() > 0)
        {
            outputText("The additional pressure against your prostate finally pushes you over the edge, and you cum hard, spraying your load against the ground.  Thick ropes of jizm spray onto the ground as the feeling wracks your body.  ");
        }
    ...
    private function oozeRapesYouOrally() : Void
    {
        ...
        function suck() : Void
        {
            ...
            if (player.vaginas.length > 0)
            {
                ...
                if (player.cockTotal() < 1 || player.lust <= 40)
                {
                    outputText("You try to reach for yourself to masturbate, but find yourself unable to reach around the slime's massive bulk.");
                }
            }
            ...
            {
                outputText("The creature withdraws while you're distracted, leaving no traces of its presence save for what it left on your body.");
            }
            player.sexReward("vaginalFluids");
        ...
        var resist : Void->Void = function() : Void
        {
            ...
            if (player.inte > player.tou && !sceneHunter.other)
            {
                outputText("You force yourself to keep your mouth shut in spite of the lack of air, holding out for as long as you can.  Eventually you become light-headed, and pass out.  When you wake up there is no trace of the creature, save for the fluid covering your mouth, chest, and the ground around you.");
            }
            else
            {
    ...
    private function oozeRapesYouVaginally() : Void
    {
        ...
        if (player.cor <= 33)
        {
            ...
            //Ginormo coochie
            else if (player.vaginalCapacity() <= 30)
            {
            ...
            //Multi biiiiitches{
                ...
                if (player.cockTotal() > 1)
                {
                    ...
                    if (player.cockTotal() > 2)
                    {
                        outputText("switching between cocks as you rapidly stroke yourself in time with the creature's movements.  ");
                    }
                    else
                    {
                        outputText("rapidly stroking one cock with each hand, working yourself in time with the creature's movements.  ");
                    }
                }
                //Single dick
                else
                {
                    outputText("Your [cock] rapidly grows erect under this assault and begins to throb.  Having now released yourself to instinct you reach to jerk off, rapidly stroking your [cock] in time with the creature's movements.  ");
                }
            }
            ...
            //Multi{
                ...
                if (player.cockTotal() > 1)
                {
                    outputText("Your " + multiCockDescript() + " climaxes as well, sending rope after rope of hot, thick cum onto your face and chest.");
                }
                //Single
                else
                {
                    outputText("Your member climaxes as well, and you pull a hand to cover your eyes and face as your jism explodes onto yourself.  Your other hand slides to the base of your [cock] and squeezes as you coat your chest in semen.");
                }
            }
            player.sexReward("vaginalFluids", "Vaginal");
            dynStats("sen", 4);
            ...
            
            {
                ...
                else
                {
                    
                    {
                        ...
                        if (player.vaginalCapacity() >= 30)
                        {
                            outputText(" almost perfectly.\n");
                        }
                        else
                        {
                            outputText(" perfectly.\n");
                        }
                    }
                }
                ...
                //multi{
                    ...
                    if (player.cockTotal() > 1)
                    {
                        outputText("Your " + multiCockDescript() + " climaxes as well, and you open your mouth as you spray rope after rope of hot, thick jism onto your face and chest.  You relish its salty taste, continuing to stroke yourself even as you come.  ");
                    }
                    //single cock
                    else
                    {
                        outputText("Your own member finally reaches its climax as well, and you open your mouth as jism explodes onto your face and chest.  Your hands slide to the base of your [cock] and squeeze as you release thick ropes of ejaculate onto yourself, coating your face and chest as you relish its salty taste.  ");
                    }
                }
    ...
    @:allow(classes.scenes.areas.lake)
    private function rapeOozeWithMilk() : Void
    {
        clearOutput();
        ...
        else if (player.gender == 3)
        {
            ...
            {
                outputText("and almost dripping down to coat your " + clitDescript() + " to add to your pleasure. ");
            }
        }
        //[If Genderless-
        else
        ...
        if (player.gender < 1)
        {
            outputText("gripping the ground as the slime has left you nothing to do; adding your hands to the mix feels like it'd be an insult to the creature's expert work.  ");
        }
        //if duder
        else if (player.gender == 1)
        {
            outputText("Your hands grip the ground as the slime has left you nothing to do; adding your fingers to the mix feels like it'd be an insult to the creature's expert work.  ");
        }
        //[if female or Herm-
        else
        {
            outputText("Your hands fly to your " + vaginaDescript(0) + " and frantically plunge your fingers in and out of it.  You wish the slime would engulf it as well.  ");
        }
        ...
        if (player.gender == 1)
        {
            outputText("feverishly jacking yourself off with it.  The cool feel of it contrasts enough to send you over the edge relatively quickly, and you release your cum into it.  You drop most of its bulk ");
        }
        //[if female-
        else if (player.gender == 2)
        {
            outputText("rapidly entering it in and out of your " + vaginaDescript(0) + " by way of your fingers.  The cool feel of it contrasts enough to send you over the edge relatively quickly, and you release your juices into it.  You flick it off your fingers ");
        }
        //[if herm-
        else if (player.gender == 3)
        {
            outputText("feverishly jacking yourself off with it while rapidly entering it in and out of your " + vaginaDescript(0) + " by way of your fingers.  The cool feel of it contrasts enough to send you over the edge relatively quickly.  You release your cum into it while it absorbs the juices from your " + vaginaDescript(0) + ".  You drop some of its bulk ");
        }
        //[if genderless-
        else
        {
            outputText("rubbing it over your " + assholeDescript() + ".  The cool feel of it contrasts enough to send you over the edge relatively quickly, and you drop it as you feel your muscles spasm with the phantom orgasm ");
        }
