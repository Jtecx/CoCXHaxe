...
class SwordInStone extends AbstractLakeContent
{
    public function new()
    {
        super();
    ...
    private function tryToTakeSwordInStone() : Void
    {
        ...
        if (player.cor >= 25)
        {
            ...
            if (player.str > 70)
            {
                outputText("pull mightily, making the tree strain and groan from the force, ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("pull hard, feeling your muscles tighten from the strain, ");
            }
            if (player.str < 40)
            {
                outputText("pull as hard as you can, ");
            }
        ...
        else
        {
            ...
            if (player.str > 70)
            {
                outputText("pull so hard you fall on your ass when the sword slips free.  The tip buries itself a few inches from your head.  You count yourself lucky and stand up.  ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("give a mighty pull and nearly fall over as the sword easily slides free from the tree.  ");
            }
            if (player.str < 40)
            {
                outputText("easily pull the sword free, surprising yourself with how easy it was to remove.  ");
            }
            ...
            {
                player.createStatusEffect(StatusEffects.BlessedItemAtTheLake, 1, 0, 0, 0);
            }
    ...
    private function tryToTakeBowInStone() : Void
    {
        ...
        else
        {
            ...
            if (player.str > 70)
            {
                outputText("pull so hard you fall on your ass when the bow slips free.  One of it sharp tips buries itself a few inches from your head.  You count yourself lucky and stand up.  ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("give a mighty pull and nearly fall over as the bow easily slides free from the tree.  ");
            }
            if (player.str < 40)
            {
                outputText("easily pull the bow free, surprising yourself with how easy it was to remove.  ");
            }
            outputText("Remarkably the tree's trunk is entirely intact.  While marveling at this new development, a leaf brushes your shoulder.  You look up and watch as every single leaf turns from healthy green, to brilliant orange, and finally changes to brown.  The leaves rain down around you, covering the ground in dead plant-matter, leaving you alone with the withering skeleton of a dead tree.  The sight saddens you, though you cannot fathom why.\n\n");
    ...
    private function tryToTakeStaffInStone() : Void
    {
        ...
        else
        {
            ...
            if (player.str > 70)
            {
                outputText("pull so hard you fall on your ass when the staff slips free.  The tip buries itself a few inches from your head.  You count yourself lucky and stand up.  ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("give a mighty pull and nearly fall over as the staff easily slides free from the tree.  ");
            }
            if (player.str < 40)
            {
                outputText("easily pull the staff free, surprising yourself with how easy it was to remove.  ");
            }
            outputText("Remarkably the tree's trunk is entirely intact.  While marveling at this new development, a leaf brushes your shoulder.  You look up and watch as every single leaf turns from healthy green, to brilliant orange, and finally changes to brown.  The leaves rain down around you, covering the ground in dead plant-matter, leaving you alone with the withering skeleton of a dead tree.  The sight saddens you, though you cannot fathom why.\n\n");
    ...
    private function tryToTakeShieldInStone() : Void
    {
        ...
        else
        {
            ...
            if (player.str > 70)
            {
                outputText("pull so hard you fall on your ass when the shield slips free.  The edge buries itself a few inches from your head.  You count yourself lucky and stand up.  ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("give a mighty pull and nearly fall over as the shield easily slides free from the tree.  ");
            }
            if (player.str < 40)
            {
                outputText("easily pull the shield free, surprising yourself with how easy it was to remove.  ");
            }
            outputText("Remarkably the tree's trunk is entirely intact.  While marveling at this new development, a leaf brushes your shoulder.  You look up and watch as every single leaf turns from healthy green, to brilliant orange, and finally changes to brown.  The leaves rain down around you, covering the ground in dead plant-matter, leaving you alone with the withering skeleton of a dead tree.  The sight saddens you, though you cannot fathom why.\n\n");
    ...
    private function tryToTakeWhipInStone() : Void
    {
        ...
        else
        {
            ...
            if (player.str > 70)
            {
                outputText("pull so hard you fall on your ass when the whip slips free.  The fall buries itself a few inches from your head.  You count yourself lucky and stand up.  ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("give a mighty pull and nearly fall over as the whip easily slides free from the tree.  ");
            }
            if (player.str < 40)
            {
                outputText("easily pull the whip free, surprising yourself with how easy it was to remove.  ");
            }
            outputText("Remarkably the tree's trunk is entirely intact.  While marveling at this new development, a leaf brushes your shoulder.  You look up and watch as every single leaf turns from healthy green, to brilliant orange, and finally changes to brown.  The leaves rain down around you, covering the ground in dead plant-matter, leaving you alone with the withering skeleton of a dead tree.  The sight saddens you, though you cannot fathom why.\n\n");
    ...
    private function tryToTakeFlyWhiskInStone() : Void
    {
        ...
        else
        {
            ...
            if (player.str > 70)
            {
                outputText("pull so hard you fall on your ass when the fly-whisk slips free.  The fall buries itself a few inches from your head.  You count yourself lucky and stand up.  ");
            }
            if (player.str <= 70 && player.str >= 40)
            {
                outputText("give a mighty pull and nearly fall over as the fly-whisk easily slides free from the tree.  ");
            }
            if (player.str < 40)
            {
                outputText("easily pull the fly-whisk free, surprising yourself with how easy it was to remove.  ");
            }
            outputText("Remarkably the tree's trunk is entirely intact.  While marveling at this new development, a leaf brushes your shoulder.  You look up and watch as every single leaf turns from healthy green, to brilliant orange, and finally changes to brown.  The leaves rain down around you, covering the ground in dead plant-matter, leaving you alone with the withering skeleton of a dead tree.  The sight saddens you, though you cannot fathom why.\n\n");
