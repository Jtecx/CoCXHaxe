...
class FetishZealotScene extends AbstractLakeContent
{
    ...
    private function cname() : String
    {
        ...
        else if (flags[kFLAGS.FETISH_FOLLOWER_SUBTYPE] == 2)
        {
            return "priest";
        }
        else
    ...
    public function zealotLossRape() : Void
    {
        ...
        {
            scene(player.mf("m", "f") == "m");
        }
        
        //============================================
        function scene(male : Bool) : Void
        //is that a guy?  Or does he just look like one?
        {
            ...
            //set the player's armor to their new male teacher outfit, see lower down for a full description.{
                ...
                {
                    player.modArmorName = "formal vest, tie, and crotchless pants";
                }
            ...
            //Set armour to female teacher outfit with no back side.{
                ...
                if (player.armor == armors.C_CLOTH)
                {
                    player.modArmorName = "backless female teacher's clothes";
                }
            ...
            if (male)
            {
                ...
                //Give the zealot a blowjob{
                    ...
                    if (player.hasVagina())
                    {
                        outputText("You slip one of your fingers inside your " + vaginaDescript(0) + ", wishing that it could get some attention, but this lesson is about pleasing <i>men</i>.  ");
                    }
    ...
    //Defeated by health
    {
        ...
        if (monster.HP < 1)
        {
            outputText("The " + cname() + " collapses from his wounds, too hurt to continue controlling his powers.");
        }
        //Defeated by lust
        else
        {
            outputText("The " + cname() + " quivers for a moment before collapsing, his desires becoming too great for even him to control.");
        }
    ...
    private function mindbreakMaleCultist() : Void
    {
        ...
        {
            outputText(" This is all it takes to get your newest plaything running to the lair. You smile, knowing you have made yet another convert as you head back to camp still giggling.");
        }
