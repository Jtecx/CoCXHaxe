...
class GooGirlScene extends AbstractLakeContent
{
    ...
    {
        var g : GooGirl = try cast(monster, GooGirl) catch(e:Dynamic) null;
        if (g == null)
        {
    ...
    private function gooColor() : String
    {
        return gooGirl().gooColor();
    }
    private function gooColor2() : String
    {
        return gooGirl().gooColor2();
    }
    private function gooColor3() : String
    {
        return gooGirl().gooColor3();
    }
    private function gooColor4() : String
    {
        return gooGirl().gooColor4();
    }
    private function gooColor5() : String
    {
        return gooGirl().gooColor5();
    }
    private function gooColor6() : String
    {
        return gooGirl().gooColor6();
    }
    private function gooColor7() : String
    {
        return gooGirl().gooColor7();
    }
    private function gooColor8() : String
    {
        return gooGirl().gooColor8();
    }
    private function gooColor9() : String
    {
        return gooGirl().gooColor9();
    }
    private function gooColor10() : String
    {
        return gooGirl().gooColor10();
    }
    private function gooColor11() : String
    {
        return gooGirl().gooColor11();
    }
    ...
    public function getBeatByGooGirl() : Void
    {
        ...
        {
            sceneHunter.print("Bad-end check failed: goo-morph, 5 consecutive losses.");
        }
        ...
        if (sceneHunter.uniHerms && !sceneHunter.lossSelect)
        {
            ...
            if (player.hasCock())
            {
                choices.push(dudeLoseToGooGal);
            }
            if (player.hasVagina())
            {
                choices.push(femaleLoseToGooGal);
            }
            if (player.isHerm())
            {
                choices.push(hermLoseToGooGal);
            }
    ...
    private function genderlessLoseToGooGal() : Void
    {
        ...
        if (player.gender != 0)
        {
            outputText("You try to avoid touching your sexual organs, and even try to cool them down with water to trick the blind goo-girl.");
        }
    ...
    private function hermLoseToGooGal() : Void
    {
        ...
        {
            outputText("  The mouths sucking at your [allbreasts] ripple against your flesh until milk sprays from your mammaries, her body suckling the entirety of your lactate-heavy chest, cleavage to teat.");
        }
    ...
    private function femaleLoseToGooGal() : Void
    {
        ...
        if (player.hasVisiblePregnancy())
        {
            ...
            {
                outputText("  She drains you in no time, hands hungrily sucking for more in goopy kisses on your overtaxed nipples.");
            }
            //[medium milk only:
            else if (player.lactationQ() <= 2000)
            {
                outputText("  She drinks gratefully, nursing you with her permeable body until the pout of her belly sloshes heavily with the pale ivory of your motherly bounty.");
            }
            else
            {
                outputText("  You bite your lip and let go, torrents of rich, pearl fluid rushing through her arms and inflating the surprised girl before your eyes. The milk gushing into her fills the goo from base to breast, giving the once-" + gooColor5() + " girl an opalescent shine, her over-filled body bloated as if she were carrying triplets.");
            }
        ...
        else
        {
            ...
            {
                outputText("She bottoms out quickly, filling every inch of your pussy with her squished form, wriggling inside of you happily, her membrane molding to your birth canals every crevasse.");
            }
            else
            {
                outputText("More and more of her ooze thrusts into you, shivers of overstimulation tearing through your mind like fists through wet parchment. Your eyes roll aimlessly as the pressure makes it difficult to breathe. With a squelching slurp, the last of the girl's form is pulled inside your slavering pussy.");
            }
            ...
            {
                outputText("  Everything she pumped into you runs back out after.  For some reason or another, it didn't take.");
            }
            else
            {
    ...
    //reset lose counter
    {
        ...
        var latexGoo_canThink : Bool = flags[kFLAGS.GOO_TFED_MEAN] == 0 && flags[kFLAGS.GOO_TFED_NICE] == 0 && flags[kFLAGS.TIMES_FUCKED_NORMAL_GOOS] >= 2;  //not checking your items, needed for the dialogue  
        var latexGoo_hasItems : Bool = (player.hasItem(consumables.SUCMILK) || player.hasItem(consumables.P_S_MLK)) && (player.hasItem(consumables.BLACKEG) || player.hasItem(consumables.L_BLKEG));  //not checking your items, needed for the dialogue  
        ...
        else
        {
            ...
            {
                addButtonDisabled(10, "???", "Requires wearing a specific 'gooey' armor and being NOT pregnant (even with anal pregnancy).");
            }
            //TF
            //corrupt chances
    ...
    private function gooMaleRape() : Void
    {
        flags[kFLAGS.TIMES_FUCKED_NORMAL_GOOS]++;
        clearOutput();
        var x : Float = player.findCock(1, -1, 24, "length");
        ...
        {
            sceneHunter.print("Failed check: high corruption (85).");
        }
        coreDropChance();
        player.sexReward("vaginalFluids", "Dick");
        cleanupAfterCombat();
    ...
    private function gooTooBigRape() : Void
    {
        flags[kFLAGS.TIMES_FUCKED_NORMAL_GOOS]++;
        clearOutput();
        var x : Float = player.findCock(1, 24, -1, "length");
        outputText("The girl wriggles in place, staring hopefully at you from her oozing puddle, her arms folded under her chest, eagerly waiting for your next move. Your skin still prickles from the lingering heat of her touch, impatient desire bubbling in your chest. You descend on the girl, and she proudly puffs out her breast, presenting herself to you.\n\n");
        //[Dick 2ft or larger]
    ...
    private function victoryRapeAGooGalAsFeeder() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("Even without stimulation, your clit practically vibrates under your climax, squeezing your body to its limits until everything fades into a pearl haze, and you lose yourself to the euphoria.\n\n");
        }
        else if (player.hasCock())
        {
            if (player.hasVagina())
            {
                outputText("Even without stimulation, your cock practically vibrates under your climax, squeezing your body to its limits until everything fades into a pearl haze, and you lose yourself to the euphoria.\n\n");
            }
            else if (player.hasVagina())
            {
                outputText("Even without stimulation, your tingling anus practically vibrates under your climax, squeezing to its limits until everything fades into a pearl haze, and you lose yourself to the euphoria.\n\n");
            }
        }
    ...
    private function slimeMerge() : Void
    {
        ...
        {
            outputText("You make a gooey smile at the idea of having some fun with the slime girl in front of you. This is going to be very satisfying. You slosh toward your defeating opponent and dive in, your fluid body merging with that of the other slime.");
        }
        else
        {
            outputText("The slime girl approaches you with a lewd gooey smile that gives you a good idea as to what's going to happen. Your own jelly-like body shivers in anticipation as she penetrates your permeable membrane and merges with you.");
        }
        outputText("\n\n");
        if (player.hasPerk(PerkLib.SlimeCore) || player.hasPerk(PerkLib.DarkSlimeCore))
        {
            outputText("As your cores touches each other you moan in delight");
        }
        else
        {
            outputText("You gasp in pleasure as your fluids gets in touch with the slime girl heart");
        }
