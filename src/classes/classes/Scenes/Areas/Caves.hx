...
class Caves extends BaseContent
{
    public var cavesEncounter(get, never) : GroupEncounter;
    ...
    private function get_cavesEncounter() : GroupEncounter
    {
    ...
    public var areaLevel(default, never) : Int = 30;
    ...
    public function cavesChance() : Float
    {
        var temp : Float = 0.5;
