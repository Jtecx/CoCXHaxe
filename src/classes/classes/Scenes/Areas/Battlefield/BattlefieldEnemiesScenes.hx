...
class BattlefieldEnemiesScenes extends BaseContent
{
    ...
    public function canEncounterZombies() : Bool
    {
    ...
    public function encounterZombies() : Void
    {
        ...
        {
            outputText("You recognize these creatures...You used to be one of them, after all. But they've noticed you now.");
        }
        else
        {
            outputText("At first you ask one of them if it needs help, but the way it's salivating...You look into their eyes, and know they're not going to listen. You ready your [weapon]");
        }
    ...
    public function loseToZombies() : Void
    {
        ...
        if (player.hasVagina())
        {
            if (player.hasCock())
            {
                outputText("grabbing and sucking your cock");
            }
            outputText("lapping at your exposed slit");
        }
        else
        {
            outputText("forcing you into a kiss");
        }
