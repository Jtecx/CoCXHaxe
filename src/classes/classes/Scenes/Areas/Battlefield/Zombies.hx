...
class Zombies extends Monster
{
    ...
    private function ZombiesUndyingFlurryH() : Void
    {
        ...
        else
        {
            ...
            var damageLust : Float = Math.round(this.lib / 50);
    ...
    public function ZombiesDrainingKiss() : Void
    {
        ...
        {
            outputText("Out of the corner of your eyes, you see the flank coming. You back up, breaking the attempted circle. The horde keeps coming, but you’re not drained.");
        }
        else
        {
            ...
            var damageLust : Float = Math.round(player.lib * 2);
