 ...
 */
class CockatriceScene extends BaseContent
{
    ...
    public function greeting() : Void
    {
        ...
        //First encounter:{
            ...
            outputText("Though you can’t pick out many details from this distance, the vibrant coloring of this individual makes you think of the harpies that rule the skies here. "
                    ...
                    + "Their enthusiasm for your [cock] is something you could really do without, "
                    + ((player.canFly()) ? " even though you could use your [wings] to ensure your safety. " : " especially at such dizzying heights.  ")
    ...
    public function defeatCockatrice() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText(images.showImage("cockatrice-fallen-hp"));
        }
        else
        {
            outputText(images.showImage("cockatrice-fallen-lust"));
        }
        outputText("The Cockatrice falls to his knees panting as he looks over at you. ");
        //Player HP victory:
        if (monster.HP < 1)
        {
            outputText("He looks thoroughly beaten, feathers ruffled and face dirtied from debris that rose during the battle. The defiant look in his eyes is all that's left of his previous manic energy.\n\n");
        }
        //Player Lust victory:
        else
        {
            outputText("He lazily strokes his purple length as he looks up at you with a come-hither gaze. His ruffled feathers, dirtied scales and leisurely pumps manage to make him look quite dashing, even in defeat.\n\n");
        }
        if (player.lust >= 33)
        {
            menu();
            ...
            if (!player.isTaur() && !player.isDrider())
            {
                if (player.hasVagina())
                {
                    addButton(0, "Ride Him Vag", rideCockatriceForeplay, cockatriceRideHimVag).hint("Let him fuck your pussy.");
                }
                ...
                {
                    addButton(2, "Buttfuck", cockatriceButtfuck).hint("Fuck the cockatrice's ass!");
                }
                if (player.hasCock())
                {
            ...
            else if (player.isTaur() && (player.hasVagina() || player.hasCock()))
            {
                addButton(5, "Taur sex", cockatriceTaurButtFuck).hint("Let him fuck your tauric butt!");
            }
            else if (player.isDrider() && (player.hasVagina() || player.hasCock()))
            {
    ...
    private function cockatriceButtfuck() : Void
    {
        ...
        if (player.longestCockLength() <= 12)
        {
            ...
            if (player.hasBalls())
            {
                outputText("Your [balls] " + ((player.balls == 1) ? "presses" : "press") + " firmly against his fluffy cheeks, caressed by his downy plumage in a delightful way.");
            }
        }
        else
        {
            outputText(" You slowly try to feed more of your [cock] into his tight cavity, but soon the crushing tightness becomes too much to handle. You sigh a little as you withdraw to a more comfortable position, disappointed you’re too big to give him a proper reaming. ");
        }
        ...
        {
            outputText("Your other " + ((player.cocks.length > 2) ? "cocks only manage" : "cock only manages") + " to spurt white tinged pre that dribbles down your lengths. ");
        }
        ...
        if (player.cocks.length > 1)
        {
            outputText(" Your other " + ((player.cocks.length > 2) ? "cocks coat" : "cock coats") + " his behind further, leaving his ruffled feathers and the underside of his tail a sticky mess, a satisfying sight making his ass look thoroughly claimed.");
        }
    ...
    {
        var CHOICE_PUSSY : Int = 1;
        var CHOICE_COCK : Int = 2;
        var choice : Int;
        if (player.hasCock() && player.hasVagina())
        {
            choice = (rand(2) == 0) ? CHOICE_PUSSY : CHOICE_COCK;
        }
        //50/50 chance for herms
        else
        {
    ...
    private function rideCockatriceForeplay(nextFun : Function) : Void
    {
        ...
        {
            outputText("as if asking for permission with his gaze. While he may be head level with your groin which would suggest your intent, he hasn’t moved to touch you once.");
        }
        ...
        {
            var cockLength : Float = player.longestCockLength();
        ...
        var assF : Void->Void = function() : Void
        {
            if (player.gender == 0)
            {
                outputText("With a slowness that seems unnatural for a creature that was moments ago bouncing around like a ferret hopped up on sugar, he examines you with a curious look. Your lack of genitals seems to have stumped him. ");
            }
    ...
    public function cockatriceBirth(womb : Int = 0) : Void
    {
        ...
        outputText("A sudden shift in the weight of your pregnant belly staggers you, dropping you to your knees. You realize something is about to be birthed, and you shed your [armor] before it can be ruined by what's coming. "
                + "A contraction pushes violently through your midsection, stretching your "
                + player.vaginaDescript(womb)
                + " painfully, the lips opening wide as something begins sliding down your passage. "
        ...
        //(eggCounter)
        outputText("When you find yourself able to stand, you examine what it is you have birthed; " + num2Text(kids) + " medium, white eggs, the unmistakable shape of hen eggs. " + "You pick up one and hold it gently against your ear; inside, you can hear a tiny heart, beating so fast. " + "You put it down carefully with his fellows and stare at your clutch, a queasy tangle of emotions tugging at you. " + "There is nothing else to be done: you will have to take this clatch to your camp\n\n");
        outputText("When the light of day breaks, you wake up and see a clutch of eggs still resting in a puddle of pink slime. All are empty, and tiny cocks against it. They have pink chests, flanks, front legs, heads, necks, and a long stretch of their backs. "
                ...
                + "You can't say whether you find the sight insanely cute or utterly disgusting, and you don't know whether the reason you can't look away is because you are fascinated by the creatures you have brought into this world, or because of the effect of "
                + (num2Text(kids))
                + " baby cockatrice eyes on you. "
        ...
        if (player.cor < 33)
        {
            outputText("You find yourself shaken by the experience, and deeply disquieted by the thought of the clutch of monsters you have unleashed on this world. You pick yourself up, rub yourself down and leave, promising yourself fervently you'll be more careful around cockatrices in the future.");
        }
