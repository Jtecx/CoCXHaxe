...
class Phoenix extends Monster
{
    public function doubleSlash() : Void
    {
        ...
        else
        {
            ...
            //Get hit
            var damage : Int = as3hx.Compat.parseInt((str + weaponAttack + rand(160)) * 2);
            player.takePhysDamage(damage, true);
            //Get hit again
            damage = as3hx.Compat.parseInt((str + weaponAttack + rand(160)) * 2);
            player.takePhysDamage(damage, true);
        }
    }
    ...
    public function phoenixFireBreathA() : Void
    {
        ...
        else
        {
            ...
            {
                var damage : Int = as3hx.Compat.parseInt((str + weaponAttack + 600 + rand(500)) * 2);
    ...
    public function new()
    {
        ...
        this.drop = new ChainedDrop().add(useables.EBONBLO, 1 / 20).add(weapons.SCIMITR, 1 / 20).elseDrop(consumables.NOCELIQ);
