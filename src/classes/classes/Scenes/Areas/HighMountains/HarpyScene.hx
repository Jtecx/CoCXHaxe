...
class HarpyScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function harpyVictoryuuuuu() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("The harpy screams out in one last, pained cry before her wings give way, the feathered woman collapsing into a weary heap.");
        }
        //(Enemy defeated by lust)
        else
        {
            outputText("The harpy can't contain her lust anymore and crumples to the ground before you, on her knees with her plush, heavy ass resting on her feet. She coos pathetically, with one hand between her legs furiously fingering herself, and the other pressed against your crotch, a needy look in her eyes.");
        }
        //Rape options
        menu();
        if (player.lust >= 33)
    ...
    private function harpyLossLust() : Void
    {
        ...
        {
            outputText(" and moves it out of your face");
        }
        ...
        if (player.hasVagina() && (x < 0 || sceneHunter.uniHerms && rand(2) == 0))
        {
            ...
            if (player.hasMostlyPlainSkin())
            {
                outputText(" and quickly alleviating the pain by brushing their wings across your hide");
            }
            ...
            if (player.hasMostlyPlainSkin())
            {
                outputText(", always followed by a soothing brush of their feathers");
            }
            ...
            if (player.hasMostlyPlainSkin())
            {
                outputText(" across your reddening skin");
            }
        ...
        else
        {
            //(Reminds me of what my own Succubus does in my novel){
                ...
                if (player.hasBalls())
                {
                    outputText("You can feel her little tongue rolling across your balls and the base of your ");
                }
                else
                {
                    outputText("You can feel her little tongue rolling across the base of your ");
                }
    ...
    private function harpyDamageLoss() : Void
    {
        ...
        var y : Float = player.findCock(2, -2, monster.vaginalCapacity());
        ...
        if (choice == 0 || choice == 1)
        {
            ...
            //with multi - forced{
                ...
                if (player.hasBalls())
                {
                    outputText(", craning their necks to slurp and massage your [balls] eagerly, trying to coax up your cum production as much as they can");
                }
                ...
                {
                    outputText("her petite bosom grinding across your [allbreasts], her nipples tickling at your " + nippleDescript(0) + ", ");
                }
            ...
            else
            {
                ...
                if (player.hasBalls())
                {
                    outputText("their hands moving up to grope and fondle your [balls], massaging them to boost your cum production as much as they can, ");
                }
                ...
                {
                    outputText(", causing your [allbreasts] to bounce and sway violently");
                }
                outputText(".  She slowly leans down, her eyes locked on yours, her lips glinting a malicious gold");
                //(if breasts)
                if (player.biggestTitSize() >= 2)
                {
                    outputText(" her toned chest and pert breasts squishing your " + breastDescript(0) + " beneath them");
                }
                outputText(".\n\n");
            }
            //Apply harpy status.
        ...
        else
        {
            ...
            {
                outputText(" and causing your [allbreasts] to jiggle, slapping into one another");
            }
            outputText(". She leans slowly over you, her gilded lips glistening with saliva as they approached yours");
            //{(If breasts)
            if (player.biggestTitSize() >= 2)
            {
                outputText(", her petite chest squashing your " + breastDescript(0) + " against hers");
            }
            outputText(".\n\n");
        ...
        if (choice == 0)
        {
            ...
            if (player.hasBalls())
            {
                outputText(", her huge feathery bottom coming to rest on your " + ballsDescriptLight());
            }
            ...
            if (player.balls >= 0)
            {
                ...
                if (player.gender == 3)
                {
                    outputText(" before swinging back to spanking your " + vaginaDescript(0) + " wetly.");
                }
                else
                {
                    outputText(".");
            ...
            {
                outputText(" while your [allbreasts] are shaking and jiggling around helplessly.");
            }
            else
            {
                outputText(".");
        ...
        else
        {
            ...
            if (player.biggestTitSize() >= 2)
            {
                outputText("Their hungry feminine mouths creep beneath the body of the harpy atop you and grab hard onto your " + breastDescript(0) + ".  They pull them towards their mouths, those gold lips wrapping themselves around your " + nippleDescript(0) + "s to suckle gently.  ");
            }
            //{(If lactating)
            if (player.biggestLactation() >= 1)
            {
                outputText("You hear some subtle slurps around the big feathery earmuffs crushing your head, and feel your " + breastDescript(0) + " begin to drain, sending motherly shivers through your whole being.  The monster-girls drink and drink, those stubby tongues circling each nipple while the drugged golden lips make you tingle sensually.  ");
            }
            ...
            if (player.biggestTitSize() >= 2)
            {
                outputText("her belly squishing your [allbreasts] beneath her weight, ");
            }
        ...
        if (choice == 0 || choice == 1)
        {
            ...
            if (player.gender == 3)
            {
                outputText(", and the number of times your " + vaginaDescript(0) + " has dripped your sweet feminine cum over your thighs");
            }
        ...
        else
        {
            ...
            if (player.biggestLactation() >= 1)
            {
                outputText("  Their bellies seem a little pudgier than when they'd started, a result of the endless drinking from your " + nippleDescript(0) + "s.  ");
            }
    ...
    private function victoryHarpyGetsHerPussyRaped() : Void
    {
        ...
        if (y >= 0)
        {
            outputText("and viciously-clenching ass ");
        }
        ...
        if (player.hasBalls())
        {
            outputText("You eventually bottom out, your [balls] coming to rest between her powerful, gelatinous thighs, her soft feathers tickling at your " + sackDescript() + " maddeningly.\n\n");
        }
        //(If balls-less)
        else
        {
            outputText("Leaning low over her back, you adjust to drive yourself ever deeper, forcing the whole length of your " + cockDescript(x) + " into her, the soft down on her gelatinous thighs prickling at your thighs maddeningly.\n\n");
        }
        ...
        if (player.hasBalls())
        {
            outputText("Your " + sackDescript() + " slaps wetly into her immense, wobbling thighs.  ");
        }
    ...
    private function winAndRapeHarpyAnally() : Void
    {
        ...
        if (player.biggestTitSize() >= 2)
        {
            outputText(" Her petite bust squishes against your [allbreasts]. Her downy tits tickle, and grind against your chest maddeningly, tickling and scratching them gently as the lust-fueled bird-girl seems to ache for you.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] come to rest against her thick, wiggly rear.");
        }
        outputText("\n\n");
        ...
        else
        {
            ...
            if (player.biggestTitSize() >= 2)
            {
                outputText(", the motions causing your [allbreasts] to bounce and sway wildly, slapping into one another lewdly, adding to your growing lust");
            }
            ...
            if (player.hasVagina())
            {
                ...
                if (player.hasBalls())
                {
                    outputText("  She even makes your " + ballsDescript() + " slap against your " + vaginaDescript(0) + ", a hot, moist SPLAT accompanying every tiny motion the harpy makes.");
                }
            }
            outputText("\n\n");
        }
        ...
        if (player.biggestTitSize() >= 2)
        {
            outputText("her chest mashing against yours as she becomes still, ");
        }
    ...
    private function WinOnHarpyAndOralRape() : Void
    {
        ...
        if (player.biggestTitSize() >= 2)
        {
            outputText(", but soon she presses her toned, petite chest against your [allbreasts], that stubby tongue tangling around yours lustily.");
        }
        else
        {
            outputText(", but soon she is pressing against you, rubbing her toned body against yours, driving her tongue back against yours in a haze of lust, turning her head quickly and sharply, birdlike.");
        }
        outputText("\n\n");
        ...
        function singleF() : Void
        {
            ...
            if (player.gender == 3)
            {
                outputText("  Her expert fingers tease up the sides of your thighs, coming to softly brush across your moist nether lips, her fingers spreading your " + vaginaDescript(0) + " wide before plunging into the warmth within, adding another sweet sensation of pleasure to the amazing orchestra of sensations her lips were giving to you.");
            }
            //(If balls)
            if (player.hasBalls())
            {
                outputText("  Her hands creep down to softly squeeze and massage your [balls], the harpy's eager head bobbing back and forth along the sweet tasting shaft of your [cock], sending waves of powerful, overwhelming pleasure resonating through your body.");
            }
            outputText("\n\n");
            ...
            if (player.gender == 3)
            {
                outputText(", her other hand doing the exact same to your own " + vaginaDescript(0) + ", digging those perfect fingers deep into the wet, hyper-sensitive flesh, spreading those lips wide");
            }
            ...
            //(If balls)
            if (player.hasBalls() && player.cocks[0].cockLength <= 16)
            {
                outputText("She even deep throats you, taking your length into her expertly-controlled mouth, that tongue creeping out to tickle at your [balls].  ");
            }
        ...
        var multiF : Void->Void = function() : Void
        {
            ...
            if (player.biggestTitSize() >= 2)
            {
                ...
                if (player.biggestLactation() >= 1)
                {
                    outputText("  Milk dribbles out gently onto the areola, trickling sensually between your cleavage.");
                }
            }
            else
            {
            ...
            if (player.hasBalls())
            {
                outputText(", dribbling all over your " + sackDescript());
            }
            ...
            if (player.gender == 3)
            {
                outputText("  Her fingers never stop their sweet teasing of your " + vaginaDescript(0) + ", using all four fingers on her hand to plumb your velvet depths.");
            }
        ...
        function vagF() : Void
        {
            ...
            if (player.biggestTitSize() >= 2)
            {
                outputText("You grasp onto your [allbreasts] violently, kneading and tweaking your " + nippleDescript(0) + " in a horny haze as the harpy's fingers tease around your pussy.  ");
            }
    ...
    private function harpyScissorSurprise() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("her arms tremble from the effort of trying to keep her body from collapsing to the floor.");
        }
        else
        {
            outputText("she leans back from her kneeling position, spreading her legs and digging her fingers into her soaking cunt. Her other hand darts up to her ample bosom, giving it a hard squeeze before starting to tease her erect nipple, pinching and flicking as she continues to fingerfuck herself ever more forcefully.");
        }
    ...
    private function clitFuckAHarpy() : Void
    {
        ...
        if (monster.lust >= monster.maxOverLust())
        {
            outputText("moan and masturbate, dipping her fingers into her honey-pot with wild abandon.");
        }
        else
        {
            outputText("moan and struggle to rise, jiggling in the cutest way each time she slumps down, defeated.");
        }
        ...
        if (player.wetness() < 3)
        {
            outputText("  Runnels of your lubricant are dripping down your [legs] in streams,");
        }
        else if (player.wetness() < 4)
        {
            outputText("  Streams of lubricant are soaking down your [legs] in waves,");
        }
        else
        {
            outputText("  Squirts of lubricant are gushing down your [legs] to puddle on the floor,");
        }
        ...
        if (player.wetness() < 3)
        {
            outputText("  A fresh gush of fluid washes out of your pussy at the peak of your pleasure even though you're far from a squirter");
        }
        else if (player.wetness() < 4)
        {
            outputText("  A fresh spout of girlspunk washes out of your pussy at the peak of your pleasure");
        }
        else
        {
            outputText("  A torrential splash of girlspunk shoots out of your pussy in a river at the peak of your pleasure");
        }
