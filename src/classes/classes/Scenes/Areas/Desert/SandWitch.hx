...
class SandWitch extends Monster
{
    ...
    private function lustMagicAttack() : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.StoneLust))
        {
            ...
            player.takeLustDamage(8 + as3hx.Compat.parseInt(player.effectiveSensitivity()) / 5, true);
        }
        else
        {
