...
class Wanderer extends BaseContent
{
    ...
    private function wandererEpilogueHuman() : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.WandererHuman))
        {
            ...
            if (player.statusEffectv1(StatusEffects.WandererHuman) == 0)
            {
                ...
                if (player.cor < 33)
                {
                    outputText("You duck back behind a dune, blushing furiously.");
                }
                else if (player.cor < 66)
                {
                    outputText("You blush crimson as you swear you see Lucia look right at you and wink.");
                }
                else
                {
                    outputText("You openly leer at the crude display, whistling lewdly at the blissful couple.  Marcus looks up and gives a cocky smile, while Lucia licks her lips and gives you a predatory grin.");
                }
