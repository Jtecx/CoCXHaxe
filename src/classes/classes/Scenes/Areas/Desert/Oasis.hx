...
class Oasis extends BaseContent
{
    ...
    private function oasisTalkAccept() : Void
    {
        ...
        if (player.isTaur())
        {
            outputText("your rear legs losing their balance and sending you crashing on your flank.  ");
        }
        else
        {
            outputText("legs falling open in the process.  ");
        }
        ...
        if (!player.hasStatusEffect(StatusEffects.VoluntaryDemonpack))
        {
            player.createStatusEffect(StatusEffects.VoluntaryDemonpack, 0, 0, 0, 0);
        }
        else
        {
    ...
    private function oasisSexing() : Void
    {
        spriteSelect(SpriteDb.s_oasis_demons);
        player.slimeFeed();
        //New screen
        ...
        if (player.cocks.length > 0)
        {
            ...
            if (player.cocks[0].cockLength > 25)
            {
                outputText("feel your [cock] slide into a hell-girl's sloppy cunt. The demoness moans and pants in pleasure as your [cock] bottoms out in her gaping pussy and she begins to ride you like the motionless whore you momentarily are, her gigantic breasts threatening to concuss you as she slides the huge distance up and down your cock in her thirst to fill her cavelike cunt.  ");
            }
            else
            {
                ...
                if (player.cocks[0].cockLength > 17)
                {
                    outputText("with hardly any of you inside her ");
                }
                else if (player.cocks[0].cockLength > 12)
                {
                    outputText("about halfway down your [cock] ");
                }
                else if (player.cocks[0].cockLength > 6)
                {
                    outputText("with almost all of you inside of her ");
                }
                else if (player.cocks[0].cockLength <= 6)
                {
                    outputText("as her pussy lips touch the base of your [cock] ");
                }
            ...
            player.sexReward("no", "Dick")  //IZ OVER FOR MENZ  ;
        ...
        //Herms only!{
            ...
            if (player.gender == 3)
            {
                outputText("From your cock it is only a tiny trip downward between your legs before the demons discover something new to play with.  ");
            }
            //Girlies only!
            else
            {
                outputText("The demons quickly find your " + vaginaDescript(0) + " and tussle eagerly for position at your entrance, first with hands and then with a wide range of demonic dicks.  ");
            }
            //gaping cunners!
        ...
        if (player.gender > 0)
        {
            outputText("However, the demons are interested in every part of you, not just your crotch.  ");
        }
        ...
        if (player.vaginas.length > 0)
        {
            outputText("You feel the cocks in your ass and pussy rubbing into each other as your lower body becomes a temple of friction. The feeling of so much demon stuffing you as full as possible is almost unbearable, and you are inches away from blacking out as you come again.  ");
        }
    ...
    private function oasisBadEnd() : Void
    {
        ...
        if (!player.isTaur())
        {
            outputText("Your feet are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ");
        }
        if (player.isTaur())
        {
            outputText("Your four legs are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ");
        }
        ...
        if (player.gender >= 2)
        {
            outputText("He reaches down to grab a hold of your hair and lifts you to your feet, causing you to yelp out in pain from the sharp pull.  ");
        }
    ...
    private function oasisBadEndEpilogue() : Void
    {
        ...
        if (player.gender <= 1)
        {
            outputText(" and a few doses of fermented succubi milk");
        }
        outputText("...\n\n");
