...
class GorgonScene extends BaseContent
{
        ...
        //Set 'last fuck as naga'{
            ...
            //[Player cock is too big]{
                ...
                else
                {
                    ...
                    if (player.cockTotal() == 1)
                    {
                        outputText("Gently she starts to stroke the length of your [cock] with one hand while circling the tip with the other. ");
                    }
