...
class Behemoth extends Monster
{
    ...
    public function tailWhip() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt((str + level) * 2);
            player.takePhysDamage(damage, true);
        }
        if (hasStatusEffect(StatusEffects.TailWhip))
        {
            addStatusValue(StatusEffects.TailWhip, 1, 5);
        }
        else
        {
            createStatusEffect(StatusEffects.TailWhip, 5, 0, 0, 0);
        }
    }
