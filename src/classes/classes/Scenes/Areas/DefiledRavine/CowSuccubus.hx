...
class CowSuccubus extends AbstractSuccubus
{
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.BIMBOLQ, 1).add(weapons.SUCWHIP, 2).add(consumables.LABOVA_, 8).add(consumables.SUCMILK, 10);
