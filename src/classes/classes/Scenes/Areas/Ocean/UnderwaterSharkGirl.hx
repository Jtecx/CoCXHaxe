...
class UnderwaterSharkGirl extends Monster
{
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.L_DRAFT, 3).add(armors.S_SWMWR, 1).add(consumables.SHARK_T, 5).add(null, 1);
