...
class Succubus extends AbstractSuccubus
{
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        ...
        {
            SceneLib.dungeons.factory.doLossSuccubus(false);
        }
    }
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.BIMBOLQ, 1).add(weapons.WHIP, 2).add(consumables.SUCMILK, 12);
