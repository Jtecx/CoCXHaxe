...
class DemonPackBlightRidge extends Monster
{
    ...
    override public function defeated(hpVictory : Bool) : Void
    {
        ...
        {
            SceneLib.tyrantia.TyrantiaAfterMainFightWon();
        }
        else
        {
            clearOutput();
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        if (TyrantiaFollower.TyrantiaFollowerStage == 2)
        {
            SceneLib.tyrantia.TyrantiaAfterMainFightLost();
        }
        else
        {
            clearOutput();
    ...
    public function postIntroFight() : Void
    {
        ...
        {
            outputText(", noticing his eyes flash in recognition");
        }
        ...
        if (player.cor < 60)
        {
            outputText("I could ask the same of you. ");
        }
        if (flags[kFLAGS.SAND_WITCHES_FRIENDLY] > 0)
        {
            outputText("I’m a mercenary in the employ of the sand covens. ");
        }
        ...
        {
            outputText(" picturing the effects of this magic on Tel’Adre’s defenders");
        }
        outputText(".");
    ...
    public function new()
    {
        ...
        this.abilities = [
                ...
                {
                    call : SceneLib.combat.packAttack,
                    type : ABILITY_PHYSICAL,
                    range : RANGE_MELEE,
                    tags : [TAG_BODY]
                }, 
                {
                    call : SceneLib.combat.lustAttack,
                    type : ABILITY_TEASE,
                    range : RANGE_RANGED,
                    tags : []
                }
