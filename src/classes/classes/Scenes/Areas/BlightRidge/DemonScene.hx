...
//use namespace CoC;
class DemonScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    public function defeatMinoIncubus() : Void
    {
        ...
        if (monster.HP < 1)
        {
            addButton(5, "Kill Him", killDemon);
        }
    ...
    public function lustyPaizuri() : Void
    {
        ...
        {
            outputText(", bouncing with each beat of [monster his] heart, thick beads of pre dribbling from [monster his] tip as you bat [monster his] hands away before [monster he] can waste the load [monster he]'s saved up for you.");
        }
        ...
        {
            outputText("a gift too fine for a selfish brute like you");
        }
        else
        {
            outputText("sacred and to be shared only with a cherished loved one");
        }
        ...
        if (monster.hasBalls())
        {
            outputText(" and fondle [monster his] balls one-handed, squeezing the virile orbs to try and coax more of [monster his] dirty, perverted thoughts to distill into salty seed");
        }
        else
        {
            outputText(" and stroke [monster his] taint, even brushing close to [monster his] asshole to try and coax more of [monster his] dirty, perverted thoughts to distill into salty seed");
        }
        ...
        {
            outputText("  It's so big and strong that it pushes right into your throat, stretching out your neck in the shape of the intruding cock.");
        }
        ...
        if (player.hasVirginVagina())
        {
            outputText("maidenhead");
        }
        else
        {
            outputText("sloppy gash");
        }
        ...
        if (monster.cockArea(0) >= 80)
        {
            outputText(" with a messy cough to clear your throat");
        }
        ...
        if (monster.hasBalls())
        {
            outputText(", [monster his] balls pumping and bouncing in [monster his] sack");
        }
    ...
    public function defeatOmnibus() : Void
    {
        ...
        if (monster.HP < 1)
        {
            addButton(5, "Kill Her", killDemon);
        }
        addButtonIfTrue(6, "Tame It", SceneLib.campMakeWinions.tamingAttempt, "Req. to have Job: Tamer", player.hasPerk(PerkLib.JobTamer));
        addButton(14, "Leave", cleanupAfterCombat);
        if (player.lust >= 33 && player.gender > 0)
        {
            ...
            addButton(0, "M. Fuck", OmnibusGetsRapedByMale).disableIf(!player.hasCock(), "Req. a cock.");
            addButton(1, "F. Fuck", OmnibusGetsRapedByFemale).disableIf(!player.hasVagina(), "Req. a vagina.");
            LustyMaidensArmor.addTitfuckButton(2);
            addButton(3, "Use demon", rapeCerberusStyle).disableIf(!player.isRaceCached(Races.CERBERUS), "Req. Cerberus race");
    ...
    public function OGRBM_fits() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.[pg]");
        }
        else if (player.cor < 66)
        {
            outputText("You groan, wondering why she just won't get over her little act.  Even though this wasn't your best idea, it isn't nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.[pg]");
        }
        else
        {
            outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit him on my cock first chance I get, dear.</i>\"[pg]");
        }
    ...
    public function OGRBM_toobig() : Void
    {
        ...
        {
            outputText("Your [cockhead] crests between her breasts with every stroke, bumping against her chin.  It grows larger as the pleasure of the act intensifies to orgasmic levels.[pg]");
        }
        else if (player.cocks[x].cockLength < 24)
        {
            outputText("Your [cockhead] slides over her cheek with every stroke, leaving a trail of pre-cum on her face.  The smudges of glistening pre grow larger and larger as the pleasure of the act nears orgasmic levels.[pg]");
        }
        else
        {
            outputText("Your [cock] slides over her face with every stroke, smearing the demon's hair with your thick pre-seed before you pull back and dribble it on her face.  The pleasure of the act is incredible, and you feel yourself getting harder as the sensation nears orgasmic levels.[pg]");
        }
        ...
        {
            outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit them on my cock first chance I get, dear.</i>\"[pg]");
        }
        outputText("As you leave, you don't bother to spare a glance at the confused omnibus; she isn't worth your time.");
        player.sexReward("Default", "Dick");
        dynStats("lib", 3, "sen", 3, "cor", 1);
    ...
    public function OmnibusGetsRapedByFemale() : Void
    {
        ...
        {
            outputText("unable to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.[pg]");
        }
        else
        {
            outputText("able to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.[pg]");
        }
        ...
        {
            outputText("You bend over and rub your belly while whispering in her ear, \"<i>Like mother, like child.</i>\"[pg]");
        }
    ...
    public function defeatSuccubus() : Void
    {
        ...
        if (player.lust >= 33)
        {
            ...
            addButton(2, "Use demon", rapeCerberusStyle).disableIf(!player.isRaceCached(Races.CERBERUS), "Req. Cerberus race");
    ...
    public function ForcefeedSuccubus() : Void
    {
        ...
        {
            outputText("Her flexible tongue easily curls around one of your " + nippleDescript(0) + "'s, letting her pull and tug on it as she increases the suction from her lips.  Your body rewards her efforts with a faster flow of milk that she sucks down as if she were starving.[pg]");
        }
        ...
        {
            outputText("Her belly bulges slightly from all the breast-milk she's consumed.[pg]");
        }
        else
        {
            outputText("The succubus looks bloated and pregnant from all the milk you've forced into her.  She sloshes and moans incoherently from the strain of it all.[pg]");
        }
    ...
    private function killDemon() : Void
    {
        ...
        if (monster.short == "succubus")
        {
            outputText("succubus");
        }
        if (monster.short == "incubus")
        {
            outputText("incubus");
        }
        if (monster.short == "omnibus")
        {
            outputText("omnibus");
        }
        if (monster.short == "cow succubus")
        {
            outputText("cow succubus");
        }
        if (monster.short == "mino incubus")
        {
            outputText("mino incubus");
        }
