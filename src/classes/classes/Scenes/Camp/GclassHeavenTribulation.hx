...
class GclassHeavenTribulation extends HclassHeavenTribulation
{
    public function tribulationLustfullThunderStrike() : Void
    {
        ...
        var ThLu : Float = player.statusEffectv3(StatusEffects.HeavenTribulationCR);
        ...
        else
        {
            ...
            var LUSTFULL : Float = (125 * player.statusEffectv3(StatusEffects.HeavenTribulationCR));
    ...
    override public function defeated(hpVictory : Bool) : Void
    {
        if (player.statusEffectv1(StatusEffects.HeavenTribulationCR) >= 5)
        {
            campscene.GclassHTsurvived();
        }
        else
        {
            campscene.GclassHTbeaten();
        }
    }
