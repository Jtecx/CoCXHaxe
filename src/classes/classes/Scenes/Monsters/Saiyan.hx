...
class Saiyan extends Monster
{
    ...
    {
        super();
        if (flags[kFLAGS.SAIYAN_ENEMY_NUMBER_COUNTER] == 1)
        
        //female (change her to diff female stats){
        ...
        if (flags[kFLAGS.SAIYAN_ENEMY_NUMBER_COUNTER] == 4)
        ...
        if (flags[kFLAGS.SAIYAN_ENEMY_NUMBER_COUNTER] == 7)
