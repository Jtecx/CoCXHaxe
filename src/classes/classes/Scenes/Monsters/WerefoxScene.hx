...
class WerefoxScene extends BaseContent
{
    ...
    public function werefoxInnerDesertEncounter() : Void
    {
        ...
        {
            outputText("Your night-adapted eyes allow you to quickly notice a white-furred female figure skulking towards you, the shadows doing a decent job at concealing her...But not from you. She pounces at you, but you saw her coming. You easily dodge her attack, readying for battle.");
        }
        else
        {
            outputText("Out of nowhere a fur-covered figure hits you from the side, bringing you down to the ground. You quickly shove it off, you manage to shove her back, and you see your assailant clearly for the first time. She appears to be a fox girl of some sort.");
        }
    ...
    public function werefoxOuterDeepDesertEncounter() : Void
    {
        ...
        {
            outputText("Out of nowhere a shadowy pounce on you and it’s barely if you manage to shove her back after overcoming the surprise attack. You focus your vision on your opponent and determine it to be a fox girl of some sort.");
        }
        outputText("She growls at you as she circles your position, claws and fangs out in a menacing display as she looks for an opening. This She-fox seems intent on fighting you.");
    ...
    public function lostToWerefox() : Void
    {
        ...
        var stolen : Float = 7 + rand(14);
        if (flags[kFLAGS.SPIRIT_STONES] > 0)
        {
            if (flags[kFLAGS.SPIRIT_STONES] < stolen)
            {
                stolen = flags[kFLAGS.SPIRIT_STONES];
            }
        ...
        else if (player.gems > 0)
        {
            stolen *= 20;
            if (player.gems < stolen)
            {
                stolen = player.gems;
            }
            player.gems -= stolen;
