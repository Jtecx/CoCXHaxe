...
class FeralImps extends Monster
{
    ...
    public function clawAttack() : Void
    {
        ...
        {
            outputText(this.capitalA + this.short + " charges at you with their claws ready! ");
        }
        else
        {
        ...
        if (player.getEvasionRoll())
        {
            if (flags[kFLAGS.FERAL_EXTRAS] == 4)
            {
                outputText("You manage to avoid their claws thanks to your reaction!");
            }
            else
            {
        ...
        else if (flags[kFLAGS.FERAL_EXTRAS] == 4)
        {
            ...
            var damage1 : Int = as3hx.Compat.parseInt(rand(50) + str + weaponAttack);
            damage1 *= 5;
            if (damage1 < 100)
            {
                damage1 = 100;
        ...
        else
        {
            ...
            var damage2 : Int = as3hx.Compat.parseInt(rand(50) + str + weaponAttack);
            if (damage2 < 20)
            {
                damage2 = 20;
            }
    ...
    public function doubleAttack() : Void
    {
        if (flags[kFLAGS.FERAL_EXTRAS] == 4)
        {
            outputText(this.capitalA + this.short + " charges at you with their claws ready and sword raised! ");
        }
        else
        {
        ...
        if (player.getEvasionRoll())
        {
            if (flags[kFLAGS.FERAL_EXTRAS] == 4)
            {
                outputText("You manage to dodge their deadly attacks!");
            }
            else
            {
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        if (flags[kFLAGS.FERAL_EXTRAS] == 5)
        {
            floor1.defeatedByFeralImp();
        }
        else if (flags[kFLAGS.FERAL_EXTRAS] == 4)
        {
            SceneLib.impScene.impRapesYou2();
        }
        else
        {
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.LABOVA_, 2).add(consumables.MINOBLO, 1).add(consumables.SUCMILK, 3).add(consumables.INCUBID, 3).add(consumables.IMPFOOD, 4).add(jewelries.POWRRNG, 1);
