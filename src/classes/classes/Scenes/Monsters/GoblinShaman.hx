...
class GoblinShaman extends Goblin
{
    ...
    public function new()
    {
        ...
        if (player.hasCock())
        {
            this.long += "  She's clearly intent on casting you into submission, to forcibly make you impregnate her.";
        }
        ...
        this.drop = new WeightedDrop().add(consumables.GOB_ALE, 5).add(weapons.W_STAFF, 1).add(undergarments.FURLOIN, 1).add(jewelries.MYSTRNG, 1).add(jewelries.LIFERNG, 1).add(consumables.GINSENG, 1).addMany(1, consumables.L_DRAFT, 
                                consumables.PINKDYE, 
                                consumables.BLUEDYE, 
                                consumables.ORANGDY, 
                                consumables.GREEN_D, 
