...
class GoblinAssassin extends Monster
{
    ...
    private function goblinDrugAttack() : Void
    {
        ...
        var multiplier : Float = 1.2 + 0.5 * newGamePlusMod();
    ...
    private function dualShot() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt((str + weaponAttack + 40) - rand(player.tou) - player.armorDef);
    ...
    private function goblinExplosion() : Void
    {
        ...
        var damage : Int = as3hx.Compat.parseInt(25 + rand(75));
    ...
    override public function defeated(hpVictory : Bool) : Void
    {
        ...
        {
            SceneLib.hexindao.gaunletchallange2fight2();
        }
        else
        {
