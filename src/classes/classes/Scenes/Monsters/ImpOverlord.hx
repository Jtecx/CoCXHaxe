...
class ImpOverlord extends Imp
{
    ...
    public function castSpell() : Void
    {
        ...
        {
            var damage : Int = as3hx.Compat.parseInt(inte + rand(50));
    ...
    private function impFire() : Void
    {
        ...
        //[-HP // +Lust(minor)]
        var damage : Int = as3hx.Compat.parseInt(80 + rand(20));
        damage = Math.round(damage);
        player.takeFireDamage(damage, true);
    ...
    private function impLordLustAttack2() : Void
    {
        ...
        var damage : Int = as3hx.Compat.parseInt(12 + rand(25));
    ...
    //Cum cannon!
    private function impLordCumCannon() : Void
    {
    ...
    public function clawAttack() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt(rand(50) + str + weaponAttack);
            if (damage < 20)
            {
                damage = 20;
            }
    ...
    public function doubleAttack() : Void
    {
        ...
        else
        {
            ...
            var damage : Int = as3hx.Compat.parseInt(rand(100) + (str * 1.5) + weaponAttack);
            if (damage < 30)
            {
                damage = 30;
            }  //Min-cap damage.  
    ...
    public function new()
    {
        ...
        this.abilities = [
                ...
                }, 
                {
                    ...
                    type : ABILITY_PHYSICAL,
                    range : RANGE_MELEE,
                    tags : [TAG_WEAPON, TAG_BODY]
                }, 
                {
                    call : impLordLustAttack2,
                    type : ABILITY_TEASE,
                    range : RANGE_MELEE,
                    tags : []
                }, 
                {
                    call : impLordCumCannon,
                    type : ABILITY_TEASE,
                    range : RANGE_RANGED,
                    tags : [TAG_FLUID]
                }, 
