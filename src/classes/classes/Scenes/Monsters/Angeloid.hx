...
class Angeloid extends AbstractAngel
{
    ...
    private function angelification() : Void
    {
        ...
        if (player.statusEffectv1(StatusEffects.AngelsChooser) == 1)
        {
            outputText("Both irises become uniform purple colored. And around it body manifest two crossed circles with pair of eyes looking exactly the same as main eye down to each detail including dual irises.");
        }
        if (player.statusEffectv1(StatusEffects.AngelsChooser) == 2)
        {
            outputText("All irises become uniform purple colored. And around it body manifest three crossed circles with three eyes looking exactly the same as main eye down to each detail including dual irises.");
        }
        if (player.statusEffectv1(StatusEffects.AngelsChooser) == 3)
        {
            outputText("All irises become uniform purple colored. And around it body manifest four crossed circles with two pairs of eyes looking exactly the same as main eye down to each detail including dual irises.");
        }
    ...
    override private function get_long() : String
    {
        ...
        if (player.statusEffectv1(StatusEffects.AngelsChooser) == 1)
        {
            ...
            if (hasStatusEffect(StatusEffects.TrueFormAngel))
            {
                str += " purple irises. Around it body are two circles each with pair of eyes looking the same as the main eye and above head hoover halo.";
            }
            else
            {
                str += " irises, one red and the other blue.";
            }
        }
        if (player.statusEffectv1(StatusEffects.AngelsChooser) == 2)
        {
            ...
            if (hasStatusEffect(StatusEffects.TrueFormAngel))
            {
                str += " purple irises each. Around it body are three circles each with three eyes looking the same as the main eye and above head hoover halo.";
            }
            else
            {
