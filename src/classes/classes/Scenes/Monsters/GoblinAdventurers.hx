...
class GoblinAdventurers extends Monster
{
    override private function outputPlayerDodged(dodge : Int) : Void
    {
        var pRdm : Float = rand(3);
        switch (pRdm)
        {
            case 0:
    ...
    private function goblinDrugAttack() : Void
    {
        ...
        var multiplier : Float = 4 + player.newGamePlusMod() * 0.5;
    ...
    //Lust Needle
    private function lustNeedle() : Void
    {
        outputText("With a swift step, one of adventurers vanishes, her movements too quick for you to follow. You take a sharp breath as you feel her ample thighs clench your head in between them, her slick cunt in full view as you take in her scent.");
    ...
    //Dual Shot
    private function dualShot() : Void
    {
        outputText("Three adventurers throws a syringe onto the ground, shattering it and allowing the dissipating smoke from its contents to distract you long enough for them to slip underneath you or to your sides. With a quick flick of wrists two needles are placed into their hands, though you’ve already caught wind of their movements.");
        ...
        var damage : Int = as3hx.Compat.parseInt(str + weaponAttack + 40);
        damage *= 3;
    ...
    //Explosion
    private function goblinExplosion() : Void
    {
        ...
        var damage : Int = as3hx.Compat.parseInt(50 + rand(50));
        damage *= 5;
    ...
    {
        var actions : Array<Dynamic> = [eAttack, goblinDrugAttack, lustNeedle, dualShot, goblinExplosion];
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.GOB_ALE, 5).add(consumables.PONAILS, 3).addMany(1, consumables.L_DRAFT, 
                        consumables.PINKDYE, 
                        consumables.BLUEDYE, 
                        consumables.ORANGDY, 
                        consumables.PURPDYE, 
