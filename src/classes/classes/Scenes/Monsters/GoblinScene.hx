...
class GoblinScene extends BaseContent
{
    public function new()
    {
        super();
    ...
    private function goblinClass(assassin : String = "assassin", shaman : String = "shaman", warrior : String = "warrior", elder : String = "elder") : String
    //Allows for variants.
    {
        
        return (Std.is(monster, GoblinAssassin) || Std.is(monster, GoblinAdventurers)) ? assassin : (Std.is(monster, GoblinShaman)) ? shaman : (Std.is(monster, GoblinWarrior) || Std.is(monster, GoblinWarriors)) ? warrior : (Std.is(monster, Priscilla)) ? "elder" : assassin;
    }
    ...
    public function gobboSpecialBeatYaUp() : Void
    {
        ...
        if (player.gender == 0)
        {
            if (monster.plural)
            {
                outputText("You collapse in front of the goblins, too wounded to fight. They growl and kick you in the head, making your vision swim. As your sight fades, you hear them murmur, \"<i>Fucking dicks can't even bother to grow a dick or cunt.</i>\"");
            }
            else
            {
        ...
        if (Std.is(monster, GoblinAdventurers))
        {
        ...
        else if (Std.is(monster, GoblinAssassin))
        {
            if (player.lust < player.maxOverLust())
            {
                outputText("You collapse, utterly beaten. To make sure you'll be easier to handle, the victorious assassin saunters up, a pair of fluid filled needles in her hands. She jams them into your [player.legs], emptying the contents into you before you can so much as stammer a protest. Burning lust pours through your veins unbidden, and you moan out loud as the chemicals have their way with you as easily as the goblin soon will.\n\n");
            }
        }
        else if (Std.is(monster, GoblinShaman))
        {
            if (player.lust < player.maxOverLust())
            {
                outputText("You collapse, utterly beaten. To make sure you'll be easier to handle, the victorious " + goblinClass() + " saunters up, pink arousing flames glow in her left hand. She exposes your nether regions and throws the pink flames right into your groin! You are unable to fight back.\n\n");
            }
        }
        else if (Std.is(monster, GoblinWarriors))
        {
            if (player.lust < player.maxOverLust())
            {
        ...
        else if (Std.is(monster, GoblinWarrior))
        {
            if (player.lust < player.maxOverLust())
            {
        ...
        function dickFitF() : Void
        {
            ...
            {
                outputText("that thing");
            }
            else
            {
                outputText("those things");
            }
            ...
            if (player.hasBalls())
            {
                outputText("[sack], giving it a gentle caress before vanishing.");
            }
            else if (player.hasVagina())
            {
                outputText(player.vaginaDescript() + ", the tips giving your soaked mound only the barest ghost of a touch.");
            }
            else
            {
                outputText("taint, the tips giving your sensitive skin only the barest ghost of a touch.");
            }
            ...
            if (player.hasSheath())
            {
                outputText(" the sheath");
            }
            else
            {
                outputText("your base");
            }
            ...
            if (silly())
            {
                outputText("Stop right there, criminal scum.");
            }
            else
            {
                outputText("Hold your horses.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("  A hand squeezes your [sack] encouragingly");
            }
            else
            {
                outputText("  Hands squeeze your [butt] encouragingly");
            }
            ...
            if (player.cumQ() >= 750)
            {
                ...
                if (player.cumQ() >= 2000)
                {
                    outputText("  It swells to a rounded, pregnant dome by the time you finish.");
                }
            }
        ...
        var dickNofitF : Void->Void = function() : Void
        {
            ...
            {
                outputText("  Your incredibly long phallus blocks your view of the sultry goblin, and you never see the blow coming.");
            }
            ...
            if (player.biggestCockLength() < player.tallness / 2)
            {
                outputText("sitting on your face, the " + player.cockHead(x) + " of your maleness jutting against her drooling lips.");
            }
            else
            {
                outputText("sitting on the ground ‘above’ you, your " + player.cockHead(x) + " reaching all the way up to spear her moist box, judging by what you’re feeling anyway.");
            }
            ...
            if (player.cumQ() >= 1000)
            {
                outputText("You spurt huge dollops of pre-cum into her waiting twat thanks to your prodigious virility, though it is only a hint of things to come.  ");
            }
            else if (player.cumQ() >= 250)
            {
                outputText("You drool a steady flow of pre-cum into her waiting twat, though it’s only a hint of things to come.  ");
            }
            ...
            if (player.biggestCockLength() >= player.tallness / 2)
            {
                outputText("pulsating, iron-hard cock");
            }
            else
            {
                outputText("captor’s pillowy asscheeks");
            }
            ...
            {
                outputText("thick wads");
            }
            else if (player.cumQ() <= 1750)
            {
                outputText("waves of gooey spooge");
            }
            else
            {
                outputText("rivers of cum");
            }
            outputText(" into the goblin’s box.");
            if (player.cumQ() >= 2500)
            {
                outputText(" Her belly rounds up nicely under your voluminous attentions.");
            }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            {
                outputText("piston in and out of your [nipple], masturbating it just as hard as the real thing.");
            }
            else
            {
                outputText("squeeze around a taut nipple, twisting and pulling on it unthinkingly.");
            }
    ...
    public function goblinRapesAlraune() : Void
    {
        ...
        if (player.isLiliraune())
        {
            outputText("<i>even for a triple girl party</i>");
        }
        outputText(".\"\n\n" +
                "She reaches into a tiny bulging pouch on her hip and pulls out a ");
        if (player.isLiliraune())
        {
            outputText("triple ended");
        }
        else
        {
            outputText("doubled ended");
        }
    ...
    public function goblinRapesBimbo() : Void
    {
        ...
        if (player.hasFuckableNipples())
        {
            outputText(", fingering your wet nipplecunts and pinching the now-puffy areolas tightly, sending uncontrollable waves of pleasure from your chest to your groin.");
        }
        //-[If not]
        else
        {
            outputText(" and slides her fingers up to your nipples, pinching and twisting them, torturing you with pain and pleasure.");
        }
        outputText("\n\n");
    ...
    public function goblinRapesPlayer() : Void
    {
        ...
        if (player.cockTotal() > 0)
        {
            ...
            if (player.cocks[0].cockLength <= 7)
            {
                outputText("as your bulge begins to press between her soft ass-cheeks");
            }
            else if (player.cocks[0].cockLength <= 14)
            {
                outputText("as your bulge grows upwards between her ass-cheeks and lays against the small of her back");
            }
            else
            {
                outputText("as your bulge grows up her back and creeps towards her shoulders steadily");
            }
            outputText(".  ");
        }
        if (player.hasVagina())
        {
            ...
            {
                outputText("The lips of your sex engorge, becoming almost as puffy as the goblin's.  ");
            }
            else if (player.vaginas[0].vaginalWetness < VaginaClass.WETNESS_DROOLING)
            {
                outputText("Feminine lubricant soaks into the back of your [armor].  ");
            }
            else
            {
                outputText("It rapidly forms into a puddle as your " + vaginaDescript(0) + " does its best to show just how ready you are.  ");
            }
        }
        outputText("Your " + nippleDescript(0) + "s poke upwards, giving the goblin easy targets.  She grabs hold of them ");
        if (player.hasFuckableNipples())
        {
            outputText("slipping her thumbs inside the tender cunts and pinching against them tightly");
        }
        else
        {
            outputText("twisting and tweaking");
        }
        ...
        var dickNofitF : Void->Void = function() : Void
        {
            ...
            if (player.cor > 50)
            {
                outputText("prolong your pleasure");
            }
            else
            {
                outputText("prevent the monstrous girl from getting what she wants");
            }
            ...
            if (player.hasVagina())
            {
                outputText("caressing your " + clitDescript());
            }
            else
            {
                outputText("pressing tightly against your prostate");
            }
            ...
            if (player.cumQ() > 100)
            {
                outputText("  Your loads keep coming, until the jism begins to backwash out of her love tunnel to soak her body and your midsection.");
            }
            if (player.cumQ() >= 250)
            {
                outputText("  Her belly distorts visibly as her uterus is packed full of cum, making her look heavily pregnant already.  She coos in delight at the sight of her swollen abdomen.");
            }
            ...
            if (player.cumQ() < 100)
            {
                outputText("wasn't much, but I'll make do");
            }
            else if (player.cumQ() < 250)
            {
                outputText("should be plenty to make a few new wet-behind-the-ears sluts for you to fuck");
            }
            else
            {
                outputText("was better than I could have dreamed.  I'm going to find you again stud");
            }
            outputText("!</i>\"\n\n");
        ...
        var dickFitF : Void->Void = function() : Void
        {
            ...
            if (player.cor < 50)
            {
                outputText("You shake your head, trying to get away from the sweet-smelling drug, but she tilts it up, pouring most of it into your throat.");
            }
            else
            {
                outputText("You lick your lips and open your mouth, happily taking in the cherry-flavored drug.");
            }
            ...
            if (player.hasBalls())
            {
                outputText("cup your [balls] in one hand, squeezing gently as the drug begins to affect them");
            }
            else
            {
                outputText("squeeze your taint in her hand, giggling as your prostate suddenly begins to swell from the drug");
            }
        ...
        var vagF : Void->Void = function() : Void
        {
            ...
            if (player.cor < 33)
            {
                outputText("You shake your head violently, clearly indicating 'No', but when you open your mouth to vocalize your complaint, your lips are swiftly plugged with bulging sex-toy.");
            }
            else if (player.cor < 66)
            {
                outputText("You open your mouth to stammer out your concerns, but she plugs the hole with the floppy artificial dong, turning your speech into surprised muffles.");
            }
            else
            {
                outputText("You lick your lips coyly then open your mouth into a welcoming 'O'.  The sex-toy slips straight into the hole, muffling the sounds of your happiness with the arrangement.");
            }
            ...
            {
                outputText("gape apart momentarily");
            }
            else
            {
                outputText("gape wider than ever, but only for a moment");
            }
            outputText(".\n\n");
    ...
    public function gobboRapeIntro() : Void
    {
        ...
        else if (Std.is(monster, GoblinShaman) || Std.is(monster, Priscilla))
        {
            if (monster.HP < 1)
            {
    ...
    public function rapeMenu() : Void
    {
        ...
        {
            addButton(7, "Pussies", gobboGetsRapedFem).hint("Get on a girl-on-girl action with the goblin!");
        }
        else
        {
            addButtonDisabled(7, "Pussies", "This scene requires you to have 33+ lust, vagina and have NOT taur or naga body.", "Pussies");
        }
        //Dick stuff:
        ...
        //Corrupt too big scene{
            ...
            //Buttsex toggle
            if (player.cockThatFits(monster.analCapacity()) >= 0 && (player.cor >= 70 - player.corruptionTolerance || player.hasPerk(PerkLib.Sadist)))
            {
                addButton(3, "Dick In Ass", gobboButtSecks).hint("Deny the goblin your baby batter and ram into her butt!");
            }
            else
            {
            ...
            if (flags[kFLAGS.WATERSPORTS_ENABLED] >= 1 && player.cockThatFits(60) >= 0)
            {
                addButton(9, "Facefuck & Piss", facefuckPiss).hint("Facefuck the goblin. And relieve yourself. What's a better way to mark the goblin with your scent too?");
            }
            else
            {
        ...
        {
            addButton(5, "Breastfeed", giveGoblinAMilkMustache).hint("You could give the goblin a taste of your milk. It's only in your desire to breastfeed someone.");
        }
        else
        {
        ...
        if (player.isGoo())
        {
            addButton(11, "Goo In", gooIn).hint("Use your unusual body to get her off.");
        }
        else
        {
        ...
        if (!monster.hasPerk(PerkLib.UniqueNPC))
        
        //no fatalities for Priscilla!{
    ...
    private function gobboButtSecks() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(player.sackDescript());
        }
        else
        {
    ...
    public function gobboGetsRapedFem() : Void
    {
        ...
        if (player.isTaur())
        {
            gobboGetsRapedFemTaur();
        }
        else if (player.isNaga())
        {
            gobboGetsRapedFemNaga();
        }
        else
        {
            gobboGetsRapedFemOther();
        }
    ...
    private function gobboGetsRapedFemNaga() : Void
    {
        ...
        {
            outputText("You bare your fangs at her and the curiosity disappears. She turns to run, but your tail is faster than she is.");
        }
        //[No fangs:
        else
        {
            outputText("You smile at her and the fear disappears. She's still wary though, and you make sure to grab her with your tail before she changes her mind about you.");
        }
        outputText("\n\n");
    ...
    private function gobboGetsRapedFemOther() : Void
    {
        ...
        {
            outputText("grows puffy and moist");
        }
        else if (player.vaginas[0].vaginalWetness < VaginaClass.WETNESS_DROOLING)
        {
            outputText("drips with feminine moisture");
        }
        else if (player.vaginas[0].vaginalWetness < VaginaClass.WETNESS_SLAVERING)
        {
            outputText("slowly begins to soak your thighs");
        }
        else
        {
            outputText("drools with need, puddling under you");
        }
        ...
        {
            outputText("splattering her with your fluids");
        }
        else if (player.vaginas[0].vaginalWetness > VaginaClass.WETNESS_SLICK)
        {
            outputText("coating her face with the proof of your pleasure");
        }
        else if (player.vaginas[0].vaginalWetness > VaginaClass.WETNESS_WET)
        {
            outputText("leaving her sticky with your nether-juices");
        }
        else
        {
            outputText("leaving the taste of pussy on her tongue");
        }
        outputText(".  ");
        if (player.biggestLactation() >= 3.5)
        {
            outputText("Milk explodes from your nipples, soaking the petite slut.  ");
        }
        else if (player.biggestLactation() > 2)
        {
            outputText("Twin streams of milk soak the slut's hair, running down her face like white tears.  ");
        }
        else if (player.biggestLactation() >= 1)
        {
            outputText("Milk dribbles from your nipples, falling into the little slut's hair.  ");
        }
        ...
        if (player.cor < 50)
        {
            outputText("a bit guilty about overdoing it.");
        }
        else
        {
            outputText("thoroughly satisfied with your revenge.");
        }
    }
    ...
    private function rapeAGoblinCorruptTooBig() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText("one of your " + player.multiCockDescriptLight() + " comes to rest on top of her and the fact that it's ");
        }
        else
        {
            outputText("your " + player.cockDescript(x) + " comes to rest on top of her and the fact that it's ");
        }
        if (player.cocks[0].cockLength < 20)
        {
            outputText("about as long as her entire torso");
        }
        else
        {
            outputText("bigger than she is");
        }
        ...
        if (player.cocks[0].cockLength < 20)
        {
            outputText("can feel the massive bulge in her midsection");
        }
        else
        {
            outputText("stretch her so much that you can see the bulge even from this angle");
        }
        ...
        if (player.biggestTitSize() >= 1)
        {
            ...
            if (player.biggestLactation() >= 1)
            {
                ...
                {
                    outputText("occasionally drip milky tears onto her face");
                }
                if (player.biggestLactation() < 3)
                {
                    outputText("weep streams of milk onto her features");
                }
                else
                {
                    outputText("plaster her with gouts of fluid");
                }
            }
        }
        ...
        if (player.hasVagina())
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText("and the rest of your " + player.multiCockDescriptLight() + " drench her, ");
            }
        }
        else if (player.cockTotal() > 1)
        {
            ...
            {
                outputText(" drench her, ");
            }
            else
            {
                outputText(" drenches her, ");
            }
        }
        outputText("the bitch is too tight! Like a natural cock-ring! ");
        if (player.balls >= 2)
        {
            outputText("Your " + player.ballsDescriptLight() + " are trying but, h");
        }
        else
        {
            outputText("H");
        ...
        if (player.cockTotal() > 2)
        {
            outputText("Your remaining " + player.multiCockDescriptLight() + " blast geysers into the air, coating you both in your spunk. ");
        }
        if (player.cockTotal() == 2)
        {
            outputText("Your remaining penis blasts geysers into the air, coating you both with spunk. ");
        }
    ...
    private function manRapesGoblinTooBig() : Void
    {
        ...
        if (player.cor < 50)
        {
            outputText("shrug and guess you may as well try since she's ready");
        }
        else
        {
            outputText("grin, happy to try and stretch her around yourself");
        }
        outputText(".  The ");
        if (player.cocks[0].cockType == CockTypesEnum.HORSE)
        {
        ...
        if (player.hasKnot(0))
        {
            outputText(" hooking the heels of her feet just behind your knot");
        }
        outputText(".\n\n");
        ...
        if (player.cumQ() < 75)
        {
            outputText("splattering her a few more times with potent seed.  ");
        }
        else if (player.cumQ() < 250)
        {
            outputText("painting her with a thick layer of seed.  ");
        }
        else
        {
            outputText("soaking her and leaving her in a thick puddle of seed. ");
        }
    ...
    private function gobboGetsRapedMaleFits() : Void
    {
        ...
        if (player.cockArea(x) > monster.vaginalCapacity() * .8)
        {
            ...
            {
                outputText(", rubbing painfully against your demonic nubs");
            }
            else if (player.cocks[0].cockType == CockTypesEnum.HORSE)
            {
                outputText(", feeling painfully tight around you");
            }
            else if (player.hasKnot(0))
            {
                outputText(", stretching painfully around your knot");
            }
            ...
            if (player.biggestTitSize() >= 1)
            {
                outputText(player.allBreastsDescript());
            }
            else
            {
                outputText("torso");
        ...
        else
        {
            ...
            if (player.cocks[0].cockType == CockTypesEnum.DEMON)
            {
                outputText(", rubbing perfectly against your demonic nubs");
            }
            else if (player.cocks[0].cockType == CockTypesEnum.HORSE)
            {
                outputText(", feeling absolutely perfect around you");
            }
            else if (player.hasKnot(0))
            {
                outputText(", stretching tightly around your knot");
            }
        ...
        if (player.hasBalls())
        {
            outputText("Your " + player.ballsDescriptLight() + " tighten, releasing the seed of your orgasm.  ");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText("  The orgasm is so potent that by the time you wind down, she looks heavily pregnant and your cum squirts out of any gap it can find between her walls and your " + player.cockDescript(x) + ".");
        }
        outputText("\n\n");
        ...
        if (player.cumQ() >= 250)
        {
            outputText("pours out in a river");
        }
        else
        {
            outputText("leaks");
        ...
        if (player.cor > 50)
        {
            outputText("Chuckling");
        }
        else
        {
            outputText("Shuddering");
        }
    ...
    private function goblinCondomed(mode : Float = 0) : Void
    {
        var x : Float = player.cockThatFits(monster.vaginalCapacity());
        clearOutput();
        ...
        if (player.hasBalls())
        {
            outputText("your throbbing sack");
        }
        else
        {
    ...
    private function gatsGoblinBoners() : Void
    {
        ...
        if (player.cockTotal() == 1)
        {
            outputText("your dick inside the panting whore, pushing her forwards violently as you enter her tight snatch");
        }
        else if (player.cockTotal() == 2)
        {
            outputText("both of your dicks inside the panting whore, pushing her forwards violently as you enter her tight snatch and asshole");
        }
        else
        {
    ...
    private function laySomeDriderEggsInGobboTwat() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("our [vagina] clenching in time with hers as your copious fluids drench your spider half.");
        }
    ...
    public function facefuckPiss() : Void
    {
        ...
        {
            outputText(" Attempting to keep the voracious pace of your thrusting, you readjust your footing. In doing so, you raise up the goblin girl until her feet are off the ground entirely, her bodly limply swinging back and forth in the air by your knees as she half-consciously receives your abuse.");
        }
    ...
    private function mindbreakGoblin() : Void
    {
        ...
        if (silly())
        {
            outputText("<b>ASSUMING DIRECT CONTROL</b>\n\n");
        }
        ...
        if (Mindbreaker.MindBreakerConvert >= Mindbreaker.MindBreakerConvertGoal)
        {
            SceneLib.mindbreaker.MindbreakerBrainEvolution();
        }
        else
        {
