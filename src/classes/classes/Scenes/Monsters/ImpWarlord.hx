...
class ImpWarlord extends Imp
{
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.MINOBLO, 2).add(consumables.LABOVA_, 2).add(consumables.INCUBID, 12).add(consumables.SUCMILK, 12).add(jewelries.POWRRNG, 1);
