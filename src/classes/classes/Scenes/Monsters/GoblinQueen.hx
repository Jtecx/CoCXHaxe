...
class GoblinQueen extends Goblin
{
    ...
    public function new()
    {
        ...
        this.drop = new WeightedDrop().add(consumables.GOB_ALE, 5).add(weapons.W_STAFF, 1).add(jewelries.MYSTRNG, 1).addMany(1, consumables.L_DRAFT, 
                        consumables.PINKDYE, 
                        consumables.BLUEDYE, 
                        consumables.ORANGDY, 
                        consumables.GREEN_D, 
