 ...
 */
class MimicScene extends BaseContent
{
    ...
    public function mimicTentacleStart(loc : Int = 0) : Void
    {
        ...
        if (loc == 1)
        {
            outputText("The wind howls through the tall pillars of rock that thrust out of the sand on both sides ");
        }
        else if (loc == 2)
        {
            outputText("Thunder rumbles overhead ");
        }
        else if (loc == 3)
        {
            outputText("The peaceful sounds of nature are everywhere ");
        }
        ...
        {
            outputText("a huge block of grey stone covered in bizarre runes and symbols ");
        }
        else if (mimicAppearance == 2)
        {
            outputText("what can only be described as an enormous, disembodied… boob ");
        }
        else if (mimicAppearance == 3)
        {
            outputText("what is unmistakably an enormous, flaccid penis, complete with gigantic balls, ");
        }
        else
        {
            outputText("a large wooden box with a hinged lid and tarnished brass fittings ");
        }
        ...
        if (rand(18) + (player.inte / 2) < 15)
        {
            ...
            if (mimicAppearance == 1)
            {
                outputText("a magic rock");
            }
            else if (mimicAppearance == 2)
            {
                outputText("a giant boob");
            }
            else if (mimicAppearance == 3)
            {
                outputText("a huge penis");
            }
            else
            {
                outputText("what is clearly a treasure chest");
            }
        ...
        else
        {
            if (mimicAppearance == 1)
            {
                outputText("While a magic rock ");
            }
            else if (mimicAppearance == 2)
            {
                outputText("While a giant boob ");
            }
            else if (mimicAppearance == 3)
            {
                outputText("While a huge penis ");
            }
            else
            {
                outputText("While what is clearly a treasure chest ");
            }
            ...
            doYesNo(mimicTentacle1, explorer.done);
        }
    }
    ...
    public function mimicTentacle1() : Void
    {
        ...
        //another d100 roll + inte/3 vs only 50 this time{
            ...
            //find a cool item!{
                ...
                if (itemRoll == 0)
                {
                    outputText("glinting silver vial ");
                }
                if (itemRoll == 1)
                {
                    outputText("small sack ");
                }
                if (itemRoll == 2)
                {
                    outputText("large glass bottle ");
                }
                if (itemRoll == 3)
                {
                    outputText("small clay jar ");
                }
                outputText("in a pile of rubbish off to one side of the alcove. What will you do?");
                menu();
                addButton(0, "TakeCareful", takeCareful, itemRoll);
                addButton(1, "Attack it!", attackIt);
            }
            //you just escape, no fancy item!
            else
            {
                ...
                menu();
                addButton(0, "Fight", function() : Dynamic
                        {
        ...
        else
        {
            ...
            if (mimicAppearance == 1)
            {
                outputText("stone's surface! ");
            }
            else if (mimicAppearance == 2)
            {
                outputText("enormous boob's skin! ");
            }
            else if (mimicAppearance == 3)
            {
                outputText("enormous cock's skin! ");
            }
            else
            {
                outputText("box's surface! ");
            }
    ...
    public function takeCareful(itemRoll : Int) : Void
    {
        outputText(" Careful not to disturb the... whatever it is, you grab the ");
        if (itemRoll == 0)
        {
            outputText("vial ");
        }
        ...
        if (itemRoll == 0)
        {
            inventory.takeItem(consumables.PPHILTR, explorer.done);
        }  //find purity philter  
        if (itemRoll == 1)
        {
            findSomeGems();
        ...
        if (itemRoll == 2)
        {
            inventory.takeItem(consumables.NUMBOIL, explorer.done);
        }  //find numbing oil  
        if (itemRoll == 3)
        {
            inventory.takeItem(consumables.HUMMUS_, explorer.done);
        }
    }
    ...
    public function mimicTentacle2() : Void
    {
        ...
        if (player.gender == 0)
        {
            ...
            */
            ...
            if (player.hasFuckableNipples())
            {
                ...
                if (player.breastRows[0].lactationMultiplier > 0)
                {
                    outputText("milky ");
                }
                ...
                if (mimicAppearance == 2 || mimicAppearance == 3)
                {
                    outputText("long, whippy tongues ");
                }
                else
                {
                    outputText("gigantic tongue");
                }
                outputText("to slurp at this new bounty.\n\nYour mind reels as ");
                //what kind of tongue? box or rock = huge, boob/dick = whippy
                if (mimicAppearance == 2 || mimicAppearance == 3)
                {
                    outputText("the seemingly uncountable number of tongues and tendrils slurp, stroke, and suck at your breasts. ");
                }
                else
                {
                    ...
                    {
                        outputText(player.totalBreasts() + " ");
                    }
                ...
                if (mimicAppearance == 2 || mimicAppearance == 3)
                {
                    outputText("what must be two dozen of its wriggling tongues deep into each of your tortured nippples, exploring every nook and crevice");
                }
                else
                {
                    outputText("its huge tongue deep into each of your tortured nipples one by one");
                }
            ...
            if (  /*!player.breastRows[0].nippleCocks && */  !player.hasFuckableNipples())
            {
                if (mimicAppearance == 2 || mimicAppearance == 3)
                {
                    outputText("and its eyes narrow, giving it a singularly furious expression. ");
                }
                else
                {
                    outputText("and the tentacles holding you seem to quiver with a palpable fury. ");
                }
        ...
        if (player.gender == 1)
        {
            ...
            {
                outputText(player.cockDescript() + " is ");
            }
            else
            {
                outputText(player.multiCockDescript() + " are ");
            }
            ...
            if (mimicAppearance == 2 || mimicAppearance == 3)
            {
                ...
                if (player.cockTotal() == 1)
                {
                    outputText(" as you attempt to pull it free. ");
                }
                else
                {
                    outputText("s as you attempt to pull them free. ");
                }
            }
            else
            {
                ...
                if (player.cockTotal() == 1)
                {
                    outputText("your " + player.cockDescript() + ". ");
                }
                else
                {
                    outputText("all of your cocks at once. ");
                }
            }
            ...
            */
            ...
            /*if (player.breastRows[0].nippleCocks) outputText("creature's mouths begin ");
                ...
                outputText("creature's mouth begins ");
            }
            ...
            else
            {
                ...
                outputText("mouth-tentacle begins ");
            }
            outputText("to suck and massage your cock");
            if (player.cockTotal() >1  /*|| player.breastRows[0].nippleCocks*/  )
            {
                outputText("s");
            }
        ...
        if (player.gender == 2)
        {
            ...
            if (mimicAppearance == 2 || mimicAppearance == 3)
            {
                outputText("thin, whippy tongues run");
            }
            else
            {
                outputText("huge tongue runs");
            }
            ...
            if (player.hasFuckableNipples())
            {
                ...
                if (mimicAppearance == 2 || mimicAppearance == 3)
                {
                    outputText("cluster of newly sprouted tongues ");
                }
                else
                {
                    outputText("seemingly <i>even larger</i> tongue ");
                }
                outputText("to slurp at this new bounty. ");
            }
            //back to the main action!
            ...
            else
            {
                ...
                {
                    outputText("all of your " + player.vaginaDescript() + "s");
                }
                outputText(" and ");
                if (player.totalBreasts() > 2)
                {
            ...
            if (mimicAppearance == 2 || mimicAppearance == 3)
            {
                ...
                {
                    outputText("each of your " + player.vaginaDescript() + "s");
                }
            ...
            else
            {
                ...
                {
                    outputText("each of your " + player.vaginaDescript() + "s one by one");
                }
            }
            outputText(", your reaction is only a weak moan. ");
            if (player.hasFuckableNipples())
            {
                outputText("Your moan drags out a bit longer as your poor nipples receive the same treatment. ");
            }
            outputText("As the thing continues to alternate between scouring your body for any last traces of nectar and attempting to coax you to further orgasm, you eventually slip into unconsciousness. ");
            //if you didnt get swallowed earlier, get swallowed now
            if (mimicAppearance == 2 || mimicAppearance == 3)
        ...
        if (player.gender == 3)
        {
            ...
            if (player.cockTotal() == 1)
            {
                outputText(player.cockDescript() + " rapidly becomes ");
            }
            else
            {
                outputText(player.multiCockDescript() + " rapidly become ");
            }
            ...
            //describe nipplecunts based on vag looseness{
                ...
                if (player.vaginas[0].vaginalLooseness < 2)
                {
                    outputText("the small openings ");
                }
                if (player.vaginas[0].vaginalLooseness >= 2 && player.vaginas[0].vaginalLooseness < 4)
                {
                    outputText("the puckered openings ");
                }
                if (player.vaginas[0].vaginalLooseness >= 4)
                {
                    outputText("the engorged lips ");
                }
                outputText("on your nipples to ease open and begin ");
                //wetness + milkyness :P
                if (player.vaginas[0].vaginalWetness < 2)
            ...
            */
            ...
            else
            {
                ...
                if (player.cockTotal() == 1 && !player.hasSheath())
                {
                    outputText("cock, ");
                }
                else if (!player.hasSheath())
                {
                    outputText("bundle of cocks, ");
                }
                else
                {
                    outputText("sheath, ");
    ...
    public function mimicTentacleEnd() : Void
    {
        ...
        if (player.hasVagina())
        {
            ...
            else if (rand(5) > player.vaginas[0].vaginalLooseness)
            {
    ...
    {
        var quantity : Int = as3hx.Compat.parseInt((rand(30) + 10 + player.level) * (1 + (player.perkv1(PerkLib.AscensionFortune) * 0.1)));
