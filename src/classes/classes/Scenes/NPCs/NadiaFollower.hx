...
class NadiaFollower extends NPCAwareContent implements TimeAwareInterface implements SaveableState
{
    ...
    //Get out if already pregged.
    {
        ...
        var score : Float = Math.min(player.cumQ() / 100, 75);
...
*/
    ...
    public static var NadiaSonsNum : Float;
    public static var NadiaDaughtersNum : Float;
    public static var NadiaHermKidsNum : Float;
    public static var NadiaTotalKidsNum : Float;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            NadiaSonsNum = Reflect.field(o, "NadiaSonsNum");
            NadiaDaughtersNum = Reflect.field(o, "NadiaDaughtersNum");
            NadiaHermKidsNum = Reflect.field(o, "NadiaHermKidsNum");
            NadiaTotalKidsNum = Reflect.field(o, "NadiaTotalKidsNum");
        }
    ...
    public function repeatEnc() : Void
    {
        ...
        else if (flags[kFLAGS.NADIA_LVL_UP] >= 2)
        {
            outputText("a unicorn");
        }
        else
        {
            outputText("a white furred horse morph");
        }
    ...
    public function wonOverNadia() : Void
    {
        ...
        if (mocking)
        {
            outputText("Getting your idea, Nadia winks to you and");
        }
        else
        {
            outputText("The horse morph");
        }
        outputText(" kneels down defeated. Seems you can do whatever you want with her now. So, what will it be?\n\n");
        menu();
        addButton(1, "Rape", wonOverNadiaSex).disableIf(player.lust < 33, "Not aroused enough.");
    ...
    public function wonOverNadiaOralF() : Void
    {
        ...
        if (player.isBiped())
        {
            ...
            {
                outputText(", hungrily licking her lips");
            }
            else
            {
        ...
        if (player.isTaur())
        {
            ...
            if (player.tailCount > 0)
            {
                outputText(" behind your [tail]");
            }
        ...
        if (player.isNaga() || player.isScylla())
        {
            ...
            if (player.isNaga())
            {
                outputText("naga tail");
            }
            else
            {
                outputText("scylla tentacles");
            }
        ...
        else
        {
            ...
            if (player.isBiped())
            {
                outputText("start cruelly twisting her mane, making her whimper in pain, telling her you won’t stop until she starts to see");
            }
            if (player.isTaur())
            {
                outputText("start sitting harder on her, painfully squishing her face and making it nearly impossible to breathe. She begins to panic, struggling uselessly, but you tell her you won’t stop until she sees");
            }
            if (player.isNaga() || player.isScylla())
            {
        ...
        if (player.isBiped() || player.isTaur())
        {
            ...
            if (flags[kFLAGS.NADIA_FOLLOWER] >= 2)
            {
                outputText(", which she eagerly licks off her face");
            }
    ...
    public function wonOverNadiaOralM(mockForce : Int = 0) : Void
    {
        ...
        var likesIt : Bool = (mocking) ? mockForce == 1 : flags[kFLAGS.NADIA_FOLLOWER] >= 2;
        if (player.isBiped())
        {
            ...
            if (player.hasVagina() && flags[kFLAGS.NADIA_FOLLOWER] == 0)
            {
                outputText(" Shocking the equine to find out you're actually a hermaphrodite.");
            }
            if (likesIt)
            {
                outputText(" The equine licks her lips eagerly at the sight of your [cockplural].");
            }
            outputText("\n\nYou step over her, standing above her torso while she watches you with ");
            if (flags[kFLAGS.NADIA_FOLLOWER] == 0)
            {
                outputText("nervous anticipation, unsure what you’re doing.");
            }
            else if (flags[kFLAGS.NADIA_FOLLOWER] == 1)
            {
                outputText("dreaded anticipation, knowing what is coming next.");
            }
            else
            {
                outputText("eager anticipation, looking at you with a come hither look.");
            }
            outputText("\n\nSmirking, you grab hold of your already hardening [cock biggest] ");
            if (player.cockTotal() > 1)
            {
                outputText("from your bunch of [cocks]");
            }
            outputText(", before reaching down and yanking her head up by her mane. Making her ");
            if (likesIt)
            {
                outputText("squeal happily, already eager to suck your cock");
            }
            else
            {
                outputText("whimper in pain");
            }
        ...
        if (player.isTaur())
        {
            ...
            if (likesIt)
            {
                outputText("the equine happily letting herself get manhandled while you prop her against a " + object() + "");
            }
            else
            {
                outputText("the equine putting up a brief struggle before giving up and letting herself be propped against the " + object() + "");
            }
        ...
        if (likesIt)
        {
            ...
            {
                outputText("she happily takes every inch of your massive member as you force it into her mouth, stopping short of deepthroating her. She doesn’t even care that her mouth is being uncomfortable stretched, she just wants the rest of your cock");
            }
            else if (player.cocks[x].cockLength >= 9)
            {
                outputText("she happily takes every inch of your large member as you force it into her mouth, stopping short of deepthroating her. She looks hungrily at the rest of your dick she has yet to take");
            }
            else if (player.cocks[x].cockLength >= 5)
            {
                outputText("she happily takes all of the cock you push into her mouth, which is nearly your entire length until her mouth is full of cock");
            }
            else
            {
                outputText("she happily takes your small member into her mouth");
            }
            ...
            {
                outputText("She reaches out and grabs hold of two more of your dicks, enthusiastically jerking them off. ");
            }
            else if (player.cockTotal() >= 1)
            {
                outputText("She reaches out and grabs hold of your other cock, enthusiastically jerking it off while her other hand buries itself into her own sex, pleasuring herself. ");
            }
            else
            {
                outputText("She buries one of her hands into her sex, while the other plays with her breasts, trying to pleasure herself while she enthusiastically blows you. ");
            }
            if (player.cocks[x].cockLength >= 15)
            {
                outputText("Smirking, you start pushing the rest of your massive cock into her mouth, making her moan loudly as her throat is stuffed with your cock, her neck bulging with its shape as it slips down her throat and into her stomach, both of you reveling in the pleasure, her eyes rolling back into her head in total bliss while her hands continue to work");
            }
            else if (player.cocks[x].cockLength >= 9)
            {
                outputText("Smirking, you push the rest of your large cock into her mouth, which she eagerly accepts it, trying to move her head forward to take it in quicker. You start deepthroating her, enjoying the feeling of your length sinking in and out of her throat while she moans like a whore");
            }
            else if (player.cocks[x].cockLength >= 5)
            {
                outputText("Smirking, you push the rest of your cock into the eager equine mouth, making her moan happily as the head of your cock slips into her throat. You start throat fucking her, letting your cock ravage the tip of her throat while you both enjoy the feeling, the equine moaning with every thrust");
            }
            else
            {
                outputText("As you thrust your hips, you tell her to pleasure you more, which she does, sucking as hard as she can while her tongue licks everything it can reach, savoring the taste of your dick");
            }
        }
        else
        {
            ...
            if (flags[kFLAGS.NADIA_FOLLOWER] == 0)
            {
                outputText("disgusted by the thought of serving you, ");
            }
            else
            {
                outputText("not wanting to serve you again, ");
            }
            outputText(" keeping her mouth shut tight. ");
            if (player.isBiped())
            {
                outputText("Irritated, you twist her mane, causing her to whimper in pain. She keeps her lips closed, and you pull again, harder. She looks up at you, fear and anger in her gaze, but gives in and parts her lips.");
            }
            if (player.isTaur())
            {
                outputText("Irritated, you whack her head with one of your hind [feet]. She yelps in pain, but stubbornly keeps her mouth closed. You strike her again, then a third time. until she gives in and opens her mouth.");
            }
            if (player.isNaga() || player.isScylla())
            {
            ...
            if (player.cocks[x].cockLength >= 15)
            {
                outputText("forcing your massive dick into her mouth, only stopping short of deepthroating her, her mouth being forced nearly painfully wide to hold your massive girth, while her eyes look fearfully at how much is left to go");
            }
            else if (player.cocks[x].cockLength >= 9)
            {
                outputText("forcing your large member into her mouth, stopping short of deepthroating her. She casts a worried gaze at how much of your dick is left out of her mouth");
            }
            else if (player.cocks[x].cockLength >= 5)
            {
                outputText("making her take your near entire length until her mouth is full of your cock");
            }
            else
            {
                outputText("her mouth easily taking your small member");
            }
            ...
            if (player.cocks[x].cockLength >= 15)
            {
                outputText("Smirking, you start forcing your entire length in, making her eyes bulge and water as your massive member pushes its way into her throat and all the way down into her stomach, her neck bulging with the shape of your cock. You start thrusting your hips again, fucking her entire throat and stomach while enjoying every second of it, her watering eyes rolling back as her hands fall limply to her side, unable to bear it all");
            }
            else if (player.cocks[x].cockLength >= 9)
            {
                outputText("Smirking, you start pushing your entire length in, her eyes widening as your cock slips down her throat, not giving her enough time to gag. You begin deepthroating her, letting your length rape nearly her entire throat, while you enjoy the feeling of her throat as she moans and whimpers");
            }
            else if (player.cocks[x].cockLength >= 5)
            {
                outputText("Smirking, you start pushing the rest of your cock into her mouth, her eyes widen as your cock slips into her throat nearly causing her gag. You begin throat fucking her, letting your cock ravage the top of her throat while you enjoy the feeling of her tight neck around your cock head, as she lets out loud muffled moans");
            }
            else
            {
                outputText("While you thrust your hips you order her to suck on your dick, which she does, sucking as hard as she can while you thrust into her mouth, enjoying the feeling");
            }
        }
        ...
        if (likesIt && player.cockTotal() > 1)
        {
            outputText(" Seeing you’re about to cum, she points your other [dickplural] at her, so you’ll cum on her.");
        }
        outputText("\n\n");
        if (likesIt)
        {
            if (player.cumQ() >= 2000)
            {
                if (player.cocks[x].cockLength >= 15)
                {
                    outputText("You make sure she is taking your entire length before you cum, spraying your massive load directly into her stomach with such force that her stomach bulges, making it swell and bloat with yor cum. She moans happily as her belly swells until she looks pregnant, her face totally blissed out");
                }
                else if (player.cocks[x].cockLength >= 5)
                {
                    outputText("You make sure she is taking your entire length before you cum, spraying your massive load right down her throat. She moans happily as her belly visibly swells with your cum, bloating her until she looks pregnant. her eyes roll back into her head, her horse-face totally blissed out");
                }
                else
                {
                    outputText("You hold your hips against her face as you cum, spraying your massive load inside her mouth making her cheeks bulge with your cum, she does her best to swallow as fast as she can but your load is too large and thick, and it starts squirting out of her nose and mouth, her face totally blissed out");
                }
                if (player.cockTotal() > 1)
                {
                    outputText(" while your other [cockplural] covers her naked body in cum");
                }
                outputText(".");
            }
            else
            {
                if (player.cocks[x].cockLength >= 15)
                {
                    outputText("You grab the back of her head, slamming her face into your hips. You sink balls-deep into her throat before you cum, spraying your load directly into her stomach");
                }
                else if (player.cocks[x].cockLength >= 5)
                {
                    outputText("You grab the back of her head, slamming her face into your hips. You sink balls-deep into her throat before you cum, spraying your load right down her throat");
                }
                else
                {
                    outputText("You force your hips against her face as you cum, spraying your load inside her mouth, making sure she swallows it");
                }
                if (player.cockTotal() > 1)
                {
                    outputText(" while your other [cockplural] spray its load all over her face and body");
                }
                outputText(".");
            }
            ...
            if (player.cumQ() >= 2000)
            {
                outputText(" She staggers away, walk slightly troubled by how bloated her belly is.");
            }
        }
        else
        {
            if (player.cumQ() >= 2000)
            {
                if (player.cocks[x].cockLength >= 15)
                {
                    outputText("You make sure she is taking your entire length before you cum, spraying your massive load directly into her stomach with such force that her stomach bulges, before making it swell and bloat with you cum. Her eyes widen and water as her belly is swelled until she looks pregnant.");
                }
                else if (player.cocks[x].cockLength >= 5)
                {
                    outputText("You make sure she is taking your entire length before you cum, spraying your massive load right down her throat, her eyes widen and water as her belly visibly swells with your cum, bloating her until she looks pregnant.");
                }
                else
                {
            ...
            {
                outputText("You make sure she is taking your entire length before you cum, spraying your load directly into her stomach.");
            }
            else if (player.cocks[x].cockLength >= 5)
            {
                outputText("You make sure she is taking your entire length before you cum, spraying your load right down her throat.");
            }
            else
            {
                outputText("You force your hips against her face as you cum, spraying your load inside her mouth, making sure she swallows it.");
            ...
            {
                outputText("releasing her from your grip before ");
            }
            outputText("letting her sink to the ground where she sits panting with her belly ");
            if (player.cumQ() >= 2000)
            {
                outputText("bloated with your cum");
            }
            else
            {
                outputText("full of your cum");
            }
    ...
    private function virginity() : Bool
    {
    ...
    public function wonOverNadiaRape() : Void
    {
        ...
        if (player.isScylla())
        {
            ...
            if (virginity())
            {
                outputText("Adjusting her body you thrust your cock into her, making her whimper as your cock rips apart her hymen, taking her virginity.\n\n");
            }
            else
            {
                outputText("Adjusting her body you thrust your cock into her, making her moan as her pussy is once again filled with your cock.\n\n");
            }
    ...
    public function mainCampMenu() : Void
    {
        ...
        //1 - Talk
        addButton(2, "Spar", nadiaSparsWithPC).hint("Ask Nadia for a mock battle.").disableIf(flags[kFLAGS.CAMP_UPGRADES_SPARING_RING] < 2, "You need a good sparring ring for that.");
        if (sceneHunter.mockFights)
        {
            addButton(3, "Mock Fight", mockFightDiana).hint("Spice things up a little - make her fight for her pussy!").disableIf(player.isGenderless(), "Not for genderless!");
        }
        //3 - ??
        if (player.lust > 33)
        {
        ...
        {
            addButtonDisabled(4, "Sex", "Req. 33+ lust");
        }
        if (player.HP < player.maxOverHP())
        {
            addButton(5, "Healing", HealingScene);
        }
        else
        {
            addButtonDisabled(5, "Healing", "You're fully healed already.");
        }
        ...
        {
            addButton(9, "Uncurse", uncurseItemsMenu2);
        }
        if (BelisaFollower.BelisaQuestOn && !BelisaFollower.BelisaQuestComp)
        {
            addButton(13, "ToothacheQ", BelisaNadiaTalk);
        }
    ...
    public function CuringCurseScene1() : Void
    //value related curses removal
    {
    ...
    public function CuringCurseScene2() : Void
    //bonus multi related curses removal
    {
    ...
    public function mainSexMenu() : Void
    {
        ...
        //addButton(0, "Breeding", SexMenuBreeding);{
            ...
            {
                addButton(1, "Vaginal", SexMenuVaginal);
            }
            else
            {
                addButtonDisabled(1, "Vaginal", "You're Too Big!");
            }
            if (player.cockThatFits(36, "length") >= 0)
            {
                addButton(2, "Anal", SexMenuAnal);
            }
            else
            {
                addButtonDisabled(2, "Anal", "You're Too Big!");
            }
            if (player.cockThatFits(36, "length") >= 0 || player.findCockWithType(CockTypesEnum.TENTACLE, 1, -1, -1))
            {
                addButton(3, "Titfuck", SexMenuTitsfuck);
            }
            else
            {
                addButtonDisabled(3, "Titfuck", "You're Too Big!");
            }
        }
...
*/
    ...
    public function SexMenuTitsfuck() : Void
    {
        ...
        if (tentacock >= 0)
        {
            outputText("Nadia gets on her knees, while your vine cocks move out around her, the largest one moves in front of her.\n\n");
        }
        else
        {
            ...
            if (player.isNaga())
            {
                outputText("from your protective snake slit");
            }
            if (player.isScylla())
            {
                outputText("out of from between your tentacles");
            }
            outputText(".\n\n");
        }
        ...
        if (tentacock >= 0)
        {
            outputText("Nadia moves forward slightly, allowing the " + ((player.cocks[x].cockLength >= 25) ? "monsterous" : "large") + " vine to sink between her mounds, your cock like vine’s lower shaft disappearing among the soft flesh.\n\n");
        }
        else
        {
            outputText("Nadia then presses her big breasts against your stomach, your [cock biggest] cock shaft slipping between her cleavage. You can’t help but out a little grunt of pleasure at the feelings of her soft flesh on your [skin].\n\n");
        }
        ...
        {
            outputText("which most of the monstrous length is laying across her head, making her shower the titanous member with her devotion in kisses and licks");
        }
        else if (player.cocks[x].cockLength >= 15)
        {
            outputText("which half is right in front of her face, so she gives a loving kiss");
        }
        else
        {
            outputText("which is sticking out of the middle of her cleavage");
        }
    ...
    public function NadiaPregAnnouncement() : Void
    {
        ...
        outputText("\"<i>I’m pregnant</i>\", she says simply, cheeks red, and a huge grin on her face. \"<i>You’re going to be a father, [Player].</i>\" She puts a hand on her stomach.  \n\n");
    ...
    public function NadiaGivesBirth() : Void
    {
        ...
        outputText("\"<i>O-oh, [Player]!</i>\" Nadia cries, reaching a hand out to you. You run over, catching her before she loses her balance entirely. \"<i>T-the baby’s coming!</i>\"  \n\n");
