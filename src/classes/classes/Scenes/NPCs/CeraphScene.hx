...
class CeraphScene extends NPCAwareContent
{
    //VARS
    //  ZETSUKO_MET:int = 406;
    ...
    private function maleFuckCeraphsPussy() : Void
    {
        ...
        function fitF() : Void
        {
            ...
            if (player.cor < 33)
            {
                outputText("Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to rape a sex-demon.");
            }
            else if (player.cor < 66)
            {
                outputText("Her words confuse you.  You never would've done this when you first came here, but you're horny and you know demons don't really mind.");
            }
            else
            {
                outputText("Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.");
            }
            ...
            {
                outputText("and with a mighty effort, you force your over-sized cock inside her.  For a moment all you can do is stare in awe as it distorts her body – the fact that such a thing is possible puzzles you");
            }
            ...
            {
                outputText("  Her belly begins to rise with the volume of cum she's absorbed, and you finish your orgasm with a mildly pregnant demon underneath you.");
            }
            else if (player.cumQ() >= 1000)
            {
                outputText("  Her belly rises quickly from the volume of cum you're pumping into her, swelling up until she looks ready to give birth, but her taut purple body seems to handle the strain quite well, save for her belly-button turning into an outtie with an abrupt 'pop'.");
            }
            ...
            if (player.cor < 33)
            {
                outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n");
            }
            else if (player.cor < 66)
            {
                outputText("You groan, wondering why she just won't get over her little act.  Even though this wasn't your best idea, it isn't nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n");
            }
            else
            {
                outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit him on my cock first chance I get, dear.</i>\"\n\n");
            }
        ...
        var nofitF : Void->Void = function() : Void
        {
            ...
            {
                outputText("Your [cockhead] crests between her breasts with every stroke, bumping against her chin.  It grows larger as the pleasure of the act intensifies to orgasmic levels.\n\n");
            }
            else if (player.cocks[x].cockLength < 24)
            {
                outputText("Your [cockhead] slides over her cheek with every stroke, leaving a trail of pre-cum on her face.  The smudges of glistening pre grow larger and larger as the pleasure of the act nears orgasmic levels.\n\n");
            }
            else
            {
                outputText("Your [cock] slides over her face with every stroke, smearing the demon's hair with your thick pre-seed before you pull back and dribble it on her face.  The pleasure of the act is incredible, and you feel yourself getting harder as the sensation nears orgasmic levels.\n\n");
            }
            ...
            if (player.cumQ() >= 1000)
            {
                outputText("  Your prodigious fertility quickly forms a puddle around her, leaving the deceptive seductress practically submerged in cum.");
            }
            outputText("\n\n");
            ...
            {
                outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit them on my cock first chance I get, dear.</i>\"\n\n");
            }
    ...
    @:allow(classes.scenes.nPCs)
    private function rideCeraphsCockLikeaBAWSSexclamation11eleven() : Void
    {
        flags[kFLAGS.TIMES_BEATEN_SERAPH_WITHOUT_LOSING]++;
        player.slimeFeed();
        spriteSelect(SpriteDb.s_ceraph);
        ...
        if (player.cor < 33)
        {
            outputText("Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to get off on a sex-demon's tool.");
        }
        else if (player.cor < 66)
        {
            outputText("Her words confuse you.  You never would've done this when you first came here, but you're horny and you know demons don't really mind.");
        ...
        if (player.vaginalCapacity() < 12)
        {
            outputText("unable to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n");
        }
        else
        {
            outputText("able to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n");
        }
        ...
        {
            outputText("You're only feeding the swarms of imps that are despoiling this land.");
        }
        else
        {
            outputText("I'm sure whatever baby you have in there won't enjoy being so soaked in corruption.");
        }
        outputText("</i>\"\n\n");
        ...
        {
            outputText("You bend over and rub your belly while whispering in her ear, \"<i>Like mother, like child.</i>\"\n\n");
        }
        outputText("As you leave, you don't bother to spare a glance at the confused omnibus; she isn't worth your time.\n\n");
    ...
    private function loseToCeraphAndGetPiercingsInEarsOrSomethingSomehow() : Void
    {
        ...
        {
            outputText("With a dismissive gesture, Ceraph murmurs words of dark magic and the piercings in your ears drop to the ground, leaving behind smooth, unbroken flesh.  ");
        }
    ...
    private function loseToCeraphAnGetPierced2() : Void
    {
        ...
        {
            outputText("With a dismissive gesture, Ceraph murmurs words of dark magic, and the piercings in your nipples drop to the ground, leaving behind smooth, unbroken flesh.  ");
        }
        //Business as usual!
    ...
    private function finalCeraphEncounterStartFight() : Void
    {
        ...
        if (player.cor <= 50)
        {
            outputText("you'll stop her devilish scheme");
        }
        else
        {
            outputText("you'll be HER [master]");
        }
    ...
    private function agreeToBecomeCeraphsFuckpetBondageToyBitchSlut() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText("  Your " + vaginaDescript(0) + " tingles as you wonder how many piercings and fetishes she could fit into your labia.");
        }
        else if (player.cockTotal() > 0)
        {
            outputText("  Your [cock] grows rock hard as you wonder if she'll give you a Jacob's ladder full of new fetishes and thoughts.");
        }
        else
        {
            outputText("  Your body hums with arousal as you wonder if she'll give you a cock and cunt, pierce them both, and fill you with new fetishes and sexy submissive thoughts.");
        }
        ...
        {
            outputText("The previous piercing has vanished!  ");
        }
    ...
    private function agreeToBeABitchPt2() : Void
    {
        ...
        if (player.cockTotal() > 0)
        {
            outputText(" along with a magical cock-ring");
        }
    ...
    private function ceraphFirstTimeVolunteer() : Void
    {
        ...
        if (player.earsPierced > 0)
        {
            outputText("Miraculously, your old earrings just fall out.  ");
        }
    ...
    //FOLLOWER CHANCE:
    {
        ...
        if (monster.HP < 1)
        {
            outputText("Ceraph collapses in a beaten, bloody heap.");
        }
        else
        {
            outputText("Ceraph masturbates futilely, too driven by desire to fight.");
        }
    ...
    public function rapeOptions(leave : Function) : Void
    {
        if (player.lust >= 33 && player.gender > 0)
        {
            ...
            addButton(1, "FuckHerAss", buttRapeCeraph).disableIf(player.cockThatFits(monster.analCapacity()) < 0, 
                    ...
                    + "\n\nReq. a cock fitting "
                    + monster.analCapacity()
                    + " capacity."
            );
            addButton(2, "FuckCorHuge", hugeCorruptionForceFuckCeraph).disableIf(player.isTaur() || player.findCock(1, 500, -1) < 0 || player.cor < 80 - player.corruptionTolerance, 
        ...
        else
        {
            ...
            {
                outputText("  You don't really have the equipment to fuck her. Oh, well.");
            }
            leave();
        }
    }
    ...
    public function ceraphRapesYouBADDAWGYODIGGITY() : Void
    {
        ...
        spriteSelect(SpriteDb.s_ceraph);
        clearOutput();
        if ((!CoC.instance.inCombat) && flags[kFLAGS.PC_FETISH] < 3)
        {
            outputText("The demoness touches your forehead, and suddenly your mind is awash with fetishes!  Judging by the playful look she has, it's temporary, and you play along.  ");
        }
        outputText("Ceraph throws her head back and laughs as you ");
        if (player.HP < 1)
        {
            outputText("slump down, defeated");
        }
        else
        {
            outputText("give up and start masturbating");
        }
        ...
        if (player.biggestTitSize() > 1)
        {
            outputText(", right between your " + player.allBreastsDescript());
        }
    ...
    private function hugeCorruptionForceFuckCeraph() : Void
    {
        ...
        if (monster.HP < 1)
        {
            outputText("beaten, prone");
        }
        else
        {
            outputText("prone, masturbating");
        }
        ...
        if (monster.HP < 1)
        {
            outputText("Her hands are too busy starting to pump away at her nodule-covered demon-dick to help her crawl away.");
        }
        else
        {
            outputText("Both her hands are too busy at her groin to help her escape.");
        }
        outputText("\n\n");
        ...
        {
            outputText("You pat your " + cockDescript(x) + " and say, \"<i>A little help please, Exgartuan?</i>\"  ");
        }
        else
        {
            outputText("You blink your eyes closed and focus your corruptive powers in your crotch.  ");
        }
        ...
        if (player.cocks[x].cockLength < 68)
        {
            outputText("  It's impossible!  You aren't long enough for that.  Her body must have shrunk itself to a more appropriate length...");
        }
        outputText("\n\n");
        ...
        if (player.cocks[x].cockLength < 68)
        {
            outputText(num2Text(as3hx.Compat.parseInt(player.cocks[x].cockLength / 12)));
        }
        else
        {
            outputText("six");
        ...
        if (player.cocks[x].cockLength > 84)
        {
            outputText("You've still got a lot more dick to get wet, and you start pushing the rest through her, using her like a plus-sized, organic onahole.  ");
        }
        else
        {
        ...
        if (player.cumQ() < 100)
        {
            outputText("You squirt your load into the dirt, but some rolls back along the underside of your urethra, catches on Ceraph's upper lip, and drips up her cheek into her tangled hair.");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("You squirt your copious cum everywhere, splattering the dirt and dripping white goo onto Ceraph's face, forehead, and hair.  By the time you finish she's got a nice glaze going on.");
        }
        else
        {
            outputText("You expel huge waves of seed in what can only be described as eruptions.  They splatter into the dirt, forming thick puddles that are joined together with each successful splash of goo.  In between blasts, a steady stream leaks from the tip, travels down the underside, and catches on Ceraph's lip.  The spunk-flow is pulled over her face and into her hair by gravity.  She's glazed white and dripping into a puddle by the time you finish.");
        }
        outputText("\n\n");
        ...
        if (flags[kFLAGS.PC_FETISH] > 0)
        {
            outputText("I'll remove some of my magic from you if you want, and I'll even let you keep the piercing.  Would you like that?");
        }
        else
        {
            outputText("I'd be willing to give you a few extra gems to keep you motivated to do something like this again.  I LIKE surprises. How about it?");
        }
        outputText("</i>\"\n\n");
    ...
    private function ceraphsNiceOffer() : Void
    {
        ...
        if (flags[kFLAGS.PC_FETISH] > 0)
        {
            ...
            if (flags[kFLAGS.PC_FETISH] == 1)
            {
                outputText("your exhibitionism is gone!");
            }
            else if (flags[kFLAGS.PC_FETISH] == 2)
            {
                outputText("your bondage fetish is gone!");
            }
            else
            {
                outputText("your pacifism is gone!");
            }
    ...
    public function friendlyNeighborhoodSpiderManCeraph() : Void
    {
        ...
        if (player.cor > 66)
        {
            outputText("and without a second thought you disrobe, tossing your [armor] to the side.  It thumps heavily in the dry mountain dust.");
        }
        else if (player.cor > 33)
        {
            outputText("and you squirm and writhe within your [armor], the material itching on your skin.  Ultimately, you manage to resist.");
        }
        else
        {
            outputText("and you stifle a laugh at the ridiculous thought, ignoring your fingers while they scratch at the itch under your gear.");
        }
        ...
        if (player.cor > 66)
        {
            outputText("I can see just how hot I'm making you, I'm so glad you gave in and got undressed for me");
        }
        else
        {
            outputText("You can't take your eyes off me.  It's a shame you didn't get undressed.  Didn't anyone tell you this mountain has a dress code?  Or should I say, an undress code");
        }
        ...
        if (player.cor > 66)
        {
            outputText("Are you going to try to fight me in the buff?  If you're going to do that then you can go ahead and get dressed, I wouldn't want to accidentally leave a scar in the wrong place.");
        }
        else
        {
            outputText("Are you going to try to fight me?  If you're going to do that, I suppose we can.  You do seem to need some practice at indulging your fetishes.");
        }
        outputText("</i>\"\n\n");
    ...
    private function runFromCeraphsNiceDeal() : Void
    {
        ...
        if (player.cor > 66)
        {
            outputText("grab your equipment and ");
        }
    ...
    private function tradeCeraphSomething() : Void
    {
        ...
        if (player.hasItem(consumables.BIMBOLQ))
        {
            ...
            if (flags[kFLAGS.PC_FETISH] > 1)
            {
                outputText("all the fetishes");
            }
            else
            {
                outputText("the fetish");
            }
            ...
            if (player.gender > 0 || player.biggestTitSize() > 2)
            {
                outputText("  Or if you'd rather keep it, I could take one of your endowments for my own use and remove a single fetish.  It's always fun giving one of my old pets a new part to play with.");
            }
        ...
        else if (player.gender > 0 || player.biggestTitSize() > 2)
        {
            ...
            if (flags[kFLAGS.PC_FETISH] == 1)
            {
                outputText("your fetish for you.</i>\"\n\n");
            }
            else
            {
                outputText("one of your fetishes for you.</i>\"\n\n");
            }
            endowment = tradeCeraphCrotchityBits;
        }
        //(NO TRADE)
    ...
    private function tradeCeraphCrotchityBits() : Void
    {
        ...
        while (i > 0)
        {
            ...
            if (player.breastRows[i].breastRating > 2)
            {
        ...
        if (choice == 0)
        {
            outputText("FUCK AN ERROR HAPPENED GET FENOXO ON THE HORN!");
        }
        //(DICKS)
        else if (choice == 1)
        {
            ...
            if (player.cocks[temp2].cockType == CockTypesEnum.HORSE)
            {
                outputText("Oooh, is that a horse-cock?  Those are quite nice.  I love the feel of a flare inside me, or even better, plunging one deep into a slut's poor, abused asshole.");
            }
            else if (player.cocks[temp2].cockType == CockTypesEnum.DOG)
            {
                outputText("Oooh, is that a dog-cock?  Those are quite nice.  It's oh-so-fun to enhance the knots on those and then watch them puff up enough to distend some poor slave's gut.");
            }
            else if (player.cocks[temp2].cockType == CockTypesEnum.DEMON)
            {
                outputText("Oooh, is that a demon-cock?  As you can see I'm QUITE familiar with those, but it might be fun to replace one of my girl's tongues with it.");
            }
            else if (player.cocks[temp2].cockType == CockTypesEnum.CAT)
            {
                outputText("Oooh, is that a kitty-dick?  The spines on those feel so good while they rub down all your walls or catch your prostate.  Meow.");
            }
            else if (player.cocks[temp2].cockType == CockTypesEnum.LIZARD)
            {
                outputText("Wow, you've got a snake-dick?  I haven't seen one of those in a while.  I love the bulbous, knot-like texture.  Maybe I'll graft it onto a chair and make one of my boys sit on it for a few days.");
            }
            else if (player.cocks[temp2].cockType == CockTypesEnum.TENTACLE)
            {
                outputText("Oooh, a tentacle cock?  How lucky to find one of those on you!  I've been meaning to add another poor tentacle-slave.");
            }
            else if (player.cocks[temp2].cockType == CockTypesEnum.ANEMONE)
            {
                outputText("Oooh, an anemone-cock?  Simply marvelous!  I might have to crank up the strength of the venom and use it myself!");
            }
            else
            {
                outputText("Oooh, a normal, uncorrupted cock.  How utterly droll!  You'd think these would be more common, but it's quite a treat to come across one.");
            }
            if (player.cockTotal() > 1)
            {
        ...
        else if (choice == 2)
        {
            ...
            if (player.wetness() >= 5)
            {
                outputText("My, my, what a juicy box you have there.  Tell me, doesn't it bother you to be soaking in your own lubricants all the time?  Perhaps I'll put it on one of my slaves and mount her on the wall.  Then I can simply slip in and lube up before giving one of my other pets a proper lesson.");
            }
            else if (player.wetness() >= 3)
            {
                outputText("My, my, what a nice wet pussy you have there.  I really feel that you have a perfect blend of moisture and practicality down there.  I might have to snatch that snatch and give it to one of my drier pets.");
            }
            else if (player.vaginalCapacity() >= 150)
            {
                outputText("My, my, what a terrifically gaped hole you have there.  Do minotaurs even feel anything while they rail you?  Perhaps I could use that when I'm playing with Shenandoah.  She's had a few too many incubi drafts and can be a little difficult to handle.");
            }
            else
            {
                outputText("My, my, such a pretty pussy.  I bet it would be fun to replace one of my noisier pet's mouth with.  She never did learn not to bite.");
            }
            outputText("</i>\"\n\n");
        }
        //(Tits)
        else
        {
            ...
            if (player.biggestTitSize() > 14)
            {
                outputText("Oh wow... just wow.  How do you walk?  With melons like this you could tit-fuck three or four people at once!  Absolutely exquisite.");
            }
            else if (player.biggestTitSize() > 6)
            {
                outputText("Tell me dear, are they real?  I mean, were they always this size, or did you have to get a little bit of work done?");
            }
            else
            {
                outputText("Well, these are a bit small.  Have you ever considered trying some Gro Plus?  I hear it's all the rage with Lethice's lackeys nowadays.");
            }
            outputText("</i>\"\n\n");
        }
    ...
    public function ceraphBodyPartDreams() : Void
    {
        ...
        if (choice == 2)
        {
            ...
            if (subChoice == 0)
            {
                ...
                if (!player.hasVagina())
                {
                    outputText("You don't have a vagina anymore, do you?");
                }
                else
                {
                    outputText("No, that doesn't feel right – it isn't your vagina.");
                }
            ...
            else if (subChoice == 1)
            {
                ...
                if (!player.hasVagina())
                {
                    outputText("Wait... you don't have a clit anymore... Ceraph took that away.  ");
                }
                else
                {
                    outputText("Wait... that's not your " + clitDescript() + "... it's the one Ceraph took from you.  ");
                }
            ...
            else if (subChoice == 2)
            {
                ...
                if (!player.hasVagina())
                {
                    outputText("Wait... you don't have a pussy anymore.  ");
                }
                else
                {
                    outputText("Wait... your pussy doesn't feel like that!  ");
                }
        ...
        else if (choice == 3)
        {
            ...
            else
            {
                ...
                if (silly())
                {
                    outputText("horsecocks ");
                }
                else
                {
                    outputText("demonic cocks ");
                }
                ...
                if (silly())
                {
                    outputText(" and what possible ramifications it has for your mental health");
                }
    ...
    @:allow(classes.scenes.nPCs)
    private function buttRapeCeraph() : Void
    {
        flags[kFLAGS.TIMES_BEATEN_SERAPH_WITHOUT_LOSING]++;
        spriteSelect(SpriteDb.s_ceraph);
        ...
        if (monster.HP < 1)
        {
            outputText("her tail hanging limp between her legs.  She spits a wad of bloody saliva and says, \"<i>What's the matter?  Beat a girl senseless and lose your nerve?  I thought you were going to rape me.</i>\"");
        }
        else
        {
            outputText("her rump up in the air while her tail plunges violently into her cunt over and over again.  She moans up to you, \"<i>What's the matter?  Are you nervous about putting it inside me?  Come on... rape me already!  Punish my gushing-wet cunt with your divine rod!</i>\"");
        }
        outputText("\n\nYou reach down and slap her ass hard, ");
        if (player.str < 75)
        {
            outputText("making her whole body jiggle");
        }
        else
        {
            outputText("making her jiggle and slide a few inches in the dirt");
        }
        ...
        if (player.cockTotal() == 2)
        {
            outputText("  The other " + cockDescript(x) + " rubs against her butt-cheeks, sliding through them with ease thanks to her copious secretions.");
        }
        else if (player.cockTotal() > 2)
        {
            outputText("  The rest of your male genitals slide between the demoness' pert butt-cheeks in one huge, femcum-slicked bundle.");
        }
        ...
        if (monster.HP < 1)
        {
            outputText("  Cunt-juice splatters over your [legs] as Ceraph's now-energetic tail plunges into her sodden box, pumping into it in time with the penetration of her asshole.");
        }
        else
        {
            outputText("  Cunt-juice dribbles over your [legs] as Ceraph's tail slowly and purposefully plows her box, mimicking the penetration of her asshole.");
        }
        outputText("\n\n");
        ...
        if (!player.hasSheath())
        {
            outputText("barely touching your groin");
        }
        else
        {
            outputText("rubbing your sheath");
        }
        ...
        if (player.cumQ() >= 500 && player.cumQ() < 1500)
        {
            outputText("Her belly bulges slightly from the cummy deposit, marking her even more obviously as a cum-bucket for your cock.  ");
        }
        else if (player.cumQ() >= 1500)
        {
            outputText("Her belly burbles and swells, bulging out to look positively pregnant, though you know she's packed from the other end.  ");
        }
        outputText("You pull out, and Ceraph's ");
        if (player.cocks[x].cockThickness < 3)
        {
            outputText("slightly-gaped");
        }
        else if (player.cocks[x].cockThickness < 5)
        {
            outputText("gaped");
        }
        else
        {
            outputText("gaping-wide");
        }
        outputText(" asshole leaks spunk everywhere. Disgusted with her");
        if (player.cor < 33)
        {
            outputText(" and a little bit by yourself");
        }
