...
class Bashemath extends Monster
{
    ...
    public function TailSpike() : Void
    {
        ...
        if (rand(100) < (this.spe - player.spe) / 2)
        {
            ...
            {
                var tailspikedmg : Float = Math.round(this.str / 12);
                var lustdmg : Float = Math.round(this.lib / 5);
    ...
    override private function get_long() : String
    {
        ...
        {
            str += "The malikore is currently circling you looking for an opening to strike. She’s actually good on the eye and you would give her more attention if not for the fact she’s trying to beat you down and rape you.";
        }
        return str;
    }
