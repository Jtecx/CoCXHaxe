...
class AmilyScene extends NPCAwareContent implements TimeAwareInterface
{
    public var clothes(get, never) : String;
    ...
    public function timeChange() : Bool
    {
        ...
        if (flags[kFLAGS.AMILY_INCEST_COUNTDOWN_TIMER] > 0 && flags[kFLAGS.AMILY_INCEST_COUNTDOWN_TIMER] < 30 * 24)
        {
        ...
        if (model.time.hours > 23 && flags[kFLAGS.AMILY_X_JOJO_COOLDOWN] > 0)
        {
    ...
    override public function amilyFollower() : Bool
    {
    ...
    public function amilySprite() : Void
    {
        ...
        {
            spriteSelect(SpriteDb.s_amily_defurr);
        }
    }
    ...
    {
        var extractedNail : Int = as3hx.Compat.parseInt(5 + rand(player.inte / 5) + rand(player.str / 10) + rand(player.tou / 10) + rand(player.spe / 20) + 5);
    ...
    public function exploreVillageRuin() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_GROSSED_OUT_BY_WORMS] == 1)
        {
            ...
            {
                flags[kFLAGS.AMILY_GROSSED_OUT_BY_WORMS] = 0;
            }
        }
        ...
        //"bad" or "good" ends.{
            ...
            {
                if (flags[kFLAGS.AMILY_AFFECTION] < 40)
                {
            ...
            //First time{
                ...
                //Set flag for what she met the player as.{
                    ...
                    {
                        outputText("sniffs the air intensely, her whiskers quivering. ");
                    }
                    //[If breasts are A-cup or bigger]
                    else
                    {
                        outputText("stares at the bulge in your top, as well as the bulge in your bottom.  ");
                    }
        ...
        var _sw1_ = (pregnancy.event);        

        switch (_sw1_)
        {
            case 1, 2, 3, 4, 5:  //Amily is slightly pregnant  
            ...
            {
                outputText("\"<i>Well, I guess despite whatever other faults you may have, you can get the job done.</i>\" She says, not looking directly at you.\n\n");
            }
            //[Medium Affection]
            else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
            {
                outputText("\"<i>Thank you. With your help, my people will soon live again.</i>\" She strokes her belly, grinning happily. \"<i>Is there something you want to talk about?</i>\"\n\n");
            }
            //[High Affection]
            else
            {
                outputText("\"<i>Thank you, thank you! I couldn't have done this without you!</i>\" She exclaims. \"<i>You've done a wonderful, noble thing, and I'm glad I found you to be their father. So, not that it isn't great to see you again, but why did you come to visit?</i>\"\n\n");
            }
            case 6, 7, 8:  //Amily is heavily pregnant  
            ...
            if (flags[kFLAGS.AMILY_AFFECTION] < 15 || player.gender == 0)
            {
                outputText("She seems to be paying more attention to her gravid midriff than to you, and it's several long moments before she finally speaks. \"<i>These children will be born soon. I guess I owe you my thanks for being willing to father them.</i>\"\n\n");
            }
            //[Medium Affection]
            else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
            {
                outputText("She groans softly. \"<i>This isn't an easy task, you know. But I still want to thank you. Maybe, when these ones are born, you'll be willing to help me make some more?</i>\" She asks, her tail gently waving behind her.\n\n");
            }
            //[High Affection]
            else
            {
                outputText("\"<i>I should have known you were coming; they always start kicking up a storm when you're here – did you know that?</i>\" She smiles beatifically. \"<i>They know their daddy already, they do. With your help, a new generation of my people will have a chance to grow up free from the taint of demons. Was there something on your mind?</i>\"\n\n");
            }
            default:  //Amily is not pregnant  
                ...
                if (flags[kFLAGS.AMILY_AFFECTION] < 15 || player.gender == 0)
                {
                    if (flags[kFLAGS.AMILY_MET_AS] == 2 && player.gender == 2)
                    {
                        outputText("She crosses her arms and smiles at you. \"<i>So you came back huh?  Did you want to chat with little old me?</i>\" she asks.\n\n");
                    }
                    else
                    {
                        outputText("She crosses her arms and taps her fingers on her shoulder. \"<i>So, why are you here? What do you want?</i>\" she asks.\n\n");
                    }
                }
                //[Medium Affection]
                else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
                ...
                else
                {
                    ...
                    if (player.hasCock())
                    {
                        ...
                        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0 && player.canGetPregnant())
                        {
                            outputText(" Or have you come to get knocked up?");
                        }
                    }
                    else if (player.hasVagina())
                    {
                        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0 && player.canGetPregnant())
                        {
                            outputText("Have you come back so I could stuff another bun in your oven?");
                        }
                        else
                        {
                            outputText("Did you come back for a little 'quality time' with me?");
                        }
                    }
    ...
    //Sex / Talk / Talk then sex
    {
        ...
        {
            addButton(3, "Efficiency", makeAmilyAHerm).hint("You could probably bring up the efficiency of having two hermaphrodite mothers, particularly since you have this purified incubi draft handy.").disableIf(!player.hasItem(consumables.P_DRAFT), "You could probably bring up the efficiency of having two hermaphrodite mothers, should you find a bottle of purified incubi draft.");
        }
        addButton(14, "Leave", explorer.done);
    }
    
    private function determineAmilySexEvent(forced : Bool = false) : Function
    {
        if (!forced && player.lust < 33)
        {
            return null;
        }
    ...
    private function talkToAmily() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_MET_AS] == 2 && player.gender == 2)
        {
            outputText("You tell Amily that you came here because you wanted to talk with her.\n\n");
        }
        else
        {
            outputText("You tell Amily that you came here because you wanted to talk with her, and you have no desire to approach her sexually on this encounter.\n\n");
        }
        
        //[Low Affection]
        if (flags[kFLAGS.AMILY_AFFECTION] < 15)
        {
            var _sw3_ = (pregnancy.event);            
    ...
    private function sneakyUberAmilyRemeetingsAnnounce() : Void
    {
        ...
        switch (_sw5_)
        {
            ...
            if (flags[kFLAGS.AMILY_AFFECTION] < 15)
            {
                outputText("\"<i>I guess maybe I'm starting to slow down with this hanging off of me,</i>\" she grumbles. \"<i>Something you wanted?</i>\"\n\n");
            }
            //[Medium Affection]
            else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
            {
                outputText("\"<i>Be honest – did this make me easier to find?</i>\" she asks, pushing out her belly for emphasis. Then, seemingly uncaring about the answer, she changes the subject. \"<i>Is there a reason you wanted to see me?</i>\"\n\n");
            }
            //High Affection
            else
            {
                outputText("\"<i>I may be pregnant, but I didn't make this any easier on you now, did I?</i>\" She smirks. \"<i>It takes great skill to find me... but what is your reason?</i>\"\n\n");
            }
            case 6, 7, 8:  //Amily is heavily pregnant  
            //[Low Affection]
            if (flags[kFLAGS.AMILY_AFFECTION] < 15)
            {
                outputText("\"<i>The only reason you could possibly find me is because this huge belly makes me too slow to move quickly and too big to hide. You know that, don't you?</i>\" she proclaims defensively, before changing her tone and asking curiously, \"<i>...Why are you here, anyway?</i>\"\n\n");
            }
            //[Medium Affection]
            else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
            {
                outputText("\"<i>I guess it's not as easy for me to hide as it once was. So, why are you here?</i>\"\n\n");
            }
            //[High Affection]
            else
            {
                outputText("\"<i>It's not easy for me to run and hide anymore, these days. I'm glad you decided to do the guardian angel act. So, how can I thank you for coming to check on me?</i>\"\n\n");
            }
            default:  //Amily is not pregnant  
                //[Low Affection]
                if (flags[kFLAGS.AMILY_AFFECTION] < 15)
                {
                    outputText("\"<i>How on earth did you get here? Nobody's ever been able to track me!</i>\" she protests. Then she shakes her head. \"<i>Ah well, I guess if it's you, it's no matter. So, whaddya want?</i>\"\n\n");
                }
                //[Medium Affection]
                else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
                {
                    outputText("\"<i>Hmm... I'll have to work on that; I can't let just any bozo trail me,</i>\" she proclaims, smiling mischievously. \"<i>What's up?</i>\"\n\n");
                }
                //[High Affection]
                else
                {
                    outputText("\"<i>You're coming along nicely, lover mine.</i>\" She smiles, proud as can be at your display of skill. \"<i>So, what brings you running to me?</i>\" she teases.\n\n");
                }
        }
        amilyVillageMenu();
    }
    ...
    private function scareAmilyRemeetingsProBaws() : Void
    {
        ...
        if (player.spe < 50)
        {
            ...
            else
            {
                ...
                if (pregnancy.isPregnant)
                {
                    outputText("  \"<i>Do you want our children to grow up without their father?</i>\" she asks softly, touching her bulging belly with one hand.\n\n");
                }
                outputText("\n\n");
    ...
    private function heyIGotTicketsToMicePoppingOut() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText(", mousy figure – pink, hairless and ");
        }
        else
        {
            outputText(" figure –");
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText(" Though hairless like regular infant mice,");
        }
        else
        {
            outputText(" Though remarkably similar to a regular infant - minus the ears and tail, of course -");
        }
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText(" and fur has already begun to cover their formerly-naked bodies.");
        }
        else
        {
            outputText(" maturing dramatically as you watch.");
        }
    ...
    private function helpThatFukkinUngratefulBitchGiveBirth() : Void
    {
        ...
        if ((player.gender == 3 || flags[kFLAGS.AMILY_WANG_LENGTH] > 0) && rand(2) == 0)
        {
            amilyKid = "herm";
        }
    ...
    private function thisFunctionProbablySucksTooOhYeahAmilyFunction() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_MET_AS] == 1)
        {
            outputText("When we first met, you were just sperm to me, a pure male to father the children I needed. ");
        }
        else
        {
            outputText("When we first met, I was afraid of you, I needed your male essence, but I was prejudiced against your other gender. ");
        }
    ...
    public function talkWithCuntIMeanAmily(sexAfter : Bool = false) : Void
    {
        clearOutput();
        amilySprite();
        var convo : Float = rand(15);
        
        // Bump past convo #12 if she's already at camp because it doesn't make much sense by this point.
        if (convo == 12 && amilyFollower())
        {
            convo++;
        }
        ...
        if (player.gender == 2 || (player.gender == 3 && flags[kFLAGS.AMILY_HERM_QUEST] < 2))
        {
            convo = rand(12);
        }
        //Boost affection!
        ...
        if (convo == 0)
        {
            ...
            else if (player.itemSlot1.itype == useables.D_SCALE)
            {
                ...
                if (camp.followerKiha() || camp.followerEmber())
                {
                    outputText(" until");
                }
                ...
                if (camp.followerEmber())
                {
                    outputText(" Ember");
                }
                if (camp.followerKiha() || camp.followerEmber())
                {
                    outputText(" came to your camp");
                }
            ...
            {
                outputText(" and take your leave of the mouse-girl.\n\n");
            }
        }
        ...
        else if (convo == 1)
        {
            ...
            {
                outputText("\"<i>I am still a virgin, after all.</i>\"\n\n");
            }
            //(If player has had sex with Amily:
            else
            {
                outputText("\"<i>I was a virgin when we met, in case you forgot.</i>\"\n\n");
            }
            ...
            {
                outputText(" and excuse yourself.\n\n");
            }
        }
        ...
        else if (convo == 2)
        {
            ...
            {
                outputText(" and take your leave.\n\n");
            }
        }
        ...
        else if (convo == 3)
        {
            ...
            {
                outputText(", and politely excuse yourself.\n\n");
            }
        }
        ...
        else if (convo == 5)
        {
            ...
            if (sexAfter)
            {
                outputText("and regains her composure.\n\n");
            }
            else
            {
                ...
                if (flags[kFLAGS.AMILY_FOLLOWER] == 0)
                {
                    outputText("  As you set off back to camp,");
                }
                else
                {
                    outputText("  As you sit back down in camp,");
                }
        ...
        else if (convo == 6)
        {
            ...
            if (!sexAfter)
            {
                outputText("Thanking her for her time, you take your leave of her.\n\n");
            }
            else
            {
                outputText("You thank her for her time as the conversation winds down.\n\n");
            }
        }
        ...
        else if (convo == 7)
        {
            ...
            if (!sexAfter)
            {
                if (flags[kFLAGS.AMILY_FOLLOWER] == 0)
                {
                    outputText("Thanking her for her time, and the warning, you head back to your own camp.\n\n");
                }
                else
                {
                    outputText("Thanking her for her time, and the warning, you sit back down in your camp.\n\n");
                }
            }
            else
            {
        ...
        else if (convo == 8)
        {
            ...
            if (!sexAfter)
            {
                outputText(", and, embarrassed and unable to explain why you did that, you politely take your leave.");
            }
            else
            {
                outputText(", before giving you a warm smile.\n\n");
            }
        }
        ...
        else if (convo == 9)
        {
            ...
            if (!sexAfter)
            {
                outputText("  Then you leave her, giving her the chance to mourn her lost family.\n\n");
            }
        }
        ...
        else if (convo == 10)
        {
            ...
            {
                outputText(", then excuse yourself once you are certain she is okay.\n\n");
            }
        }
        ...
        else if (convo == 11)
        {
            ...
            if (!sexAfter)
            {
                if (flags[kFLAGS.AMILY_FOLLOWER] == 0)
                {
                    outputText("\", politely excuse yourself, and head back to your own camp. It sounds like she's doing better at keeping a steady supply of food and water going than you are.  But if that's the case... why does she look so thin?\n\n");
                }
                else
                {
                    outputText("\", politely excuse yourself, and sit back down in camp.  It sounds like she's doing better at keeping a steady supply of food and water going than you are.  But if that's the case... why does she look so thin?\n\n");
                }
            }
            else
            {
        ...
        else
        {
            ...
            if (!sexAfter)
            {
                if (flags[kFLAGS.AMILY_FOLLOWER] == 0)
                {
                    outputText("  Then, as if realising you are still here, she waves at you to go, getting up and leaving herself.  Wondering what that was about, you return to camp.\n\n");
                }
                else
                {
                    outputText("  Then, as if realising you are still here, she waves at you to go, getting up and leaving herself.  Wondering what that was about, you sit down in camp.\n\n");
                }
            }
        }
        if (sexAfter)
    ...
    private function stickItInMouseTwatForTheFirstTimeNOTWORTHALLBULLSHIT() : Void
    {
        ...
        {
            outputText("Fortunately, being smaller than average means you have less difficulty following her than you might.");
        }
        else if (player.tallness >= 84)
        {
            outputText("Your considerable size makes it surprisingly tricky to get around, but you manage to stay with her.");
        }
    ...
    private function FirstTimeAmilyTakeCharge() : Void
    {
        ...
        if (player.cocks[0].cockLength >= 14)
        {
            outputText("failing to fit in more than a foot of your cock's length, ");
        }
    ...
    public function amilySexHappens() : Void
    {
        clearOutput();
        amilySprite();
        var x : Float = player.cockThatFits(61);
        //If too big
        ...
        else if (flags[kFLAGS.AMILY_AFFECTION] < 40)
        {
            ...
            {
                outputText("  However, she does sometimes touch the swell signifying the litter growing inside her, and when she does her attitude becomes uncertain and nervous.");
            }
            outputText("\n\n");
            ...
            if (pregEvent >= 6)
            {
                outputText("  However, her confidence visibly slips when she has to fully bare the bulging belly that marks her pregnant state, but she musters the confidence and starts to show it off for you as well.");
            }
            simpleChoices("Step In", amilyStepTheFuckIn, "Watch Show", amilyEnjoyShow, "", null, "", null, "", null);
        }
        else if (pregnancy.event >= 6)
        {
            fuckAmilyPreg();
        }
        else
    ...
    private function amilyEnjoyShow() : Void
    {
        ...
        if (pregnancy.event >= 6)
        {
            outputText("  Even though she was clearly a little nervous about her gravid state in the beginning, as she continues, she grows in confidence to the point it seems she has almost forgotten about it.");
        }
        outputText("\n\n");
        AmilyMidSexLevel2();
    }
    ...
    private function amilyHighAffectionSecks() : Void
    {
        ...
        if (pregnancy.isPregnant)
        {
            outputText("  Even in a slightly pregnant state, she goes surprisingly fast, though she's also rather cautious of her small bump.");
        }
        outputText("\n\n");
        ...
        if (pregnancy.isPregnant)
        {
            outputText("  Really it seems the only thing between you two now is Amily's small stomach bulge.");
        }
        //(If Amily is herm:
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("  You can feel her erection, hot and solid, pressed between your two bodies.");
        }
        outputText("\n\n");
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] == 0)
        {
            outputText("sucking on her sensitive clit");
        }
        else
        {
            outputText("licking and kissing her human-like cock");
        }
        ...
        if (pregnancy.isPregnant)
        {
            outputText("  As you move your head across her beautiful form, you stop at her growing baby bump and give it a small kiss.");
        }
        outputText("  Your head hovers at her breasts");
        if (pregnancy.isPregnant)
        {
            outputText(", which seem to have grown from the pregnancy,");
        }
        outputText(" and get to work licking and suckling her nipples, rubbing the sensitive mounds.");
        if (pregnancy.isPregnant)
        {
            outputText("  When you get a dribble of milk in your mouth it surprises you, but you certainly don't stop.  \"<i>Hah...You're going to have to teach the children how that's done,</i>\" Amily says, in between fevered breaths.");
        }
        outputText("\n\n");
        ...
        if (pregnancy.isPregnant)
        {
            outputText("  You are of course mindful of her baby bump, not going too fast and making sure you're in a position that's comfortable for the two of you, not wanting to harm your future offspring with the lovely mouse maiden.");
        }
        ...
        if (!pregnancy.isPregnant)
        {
            outputText("Fill me up with everything you have... I want to be a mother for your children, just as much as I want to be a mother of my own people,");
        }
        else
        {
            outputText("No need to hold back, pump as much cum into me as you can,");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" and cum spurts into the air between you, splattering on you both");
        }
        outputText(".\n\n");
        
        if (!pregnancy.isPregnant)
        {
            outputText("\"<i>If that didn't knock me up... I don't care as much as you'd think. It was magnificent either way,");
        }
        else
        {
            outputText("\"<i>Hmm...My kids are pretty lucky that their father is such a virile specimen,");
        }
        ...
        if (!pregnancy.isPregnant)
        {
            outputText("Okay... Well, I'm sure you'll be back. I will need your help again if this doesn't set,");
        }
        else
        {
            outputText("Okay dear...But you better come back some time. You don't want your children to have abandonment issues, do you?");
        }
    ...
    private function fuckAmilyPreg() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("  The erection tenting her pants isn't helping.");
        }
        outputText("\n\n");
        ...
        {
            outputText("You even feel Amily wrap her mousy tail around your own, making you chuckle softly into your lovers mouth.  ");
        }
        else
        {
            outputText("A tickling sensation hits your body, making you snort and giggle, realising that Amily's tail is fondling your thigh.  ");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(", her own mouse-cock spewing futa-cum all over your belly");
        }
        outputText(".\n\n");
        
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("\"<i>Remember when you said this cock was a bad thing?</i>\" you tease, causing Amily to blush and playfully punch you in the shoulder.  \"<i>Sh-shut up!  It's... it's pretty incredible, there, I said it.</i>\"\n\n");
        }
    ...
    //Is amily a chaste follower?
    {
        ...
        if (rand(4) == 0 || player.cumQ() > rand(1000) || player.hasPerk(PerkLib.PilgrimsBounty))
        {
            ...
            if (flags[kFLAGS.SCENEHUNTER_PRINT_CHECKS] != null)
            {
    ...
    public function amilyFollowerEncounter2() : Void
    {
        ...
        {
            if ((flags[kFLAGS.LUNA_JEALOUSY] > 200 && rand(10) < 4) || (flags[kFLAGS.LUNA_JEALOUSY] > 300 && rand(10) < 8))
            {
                mishapsLunaAmily();
            }
            else
    ...
    public function amilyFollowerEncounter() : Void
    {
        ...
        if (player.cor < 50 + player.corruptionTolerance && flags[kFLAGS.AMILY_WARNING] > 0)
        {
        ...
        if (flags[kFLAGS.AMILY_FOLLOWER] == 1)
        {
            outputText("As you approach the mouse-woman, her big, hairless ears twitch and she turns to face you with a smile. \"<i>Hi, [name]! What's up?</i>\" She grins at you.\n\n");
        }
        //Corrupt!
        else
        {
        ...
        var _sw6_ = (pregnancy.event);        

        switch (_sw6_)
        {
            case 2:if (flags[kFLAGS.AMILY_FOLLOWER] == 1)
            ...
            case 3, 4:outputText("Amily's belly is starting to protrude a little. She's unquestionably pregnant.\n\n");
            case 5, 6:outputText("Amily's belly has gotten very big. She must be carrying more than one child.\n\n");
            case 7:if (flags[kFLAGS.AMILY_FOLLOWER] == 1)
    ...
    public function amilyMenu(output : Bool = true) : Void
    {
        menu();
        //Innocent
        if (flags[kFLAGS.AMILY_FOLLOWER] == 1)
        ...
        //outputText("Options:\nAppearance\nTalk\nMake Love\n");{
            ...
            {
                addButton(5, "Team", amilyHenchmanOption);
            }
            else
            {
                addButtonDisabled(5, "Team", "You need to have at least Basic Leadership to form a team.");
            }
            addButton(6, "Lay Eggs", layEggsInAmily).hint("Unload your eggs into Amily's ass.").disableIf(!flags[kFLAGS.AMILY_OVIPOSITION_UNLOCKED], "She's not ready yet.").disableIf(!player.canOviposit(), "Req. an ovipositor");
            if (CorruptedGlade.canBeDestroyed())
            {
                if (flags[kFLAGS.AMILY_DESTROYING_CORRUPTED_GLADES] == 0)
                {
                    addButton(7, "Destroy Glades", amilyDestroyGladesToggle).hint("Request Amily to destroy any corrupted glades she can find.");
                }
                else
                {
                    addButton(7, "Stop Destroying", amilyDestroyGladesToggle).hint("Request Amily to stop destroying the corrupted glades.");
                }
            }
            ...
            if (player.gender > 0 && flags[kFLAGS.AMILY_FOLLOWER] == 1 && flags[kFLAGS.AMILY_VISITING_URTA] == 0)
            {
                if (output)
                {
                    outputText("<b>You could take Amily on a date to Tel'Adre, and perhaps even introduce her to Urta!</b>\n\n");
                }
                addButton(8, "Date", dateNightFirstTime).hint("Take Amily on a date to Tel'Adre?").disableIf(SceneLib.urtaQuest.urtaBusy(), "Urta is busy right now.").disableIf(flags[kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 5 && !urtaLove(), 
        ...
        else
        {
            ...
            if (!pregnancy.isPregnant && flags[kFLAGS.FOLLOWER_AT_FARM_AMILY] == 0 && flags[kFLAGS.FARM_CORRUPTION_STARTED] == 1)
            {
                ...
                if (player.hasPerk(PerkLib.BasicLeadership))
                {
                    addButton(10, "Team", amilyHenchmanOption);
                }
            }
            ...
            if (flags[kFLAGS.FOLLOWER_AT_FARM_AMILY] == 1)
            {
                ...
                if (flags[kFLAGS.FOLLOWER_PRODUCTION_AMILY] == 0)
                {
                    addButton(6, "Harvest Milk", harvestMilk);
                }
                else
                {
                    addButton(6, "Stop Harvest", stopHarvestingMilk);
                }
    ...
    private function amilyCorruptSexMenu() : Void
    {
        ...
        if (player.gender > 0)
        {
            ...
            menu();
            addButton(0, "Anal", corruptAmilyBuckFutter).hint("Fuck Amily in the ass!").disableIf(!player.hasCock(), "Req. a cock!");
            addButton(1, "Get BJ", corruptAmilyOralSuckOff).hint("Have Amily suck you off.", "Get Blowjob").disableIf(!player.hasCock(), "Req. a cock!");
            addButton(5, "Vagina", corruptAmilysPussyGetsMotherfuckingFucked).hint("Fuck Amily the classic way by penetrating her vaginally.").disableIf(!player.hasCock(), "Req. a cock!");
            addButton(2, "Get Licked", corruptAmilyLickPussiesLikeAPro).hint("Have Amily lick your pussy.").disableIf(!player.hasVagina(), "Req. a vagina!");
            addButton(3, "GetPen'ed", corruptAmilyCampBonesPCWithHerCock).hint("Have Amily put her cock to good use by penetrating you vaginally.", "Get Penetrated").disableIf(!player.hasVagina(), "Req. a vagina!").disableIf(flags[kFLAGS.AMILY_WANG_LENGTH] == 0, "Amily doesn't have a cock to penetrate you with.");
            addButton(4, "Scissor", corruptAmilyScissorsLikeAPro).hint("Do some girly fun-times with Amily.").disableIf(!player.hasVagina(), "Req. a vagina!");
    ...
    private function amilyAppearance() : Void
    {
        ...
        //(Start [horsecock]{
            ...
            //([horsecock]{
                ...
                {
                    outputText(" - it even has a foreskin, not a sheath.");
                }
                else
                {
                    outputText(", though it does have a" + (((flags[kFLAGS.AMILY_NOT_FURRY] == 1)) ? " little sheath." : " fuzzy little sheath.") + "");
                }
                outputText("\n\n");
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
            {
                ...
                if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
                {
                    outputText("underneath her shaft");
                }
                else
                {
                    outputText("from her groin");
                }
                outputText(".\n\n");
            }
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] == 2)
            {
                outputText("moist, ");
            }
            if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] == 3)
            {
                outputText("wet, ");
            }
            if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] == 4)
            {
                outputText("dripping, ");
            }
            ...
            if (SceneLib.farm.farmCorruption.hasTattoo("amily"))
            {
                ...
                {
                    if (SceneLib.farm.farmCorruption.numTattoos("amily") > 1)
                    {
                        outputText("She has the following tattoos emblazoned across her body:\n");
                    }
                    else
                    {
                        outputText("\nShe has ");
                    ...
                    if (flags[kFLAGS.AMILY_TATTOO_COLLARBONE] != 0)
                    {
                        outputText(flags[kFLAGS.AMILY_TATTOO_COLLARBONE] + "\n");
                    }
                    if (flags[kFLAGS.AMILY_TATTOO_SHOULDERS] != 0)
                    {
                        outputText(flags[kFLAGS.AMILY_TATTOO_SHOULDERS] + "\n");
                    }
                    if (flags[kFLAGS.AMILY_TATTOO_LOWERBACK] != 0)
                    {
                        outputText(flags[kFLAGS.AMILY_TATTOO_LOWERBACK] + "\n");
                    }
                    if (flags[kFLAGS.AMILY_TATTOO_BUTT] != 0)
                    {
                        outputText(flags[kFLAGS.AMILY_TATTOO_BUTT] + "\n");
                    }
                }
            }
        }
    ...
    private function fuckTheMouseBitch() : Void
    {
        ...
        if (rand(2) == 0)
        {
            outputText("She grins wickedly back, \"<i>Ooh, is that so? Well, I suppose I might be able to squeeze you in...</i>\"\n\n");
        }
        else
        {
            outputText("She giggles, \"<i>What kept you so long? I've been waiting way too long.</i>\"\n\n");
        }
        ...
        if (flags[kFLAGS.AMILY_X_IZMA_POTION_3SOME] == 0)
        {
            ...
            if (izmaFollower())
            {
                if (flags[kFLAGS.AMILY_ALLOWS_FERTILITY] == 0)
                {
                    izmaHint += "Asking her to stop taking herbs ";
                }
                else
                {
                    izmaHint += "Asking her to start taking herbs, and then stop AGAIN ";
                }
                ...
                {
                    izmaHint += "when neither she nor Izma is pregnant";
                }
                izmaHint += " could lead to VERY interesting results.";
            }
            else
            {
                izmaHint += "A new half-hidden option will be available when you get a specific follower.";
            }
        ...
        {
            addButton(3, "Urta", SceneLib.followerInteractions.amilyUrtaSex).hint("Take Amily for a visit to Urta in Tel'Adre for some threesome sexy times.").disableIf(SceneLib.urtaQuest.urtaBusy(), "Urta is not available right now.");
        }
        if (flags[kFLAGS.AMILY_OWNS_BIKINI] > 0)
        {
            addButton(4, "Swim", amilySwimFuckIntro).hint("What's a better pleasure than to take Amily for a swim and do some fuck?").disableIf(player.cockThatFits(61) < 0, "Req. a cock fitting 61 area.");
        }
        ...
        if (flags[kFLAGS.GIVEN_AMILY_NURSE_OUTFIT] != null)
        {
            outputText("Amily might be up for playing nurse again.\n");
            addButton(6, "Nurse RP", amilyNurseCheckup).hint("Have Amily roleplay as a nurse in a naughty way.").disableIf(player.cockThatFits(61) < 0, "Req. a cock fitting 61 area.");
        }
    ...
    private function amilyTakesChargeSex() : Void
    {
        ...
        menu();
        addButton(0, "Fuck", takeChargeAmilyFuck).hint("Penetrate Amily vaginally.").disableIf(player.cockThatFits(61) < 0, "Req. a cock fitting 61 area.");
        addButton(5, "Buttfuck", fuckPureAmilysHeiny).hint("Take Amily from behind.").disableIf(player.cockThatFits(50) < 0, "Req. a cock fitting 50 area.");
        addButton(10, "Get Sucked", takeChargeAmilyGetSucked).hint("Have Amily suck you off.").disableIf(!player.hasCock(), "Req. a cock.");
        addButton(1, "Scissor", takeChargeAmilyScissorMeTimbers).hint("Get into some girly fun-times by rubbing your girl-bits against Amily's.").disableIf(!player.hasVagina(), "Req. a vagina.");
        addButton(6, "Eat Out", takeChargeAmilyEatOut).hint("Get a taste of Amily's pussy.");
        addButton(11, "Drink Milk", takeChargeAmilyMouseMilk).hint("Drink some of Amily's yummy mouse-milk.").disableIf(flags[kFLAGS.AMILY_LACTATION_RATE] < 1, "She doesn't lactate enough.").disableIf(flags[kFLAGS.AMILY_BIRTH_TOTAL] == 0, "She needs to birth first to start lactating.");
        addButton(2, "Mount Her", takeChargeAmilyMountHer).hint("Ride Amily's cock until she cums!").hint("Get into some girly fun-times by rubbing your girl-bits against Amily's.").disableIf(flags[kFLAGS.AMILY_WANG_LENGTH] == 0, "Amily doesn't have a dick... maybe you should fix this?").disableIf(!player.hasVagina(), "Req. a vagina.");
        addButton(7, "Catch Anal", pureAmilyPutsItInYourRectumDamnNearKilledEm).hint("Have Amily put her cock to a good use by taking you from behind.").disableIf(flags[kFLAGS.AMILY_WANG_LENGTH] == 0, "Amily doesn't have a dick... maybe you should fix this?");
    ...
    private function takeChargeAmilyFuck() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("  Her pants begin to tent as her male organ reacts, and you start to idly stroke it as well for emphasis.");
        }
        outputText("\n\n");
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" and her " + amilyCock() + " standing erect");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" her " + amilyCock() + " spasming and spraying futa-jism in between your bodies");
        }
        outputText(".\n\n");
    ...
    private function takeChargeAmilyMouseMilk() : Void
    {
        ...
        var refillAmount : Int = as3hx.Compat.parseInt((10 + (flags[kFLAGS.AMILY_CUP_SIZE] * 2)) * flags[kFLAGS.AMILY_LACTATION_RATE]);
        if (refillAmount > 100)
        {
            refillAmount = 100;
        }
    ...
    private function takeChargeAmilyEatOut() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(", and her " + amilyCock() + " is sticking up where her clitoris should be.  Y");
        }
        else
        {
            outputText(", and y");
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] == 0)
        {
            outputText("her clitoris.");
        }
        else
        {
            outputText("the base of her cock.");
        }
        outputText("\n\n");
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" as her penis erupts and sprays its own cum into the air to sprinkle both of you");
        }
        outputText(".\n\n");
    ...
    private function takeChargeAmilyGetSucked() : Void
    {
        ...
        if (player.cumQ() < 50)
        {
            outputText("she swallows it all without skipping a beat");
        }
        else if (player.cumQ() < 500)
        {
            outputText("her cheeks bulge but she manages to swallow it all");
        }
        else
        {
            outputText("her cheeks bulge hugely and, though she swallows valiantly (her stomach bulges from the amount she takes), a lot of it spurts back from between her lips, drizzling onto your crotch and her " + amilyTits());
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("She turns halfway back to you as she goes. \"<i>I hope you'll remember this and return the favor someday,</i>\" she calls out to you. She then resumes walking off.");
        }
        //if (AbandonedTownRebuilt.InTown = false) {
        doNext(camp.campLoversMenu);
        //if (AbandonedTownRebuilt.InTown = true) doNext(AbandonedTownRebuilt.EnterTown);
    ...
    private function takeChargeAmilyMountHer() : Void
    {
        ...
        //(If pussy is gaping:
        if (player.looseness() >= 5)
        {
            outputText("You can barely feel it within your stretched out depths, but you determine to do your best, for your sake and for hers.");
        }
        //Otherwise:
        else
        {
            outputText("You grin lustfully as you feel it filling you. Hungry for more, you start to rise and fall, letting it pierce you as deeply as possible.");
        }
        outputText("\n\n");
        ...
        if (player.longestCockLength() >= 18)
        {
            ...
            if (player.longestCockLength() >= 22)
            {
                outputText("  She then starts to lick and kiss the tip, sucking on it, playing with its slit with her tongue, smothering it with oral affection.");
            }
            outputText("\n\n");
        }
        //(If player is herm:
        ...
        {
            outputText("She reaches out and grabs hold of " + oMultiCockDesc() + ", stroking, tugging, and teasing it to further excite you into increasing the speed and force with which you thrust.... Something that she succeeds admirably in doing.\n\n");
        }
        ...
        if (player.hasCock())
        {
            outputText(", spraying your own herm-cum onto Amily's face");
        }
    ...
    private function letAmilyLead() : Void
    {
        ...
        if (player.hasCock() && player.cockThatFits(61) < 0)
        {
            outputText("Amily glances down at the beast between your legs and says, \"<i>I was going to ride you, but since you're SOOO big I think I'll have to get creative...</i>\"\n\n");
        }
        ...
        function eatHerOut() : Void
        {
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText("  Her cock bobs merrily in your field of vision.");
            }
            outputText("\n\n");
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText("\"<i>Could you... could you give it a lick, please?</i>\" she whispers, pointing at her male addition. Wanting to make her happy, you kiss the tip of her penis, eliciting a squeak of shock, before you start to lick from the base of her " + amilyCock() + " to the tip again. You then return your attention to her vagina itself.\n\n");
            }
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText("  Her penis erupts and sprays its own cum into the air to sprinkle both of you.");
            }
            outputText("\n\n");
        ...
        function getRidden() : Void
        {
            ...
            if (player.cumQ() > 500)
            {
                outputText(", your torrents of spooge making her belly distend visibly");
            }
        ...
        function suckHerOff() : Void
        {
            ...
            if (player.hasCock())
            {
                outputText("When I do that for you?</i>\"\n\n");
            }
            else
            {
                outputText("For a guy?</i>\"\n\n");
            }
        ...
        function takeHerCock() : Void
        {
            ...
            if (player.hasCock())
            {
                outputText("  She strokes your [cock] a few times, but in a prefunctory manner; it's obvious that she's focusing on her own penis, this time.");
            }
            outputText("\n\n");
            ...
            if (player.looseness() >= 4)
            {
                outputText("You are so large that you barely feel it, but Amily is determined to take what pleasure she can all the same.");
            }
            //Otherwise:
            else
            {
                outputText("You gasp in pleasure and do your best to grip Amily's dick with your netherlips.");
            }
            outputText("\n\n");
            ...
            if (player.wetness() >= 5)
            {
                outputText(" audibly squelching and slurpring thanks to the wetness of your pussy,");
            }
            ...
            if (player.hasCock())
            {
                outputText(", " + sMultiCockDesc() + " spraying jism to fall upon you both like sex-scented rain");
            }
            ...
            player.sexReward("cum", "Vaginal");
            dynStats("sen", -1);
        }  //if (AbandonedTownRebuilt.InTown = true) doNext(AbandonedTownRebuilt.EnterTown);    //if (AbandonedTownRebuilt.InTown = false) {  ;
    }
    
    //Give Present:
    private function giveAmilyAPresent() : Void
    {
        var addItemButton : Int->ItemType->Function->CoCButton = function(num : Int, item : ItemType, fun : Function) : CoCButton
        {
            return addButton(num, item.shortName, fun).disableIf(!player.hasItem(item), "You don't have any!");
        }
        var addItemAltButton : Int->ItemType->ItemType->Function->CoCButton = function(num : Int, small : ItemType, large : ItemType, fun : Function) : CoCButton
        {
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_OWNS_BIKINI] == null)
            {
                addItemButton(8, armors.S_SWMWR, amilySwimFuckIntro).hint("You could give her a bikini, then invite her for a swim in the stream to show it off.").disableIf(player.cockThatFits(61) < 0, "You would require a fitting dick too.");
            }
            if (flags[kFLAGS.GIVEN_AMILY_NURSE_OUTFIT] == null)
            {
                addItemButton(13, armors.NURSECL, amilyNurseCheckup).hint("You could give Amily the nurse's outfit you got, though it barely covers anything at all, and would likely be inviting some roleplay from the kinky mouse-girl.").disableIf(player.cockThatFits(61) < 0, "You would require a fitting dick too.");
            }
        }
    ...
    public function giveAmilyPureIncubusDraft() : Void
    {
        ...
        var maxSizePure : Float = 13;
        var maxSizeCorr : Float = 15;
        var maxSizeHypr : Float = 23;
        ...
        //Herm amily is different{
            ...
            //[Purified Incubus Draft - If Amily is Herm and has a 13" penis]{
                ...
                if (
                    (flags[kFLAGS.AMILY_WANG_LENGTH] >= maxSizePure && flags[kFLAGS.HYPER_HAPPY] == null) ||
                    (flags[kFLAGS.AMILY_WANG_LENGTH] >= maxSizeHypr && flags[kFLAGS.HYPER_HAPPY] != null))
                {
                    ...
                    if (player.cor >= 50 || player.vaginalCapacity() >= 50)
                    {
                        ...
                        if (player.cor >= 75)
                        {
                            outputText("  Although the idea of raping yourself with your futa-mouse lover's helpless body is appealing, you realize this is one argument you simply won't win.");
                        }
                        outputText("\n\n");
                    }
                    //otherwise]
                    ...
                    {
                        outputText("Her logic is undeniable, even though you had looked forward to enjoying even more of her body than before. You nod and explain that you understand perfectly; you want what's best for her above anything else.\n\n");
                    }
    ...
    //flags[kFLAGS.AMILY_WANG_LENGTH] - length
    {
        ...
        else if (flags[kFLAGS.AMILY_WANG_LENGTH] < 15 || flags[kFLAGS.HYPER_HAPPY] != null)
        {
    ...
    public function giveAmilyPurifiedSuccubusMilk() : Void
    {
        ...
        var maxSizePure : Float = 5;
        var maxSizeHypr : Float = 22;
        ...
        if (flags[kFLAGS.AMILY_FOLLOWER] == 1)
        {
            ...
            if ((flags[kFLAGS.AMILY_CUP_SIZE] < maxSizePure) || (flags[kFLAGS.AMILY_CUP_SIZE] < maxSizeHypr && flags[kFLAGS.HYPER_HAPPY] != null))
            {
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText("  Her cock hardens with delight at your idea.");
            }
            outputText("\n\n");
            ...
            if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] >= 5)
            {
                outputText("  A jet of femcum flies straight out of her pussy, only to arch and hit her straight in the face.");
            }
            else
            {
                outputText("  Juices flood out of her pussy like water comes out of a spring, running down her body and pooling underneath her.");
            }
            outputText("\n\n");
    ...
    private function amilyDrinksSuccubusDelight() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] == 0)
        {
            if (flags[kFLAGS.AMILY_FOLLOWER] == 2)
            {
                ...
                if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
                {
                    outputText("Her cock grows hard, but nothing else seems to happen...");
                }
                outputText("\n\n");
                ...
                if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
                {
                    outputText("right under her cock. Her skin grows and covers the base of her cock, pulling it in; giving her what looks like a sheath. It continues to expand and is finally complimented by a couple of orbs falling into her " + (((flags[kFLAGS.AMILY_NOT_FURRY] == 0)) ? "fuzzy " : "") + "sack, giving it the weight it needs to produce more cum. ");
                }
                else
                {
                    outputText("between her legs. Her skin expands with the lumps, forming into a small sack. It continues to expand and is finally complimented by a couple of orbs falling into her " + (((flags[kFLAGS.AMILY_NOT_FURRY] == 0)) ? "fuzzy " : "") + " nutsack, giving it the weight it needs to produce cum, though how it will ever expel it is a mystery to you. ");
                }
    ...
    public function giveAmilyAWhiteEgg() : Void
    {
        ...
        var maxSizePure : Float = 4;
        var maxSizeCorr : Float = 4;
        var maxSizeHypr : Float = 8;
        ...
        //(If Nipples are smaller than 4 inches:{
            ...
            if (flags[kFLAGS.AMILY_NIPPLE_LENGTH] < maxSizePure || (flags[kFLAGS.AMILY_NIPPLE_LENGTH] < maxSizeHypr && flags[kFLAGS.HYPER_HAPPY] != null))
            {
                ...
                if (player.hasItem(consumables.WHITEEG))
                {
                    ...
                    flags[kFLAGS.AMILY_NIPPLE_LENGTH] = as3hx.Compat.parseInt(flags[kFLAGS.AMILY_NIPPLE_LENGTH] * 100) / 100;
                }
                else
                {
                ...
                if (flags[kFLAGS.AMILY_NIPPLE_LENGTH] > maxSizePure && flags[kFLAGS.HYPER_HAPPY] == null)
                {
        ...
        {
            //(If Nipples are smaller than 4 inches:
            if (flags[kFLAGS.AMILY_NIPPLE_LENGTH] < maxSizeCorr)
            {
                outputText("She looks at it and smiles knowingly. \"<i>Is [master] going to make this one's nipples into obscene toys?</i>\" she asks while accepting the egg.  She bites off the top and sucks down the contents in a practiced gulp.  Crushing the shell in her hand, she pulls at her top, allowing you to see her nipples swell and grow until they stop. She experimentally tweaks one, squeaking in shock at the sensation. \"<i>Thank you [master] for giving your slut such wonderful nipple-toys.  Would you like to abuse your slut's needy fuck-hole now?</i>\"\n\n");
            }
            else
            {
                outputText("She looks at it and moans lewdly, \"<i>My nipples are going to be sure huge for you [master].  No, nipples isn't right.  They're teats now.  Huge, swollen cow-teats on your mousey fuck-pet.  Lets make them bigger!</i>\" She bites off the top and sucks down the contents in a practiced gulp.  Crushing the shell in her hand, she pulls at her top, allowing you to see her nipples swell and hang even lower. She experimentally tweaks one, squeaking in shock at the sensation. \"<i>Thank you [master] for making your slut's body useless for anything but sex.  Would you like to abuse your slut's needy fuck-hole now?</i>\"\n\n");
            }
            if (player.hasItem(consumables.WHITEEG))
            {
                player.consumeItem(consumables.WHITEEG);
    ...
    public function giveAmilyABrownEgg() : Void
    {
        ...
        var maxSizePure : Float = 16;
        var maxSizeCorr : Float = 20;
        var maxSizeHypr : Float = 35;
        ...
        //(If Amily's butt size is smaller than "jiggles with every step":{
            ...
            if (flags[kFLAGS.AMILY_ASS_SIZE] < maxSizePure || (flags[kFLAGS.AMILY_ASS_SIZE] < maxSizeHypr && flags[kFLAGS.HYPER_HAPPY] != null))
            {
                ...
                if (flags[kFLAGS.HYPER_HAPPY] != null && flags[kFLAGS.AMILY_ASS_SIZE] > maxSizeHypr)
                {
                    flags[kFLAGS.AMILY_ASS_SIZE] = maxSizeHypr;
                }
                else if (flags[kFLAGS.AMILY_ASS_SIZE] > maxSizePure)
                {
        ...
        {
            //(If Amily's butt size is smaller than "jiggles with every step":
            if (flags[kFLAGS.AMILY_ASS_SIZE] < maxSizeCorr || (flags[kFLAGS.AMILY_ASS_SIZE] < maxSizeHypr && flags[kFLAGS.HYPER_HAPPY] != null))
            {
    ...
    public function giveAmilyAPurpleEgg() : Void
    {
        ...
        var maxSizePure : Float = 16;
        var maxSizeCorr : Float = 20;
        var maxSizeHypr : Float = 20;  //Realistically, the maximum supported hip size in the game is 20.  
        ...
        //(If Amily doesn't have "full, womanly hips":{
            ...
            if (flags[kFLAGS.AMILY_HIP_RATING] < maxSizePure || (flags[kFLAGS.AMILY_HIP_RATING] < maxSizeCorr && flags[kFLAGS.HYPER_HAPPY] != null))
            {
                ...
                if (flags[kFLAGS.AMILY_HIP_RATING] > maxSizeHypr && flags[kFLAGS.HYPER_HAPPY] != null)
                {
    ...
    private function giveAmilySomeReducto() : Void
    {
        ...
        menu();
        if (flags[kFLAGS.AMILY_CUP_SIZE] > 1)
        {
            addButton(0, "Breasts", amilyReducto, 0);
        }
        if (flags[kFLAGS.AMILY_NIPPLE_LENGTH] > 0.5)
        {
            addButton(1, "Nipples", amilyReducto, 1);
        }
        if (flags[kFLAGS.AMILY_HIP_RATING] > 6)
        {
            addButton(2, "Hips", amilyReducto, 2);
        }
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 4)
        {
            addButton(3, "Penis", amilyReducto, 3);
        }
        if (flags[kFLAGS.AMILY_ASS_SIZE] > 6)
        {
            addButton(4, "Butt", amilyReducto, 4);
        }
        addButton(14, "Never mind", amilyFollowerEncounter);
    }
    private function amilyReducto(part : Int) : Void
    {
        ...
        //Breasts{
            ...
            chosenPart = "breasts";
            if (flags[kFLAGS.AMILY_CUP_SIZE] > 6)
            {
                flags[kFLAGS.AMILY_CUP_SIZE]--;
            }  //Large breasts shrink more!  
            flags[kFLAGS.AMILY_CUP_SIZE]--;
            if (flags[kFLAGS.AMILY_CUP_SIZE] < 1)
            {
                flags[kFLAGS.AMILY_CUP_SIZE] = 1;
        ...
        //Nipples{
            ...
            chosenPart = "nipples";
            if (flags[kFLAGS.AMILY_NIPPLE_LENGTH] > 3)
            {
                flags[kFLAGS.AMILY_NIPPLE_LENGTH] -= 0.5;
            }  //Large nipples shrink more!  
            flags[kFLAGS.AMILY_NIPPLE_LENGTH] -= 0.5;
            if (flags[kFLAGS.AMILY_NIPPLE_LENGTH] < 0.5)
            {
                flags[kFLAGS.AMILY_NIPPLE_LENGTH] = 0.5;
        ...
        //Hips{
            ...
            chosenPart = "hips";
            if (flags[kFLAGS.AMILY_HIP_RATING] > 12)
            {
                flags[kFLAGS.AMILY_HIP_RATING]--;
            }  //Large hips shrink more!  
            flags[kFLAGS.AMILY_HIP_RATING]--;
            if (flags[kFLAGS.AMILY_HIP_RATING] < 6)
            {
                flags[kFLAGS.AMILY_HIP_RATING] = 6;
        ...
        //Penis{
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 10)
            {
                flags[kFLAGS.AMILY_WANG_LENGTH]--;
            }  //Large cock shrinks more!  
            flags[kFLAGS.AMILY_WANG_LENGTH]--;
            if (flags[kFLAGS.AMILY_WANG_LENGTH] < 4)
            {
                flags[kFLAGS.AMILY_HIP_RATING] = 4;
            }
            flags[kFLAGS.AMILY_WANG_GIRTH] = 1 + ((flags[kFLAGS.AMILY_WANG_LENGTH] - 4) / 9);
        }
        else if (part == 4)
        ...
        //Butt{
            ...
            if (flags[kFLAGS.AMILY_ASS_SIZE] > 10)
            {
                flags[kFLAGS.AMILY_ASS_SIZE]--;
            }  //Large butt shrinks more!  
            flags[kFLAGS.AMILY_ASS_SIZE]--;
            if (flags[kFLAGS.AMILY_ASS_SIZE] < 6)
            {
                flags[kFLAGS.AMILY_ASS_SIZE] = 6;
    ...
    private function get_clothes() : String
    {
        return (flags[kFLAGS.AMILY_CLOTHING] != null) ? "clothes" : (amilyCorrupt()) ? "sexy rags" : "rags";
    }
    ...
    public function giveAmilySomePants() : Void
    {
        ...
        if (amilyCorrupt() || flags[kFLAGS.AMILY_OWNS_BIKINI] == null && flags[kFLAGS.GIVEN_AMILY_NURSE_OUTFIT] == null)
        
        //never given anything else{
    ...
    private function amilyHips() : String
    {
        ...
        if (rando == 0)
        {
            if (rand(2) == 0 && flags[kFLAGS.AMILY_HIP_RATING] >= 15)
            {
                desc += "flanks";
            }
            else
    ...
    private function amilyBalls() : String
    {
        ...
        {
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 1 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 2)
            {
                desc += "large ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 2 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 3)
            {
                desc += "baseball-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 3 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 4)
            {
                desc += "apple-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 4 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 5)
            {
                desc += "grapefruit-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 5 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 7)
            {
                desc += "cantaloupe-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 7 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 9)
            {
                desc += "soccerball-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 9 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 12)
            {
                desc += "basketball-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 12 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 15)
            {
                desc += "watermelon-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 15 && flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] < 18)
            {
                desc += "beachball-sized ";
            }
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] >= 18)
            {
                desc += "hideously swollen and oversized ";
            }
        }
        else if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            desc += "fuzzy ";
        }
        rando = rand(9);
    ...
    {
        var temp : Int = as3hx.Compat.parseInt(Math.random() * 3);
        var descript : String = "";
        ...
        if (temp == 2)
        {
            if (flags[kFLAGS.AMILY_LACTATION_RATE] > 1.5)
            {
                descript += "milky ";
            }
            if (flags[kFLAGS.AMILY_CUP_SIZE] > 4)
            {
                descript += "tits";
            }
            else
        ...
        if (temp == 7)
        {
            if (flags[kFLAGS.AMILY_LACTATION_RATE] >= 1 && flags[kFLAGS.AMILY_LACTATION_RATE] < 2.5)
            {
                descript += "milk jugs";
            }
            if (flags[kFLAGS.AMILY_LACTATION_RATE] >= 2.5)
            {
                descript += "udders";
            }
    ...
    public function amilyCock() : String
    {
        ...
        if (rand(3) == 0)
        {
            if (flags[kFLAGS.AMILY_WANG_LENGTH] < 3)
            {
                descript = "squat ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 3 && flags[kFLAGS.AMILY_WANG_LENGTH] < 5)
            {
                descript = "short ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 5 && flags[kFLAGS.AMILY_WANG_LENGTH] < 7)
            {
                descript = "average ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 7 && flags[kFLAGS.AMILY_WANG_LENGTH] < 9)
            {
                descript = "long ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 10 && flags[kFLAGS.AMILY_WANG_LENGTH] < 13)
            {
                descript = "huge ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 13 && flags[kFLAGS.AMILY_WANG_LENGTH] < 18)
            {
                descript = "massive ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 18 && flags[kFLAGS.AMILY_WANG_LENGTH] < 30)
            {
                descript = "enormous ";
            }
            if (flags[kFLAGS.AMILY_WANG_LENGTH] >= 30)
            {
                descript = "towering ";
            }
        }
        ...
        //narrow, thin, ample, broad, distended, voluminous{
            ...
            if (flags[kFLAGS.AMILY_WANG_GIRTH] <= .75)
            {
                descript += "narrow ";
            }
            if (flags[kFLAGS.AMILY_WANG_GIRTH] > 1 && flags[kFLAGS.AMILY_WANG_GIRTH] <= 1.4)
            {
                descript += "ample ";
            }
            if (flags[kFLAGS.AMILY_WANG_GIRTH] > 1.4 && flags[kFLAGS.AMILY_WANG_GIRTH] <= 2)
            {
                descript += "broad ";
            }
            if (flags[kFLAGS.AMILY_WANG_GIRTH] > 2 && flags[kFLAGS.AMILY_WANG_GIRTH] <= 3.5)
            {
                descript += "fat ";
            }
            if (flags[kFLAGS.AMILY_WANG_GIRTH] > 3.5)
            {
                descript += "distended ";
            }
        }
    ...
    private function amilyNipples() : String
    {
        ...
        var nippleLength : Float = flags[kFLAGS.AMILY_NIPPLE_LENGTH];
        if (rand(4) == 0)
        ...
        var lactationRate : Float = flags[kFLAGS.AMILY_LACTATION_RATE];
    ...
    private function corruptAmilyOralSuckOff() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("tickling your balls with her " + (((flags[kFLAGS.AMILY_NOT_FURRY] == 0)) ? "fur" : "skin"));
        }
        ...
        {
            outputText("  However, even she has her limits. At one point Amily's throat just can't take in any more of you, and the rest of your shaft is left out of her mouth. She's determined to take in all of you however; and keeps trying to push more of your shaft inside, until you get tired of waiting and tell her to just start bobbing like a good slut. She immediately complies.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText(" balls churn and your");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            outputText("  Her belly distends and doesn't stop distending, nor does the flow of your cum ebb. For Amily, this is her purpose in life, to serve as a receptacle for your lusts, to serve you like a good cumbucket and take every little drop you pour into her. That thought only makes you cum harder.");
        }
    ...
    private function corruptAmilyLickPussiesLikeAPro() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("hardening " + Appearance.cockNoun(player.cocks[0].cockType) + " and ");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("and a jet of fluids shoots out of your sensitive pussy.");
        }
        else
        {
            outputText("moisture wetting your finger.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("lifts your [balls] to set them gently atop her head, ");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" and her small horns gently massage your " + ballsDescriptLight());
        }
        //[(if PC has a cock)
        if (player.hasCock())
        {
            outputText("; " + sMultiCockDesc() + " throbs and begins leaking pre; it forms small rivulets that run down onto Amily's head");
        }
        ...
        {
            outputText("You pull yourself off Amily's " + (((flags[kFLAGS.AMILY_NOT_FURRY] == 0)) ? "muzzle" : "face") + " and moan deeply.");
        }
        else
        {
            outputText("You let go of Amily's " + (((flags[kFLAGS.AMILY_NOT_FURRY] == 0)) ? "muzzle" : "face") + " and moan deeply.");
        }
    ...
    private function corruptAmilyScissorsLikeAPro() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" Amily's " + amilyCock() + " throbs,");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            ...
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
            {
                outputText(" and " + amilyBalls() + ", which you shift to reveal her ");
            }
            else
            {
                outputText(" before dipping down to her ");
            }
        }
        else
        {
            outputText("eyeing her ");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" almost as if trying to match its bigger brother above");
        }
        ...
        if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] >= 5)
        {
            outputText(" and a jet of warm juices splashes against your " + vaginaDescript());
        }
        // [Horsecock]
        ...
        if (player.hasCock())
        {
            outputText(" and an aching " + cockDescript(0));
        }
        ...
        if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] >= 5)
        {
            outputText("  A veritable jet of juices shoots up, splashing against your netherlips, some of it even making it inside.");
        }
        else
        {
            outputText("  Wet squeltches and splats resound around you, as the results of Amily's orgasm flood what little space remains between the two of you.");
        }
        //[(if Amily has a cock)
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" Her " + amilyCock() + " throbs and cum splashes on her breasts and face.");
        }
        outputText("\n\n");
        ...
        if (player.hasCock())
        {
            outputText("  Amily's hands shoot out to grab " + sMultiCockDesc() + " and begin masturbating you; the corrupt succu-mouse doing all she can to give you the release that you crave.");
        }
        outputText("\n\n");
        ...
        if (player.wetness() >= 5)
        {
            outputText(", drenching Amily's body in your fluids and marking her quite emphatically as your property");
        }
        outputText(".\n\n");
    ...
    private function corruptAmilysPussyGetsMotherfuckingFucked() : Void
    {
        ...
        {
            outputText("  Her gravid state doesn't faze her; indeed, she thrusts her bump forward proudly, a visible sign of your mastery over her.");
        }
        ...
        if (player.hasVagina())
        {
            outputText("  Your other hand probes your moist fuck-hole for lube to help with your stroking.");
        }
        outputText("\n\n");
        ...
        if (!pregnancy.isPregnant)
        {
            outputText("  I want you to fuck me full of cum, bloat me with seed until I'm a ball of skin over spooge with a head and limbs sticking out! I need to be full and round with the very stuff of life; fucking cum into me, [master]!");
        }
        //(If pregnant:
        else
        {
            outputText("  The babies need their cum, [Master]. They won't grow strong and healthy and slutty if you don't flood their womb with your hot baby-making juice! Please, cum and fill me with cum, for their sake?");
        }
        outputText("</i>\"\n\n");
        ...
        if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
        {
            outputText("  Her balls do get in the way, but they form a nice cushion to rub your [cock] on, further stimulating you.");
        }
        ...
        {
            outputText("Jojo wants to play,");
        }
        //(else)
        else
        {
            outputText("I can't find someone else to play with,");
        }
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] >= 5)
            {
                outputText("  Jets of fluid wash down whatever pre escapes your rigid tool.");
            }
        ...
        if (player.hasBalls())
        {
            outputText("your balls slap against her butt and ");
        }
        ...
        if (pregnancy.isPregnant)
        {
            outputText("  You wonder if your unborn children will appreciate their bath. Their mother certainly does.");
        }
        //(If not squirter:
        if (flags[kFLAGS.AMILY_VAGINAL_WETNESS] < 5)
        {
            outputText("  Her fluids slop wetly over your crotch, painting between your legs with her lubricant.");
        }
        //(If squirter:
        else
        {
            outputText("  A cascade of fluids pours from inside her; if you had allowed her to ride atop you, you'd be sopping with her femcum.");
        }
        //(If Amily is herm:
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("  It doesn't take long - seconds, at most - before her pulsing, twitching cock finally explodes, spewing gush after gush of herm-spunk all over her tits and face, which Amily eagerly laps up.");
        }
        outputText("\n\n");
        ...
        //(if Amily is not pregnant){
            ...
            if (!pregnancy.isPregnant)
            {
                outputText("  Amily's womb is so full of cum that it's bloated as if she was carrying a full litter of mousy sluts ready to birth.");
            }
            //(else)
            else
            {
                outputText("  Amily's belly looks ready to explode; besides the litter she's carrying, you've also filled her with enough cum to feed the little mousy sluts for week.");
            }
        }
        ...
        if (player.hasVagina())
        {
            outputText("  Despite being neglected during the act, your " + vaginaDescript() + " leaks fluids to join Amily's on the floor.");
        }
        ...
        if (!pregnancy.isPregnant)
        {
            outputText("  I can only hope you've knocked me up, so I can do what I was made for,");
        }
        else
        {
            outputText("  I almost wish I wasn't pregnant, just so I could have the pleasure of knowing you've knocked me up,");
        }
        ...
        if (player.hasVagina())
        {
            outputText("  Once she's done with your cock she begins licking your thighs; ensuring none of your precious juices go to waste.");
        }
    ...
    private function corruptAmilyCampBonesPCWithHerCock() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
        {
            outputText("  A pair of balls hangs under Amily's shaft; as you look, you have the slightest impression that her balls became rounder, fuller...");
        }
        outputText("  Amily's shaft is ");
        if (flags[kFLAGS.AMILY_WANG_LENGTH] < 6)
        {
            outputText("small");
        }
        else if (flags[kFLAGS.AMILY_WANG_LENGTH] < 9)
        {
            outputText("average");
        }
        else
        ...
        if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
        {
            outputText(", and her balls seeingly inflate");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] * flags[kFLAGS.AMILY_WANG_GIRTH] > player.vaginalCapacity())
        {
            outputText("  You growl at her rough penetration, Amily stretches you out without regards for your pleasure; you'll definitely have to punish her for this later...");
        }
        outputText("\n\n");
        ...
        if (player.wetness() >= 5)
        {
            outputText(", the sounds of your fem-lube slurping and squelching as she smears it over herself and makes it splash out onto the ground beneath you");
        }
        //(if Amily has balls:
        if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
        {
            outputText(" and the meaty smack-smack-smack of her balls slapping against your " + assDescript());
        }
        outputText(".\n\n");
        ...
        if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
        {
            outputText("The slapping of her balls on your ass reverberates around you.  ");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("  Your jets of femcum wash down all the seed Amily spills inside you, pushing it all out around her cock and painting Amily's lower body in juice and cum.");
        }
        ...
        if (player.isBiped())
        {
            outputText("  You begin stroking her limp dick with your [foot], ");
        }
        //(else)
        else
        {
            outputText("  You reach down and begin stroking her limp dick with your hands, ");
        }
        ...
        if (player.hasCock())
        {
            outputText("  If she did, you might have to return the favor...");
        }
        //(else)
        else
        {
            outputText("  If she did, you'll just have to tie her up and get someone to return the favor...");
        }
        //Preg chanceeee
        if (player.hasUniquePregnancy())
        {
    ...
    private function corruptAmilyBuckFutter() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("; her " + amilyCock() + " stands erect, a tiny bead of pre forming on the tip as it throbs");
        }
        outputText("\n\n");
        ...
        else
        {
            ...
            if (player.hasBalls())
            {
                outputText("and your [balls] slap against her pussy, causing her juices to squirt all over them.");
            }
            else
            {
                outputText(" and draw back before violently plunging back in.  Her juices squirt all over you.");
            }
        }
        outputText("\n\n");
        ...
        if (player.cumQ() >= 750)
        {
            outputText("Her belly begins filling and inflating, not stopping even as she starts to look 6 months pregnant. Her ass clenches around you, trying to prevent the massive load you're still depositing from escaping, but inevitably, a few weak jets escape from around your [cock].  ");
        }
        outputText("You spill your last jets with a couple more hard thrusts and then pull out of Amily's ass.");
        //[(if PC has large cum amount)
        if (player.cumQ() >= 1000)
        {
            outputText("  Some cum backflows out of her ass in a jet, before she plugs herself with a hand, attempting to hold everything in.");
        }
        else
        {
            outputText("  Some cum begins leaking out of her ass, before she plugs herself with a hand.");
        }
        outputText("\n\n");
        ...
        if (player.cumQ() >= 750)
        {
            outputText(" heavy belly jiggling along her breasts, ");
        }
        else
        {
            outputText(" boobs jiggling, ");
        }
        ...
        if (player.hasBalls())
        {
            outputText(" and her spilled juices from your balls");
        }
    ...
    private function amilyLesboLetHerGo() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_AFFECTION] > 10)
        {
            flags[kFLAGS.AMILY_AFFECTION] = 10;
        }
        endEncounter();
    ...
    public function girlyGirlMouseSex() : Void
    {
        ...
        if (player.gender == 3 && flags[kFLAGS.AMILY_WANG_LENGTH == 0] != null)
        {
            outputText("You suggest using your other sex this time.  ");
        }
        else if (player.gender == 3 && flags[kFLAGS.AMILY_WANG_LENGTH == 0] != null)
        {
            outputText("You suggest indulging in your feminine parts.  ");
        }
        //(If first time:
        if (flags[kFLAGS.AMILY_TIMES_FUCKED_FEMPC] == 0)
        {
            outputText("Amily stops and lets go of your hand, blushing faintly and looking embarrassed. \"<i>So, ah... how do we do this? I... I've never been attracted to another woman before, how does sex even work between us?</i>\"\n\n");
        }
        else
        {
            outputText("\"<i>Remember how you had to take charge the first time?</i>\" She grins. \"<i>Care to see if you've still got it?</i>\"\n\n");
        }
        ...
        if (flags[kFLAGS.AMILY_TIMES_FUCKED_FEMPC] == 0)
        {
            outputText("\"<i>...I'm supposed to lick you there, right?</i>\" Amily asks, hesitantly. You smirk and promptly give her own sex a long, sloppy lick of your own. She squeaks in shock and then clumsily licks you in return.\n\n");
        }
        else
        {
            outputText("Amily needs no instructions and plunges her tongue as deeply as it can go into your sex. You yelp in shock, which makes Amily's tail wave happily, and, grinning mischievously, you return the favor.\n\n");
        }
        ...
        if (flags[kFLAGS.AMILY_TIMES_FUCKED_FEMPC] == 0)
        {
            outputText("\"<i>...I didn't know it could feel so good with another woman.... But I was never attracted to women before.</i>\" Amily murmurs to herself.\n\n");
        }
        else
        {
    ...
    public function hermilyOnFemalePC() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
        {
            outputText("\"<i>I can't believe this is actually happening... I've grown a cock and I'm about to use it on another woman.</i>\" Amily mutters to herself, though it's very evident that she likes what she sees, unable to resist staring at your " + chestDesc() + " or your " + vaginaDescript() + ".\n\n");
        }
        else
        {
            outputText("\"<i>I still can't believe that I'm burying this hot, throbbing thing in another woman's pussy... More than that, I think I'm actually starting to like it.</i>\" Amily comments to herself, staring unabashedly at your curves.\n\n");
        }
        ...
        if (player.gender == 3)
        {
            if (flags[kFLAGS.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
            {
                outputText("\"<i>How on earth did I let myself get talked into this? If you've got both a cock and a pussy, then what's wrong with you just filling me with that cock?</i>\" Amily mutters to herself. Despite her words, though, her gaze is fixed squarely on your " + vaginaDescript() + ".\n\n");
            }
            //else
            else
            {
                outputText("\"<i>You know, it's not all bad, us both being this way... but remember that I want a turn at that, too.</i>\" She states, staring hungrily at your [cocks].\n\n");
            }
        }
        ...
        if (player.isBiped())
        {
            outputText(player.legs() + " in readiness for her.");
        }
        else
        {
            outputText(" [cunt] in readiness for her.");
        }
        ...
        if (flags[kFLAGS.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
        {
            outputText("\"<i>...I had no idea it would feel like that,</i>\" she gasps softly.\n\n");
        }
        else
        {
            outputText("\"<i>It gets me every time when that happens. Is this what it's like for men?</i>\" she wonders.\n\n");
        }
        ...
        if (player.isPregnant())
        {
            ...
            {
                outputText("\"<i>After you give birth to this baby come and see me when you're ready for mine.  This is really weird, I'm a woman and I can't wait to be a dad.");
            }
        }
        //not preg yet!
        else
    ...
    public function pcBirthsAmilysKidsQuestVersion(womb : Int = 0) : Void
    {
        ...
        {
            flags[kFLAGS.PC_TIMES_BIRTHED_AMILYKIDS] += 2;
        }
        else
        {
    ...
    public function postBirthingEndChoices() : Void
    {
        ...
        if (player.gender == 2)
        {
            outputText("another woman");
        }
        //, if player is herm:
        else
        {
            outputText("a hermaphrodite");
        }
    ...
    private function amilyNewGenderConfrontation() : Void
    {
        ...
        clearOutput();
        //Remember old gender.
        var oldGender : Float = flags[kFLAGS.AMILY_PC_GENDER];
        ...
        //[Herm to Male]{
            ...
            //Low Affection:{
                ...
                if (flags[kFLAGS.AMILY_AFFECTION] < 15)
                {
                    ...
                    if (flags[kFLAGS.AMILY_HERM_QUEST] == 2)
                    {
                        flags[kFLAGS.AMILY_OFFER_ACCEPTED] = 1;
                    }
                }
        ...
        else
        {
            ...
            else
            {
                ...
                if (player.hasCock())
                {
                    outputText("bringing your [cock] to erection");
                }
                ...
                if (player.hasVagina())
                {
                    outputText("earning a clench from your " + vaginaDescript(0));
                }
    ...
    private function playerBirthsWifAmilyMiceInCamp() : Void
    {
        ...
        if (flags[kFLAGS.PC_TIMES_BIRTHED_AMILYKIDS] > 0)
        {
            outputText("this is hardly the first time you've given birth to her offspring before, after all");
        }
        //First time!
        else
        {
            outputText("she's probably just glad you're the one that has to push them all out");
        }
    ...
    public function amilyPopsOutKidsInCamp() : Void
    {
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_INCEST_COUNTDOWN_TIMER] == 0)
            {
                flags[kFLAGS.AMILY_INCEST_COUNTDOWN_TIMER] = 1;
            }
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText("  She has hold of her cock with both hands and is furiously jacking herself off, spurts of cum spilling like a fountain; then spattering onto her heaving breasts, face and belly, even though her erection refuses to die away.");
            }
            //[If Amily has balls:
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
            {
                outputText("  Her testicles shake and quiver, swaying in the breeze as the pussy behind them readies itself to disgorge the life crammed into her swollen stomach above.");
            }
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText(" followed by a spurt of cum");
            }
            ...
            if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
            {
                outputText(" it grabs Amily's balls and uses them to try and pull itself out;");
            }
            ...
            if (player.hasCock() && (player.gender == 1 || rand(2) == 0))
            {
                ...
                if (player.hasVagina())
                {
                    outputText(" and " + vaginaDescript(0));
                }
                ...
                if (player.cumQ() >= 500)
                {
                    outputText("  Her belly distends, but she continues drinking and suckling as efficiently as ever; making sure not to spill even a single drop of her [master]' precious seed; the sight is enough to make you swell with pride at how seriously Amily takes her job; you decide to reward her with even more spunk.");
                }
                outputText("\n\n");
            }
            //[=Pussy=]
            else
            {
                ...
                if (player.hasBalls())
                {
                    outputText("  She gives your balls a teasing lick, tickling you; impatient, you tell her to get on with it before you change your mind and go fuck something else.");
                }
                ...
                if (player.wetness() >= 5)
                {
                    outputText("  Amily has no problem dealing with the constant jets of girl-cum that spill from your pussy, in fact she does all she can to make sure you shoot as many of those as possible into her hungry maw; you're pleased to notice that not even a small drop escapes her searching tongue and slurping maw.");
                }
                outputText("\n\n");
            }
    ...
    private function meetAmilyAsACorruptAsshat() : Void
    {
        ...
        if (!player.hasPerk(PerkLib.Evade) && !player.hasPerk(PerkLib.Flexibility))
        {
            ...
            if (player.inte >= 40)
            {
                outputText("You begin to formulate a plan, but to put this plan into motion you'll require a Lust Draft and some Goblin Ale. That damn rat is going to rue the day she denied you.\n\n");
            }
            //-(else)
            else
            {
                outputText("You think about some of the more interesting potions you found while exploring; perhaps you could use some of them...");
            }
        }
        //(else)
        else
    ...
    private function cookAmilyASnack() : Void
    {
        ...
        //After raping Amily for the first time, she is commited to the path of corruption.{
            ...
            else
            {
                ...
                if (player.hasVagina())
                {
                    outputText("your " + vaginaDescript() + " moistens itself ");
                }
                ...
                if (player.hasCock())
                {
                    ...
                    if (player.hasVagina())
                    {
                        outputText("  Not yet fully sated, you decide that it couldn't hurt to add something 'girly' to the mixture...");
                    }
                    outputText("\n\n");
                }
                //[Female]
        ...
        else
        {
            ...
            else
            {
                ...
                if (player.hasItem(consumables.L_DRAFT))
                {
                    outputText("Lust Draft ");
                }
                else
                {
                    outputText("Fuck Draft ");
                }
                ...
                if (player.hasCock())
                {
                    outputText(cockDescript(0) + " jumps up to attention");
                }
                ...
                if (player.hasVagina())
                {
                    outputText(vaginaDescript() + " nearly juices itself");
                }
    ...
    private function harvestMilk() : Void
    {
        ...
        if (flags[kFLAGS.FARM_UPGRADES_REFINERY] == 0)
        {
        ...
        if (flags[kFLAGS.FARM_UPGRADES_REFINERY] == 1)
        {
    ...
    private function talkWithCORRUPTCUNT() : Void
    {
        ...
        else if (convo == 5)
        {
            ...
            if (player.biggestCockArea() < 24 && player.hasCock())
            {
                outputText("\"<i>[Master], can you grow a bigger cock to fuck your loyal cumdumpster?</i>\"");
            }
            //(else if PC has a dick >= 24 area)
            else if (player.hasCock())
            {
                outputText("\"<i>[Master] I'm so horny, can you take your huge cock and jam it into your slutty mouse slave?</i>\"");
            }
            //(else)
            else
            {
                outputText("\"<i>[Master], can you grow a huge dick to fuck your needy cumslut?</i>\"");
            }
        ...
        else if (convo == 7)
        {
            ...
            if (pregnancy.isPregnant)
            {
                outputText("  I can't wait to give birth to this batch of mice, just so I can get pregnant again.");
            }
            //(else)
            else
            {
                outputText("  Can you please knock me up? I don't care how, just order me to fuck until I get pregnant.");
            }
            outputText("</i>\"\n\n");
    ...
    public function conquerThatMouseBitch() : Void
    {
        ...
        {
            outputText("Amily falls on the ground, unconscious. You drag the mousette towards an empty spot in her hideout. You smile as you strip her clothes off, then you find a rope to tie her up. You tie her hands together, then tie her hands to her ankles, ensuring she won't be able to fight you back. After that, you dispose of anything that could be used as a weapon, or could aid her in her escape, then sit down on a nearby stool to wait until she's recovered her consciousness. After all, it's much more fun if she's awake to see everything you'll do to her...\n\n");
        }
        //By Lust:
        else
        {
            outputText("Amily lets go of her knife and begins masturbating in earnest, too horny to fight. You walk up to her, pick up one of her darts and stab her, knocking her out. You drag the mousette towards an empty spot in her hideout. You smile as you strip her clothes off, then you find a rope to tie her up. You tie her hands together, then tie her hands to her ankles, ensuring she won't be able to fight you back. After that you dispose of anything that could be used as a weapon, or could aid her in her escape, then sit down on a nearby stool to wait until she's recovered her consciousness.  After all, it's much more fun if she's awake to see everything you'll do to her...\n\n");
        }
        //Amily gives XP and Gems normally; but you have no option, you always rape her.
        if (flags[kFLAGS.AMILY_CORRUPTION] != 0)
        {
            throw new Error("Svalkash fucked up after all, please report this and ping him on Discord.");
        }
    ...
    private function rapeCorruptAmily1() : Void
    {
        ...
        if (player.cockTotal() > 0)
        {
            if (player.cockTotal() > 1)
            {
                outputText(multiCockDescriptLight() + " are");
            }
            else
            {
                outputText(cockDescript(0) + " is");
            }
        ...
        if (player.hasVagina())
        {
            outputText(vaginaDescript() + " is already wet");
        }
    ...
    private function rapeCorruptAmily1Male() : Void
    {
        ...
        {
            outputText("- you're quite surprised she managed to fit it in at all.");
        }
        else
        {
            outputText(".");
        ...
        if (player.hasBalls())
        {
            outputText(ballsDescriptLight() + " churn");
        }
        else
        {
            outputText(cockDescript(x) + " throb");
        }
    ...
    private function rapeCorruptAmily1Female() : Void
    {
        ...
        if (player.wetness() >= 5)
        {
            outputText(", a jet of fluids escape your lower lips and hit her straight in the face; but she pays no mind");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("She tries to gulp down everything she can, but ultimately a lot of it escapes her mouth and ends up on her face and all around her.  ");
        }
    ...
    private function rapeCorruptAmily2Male() : Void
    {
        ...
        {
            outputText("Despite your size, she presses forward to take in as much of you as possible.  ");
        }
        ...
        if (player.cockThatFits(61) < 0)
        {
            outputText("is possible.");
        }
        //(else)
        else
        {
            outputText("you have to offer.");
        }
        outputText("\n\n");
        ...
        if (player.cockThatFits(61) < 0)
        {
            outputText("  One of Amily's hands settles on your " + cockDescript(x) + ", stroking whatever she doesn't manage to swallow.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("Amily grabs your balls and begins kneading them.  ");
        }
        //(else if PC has a pussy)
        else if (player.hasVagina())
        {
            outputText("Amily shoves her fingers into your " + vaginaDescript() + ".  ");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  Just the thought of it is enough to make your balls churn.");
        }
        ...
        if (player.cumQ() >= 750)
        {
            outputText("  You feel your enourmous load coming back through her throat and spilling from her mouth and nose, smearing your crotch as you pull away to let her breathe.");
        }
        outputText("\n\n");
        if (!recalling)
        {
    ...
    private function rapeCorruptAmily2Female() : Void
    {
        ...
        if (player.wetness() >= 5)
        {
            outputText("  Your juices rocket into her face, painting her " + (((flags[kFLAGS.AMILY_NOT_FURRY] == 0)) ? "muzzle" : "face") + " in your femcum as she giggles with happiness and pleasure.");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText(", giving Amily a juice bath; even if the mousy cunt did get better at drinking, there is no way she'd be able to drink all of your fluids");
        }
        outputText(".");
        //(else)
        if (player.wetness() < 5)
        {
            outputText("  A flood of juices escape your pussy and go directly into the mousy cunt's hungry maw, however, some of it spills; even if Amily did get better at drinking, she's still a long way from being the perfect fucktoy you want her to be.");
        }
        outputText("\n\n");
        ...
        if (player.wetness() >= 5)
        {
            outputText("  Your orgasm lasts much longer than usual. Eventually you release Amily and finish off on top of her head.\n\n");
        }
        if (!recalling)
        {
            player.sexReward("saliva", "Vaginal");
    ...
    private function rapeCorruptAmily3Male() : Void
    {
        ...
        if (player.biggestCockArea() >= 61)
        {
            outputText("  She can't get her breasts all the way around though, still she doesn't stop, determined to do as you ordered.");
        }
        outputText("\n\n");
        ...
        {
            outputText("You didn't think it was possible, but somehow ");
        }
        ...
        if (player.hasBalls())
        {
            outputText("your " + ballsDescriptLight());
        }
        else if (player.hasVagina())
        {
        ...
        {
            outputText("the base of your shaft");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] churn with cum, growing heavier with every nasty detail that goes through your mind.");
        }
        ...
        if (player.cumQ() >= 750)
        {
            outputText("  You keep pumping and she keeps drinking; her distended belly doesn't stop growing until she looks heavily pregnant and you're spent.");
        }
        outputText("\n\n");
        if (!recalling)
        {
    ...
    private function rapeCorruptAmily3Female() : Void
    {
        ...
        if (player.wetness() >= 5)
        {
            outputText("you show her your enjoyment by spurting a jet of femcum all over her breasts, washing them with sexual lubricant. Amily can't help but smile as she looks at her now glistening breasts.");
        }
        //(else)
        else
        {
            outputText("moisture gathers and drips over Amily's sensitive nipples, causing the mousette to sigh in pleasure and smile as she looks at her wet nipples.");
        }
        outputText("\n\n");
        ...
        {
            outputText("Amily then crushes your sensitive clit between her breasts, working her mounds over it like it was a cock. You gasp and moan as Amily smiles up at you, happy to see your reaction to her stimulation.");
        }
        //(else)
        else
        {
            outputText("Amily decides to tease your sensitive clit with her wet nipples, circling the little nub and sending electric shocks up your spine; you can't help but moan; Amily just smiles and grinds her generous breasts harder against your pussy.");
        }
        outputText("\n\n");
        ...
        if (player.wetness() >= 5)
        {
            outputText("  Her nose bumps against your clit, causing you to release a jet of juices up the mousette's throat. To your surprise, she doesn't spill even a single drop and happily gulps all of it down.");
        }
        ...
        if (player.wetness() >= 5)
        {
            outputText("  You keep on spilling more and more juices; at one point you worry you might become dehydrated, but the pleasure of your overwhelming orgasm is enough to make you push the thought away. Amily doesn't stop drinking, even as her belly begins distending. You keep cumming until you are spent.");
        }
        outputText("\n\n");
        if (!recalling)
        {
    ...
    private function rapeCorruptAmily4Male() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(" and " + ballsDescriptLight());
        }
        outputText(".\n\n");
        ...
        if (player.biggestCockArea() > 50)
        {
            outputText("  You smirk, pleased; with your size, you'd probably choke whomever tried to swallow your [cock] to death. But Amily doesn't choke or gag, she's only capable of moaning in delight with each inch that she manages to fit inside her hungry maw.");
        }
        outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("  Sometimes you even feel her nipples brush your balls teasingly.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  One of her hands even begins kneading your balls, attempting to coax even more out of you.");
        }
        outputText("\n\n");
        ...
        if (player.cor < 80 && !recalling)
        {
            ...
            if (player.cumQ() >= 750)
            {
                outputText("her belly distended to the point that she looks pregnant and just about ready to give birth.");
            }
            //(else)
            else
            {
                outputText("her belly filled with the huge load you just dumped in her.");
            }
            outputText("\n\n");
        ...
        if (player.isNaga())
        {
            outputText("coil your serpentine tail around her head.");
        }
        else if (player.lowerBody == LowerBody.GOO)
        {
            outputText("engulf her maw in slime.");
        }
        else
        {
            outputText("put a [foot] on her head.");
        }
    ...
    private function rapeCorruptAmily4Female() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("  Pulling back enough to give your balls a teasing lick.");
        }
        outputText("\n\n");
        ...
        if (player.wetness() >= 5)
        {
            outputText("wet her face with a small jet of juices.");
        }
        //(else)
        else
        {
            outputText("even wetter.");
        }
        ...
        if (player.clitLength >= 4)
        {
            outputText("  One of her hands begins stroking your erect clit as if it was a cock. The pleasure of the act nearly overloads your senses.");
        }
        outputText("\n\n");
        ...
        if (player.wetness() >= 5)
        {
            outputText("  Amily barely has to work to drink your juices, your pussy jets them forth with such force that all of them go straight through Amily's mouth and into her throat.");
        }
        //(else)
        else
        {
            outputText("  Amily drinks from you like a parched man drinks from a well.");
        }
        ...
        if (player.cor < 80 - player.corruptionTolerance && !recalling)
        {
            ...
            if (player.wetness() >= 5)
            {
                outputText("her belly distended from the immense amount of femcum she just drank.");
            }
            //(else)
            else
            {
                outputText("her belly slightly distended from the flood of juices you just dumped in her.");
            }
            outputText("\n\n");
        ...
        if (player.hasBalls())
        {
            outputText("  She ignores your balls for the moment, so concentrated in her task, that she barely notices them resting on top of her head.");
        }
    ...
    private function rapeCorruptAmily4Epilogue() : Void
    {
        ...
        {
            outputText("her feet are forced into a perpetual tip-toe as the trademark demonic bone juts from her heel");
        }
        ...
        if (!recalling)
        {
            ...
            {
                player.knockUpForce(PregnancyStore.PREGNANCY_MOUSE, player.pregnancy2Incubation, 1);
            }
    ...
    public function stalkingZeAmiliez2() : Void
    {
        ...
        else
        {
            ...
            if (player.hasVagina())
            {
                outputText(vaginaDescript() + " growing wet");
            }
            outputText(".\n\n");
            ...
            if (player.hasVagina())
            {
                outputText(" dripping " + vaginaDescript());
            }
            ...
            {
                simpleChoices("MaleFocus", rapeCorruptAmily2Male, "FemaleFocus", rapeCorruptAmily2Female, "", null, "", null, "", null);
            }
        }
    }
    ...
    public function stalkingZeAmiliez3() : Void
    {
        ...
        if (player.hasVagina())
        {
            outputText(" moistening your " + vaginaDescript());
        }
        ...
        {
            simpleChoices("MaleFocus", rapeCorruptAmily3Male, "FemaleFocus", rapeCorruptAmily3Female, "", null, "", null, "", null);
        }
    }
    ...
    private function amilyCanHaveTFNow() : Bool
    //<b>golden seed</b> for a human face
    {
        
        // <b>black egg</b> to get rid of the fur
        // some purified <b>succubus milk</b> to round things off
        return flags[kFLAGS.AMILY_NOT_FURRY] ==0
        && flags[kFLAGS.AMILY_OFFERED_DEFURRY] ==1
        &&player.hasItem(consumables.GLDSEED)
        && (player.hasItem(consumables.BLACKEG) || player.hasItem(consumables.L_BLKEG))
        && (player.hasItem(consumables.P_S_MLK) || (amilyCorrupt() && player.hasItem(consumables.SUCMILK)))  // And we have all the shit we need    // Amily has been offered to be dehaired    // Amily isn't already defurried  ;
    }
    ...
    private function amilyDefurrify() : Void
    {
        ...
        {
            player.consumeItem(consumables.L_BLKEG);
        }
        if (amilyCorrupt())
        {
            if (player.hasItem(consumables.SUCMILK))
...
*/
    ...
    public function amilyDefurryOfferAtCamp() : Void
    {
        clearOutput();
        amilySprite();
        if (flags[kFLAGS.AMILY_OFFERED_DEFURRY] <= 0)
        {
            flags[kFLAGS.AMILY_OFFERED_DEFURRY] = 1;
        }
        if (!amilyCanHaveTFNow())
    ...
    public function amilyHenchmanOption() : Void
    {
        ...
        {
            if (flags[kFLAGS.PLAYER_COMPANION_2] == "Amily" || flags[kFLAGS.PLAYER_COMPANION_3] == "Amily")
            {
                addButtonDisabled(0, "Team (1)", "You already have Amily accompany you.");
            }
            else
            {
                addButton(0, "Team (1)", amilyHenchmanOption2, 1).hint("Ask Amily to join you in adventures outside camp.");
            }
        }
        else if (flags[kFLAGS.PLAYER_COMPANION_1] == "Amily")
        {
            addButton(5, "Team (1)", amilyHenchmanOption2, 21).hint("Ask Amily to stay in camp.");
        }
        else
        {
            addButtonDisabled(5, "Team (1)", "You already have other henchman accompany you as first party member. Ask him/her to stay at camp before you talk with Amily about accompaning you as first party member.");
        }
        if (player.hasPerk(PerkLib.IntermediateLeadership))
        {
            if (flags[kFLAGS.PLAYER_COMPANION_2] == "")
            {
                if (flags[kFLAGS.PLAYER_COMPANION_1] == "Amily" || flags[kFLAGS.PLAYER_COMPANION_3] == "Amily")
                {
                    addButtonDisabled(1, "Team (2)", "You already have Amily accompany you.");
                }
                else
                {
                    addButton(1, "Team (2)", amilyHenchmanOption2, 2).hint("Ask Amily to join you in adventures outside camp.");
                }
            }
            else if (flags[kFLAGS.PLAYER_COMPANION_2] == "Amily")
            {
                addButton(6, "Team (2)", amilyHenchmanOption2, 22).hint("Ask Amily to stay in camp.");
            }
            else
            {
                addButtonDisabled(6, "Team (2)", "You already have other henchman accompany you as second party member. Ask him/her to stay at camp before you talk with Amily about accompaning you as second party member.");
            }
        }
        else
        {
    ...
    public function amilyHenchmanOption2(slot : Float = 1) : Void
    {
        clearOutput();
        if (slot < 21)
        {
            ...
            var strAmily : Float = 40;
            var libAmily : Float = 44;  /*
            ...
            if (slot == 2)
            {
                flags[kFLAGS.PLAYER_COMPANION_2] = "Amily";
            }
            if (slot == 1)
            {
    ...
    public function dateNightFirstTime() : Void
    {
        ...
        if (model.time.hours >= 18)
        {
            outputText("despite the late hour, bustling with centaurs and canine-morphs going about their business, heading home after a long day's work or making their way to the Wet Bitch for a relaxing drink.\n\n");
        }
        else if (model.time.hours < 6)
        {
            outputText("despite the early time, bustling with centaur and canine-morphs on their way to their pre-dawn activities.");
        }
        else if (model.time.hours < 12)
        {
            outputText("despite the morning hours, busy with centaur and canine-morphs hurrying to their own personal tasks.");
        }
        else
        {
            outputText(" with centaur and canine-morphs busy with their own tasks.");
        }
        ...
        {
            outputText("a passing waitress");
        }
        else
        {
            outputText("a rather alarmed Vala as she flutters by");
        }
    ...
    private function liqueurUpTheWaifus() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText(", already feeling a strong stirring in your " + multiCockDescriptLight());
        }
        else if (player.hasVagina())
        {
            outputText(", already feeling a little moisture in your loins");
        }
        outputText(".\n\n");
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText("through the mouse's fur ");
        }
        else
        {
            outputText("over the mouse's skin ");
        }
        ...
        if (player.hasCock())
        {
            addButton(0, "Use Cock", threesomeAmilUrtaCAWKS);
        }
        if (player.hasVagina())
        {
            addButton(1, "Use Vagina", urtaXAmilyCuntPussyVagSQUICK);
        }
    ...
    {
        clearOutput();
        var x : Float = player.cockThatFits(60);
        if (x < 0)
        {
        ...
        {
            outputText("filling her until she just can't take any more of you");
        }
        else
        {
            outputText("burying yourself up to the hilt in her sweet, wonderfully tight bum");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" as her cock orgasms, too, spurting a nice, thick trail of mousecum all over Urta's face and tits");
        }
        outputText(".\n\n");
    ...
    public function pureAmilyPutsItInYourRectumDamnNearKilledEm() : Void
    {
        ...
        if (player.tailType > Tail.NONE)
        {
            outputText(", moving your tail out of the way");
        }
        outputText(".\n\n");
        ...
        if (flags[kFLAGS.AMILY_TIMES_BUTTFUCKED_PC] == 0)
        {
            outputText("looks a bit puzzled as she contemplates the mechanics of this for a moment, and then with a shrug, ");
        }
        ...
        {
            outputText("Bracing yourself a bit, you grimace a little as you feel Amily start to push against your " + assholeDescript() + ", just the tip sliding in with a bit of resistance.");
        }
        else if (player.analCapacity() <= 60)
        {
            outputText("You relax yourself, letting out a husky moan as you feel the tip of Amily's cock sliding into you.");
        }
        else
        {
            outputText("Amily lets out a slightly surprised squeak as your " + assholeDescript() + " offers her little resistance.");
        }
        ...
        {
            outputText(", though you are sure you could easily handle her without it");
        }
        ...
        if (flags[kFLAGS.AMILY_TIMES_BUTTFUCKED_PC] == 0)
        {
            outputText("\"<i>Is this okay? Ah... it feels... really good...</i>\" she says with a low moan, to which you reply with a pleasure-filled groan of your own.\n\n");
        }
        ...
        if (player.hasCock())
        {
            ...
            if (player.cockTotal() > 1)
            {
                outputText("She brushes along " + sMultiCockDesc() + " one at a time, stroking for a moment or two before switching off.");
            }
        }
        outputText("\n\n");
        ...
        if (player.gender > 0)
        {
            outputText(", forming a small puddle underneath you as you feel your climax approaching.");
        }
        ...
        if (player.hasCock())
        {
            ...
            if (player.cumQ() < 250)
            {
                outputText("a few streams");
            }
            else if (player.cumQ() < 500)
            {
                outputText("a small deluge");
            }
            else
            {
                outputText("a small lake");
            }
            outputText(" of cum.");
        }
        outputText("\n\n");
    ...
    {
        clearOutput();
        var x : Float = player.cockThatFits(50);
        if (x < 0)
        {
            x = 0;
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("  Her pants tent from arousal as her male organ reacts to your sensual touching, and you start to teasingly stroke it as well.");
        }
        outputText("\n\n");
        ...
        if (flags[kFLAGS.TIMES_FUCKED_AMILYBUTT] == 0)
        {
            outputText("  \"<i>I'm... not really sure how this goes... I guess... like this?</i>\"");
        }
        ...
        if (flags[kFLAGS.TIMES_FUCKED_AMILYBUTT] == 0)
        {
            outputText("\"<i>Aah... ah... that feels really weird,</i>\" she pants, noticeably struggling against the instinct to clench up against the invader. \"<i>Ah... not... bad... just weird...</i>\"\n\n");
        }
        else
        {
            outputText("\"<i>Ahhn... it's still weird... but I just might be starting to like it...</i>\"\n\n");
        }
        ...
        if (player.cumQ() <= 250)
        {
            outputText("your " + cockDescript(x) + " twitching and throbbing as you paint her insides with a few strands of cum");
        }
        else if (player.cumQ() <= 500)
        {
            outputText(" the swell of your orgasm pushing past her sphincter as you unload a thick deluge into her back door");
        }
        else
        {
            outputText(" the volume of your virile jism filling her innards with warmth as she begins to gain a slight bulge in her abdomen");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("her own member twitch and dribble a small puddle of clear pre-cum onto the ground below her, joining with ");
        }
        ...
        if (player.cumQ() > 500)
        {
            outputText(" and gently stroking along the curves of her belly with a smile");
        }
        outputText(".");
        player.sexReward("vaginalFluids", "Dick");
        dynStats("sen", -2);
    ...
    private function amilyIncest() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText("through her mother's fur");
        }
        else
        {
            outputText("over her mother's thigh");
        }
        ...
        if (player.hasCock())
        {
            ...
            {
                outputText("[pg]Sadly, you're too big to fuck any of them.");
            }
        }
        else
        {
            outputText("[pg]If only you had a cock, you could fuck them all.");
        }
        addButton(4, "Leave", playerMenu);
    }
    //Fuck Cunts/All (extra pg or two) (Z)
    private function fuckIncestCunts(all : Bool) : Void
    {
        var x : Float = player.cockThatFits(61);
        if (x < 0)
        {
        ...
        if (!all)
        {
            outputText("tell Amily to send the male away - you've got pussies to fuck.  She squeaks in excitement, barely noticing as her son tramps off.");
        }
        else
        {
            outputText("tell Amily to get ready - you're going to fuck each of them full of their [master]'s cum.  She squeaks in excitement, her nipples visibly puckering.");
        }
    ...
    private function amilyEggStuff() : Void
    {
        ...
        //if dogmorph
        if (player.isRace(Races.DOG, 1, false))
        {
            outputText(", which you know for a fact are <i>very</i> good,");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("and you notice a growing bulge in her trousers");
        }
    ...
    public function layEggsInAmily() : Void
    {
        ...
        {
            outputText("unbelievably swollen");
        }
        ...
        if (player.gender == 0)
        {
            outputText("blank groin");
        }
        outputText(", teasing you into unconsciously humping against her slender digits.");
        if (pregnancy.isPregnant)
        {
            outputText("  \"<i>But try to remember that I'm already carrying.  I don't want it getting too cramped in there; so make sure you don't miss, alright?</i>\"");
        }
    ...
    private function layEggsInAmilysCorruptedHole() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" and her erect shaft shuddering as it throbs in the air");
        }
        ...
        if (player.hasCock())
        {
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText(", her shaft oozing thick globs of pre-cum that roll down her cock to smear against your own as she moves against you");
            }
            outputText(".");
        }
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                outputText(", her shaft covering your stomach with thick strands of pre-cum");
            }
        ...
        if (player.hasCock())
        {
            outputText("  Amily jolts forwards from the unexpected movement and you seize the opportunity, impaling her tight, wet entrance on your [cock].  You both cry out in bliss as she sinks down your shaft, her passage almost burning your oversensitive shaft as her arms wrap around your neck, pulling herself close to you.");
        }
        //(Females + AmilyHerm)
        else if (player.hasVagina() && flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
        ...
        {
            outputText("  You moan as Amily slumps against you, her arms sliding around your neck as her crotch presses ever more forcefully against your.  Your eyes lock with hers as she groans, her lower body undulating against yours with a desperate need, your abdomen straining as your body flushes with desire.");
        }
        ...
        if (player.hasCock())
        {
            outputText("you feel her passage clamp down around your shaft, her body shaking as she whimpers softly above you.");
        }
        //(Females + AmilyHerm)
        else if (player.hasVagina())
        {
            outputText("her thrusts falter slightly, her member twitching within you as your ovipositor fills her body up, shaking slightly with pleasure as her hot shaft brushes against your walls.");
        }
        //(F/F or Genderless)
        else
        {
            outputText("her body hammers into you with more urgency, each hit covering you with another splatter of her femspunk as she groans at how much you're filling her.");
        }
        ...
        if (player.fertilizedEggs() > 0)
        {
            ...
            {
                pregnancy.buttKnockUp(PregnancyStore.PREGNANCY_DRIDER_EGGS, PregnancyStore.INCUBATION_DRIDER - 304);
            }
            else if (player.canOvipositBee())
            {
                pregnancy.buttKnockUp(PregnancyStore.PREGNANCY_BEE_EGGS, PregnancyStore.INCUBATION_BEE + 48);
            }
    ...
    public function amilyLaysEggsLikeABitch() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] == 0)
        {
            outputText("teases her clit");
        }
        else
        {
            outputText("squeezes her shaft");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] == 0)
        {
            outputText("pussy visibly quivering");
        }
        else
        {
            outputText("member oozing a thick glob of pre-cum");
        }
        ...
        {
            outputText("though the sight has certainly gotten you thinking about what you'll be doing with your next clutch.\n");
        }
        else
        {
            outputText("though a distinct heat in your nethers leaves you wishing you had another clutch to unload right now\n");
        }
    ...
    public function amilySwimFuckIntro() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_TIMES_SWIMFUCKED] == 0)
        {
            ...
            if (player.lib >= 60)
            {
                outputText(", eagerly anticipating the opportunity to drink in her form while it's bound up in body-hugging black fabric.");
            }
            else if (player.cor < 50)
            {
                outputText(", happy to share the fruits of your adventure with your mousy lover.");
            }
            else
            {
                outputText(", secretly hoping she'll get used to putting on a show for you.");
            }
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                ...
                if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
                {
                    outputText("  It snaps back onto her " + amilyBalls() + " to snug them tightly.");
                }
            }
        ...
        else
        {
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            {
                ...
                if (flags[kFLAGS.AMILY_HAS_BALLS_AND_SIZE] > 0)
                {
                    outputText("  Her balls are snugly secured in her bottoms, looking like a cute little sphere of virile fun.");
                }
            }
    ...
    private function amilySwimFuckPartII() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_TIMES_SWIMFUCKED] > 1)
        {
            outputText(", and wondering why you keep falling for it");
        }
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText("her silky coat ");
        }
        else
        {
            outputText("her smooth skin ");
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] == 0)
        {
            outputText("engorged bud that is her clit");
        }
        else
        {
            outputText("slippery member");
        }
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText("  Her whiskers tickle your cheeks as s");
        }
        else
        {
            outputText("  S");
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(", and she climaxes all over again, spraying the underside of her " + amilyTits() + " and your [chest] with milky mouse seed");
        }
        ...
        if (player.cumQ() > 250)
        {
            ...
            if (player.cumQ() < 500)
            {
                outputText("squirting more and more spunk from the contracting cunt with every movement");
            }
            else if (player.cumQ() < 750)
            {
                outputText("spurting out a backflood of semen as Amily's belly gains a tiny but visible cum-bump");
            }
            else if (player.cumQ() < 1000)
            {
                outputText("gouts of cum washing from her snatch as her belly rounds nicely");
            }
            else if (player.cumQ() < 2000)
            {
                outputText("waves of jism washing out around your " + cockDescript(x) + " as it pumps her to a rounded, pregnant look");
            }
            else
            {
                outputText("geysers of cum bursts out from the quivering mouse-hole as Amily's belly balloons with jizz.  Even after it can stretch no more, you keep cumming, firing out high pressure jets that splatter your [legs]");
            }
        }
        outputText(".\n\n");
    ...
    public function drinkThePotion() : Void
    {
        ...
        if (flags[kFLAGS.AMILY_X_IZMA_POTION_3SOME] == 1)
        {
            ...
            if (player.biggestCockArea() < 10)
            {
                outputText("overtop of the petite, cock-holding digits");
            }
            else
            {
                outputText("on your [sheath]");
            }
        ...
        {
            //Try the Potion: Repeat  //Appears in Amily's Sex Menu - Izma3Some  {
                ...
                if (pregnancy.isPregnant)
                {
                    outputText("  At least I can't get any more pregnant!");
                }
                outputText("</i>\"");
                ...
                {
                    outputText(", barely concealing the half-swollen bulge beneath");
                }
                outputText(".  Izma says, \"<i>What the hell, I ");
                if (izmaScene.pregnancy.isPregnant)
                {
                    outputText("suppose I can do it for fun, since I'm already pregnant.");
                }
                else
                {
                    outputText("suppose we can have another kid.");
                }
                outputText("</i>\"");
                ...
                if (!pregnancy.isPregnant)
                {
                    outputText("give me lots of babies");
                }
                else
                {
                    outputText("put even more babies inside me");
                }
    ...
    private function izmaAmilyDrugThreeWaySex() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(", one that has your [sack] swelling slightly, the skin growing smooth and glossy as it fills with the heavy, comfortable weight of your sloshing seed");
        }
        else
        {
            outputText(", one that has you feeling comfortably swollen with pent-up seed just waiting to erupt");
        }
        ...
        if (!pregnancy.isPregnant && !izmaScene.pregnancy.isPregnant)
        {
            outputText(", with their hungry wombs just waiting to be impregnated at your leisure");
        }
        else if (pregnancy.isPregnant && izmaScene.pregnancy.isPregnant)
        {
            outputText(", with their ripe wombs stuffed full of your offspring already");
        }
        else
        {
            outputText(", with at least one of their wombs already ripe with your offspring");
        }
        outputText(".");
        ...
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText("Izma's skirt rustles softly, and some of the fronds that compose it slowly begin to rise.  For a while, it's just a slight protrusion, but as the tigershark-girl has her way with your [cock biggest], her bulge lifts into a tent well over a foot tall and inches thick.  Its owner's cheeks blush more red than normal  as Izma begins to pant, accompanied by something steadily dripping within the confines of her sorely-stretched waist-covering.");
        }
        else
        {
            outputText("Izma's skirt visibly begins to dampen, and some of the fronds start sticking to her striped thighs in a rather alluring manner.  For a while, that's all that comes of it, but as the tigershark-girl has her way with your [cock biggest], the skirt gets wet enough to stick to her like a second skin.  Blushing a deeper red than normal, Izma begins to pant, accompanied by a steady dripping that spatters the ground below.");
        }
        ...
        {
            outputText("one of your nipples");
        }
        else
        {
            outputText("at your multitude of nipples");
        }
        ...
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText("The shark-girl's balls are pushed to the side, barely avoiding being smothered in the mouse-girl's weight, and her rigid dick is drooling up between Amily's tits, where it seems quite happy to rest.  ");
        }
        ...
        if (player.cockTotal() == 2)
        {
            outputText("  You even cram your second member in alongside its big brother.  The two cunt-oiled shafts rub against each other as well as the sloppy holes on either side, leaving you grateful for the extra maleness.");
        }
        else if (player.cockTotal() > 2)
        {
            outputText("  You even cram an extra member in alongside its big brother.  The two cunt-oiled shafts rub against each other as well as the sloppy holes surrounding them, leaving you grateful for your extra maleness.  Of course, that isn't your entire package, but there isn't room to stuff any more dick into that stuffed cock-sauna.");
        }
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText("  You even bump up against Izma's forgotten package, slathering it with mixed juices.  While it's rigid with arousal, Izma seems to have almost forgotten about it, instead choosing to focus exclusively on her more womanly parts.");
        }
        ...
        if (izmaScene.pregnancy.isPregnant)
        {
            outputText("My pussy is the obvious, stronger choice.");
        }
        else
        {
            outputText("I'm the stronger, obvious breeding choice.  Knock me up and you'll have fitter, better offspring.");
        }
        ...
        if (!pregnancy.isPregnant)
        {
            outputText("Give me your babies...  Mmmm, we'll make such smart babies.  ");
        }
        ...
        if (flags[kFLAGS.AMILY_NOT_FURRY] == 0)
        {
            outputText("actually blushing so hard that you can see it through her fur, a crimson tint that looks even better on her with the way her tongue is hanging out");
        }
        else
        {
            outputText("blushing so hard her whole face is almost beet-red, a fine look on her with her tongue dangling so erotically out of her gasping mouth");
        }
        outputText(".");
        ...
        if (player.hasBalls())
        {
            outputText("straining balls slosh ");
        }
        else
        {
            outputText("straining fullness tingles ");
        }
        ...
        if (player.biggestCockArea() > 61)
        {
            outputText("as far into Amily's juicy slit as it will go");
        }
        else
        {
            outputText("straight into Amily's juicy slit");
        }
        ...
        else
        {
            ...
            if (player.hasKnot(player.biggestCockIndex()))
            {
                outputText(", but your knot traps it inside anyway.  You cum and cum until the pressure is almost painful, but even your magnificent knot can't hold it all back");
            }
    ...
    private function izmaAmilyDrugThreeWaySex2() : Void
    {
        ...
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText(", dick and balls flopping lamely on top of you");
        }
        ...
        if (!izmaScene.pregnancy.isPregnant)
        {
            outputText("be inseminated");
        }
        else
        {
            outputText("have her pregnant-pussy packed full again");
        }
        outputText(".");
        ...
        if (player.balls == 0)
        {
            outputText("the pressure is as omnipresent as ever");
        }
        else
        {
            outputText("your [balls] are stretching your [sack] as tight as before");
        }
        ...
        if (player.biggestCockArea() <= 65)
        {
            outputText("bottoms out");
        }
        else
        {
            outputText("takes as much as she can");
        }
        outputText(", there's a squirt of lubricant that washes out onto your middle");
        
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText(" along with a matching jet of pre-cum from her tip");
        }
        outputText(".");
        if (player.cockTotal() > 1)
        {
        ...
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText(", ignoring the dribbly cock that's leaking on your chest");
        }
        ...
        if (player.cockTotal() == 2)
        {
            outputText(", taking a hand away from your extra dick to support herself,");
        }
        if (player.cockTotal() > 2)
        {
            outputText(", taking a hand away from one of your extra dicks to support herself,");
        }
        ...
        if (izmaScene.pregnancy.isPregnant)
        {
            outputText("I know I'm pregnant, but I want you to cum as deeply inside me as possible, okay?  I just... I have to have your cum. I NEED to feel that warmth flooding inside me.  It'll... ohh, yes... it'll make me feel so good, so loved.");
        }
        else
        {
            outputText("I don't know how, but I just know that you're going to make me pregnant when you cum inside me.  It's going to get me oh-ohhhhh... so heavy with your child, and it'll be perfect and blissful.  You're going to fucking flood me with jizz, aren't you, Alpha?");
        }
        ...
        if (!izmaScene.pregnancy.isPregnant)
        {
            outputText(" make me your gravid, jizz-slurping beta-wife?");
        }
        else
        {
            outputText(" cum in your pregnant, jizz-hungry wife?");
        }
        outputText("</i>\"");
        ...
        if (!izmaScene.pregnancy.isPregnant)
        {
            outputText("watching a bitch's belly bloat as it's packed to a full, fertile dome");
        }
        else
        {
            outputText("stuffing a cunt so full she'll never stop dripping your seed");
        }
        ...
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText("  Her four balls quake atop you, and you watch her urethra bulge, ready to splatter your [chest] with her own, lesser climax.");
        }
        ...
        if (flags[kFLAGS.IZMA_NO_COCK] == 0)
        {
            outputText("  The smell of her hot, inferior seed hits your nostrils, exciting you even further as it rolls off of you in thick globs.");
        }
        ...
        if (izmaScene.pregnancy.isPregnant)
        {
            ...
            if (player.hasKnot(player.biggestCockIndex()))
            {
                outputText("  Your knot balloons explosively inside her, but the seal on her womb is tighter.");
            }
        ...
        else
        {
            ...
            if (player.hasKnot(player.biggestCockIndex()))
            {
                outputText("  Of course, with a knot like yours there's no need for that.  You keep her sealed up so tightly that she has no choice but to take every drop.");
            }
            outputText("  The tigershark babbles, \"<i>So... full</i>\" and topples over backward under her own doubled weight");
            if (player.hasKnot(player.biggestCockIndex()))
            {
                outputText(", your dong forced out with a noisy 'SCHLURRRPOP'");
            }
            outputText(".");
        }
        ...
        if (!pregnancy.isPregnant)
        {
            outputText("jizz-bloated");
        }
        else
        {
            outputText("child-bearing");
        }
    ...
    private function amilyNurseCheckupV2(repeat : Bool) : Void
    {
        clearOutput();
        ...
        var _sw9_ = (pregnancy.event);        

        switch (_sw9_)
        {
            case 2, 3:outputText("slightly-protruding pregnancy is exposed beneath it");
            case 4, 5:outputText("pregnancy-swollen tummy rounds out beneath it");
            case 6, 7, 8:outputText("pregnancy-bloated belly bulges out beneath it");
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText("  It bulges out lewdly in a sheer outline of her " + amilyCock() + ", which is curled over to remain inside the stretchy skirt.");
        }
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 9)
        {
            outputText("  The effort is a failure, as her immense cock is simply too big for such a slinky covering, and the fat tip curves down to dangle below the hem, pulsing dangerously.");
        }
        ...
        if (player.balls == 0)
        {
            outputText(", testing to engorgement with soft squeezes that are almost painful with how aroused you've become.");
        }
        else
        {
            ...
            {
                outputText("rolling them in her fingers with a sly smile");
            }
            else
            {
                outputText("letting her fingers sink into one of the swollen orbs with a sly smile");
            }
            outputText(".");
        }
        ...
        if (player.hasVagina())
        {
            outputText(", while a sneaky finger slides into your cleft, testing the wetness");
        }
        outputText(".");
        ...
        if (player.hasBalls())
        {
            outputText("Blue Balls");
        }
        else
        {
            outputText("Boneritus");
        }
        ...
        if (player.hasBalls())
        {
            outputText("plump balls are");
        }
        else
        {
            outputText("stiff shaft is");
        }
        ...
        {
            outputText("alongside your equine lower half");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() > 2)
            {
                outputText("one of your extra cocks");
            }
            else if (player.cockTotal() == 2)
            {
        ...
        if (player.cumQ() >= 500)
        {
            ...
            if (!pregnancy.isPregnant)
            {
                outputText("slowly filling Amily's womb to capacity");
            }
            else
            {
                outputText("slowly forcing trails of semen out of her entrance");
            }
            outputText(".");
            if (player.cumQ() >= 2000)
            {
                ...
                if (!pregnancy.isPregnant)
                {
                    outputText("she's filled to capacity, her stretchy, mallaeble middle bulging lewdly with spunky jizz, sloshing with each fresh injection.");
                }
                else
                {
                    outputText("torrents of the stuff spray out of her entrance, her canal too filled to hold even a drop more and your penis continuing to push the pressure higher.");
                }
            }
            if (player.cumQ() >= 500)
            {
                outputText("  It turns your crotch into a sticky mess.");
            }
        }
        ...
        if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
        {
            outputText(" that flings sticky ropes across your [chest].  Her back arches as she continues to launch her own jism towards you");
        }
        ...
        if (player.hasKnot(x))
        {
            outputText("  She tries again.  This time, it's your knot that keeps her rooted firmly in place, and she stays plugged like that for a good twenty minutes, her cunt basting in your animal-spooge as she enjoys the fullness only a thick knot can provide.");
        }
    ...
    public function mishapsLunaAmily() : Void
    {
        ...
        if (player.hasStatusEffect(StatusEffects.CampLunaMishaps1))
        {
            player.addStatusValue(StatusEffects.CampLunaMishaps1, 1, 1);
        }
        else
        {
            player.createStatusEffect(StatusEffects.CampLunaMishaps1, 1, 0, 0, 0);
        }
        if (!player.hasStatusEffect(StatusEffects.LunaWasCaugh))
        {
            player.createStatusEffect(StatusEffects.LunaWasCaugh, 1, 0, 0, 0);
        }
        else
        {
            player.addStatusValue(StatusEffects.LunaWasCaugh, 1, 1);
        }
        if (player.statusEffectv1(StatusEffects.LunaWasCaugh) == 3)
        {
            outputText("<b>That's it, you're sure of it now, it's all Luna's doing!</b>\n\n");
        }
        doNext(playerMenu);
    }
}
