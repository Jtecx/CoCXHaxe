...
class BelisaFollower extends NPCAwareContent implements SaveableState
{
    public static var BelisaEncounternum : Float;
    public static var BelisaAffectionMeter : Float;
    public static var BelisaInGame : Bool;
    public static var BelisaFollowerStage : Float;
    public static var BelisaVirgin : Bool;
    public static var BelisaShopOpen : Bool;
    public static var BelisaQuestOn : Bool;
    public static var BelisaRalthTalked : Bool;
    public static var BelisaQuestComp : Bool;
    public static var BelisaConfessed : Bool;
    public static var BelisaToldTyrantia : Bool;
    public static var BelisaInCamp : Bool;
    public static var HolyBand1 : Float;
    public static var HolyBand1Cap : Float;
    public static var HolyBand2 : Float;
    public static var HolyBand2Cap : Float;
    public static var HolyBand3 : Float;
    public static var HolyBand3Cap : Float;
    public static var HolyBand4 : Float;
    public static var HolyBand4Cap : Float;
    public static var HolyBand5 : Float;
    public static var HolyBand5Cap : Float;
    public static var HolyBand6 : Float;
    public static var HolyBand6Cap : Float;
    public static var HolyBand7 : Float;
    public static var HolyBand7Cap : Float;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            BelisaEncounternum = Reflect.field(o, "BelisaEncounternum");
            BelisaAffectionMeter = Reflect.field(o, "BelisaAffectionMeter");
            BelisaInGame = Reflect.field(o, "BelisaInGame");
            BelisaFollowerStage = Reflect.field(o, "BelisaFollowerStage");
            BelisaVirgin = Reflect.field(o, "BelisaVirgin");
            BelisaShopOpen = Reflect.field(o, "BelisaShopOpen");
            BelisaQuestOn = Reflect.field(o, "BelisaQuestOn");
            BelisaRalthTalked = Reflect.field(o, "BelisaRalthTalked");
            BelisaQuestComp = Reflect.field(o, "BelisaQuestComp");
            BelisaConfessed = Reflect.field(o, "BelisaConfessed");
            BelisaToldTyrantia = Reflect.field(o, "BelisaToldTyrantia");
            BelisaInCamp = Reflect.field(o, "BelisaInCamp");
            HolyBand1 = valueOr(Reflect.field(o, "HolyBand1"), 0);
            HolyBand1Cap = valueOr(Reflect.field(o, "HolyBand1Cap"), 0);
            HolyBand2 = valueOr(Reflect.field(o, "HolyBand2"), 0);
            HolyBand2Cap = valueOr(Reflect.field(o, "HolyBand2Cap"), 0);
            HolyBand3 = valueOr(Reflect.field(o, "HolyBand3"), 0);
            HolyBand3Cap = valueOr(Reflect.field(o, "HolyBand3Cap"), 0);
            HolyBand4 = valueOr(Reflect.field(o, "HolyBand4"), 0);
            HolyBand4Cap = valueOr(Reflect.field(o, "HolyBand4Cap"), 0);
            HolyBand5 = valueOr(Reflect.field(o, "HolyBand5"), 0);
            HolyBand5Cap = valueOr(Reflect.field(o, "HolyBand5Cap"), 0);
            HolyBand6 = valueOr(Reflect.field(o, "HolyBand6"), 0);
            HolyBand6Cap = valueOr(Reflect.field(o, "HolyBand6Cap"), 0);
            HolyBand7 = valueOr(Reflect.field(o, "HolyBand7"), 0);
            HolyBand7Cap = valueOr(Reflect.field(o, "HolyBand7Cap"), 0);
        }
    ...
    private function BelisaHolyBands() : Bool
    {
        if (HolyBand1Cap > 0 || HolyBand2Cap > 0 || HolyBand3Cap > 0 || HolyBand4Cap > 0 || HolyBand5Cap > 0 || HolyBand6Cap > 0 || HolyBand7Cap > 0)
        {
            return true;
        }
        return false;
    ...
    public function BelisaAffection(changes : Float = 0) : Float
    {
        BelisaAffectionMeter += changes;
        if (BelisaAffectionMeter > 120)
        {
            BelisaAffectionMeter = 120;
        }
        if (BelisaAffectionMeter < 0)
        {
            BelisaAffectionMeter = 0;
        }
    ...
    public function subsequentEncounters() : Void
    {
        ...
        if (BelisaHolyBands())
        {
            addButton(5, "Holy Bands", BelisaHolyBandsManagment).hint("Putting on ot taking of any of the Holy Bands you own. With little Belisa help ;)");
        }
    }
    ...
    public function BelisaTalk() : Void
    {
        ...
        {
            addButtonDisabled(2, "???", "Req. 15+ affection.");
        }
        addButton(3, "Her", BelisaTalkHer);
        if (BelisaAffectionMeter >= 50 && !BelisaQuestComp)
        {
            addButton(6, "Injuries", BelisaTalkInjuries);
        }
        else if (BelisaQuestComp)
        {
            addButtonDisabled(6, "Injuries", "You've already solved her tooth problem!");
        }
        else
        {
            addButtonDisabled(6, "???", "Req. 50+ affection.");
        }
        if (!BelisaInCamp && BelisaQuestComp && BelisaAffectionMeter >= 80 && player.statusEffectv1(StatusEffects.TelAdre) >= 1 && flags[kFLAGS.HEXINDAO_UNLOCKED] >= 1 && player.hasStatusEffect(StatusEffects.MetWhitney) && player.statusEffectv1(StatusEffects.MetWhitney) > 1)
        {
            addButton(7, "ComeW/Me", BelisaComeCamp);
        }
        else if (BelisaInCamp)
        {
            addButtonDisabled(7, "ComeW/Me", "She's already at your camp!");
        }
        else
        {
            addButtonDisabled(7, "???", "Req. 80+ affection, healing her tooth injury and finding: Farm, Tel'Adre, He'Xin'Dao.");
        }
        if (BelisaInCamp && BelisaConfessed && BelisaAffectionMeter >= 80)
        {
            if (flags[kFLAGS.SLEEP_WITH] != "Belisa")
            {
                addButton(12, "Sleep With", BelisaSleepToggle);
            }
            else
            {
                addButton(12, "Sleep Alone", BelisaSleepToggle);
            }
        }
        if (BelisaInCamp)
        {
        ...
        {
            addButton(14, "Back", Encounterback);
        }
    }
    ...
    public function BelisaTalkHer() : Void
    {
        ...
        if (BelisaAffectionMeter >= 50 && !BelisaQuestComp)
        {
            addButton(2, "Injuries", BelisaTalkInjuries);
        }
        else if (BelisaQuestComp)
        {
            addButtonDisabled(2, "Injuries", "You've already solved her tooth problem!");
        }
        else
        {
            addButtonDisabled(2, "???", "Req. 50+ affection.");
        }
        if (BelisaAffectionMeter >= 50)
        {
            if (BelisaInCamp)
            {
                if (LilyFollower.LilyFollowerState || TyrantiaFollower.isLover())
                {
                    addButton(3, "Family", BelisaTalkHerFamily);
                }
                else
                {
                    addButtonDisabled(3, "Family", "Not avialable until you find one of her sisters.");
                }
            }
            else
            {
        ...
        {
            addButtonDisabled(3, "???", "Req. 50+ affection.");
        }
    ...
    public function BelisaTalkHerFamily() : Void
    {
        ...
        if (BelisaInCamp)
        {
            ...
            if (TyrantiaFollower.isLover())
            {
                ...
                {
                    outputText("\"<i>Her kids are surprisingly soft.</i>\" Belisa chuckles. \"<i>Mischievous, but not aggressive or warlike. Not like their mom.</i>\" She smiles down at the meadow, where Tyrantia plays with your kids. \"<i>Unicorn-Driders. Who would’ve thought?</i>\"\n\n");
                }
            }
            if (LilyFollower.LilyFollowerState)
            {
                outputText("\"<i>Lily…Doesn’t look the same as she did before, but that’s going around, it would seem.</i>\" Belisa rubs one of her legs idly. \"<i>Most Driders looked like me, before the demons. She also…Developed some rather odd tastes in the years we spent apart.</i>\"\n\n");
            }
            advanceMinutes(15);
            doNext(BelisaTalk);
        }
    ...
    public function BelisaTalkInjuriesHeal() : Void
    {
        ...
        {
            outputText("Ayane can heal curses. She'd be more than willing to help if she could.\n\n");
        }
        if (flags[kFLAGS.NADIA_FOLLOWER] >= 6 && !player.hasStatusEffect(StatusEffects.NadiaOff))
        {
            outputText("Nadia should be able to heal such a curse. You make a note to ask her.\n\n");
        }
        cast((5), BelisaAffection);
        BelisaQuestOn = true;
        endEncounter();
    ...
    public function BelisaHangSparWon(hpVictory : Bool) : Void
    {
        clearOutput();
        if (hpVictory)
        {
    ...
    {
        if (flags[kFLAGS.BELISA_DEFEATS_COUNTER] >= 1)
        {
            flags[kFLAGS.BELISA_DEFEATS_COUNTER]++;
        }
        else
        {
            flags[kFLAGS.BELISA_DEFEATS_COUNTER] = 1;
        }
        if (flags[kFLAGS.BELISA_LVL_UP] < 8 && flags[kFLAGS.BELISA_DEFEATS_COUNTER] >= flags[kFLAGS.BELISA_LVL_UP] + 4)
        {
            ...
            {
                player.addStatusValue(StatusEffects.CampSparingNpcsTimers5, 3, player.statusEffectv1(StatusEffects.TrainingNPCsTimersReduction) * flags[kFLAGS.BELISA_DEFEATS_COUNTER]);
            }
            else
            {
                player.createStatusEffect(StatusEffects.CampSparingNpcsTimers5, 0, 0, player.statusEffectv1(StatusEffects.TrainingNPCsTimersReduction) * flags[kFLAGS.BELISA_DEFEATS_COUNTER], 0);
            }
            flags[kFLAGS.BELISA_DEFEATS_COUNTER] = 0;
    ...
    public function BelisaHangFish() : Void
    {
        ...
        if (player.hasGills() || player.hasPerk(PerkLib.AffinityUndine))
        {
            ...
            {
                outputText("  She brings an odd bunch of silk down with her, and you look at it curiously. She drapes it over your head, and you push it away, taking in a deep breath. She gives you a thumbs-up, and doesn’t give you the air-bag again.\n\n");
            }
            else
            {
                outputText(" She brings an odd bunch of silk down with her, and you look at it curiously. She drapes it over your head, and you breathe in a lungful of fresh air. You point at your gills, and she nods, taking a breath herself. She gives you a thumbs-up, and doesn’t give you the air-bag again.\n\n");
            }
        }
        else
        {
            outputText(" You dive down, deep into the lake with Belisa. Eventually, you begin to run low on air, and...she keeps going down! You turn back, but Belisa grabs your foot, pulling you down to her. The spider-girl produces an odd, silky bag, draping it over your head. You struggle at first, but you quickly realize that the bag’s...full of breathable air? She takes it off your head, and giggles, sending bubbles back up to the surface of the water.\n\n");
        }
    ...
    private function BelisaShop() : Void
    {
        ...
        {
            addButton(14, "Never mind", Encounterback);
        }
    }
    public function BuyHolyBands() : Void
    {
        ...
        if (HolyBand1Cap > 2)
        {
            addButtonDisabled(0, "Crimson", "You can wear at most 3 of them at once so it's pointless to buy another one.");
        }
        else
        {
            addButton(0, "Crimson", BuyCrimsonBand).hint("Cost: 1,500 gems");
        }
        if (HolyBand2Cap > 2)
        {
            addButtonDisabled(1, "Pink", "You can wear at most 3 of them at once so it's pointless to buy another one.");
        }
        else
        {
            addButton(1, "Pink", BuyPinkBand).hint("Cost: 1,500 gems");
        }
        if (HolyBand3Cap > 2)
        {
            addButtonDisabled(2, "Yellow", "You can wear at most 3 of them at once so it's pointless to buy another one.");
        }
        else
        {
            addButton(2, "Yellow", BuyYellowBand).hint("Cost: 1,500 gems");
        }
        if (HolyBand4Cap > 0)
        {
            addButtonDisabled(3, "Turqouise", "You can wear only one so it's pointless to buy another one.");
        }
        else
        {
            addButton(3, "Turqouise", BuyTurqouiseBand).hint("Cost: 3,000 gems");
        }
        if (HolyBand5Cap > 0)
        {
            addButtonDisabled(4, "Crossed", "You can wear only one so it's pointless to buy another one.");
        }
        else
        {
            addButton(4, "Crossed", BuyCrossedBand).hint("Cost: 4,000 gems");
        }
        if (HolyBand6Cap > 0)
        {
            addButtonDisabled(5, "Brown&Beige", "You can wear only one so it's pointless to buy another one.");
        }
        else
        {
            addButton(5, "Brown&Beige", BuyBrownAndBeigeBand).hint("Cost: 7,000 gems");
        }
        if (HolyBand7Cap > 1)
        {
            addButtonDisabled(6, "R.Blue", "You can wear at most 2 of them at once so it's pointless to buy another one.");
        }
        else
        {
            addButton(6, "R.Blue", BuyBlueBand).hint("Cost: 2,000 gems");
        }
    ...
    public function belisaBuy(itype : ItemType, cost : Float) : Void
    {
        clearOutput();
    ...
    public function belisaBuy1(itype : ItemType, cost : Float) : Void
    {
        clearOutput();
        if (itype == useables.T_SSILK)
        {
            outputText("<i>\"Oh, you want raw silk?\"</i> She looks mildly disappointed, but pulls out a few spools from one of her boxes. <i>\"You know we Driders were the best weavers on Mareth, right?\"</i> She sighs, clearly not very pleased with selling her silk raw. <i>\"Okay, that’s 300 gems.\"</i>\n\n");
        }
        if (itype == undergarments.DRI_PANTY || itype == undergarments.DRI_BRA)
        {
            if (BelisaAffectionMeter < 30)
            {
                outputText("<i>\"O-okay, just...If you need to try them on, take them home first. If they don’t fit, I’ll let you exchange them later.\"</i> She opens one of the boxes, and a small array of fancy-looking undergarments catch your eye as they shimmer in the sunlight.\n\n");
            }
            else
            {
                outputText("She blushes, turning her head away. <i>\"Y-you...Want to buy those from me? Okay...I can help you fit them, if you want.\"</i> She seems to like the idea of you wearing her work.\n\n");
            }
        }
        player.gems -= cost;
        statScreenRefresh();
    ...
    public function belisaBuyBand(type : Float, cost : Float) : Void
    {
        clearOutput();
        if (player.gems < cost)
        {
    ...
    private function BelisaHolyBandsManagmentCurrent() : Float
    {
        var BHBMC : Float = 0;
        if (HolyBand1 > 0)
        {
    ...
    private function BelisaHolyBandsManagmentCap() : Float
    {
        var BHBMCap : Float = 4;
        if (BelisaAffectionMeter >= 80)
        {
            BHBMCap += 2;
        }
        if (BelisaAffectionMeter >= 120)
    ...
    private function BelisaHolyBandsManagment() : Void
    {
        ...
        {
            if (HolyBand1 < 3 && HolyBand1Cap > 0 && HolyBand1 < HolyBand1Cap)
            {
                addButton(0, "Crimson", BelisaHolyBandsManagmentCrimsonAdd).hint("Put on one Crimson Holy Band.");
            }
            if (HolyBand2 < 3 && HolyBand2Cap > 0 && HolyBand2 < HolyBand2Cap)
            {
                addButton(2, "Pink", BelisaHolyBandsManagmentPinkAdd).hint("Put on one Pink Holy Band.");
            }
            if (HolyBand3 < 3 && HolyBand3Cap > 0 && HolyBand3 < HolyBand3Cap)
            {
                addButton(5, "Yellow", BelisaHolyBandsManagmentYellowAdd).hint("Put on one Yellow Holy Band.");
            }
            if (HolyBand4 == 0 && HolyBand4Cap > 0)
            {
                addButton(7, "Turqouise", BelisaHolyBandsManagmentTurqouiseAdd).hint("Put on Turqouise Holy Band.");
            }
            if (HolyBand5 == 0 && HolyBand5Cap > 0)
            {
                addButton(10, "Crossed", BelisaHolyBandsManagmentCrossedAdd).hint("Put on Crossed Holy Band.");
            }
            if (HolyBand6 == 0 && HolyBand6Cap > 0)
            {
                addButton(12, "Brown and Beige", BelisaHolyBandsManagmentBrownAndBeigeAdd).hint("Put on Brown and Beige Holy Band.");
            }
            if (HolyBand7 < 2 && HolyBand7Cap > 0 && HolyBand7 < HolyBand7Cap)
            {
                addButton(4, "Royal Blue", BelisaHolyBandsManagmentRoyalBlueAdd).hint("Put on one Royal Blue Holy Band.");
            }
        }
        else
        {
        ...
        if (HolyBand1 > 0)
        {
            addButton(1, "Crimson", BelisaHolyBandsManagmentCrimsonRemove).hint("Take off one Crimson Holy Band.");
        }
        if (HolyBand2 > 0)
        {
            addButton(3, "Pink", BelisaHolyBandsManagmentPinkRemove).hint("Take off one Pink Holy Band.");
        }
        if (HolyBand3 > 0)
        {
            addButton(6, "Yellow", BelisaHolyBandsManagmentYellowRemove).hint("Take off one Yellow Holy Band.");
        }
        if (HolyBand4 > 0)
        {
            addButton(8, "Turqouise", BelisaHolyBandsManagmentTurqouiseRemove).hint("Take off Turqouise Holy Band.");
        }
        if (HolyBand5 > 0)
        {
            addButton(11, "Crossed", BelisaHolyBandsManagmentCrossedRemove).hint("Take off Crossed Holy Band.");
        }
        if (HolyBand6 > 0)
        {
            addButton(13, "Brown and Beige", BelisaHolyBandsManagmentBrownAndBeigeRemove).hint("Take off Brown and Beige Holy Band.");
        }
        if (HolyBand7 > 0)
        {
            addButton(9, "Royal Blue", BelisaHolyBandsManagmentRoyalBlueRemove).hint("Take off one Royal Blue Holy Band.");
        }
        if (BelisaInCamp)
        {
            addButton(14, "Back", BelisaMainCampMenu);
    ...
    private function BelisaHolyBandsManagmentYellowAdd2() : Void
    {
        ...
        else
        {
            HolyBand3 += 1;
            player.statStore.replaceBuffObject({
                        spe.mult : (0.1 * HolyBand3),
                        maxsf_mult : (-0.1 * HolyBand3)
                    }, "Yellow Holy Band", {
                        text : "Yellow Holy Band"
                    });
        }
    ...
    private function BelisaHolyBandsManagmentBrownAndBeigeAdd2() : Void
    {
        ...
        player.statStore.addBuffObject({
                    ...
                    spe.mult : 0.15,
                    maxsf_mult : -0.1
                }, "Brown and Beige Holy Band", {
                    text : "Brown and Beige Holy Band"
                });
        doNext(BelisaHolyBandsManagment);
    }
    ...
    private function BelisaHolyBandsManagmentRoyalBlueAdd2() : Void
    {
        if (HolyBand7 == 0)
        {
            ...
            player.statStore.addBuffObject({
                        maxmana_mult : -0.1
                    }, "Royal Blue Holy Band", {
                        text : "Royal Blue Holy Band"
                    });
        }
        else
        {
    ...
    public function BelisaMainCampMenu() : Void
    {
        ...
        else
        {
            ...
            if (BelisaConfessed)
            {
                outputText("<i>\"...Anything I can help you with?\"</i> When she thinks you aren’t looking, she takes a glance down, beads of drool forming on her fangs.");
            }
            outputText("\n\n");
        }
        menu();
        ...
        if (BelisaHolyBands())
        {
            addButton(5, "Holy Bands", BelisaHolyBandsManagment).hint("Putting on or taking off any of the Holy Bands you own. With Belisa's help ;)");
        }
        if (DriderTown.DriderTownComplete)
        {
            addButton(13, "Back", SceneLib.dridertown.DriderTownEnter).hint("Return to main DriderTown menu.");
        }
    ...
    public function BelisaAppearance() : Void
    {
        ...
        if (BelisaQuestComp)
        {
            outputText("As she sees you looking at her face, she smiles, revealing her restored teeth and glimmering fangs. She blushes, but doesn’t seem to mind the attention.\n\n");
        }
        else
        {
            outputText("One of her thin fangs sticks out over her lower lip, but she’s deliberately hidden the other from view. When you look at where that fang would be, she cringes, tilting her head so her sunhat hides her face from view.\n\n");
        }
    ...
    public function BelisaSexMenu(fromCombat : Bool = false) : Void
    {
        menu();
    ...
    public function BelisaSex() : Void
    {
        ...
        else
        {
            if (BelisaAffectionMeter < 20)
            {
                outputText("<i>\"I knew you were a pervert! Get away from me!\"</i> Belisa draws her knives, but she looks scared, as if she doesn’t really want to fight. You decide to not aggravate the slender Drider further, backing away from her and heading on your way.\n\n");
            }
            else if (BelisaAffectionMeter < 40)
            {
                outputText("<i>\"...Look…I know the world’s gone to horny hell, but I haven’t yet.\"</i> Belisa says tightly. <i>\"I don’t want to sound…rude…but I don’t really want to…Sleep with just anyone.\"</i> Not sure whether to be insulted or impressed, you leave Belisa alone, heading back to camp.\n\n");
            }
            else if (BelisaAffectionMeter < 60)
            {
                outputText("Belisa stares at you for a moment, her blush getting redder. <i>\"...No.\"</i> She shakes herself, slapping her cheeks. <i>\"It’s not that I don’t trust you…But…\"</i> She winces. <i>\"Just…I can’t, okay?\"</i>\n\nYou apologize, and Belisa nods, accepting your apology. She heads back inside, and you back away, leaving her in peace to do…whatever she’s doing now.\n\n");
            }
            else if (BelisaAffectionMeter < 80)
            {
                outputText("Belisa blushes, turning her head away from you shyly. <i>\"...[name], I can’t right now, okay?\"</i> She heads back into her home, and you can hear some rustling inside. You can hear a small gasp, and a wet <i>schluck</i>. Is...Is Belisa...?\n\n");
            }
            else if (BelisaAffectionMeter >= 80)
            {
                outputText("Your shy Drider looks you up and down, a small bit of drool dripping from the corner of her mouth. She snaps out of it, then immediately turns her head. <i>\"Nope! Nope nope nope nope! Nope!\"</i> She sprints as fast as she can, launching herself face-first into the water. Judging from her reaction…she wants to…? But…Something’s in the way? You’re not sure whether to be amused or insulted by her reaction.\n\n");
            }
            if (BelisaInCamp)
            {
                doNext(BelisaMainCampMenu);
    ...
    public function BelisaFuck() : Void
    {
        ...
        var rng : Float = (Math.random() * 3 + 1);
        if (rng == 1)
        {
            doNext(BelisaAfterSex1, true);
        }
        else
        {
            doNext(BelisaAfterSex2);
        }
    }
    ...
    public function BelisaDildo() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("<i>\"Not to be...rude, [name], but...wouldn’t you rather use...your…?\"</i> She gently nudges your [cock]. You shake your head, and she looks at you, shrugging her shoulders.\n\n");
        }
        ...
        if (player.hasCock())
        {
            outputText("She brings her hand to your [cock]. <i>\"I wish this were in here…But it’s nice to see…even without it in me, you still…\"</i> She pumps your tool, her soft, slippery hand working your shaft. <i>\"Want to cum for me.\"</i>\n\n");
        }
        ...
        if (player.hasCock())
        {
            outputText("Belisa’s hand on your [cock] doesn’t stop, and as you come, spraying her stomach with your spooge, she aims it towards her chest, spreading your baby batter onto her breasts and stomach.\n\n");
        }
    ...
    public function BelisaVirginLesbian() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("<i>\"Not to be...rude, [name], but...wouldn’t you rather use...your…?\"</i> She gently nudges your [cock]. You shake your head, and she looks at you, confused.\n\n");
        }
    ...
    public function BelisaAfterSex1(preg : Bool = false) : Void
    {
        clearOutput();
    ...
    private function chanceToFail() : Float
    {
        var chance : Float = 10;
