...
class RyuBiDragon extends Monster
{
    private function ryubiAttack() : Void
    {
        ...
        {
            outputText("You dodge aside at the last second and it's claws whistle past you.");
        }
        else
        {
            var damage : Float = 0;
            ...
            if (damage <= 0)
            {
                outputText("It's claws scrape noisily but harmlessly off your [armor].");
            }
            else
            {
    ...
    override private function get_long() : String
    {
        ...
        {
            str += "head and neck which is covered by mismatching mix of red, blue, white, black and green scales.";
        }
        else if (flags[kFLAGS.RYUBI_LVL_UP] == 3)
        {
            str += "head and neck which is covered by mismatching mix of red, blue, white, black and green scales.";
        }
        else if (flags[kFLAGS.RYUBI_LVL_UP] == 2)
        {
            str += "head and neck which is covered by mismatching mix of red, blue, white, black and green scales.";
        }
        else if (flags[kFLAGS.RYUBI_LVL_UP] == 1)
        {
            str += "head and neck which is covered by mismatching mix of red, blue, white, black and green scales.";
        }
        else
    ...
    public function new()
    {
        ...
        if (flags[kFLAGS.RYUBI_LVL_UP] >= 2 && flags[kFLAGS.RYUBI_LVL_UP] < 8)
        {
