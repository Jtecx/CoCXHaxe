...
class AikoScene extends BaseContent implements TimeAwareInterface
{
    ...
    private var talkAndSex : Bool = false;
    ...
    public function encounterAiko() : Void
    {
        ...
        if (flags[kFLAGS.AIKO_TIMES_MET] == 1)
        {
            ...
            else
            {
                outputText("<i>\"I am Aiko, guardian of these woods. You’re trespassing in kitsune territory. Didn’t you see the sign?\"</i>\n\n"
                        ...
                        + ((player.cor > 20) ? "and tell her as much with a slight scowl," : "")
                        + " but you nod your head "
                        + ((player.cor <= 20) ? "politely" : "")
        ...
        else if (flags[kFLAGS.AIKO_TIMES_MET] == 2)
        {
            outputText("You have a vague sense of déjà vu as you explore deeper into the forest. You can’t place it, but you feel like you’ve been here before… even stranger still is the feeling that you’re being watched. Attempting to shrug it off, you keep on the trail, but the back of your neck continues to tingle with a nagging suspicion, and you begin to succumb to paranoia, looking over your shoulder nervously.\n\n"
                    ...
                    + ((player.isRace(Races.DOG, 1, false) || player.isRace(Races.WEREWOLF, 1, false)) ? "Your canine chase instinct overrides your previous sentiments of paranoia, and you dash headlong through" : "You hesitate at first, but then decide to give chase, dashing into")
                    + " the bushes after it.\n\n"
                    ...
                    + "<i>\"I’m surprised you managed to find this place again,\"</i> she says once she has completed her short ritual, "
                    + ((flags[kFLAGS.AIKO_HAS_FOUGHT] > 0) ? "smiling" : "glaring")
                    + " at you.");
            if (flags[kFLAGS.AIKO_AFFECTION] >= 55)
            {
                outputText("<i>\"Pleasantly surprised,\"</i> she adds, her expression turning soft and affectionate. "
                        ...
                        + "\n\nShe starts to make her way toward you, swaying gently as she walks. <i>\"I wanted to say thank you again for returning my star sphere…"
                        + ((flags[kFLAGS.AIKO_FIRST_CHOICE] == 6) ? " and especially… for the other things you did,\"</i> she says with a slight blush" : "\"</i> she says")
                        + ". <i>\"Most people probably wouldn’t have been that nice.\"</i>\n\n"
            ...
            else if ((flags[kFLAGS.AIKO_AFFECTION] > 50))
            {
                outputText("<i>\"So, did you enjoy your ‘present’?\"</i> she says with a snicker, barely suppressing a full-blown grin. You give her a flat look, mustering up your best deadpan, and reply that you’ve had better.\n\n"
                        ...
                        + "At your expense, you are quick to remind her, crossing your arms indignantly. "
                        + ((flags[kFLAGS.AIKO_FIRST_CHOICE] == 3) ? "You have to admit, the sex was good—you just could have gone without the undesired side effects." : "")
                        + " You would like to pursue the subject of her trickery further, but Aiko quickly deflects the discussion before you get a chance to speak up.\n\n"
            ...
            if (flags[kFLAGS.AIKO_AFFECTION] >= 50)
            {
                ...
                else
                {
                    outputText("She nods, but seems to shrink back from you uneasily. You notice she hasn’t dismissed her bow yet, even though it isn’t pointed at you anymore.\n\n"
                            + "<i>\"You… you’re not gonna try to rape me again, are you?\"</i> she says, looking at you hopefully. "
                            + ((player.cor <= 50) ? "Her question stings your conscience a little, and it’s made only worse by her innocent expression. She dearly wants to like you—you can see it in her eyes." : "")
                            + "\n\n"
        ...
        else
        {
            ...
            if (flags[kFLAGS.AIKO_CORRUPTION] < 0 || flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] == 0)
            {
                if (flags[kFLAGS.AIKO_AFFECTION] >= 50)
                {
                    ...
                    //33% chance if affection > 50{
                        
                        outputText("<i>\"DYNAMIC ENTRY!\"</i>\n\n"
                                + "Before you can react, you feel Aiko’s thighs suddenly slam down on your shoulders as she seems to drop out of nowhere. "
                    ...
                    //33% chance if affection > 50 else 50%{
            ...
            else
            {
                ...
                {
                    outputText("<i>\"Back again? You’d better not be wasting my time…\"</i> ");
                }
    ...
    {
        flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] = flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] ^ 1;
        flags[kFLAGS.AIKO_TIMES_MET]--;
    ...
    private function aikoE1Power() : Void
    {
        ...
        outputText("After a little thought, you tell her that a little more power could go a long way toward helping you on your quest.\n\n"
                + "<i>\"Teehee… Alright "
                + player.mf("Mr.", "Mrs.")
                + " Hero, your wish is my command,\"</i> Aiko teases, grinning mischievously. She thinks for a minute and then appears to be struck with inspiration, her face lighting up as she runs off, shouting to you, <i>\"Stay right here! Don’t move!\"</i>\n\n"
    ...
    private function aikoTouchFluffTail() : Void
    {
        ...
        outputText("<i>\"Wh-what?!\"</i> Aiko shouts, a deep crimson blush on her cheeks.\n\n"
                ...
                + "<i>\"O-oh… th-that’s what I thought you said,\"</i> she says, trying to hide her blush with her hands, looking [if ("
                + "[tallness]"
                + "> 64)up|down] at you cutely between her fingers. <i>\"W-well… I suppose… you could touch my tails… for just a little while…\"</i>\n\n");
        if (player.isRace(Races.KITSUNE, 1, false))
        
        //if (flags[kFLAGS.PC_KITSUNE_TAILFLUFFED] == 1) { // Need a flag here please. But only after the scene for PC experiencing it him/herself. So this is just placeholder. #NTMel{
        ...
        //#NTMel Again, needs the flag[kFLAGS.PC_KITSUNE_TAILFLUFFED] == 1. For now, can be this. Side note, is there a way to use the : thing to switch later on?{
    ...
    private function aikoLosesIntro() : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_aiko);
        outputText("Aiko drops to one knee, panting heavily and supporting herself with her bow. Mustering up the last reserves of her willpower, she lines up one last arrow and releases it, but her strength is clearly spent—the arrow lobs through the air with all the grace of a drunken bumblebee, flying wide and clattering against the trunk of a tree.\n\n"
                ...
                + "That’s a good question. She’s at your mercy now, so you could do just about whatever you want to her. "
                + ((player.cor >= 40) ? "An evil smirk crosses your face as you think about teaching this little bitch a lesson for crossing you." : "")
    ...
    @:allow(classes.scenes.nPCs)
    private function aikoWinsIntro() : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_aiko);
        ...
        if (flags[kFLAGS.AIKO_TIMES_MET] == 1)
        {
            ...
            {
                if (player.tail.type == Tail.FOX && player.tailCount == 9)
                
                //what's the difference in tail.type == Tail.FOX here and tailtype == 13 above?{
            ...
            else
            {
                outputText("<i>\"Just remember, you brought this on yourself,\"</i> she says as she lowers her bow, allowing it to disappear in a puff of smoke. She keeps her eyes trained on you as she walks over, cautiously preparing a fireball in one hand, and reaches down to retrieve the white star sphere from your pouch.\n\n"
                        ...
                        + "When you finally come to your senses, you find that you’ve been dumped at the edge of the forest, and there’s no sign of Aiko or the ancient-looking tree."  //+"8 Hours Pass…" //Don't need this if it doesn't actually jump by 8 hours.  );
            }
        }
        else
        {
    ...
    private function aikoRequestsBallAfterLose() : Void
    {
        ...
        outputText("You turn away from the collapsed kitsune, ready to leave, but stop when you feel her hand clutching your [armor] desperately.\n\n"
                ...
                + ""
                + ((player.cor >= 40) ? "You angrily swat her hand away, glaring at the impertinent girl." : "")
                + " Your hand moves instinctively to the pouch where you stowed the white star sphere you found earlier. She seems to be truly desperate to get it back... Will you give it to her?");
        //[Give][Don't Give]
        menu();
    ...
    private function aikoSexE2() : Void
    {
        ...
        if (flags[kFLAGS.AIKO_AFFECTION] >= 55)
        {
            outputText("She smiles a bit in return, giggling at your forwardness.\n\n"
                    ...
                    + "She walks over to you and [if ("
                    + "[tallness]"
                    + " >64)standing on tiptoes,] gives you a peck on your cheek that leaves behind a light tingling sensation as she starts to help you out of your [armor] carefully.");
            aikoConsSex();
        }
        else if (flags[kFLAGS.AIKO_AFFECTION] >= 50)
        {
        ...
        else
        {
            outputText("<i>\"You’ve got to be kidding me. After what you did?!\"</i>\n\n"
                    + "She sneers at you, baring her sharp animalistic teeth angrily. <i>\"Seriously, what are you, some kind of psycho? Get out of here, you unbelievable "
    ...
    private function aikoApologize1() : Void
    {
        ...
        outputText("You put your hands up slowly, trying to look as non-threatning as possible. You’re just here to talk, you explain.\n\n"
                ...
                + "You tell her that you want to apologize for what you did. You’ve had a little time to reflect on it and you feel terrible about "
                + ((flags[kFLAGS.AIKO_RAPE] <= 0) ? "attacking her" : "your brutal rape")
                + ". There’s no way mere words could make up for your shameful actions, so you understand if she can’t forgive you; you just needed to tell her you’re sorry.\n\n"
    ...
    private function aikoApologyTrick() : Void
    {
        ...
        if (flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] == 1)
        {
            flags[kFLAGS.AIKO_CORRUPTION] += 20;
        }
        if (player.str > 35)
        {
            outputText("She screams, struggling in vain against your superior physical strength as you beat her into submission, ripping her clothes off to claim your prize.\n\n"
                    + "<i>\"Y-you fucking "
                    + player.mf("bastard", "cunt")
                    + "!\"</i> she is in tears now, her face covered with dirt and scratches from the way you tumbled around with her. <i>\"I knew I shouldn’t have trusted you!\"</i>\n\n"
    ...
    private function aikoTalkE3() : Void
    {
        ...
        else
        {
            outputText("You tell her you just want to talk, holding your hands up.\n\n"
                    ...
                    + "<i>\"Why should I believe you? So far you’ve turned out to be nothing but an arrogant jackass who does whatever "
                    + player.mf("he", "she")
                    + " wants to whoever "
                    + player.mf("he", "she")
                    + " wants.\"</i>\n\n"
                    ...
                    + "<i>\"Of course, you didn’t think mine was the only one, did you? …Never mind. They’re hidden, and you won’t be getting their locations from me; I don’t even know where most of them are. "
                    + (((player.tail.type == Tail.FOX && player.tailCount == 9)) ? "you should be able to locate them if you want to, you are nine-tails and all." : "")
                    + "\"</i>\n\n"
    ...
    private function talkTentacles() : Void
    {
        ...
        outputText("You decide to ask her about some of the local fauna. You ask her what she knows about tentacle beasts.\n\n"
                ...
                +"You tell her you find that kind of hard to believe, but gesture for her to continue."
                ...
                + "You agree with her on that, and then the two of you discuss your various encounters with the creatures out in the wilds."  //(has not seen consentacles)    //+"(You tell her that now that she mentions it, you did see a kitsune with a tame tentacle monster once, but you didn’t know what to make of it. //(has seen consentacles) //Scene not in game currently  );
        if (talkAndSex)
        {
    ...
    private function talkAiko() : Void
    {
        ...
        outputText("You tell her that you had a few personal questions, if she doesn’t mind.\n\n"
                ...
                + "<i>\"[if (flags[kFLAGS.AIKO_TALK_AIKO]>0)Yeah, did you forget? ]That’s because I’m "
                + (((flags[kFLAGS.AIKO_BOSS_COMPLETE] > 0)) ? "an eight" : "a seven")
                + "-tails.\"</i> she explains, smiling as she runs a hand along the length of one of her tails. <i>\"We’re born with just one, but it splits as we grow older and our magic and wisdom gets stronger. The number of tails we have is something of a status symbol. My seventh tail came in just a little while after the demons showed up"
                + (((flags[kFLAGS.AIKO_BOSS_COMPLETE] > 0)) ? ", and my last one after we beat my sister, as you well know." : "")
                +"</i>\n\n"
                ...
                + "You decide to wrap the conversation up for now"  //removed the if since it didn't make sense.  );
    ...
    private function talkNineTails() : Void
    {
        ...
        if (player.isRace(Races.KITSUNE, 1, false) && player.tailCount == 9)
        ...
        outputText("She laughs with her tongue out of her mouth, pulling a mischievous grin.\n\n"
                ...
                + "You nod as you see her lips stop moving. You ask if she has ever become a retainer, noting that she has "
                + (((flags[kFLAGS.AIKO_BOSS_COMPLETE] > 0)) ? "eight" : "seven")
                + " tails. You see her with an irritated grin immediately after you finished talking, it's clear something is up.\n\n"
    ...
    private function talkArchery() : Void
    {
        ...
        if (player.weaponRangePerk == "Bow")
        {
            ...
            else if (flags[kFLAGS.AIKO_TALK_ARCHERY] == 1)
            {
                outputText("You tell her you’ve been trying to learn as well, pulling out your own bow to show her. She examines it for a bit, smiling as she runs her hand down the side.\n\n"
                        + "<i>\"Wow, this is quality work! Centaur make, if I’m not mistaken... Where did you get it?\"</i>\n\n"
                        + "You explain to her your dealings with Kelt, "
    ...
    private var playerchoice : Bool = true;
    public function aikoConsSex() : Void
    //[Missionary] [DoggyStyle] [BJ] [GetLicked] [Tailjob]--[Leave]
    {
        
        menu();
        addButton(0, "Missionary", aikoSexMissionary).disableIf(!player.hasCock(), "Req. a cock!");
        addButton(1, "DoggyStyle", aikoSexDoggy).disableIf(!player.hasCock(), "Req. a cock!");
        addButton(2, "BJ", aikoSexBJ).hint("Have her pleasure your dick with her mouth.").disableIf(!player.hasCock(), "Req. a cock!");
        addButton(3, "Get Licked", aikoSexCunni).hint("Let her explore the soft folds of your pussy with her tongue.").disableIf(!player.hasVagina(), "Req. a vagina!");
        if (flags[kFLAGS.AIKO_AFFECTION] >= 75)
        {
            addButton(4, "Tailjob", aikoSexTailjob).hint("Ask her to surround your cock with her luxurious tails").disableIf(!player.hasCock(), "Req. a cock!");
            addButton(5, "Kitsune Tailjob", aikoSexKitsuneTailjob).hint((silly()) ? "Kitsune tailplay! Floofing all the floofs!" : "Kitsune tailplay, in the way only Kitsunes can understand.").disableIf(!player.hasCock() && !player.hasVagina() || !player.isRace(Races.KITSUNE, 1, false), 
        ...
        addButton(9, "Submit", submitToAiko).hint("Submit to Aiko and see what she does with you").disableIf(!flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] || flags[kFLAGS.AIKO_CORRUPTION] <= 0, 
    ...
    public function pcWinsDomFight() : Void
    {
        ...
        if (flags[kFLAGS.AIKO_CORRUPTION] < 0 && flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] > 0)
        {
            outputText("Aiko stumbles and falls to the ground, panting hard. Though she puts up a good fight, in the end it seems her muscles are too weak to carry on, and she just stays slumped on the ground, looking up at you with a crazed fire in her eyes.\n\n"
                    + "<i>\"Eh...heh...haha... So you DO know how to show a girl a good time. Maybe you’re not such a "
                    + player.mf("limp-dicked choir boy", "washed-up whore")
                    + " after all.\"</i> she says, grinning sarcastically. <i>\"Well come on, or are you too much of a wuss to go through with it now that I’m on the ground?\"</i>\n\n"
    ...
    public function pcLosesDomFight() : Void
    {
        ...
        if (flags[kFLAGS.AIKO_CORRUPTION] < 0 && flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] > 0)
        {
            ...
            outputText("You fall to the ground, giving in to the crazed vixen’s power. Aiko approaches with a toothy grin and a glimmer of insanity in her eyes as she begins to disrobe, letting her clothes lay haphazardly where they drop. She plants a foot on your chest and pushes you back, giving you a smug little smirk as you collapse backward onto the ground.\n\n"
                    ...
                    + "To your "
                    + ((player.hasPerk(PerkLib.Masochist)) ? "delight" : "horror")
                    + ", your foxy dominatrix's hands both clasp firmly around your neck, bearing down on you. You choke and thrash weakly, staring up at her vindictive grin as darkness begins to enclose on your vision. At the edges of your consciousness, you can feel Aiko’s tails slowly sliding down toward your groin, "
                    + ((player.hasCock()) ? "wrapping around your [cocks]" : "")
                    + ((player.hasVagina() && player.hasCock()) ? " and " : "")
                    + ((player.hasVagina()) ? "beginning to tease your [clit] with their furry bottle-brush tips" : "")
                    + ".\n\n"
                    + "You gasp violently as her hands let up just enough to pull you back from the brink, filling your lungs with sweet fresh air at the exact moment that she begins to pump her tails "
                    + ((player.hasCock()) ? "up and down your [cocks]" : "")
                    + ((player.hasVagina() && player.hasCock()) ? " and " : "")
                    + ((player.hasVagina()) ? "into your [vagina]. The worst part is that it feels so GOOD" : "")
                    + ", the combination of the sensations pulling you toward your climax by leaps and bounds while Aiko laughs derisively at your pathetic struggles underneath her.\n\n"
                    ...
                    + "Her hands suddenly release their grip on your throat entirely, and as you hoarsely fill your lungs with sweet, wonderful fresh air, your body is wracked with a tremendous orgasm, sending you into a frenzy from head to toe. Aiko’s tails frizz up with pleasure as she seems to synchronize with you, clawing at her own body with both hands as she rides the wave of her own climax. "
                    + ((player.cumQ() > 350 && player.hasCock()) ? "Her abdomen swells with seed as your orgasm goes on for even longer than usual, a side effect of the strange asphyxiation-play that she put you through." : "")
                    + "\n\n"
                    + "Released from your pleasurable torment and finally able to climax, you lay panting on the ground, gasping for breath as Aiko slowly dismounts you"
                    + ((player.cumQ() > 350 && player.hasCock()) ? ", allowing the pent-up seed to gush out over your lower body" : "")
                    + ". Your last sight is that of her retrieving her robes just before you pass out from exhaustion.");
            if (player.hasCock())
            {
 ...
 */
    ...
    private function aikoRapeFuckVag() : Void
    {
        ...
        outputText(("up at the corners of her eyes as your hands tug at her chest wrap, letting her perky D-cups bounce free. " + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "You smack her around a bit more, telling her to shut up" + ((flags[kFLAGS.AIKO_TIMES_MET] == 1) ? " about her stupid star sphere" : "") + ". You could have sworn you told this bitch to keep her damn trap shut! " : "You do your best to shrug off the pangs of guilt, knowing that you’re in it too deep to turn back now.") + " She sniffles a little, biting her lip. It seems she’s prepared to suffer through whatever you plan to do to her, not that she had much choice in the matter." + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? " At least now, perhaps she’ll stop whining long enough for you to get off!" : "") + "\n\n" + "You place the tip of your [cock] against her quivering snatch, bearing down on her just a bit. Her moist love-hole is tight, but yields to you with relative ease. You let out a moan as you sink into her little by little, her soft, muscular walls wrapping around you and enveloping you with an almost ethereal warmth. [if (player.cocks[" + (x + 1) + "].length >= 40) Just when you are certain that she should be unable to take any more of your enormous manhood, a slurping contraction draws you even deeper.] " + ((player.hasKnot(x)) ? "When you feel your knot pushing against her lips, you shift your weight to lean over her and begin to pound her pussy with your [cock]." : "When you feel your hips rocking against hers, you shift your weight to lean over her and begin to pound her pussy with your [cock].") + " You shift focus to toying with her breasts, [if (player.hasPerk(PerkLib.Sadist)) biting her nipples painfully| pinching her nipples] while your hips roughly slam against her. As you begin to ramp up your furious thrusting, Aiko bites her lip and looks off to the side, her cheeks a glowering red. You can tell by the way her throat muscles tense up that she is doing her best to suppress her moans.\n\n" + "" + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "Roughly, you grasp her by the hair and yank her back to facing you, barking at her that you like to look your sluts in the eyes when you fuck them. She meekly complies, blinking away tears in her eyes. Yes, that’s a good slut…" : "") + "\n\n]" + "If one thing can be said in her favor, it’s that she knows how to please a cock—her pussy ripples around you with an incredible degree of control, squeezing, pulling and kneading your shaft with what can only be a practiced skill. You can only assume that she is trying to get you to cum quickly so she can get this over with, and she may just get her way if this keeps up.\n\n" + ((player.hasKnot(x)) ? "You feel yourself nearing your end and slam your knot home, Aiko's tight pussy having barely enough give for you to squeeze it in, but it lodges in place and grows to the max, locking you together.\n\n" : "") + player.cumQ() <= 150) ? "You let out a loud moan as your climax finally boils forth, shooting " + ((player.hasKnot(x)) ? "streams of cum into Aiko’s abused pussy before forcefully yanking out your knot, much to Aiko's displeasure and she screams from the pain of the forceful extraction." : "a few streams of cum into Aiko’s abused pussy, pulling out and letting the last few ropes spray across her stomach.") + "\n\n" : 
                ...
                + "You have no use for it, you reason, and she was a decent fuck, so you reach into your pouch and pull out the star sphere, haphazardly tossing it over. It lands in the sticky pool of cum forming between Aiko’s legs, a bit of it splattering up onto her thighs"
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? ", and for good measure, you hock a wad of spit onto it as well" : "")
                + ". " : "")
    ...
    private function aikoRapeFuckAss() : Void
    {
        ...
        outputText("Your eyes trail lasciviously down the fallen priestess’s body, and finally come to rest on the plump cheeks of her ass, exposed by her immodest robes. Making up your mind, you reach down to pull off the lower portion of her robes away, bearing down on her to prevent her from struggling.\n\n"
                ...
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "You backhand her across the face, reminding her to shut up and be a good little whore if she wants her star sphere back." : "You give her a disciplinary tap, reminding her to sit still if she wants to get her star sphere back.")
                + " She shrinks away from you and obediently raises her plump hind quarters into the air, her tails rising out of the way, revealing her glistening slit and cute pucker. Giving her a firm exploratory slap on the ass, you turn almost giddy with delight as the pillowy cheeks ripple and jiggle for an extended period of time.\n\n"
                ...
                + "[if (player.cockArea("
                + x
                + ") >= 40)<i>\"AH! N..no, no more, it’s not going to…iieah!\"</i> She cuts off mid sentence as you easily sink another four inches into her. Not fit? Hardly, you tell her, giving her a firm spank. Her slutty asshole begs to differ, you say—it’s practically swallowing your dick!\n\n]"
                + "You give one last firm shove forward with your hips, forcing a cry from Aiko’s throat as she is finally speared "
                + ((player.hasKnot(x)) ? "on your full length up to the knot, and that starting to spread her pucker rather wide." : "on the full length of your cock.")
                + " You’re barely able to control yourself as you squeeze her delicious ass, beginning to pump in and out with a reckless haste.\n\n"
                + "Aiko squeals, but from pain or pleasure, it is difficult to tell. "
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "You find yourself hoping that it is the former, making a point of roughly abusing her ass for your own selfish pleasure. " : "")
                + "The way her rectum constricts your shaft is exquisite, the inner flesh feeling pillowy soft and warm as it ripples across your [cock] with every thrust.\n\n"
                + "You lose yourself in the pleasure, your ears deaf to the lovely priestess’s cries as her ass is impaled on your rod again and again, pulling you closer and closer to climax with every thrust."
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? " Smiling vindictively, you lean over her, digging your nails into her back painfully as you pound her ass harder still, her pained yelps filling you with delight." : "")
                + " Finally, you can take it no longer, "
                + ((player.hasKnot(x)) ? "shoving your hips forward with all your might and burying your knot in her ass as," : "")
                + " your shaft distending with cum as you begin to pour out your lusts into the girl’s abused fuckhole. "
                + ((player.cumQ() > 350) ? "Her belly begins to swell with your seed, gurgling audibly as you dump load after load into her innards. When your cock’s spasms finally end, she is significantly rounder and heavier than previously, weighed down by the enormous volume of semen you filled her with." : "")
                + "\n\n"
                ...
                + "When you pull out, her ass makes a sloppy slurping noise around your shaft, a glob of jism spilling out after it and splashing to the ground. "
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "Aiko lays in a puddle comprised mainly of her own pussy juices, tears, and shame, weeping softly. " : "")
                + "You stand and brush yourself off, giving the kitsune priestess a hearty smack on the ass"
                +
    ...
    private function aikoRapeHumiliate() : Void
    {
        ...
        outputText("As you stand over the fallen priestess, your eyes stray to her lush, bushy tails and furry ears. The cute fox-girl’s defiant yet defeated expression only enhances your desire to make her your pet. Her expression takes on a slightly fearful tone when she notices the sinister smile that graces your face as you walk forward and kneel down over her.\n\n"
                ...
                + "You "
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "promptly slap her" : "give her a small disciplinary tap on the nose")
                + ", silencing the meager defiance—you let her know that "
                + ((player.cor <= 50) ? "for now" : "")
                + " she belongs to you, regardless of her past experiences, especially if she ever hopes to get her star sphere back. Commanding her to get on all fours, the defeated fox girl can do nothing but obey as she hesitantly gets in position, blushing meekly"
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? " and tearing up" : "")
                + " as she whimpers on.\n\n"
                + "<i>\"Please...all I ask is that you be gentle with me.\"</i>\n\n"
                + "You let her know that her request is duly noted, but only for as long as your will allows. Your hand finally makes contact, and the stroking begins, curious to fully test her sensitivity. You begin with a gentle motion, and Aiko’s reaction exceeds your wildest expectations. Her eyes roll back into her head as her tongue starts to loll out, body bucking and twitching in time with the rhythm of your strokes as she suffers through the telltale signs of a rapidly-approaching orgasm. It’s quite clear that she’s enjoying her treatment, but unfortunately for her, you are reaching the end of your mercy. You turn your gently-stroking palm into a "
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? "clenched fist" : "firm grip")
                + " around one of the furry limbs, and Aiko arches her back in response, releasing a howl. Her confused yelps alternate between pleasure and pain, but as her dripping pussy begins to turn into a torrential flood, you can easily tell which feeling has higher priority. Her wetness drenches her thighs as her knees buckle, and she collapses onto the ground, unable to support her own weight from the convulsions brought on by her climax.\n\n"
                + "After her body finally stops twitching, Aiko lays utterly defeated,"
                + ((player.cor >= 50 || player.hasPerk(PerkLib.Sadist)) ? " meagerly crying in a pool of her own shame," : "")
                + "but you are far from finished. You turn her around so you can plant your lips firmly against hers, shoving your tongue down her throat and moaning lewdly into her mouth as your hand roughly grips the hair on the back of her head. You break your kiss only to begin breathing hotly into her ear, and as she melts from the brief moment of passion, you whisper promises that her pain will only give way to greater pleasure. Aiko, already broken by her shame, hangs her head and prepares herself to suffer through whatever it takes to get her star sphere back.\n\n");
        if (player.hasVagina())
        {
    ...
    private function aikoSexDoggy() : Void
    {
        clearOutput();
        spriteSelect(SpriteDb.s_aiko);
        var y : Float = player.cockThatFits(50, "area");
        var x : Float = rand(player.cocks.length);
        ...
        outputText(((playerchoice) ? "You tell Aiko that this time, you want to take her doggy style." : "Aiko looks you over for a bit, an uncharacteristic lust in her eyes as her gaze lingers over your groin for a moment. <i>\"Mn... I’m in the mood for something a bit ‘wild’ today... if you know what I mean,\"</i> she says, giving you a coy smirk.")
                ...
                + "The wonderful warmth of her insides wraps around you like a glove, and your hips fall forward involuntarily, "
                + ((player.hasKnot(x)) ? "driving the full length of your shaft up till the knot" : "driving every last inch of your shaft")
                + " inside in one stroke. Aiko’s mouth opens wide in a powerful moan, and she begins to rock her hips back and forth, slamming her bountiful bottom against your "
                + ((player.hasKnot(x)) ? "knot" : "hips")
                + " over and over again.\n\n"
                ...
                + "Impaled on your shaft[if ("
                + (y + 1)
                + " != 0)s], Aiko starts to buck back into you with redoubled passion, pressing her cheek into the grass as she continues to flick and squeeze her clitoris.\n\n"
                ...
                + "She cums HARD, and the effect is immediate and intense—her pussy [if ("
                + (y + 1)
                + " != 0)and asshole] squeeze[if ("
                + (y + 1)
                + " == 0)s] down on your cock[if ("
                + (y + 1)
                + " != 0)s], and the heat inside her becomes almost unbearably pleasurable. You can’t hold back any longer, and have no reason to, squeezing her hips and thrusting with one final moan as you release your load inside her.\n\n"
                ...
                + "Gathering your things, you put on your [armor] and head back to camp."  //possible play with aiko tails on pc pussy  );
        flags[kFLAGS.AIKO_SEXED]++;
        postSexUpdate();
        player.sexReward("vaginalFluids", "Dick");
        if (player.hasStatusEffect(StatusEffects.Spar))
    ...
    private function aikoSexBJscene(x : Int) : Void
    {
        ...
        postSexUpdate();
        player.sexReward("saliva", "Dick");
        if (flags[kFLAGS.AIKO_TIMES_MET == 1] != null)
        {
            doNext(aikoE1SexPart2);
        }
        else
    ...
    private function aikoSexTailjob() : Void
    {
        ...
        outputText(((playerchoice) ? "You ask Aiko if she can use her tails this time as you seductively let your [armor] slide off your body, exposing to the skittish kitsune your [cock]. She instantly blushes and lowers her ears, aww.\n\n"
                ...
                + "<i>\"Just relax... and enjoy my fluffy tails, big boy.\"</i> She says coyly as you see her "
                + (((flags[kFLAGS.AIKO_BOSS_COMPLETE] > 0)) ? "eight" : "seven")
                + " tails start moving and stretching out like the feathers of a peacock. You already feel hard just at looking at them.\n\n"
    ...
    private function yamataIntro() : Void
    {
        ...
        outputText("The streets of the Kitsune village are deserted, and an eerie silence has settled over the town. Each house you pass is just as dark and empty as the last, and there’s not a single sign of any of the townsfolk. Just as you begin to think you might have been too late, you hear someone cry out in pain!\n\n"
                ...
                + "<i>\""
                + ((player.racialScore(Races.CAT, false) > 0) ? "Well, well... look who the cat dragged in!" : "Well, well... look who we have here...")
                + "\"</i>\n\n"
                ...
                + "<i>\"Looking for this?\"</i> she says, grinning condescendingly as she twirls Aiko’s star sphere on her fingertip. <i>\"I see you’ve brought a friend, dear sister. I hope you don’t think "
                + player.mf("he", "she")
                + "’s going to save you!\"</i> Grinning, she shoves her insensate victim aside with a foot, and begins walking toward you and Aiko. <i>\"Of course, I can always use more toys for my pleasure... Mn... Yes, I think you’ll be the perfect addition to my playhouse... Champion.\"</i>\n\n"
                ...
                + "<i>\"[name]! "
                + ((flags[kFLAGS.AIKO_CORRUPTION] < 0 || flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] == 0) ? "I... I believe in you!" : "Kick that cocky bitch’s ass!")
                + "\"</i>");
    ...
    public function yamataLoses() : Void
    {
        ...
        outputText("You relax your shoulders as you see Yamata falling onto her all fours, desperately gasping with her evil eyes opened.\n\n"
                + "<i>\"IMPOSSIBLE! You have such strength, "
                + ((player.racialScore(Races.KITSUNE, false) == 0) ? "for a lowly mortal!" : "even if you are weaker than I am!")
                + "\"</i>\n\n"
                ...
                + "You look at the defeated demon, with her eyes she's pleading mercy. You suppose you can let Yamata go, let Aiko finish her sister"
                + ((player.cor > 60) ? ", end her yourself or fuck her before deciding what to do." : "or end her yourself."));
    ...
    private function killYamata() : Void
    {
        ...
        switch (_sw0_)
        {
            ...
            case "slash", "stab":outputText("You narrow your eyes and dash toward the defeated corrupted kitsune, Aiko and Yamata both widening their eyes in surprise. You then coldly stab the defeated opponent right to the heart");
    ...
    private function yamataAftermath() : Void
    {
        ...
        outputText("Before you can go to free the kitsune townsfolk, your attention is drawn by the nefarious blade Yamata was using. \"Muramasa\", you recall her naming it. You approach it cautiously, inspecting the blade closely: it's a black and sharp-edged katana with deep purplish black swirls moving throughout the blade, it emits a very fierce corrupted energy, making you feel dirty by simply being near it. You think that this weapon may be too corrupted even for Rathazul to cleanse.\n\n"
                + "Aiko arrives and narrows her eyes, peering at the sword. <i>\"This is a very powerful weapon... if ever it falls into demonic hands again, it will be disasterous... "
                + ((flags[kFLAGS.AIKO_BOSS_COMPLETE] == 1) ? "Perhaps I can purify it with my magic" : "I can use it to locate Yamata, I think I'll be able to use it against her when I'm ready")
                + ".\"</i> You stand still and watch Aiko grab the hilt of the katana and pull it out of the ground. You are tempted to warn her of its demonic influence, though she probably already knows more about the blade than you do, and can sense the taint regardless. She clearly understands the dangers of her actions.\n\n"
