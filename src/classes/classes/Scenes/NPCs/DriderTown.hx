...
class DriderTown extends NPCAwareContent implements SaveableState
{
    public static var DriderTownComplete : Bool;
    public static var SisterBangEnabled : Bool;
    public static var BelisaKids : Float;
    public static var BelisaPregnancy : Float;
    public static var BelisaKidsEggs : Float;
    public static var BelisaKidsEggs1 : Float;
    public static var BelisaKidsEggs2 : Float;
    public static var BelisaKidsEggsHatching : Float;
    public static var BelisaKidsEggsHatching1 : Float;
    public static var BelisaKidsEggsHatching2 : Float;
    public static var LilyKidsPC : Float;
    public static var LilyKidsPCPregnancy : Float;
    public static var LilyKidsPCEggs : Float;
    public static var LilyKidsPCEggs1 : Float;
    public static var LilyKidsPCEggs2 : Float;
    public static var LilyKidsPCEggsHatching : Float;
    public static var LilyKidsPCEggsHatching1 : Float;
    public static var LilyKidsPCEggsHatching2 : Float;
    public static var LilyKidsIzma : Float;
    public static var LilyKidsIzmaPregnancy : Float;
    public static var LilyKidsSidone : Float;
    public static var LilyKidsSidonePregnancy : Float;
    public static var TyrantiaMaleKids : Float;
    public static var TyrantiaFemaleKids : Float;
    public static var TyrantiaPregnancy : Float;
    public static var TyrantiaKidsEggs : Float;
    public static var TyrantiaKidsEggs1 : Float;
    public static var TyrantiaKidsEggs2 : Float;
    public static var TyrantiaKidsEggsHatching : Float;
    public static var TyrantiaKidsEggsHatching1 : Float;
    public static var TyrantiaKidsEggsHatching2 : Float;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            DriderTownComplete = Reflect.field(o, "DriderTownComplete");
            SisterBangEnabled = Reflect.field(o, "SisterBangEnabled");
            BelisaKids = valueOr(Reflect.field(o, "BelisaKids"), 0);
            BelisaPregnancy = valueOr(Reflect.field(o, "BelisaPregnancy"), 0);
            BelisaKidsEggs = valueOr(Reflect.field(o, "BelisaKidsEggs"), 0);
            BelisaKidsEggs1 = valueOr(Reflect.field(o, "BelisaKidsEggs1"), 0);
            BelisaKidsEggs2 = valueOr(Reflect.field(o, "BelisaKidsEggs2"), 0);
            BelisaKidsEggsHatching = valueOr(Reflect.field(o, "BelisaKidsEggsHatching"), 0);
            BelisaKidsEggsHatching1 = valueOr(Reflect.field(o, "BelisaKidsEggsHatching1"), 0);
            BelisaKidsEggsHatching2 = valueOr(Reflect.field(o, "BelisaKidsEggsHatching2"), 0);
            LilyKidsPC = Reflect.field(o, "LilyKidsPC");
            LilyKidsPCPregnancy = Reflect.field(o, "LilyKidsPCPregnancy");
            LilyKidsPCEggs = valueOr(Reflect.field(o, "LilyKidsPCEggs"), 0);
            LilyKidsPCEggs1 = valueOr(Reflect.field(o, "LilyKidsPCEggs1"), 0);
            LilyKidsPCEggs2 = valueOr(Reflect.field(o, "LilyKidsPCEggs2"), 0);
            LilyKidsPCEggsHatching = valueOr(Reflect.field(o, "LilyKidsPCEggsHatching"), 0);
            LilyKidsPCEggsHatching1 = valueOr(Reflect.field(o, "LilyKidsPCEggsHatching1"), 0);
            LilyKidsPCEggsHatching2 = valueOr(Reflect.field(o, "LilyKidsPCEggsHatching2"), 0);
            LilyKidsIzma = Reflect.field(o, "LilyKidsIzma");
            LilyKidsIzmaPregnancy = Reflect.field(o, "LilyKidsIzmaPregnancy");
            LilyKidsSidone = Reflect.field(o, "LilyKidsSidone");
            LilyKidsSidonePregnancy = Reflect.field(o, "LilyKidsSidonePregnancy");
            TyrantiaMaleKids = valueOr(Reflect.field(o, "TyrantiaMaleKids"), 0);
            TyrantiaFemaleKids = valueOr(Reflect.field(o, "TyrantiaFemaleKids"), 0);
            TyrantiaPregnancy = valueOr(Reflect.field(o, "TyrantiaPregnancy"), 0);
            TyrantiaKidsEggs = valueOr(Reflect.field(o, "TyrantiaKidsEggs"), 0);
            TyrantiaKidsEggs1 = valueOr(Reflect.field(o, "TyrantiaKidsEggs1"), 0);
            TyrantiaKidsEggs2 = valueOr(Reflect.field(o, "TyrantiaKidsEggs2"), 0);
            TyrantiaKidsEggsHatching = valueOr(Reflect.field(o, "TyrantiaKidsEggsHatching"), 0);
            TyrantiaKidsEggsHatching1 = valueOr(Reflect.field(o, "TyrantiaKidsEggsHatching1"), 0);
            TyrantiaKidsEggsHatching2 = valueOr(Reflect.field(o, "TyrantiaKidsEggsHatching2"), 0);
        }
    ...
    public function DriderTownEnter() : Void
    {
        ...
        if (BelisaKidsEggs > 0 || BelisaKidsEggs1 > 0 || BelisaKidsEggs2 > 0 || TyrantiaKidsEggs > 0 || TyrantiaKidsEggs1 > 0 || TyrantiaKidsEggs2 > 0)
        {
            outputText("Several egg-sacs are hung inside Tyrantia’s hutch, now a longhouse, and one of the Drider sisters is always on guard by the door.\n\n");
        }
        if (BelisaKids > 0)
        {
            outputText("Several small Drider-kids wander around their little complex, playing, weaving or play-fighting with the others. Belisa frequently looks over at the smaller Driders, a smile on her face as she watches them play. You currently have " + BelisaKids + " kids milling around.\n\n");
        }
        ...
        if (LilyKidsPC > 0)
        {
            outputText("From her treehouse, Lily watches her spider-children at play. Some sit underneath the tree, reading, while others rush around the tree, throwing silk lines at each other.\n\n");
        }
        menu();
        ...
        //{
            ...
            if (SisterBangEnabled && player.hasCock())
            
            //remove later on req. to have cock{
                
                if (player.gender > 0)
                {
                    addButton(3, "Bonding", FamilySex);
                }
                else
                {
                    addButtonDisabled(3, "Bonding", "No bonding for genderless one.");
                }
            }
    ...
    public function DriderTownSisters() : Void
    {
        ...
        {
            addButtonDisabled(1, "Belisa", "Training.");
        }
        else
        {
        ...
        {
            addButtonDisabled(2, "Lily", "Training.");
        }
        else
        {
        ...
        {
            addButtonDisabled(3, "Tyrantia", "Training.");
        }
        else
        {
            addButton(3, "Tyrantia", SceneLib.tyrantia.TyrantiaAtCamp);
        }
    ...
    public function BelisaEggLaying() : Void
    {
        ...
        {
            outputText("The middle sister comes over as fast as she can, positioning herself on the other side of the trough, holding her hands out. Belisa takes Lily’s hands, and the siblings lock eyes.\n\n");
        }
    ...
    public function LilyEggLayingPC() : Void
    {
        ...
        if (BelisaFollower.BelisaInCamp && TyrantiaFollower.isLover())
        {
            outputText("\"<i>Lily’s gonna lay her eggs.</i>\" Tyrantia calls. \"<i>Belisa, I’ve got her, you’ve got the net.</i>\" The two sisters move quickly, positioning her close to the net.\n\n");
        }
        else if (BelisaFollower.BelisaInCamp)
        {
            outputText("\"<i>You came just in time!</i>\" Belisa calls out. \"<i>She’s going to lay, any minute now!</i>\" She leans Lily against a tree. \"<i>Hold on, sis.</i>\"\n\n");
        }
        else if (TyrantiaFollower.isLover())
        {
            outputText("\"<i>Good timing, [name]!</i>\" The giantess says. \"<i>Help me out, wouldya?</i>\" Lily leans on her larger sister, and groans, eyes opening and closing rapidly \"<i>It’s okay, sis. Hold in there.</i>\"\n\n");
        }
    ...
    public function SpooderSleep() : Void
    {
        ...
        if (!SisterBangEnabled)
        {
            ...
            if ((BelisaKids + LilyKidsPC + TyrantiaFemaleKids + TyrantiaMaleKids) > 0)
            {
                outputText("Several Driders are bustling in and out of various nooks in the building, and you notice that there’s a stone climbing wall to the left, leading underground. One of your Drider kids scuttles up to you, hugging you around the waist for a moment before scuttling off again, happier than before.\n\n");
            }
    ...
    public function SpooderBang() : Void
    {
        ...
        {
            outputText("Lily goes to work on your downstairs, pulling your [lowergarment] down and away.\n\n");
        }
        else
        {
    ...
    public function TriFuckta() : Void
    {
        ...
        {
            sceneHunter.print("You could still use more ;).");
        }
        ...
        if (player.cockTotal() > 4)
        {
            outputText("After a few minutes, you feel two of the hands on your shafts leave. ");
        }
        else if (player.cockTotal() == 4)
        {
            outputText("After a few minutes, your lone pussyless shaft is abandoned. ");
        }
        ...
        if (player.cockTotal() > 4)
        {
            outputText("After a few minutes, you feel two of the hands on your shafts leave.  Your unattended shafts are taken care of as Belisa’s hands replace Lily’s");
        }
        else if (player.cockTotal() == 4)
        {
            outputText("After a few minutes, your lone pussyless shaft is abandoned. Belisa’s smooth hands wrap around the shaft Lily’s left behind ");
        }
        if (player.cockTotal() >= 4)
        {
            outputText(", and ");
