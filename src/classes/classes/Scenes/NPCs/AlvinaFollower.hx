...
class AlvinaFollower extends NPCAwareContent implements TimeAwareInterface implements SaveableState
{
    public var JojoDevilPurification : Int;
    public var DefeatedAlvinaFirstStage : Bool;
    public var GaveAlvinaFafnirTear : Bool;
    public var GaveAlvinaFlowers : Bool;
    public var GaveAlvinaChocolate : Bool;
    public var GaveAlvinaMrPaw : Bool;
    public var GaveAlvinaWand : Bool;
    public var MetAlvinaAtBar : Bool;
    public var GiftCooldown : Int;
    public var WandCooldown : Int;
    public var DateFailed : Bool;
    public var FirstDateSuccess : Bool;
    public var SecondDateSuccess : Bool;
    public var FightForAlvina : Bool;
    public var AlvinaFightingToCorruptYou : Bool;
    public var AlvinaDied : Bool;
    public var AlvinaPurified : Bool;
    public var AlvinaInfernalOilAsked : Bool;
    public var AlvinaInfernalOilCooldown : Int;
    public var AlvinaGaveScroll : Bool;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            JojoDevilPurification = valueOr(Reflect.field(o, "JojoDevilPurification"), 0);
            DefeatedAlvinaFirstStage = valueOr(Reflect.field(o, "DefeatedAlvinaFirstStage"), false);
            GaveAlvinaFafnirTear = valueOr(Reflect.field(o, "GaveAlvinaFafnirTear"), false);
            GaveAlvinaFlowers = valueOr(Reflect.field(o, "GaveAlvinaFlowers"), false);
            GaveAlvinaChocolate = valueOr(Reflect.field(o, "GaveAlvinaChocolate"), false);
            GaveAlvinaMrPaw = valueOr(Reflect.field(o, "GaveAlvinaMrPaw"), false);
            GaveAlvinaWand = valueOr(Reflect.field(o, "GaveAlvinaWand"), false);
            MetAlvinaAtBar = valueOr(Reflect.field(o, "MetAlvinaAtBar"), false);
            GiftCooldown = valueOr(Reflect.field(o, "GiftCooldown"), 0);
            WandCooldown = valueOr(Reflect.field(o, "WandCooldown"), 0);
            DateFailed = valueOr(Reflect.field(o, "DateFailed"), false);
            FirstDateSuccess = valueOr(Reflect.field(o, "FirstDateSuccess"), false);
            SecondDateSuccess = valueOr(Reflect.field(o, "SecondDateSuccess"), false);
            FightForAlvina = valueOr(Reflect.field(o, "FightForAlvina"), false);
            AlvinaFightingToCorruptYou = valueOr(Reflect.field(o, "AlvinaFightingToCorruptYou"), false);
            AlvinaDied = valueOr(Reflect.field(o, "AlvinaDied"), false);
            AlvinaPurified = valueOr(Reflect.field(o, "AlvinaPurified"), false);
            AlvinaInfernalOilAsked = valueOr(Reflect.field(o, "AlvinaInfernalOilAsked"), false);
            AlvinaInfernalOilCooldown = valueOr(Reflect.field(o, "AlvinaInfernalOilCooldown"), 0);
            AlvinaGaveScroll = valueOr(Reflect.field(o, "AlvinaGaveScroll"), false);
        }
        else
        {
            resetState();
    ...
    public function alvinaSecondEncounter() : Void
    {
        ...
        {
            outputText(" though it ended in disaster, thanks to your actions");
        }
    ...
    public function alvinaSecondEncounterTalkHer(next : Function) : Void
    {
        ...
        if (player.inte > 150)
        {
            outputText("There’s something she’s not telling you, likely it being related to her relation with the sand witches. She probably left in very bad terms. Regardless, you find it more prudent to talk about something else.\n\n");
        }
        doNext(next);
    }
    ...
    public function alvinaThirdEncounter() : Void
    {
        ...
        if (SecondDateSuccess)
        {
            outputText("You have a feeling Marae's Pure Pearl could be useful here.");
        }
        menu();
    ...
    public function alvinaThirdEncounterYes() : Void
    {
        ...
        {
            outputText("<i>You even defeated Lethice for me, which I will admit is highly convenient. She was way too hardheaded for me to properly redirect as I pleased.</i>");
        }
        outputText("\"");
    ...
    public function alvinaThirdEncounterYesContinue() : Void
    {
        ...
        {
            outputText("I’m amazed a being still carrying a soul would achieve what you did. ");
        }
        ...
        menu();
        if (flags[kFLAGS.SIEGWEIRD_FOLLOWER] >= 4)
        {
            addButtonDisabled(0, "Sure", "There's no way you would be able to have HER in your camp at the same time as Siegweird. He'd kill her or she'd kill him.");
        }
        else
        {
            addButton(0, "Sure", alvinaThirdEncounterYesSure);
        }
        if (SecondDateSuccess)
        {
            addButton(3, "Stop It!", alvinaDontFight);
        }
    ...
    public function alvinaThirdEncounterYesNever() : Void
    {
        ...
        {
            outputText("You're here to kill this witch. There is no way you’d ever accept her offer. ");
        }
    ...
    public function alvinaCanMeetAtBar() : Bool
    {
    ...
    public function alvinaOnGiftCooldown() : Bool
    {
    ...
    public function alvinaWaitingAtRavine() : Bool
    {
    ...
    public function alvinaMeetAtBar() : Void
    {
        ...
        if (gaveAnyPresent())
        {
            outputText("\"<i>Ah [name], how nice to see you. ");
        }
        else
        {
            outputText("\"Ah [name], a welcome sight indeed. ");
        }
        ...
        var gaveAnyPresent : Void->Bool = function() : Bool
        {
            return GaveAlvinaFlowers || GaveAlvinaFafnirTear || GaveAlvinaChocolate || GaveAlvinaMrPaw || GaveAlvinaWand;
        }
        ...
        var gaveAllPresents : Void->Bool = function() : Bool
        {
            return GaveAlvinaFafnirTear && GaveAlvinaChocolate && GaveAlvinaMrPaw && GaveAlvinaWand && WandCooldown < 0;
        }
    ...
    public function alvinaBarGiftOptions() : Void
    {
        ...
        var hasFlowers : Void->Bool = function() : Bool
        {
    ...
    public function alvinaGiveAFlower() : Void
    {
        spriteSelect(SpriteDb.s_archmage_alvina_shadowmantle2Concealed_16bit);
        clearOutput();
        var flowers : Array<Dynamic> = [];
        if (player.hasItem(consumables.F_TEAR))
        {
            flowers.push(consumables.F_TEAR);
        }
        else
        {
            if (player.hasItem(consumables.DRAKHRT))
            {
                flowers.push(consumables.DRAKHRT);
            }
            if (player.hasItem(consumables.STRFLOW))
            {
                flowers.push(consumables.STRFLOW);
            }
            if (player.hasItem(consumables.SNAKEBANE))
            {
                flowers.push(consumables.SNAKEBANE);
            }
        }
        ...
        menu();
        if (flower.shortName == consumables.F_TEAR.shortName)
        {
            addButton(0, "Yes", alvinaGiveFafnirTear);
        }
        else
        {
            addButton(0, "Yes", alvinaGiveFlower, flower);
        }
    ...
    public function alvinaDontFight() : Void
    {
        ...
        if (flags[kFLAGS.ALVINA_DIARY] >= 4)
        {
            ...
            if (FirstDateSuccess)
            {
                outputText(" You also saw her reactions to the flower and the teddy bear. ");
            }
            ...
            if (SecondDateSuccess)
            {
                outputText("Not after she recoiled when you told her the beauty of impermanence and living like every day was your last. ");
            }
    ...
    public function alvinaDontFightWon() : Void
    {
        ...
        menu();
        addButton(0, "Stop her", alvinaDestroyPhylactoryStopHer).disableIf(player.spe100 < 80, "You are simply not fast enough to stop her.").disableIf(!player.hasItem(consumables.P_PEARL), "You were warned to bring the pearl along, now it is too late!");
    ...
    {
        menu();
        addButton(0, "Take Her", curry(sceneHunter.callBigSmall, alvinaPureTakeHer, 20, 10, "length")).disableIf(!player.hasCock(), "You need a penis to do this");
        addButton(1, "Let Her", alvinaPureLetHerTakeYou).disableIf(!player.hasVagina(), "You need a vagina to do this");
        addButton(2, "Make Out", alvinaPureMakeOut).disableIf(!player.hasVagina(), "You need to have a vagina to do this");
    ...
    public function alvinaMainCampMenu() : Void
    {
        ...
        if (flags[kFLAGS.ALVINA_DIARY] < 5)
        {
            addButton(1, "Diary", alvinaMainCampMenuDiary);
        }
        if (flags[kFLAGS.ALVINA_DIARY] == 5)
        {
            addButton(1, "Diary", alvinaMainCampMenuDiaryAreYouSure);
        }
        if (flags[kFLAGS.ALVINA_DIARY] == 6)
        {
            addButtonDisabled(1, "Diary", "You've already read it.");
        }
        if (player.statusEffectv1(StatusEffects.AlvinaTraining2) == 4 && flags[kFLAGS.ALVINA_FOLLOWER] >= 16)
        {
            ...
            {
                addButton(2, "Sex", alvinaMainCampSexMenu).disableIf(player.isGenderless(), "Not. For. Genderless!");
            }
            if (flags[kFLAGS.ALVINA_FOLLOWER] == 16 || flags[kFLAGS.ALVINA_FOLLOWER] == 18)
            {
                addButton(2, "Confession", alvinaMainCampMenuConfession).hint("If you don't know what this means... I have lost faith in your intelligence.");
            }  //Just cleaning this up.  
            if (flags[kFLAGS.ALVINA_FOLLOWER] < 21)
            {
                addButton(3, "Proposal", alvinaProposal).disableIf(player.isGenderless(), "Not. For. Genderless!").disableIf(flags[kFLAGS.ALVINA_TIMES_FUCKED] < 4, "You doubt it is mutual. You don't even have sex with her often enough!").disableIf(!flags[kFLAGS.MICHIKO_TALK_MARRIAGE], "You don't know something important about Mareth yet. Check later.", "???").disableIf(flags[kFLAGS.ALVINA_DIARY] < 6, "You still don't know her well enough... maybe her diary could help?", "???").disableIf(flags[kFLAGS.ALVINA_FOLLOWER] < 20, "You should know her better for this", "???").disableIf(!sceneHunter.canMarry(), "You have already married someone else.");
            }
            if (sceneHunter.married("Alvina"))
            {
                if (flags[kFLAGS.SLEEP_WITH] == "Alvina")
                {
                    addButton(4, "Sleep Alone", noSleep);
                }
                else
                {
                    addButton(4, "Sleep WIth", sleepWith).hint("Ask Alvina to sleep with her.");
                }
            }
            else
            {
                addButtonDisabled(4, "???", "See the button to the left? Make it work :)");
            }
        }
        else
        {
            addButtonDisabled(2, "???", "You need to finish Advanced Study to unlock this option.");
        }
        if (flags[kFLAGS.ALVINA_FOLLOWER] >= 19)
        {
            if (player.hasPerk(PerkLib.BasicLeadership))
            {
                addButton(5, "Team", alvinaHenchmanOption);
            }
            else
            {
        ...
        {
            addButtonDisabled(10, "Study", "You have already completed basic Study.");
        }
        else
        {
            addButton(10, "Study", alvinaCampStudy);
        }
        if (player.hasStatusEffect(StatusEffects.AlvinaTraining) && player.statusEffectv1(StatusEffects.AlvinaTraining2) < 2)
        {
            addButton(11, "Advanced Study", alvinaCampAdvancedStudy);
        }
        else
        {
            if (player.hasStatusEffect(StatusEffects.AlvinaTraining) && player.statusEffectv1(StatusEffects.AlvinaTraining2) == 2)
            {
                if (player.hasItem(useables.AMETIST, 1) && player.hasItem(consumables.L_DRAFT, 5) && player.hasItem(useables.SOULGEM, 5) && (player.hasKeyItem("Marae's Lethicite") >= 0 && player.keyItemvX("Marae's Lethicite", 1) > 0 || player.hasKeyItem("Stone Statue Lethicite") >= 0))
                {
                    addButton(11, "Advanced Study", alvinaCampAdvancedStudy);
                }
                else
                {
                    addButtonDisabled(11, "Advanced Study", "You need to gather a flawless Amethyst necklace, five lust drafts, five soul gems, and a piece of very powerful Lethicite before you can progress.");
                }
            }
            if (player.statusEffectv1(StatusEffects.AlvinaTraining2) == 3)
            {
                if (player.hasKeyItem("Siegweird's holy symbol") >= 0)
                {
                    addButton(11, "Advanced Study", alvinaCampAdvancedStudy);
                }
                else
                {
                    addButtonDisabled(11, "Advanced Study", "You need to go kill a certain annoying paladin in Blight Ridge.");
                }
            }
            if (player.statusEffectv1(StatusEffects.AlvinaTraining2) == 4)
            {
                addButtonDisabled(11, "Advanced Study", "You have already completed Advanced Study.");
            }
        }
    ...
    public function alvinaMainCampMenuAppearance() : Void
    {
        ...
        if (flags[kFLAGS.ALVINA_FOLLOWER] < 19)
        {
            outputText(" I have little time for games as you know all too well.");
        }
        outputText("</i>\"\n\n");
        menu();
    ...
    public function alvinaMainCampSexMenu2() : Void
    {
        if (player.lib > 50)
        {
            ...
            if (sceneHunter.married("Alvina"))
            {
                outputText(" It’s been so long since last we consummated our love. I’m quite glad you asked, as you know. ");
            }
            ...
            if (sceneHunter.married("Alvina"))
            {
                outputText(" Not that you mind. Since the wedding, Alvina has been doing less research on how to bend the universe and more on how for both of you to have the best mind-blowing sex, an initiative you greatly appreciate.");
            }
            //sex menu
            menu();
            if (player.hasCock())
            {
                addButton(0, "Pride of Lucifer", alvinaMainCampSexMenuPrideOfLucifer);
            }
            else
            {
                addButtonDisabled(0, "Pride of Lucifer", "Need to be Male or Herm for this.");
            }
            //addButtonDisabled(1, "Greed of Mammon", "Still unwritten.");
            if (player.hasVagina())
            {
                addButton(2, "Blaspheme of Baphomet", alvinaMainCampSexMenuBlasphemeOfBaphomet);
            }
            else
            {
                addButtonDisabled(2, "Blaspheme of Baphomet", "Need to have pussy for this.");
            }
            if (player.hasVagina())
            {
                addButton(3, "Contract of Mephistopheles", alvinaMainCampSexMenuContractOfMephistopheles);
            }
            else
            {
                addButtonDisabled(3, "Contract of Mephistopheles", "Need to have pussy for this.");
            }
            if (player.hasVagina())
            {
                addButton(4, "Gluttony of Beelzebub", alvinaMainCampSexMenuGluttonyOfBeelzebub).hint("Warning this one is weird");
            }
            else
            {
                addButtonDisabled(4, "Gluttony of Beelzebub", "Not yet coded.");
            }
            addButton(14, "Back", alvinaMainCampMenu);
        }
        else
    ...
    public function alvinaMainCampSexMenuPrideOfLucifer() : Void
    {
        ...
        if (sceneHunter.married("Alvina"))
        {
            outputText("You suggest Alvina takes charge this time around and she replies to you with a smug grin. ");
        }
        ...
        if (sceneHunter.married("Alvina"))
        {
            outputText("\"<i>I know you love this form a lot, so today");
        }
        else
        {
            outputText("\"<i>You thought I couldn't change my shape to that of a proper succubus? Think again, because");
        }
        outputText(" I’m going to show you all the delightful things this perfect temptress body can do.</i>\"");
        if (player.tallness > 48)
        {
            outputText(" pressing her immaculate form against you, your mind fully enveloped by the rush of elation from her erect teets boring into your chest, her soft cheek pressing against yours as those plush lips whisper a tantalizing promise ");
        }
        else
        {
            outputText(" pressing her immaculate form against you, your head fully enveloped by those plump mounds, intoxicating sweet fragrance mingling with her natural titillating musk and light coat of alluring spice. Her form envelops yours, her chin pressed atop of your cranium, she curls down so her lips rest against the tip of your ear, warm breath cascading over the sensitive skin, ");
        }
        ...
        {
            outputText(" and hell you are one, I can taste it");
        }
...
*/
    public function alvinaMainCampSexMenuBlasphemeOfBaphomet() : Void
    {
        ...
        if (sceneHunter.married("Alvina"))
        {
            outputText(", as you know already");
        }
        ...
        if (player.tongue.type == Tongue.DEMONIC)
        {
            outputText(" That said, your demon tongue is perfectly capable of bringing both of you to orgasm and you ravenously play with her cunt using your unique appendage, easily able to stimulate every sensitive area, your prowess aptly exemplified. From above,  you can hear Alvina gasp in delight.");
        }
        ...
        {
            outputText("She gropes your lovely [breasts] teasing your nipples as she gets into position, using your globes for handles. ");
        }
        ...
        if (sceneHunter.married("Alvina"))
        {
            outputText("This is one of the things I love so much about you.");
        }
        else
        {
    ...
    public function alvinaAfterSex() : Void
    {
        if (flags[kFLAGS.ALVINA_FOLLOWER] >= 20)
        {
            ...
            if (sceneHunter.married("Alvina"))
            {
                outputText(" You know all too well I ought to find better ways to improve our pleasure because in all honesty sex with you is one of my biggest joys in life.");
            }
    ...
    public function alvinaHenchmanOption() : Void
    {
        ...
        {
            if (flags[kFLAGS.PLAYER_COMPANION_2] == "Alvina" || flags[kFLAGS.PLAYER_COMPANION_3] == "Alvina")
            {
                addButtonDisabled(0, "Team (1)", "You already have Alvina accompany you.");
            }
            else
            {
                addButton(0, "Team (1)", alvinaHenchmanOption2, 1).hint("Ask Alvina to join you in adventures outside camp.");
            }
        }
        else if (flags[kFLAGS.PLAYER_COMPANION_1] == "Alvina")
        {
            addButton(5, "Team (1)", alvinaHenchmanOption2, 21).hint("Ask Alvina to stay in camp.");
        }
        else
        {
            addButtonDisabled(5, "Team (1)", "You already have other henchman accompany you as first party member. Ask him/her to stay at camp before you talk with Alvina about accompaning you as first party member.");
        }
        if (player.hasPerk(PerkLib.IntermediateLeadership))
        {
            if (flags[kFLAGS.PLAYER_COMPANION_2] == "")
            {
                if (flags[kFLAGS.PLAYER_COMPANION_1] == "Alvina" || flags[kFLAGS.PLAYER_COMPANION_3] == "Alvina")
                {
                    addButtonDisabled(1, "Team (2)", "You already have Alvina accompany you.");
                }
                else
                {
                    addButton(1, "Team (2)", alvinaHenchmanOption2, 2).hint("Ask Alvina to join you in adventures outside camp.");
                }
            }
            else if (flags[kFLAGS.PLAYER_COMPANION_2] == "Alvina")
            {
                addButton(6, "Team (2)", alvinaHenchmanOption2, 22).hint("Ask Alvina to stay in camp.");
            }
            else
            {
                addButtonDisabled(6, "Team (2)", "You already have other henchman accompany you as second party member. Ask him/her to stay at camp before you talk with Alvina about accompaning you as second party member.");
            }
        }
        else
        {
    ...
    public function alvinaHenchmanOption2(slot : Float = 1) : Void
    {
        clearOutput();
        if (slot < 21)
        {
            ...
            var strAlvina : Float = 375;
            var inteAlvina : Float = 480;
            var libAlvina : Float = 375;
            ...
            if (slot == 2)
            {
                flags[kFLAGS.PLAYER_COMPANION_2] = "Alvina";
            }
            if (slot == 1)
            {
    ...
    public function alvinaCampStudy() : Void
    {
        ...
        if (player.gems < 50 || player.lust < 50)
        {
            ...
            if (player.gems < 50)
            {
                outputText("\"<i>It’s 50 gems for each session, the training materials don’t come cheap you know and I won’t pay for their expenses.</i>\"\n\n");
            }
            else
            {
                outputText("\"<i>I can’t teach you the dark arts if you are not suitably aroused! Black magic is the art of giving shape to your desires, and without any desires of your own, there is no way you will be able to learn anything. Come back later when you have the correct mindset.</i>\"\n\n");
            }
            outputText("She dismisses you, adjusts her glasses, and resumes reading one of her many hentai comics.\n\n");
            if (rand(2) == 0)
            {
                outputText("\"<i>Hmm...I wonder if you could really fit a pineapple in your ass...</i>\" She ponders this weird question as you back away.\n\n");
            }
            else if (rand(2) == 0)
            {
                outputText("\"<i>Do you think, if I tried hard enough, I could fit this chair inside me [name]?</i>\" You try not to think about this weird question as you back away.\n\n");
            }
            else if (rand(2) == 0)
            {
                outputText("\"<i>Various recipes for cooking lethicite mmm… perhaps I should try that one with fellblooms.</i>\" You back away before she considers using yours for it.\n\n");
            }
            else if (rand(2) == 0 && Holidays.isAlvinaBirthday())
            {
    ...
    public function alvinaCampAdvancedStudy() : Void
    {
        ...
        else if (player.statusEffectv1(StatusEffects.AlvinaTraining2) == 2 && player.hasItem(useables.AMETIST, 1) && player.hasItem(consumables.L_DRAFT, 5) && player.hasItem(useables.SOULGEM, 5) && (player.hasKeyItem("Marae's Lethicite") >= 0 && player.keyItemvX("Marae's Lethicite", 1) > 0 || player.hasKeyItem("Stone Statue Lethicite") >= 0))
        {
            ...
            if (player.hasKeyItem("Stone Statue Lethicite") >= 0)
            {
        ...
        else if (player.statusEffectv1(StatusEffects.AlvinaTraining2) == 1)
        {
            ...
            {
                outputText("\"<i>You are still way too pure for us to proceed further. Corrupt your body with some demonic transformatives and we will continue.</i>\"\n\n");
            }
            doNext(camp.campFollowers);
            advanceMinutes(5);
        }
    ...
    private function alvinaProposal() : Void
    {
        ...
        if (player.hasPerk(PerkLib.Phylactery))
        {
            outputText(" You say this because I hold control over your phylactery. Your very life in the depths of my paw.");
        }
    ...
    //skip one month
    {
        ...
        if (!recalling)
        {
            if (flags[kFLAGS.DAYS_PER_YEAR] <= 0 || flags[kFLAGS.DAYS_PER_YEAR] == 365)
            {
                model.time.days += 30;
            }
            else
            {
                model.time.days += flags[kFLAGS.DAYS_PER_YEAR] / 12;
            }
        }
        clearOutput();
        ...
        if (vapulaSlave())
        {
            outputText(" Vapula and her horde are attending. Mostly because she is in your service though she did develop a liking for you over time.");
        }
        if (ceraphIsFollower())
        {
            outputText(" Notable in the crowd, Ceraph brought with her some of her slaves as guests.");
        }
        if (campCorruptJojo())
        {
            outputText(" Jojo is there on a bench selecting his pick out of the many slut banquet to fuck and fiercely masturbating in anticipation. You gave him free rein for the duration of your happy day and he's sure to enjoy the use of his dick.");
        }
        if (amilyScene.amilyCorrupt())
        {
            outputText(" Amily is there right at your side as the maid of honor her spaded tail twitching with excitement. She is so happy for you, it’s almost like she is about to burst.");
        }
        if (bimboSophie())
        {
            outputText(" While Sophie is too much of a birdbrain to realize she is surrounded with demons and utterly corrupted creatures, she did have the common sense to at least hold her instinct in check, waiting for the end before jumping the nearest dick in the crowd.");
        }
        if (flags[kFLAGS.SHEILA_DEMON] != null)
        {
            outputText(" Sheila being one of your lovers is attending. She’s clearly jealous of your pick but so long as the two of you can keep having sex she doesn’t seem to mind.");
        }
        if (flags[kFLAGS.ETNA_FOLLOWER] > 0 && !player.hasStatusEffect(StatusEffects.EtnaOff))
        {
            outputText(" Etna looks somewhat like a bored cat right now. She wants the ceremony to be over already so she can get to part two.");
        }
        if (flags[kFLAGS.ELECTRA_FOLLOWER] > 1 && !player.hasStatusEffect(StatusEffects.ElectraOff))
        {
            outputText(" Electra has the telltale sign of a surge although for the moment she manages to contain herself.");
        }
        ...
        if (!recalling)
        {
            startCombat(new SiegweirdBoss());
        }
        else
        {
            doNext(marriagePostFight);
        }
    }
    ...
    public function marriagePostFight() : Void
    {
        ...
        if (player.hasCock())
        {
            outputText("[cock] rise to full mast");
        }
        if (player.isHerm())
        {
            outputText(", not to mention that your ");
        }
        if (player.hasVagina())
        {
            outputText("[pussy] is as wet with anticipation as hers");
        }
        outputText(".\n"
                + "\n"
    ...
    private function marriageSexMale(sleep : Bool = false) : Void
    {
        clearOutput();
    ...
    private function marriageSexFemale(sleep : Bool = false) : Void
    {
        clearOutput();
        outputText(" You gently kiss Alvina as she casts a swift spell, her lovely horsecock sliding out of her juicy pussy like a sheath already lubricated by her own juices. You smile and gently caress her member with your vaginal lips, teasing her until a small dollop of demonic precum covers the flare. Alvina coos as you smear it all over your [pussy] moaning in delight as the corrupted fluid soaks into your tainted flesh. Done with the foreplay you slowly slide the delicious horse meat between your lips savoring it as it touches and fills every inch of your walls. Sex for a female demon is far more different than it is for a human, for instance, you can not only feel but also taste Alvina's dick with your vagina just like a mouth, licking your lips in delight as your hungry cunt sucks on her penis.\n"
                ...
                + "\n"
                + "This is enough to get you going; joyfully ride Alvina reverse cowgirl style"
                + ((player.tailType == Tail.DEMONIC) ? ", your spaded tail swinging from one side to another and drawing circles in the air" : "")
                + " as you moan like the succubus you are and what’s so wrong about it really? You’re enjoying yourself, Alvina is enjoying herself and whoever has a say against this deserves to burn. \n"
                + "\n"
    ...
    public function postMarriageSleep() : Void
    {
        ...
        var sleepySex : Void->Void = function() : Void
        {
            clearOutput();
    ...
    public function alvinaPureMainCampMenu() : Void
    {
        ...
        addButton(2, "Infernal Oil", alvinaPureInfernalOil).disableIf(!player.hasItem(consumables.INFWINE) && !AlvinaInfernalOilAsked, "You need this item to ask her about it DUH...").disableIf(AlvinaInfernalOilCooldown > 0, "Alvina is stll busy making the potion")  //.disableIf(!player.hasPerk(PerkLib.Phylactery) || !player.hasPerk(PerkLib.Soulless), "Requires you to be soulless")  ;
    ...
    public function alvinaPureInfernalOil() : Void
    {
        ...
        AlvinaInfernalOilAsked = false;
        advanceMinutes(15);
        inventory.takeItem(consumables.SAGEMED, playerMenu);
    }
    ...
    //Male or Herm
    {
        ...
        else if (player.cocks[x].cockLength < 10)
        {
            remarkSmallCock();
        }
        else
        ...
        var remarkTooBigCock : Void->Void = function() : Void
        {
        ...
        var remarkAverageCock : Void->Void = function() : Void
        {
        ...
        var remarkSmallCock : Void->Void = function() : Void
        {
    ...
    //Female or Herm
    {
        ...
        if (player.biggestTitSize() > 2)
        {
            outputText(" with just the right amount of quake to make you moan");
        }
