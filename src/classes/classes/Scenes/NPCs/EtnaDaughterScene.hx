...
class EtnaDaughterScene extends NPCAwareContent implements TimeAwareInterface implements SaveableState
{
    
    public static var EtnaDaughterName : String;
    public static var EtnaDaughterIncestEnabled : Bool;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            EtnaDaughterName = Reflect.field(o, "EtnaDaughterName");
            EtnaDaughterIncestEnabled = Reflect.field(o, "EtnaDaughterIncestEnabled");
            EtnaDaughterAge = Reflect.field(o, "EtnaDaughterAge");
            EtnaDaughterGuardingCamp = Reflect.field(o, "EtnaDaughterGuardingCamp");
        }
        else
        {
            resetState();
    ...
    public function etnaDaughterFollower() : Bool
    {
    ...
    public function etnaDaughterMainMenu() : Void
    {
        ...
        //[Sex]; bipeds only, lust must be high, incest must be flagged active, and player must have a dick.{
            ...
            {
                addButton(3, "Play: Carry", playWithEtnaDaughter).disableIf(player.lust < 33, "Not aroused enough.").disableIf(!player.isBiped(), "You have to be biped, sorry.").disableIf(!player.hasCock(), "Req. a cock.");
            }
            else
            {
