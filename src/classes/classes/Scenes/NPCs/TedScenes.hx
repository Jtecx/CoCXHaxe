...
class TedScenes extends NPCAwareContent
{
    ...
    public function canEncounterTed() : Bool
    {
    ...
    public function tedWrath(changes : Float = 0) : Float
    {
        flags[kFLAGS.TED_WRATH] += changes;
        if (flags[kFLAGS.TED_WRATH] > 100)
        {
            flags[kFLAGS.TED_WRATH] = 100;
        }
    ...
    public function lostToTedPostHiddenCave() : Void
    {
        ...
        if (player.statusEffectv1(StatusEffects.Bammed1) < 3 && player.statusEffectv2(StatusEffects.Bammed1) < 3 && player.statusEffectv1(StatusEffects.Bammed2) < 3 && player.statusEffectv2(StatusEffects.Bammed2) < 3)
        {
            bammingPC();
        }
        cleanupAfterCombat();
    ...
    private function levelingHimself() : Void
    {
        ...
        if (flags[kFLAGS.TED_DEFEATS_COUNTER] == 3 && flags[kFLAGS.TED_LVL_UP] == 1)
        {
            ...
            {
                player.addStatusValue(StatusEffects.CampSparingNpcsTimers4, 1, 18);
            }
            else
            {
                player.createStatusEffect(StatusEffects.CampSparingNpcsTimers4, 18, 0, 0, 0);
            }
    ...
    //spells ??? i soulskills i tease ??? bammed
    {
        ...
        if (rand(2) == 0 && (!player.hasStatusEffect(StatusEffects.Bammed2) || player.statusEffectv2(StatusEffects.Bammed2) < 3))
        
        //magic specials{
            
            if (!player.hasStatusEffect(StatusEffects.Bammed2))
            {
                player.createStatusEffect(StatusEffects.Bammed2, 0, 0, 0, 0);
            }
            if (player.statusEffectv2(StatusEffects.Bammed2) == 1)
            {
                if (player.statusEffectv2(StatusEffects.Bammed2) == 2)
                {
        ...
        if (rand(2) == 0 && (!player.hasStatusEffect(StatusEffects.Bammed2) || player.statusEffectv1(StatusEffects.Bammed2) < 3))
        ...
        //physical specials{
            ...
            {
                if (player.statusEffectv1(StatusEffects.Bammed2) == 2)
                {
        ...
        if (rand(2) == 0 && (!player.hasStatusEffect(StatusEffects.Bammed1) || player.statusEffectv2(StatusEffects.Bammed1) < 3))
        
        //range attacks{
            
            if (!player.hasStatusEffect(StatusEffects.Bammed1))
            {
                player.createStatusEffect(StatusEffects.Bammed1, 0, 0, 0, 0);
            }
            if (player.statusEffectv2(StatusEffects.Bammed1) == 1)
            {
                if (player.statusEffectv2(StatusEffects.Bammed1) == 2)
                {
        ...
        if (rand(2) == 0 && (!player.hasStatusEffect(StatusEffects.Bammed1) || player.statusEffectv1(StatusEffects.Bammed1) < 3))
        ...
        //melee attacks{
            ...
            {
                if (player.statusEffectv1(StatusEffects.Bammed1) == 2)
                {
