...
class Forgefather extends NPCAwareContent implements SaveableState
{
    public static var statueProgress(get, never) : Int;
    ...
    public static var talkedToFF : Bool;
    public static var purePearlEaten : Bool;
    public static var lethiciteEaten : Bool;
    public static var materialsExplained : Bool;
    public static var refinementExplained : Bool;
    public static var inlaysExplained : Bool;
    public static var gemstonesExplained : Bool;
    public static var avatarsExplained : Bool;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            hairLength = Reflect.field(o, "hairLength");
            gender = Reflect.field(o, "gender");
            wings = Reflect.field(o, "wings");
            arms = Reflect.field(o, "arms");
            tail = Reflect.field(o, "tail");
            lowerBody = Reflect.field(o, "lowerBody");
            chest = Reflect.field(o, "chest");
            vagina = Reflect.field(o, "vagina");
            cock = Reflect.field(o, "cock");
            balls = Reflect.field(o, "balls");
            granite = Reflect.field(o, "granite");
            ebony = Reflect.field(o, "ebony");
            marble = Reflect.field(o, "marble");
            sandstone = Reflect.field(o, "sandstone");
            alabaster = Reflect.field(o, "alabaster");
            material = Reflect.field(o, "material");
            refinement = Reflect.field(o, "refinement");
            channelInlay = Reflect.field(o, "channelInlay");
            gem = Reflect.field(o, "gem");
            rarityAbsorbed = Reflect.field(o, "rarityAbsorbed");
            talkedToFF = Reflect.field(o, "talkedToFF");
            purePearlEaten = Reflect.field(o, "purePearlEaten");
            lethiciteEaten = Reflect.field(o, "lethiciteEaten");
            materialsExplained = Reflect.field(o, "materialsExplained");
            refinementExplained = Reflect.field(o, "refinementExplained");
            inlaysExplained = Reflect.field(o, "inlaysExplained");
            gemstonesExplained = Reflect.field(o, "gemstonesExplained");
            avatarsExplained = Reflect.field(o, "avatarsExplained");
        }
    ...
    private static function get_statueProgress() : Int
    {
        var p : Int = 0;
        ...
        if (Forgefather.wings > 0)
        {
            ++p;
        }
        if (Forgefather.tail > 0)
        {
            ++p;
        }
        if (Forgefather.lowerBody > 0)
        {
            ++p;
        }
        if (Forgefather.arms > 0)
        {
            ++p;
        }
        if (Forgefather.hairLength > 0)
        {
            ++p;
        }
        ...
        if (Forgefather.cock > 0)
        {
            ++p;
        }
        if (Forgefather.balls > 0)
        {
            ++p;
        }
        return p;
    ...
    public function workshopMainMenu() : Void
    {
        ...
        if (materialsExplained && refinement < 5)
        {
            addButton(6, "Change Mat's", changeMaterials).hint("Change" +
                    " your body's material.");
        }
        else if (refinement >= 5)
        {
            addButtonDisabled(6, "Change Mat's", "You've crossed the rubicon, there is no" +
                    " turning back.");
        }
        else
        {
            addButtonDisabled(6, "Change Mat's", "Maybe you should learn what the materials do first?");
        }
        ...
        {
            addButtonDisabled(7, "Refine Body", "Maybe you should learn about refining your form first?");
        }
        if (gemstonesExplained)
        {
            addButton(8, "Change Inlays", inlayBody).hint("Set/Change your Inlays.");
        }
        else
        {
            addButtonDisabled(8, "Change Inlays", "Maybe you should learn about inlays first?");
        }
        if (gemstonesExplained)
        {
            addButton(9, "Change Gems", blingBody).hint("Set/Change your Gems.");
        }
        else
        {
            addButtonDisabled(9, "Change Gems", "Maybe you should learn about Gemstones first?");
        }
        if (refinement == 4 && channelInlay != "" && gem != "")
        {
            addButton(10, "What's Next", learnAboutAvatars).hint("You've come this far, what more can you do?");
        }
        else if (refinement == 4 && avatarsExplained && !celessScene.isAdult)
        {
            addButtonDisabled(10, "Become" +
                    " Avatar", "You need to find a being of divine purity or corruption.");
        }
        else if (refinement == 4 && avatarsExplained && celessScene.isAdult)
        {
            addButton(10, "Become the Avatar", gargoyleFinalForm).hint("Take the final step.");
        }
    ...
    public function changeMaterials() : Void
    {
        ...
        if (granite >= 100)
        {
            addButton(0, "Granite", changeMatFunc, "granite").hint("Change your body to Granite");
        }
        else
        {
            addButtonDisabled(0, "Granite", "Not enough Granite");
        }
        if (ebony >= 100)
        {
            addButton(1, "Ebony", changeMatFunc, "ebony").hint("Change your body to Ebony");
        }
        else
        {
            addButtonDisabled(1, "Ebony", "Not enough Ebony");
        }
        if (alabaster >= 100)
        {
            addButton(2, "Alabaster", changeMatFunc, "alabaster").hint("Change your body to Alabaster");
        }
        else
        {
            addButtonDisabled(2, "Alabaster", "Not enough Alabaster");
        }
        if (marble >= 100)
        {
            addButton(3, "Marble", changeMatFunc, "marble").hint("Change your body to Marble");
        }
        else
        {
            addButtonDisabled(3, "Marble", "Not enough Marble");
        }
        if (sandstone >= 100)
        {
            addButton(4, "Sandstone", changeMatFunc, "sandstone").hint("Change your body to Sandstone");
        }
        else
        {
            addButtonDisabled(4, "Sandstone", "Not enough Sandstone");
        }
        addButton(14, "Back", workshopMainMenu);
    }
    ...
    public function refineBody() : Void
    {
        clearOutput();
        menu();
        var hasChannelMats : Bool = (player.hasItem(consumables.GODMEAD, 1) && player.hasItem(consumables.S_WATER, 2) && player.hasItem(consumables.SHEEPMK, 2) && player.hasItem(consumables.ECTOPLS, 1));
        var hasPolishingMats : Bool = (player.hasItem(consumables.ROUGHLN, 3) && player.hasItem(consumables.COAL___, 2) && player.hasItem(consumables.IRONWEED, 1) && player.hasItem(consumables.LIGHTOL, 1));
        ...
        switch (material)
        {
            case ("granite"):
                if (refinement < 2)
                {
                    if (granite >= (100 * (refinement + 2)))
                    {
                        addButton(0, "Refine", refineFunc);
                    }
                    else
                    {
                        addButtonDisabled(0, "Refine", "Not enough materials");
                    }
                }
                else if (refinement == 2)
                {
                    if (hasChannelMats)
                    {
                        addButton(0, "Carve Channel", refineFunc);
                    }
                    else
                    {
                        addButtonDisabled(0, "Carve Channel", "Not enough materials");
                    }
                }
                else if (refinement == 3)
                {
                    if (hasPolishingMats)
                    {
                        addButton(0, "Polish Form", refineFunc);
                    }
                    else
                    {
                        addButtonDisabled(0, "Polish Form", "Not enough materials");
                    }
                }
            case ("ebony"):
                if (refinement < 2)
                {
                    if (ebony >= (100 * (refinement + 2)))
                    {
                        addButton(0, "Refine", refineFunc);
                    }
                    else
            ...
            default:
                if (refinement < 2)
                {
                    if (CampStatsAndResources.StonesResc >= (100 * (refinement + 2)))
                    {
                        addButton(0, "Refine", refineFunc);
                    }
                    else
                ...
                {
                    addButtonDisabled(0, "Refine", "Stone cannot be refined further");
                }
        }
        addButton(14, "Back", workshopMainMenu);
    }
    ...
    public function refineFunc() : Void
    {
        if (refinement < 2)
        {
            ...
            {
                case "granite":
                    granite -= as3hx.Compat.parseInt((refinement + 2) * 100);
                case "ebony":
                    ebony -= as3hx.Compat.parseInt((refinement + 2) * 100);
                case "alabaster":
                    alabaster -= as3hx.Compat.parseInt((refinement + 2) * 100);
                case "marble":
                    marble -= as3hx.Compat.parseInt((refinement + 2) * 100);
                case "sandstone":
                    sandstone -= as3hx.Compat.parseInt((refinement + 2) * 100);
                case "stone":
    ...
    public function inlayFunc(inlayNew : String, replace : Bool) : Void
    {
        switch (inlayNew)
        {
            case "amethyst":
                if (!replace)
                {
                    player.destroyItems(useables.AMEGEM, 15);
                }
                else
                {
                    player.destroyItems(useables.AMEGEM, 20);
                }
            case "emerald":
                if (!replace)
                {
                    player.destroyItems(useables.EMDGEM, 15);
                }
                else
                {
                    player.destroyItems(useables.EMDGEM, 20);
                }
            case "ruby":
                if (!replace)
                {
                    player.destroyItems(useables.RBYGEM, 15);
                }
                else
                {
                    player.destroyItems(useables.RBYGEM, 20);
                }
            case "sapphire":
                if (!replace)
                {
                    player.destroyItems(useables.SAPPGEM, 15);
                }
                else
                {
                    player.destroyItems(useables.SAPPGEM, 20);
                }
            case "topaz":
                if (!replace)
                {
                    player.destroyItems(useables.TPAZGEM, 15);
                }
                else
                {
                    player.destroyItems(useables.TPAZGEM, 20);
                }
        }
    ...
    public function blingFunc(gemNew : String, replace : Bool) : Void
    {
        switch (gemNew)
        {
            case "amethyst":
                if (!replace)
                {
                    player.destroyItems(useables.AMEGEM, 10);
                }
                else
                {
                    player.destroyItems(useables.AMEGEM, 15);
            ...
            case "emerald":
                if (!replace)
                {
                    player.destroyItems(useables.EMDGEM, 10);
                }
                else
                {
                    player.destroyItems(useables.EMDGEM, 15);
            ...
            case "ruby":
                if (!replace)
                {
                    player.destroyItems(useables.RBYGEM, 10);
                }
                else
                {
                    player.destroyItems(useables.RBYGEM, 15);
            ...
            case "sapphire":
                if (!replace)
                {
                    player.destroyItems(useables.SAPPGEM, 10);
                }
                else
                {
                    player.destroyItems(useables.SAPPGEM, 15);
            ...
            case "topaz":
                if (!replace)
                {
                    player.destroyItems(useables.TPAZGEM, 10);
                }
                else
                {
                    player.destroyItems(useables.TPAZGEM, 15);
    ...
    public function inlayBody() : Void
    {
        ...
        {
            if (player.hasItem(useables.AMEGEM, 20) && (player.gems >= 2000))
            {
                addButton(0, "Amethyst", inlayFunc, "amethyst", true).hint("Change inlay to Amethyst");
            }
            else
            {
                addButtonDisabled(0, "Amythyst", "You need 20 Amethyst and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.AMEGEM, 15))
        {
            addButton(0, "Amethyst", inlayFunc, "amethyst", false).hint("Set inlay to Amethyst");
        }
        else
        {
            addButtonDisabled(0, "Amythyst", "You need 15 Amethyst to do this.");
        }
        ...
        {
            if (player.hasItem(useables.EMDGEM, 20) && (player.gems >= 2000))
            {
                addButton(1, "Emerald", inlayFunc, "emerald", true).hint("Change inlay to Emerald");
            }
            else
            {
                addButtonDisabled(1, "Emerald", "You need 20 Emerald and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.EMDGEM, 15))
        {
            addButton(1, "Emerald", inlayFunc, "emerald", false).hint("Set inlay to Emerald");
        }
        else
        {
            addButtonDisabled(1, "Emerald", "You need 15 Emerald to do this.");
        }
        ...
        {
            if (player.hasItem(useables.RBYGEM, 20) && (player.gems >= 2000))
            {
                addButton(2, "Ruby", inlayFunc, "ruby", true).hint("Change inlay to Ruby");
            }
            else
            {
                addButtonDisabled(2, "Ruby", "You need 20 Ruby and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.RBYGEM, 15))
        {
            addButton(2, "Ruby", inlayFunc, "ruby", false).hint("Set inlay to Ruby");
        }
        else
        {
            addButtonDisabled(2, "Ruby", "You need 15 Ruby to do this.");
        }
        ...
        {
            if (player.hasItem(useables.SAPPGEM, 20) && (player.gems >= 2000))
            {
                addButton(3, "Sapphire", inlayFunc, "sapphire", true).hint("Change inlay to Sapphire");
            }
            else
            {
                addButtonDisabled(3, "Sapphire", "You need 20 Sapphire and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.SAPPGEM, 15))
        {
            addButton(3, "Sapphire", inlayFunc, "sapphire", false).hint("Set inlay to Sapphire");
        }
        else
        {
            addButtonDisabled(3, "Sapphire", "You need 15 Sapphire to do this.");
        }
        ...
        {
            if (player.hasItem(useables.TPAZGEM, 20) && (player.gems >= 2000))
            {
                addButton(4, "Topaz", inlayFunc, "topaz", true).hint("Change inlay to Topaz");
            }
            else
            {
                addButtonDisabled(4, "Topaz", "You need 20 Topaz and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.TPAZGEM, 15))
        {
            addButton(4, "Topaz", inlayFunc, "topaz", false).hint("Set inlay to Topaz");
        }
        else
        {
            addButtonDisabled(4, "Topaz", "You need 15 Topaz to do this.");
        }
        addButton(14, "Back", workshopMainMenu);
    }
    ...
    public function blingBody() : Void
    {
        ...
        {
            if (player.hasItem(useables.AMEGEM, 15) && (player.gems >= 2000))
            {
                addButton(0, "Amethyst", blingFunc, "amethyst", true).hint("Change gems to Amethyst");
            }
            else
            {
                addButtonDisabled(0, "Amythyst", "You need 15 Amethyst and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.AMEGEM, 10))
        {
            addButton(0, "Amethyst", blingFunc, "amethyst", false).hint("Set gems to Amethyst");
        }
        else
        {
            addButtonDisabled(0, "Amythyst", "You need 10 Amethyst to do this.");
        }
        ...
        {
            if (player.hasItem(useables.EMDGEM, 15) && (player.gems >= 2000))
            {
                addButton(1, "Emerald", blingFunc, "emerald", true).hint("Change gems to Emerald");
            }
            else
            {
                addButtonDisabled(1, "Emerald", "You need 15 Emerald and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.EMDGEM, 10))
        {
            addButton(1, "Emerald", blingFunc, "emerald", false).hint("Set gems to Emerald");
        }
        else
        {
            addButtonDisabled(1, "Emerald", "You need 10 Emerald to do this.");
        }
        ...
        {
            if (player.hasItem(useables.RBYGEM, 15) && (player.gems >= 2000))
            {
                addButton(2, "Ruby", blingFunc, "ruby", true).hint("Change gems to Ruby");
            }
            else
            {
                addButtonDisabled(2, "Ruby", "You need 15 Ruby and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.RBYGEM, 10))
        {
            addButton(2, "Ruby", blingFunc, "ruby", false).hint("Set gems to Ruby");
        }
        else
        {
            addButtonDisabled(2, "Ruby", "You need 10 Ruby to do this.");
        }
        ...
        {
            if (player.hasItem(useables.SAPPGEM, 15) && (player.gems >= 2000))
            {
                addButton(3, "Sapphire", blingFunc, "sapphire", true).hint("Change gems to Sapphire");
            }
            else
            {
                addButtonDisabled(3, "Sapphire", "You need 15 Sapphire and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.SAPPGEM, 10))
        {
            addButton(3, "Sapphire", blingFunc, "sapphire", false).hint("Set gems to Sapphire");
        }
        else
        {
            addButtonDisabled(3, "Sapphire", "You need 10 Sapphire to do this.");
        }
        ...
        {
            if (player.hasItem(useables.TPAZGEM, 15) && (player.gems >= 2000))
            {
                addButton(4, "Topaz", blingFunc, "topaz", true).hint("Change gems to Topaz");
            }
            else
            {
                addButtonDisabled(4, "Topaz", "You need 15 Topaz and 2000 gems to do this.");
            }
        }
        else if (player.hasItem(useables.TPAZGEM, 10))
        {
            addButton(4, "Topaz", blingFunc, "topaz", false).hint("Set gems to Topaz");
        }
        else
        {
            addButtonDisabled(4, "Topaz", "You need 10 Topaz to do this.");
        }
        addButton(14, "Back", workshopMainMenu);
    }
