...
class LatexGirl extends NPCAwareContent
{
...
*/
    public function gooFluid(arg : Float = 0, output : Bool = true) : Float
    {
        if (arg != 0)
        {
            ...
            if (flags[kFLAGS.GOO_FLUID_AMOUNT] < 1)
            {
                flags[kFLAGS.GOO_FLUID_AMOUNT] = 1;
            }
            if (flags[kFLAGS.GOO_FLUID_AMOUNT] > 100)
            {
    ...
    public function gooHappiness(arg : Float = 0, output : Bool = true) : Float
    {
        if (arg != 0)
        {
            ...
            if (flags[kFLAGS.GOO_HAPPINESS] < 1)
            {
                flags[kFLAGS.GOO_HAPPINESS] = 1;
            }
            if (flags[kFLAGS.GOO_HAPPINESS] > 100)
            {
    ...
    public function gooObedience(arg : Float = 0, output : Bool = true) : Float
    {
        if (arg != 0)
        {
            ...
            if (flags[kFLAGS.GOO_OBEDIENCE] < 1)
            {
                flags[kFLAGS.GOO_OBEDIENCE] = 1;
            }
            if (flags[kFLAGS.GOO_OBEDIENCE] > 100)
            {
    ...
    override public function latexGooFollower() : Bool
    {
        return flags[kFLAGS.GOO_SLAVE_RECRUITED] > 0;
    }
    
    private function gooTitSize() : Float
    //If tits are lowered
    {
    ...
    public function meanGooGirlRecruitment() : Void
    {
        ...
        if (player.spe > 60)
        {
            outputText("idly spin it on your finger, tossing it into the air and catching it on the next as you advance");
        }
        else
        {
            outputText("firmly grasp it in your hand as you approach");
        }
    ...
    private function PCCarriedGooBackHome() : Void
    {
        ...
        {
            outputText(", away from prying eyes");
        }
        ...
        {
            outputText("  You can't help but wonder what it would feel like to let her sheath your [cocks] with her juices.");
        }
        ...
        if (player.cor < 33)
        {
            outputText("that you'll be a nice [master].  She'll never be in want for the fluids she needs, and so long as she obeys you, you'll see to her other needs.");
        }
        else if (player.cor < 66)
        {
            outputText("that you'll be a good [master] for her.  You'll keep her healthy and satisfied, so long as she's obedient.");
        }
        else
        {
            outputText("that so long as she obeys you, she has nothing to fear.  She had better obey.");
        }
    ...
    //returns 1 if error
    private function nameReactions(nice : Bool = false) : Bool
    {
        ...
        clearOutput();
        outputText("\"<i>");
        if (flags[kFLAGS.GOO_NAME] == "Cattleya")
        {
            outputText("Cattleya, huh?  I don't know if my tits are big enough to live up to that name,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Helia")
        {
            outputText("Helia, huh?  I don't know if I like anal enough for that!");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Urta")
        {
            outputText("Urta, huh?  What do you take me for, a furry?  I guess it will have to do,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Tifa")
        {
            outputText("Tifa, huh?  I like the sound of that one!");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Aeris")
        {
            outputText("Aeris, huh?  That sounds like a name for a hoity-toity pain in the ass!");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Latexy")
        {
            outputText("Latexy, huh? That's, uh... real original...");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Goo")
        {
            outputText("Goo, huh?  Wow, not too bright, are you?  Still, I guess I can live with it.  Call me Goo, I guess,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Blacky")
        {
            outputText("Blacky, huh?  Do I look like a horse or something?  I guess it will have to do,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Fetish")
        {
            outputText("Fetish, huh?  You're pretty transparent about your motives, aren't you?");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Fenoxo")
        {
            outputText("Fenoxo?</i>\"  Her hair slowly morphs into a fedora.  \"<i>I'm not sure this is quite my look, but it's a lovely name,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Maria")
        {
            outputText("Maria?  Fuck, this isn't Cursed!  You don't expect me to turn you into a woman, do you?");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Valeria")
        {
            outputText("Valeria? Wait, I've heard that name before...");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Christmas")
        {
            outputText("Christmas, huh?  How very festive.  The big difference is that I can come more than once a year.");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Symphonie")
        {
            outputText("Symphonie, eh?  That seems very... fitting.  Snug and comfortable, somehow,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Savin")
        {
            outputText("Savin, huh? Why would you want to name me after the second worst person since Stalin?");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Galatea")
        {
            outputText("Galatea?  By Oblimo, that's a beautiful name!");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Kara")
        {
            outputText("Kara, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Karazelle")
        {
            outputText("Karazelle, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Jacques")
        {
            outputText("Jacques?  That's kind of a boy's name isn't it?  ...Did my boobs just get bigger?");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Whitney")
        {
            outputText("Whitney?  The farm-girl?  Well, I suppose I can fill in for that frigid cunt.");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Hedrah")
        {
            outputText("Hedrah?  A nice strong name.  I approve,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Third")
        {
            outputText("Third, huh?  Do I speak with a silly accent and miss headshots all day long?  Well, I suppose it will work,");
        }
        else if (flags[kFLAGS.GOO_NAME] == "Luckster")
        {
            outputText("Luckster, huh?  Strange, I don't feel that Lucky.  Are there any cow-girls about?");
        }
        else
        {
            outputText(flags[kFLAGS.GOO_NAME] + ", huh?  I can live with that, I suppose,");
        }
    ...
    private function nameZeLatexGoo() : Void
    {
        ...
        if (player.cor < 50)
        {
            outputText("Patiently");
        }
        else
        {
            outputText("Impatiently");
        }
        ...
        if (player.gender == 0)
        {
            outputText(", so please grow some genitals");
        }
    ...
    public function encounterLeftBehindGooSlave() : Void
    {
        ...
        else
        {
            ...
            if (player.cor < 33)
            {
                outputText("Sighing apologetically");
            }
            else if (player.cor < 66)
            {
                outputText("Frowning");
    ...
    private function niceGuysKeepTheirGooGals() : Void
    {
        ...
        if (player.gender == 0)
        {
            outputText(", so you had better grow some genitals");
        }
    ...
    public function approachLatexy() : Void
    {
        ...
        if (gooHappiness() < 10)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " scowls up at your approach, her unhappiness clearly visible in her " + flags[kFLAGS.GOO_EYES] + " eyes.  You doubt her solid onyx face could be any more morose.");
        }
        //(Sub 20)
        else if (gooHappiness() < 20)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " glares at you as you approach, clearly unhappy with the situation.  She looks like she's having a pretty terrible time.");
        }
        //(Sub 30)
        else if (gooHappiness() < 30)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " frowns at you as you approach, more than a little displeased to see you.  She doesn't seem to be having a very good time.");
        }
        //(Sub 40)
        else if (gooHappiness() < 40)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " knits her eyebrows in consternation at your approach, visibly less than happy.  It doesn't look like she's thrilled to be here.");
        }
        //(Sub 50)
        else if (gooHappiness() < 50)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " glances up at you when you approach, visibly bored.  She looks like she needs some cheering up.");
        }
        //(Sub 60)
        else if (gooHappiness() < 60)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " gives you a wan smile as you approach, looking a tad bored.  Still, the glitter in her eyes tells you that she's still a good ways from unhappy.");
        }
        //(Sub 70)
        else if (gooHappiness() < 70)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " cracks a small grin at the sight of you, happy to see you.  It's good to see her having a positive outlook.");
        }
        //(Sub 80)
        else if (gooHappiness() < 80)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " openly smiles at you as you approach, in good spirits, it seems.  Her sensual, fetishy skin reflects the light as she smiles, looking truly beautiful.");
        }
        //(Sub 90)
        else if (gooHappiness() < 90)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " grins at you, revealing rows of glittering black teeth.  She playfully regards you with happy, " + flags[kFLAGS.GOO_EYES] + " eyes.");
        }
        //(Sub 100)
        else if (gooHappiness() < 100)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " bounces up at your approach, mouth splitting into a wide smile.  Her glittering, " + flags[kFLAGS.GOO_EYES] + " eyes twinkle with genuine pleasure.");
        }
        //(MAX)
        else
        {
            outputText(flags[kFLAGS.GOO_NAME] + " jumps up on her feet at your approach, gleefully clapping her hands as you close in on her.  Her " + flags[kFLAGS.GOO_EYES] + " eyes and ecstatic visage make it clear how unbelievably happy she is.");
        }
        ...
        if (gooTitSize() >= 35)
        {
            outputText("Utterly filled with moisture, her " + gooTits() + " are so big her arms can barely encompass them, her hands pressing fruitlessly against the sloshing sides.  The bubbly black surface bulges obscenely, barely containing the liquid weight within.");
        }
        //{Very Big-Sized Titties}
        else if (gooTitSize() >= 24)
        {
            outputText("Wobbling like crazy, her incredible chest barely stays bound up in her hands.  It completely obscures her torso from view.  Eventually, she gives up on restraining them and lets them slosh free.  You can't help but admire the flawless curves as you ponder how she can possibly remain upright.");
        }
        //{Pretty nice sized}
        else if (gooTitSize() >= 15)
        {
            outputText("Big enough to hide most of her torso, the " + gooTits() + " sway and bounce ponderously.  Light reflects off the shiny, hypnotizing surface of her chest as she supports it with her hands.");
        }
        //{Big SizedVolley}
        else if (gooTitSize() > 4)
        {
            outputText("Well-rounded and jiggly, her " + gooTits() + " ripples slightly as she moves.  Those well-rounded spheres seem soft and firm at the same time.");
        }
        //{LargeDD}
        else if (gooTitSize() > 3)
        {
            outputText("Sitting high on her chest, a proud pair of " + gooTits() + " jiggle slightly with her every movement.  They're still nice and round, but nowhere near the mammoths she had before.");
        }
        //{MediumC}
        else if (gooTitSize() > 2)
        {
            outputText("High and curvy, her " + gooTits() + " looks pert and perky, topped with dark chocolate nipples.  The reflective surface makes them appear larger than they truly are, a feast of midnight darkness for your eyes.");
        }
        //{LightA}
        else
        {
            outputText("Sitting high on her chest, her " + gooTits() + " seems almost disproportionately tiny for her frame.  The perky onyx nipples protrude invitingly, tiny caps of inviting midnight.");
        }
        //{Regardless}
        ...
        {
            outputText("  Those proud nipples have odd bulges at the tips, bulges that can swell tremendously, turning into rigid dicknipples.");
        }
        //Cuntnips:
        else if (flags[kFLAGS.GOO_NIPPLE_TYPE] == -1)
        {
            outputText("  Those proud nipples have a visible slit down the middle, just waiting to be spread into hungry pussies.");
        }
        //Third Line - Fluid content
        //{Above 75}
        if (gooFluid() >= 75)
        {
            outputText("  Her onyx lips are plush and inviting, full of liquid.  Likewise, her body seems flush and full of life, certainly not suffering for fluid nutrients.");
        }
        //{Above 50}
        else if (gooFluid() >= 50)
        {
            outputText("  Her onyx lips are full and pouty.  Likewise, her body is smooth and curvy, filled with plenty of fluid nutrients.");
        }
        //{Above 25}
        else if (gooFluid() >= 25)
        {
            outputText("  Her onyx lips look a little on the small side.  Likewise, her body is slim and narrow, not very filled out or curvy.  She could probably use more liquid nutrients.");
        }
        //{Low}
        else
        {
            ...
            if (gooFluid() <= 5)
            {
                outputText("  She looks very unhealthy - she might be able to survive like this, but you can tell it will weigh heavily on her.");
            }
        }
        ...
        {
            outputText("Below her waist, a " + num2Text(Math.round(flags[kFLAGS.GOO_DICK_LENGTH] * 10) / 10) + "-inch, " + gooCock() + " hangs, soft and shiny.  ");
        }
        ...
        if (gooObedience() < 10)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " gives you a look of pure defiance, ready to disobey at the slightest notice.");
        }
        //{sub 20}
        else if (gooObedience() < 20)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " idly twirls a raven lock of hair as she awaits your comment, a rebellious look glinting in her " + flags[kFLAGS.GOO_EYES] + " eyes.");
        }
        //{sub 30}
        else if (gooObedience() < 30)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " smirks at you with a rebellious cast on her features.");
        }
        //{sub 40}
        else if (gooObedience() < 40)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " bats charcoal eyelashes at you as she watches you with " + flags[kFLAGS.GOO_EYES] + ", fiery eyes, still far from obedient.");
        }
        //{sub 50}
        else if (gooObedience() < 50)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " glances downwards for a moment, averting her eyes until she remembers to look up, defying her own submission.");
        }
        //{sub 60}
        else if (gooObedience() < 60)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " casts her eyes down but peeks up through her charcoal eyelashes to regard you.");
        }
        //{sub 70}
        else if (gooObedience() < 70)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " keeps her " + flags[kFLAGS.GOO_EYES] + " eyes cast down at the ground in deference to you, though she nervously draws in the dirt with a finger while she awaits a command.");
        }
        //{sub 80}
        else if (gooObedience() < 80)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " fixes her gaze down obediently, her cheeks flushing purplish.  Is she enjoying submitting to you?");
        }
        //{sub 90)
        else if (gooObedience() < 90)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " prostrates herself on the ground before you, tilting her head back so that she can fix her eyes on your waist, unfit to meet your gaze.");
        }
        //{sub 100)
        else if (gooObedience() < 100)
        {
            outputText(flags[kFLAGS.GOO_NAME] + " submissively prostrates herself before you, raising her onyx rump high as her forehead lowers.  Her cheeks and rump both manage to blush purple through her latex skin, clearly aroused by her own submissiveness.");
        }
        //{MAX}
        else
        {
            outputText(flags[kFLAGS.GOO_NAME] + " plants herself on all fours before you, kissing at your [feet].  Her smooth butt lightens along with her sides and cheeks, blushing violet with lust from the heat of her own submission.  Lewdly, she greets you, \"<i>[Master].</i>\"");
        }
        ...
        addButton(1, "Use Her", useLatexy).disableIf(player.lust < 33, "Not aroused enough!").disableIf(player.gender == 0, "Not for genderless!");
        ...
        if (flags[kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 0 && flags[kFLAGS.FARM_CORRUPTION_STARTED] == 1)
        {
            addButton(5, "Farm Work", sendToFarm);
        }
        if (flags[kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 1)
        {
    ...
    private function useLatexy() : Void
    {
        ...
        menu();
        addButton(0, "DomWithVag", femalePCDomFucksLatexGoo).disableIf(!player.hasVagina(), "Req. a vagina!");
        addButton(1, "RideGooCock", femalePCDomFucksLatexGooFuta).disableIf(!player.hasVagina(), "Req. a vagina!").disableIf(flags[kFLAGS.GOO_DICK_LENGTH] == 0, "She doesn't have a cock!");
        addButton(2, "DickFuckHer", malePCDomFucksLatexGoo).disableIf(!player.hasCock(), "Req. a cock!");
    ...
    private function changeGooDick() : Void
    {
        ...
        if (gooObedience() >= 60)
        {
            ...
            if (flags[kFLAGS.GOO_DICK_LENGTH] == 0)
            {
                outputText("ask " + flags[kFLAGS.GOO_NAME] + " if she's ever considered growing a dick for fun.");
            }
            else
            {
                outputText("ask her if she'd like to change what kind of dick she has.");
            }
            outputText("  She whimpers and moans, \"<i>[Master], I loved growing penises back before I changed.  More than that, ");
            if (flags[kFLAGS.GOO_DICK_LENGTH] == 0)
            {
                outputText("I want to grow one for you.  ");
            }
            else
            {
                outputText("I want you to order me to shift it often.  ");
            }
        ...
        else if (gooHappiness() >= 70)
        {
            ...
            if (flags[kFLAGS.GOO_DICK_LENGTH] == 0)
            {
                outputText("she's ever considered growing a dick for fun.");
            }
            else
            {
                outputText("she'd like to change what kind of dick she has.");
            }
        ...
        if (flags[kFLAGS.GOO_DICK_LENGTH] > 0)
        {
            ...
            if (flags[kFLAGS.GOO_DICK_LENGTH] < 24 + ((flags[kFLAGS.HYPER_HAPPY] != null) ? 0 : 36))
            {
    ...
    {
        return addButton(num, item.shortName, latexyEatsADickItem, item).disableIf(!player.hasItem(item), "You don't have any!");
    }
    ...
    private function latexyEatsADickItem(item : ItemType) : Void
    {
        ...
        if (flags[kFLAGS.GOO_DICK_LENGTH] == 0)
        {
            ...
            {
                outputText("flattened head");
            }
            else
            {
                outputText("bulbous crown");
            }
        ...
        if (item == consumables.CANINEP)
        {
            flags[kFLAGS.GOO_DICK_TYPE] = CockTypesEnum.DOG;
        }
        if (item == consumables.EQUINUM)
        {
            flags[kFLAGS.GOO_DICK_TYPE] = CockTypesEnum.HORSE;
        }
        if (item == consumables.P_DRAFT)
        {
            flags[kFLAGS.GOO_DICK_TYPE] = CockTypesEnum.HUMAN;
        }
        if (item == consumables.W_FRUIT)
        {
            flags[kFLAGS.GOO_DICK_TYPE] = CockTypesEnum.CAT;
        }
        if (item == consumables.INCUBID)
        {
            flags[kFLAGS.GOO_DICK_TYPE] = CockTypesEnum.DEMON;
        }
        if (item == consumables.MINOBLO)
        {
            flags[kFLAGS.GOO_DICK_TYPE] = CockTypesEnum.HORSE;
    ...
    private function setLatexysBustSize() : Void
    {
        ...
        menu();
        if (gooTitClass(gooTitSize()) != 1)
        {
            addButton(0, "A-Cups", changeLatexyTits, 1);
        }
        if (gooTitClass(gooTitSize()) != 2)
        {
            addButton(1, "C-Cups", changeLatexyTits, 3);
        }
        if (gooTitClass(gooTitSize()) != 3)
        {
            addButton(2, "DD-Cups", changeLatexyTits, 4);
        }
        if (gooTitClass(gooTitSize()) != 4)
        {
            addButton(3, "Volleyballs", changeLatexyTits, 8);
        }
        if (gooTitClass(gooTitSize()) != 5)
        {
            addButton(4, "Basketballs", changeLatexyTits, 15);
        }
        if (gooTitClass(gooTitSize()) != 6)
        {
            addButton(5, "Huge", changeLatexyTits, 24);
        }
        if (gooTitClass(gooTitSize()) != 7)
        {
            addButton(6, "Gigantic", changeLatexyTits, 35);
        }
        if (flags[kFLAGS.GOO_PREFERRED_TIT_SIZE] != 0)
        {
            addButton(7, "Whatever", changeLatexyTits, 0);
        }
        addButton(14, "Back", approachLatexy);
    }
    ...
    private function changeLatexyTits(arg : Int = 0) : Void
    {
        ...
        //Bigger:{
            ...
            if (gooTitClass(gooTitSize()) < 3)
            {
                outputText(flags[kFLAGS.GOO_NAME] + " sighs as she cups her breasts and breaths, \"<i>Grow,</i>\" aloud.  Like the obedient sweater-puppies they are, her breasts expand and fill.  Their curves fill, the cleavage deepens, and " + flags[kFLAGS.GOO_NAME] + " smiles at the result.  Her breasts are now around a DD-cup - just as requested.");
            }
            //Smaller: " +
            else
            {
                outputText(flags[kFLAGS.GOO_NAME] + " groans in disappointment, \"<i>I liked em big!  Well, you're the boss...</i>\"  She clenches her fists and closes her eyes.  Nothing happens at first, but after a moment, her " + gooTits() + " tighten up.  Over the span of a few dozen seconds, " + flags[kFLAGS.GOO_NAME] + " is reduced to having something like a DD-cup - a nice but fairly normal size, as ordered.");
            }
        }
        //To C {medium} sized:
        ...
        //Bigger:{
            ...
            if (gooTitClass(gooTitSize()) < 2)
            {
                outputText(flags[kFLAGS.GOO_NAME] + " says, \"<i>Well, that's a start I suppose.</i>\"  She cups her tiny teats and massages them with gentle gropes.  Each time, they jiggle a little bit more.  Almost as soon as she starts, she stops, leaving them as curvy C-cups.  \"<i>Could we go bigger?</i>\"");
            }
            //Smaller:
            else
            {
                outputText(flags[kFLAGS.GOO_NAME] + " shudders, but obeys.  First, she presses down on her " + gooTits() + ", then, she blinks her eyes closed and shivers.  Before your eyes, the breast-flesh diminishes, eventually settling on a pair of curvy C-cups.  \"<i>I look like I must be dehydrated!  Good thing the other girls can't see me!</i>\"");
            }
        }
        //To A {light} sized:
    ...
    private function feedLatexy() : Void
    {
        ...
        {
            outputText("  You aren't aroused enough to try and feed her any sexual fluids.");
        }
        else
        {
        ...
        addButton(4, "Milk", feedLatexySomeMilk).disableIf(gooHappiness() < 50, "She's not happy enough to consider the option.").disableIf(player.lactationQ() < 100, "You need to lactate!").disableIf(player.biggestTitSize() < 3, "Your booba are too small!");
        addButton(5, "MinoCumNice", minotaurCumFeedingGoo, true).disableIf(!player.hasItem(consumables.MINOCUM), "Req. a vial of minotaur cum!");
        addButton(6, "MinoCumRough", minotaurCumFeedingGoo, false).disableIf(!player.hasItem(consumables.MINOCUM), "Req. a vial of minotaur cum!");
        addButton(14, "Back", approachLatexy);
    }
    ...
    private function feedLatexyCumIndirectly() : Void
    {
        ...
        if (gooObedience() < 70)
        {
            outputText(" and unashamedly reaching for your [armor].  You bat her hands away, forcing her greedy little latex digits to wait along with the rest of her");
        }
        else
        {
            outputText(", obediently waiting with her tongue wagging.");
        }
        if (gooFluid() < 33)
        {
        ...
        {
            outputText("  The hunger in her eyes is a palpable thing, one you fear could prod her into rash action.");
        }
        else if (gooFluid() < 90)
        {
            outputText("  The hunger in her eyes is a lazy thing.  It doesn't seem that strong, but she's always willing to drink more.");
        }
        else
        {
            outputText("  The hunger in her eyes is a decadent, gluttonous thing that's barely roused by the prospect of fresh seed.  It still causes her to smear a lick across her shiny lips.");
        }
        ...
        if (player.cumQ() < 250)
        {
            outputText("oozing a thicker river of pre-cum than normal");
        }
        else if (player.cumQ() < 500)
        {
            outputText("dripping even more pre-cum than usual");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("dribbling pre-cum");
        }
        else
        {
            outputText("oozing out a river of pre-cum");
        }
        ...
        if (player.cockTotal() > 1)
        {
            outputText("s at once");
        }
        outputText(", raining down into the bowl in thick white ropes.");
        if (player.cumQ() >= 500)
        {
            outputText("  In a short time, you have overfilled it, so you settle for spraying the remainder over your rubbery prize.  Long strands of sticky, slick breeding fluid rain over her charcoal mane, painting into a gray mop.");
        }
        if (player.cumQ() >= 1000)
        {
            outputText("  Still, you relentlessly pump yourself through more and more ejaculations, until the ground can bear no more and a puddle forms below.");
        }
        if (player.cumQ() >= 4000)
        {
            outputText("  That puddle swiftly fills into a foot deep lake of spunk, a muddy morass of your own virile semen.");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText(", and she turns to cleaning herself");
        }
        outputText(".");
        if (player.cumQ() >= 1000)
        {
            outputText("  Sadly, the copious jizz that puddled up has already been devoured by the dry ground.  It seems the dirt can drink faster than your latex slave.");
        }
    ...
    private function feedLatexyGirlCumIndirectly() : Void
    {
        ...
        if (gooFluid() < 33)
        {
            outputText("  The hunger in her eyes is so relentless you fear her gaze could drill directly into your [vagina].");
        }
        else if (gooFluid() < 66)
        {
            outputText("  The hunger in her eyes is a palpable thing, one you fear could prod her into rash action.");
        ...
        {
            outputText("  Soon, it stands out proud and erect, a column of glistening femme-flesh that tingles with every stray breeze.");
        }
        ...
        if (player.wetness() < 3)
        {
            outputText("absolutely soaked with your girlish moisture");
        }
        else if (player.wetness() < 4)
        {
            outputText("dripping strings of girlish liquid with abandon");
        }
        else
        {
            outputText("practically gushing girlish moisture into the bowl");
        }
        ...
        if (player.clitLength >= 3.5)
        {
            outputText("  You wrap your hand around it without meaning to, caressing the slick, womanly shaft so fast that it floods your mind with white waves of unthinking pleasure.");
        }
        ...
        if (player.wetness() < 3)
        {
            outputText("Your dribbling cunny paints a thin film of lady-spunk on the bowl, filling it slowly as you drip and squirm.");
        }
        else if (player.wetness() < 4)
        {
            outputText("Your ludicrously wet cunt oozes thick flows of lady-spunk into the bowl, rapidly filling it with the proof of your orgasm.");
        }
        else
        {
            outputText("Your gushing cunny sprays a lurid flow of lady-spunk into the bowl, immediately filling it beyond its rim.  It does a fine job of muddying the ground with the proof of your orgasm as your bliss drags on.");
        }
        outputText("\n\n" + flags[kFLAGS.GOO_NAME] + " dives into the bowl with gusto, greedily devouring every drop.  Her tongue hangs free, thrashing against the polished wood as more and more of her latex mouth-muscle spools free to help with the feeding.  In seconds, the bowl is emptied.");
        if (player.wetness() >= 4)
        {
            outputText("  Sadly, the copious vaginal lube that muddied the ground is already absorbed.  It seems the dirt can eat faster than your pet.");
        }
        //{Boost her fluid quantity, bonus for over 250mL.}
        var fluid : Int = 10;
        if (player.wetness() >= 3)
    ...
    private function minotaurCumFeedingGoo(nice : Bool = false) : Void
    {
        clearOutput();
        player.consumeItem(consumables.MINOCUM);
        outputText("You pull a vial of minotaur cum from the pouches at your waist");
        if (player.minotaurNeed() || player.minotaurAddicted())
        {
            outputText(" and hungrily lick at your lips, always eager to take such a treat yourself");
        }
        outputText(".  The latex woman ");
        if (flags[kFLAGS.TIMES_FED_LATEXY_MINO_CUM] > 0)
        {
            outputText("claps in excitement, her dark-as-night nipples perking up immediately.  She hasn't forgotten her last taste of the heady treat.");
        }
        else
        {
            outputText(" tilts her head in confusion, though when she realizes that it's cum you carry, her dark-as-night nipples perk up.");
        }
        ...
        if (!nice)
        {
            ...
            if (gooObedience() >= 70)
            {
                outputText("  " + flags[kFLAGS.GOO_NAME] + " immediately drops to the ground on all fours, rubbing her head against your [foot] and begging, \"<i>Please [Master], may your latex fuckpet have some of that wonderful cum?</i>\"  It seems she can be obedient after all.");
            }
            //[Semi obedient:]
            else if (gooObedience() >= 40)
            {
        ...
        if (player.minotaurNeed())
        {
            ...
            if (gooHappiness() < 33)
            {
                outputText(" reluctantly returns the kiss, seeming to tolerate it more than anything else.  You barely notice, lust drunk as you are.");
            }
            else if (gooHappiness() < 66)
            {
                outputText(" seems surprised at first but quickly comes to enjoy it, swapping cummy spit with passion.");
            }
            else
            {
                outputText(" eagerly returns the kiss, frenching you with abandon.  Her tongue happily pushes the leftover jizz into your mouth.");
            }
    ...
    private function feedLatexyCumDirectly() : Void
    {
        ...
        {
            outputText("  Her throat is stretched so tightly that it appears more like an inky condom than anything else.  Every vein, every variation in length is perfectly represented - until it disappears into her chest.");
        }
        else
        {
            outputText("  Her body, devoid of gag reflex, swallows you with ease.");
        }
        ...
        if (player.cockTotal() > 1)
        {
            ...
            {
                outputText("dick fruitlessly paints");
            }
            else
            {
                outputText("dicks fruitlessly paint");
            }
            outputText(" her " + gooTits() + " with a sheen of white, wasting their moisture in a decadent display of virility.");
        }
        if (player.cumQ() >= 500)
        {
            outputText("  You cream her internals so full that her belly distends and jiggles with each fresh pump of spunk.");
        }
        if (player.cumQ() >= 1500)
        {
            outputText("  Rounder and rounder she swells, until her middle is almost balloonish, stretched so taut it appears grayish-white thanks to all the white beneath.");
        }
        if (player.cumQ() >= 500)
        {
            outputText("  However, by the time your orgasm is winding down, she's already metabolizing it, converting her spunk-plumped belly into supple, denser curves for the rest of her form.");
        }
        ...
        if (gooObedience() >= 60)
        {
            ...
            if (flags[kFLAGS.GOO_DICK_LENGTH] > 0)
            {
                outputText(" and " + gooCock() + " spatter");
            }
            else
            {
                outputText(" spatters");
    ...
    private function maleDirectFeedLatexGooGoneWrong() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            ...
            if (player.cockTotal() > 2)
            {
                outputText("your remaining erections");
            }
            else
            {
        ...
        if (player.cockTotal() == 1)
        {
            outputText("Her hands fixate on your slick, black-coated length, beginning to stroke it with eager pumps");
        }
        else
        {
            outputText("Her eager pumps never slow, and she moves one of her busy mitts to stroke your black-coated length");
        }
    ...
    private function feedLatexyGirlCumDirect() : Void
    {
        ...
        if (player.hasCock())
        {
            ...
            if (player.hasBalls())
            {
                outputText("lift your [balls]");
            }
            else
            {
                outputText("shift position");
            }
            outputText(" to show your [vagina].");
        }
        else
        {
            outputText("  When " + flags[kFLAGS.GOO_NAME] + " glances down, you sashay to better show your [vagina].");
        }
        ...
        if (player.wetness() < 3)
        {
            outputText("  Drizzling wetness pours down your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, happy to have such a... moist [master].");
        }
        else if (player.wetness() < 4)
        {
            outputText("  Drops of wetness beat on your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, pleased to have an appetizer before the main course.");
        }
        else
        {
            outputText("  Lubricant shines on your pet's glossy chin as she pleases you.  She swallows every now and again with eager bobs of her throat, sampling your flavor.");
        }
        ...
        if (player.wetness() >= 4)
        {
            outputText("  You squirt a small river of gushing juices directly into her mouth, her cheeks flooded by the copious outpouring of lubricant.");
        }
        else
        {
            outputText("  You gradually fill her mouth with your free-flowing orgasmic lubricants.");
        }
    ...
    private function letLatexGooDrainCuntDry() : Void
    {
        ...
        {
            outputText("  She happily fellates your female pole in time with the pumping of her arm.");
        }
        else
        {
            outputText("  She happily licks and sucks your most sensitive spot in time with the pumping of her arm.");
        }
    ...
    private function femalePCDomFucksLatexGoo() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("lift your [sack] out of the way to ");
        }
        else if (player.hasCock())
        {
            outputText("lift your [cocks] out of the way to ");
        }
        ...
        if (gooObedience() < 60)
        {
            ...
            if (gooObedience() < 20)
            {
                outputText("boldly retorts");
            }
            else if (gooObedience() < 40)
            {
                outputText("answers snarkily");
            }
            else
            {
                outputText("timidly protests");
            }
            ...
            if (flags[kFLAGS.GOO_DICK_LENGTH] > 0)
            {
                outputText(" and the rigidity of her " + gooCock() + " have");
            }
            else
            {
                outputText(" has");
            ...
            if (gooFluid() < 15)
            {
                outputText("  Her hunger is palpable, perhaps it would be best if you simply 'fed' her soon?");
            }
            endEncounter();
            gooObedience(-3);
            return;
        ...
        if (flags[kFLAGS.GOO_DICK_LENGTH] > 0)
        {
            outputText("  Meanwhile, the " + gooCock() + " sways uselessly above the conjoined vaginas, leaking its own secretions as it's ignored.");
        }
        ...
        if (player.biggestTitSize() >= 1)
        {
            ...
            if (player.lactationQ() > 50)
            {
                ...
                {
                    outputText("dribbles over your fingers");
                }
                else if (player.lactationQ() < 500)
                {
                    outputText("squirts out unhindered");
                }
                else
                {
                    outputText("sprays out in a fountain");
                }
            }
        }
        else
        {
            outputText(", pinching your [nipples]");
        }
        ...
        if (player.hasCock())
        {
            outputText("  Some of it even splats onto your [cocks], leaving tight black spots on your maleness.");
        }
        if (flags[kFLAGS.GOO_DICK_LENGTH] > 0)
        {
            outputText("  Her " + gooCock() + " practically bursts from within, distending to accommodate its lurid latex discharge.  Most of it splatters against " + flags[kFLAGS.GOO_NAME] + "'s skin and rolls down her flesh in a march of onyx droplets.");
        }
        ...
        var normF : Void->Void = function() : Void
        {
    ...
    private function femalePCDomFucksLatexGooFuta() : Void
    {
        ...
        if (gooObedience() < 60)
        {
            if (gooFluid() < 33)
            {
                outputText("Licking her lips with unrepentant hunger");
            }
            else if (gooFluid() < 66)
            {
                outputText("Sticking her tongue against her cheek in consternation");
            }
            else
            {
                outputText("Rolling her eyes");
            }
            outputText(", " + flags[kFLAGS.GOO_NAME] + " ");
            if (gooObedience() < 20)
            {
        ...
        if (flags[kFLAGS.GOO_DICK_LENGTH] * flags[kFLAGS.GOO_DICK_LENGTH] / 6 > player.vaginalCapacity())
        {
            outputText("  Of course, as gigantic as it is, you can't take all of it, but you do your damnedest to try.");
        }
        else
        {
            outputText("  Soon, your [butt] comes to rest against " + flags[kFLAGS.GOO_NAME] + "'s oily skin, her erection nestled nicely inside you.");
        }
        ...
        if (player.isTaur())
        {
            outputText("into your haunches");
        }
        else if (player.tallness >= 84)
        {
            outputText("against your side");
        }
        else if (player.tallness >= 70)
        {
            outputText("into your shoulder");
        }
        else if (player.tallness >= 60)
        {
            outputText("into your neck");
        }
        else
        {
            outputText("over your head");
        }
        ...
        if (flags[kFLAGS.GOO_DICK_LENGTH] * flags[kFLAGS.GOO_DICK_LENGTH] / 6 <= player.vaginalCapacity())
        {
            outputText(", your [butt] clapping wetly against her onyx thighs");
        }
        ...
        if (flags[kFLAGS.GOO_DICK_TYPE] == CockTypesEnum.DOG)
        {
            outputText("stays trapped inside you thanks to your pet's thick knot");
        }
        else
        {
            outputText("sprays out of your [vagina]");
        }
        ...
        if (!player.isTaur())
        {
            ...
            if (flags[kFLAGS.GOO_NIPPLE_TYPE] == -1)
            {
                ...
                {
                    outputText("kiss yours");
                }
                else
                {
                    outputText("swallow your nipples");
                }
                outputText(".");
            }
            else if (flags[kFLAGS.GOO_NIPPLE_TYPE] == 1)
            {
                ...
                if (!player.hasFuckableNipples())
                {
                    outputText("smear over the tops of your tits");
                }
                else
                {
                    outputText("disappear into your nipplecunts");
                }
                outputText(".");
            }
            else
            {
                ...
                if (!player.hasFuckableNipples())
                {
                    outputText("rub all over your own");
                }
                else
                {
                    outputText("dock into your nipple-cunts");
                }
                outputText(".");
            }
        }
        ...
        {
            outputText(", you begin to fondle your [nipples] and bounce haunches on her lap.");
        }
        ...
        if (player.isTaur())
        {
            outputText("The latex woman wastes no time in bending double to kiss your equine ass, even darting forward to smooch your tender ring.");
        }
        else
        {
            outputText("The latex woman wastes no time in placing her glossy lips against yours, even plunging her slick tongue into your mouth.");
        }
        ...
        if (!player.isTaur())
        {
            outputText(" along with your own");
        }
        outputText(".  Together, the two of you give in to ecstasy and cum... and cum... and cum.");
        if (player.hasCock())
        {
            outputText("  White erupts from your [cocks] with abandon.  You don't even care that it stains " + flags[kFLAGS.GOO_NAME] + "'s " + gooTits() + ".  It feels so good and she looks so pretty with strands of icing spattering over top of her.");
        }
        if (player.hasCock() && player.cumQ() >= 750)
        {
            outputText("  Of course, you quickly bury those strands in a wave of alabaster.");
        }
        ...
        if (flags[kFLAGS.GOO_DICK_TYPE] == CockTypesEnum.DOG)
        {
            outputText(", ignoring the loud 'pop' of her knot slipping free,");
        }
        ...
        if (flags[kFLAGS.LATEX_GOO_TIMES_FEMDOMMED_BY_PC] > 0)
        {
            outputText(", and obediently, she does.  To reward her for being a good pet, you give her a deep tongue kiss.");
        }
        else
        {
    ...
    private function malePCDomFucksLatexGoo() : Void
    {
        ...
        {
            outputText("Smiling knowingly");
        }
        else
        {
            outputText("Tired of her blather");
        }
        ...
        if (player.biggestCockArea() < 80)
        {
            outputText("easily encompassing your erection");
        }
        else
        {
            outputText("gleefully stretching into a mold of your erection as it passes into her core");
        }
        ...
        if (player.biggestCockArea() >= 10 && player.biggestCockArea() < 50)
        {
            outputText(" and throat");
        }
        else if (player.biggestCockArea() >= 50)
        {
            outputText(", throat, and body");
        }
        outputText(" with quick strokes.  Faster and faster you bounce her on your loins");
        if (player.biggestCockArea() >= 80)
        {
            outputText(", amazed that she can take so much so easily");
        }
        ...
        if (player.cumQ() >= 500)
        {
            outputText("  Squirts of spooge run out of her nostrils after a particularly potent blast, but " + flags[kFLAGS.GOO_NAME] + " doesn't mind or even break her gaze.");
        }
        if (player.cumQ() >= 1000)
        {
            outputText("  Your copious spunk rounds her belly, but most of that liquid weight transfers to her tits, hips, and ass in moments.");
        }
        if (player.cumQ() >= 4000)
        {
            outputText("  That isn't enough to keep up with your potency.  A moment later, the corners of her mouth begin to ooze alabaster, squirting out with each pulse.  Poor girl.");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            outputText("  This quickly bloats her into a pregnant-looking state, and after her last injection, she has nowhere to metabolize it all.");
        }
        if (player.cumQ() >= 2000)
        {
            outputText("  You keep going until a torrent of alabaster seed is running out of her cunt around your cock.  Glorious.");
        }
        if (flags[kFLAGS.GOO_DICK_LENGTH] > 0)
        {
            outputText("  The " + gooCock() + " below noisily fires inky loads into the dirt, where it's quickly absorbed.");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            outputText("  And so messy!  I don't know if I can hold any more!");
        }
        ...
        if (player.cumQ() >= 1000)
        {
            outputText("  Almost immediately, cream drips out around her ass and over your [legs].  She's just too full to take much more - your cum has nowhere to go but out!");
        }
        if (player.cumQ() >= 2000)
        {
        ...
        if (player.cumQ() >= 1000)
        {
            outputText("of mixed fluids");
        }
        else
        {
            outputText("of her own leftover sex-juice");
        }
    ...
    private function feedLatexySomeMilk() : Void
    {
        ...
        if (gooFluid() >= 66)
        {
            outputText("  She shrugs, but gives you a little smile as she sidles closer to you. \"<i>No, but if you need to lighten your load... I'm your girl!</i>\"");
        }
        //{Middling hungry}
        else if (gooFluid() >= 33)
        {
            outputText("  She licks her lips in response to your offer, obviously ready for a taste of your delicious milk.");
        }
        //{Really fucking hungry}
        else
        {
            outputText("  Before you've even completed your offer, " + flags[kFLAGS.GOO_NAME] + " is on you like a moth to a flame, eagerly pulling at your clothes to try and free your teats.");
        }
        ...
        if (player.gender > 0)
        {
            outputText("smearing her fingers with a liberal spattering of your cum");
        }
        else
        {
            outputText("your [ass] clamping down hard as her finger milks you from behind");
        }
        ...
        if (player.lactationQ() >= 4000)
        {
            fluid += 10;
        }
        if (player.lactationQ() >= 8000)
        {
            fluid += 10;
        }
        gooFluid(fluid);
