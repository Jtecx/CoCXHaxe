...
class Isabella extends Monster
{
    ...
    //[Standard attack]
    {
        ...
        else
        {
            ...
            {
                damage = Math.round(((weaponAttack + str + 20) * flags[kFLAGS.ISABELLA_LVL_UP]) - rand(player.tou + player.armorDef));
            }
            else
            {
    ...
    //[Stunning Impact]
    {
        ...
        else
        {
            ...
            if (flags[kFLAGS.ISABELLA_LVL_UP] >= 1)
            {
                damage = Math.round(((weaponAttack + str) * (1 + (flags[kFLAGS.ISABELLA_LVL_UP] * 0.1))) - rand(player.tou + player.armorDef));
            }
            else
            {
    ...
    public function isabellaThroatPunch() : Void
    {
        ...
        else
        {
            ...
            if (flags[kFLAGS.ISABELLA_LVL_UP] >= 1)
            {
                damage = Math.round((str * (1 + (flags[kFLAGS.ISABELLA_LVL_UP] * 0.1))) - rand(player.tou + player.armorDef));
            }
            else
            {
    ...
    public function drankMalkYaCunt() : Void
    {
        ...
        if (flags[kFLAGS.ISABELLA_LVL_UP] >= 1)
        {
            HP += 100 * flags[kFLAGS.ISABELLA_LVL_UP];
        }
        else
        {
            HP += 100;
    ...
    public function new()
    {
        ...
        this.hairColor = "red";
        this.hairLength = 13;
        var lvlMulti : Float = flags[kFLAGS.ISABELLA_LVL_UP];
        if (flags[kFLAGS.ISABELLA_LVL_UP] < 1)
        {
        ...
        else if (flags[kFLAGS.ISABELLA_LVL_UP] <= 15)
        ...
        if (flags[kFLAGS.ISABELLA_LVL_UP] >= 15)
        {
