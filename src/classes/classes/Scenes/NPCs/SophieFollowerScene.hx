...
class SophieFollowerScene extends NPCAwareContent implements SaveableState
{
    ...
    public static var HarpyEggHatching : Bool;
    public static var HarpyEggReady : Bool;
    ...
    public function loadFromObject(o : Dynamic, ignoreErrors : Bool) : Void
    {
        if (o != null)
        {
            HarpyEggHatching = Reflect.field(o, "HEggHatching");
            HarpyEggReady = Reflect.field(o, "HEggReady");
            if (Lambda.has(o, "HEggDay"))
            {
                HarpyEggDay = Reflect.field(o, "HEggDay");
            }
            else
            {
                HarpyEggDay = 0;
            }
            if (Lambda.has(o, "HKids"))
            {
                HarpyKids = Reflect.field(o, "HKids");
            }
            else
            {
                HarpyKids = 0;
    ...
    override public function sophieFollower() : Bool
    {
    ...
    private function unbimboSophie() : Void
    {
        clearOutput();
    ...
    private function yesDebimboSophie() : Void
    {
        ...
        //first time{
            ...
            {
                flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] = 1;
            }
    ...
    private function bimboSophieAgain() : Void
    {
        ...
        {
            sophieBimbo.approachBimboSophieInCamp(false);
        }
    }
    ...
    @:allow(classes.scenes.nPCs)
    private function beatUpDebimboSophie() : Void
    {
        clearOutput();
        ...
        {
            addButton(4, "Bimbo Again", bimboSophieAgain);
        }
        else
        {
            addButtonDisabled(4, "Bimbo Again", "Oops... you were not prepared for this outcome, were you?");
        }
    }
    
    //Get the Shit Beaten Out of You by a God-damn Bimbo (You (weakling) Monster)
    @:allow(classes.scenes.nPCs)
    private function debimboSophieBeatsYouUp() : Void
    {
        clearOutput();
        ...
        menu();
        if (player.inte > 60 && flags[kFLAGS.SOPHIE_BIMBO_AGAIN] == 0)
        
        //fuck your explanations, you just attacked her!{
    ...
    public function followerSophieMainScreen() : Void
    {
        ...
        //Replacement Greeting Screen For In Season{
            ...
            {
                outputText("restoring her intellect made her quite skilled at it again");
            }
            else
            {
                outputText("she's quite skilled at it");
            }
        ...
        else if (flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0)
        {
            ...
            {
                outputText("Sophie leans back in her nest as you approach, her prominent, bare F-cups on display.  She's completely nude, as always, and sits with her avian legs shamelessly spread, revealing the slick slit of her womanhood framed by downy-soft platinum blonde feathers.  \"<i>Hey there, " + player.mf("handsome", "cutey") + ".  What can Momma Sophie do for you?  Come for a cuddle in my welcoming wings, maybe; or for something more... exciting?</i>\"");
            }
            else
            {
                outputText("Sophie leans back in her nest as you approach, her prominant, bare DD-cups on display.  She's completely nude, as always, and sits with her avian legs demurely crossed, concealing the slick slit of her womanhood from you.  \"<i>Hey there, " + player.mf("handsome", "cutey") + ".  What can Momma Sophie do for you?</i>\"");
            }
        }
        else
        {
        ...
        menu();
        addButton(0, "Appearance", sophieAppearance);
        addButton(1, "Sex", sexWithFollowerSophie).disableIf(player.lust < 33, "You aren't aroused enough to sleep with Sophie at the moment.");
        ...
        if (flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] != null)
        {
            ...
            {
                addButton(3, "Harvest Eggs", harvestEggs);
            }
        ...
        else
        {
            ...
            {
                addButton(2, "Farm Work", sendToFarm);
            }
            ...
            {
                addButton(10, "Mock Fight", mockSophie);
            }
            addButton(14, "Back", camp.campFollowers);
        }
    }
    ...
    private function mockSophie() : Void
    {
        ...
        var fight : Void->Void = function() : Void
        {
    ...
    private function sexWithFollowerSophie() : Void
    {
        ...
        addButton(0, "Vaginal", fuckFollowerSophie).disableIf(!sophieBimbo.cockFits, sophieBimbo.nofitMsg);
        addButton(1, "Blowjob", sophieFollowerGivesBlowjobs).disableIf(!player.hasCock(), "Req. a cock!");
        if (!(flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] > 0 && flags[kFLAGS.SOPHIE_FAMILY_INCEST] == 0))
        {
            addButton(4, "DaughterFuck", sophieIncest).disableIf(!sophieBimbo.cockFits, sophieBimbo.nofitMsg).disableIf(flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] == 0, "This scene requires some actions when Sophie's... not so smart.\n\n", "???");
        }
    ...
    private function sleepWithSophieToggle() : Void
    {
        ...
        if (flags[kFLAGS.SLEEP_WITH] != "Sophie")
        {
            ...
            if (flags[kFLAGS.SOPHIE_BIMBO_ACCEPTED] > 0)
            {
                ...
                if (player.smallestCockArea() <= 5 && player.hasCock())
                {
                    outputText(", but don't be surprised if I go a little rough on that tiny dick of yours in the morning");
                }
            ...
            else
            {
                ...
                if (player.smallestCockArea() <= 5 && player.hasCock())
                {
                    outputText("  \"<i>You won't mind me teasing your cute little dick in the mornings, will you [name]?  It's so cute...</i>\" she muses.\n\n<b>If you don't want her to tease you about your small penis, you had better not sleep with her.</b>");
                }
            }
        ...
        else
        {
            ...
            if (flags[kFLAGS.SOPHIE_BIMBO_ACCEPTED] == 0)
            {
                outputText("Well, it is your bed.  Let me know if you want me coming back for snuggles, okay?");
            }
            else
            {
                outputText("Couldn't handle all these curves, huh, [name]?  Don't fret, Momma Sophie will stick around until you can't stop yourself from cuddling up on her.");
            }
            outputText("</i>\"");
    ...
    private function fuckFollowerSophie() : Void
    {
        ...
        if (sophieBimbo.sophieIsInSeason())
        {
            outputText("gushing, sperm-hungry");
        }
        else
        {
            outputText("slippery");
        ...
        {
            outputText("finger my asshole");
        }
        outputText(" while I fuck you, [name]!</i>\" she commands, fixing you with her eyes authoritatively.  ");
        if (y >= 0)
        {
            outputText("You shift to bring your " + cockDescript(y) + " up in place, just in time for Sophie's wiggling rectum to spread around it.  It slides on in without so much as a whimper.");
        }
        else
        {
            outputText("You thumb at her asshole hesitantly, right up until her wiggling rectum presses on it, easily dilating around your invading finger.");
        }
        ...
        if (y >= 0)
        {
            outputText("  You pack her intestines full of cum at the same time that you sperm up her clingy cunny tunnel.");
        }
        if (sophieBimbo.sophieIsInSeason())
        {
            outputText("  Her pussy seems to drink the spunky deposit down, her cervix opening to allow in as much in as possible.  You can feel the suction, and if you weren't already riding out a mind-bending orgasm, you're sure you'd be cumming harder than normal right now.");
        }
        ...
        if (player.cumQ() >= 500)
        {
            ...
            if (player.cumQ() < 1000)
            {
                outputText("has begun to inflate");
            }
            else
            {
                outputText("has inflated to an absurd degree");
            }
            outputText(" due to all the spooge you're squirting");
            if (player.cumQ() >= 4000)
            {
                outputText(" and it's still growing larger");
            }
            outputText(".");
        }
    ...
    private function sophieVagFollowerFollowup() : Void
    {
        ...
        if (sophieBimbo.sophieIsInSeason())
        {
            outputText("If that didn't take, I don't know what will!");
        }
        else if (player.cockArea(x) <= 5)
        {
            outputText("Not too bad for a tiny girl-dick!");
        }
        else
        {
            outputText("It's always better when you have to wait for it, isn't it?");
        }
        outputText("</i>\"");
    ...
    private function sophieFollowerGivesBlowjobs() : Void
    {
        ...
        if (player.cockArea(x) <= 5)
        {
            outputText("tiny clit you call a penis");
        }
        else if (player.cockArea(x) <= sophieBimbo.sophieCapacity() / 2)
        {
            outputText("needy boy-cock");
        }
        else
        {
            outputText("over-swollen engorgement you call a cock");
        }
        ...
        {
            outputText(", right between your [chest]");
        }
        outputText(", and she slowly trails it up to your chin, which she gently grabs in her long-nailed fingers.  \"<i>");
        if (flags[kFLAGS.SOPHIE_BIMBO_ACCEPTED] > 0)
        {
            outputText("You may have given me a bimbo's body and an insatiable need for sex,");
        }
        else
        {
            outputText("You may have seduced me into your camp with hot sex,");
        }
    ...
    private function sophieBlowsSixtyNine() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText("s, searching for her target of the day.  At last, she settles on your " + cockDescript(x) + ", giving it an affectionate squeeze");
        }
        else
        {
            outputText(", giving it an affectionate squeeze");
        }
        ...
        if (player.tongue.type > Tongue.HUMAN && player.tongue.type <= Tongue.DRACONIC)
        {
        ...
        {
            outputText("Your tongue slides right in, the harpy's pussy seeming almost like a second home.  Her taste saturates your taste buds as you plunge in as deeply as possible, gliding over her velvet folds as it goes.");
        }
        ...
        if (player.hasVagina())
        {
            ...
            if (player.hasBalls())
            {
                outputText(" reaches under your [balls] and");
            }
        ...
        {
            outputText("She tenderly strokes a long nail across the sensitive skin of your taint.  It seems she's being very considerate to your pleasure, so considerate she has you so hard and full that it almost hurts.");
        }
        ...
        {
            outputText("to the [sheath]");
        }
        else
        {
            outputText("as far as she can, gagging slightly");
        }
        ...
        if (player.cumQ() >= 1000 || player.cockTotal() > 1)
        {
            outputText("  Warm goo covers your [hips] and [butt] once your virile deposit becomes too much for Sophie to handle.");
        }
        if (player.cumQ() >= 500)
        {
            outputText("  She quickly gives up on trying to swallow it after she starts showing some cum-pudge, but her hand pumps you energetically as she milks your " + cockDescript(x) + ", squeezing the voluminous ropes of cum all over your [chest].");
        }
        if (player.cumQ() >= 3000)
        {
            outputText("  You make a big white puddle with all the drippings, sinking into the cummy mud as you eat out the orgasmic harpy matron.");
        }
    ...
    private function forceSophieBlowjob() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText("fondling your [balls] with almost eager attention,");
        }
        else
        {
            outputText("rubbing your length with almost eager attention,");
        }
        ...
        if (player.cockArea(x) <= 60)
        {
            outputText("as far as it can go, even taking you part way into her throat before she runs out of room");
        }
        else
        {
            outputText("the whole way to your base, inch after inch of dick-flesh vanishing into her pliant throat");
        }
        outputText(".");
        ...
        {
            outputText("  Your extra cock flops against her cheek, catching on her ear and slowly leaking pre-cum into her down-soft hair.");
        }
        else if (player.cockTotal() > 2)
        {
            outputText("  Your extra cocks flop against her cheeks, catching on her ear and shoulder and slowly leaking pre-cum into her down-soft hair.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] feel almost like they're filling up, taut with liquid weight that begs to pump out");
        }
        else
        {
            outputText("  It feels tight, like you're filling up with a warm liquid weight that's just begging to be let out");
        }
        ...
        if (player.hasKnot(x))
        {
            outputText("  The knot inflates just behind her lips, a golden orb that entraps you within her slick mouth and makes sure all your salty cremè is going to go down her throat.");
        }
        ...
        if (player.cumQ() >= 500)
        {
            ...
            if (player.cumQ() >= 2000)
            {
                outputText(", but that's just the beginning.  You bloat her tummy to an obscene, almost spherical shape");
            }
            if (player.cumQ() >= 4000)
            {
                outputText(", and then cum some more, the flooding jizz forced to escape from her nostrils after you finish flooding every inch of her digestive system");
            }
            outputText(".");
        }
        ...
        {
            outputText("slip your spasming boner out of her golden gates, dripping the last few drops onto her pouty lower-lip.");
        }
        else
        {
            outputText("pull against Sophie's cock-locked mouth, but your knot won't budge.  You sit there waiting for it to go down for what seems like forever, and her lipstick doesn't exactly help - it seems like your cum continues to flow and dribble the entire time, your animal-dong intent on inseminating the harpy's mouth.  Still, you manage to 'pop' free eventually, even though it stretches Sophie's jaw and echoes around your camp.");
        }
        ...
        if (flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] == 1)
        {
            outputText("Ahhh... not... not as much as... I would if you'd reciprocate!");
        }
        else if (flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] == 2)
        {
            outputText("Ahhh... I... I don't know how many times I'll put up with this kind of treatment!");
        }
        else if (flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] == 3)
        {
            outputText("Ahhh... are... are you ever going to reciprocate?");
        }
        else if (flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] == 4)
        {
            outputText("Ahhh... actually... I think... <b>I think if you don't treat me nicer, I might leave.</b>");
        }
        else
        {
            outputText("Ahhh... I think... I've had enough...");
        }
        outputText("</i>\"");
    ...
    public function sophieSmallDongTeases() : Void
    {
        ...
        if (player.str >= 70)
        {
            outputText("  You could force her off you if you wanted, but you didn't bring her to bed for nothing.");
        }
        ...
        {
            outputText(" and squeezes your " + player.breastCup(0) + " breast roughy.");
        }
        else
        {
            outputText(" and lets the talons dig into your " + player.skinFurScales() + " just enough to hurt a little.");
        }
        ...
        if (flags[kFLAGS.TIMES_MORNING_SOPHIE_FEMDOMMED] > 0)
        {
            outputText("In the back of your mind, you know that if her words weren't true you wouldn't have kept sleeping with her and letting her do this to you.");
        }
        else
        {
            outputText("In the back of your mind, you almost have to wonder if it's true, or if her lipstick is just now getting into your system...");
        }
        ...
        if (player.lust < 0.5 * player.maxLust())
        {
            ...
            if (player.cumQ() >= 500)
            {
                ...
                if (player.cumQ() < 1000)
                {
                    outputText(" with huge wet spots over your bodies");
                }
                else
                {
                    outputText(" soaked from the waist down");
                }
                outputText(".  It feels so good that neither of you mind.");
            }
            if (player.cumQ() >= 2000)
            {
                outputText("  Your bed is a reflective, sticky white as well, practically a lake of seed by now.");
            }
        }
        //{High Sensitivity}
        else
        {
            ...
            if (player.pregnancyIncubation > 0 && player.pregnancyIncubation < sceneHunter.adjustPregEventTimer(150, player.pregnancyType))
            {
                outputText(", rolling off the pregnant dome you call your tummy");
            }
            outputText(".");
            if (player.cumQ() >= 500)
            {
                outputText("  You cum for what seems like hours, emptying your [balls] onto yourself, every drop of wasted seed a testament to your pussy-whipped status.");
            }
            if (player.cumQ() >= 1000)
            {
                outputText("  A puddle of jizz forms around you before long, mixing with the drippings from her pussy as she rides you into your own soaked bedding.");
            }
    ...
    private function sophieSpecial() : Void
    {
        ...
        if (player.hasBalls())
        {
            outputText(", and your [balls] are just waiting to unload a virile, sticky package down her throat");
        }
        ...
        {
            outputText("giant piece of a meat rod");
        }
        ...
        if (player.cumQ() < 250)
        {
            outputText("  She milks you for all you're worth.");
        }
        else if (player.cumQ() < 750)
        {
            outputText("  She whimpers at how much you've discharged into her.");
        }
        else if (player.cumQ() <= 1500)
        {
            outputText("  Your cum soon gushes out into a small puddle from her pussy and onto your [hips].");
        }
        else
        {
            outputText("  Her ass is suddenly pushed out more towards you, cum gushing out of her wet cunt as she starts inflating from the sheer amount of cum in your first load.");
        }
        ...
        {
            outputText("pretty cock");
        }
        else
        {
            outputText("humongous cunt-stretcher");
        }
        ...
        if (player.cumQ() < 250)
        {
            outputText("her pussy dripping your cum down onto the ground");
        }
        else
        {
            outputText("your own semen drowning your [hips] and [butt] in a messy cum-puddle as it drips out of her");
        }
        ...
        if (player.cockArea(x) <= 5)
        {
            outputText("dainty little fem-cock");
        }
        else if (player.cockArea(x) <= 30)
        {
            outputText("nice, sweet cum-squirter");
        }
        else
        {
            outputText("immense, gorgeous beast of a cock");
        }
        ...
        if (player.cumQ() < 250)
        {
            outputText("several ropes");
        }
        else if (player.cumQ() < 750)
        {
            outputText("a large, chaotic stream");
        }
        ...
        {
            outputText("massive amounts");
        }
        outputText(" of cum into her, causing her to ");
        if (player.cumQ() < 500)
        {
            outputText("moan in satisfaction");
        }
        else if (player.cumQ() < 1000)
        {
            outputText("groan as her cunny is unable to hold it all");
        }
        else if (player.cumQ() < 2000)
        {
            outputText("stretch atop of you, a cum-filled tummy added to the jiggling tits and soft butt");
        }
        else
        {
            outputText("erupt your cum violently around your shaft as you stretch her to pregnancy-looking visage with your cum alone");
        }
        outputText(".");
        ...
        if (player.cumQ() < 250)
        {
            outputText("  You only drop a meager few squirts inside of her");
        }
        else if (player.cumQ() < 750)
        {
            outputText("  Even your large cum production can't keep up with that pace");
        }
        else
        {
            outputText("  Inhuman as your cum factories are, you're only capable of delivering a few big spurts before it slows to a dribble");
        }
    ...
    private function kissSophieRecruitment() : Void
    {
        ...
        if (player.cockTotal() > 1)
        {
            outputText(", your second one sliding up between her butt");
        }
        if (player.cockTotal() > 3)
        {
            outputText(" while the others press against her");
        }
    ...
    private function sophieRecruitmentFinale() : Void
    {
        ...
        {
            outputText(", sure to introduce her to the other denizens along the way and smooth over any ruffled feathers before things escalate.  Sophie does a good job helping with that.  She seems to have a natural ability to defuse angry situations, something she attributes to raising her many daughters");
        }
        outputText(".");
...
intro for all scenes*/
    @:allow(classes.scenes.nPCs)
    private function sophieIncest() : Void
    {
        clearOutput();
        outputText("Approaching the harpy nest you call out for one of your daughters.  ");
        if (flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] > 1)
        {
            outputText("The prospect of their " + player.mf("father", "mother") + "'s attention causes a small scuffle to break out between your feathery daughters. Thankfully, the small fight is soon ended and one of your daughters flies down and stands before you.  ");
        }
        else
        {
            outputText("Your daughter, hearing your call, is more than happy to come to you.  ");
        }
        ...
        //[first daughter:{
            ...
            if (flags[kFLAGS.DAUGHTER_ONE_BIMBO] > 0 && flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0)
            {
                outputText("\"<i>Like, how do I look, " + player.mf("Daddy", "Mommy") + "?  Aren't my breasts so totally soft?  Don't you just want to suck and squeeze them?  Ooohhh!  " + player.mf("Daddy", "Mommy") + ", can you please touch me?  I want you so bad!  My pussy gets sooo wet when I, like, think about you pounding my cunny!</i>\"");
            }
            //normal speech:
            else
            {
                outputText("\"<i>Don't you like how big and soft my breasts are, " + player.mf("Daddy", "Mommy") + "?  Don't you just want to squeeze them and suck on them?  Ooohh, " + player.mf("Daddy", "Mommy") + ", please, I want you so bad.  I get so hot and wet when I think of you!  I just want your [cock] inside me, pounding my hot cunt until I scream!</i>\"");
            }
        ...
        else if (daughterCap == 1)
        {
            ...
            if (flags[kFLAGS.DAUGHTER_TWO_BIMBO] > 0)
            {
                outputText("bimbo ");
            }
            ...
            if (flags[kFLAGS.DAUGHTER_TWO_BIMBO] > 0 && flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0)
            {
                outputText("\"<i>Mmmm... doncha want to just like, pound my sexy ass, " + player.mf("Daddy", "Mommy") + "?  It's so big, it's just begging to be spanked and squeezed till it's totally red and sensitive</i>\"");
            }
            else
            {
                outputText("\"<i>Come on, " + player.mf("Daddy", "Mommy") + ", touch me, spank me like the bad girl I am, lusting after my " + player.mf("Daddy", "Mommy") + " like this.  Give it to me hard, spank my big round ass and pound my hot tight cunt like I know you want</i>\"");
            }
        ...
        else if (daughterCap == 2)
        {
            ...
            if (flags[kFLAGS.DAUGHTER_THREE_BIMBO] > 0 && flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0)
            {
                outputText("\"<i>L-like, did I do a good job, " + player.mf("Daddy", "Mommy") + "?  I so totally did my best for you.  I know I'm not super sexy like Mom and my sisters... but, " + player.mf("Daddy", "Mommy") + ".. I will like, still please you, like, totally the best that I can!</i>\"");
            }
            else
            {
                outputText("\"<i>W-well, what did you think, " + player.mf("Dad", "Mommy") + "?  Did I do a good job?  I know I'm not as hot as Mom, but I promise I'll please you as best I can!</i>\"");
            }
        ...
        else
        {
            ...
            {
                outputText("\"<i>Come on " + player.mf("Daddy", "Mommy") + ", can't you see how totally hot I am?  Don't you just want to let loose and like, just fuck me till I scream.</i>\"");
            }
            else
            {
                outputText("\"<i>Just look at me, " + player.mf("Daddy", "Mommy") + ", so curvy, so ready, so hot and wet for you.  Just let loose and show me your love, show me how much you love me, " + player.mf("Daddy", "Mommy") + ", fuck me hard, make me scream and claim me as yours.</i>\"");
            }
            ...
            if (flags[kFLAGS.DAUGHTER_FOUR_BIMBO] > 0 && flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0)
            {
                outputText("  \"<i>Ahh... ohhh... oh, " + player.mf("Daddy", "Mommy") + "!  You like my butt, don't you; isn't it nice?  It's so good to grab and squeeze.  I bet it would be fun to, like, spank it too....</i>\"");
            }
            //[normal speech:]
            else
            {
                outputText("  \"<i>Mmmm... Oh, " + player.mf("Daddy", "Mommy") + ", yessss...  That's it, touch me, touch me and play with me, do whatever you want with me.</i>\"");
            }
    ...
    private function phaseTwoOfIncest(daughter : Int) : Void
    {
        ...
        if (daughter == 1)
        {
            outputText("massive pillowy tits");
        }
        else
        {
            outputText("tender perky breasts");
        }
        ...
        if (daughter == 2)
        {
            outputText("massive, round, spankable ass");
        }
        else
        {
            outputText("gropable, soft ass");
        }
        ...
        if (player.biggestTitSize() >= 1)
        {
            ...
            {
                outputText(", perk up as the cool air brushes past your hard, aroused nipples.");
            }
            else if (player.biggestTitSize() < 10)
            {
                outputText(", bounce perkily, nipples hard as your handful of breast flesh touches the cool air.");
            }
            else
            {
                outputText(", spring forth in a wave of soft, squeezable bustiness; the kind of breasts one could curl up with and use as a pillow.");
            }
        }
        ...
        if (flags[kFLAGS.DAUGHTER_FOUR_BIMBO] > 0 && flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0)
        {
            var bimbo : Bool = (((daughter == 4 && flags[kFLAGS.DAUGHTER_FOUR_BIMBO] > 0) || (daughter == 3 && flags[kFLAGS.DAUGHTER_THREE_BIMBO] > 0) || (daughter == 2 && flags[kFLAGS.DAUGHTER_TWO_BIMBO] > 0) || (daughter == 1 && flags[kFLAGS.DAUGHTER_ONE_BIMBO] > 0)) && flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0);
        }
        ...
        if (daughter == 1)
        {
            outputText("The sensation of your lips pressing against her puffy, sensitive lips so roughly only makes her pleasure greater; her pussy quivering around you and clenching hard as you kiss her.  ");
        }
        ...
        if (player.cumQ() < 250)
        {
            outputText("  Squirting over and over into your sweet, lusty girl, you inseminate your fertile daughter, spilling as much of your cream right into her needy, hungry womb as possible.");
        }
        //cum volume medium:
        else if (player.cumQ() < 500)
        {
            outputText("  Gushing over and over into your sweet, lusty daughter, you hold yourself tighter against her, making sure you force as much of your spunk into her waiting, hungry womb as you can.");
        }
        //[cum volume high:
        else if (player.cumQ() < 2000)
        {
            outputText("  Gush after gush of thick rich cum flows from you, basting your daughter's womb with your virile spunk.  Wedging yourself as tightly against her as you can, you make sure that every drop packs into her fertile belly.  The potent flow of your seed quickly swells her stomach into a cute cum bloated paunch.");
        }
        else
        {
            outputText("  Your seed floods your daughter's tight, squeezing cunt like a flood, wave after wave of your thick, frothy spunk forces its way through her convulsing cunt and right into her eager, waiting womb.  Geysers of thick, frothy spunk force their way into her womb, filling it fuller and fuller until her belly swells and swells.  Her once tight, flat tummy rounds out into a healthy round cumbaby, your thick, yogurt-like spunk overflowing from her overstuffed snatch in thick, sticky streams.");
        }
        ...
        if (bimbo)
        {
            outputText("  \"<i>Oh, " + player.mf("Daddy", "Mommy") + ", oh, " + player.mf("Daddy", "Mommy") + "...  So good!  My " + player.mf("Daddy", "Mommy") + "'s such a hot, sexy " + player.mf("stud", "herm") + ".  I so totally thought I was going to like, lose my mind for a second.  I love you, " + player.mf("Daddy", "Mommy") + ".</i>\"");
        }
        else
        {
            outputText("  \"<i>Oh, " + player.mf("Daddy", "Mommy") + ", oh, " + player.mf("Daddy", "Mommy") + "... so good, you're such a fucking " + player.mf("stud", "perfect breeder") + "!  I could just get addicted to you.  I love you, " + player.mf("Daddy", "Mommy") + ",</i>\"");
        }
