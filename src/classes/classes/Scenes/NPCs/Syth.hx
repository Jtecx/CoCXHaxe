...
class Syth extends Monster
{
    ...
    {
        wrath -= 30;
        var damage : Float = this.weaponAttack;
    ...
    private function sythAttack2() : Void
    {
        ...
        damage = as3hx.Compat.parseInt((str) - rand(player.tou) - player.armorDef);
        ...
        {
            outputText("The salamander rushes at you, knocking aside your defensive feint and sliding in past your guard.  He lashes out at your feet with his tail, and you can feel the heated wake of the fiery appendage on your ensuing fall toward the now-smouldering grass. ");
        }
        if (damage > 0)
        {
    ...
    private function sythAttack3() : Void
    {
        ...
        var lustDmg : Float = this.lust / 10 + this.lib / 10 + this.inte / 10 + this.wis / 10 + this.sens / 10;
    ...
    public function new()
    {
        ...
        this.drop = new ChainedDrop().add(weapons.DBFSWO, 1 / 50).add(armors.LEATHRA, 1 / 20).add(consumables.SALAMFW, 0.7);
