...
class Nadia extends Monster
{
    ...
    public function usingARC() : Void
    {
        ...
        else if (flags[kFLAGS.NADIA_LVL_UP] >= 12)
        {
            mana += 1440;
        }
        else if (flags[kFLAGS.NADIA_LVL_UP] >= 5)
        {
            mana += 240;
        }
        else
    ...
    public function usingHealSpell() : Void
    {
        ...
        else if (flags[kFLAGS.NADIA_LVL_UP] >= 2 && flags[kFLAGS.NADIA_LVL_UP] < 8)
        {
            outputText("Unicorn");
        }
        else
    ...
    override private function performCombatAction() : Void
    {
        ...
        else if (flags[kFLAGS.NADIA_LVL_UP] >= 12 && flags[kFLAGS.NADIA_LVL_UP] < 16)
        {
            ...
            if (choice4 > 2 && choice4 < 5)
            {
                ...
                else if (rand(3) == 0 && (mana >= 100))
                {
                    usingMagicBoltsBarrageSpell();
                }
                else if (rand(2) == 0 && (mana >= 20))
                {
                    usingMagicBoltSpell();
                }
    ...
    override public function won(hpVictory : Bool, pcCameWorms : Bool) : Void
    {
        ...
        {
            SceneLib.nadiaScene.lostToNadiaSpar();
        }
        else
        {
            SceneLib.nadiaScene.lostToNadia();
        }
    }
