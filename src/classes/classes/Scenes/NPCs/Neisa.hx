...
class Neisa extends Monster
{
    ...
    public function new()
    {
        super();  //  Her skin is dusky, nearly chocolate except for a few white spots spattered over her body.  
        ...
        {
            var mod : Int = as3hx.Compat.parseInt(flags[kFLAGS.NEISA_LVL_UP] - 1);
