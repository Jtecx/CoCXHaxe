...
class Exgartuan extends NPCAwareContent implements TimeAwareInterface
{
...
*/
    ...
    public function timeChange() : Bool
    {
        ...
        if (dickPresent() && (!player.hasCock() || player.cockArea(0) < 100))
        ...
        //If too small dick, remove him{
            ...
            if (player.hasCock())
            {
                outputText("<b>Perhaps you've got too small for him to handle?</b>\n");
            }
            else
            {
                outputText("<b>It looks like the demon didn't want to stick around without your manhood.</b>\n");
            }
            awardAchievement("Urine Trouble", kACHIEVEMENTS.GENERAL_URINE_TROUBLE, true, false, true);
            leaveDick();
            needNext = true;
        }
        if (boobsPresent() && player.biggestTitSize() < 12)
        ...
        if (dickPresent())
        {
            ...
            {
                period = as3hx.Compat.parseInt(768 / player.statusEffectv2(StatusEffects.Exgartuan));
                if (period < 8)
                {
                    period = 8;
                }
                ...
                {
                    dynStats("lus", (1 + rand(3)) * (-player.statusEffectv2(StatusEffects.Exgartuan)) / 6, "scale", false);
                }
            }
        }
        if (boobsPresent())
        {
            ...
            {
                period = as3hx.Compat.parseInt(384 / player.statusEffectv3(StatusEffects.Exgartuan));
                if (period < 4)
                {
                    period = 4;
                }
                ...
                {
                    dynStats("lus", (1 + rand(2)) * (-player.statusEffectv3(StatusEffects.Exgartuan)) / 18);
                }
            }
        }
        return needNext;
    ...
    public function infestDick() : Void
    {
        ...
        {
            player.addStatusValue(StatusEffects.Exgartuan, 1, 1);
        }
    }
    public function infestBoobs() : Void
    {
        ...
        {
            player.addStatusValue(StatusEffects.Exgartuan, 1, 2);
        }
    }
    ...
    private function drinkFountainEndowment() : Void
    {
        ...
        if (rand(4) == 0 && player.hasVagina())
        {
            ...
            {
                outputText("gets as big as a cock");
            }
            else
            {
                outputText("gets bigger than most cocks");
            }
            outputText(" now!");
            changed = true;
        }
    ...
    public function exgartuanMasturbation_dick() : Void
    {
        ...
        if (player.cor < 15)
        {
            outputText("You sheepishly find some rocks to hide in, where you remove your clothes.  Exgartuan loudly grumbles, \"<i>Quit fucking around and hiding.  I WANT someone to walk in on this!</i>\"\n\nDisgusting...\n\n");
        }
        if (player.cor >= 15 && player.cor < 30)
        {
            outputText("You make sure you are alone and strip naked.  Exgartuan mutters, \"<i>Why did you wait until you were alone?  Wouldn't it be fun to have a succubus wander in on us?</i>\"\n\n");
        }
        if (player.cor >= 30 && player.cor < 60)
        {
            outputText("You happily remove your [armor], eager to pleasure yourself.  Your possessed [cock] throbbs happily.\n\n");
        }
        if (player.cor >= 60 && player.cor < 80)
        {
            outputText("You strip naked in an exaggerated fashion, hoping someone might be watching.  The demon-possessed member at your groin pulses happily, flooding you with lust in reward for your attitude.\n\n");
        }
        if (player.cor >= 80)
        {
            outputText("You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.  Your possessed member wiggles happily, flooding your body with feelings of lust and desire in reward.  Maybe it can call in a demonic companion for you?\n\n");
        }
        ...
        if (player.cor < 33)
        {
            ...
            {
                outputText("  A tentacle-cock curls up, tightening around the base like an organic cock-ring.  It makes each of the corrupt nodules grow bigger, harder, and even more sensitive.");
            }
        ...
        else if (player.cor < 66)
        {
            ...
            {
                outputText("shove the bloated demon between your [allbreasts], surrounding it in a home of jiggling flesh.  The wet demon-pre soaks into the skin of your tits, lubricating the passage as you mash them around, vigorously tit-fucking the source of your unholy desires.");
            }
            else
            {
                outputText("work the shaft relentlessly, drawing out more and more of the demon's pre-seed until your forearms and upper thighs are coated in the stuff, shining darkly.");
            }
        ...
        else
        {
            ...
            if (player.biggestTitSize() >= 5)
            {
                outputText("your hands smashing your [allbreasts] around the [cock] and vigorously titfucking it.");
            }
            else
            {
                outputText("your hands repositioning your [cock] so it lays against your chest.");
            }
    ...
    public function exgartuanMasturbation_boobs() : Void
    {
        ...
        if (player.isFurCovered() == Skin.FUR)
        {
            outputText("furry-covered flesh");
        }
        else if (player.isScaleCovered() == Skin.SCALES)
        {
            outputText("soft scaley flesh");
        }
        else if (player.isGooSkin())
        {
            outputText("gooey surface");
        }
        else
        {
            outputText("flesh");
        ...
        if (player.hasVagina())
        {
            ...
            {
                outputText(" and pre-cum");
            }
            outputText(" soaks your groin");
        }
        else if (player.cockTotal() > 0)
        {
            outputText("pre-cum soaks your groin");
        }
        else
        {
            outputText("Warmth radiates through your body");
        }
        outputText(" as you're more and more turned on by the feelings coming from your chest.  Fingertips ");
        if (player.nippleLength < 2)
        {
            outputText("pinch together and pull, and it's too much for you.");
        }
        else
        {
            outputText("stroke your enlongated nipples, occasionally pinching them gently as you jerk them off.  It's far too much sensation for you.");
        }
        ...
        {
            outputText("As you calm down you realize your " + nippleDescript(0) + "s are dribbling streams of milk, and judging from the pools of whiteness in the soil, you turned into quite the little milk-sprinkler.  ");
        }
    ...
    public function exgartuanBored_dick() : Void
    {
        ...
        switch (rand(9))
        {
            ...
            case 6:
                ...
                if (player.hasBalls())
                {
                    outputText("teasing your ballsack");
                }
                //[if vagina, no balls]
                else if (player.hasVagina())
                {
                    outputText("poking your labia");
                }
                else
                {
                    outputText("stroking your perineum");
                }
            ...
            case 8:
                ...
                if (player.hasBalls())
                {
                    outputText("boiling in your [balls].");
                }
                else
                {
                    outputText("cooking deep within you.");
                }
    ...
    public function exgartuanCombatUpdate() : Bool
    //Monsters not effected by Exgartuan's stuff
    {
        
        if (monster.short == "tentacle beast" || monster.short == "worms" || monster.short == "demons")
        {
            return false;
        }
        var select : Float = rand(3);
            ...
            else if (monster.hasVagina())
            {
                ...
                switch (select)
                {
                    case 0:
                        ...
                        if (player.cor < 50)
                        {
                            outputText("  You glance down at the sensitive bulge in your [armor] and sigh.  Damned demons.");
                        }
                    case 1:
                    ...
                    case 2:
                        ...
                        if (player.cor < 50)
                        {
                            outputText("  That's terrible!  It's all that demon's fault!");
                        }
                    case 3:
                        ...
                        if (player.cor < 50)
                        {
                            outputText("  You snap back to reality and curse yourself for falling to the demon's desires.");
                        }
                    case 4:
        ...
        else if (boobsAwake() && select == 2)
        {
            ...
            else if (rand(3) == 0)
            {
                ...
                if (rand(3) == 0 && monster.lustVuln > 0)
                {
                    monster.lust += 5 + monster.lib / 10;
                }
                return true;
            }
        }
    ...
    public function exgartuanArmorShift() : Void
    {
        ...
        if (player.cor < 33)
        {
            outputText("  You cringe and blush bright crimson, raging against the demon inside you and wishing he would stop tormenting you!");
        }
        else if (player.cor < 66)
        {
            outputText("  You cringe a bit at the exhibitionist outfit you're forced to wear, but spend a little time admiring just how well the changes show off your package... Maybe Exgartuan isn't all bad?");
        }
        else
        {
            outputText("  You pivot your hips forwards, doing your best to show off your sensational package with every step.  Oh, very nice, you'll have to thank Exgartuan later...");
        }
        outputText("\n");
        if (changed && !player.hasPerk(PerkLib.BulgeArmor))
        {
    ...
    public function caressYourself() : Void
    {
        ...
        else
        {
            ...
            if (player.cor < 50)
            {
                outputText(", angry at yourself for falling prey to the demon's directions");
            }
            outputText(".");
        }
    ...
    public function exgartuanLactationAdjustment() : Void
    {
        ...
        //(Increase){
            ...
            if (rand(2) == 0 || player.hasStatusEffect(StatusEffects.Feeder))
            {
                ...
                player.boostLactation(player.breastRows.length, true);
            }
            //(Stops)
            else
            {
    ...
    private function exgartuanSleepSurprise() : Void
    {
        ...
        if (player.cor <= 20 && player.hasPerk(PerkLib.BulgeArmor))
        {
            ...
            {
                outputText("  You remove your [armor] piece by piece, leaving only the magically-altered centerpiece that your favorite demon ever so generously \"<i>gifted</i>\" to you.\n\n");
            }
            //[else]
            else
            {
                outputText("  You glare at your [armor], its altered state so graciously bestowed upon you by the ever-thoughtful demon that resides in your crotch.\n\n");
            }
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    outputText("wrap your tits around me and squeeze");
                }
                else
                {
                    outputText("wrap your arms around me and stroke");
                }
            ...
            if (player.cor < 33)
            {
                ...
                {
                    outputText(" and bouncing your [allbreasts] around it");
                }
            ...
            else
            {
                ...
                if (flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 5)
                {
                    ...
                    if (player.biggestTitSize() >= 2)
                    {
                        outputText("you squeeze your tits around your [cock] with your biceps");
                    }
                    else
                    {
                        outputText("you squeeze and caress your " + cockDescript(0));
                    }
                ...
                else
                {
                    ...
                    if (player.biggestTitSize() >= 2)
                    {
                        ...
                        {
                            outputText("  Milk and lubricants ");
                        }
                        else if (player.hasFuckableNipples())
                        {
                            outputText("  Lubricants ");
                        }
            ...
            //(no balls){
                ...
                if (player.balls == 0)
                {
                    ...
                    {
                        outputText(" or stroke your " + clitDescript());
                    }
            ...
            if (player.cor < 33)
            {
                outputText("The desire shocks you with the sheer... wrongness of it, but you cannot deny the pleasure of drilling your own slobbering mouth.");
            }
            else if (player.cor < 66)
            {
                outputText("The desire sinks its hooks into the lust-addled flesh of your brain and drags you deeper into lust.  You can't deny the pleasure of drilling your own slobbering mouth.");
            }
            else
            {
                outputText("The desire rushes through your blood as you imagine how you must look, sprawled out, eyes rolled back, and cock drilling at your own slobbering mouth.");
            }
            ...
            {
                outputText(", and judging by Jojo's high pitched whines, he certainly is,");
            }
            ...
            var cumQ : Float = player.cumQ();
            if (cumQ < 50)
            {
                outputText("surprisingly light");
            }
            else if (cumQ < 150)
            {
                outputText("sticky");
            ...
            if (cumQ > 500)
            {
                ...
                if (cumQ > 1500)
                {
                    outputText(", but it doesn't stop there.  It keeps growing until you look full and pregnant.");
                }
                else
                {
                    outputText(".");
                ...
                if (cumQ > 2500)
                {
                    outputText("  Back-pressure blasts your [cock] free from your imprisoning oral cavity along with a fountain of seed while you weakly try to cough out enough spooge to breathe.");
                }
            }
            outputText("\n\n");
            ...
            if (player.biggestTitSize() < 1)
            {
                outputText("over your chest");
            }
            else
            {
                outputText("between your tits");
            }
    ...
    private function exgartuanBulgeTortureII() : Void
    {
        ...
        if (player.armorName == "crotch-hugging full platemail" || player.armorName == "crotch-hugging scale-mail armor")
        {
            outputText("your [armor] feels as if it's become incredibly stiff, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.");
        }
        ...
        if (player.armorName == "crotch-hugging practically indecent steel armor" || player.armorName == "crotch-hugging full-body chainmail" || player.armorName == "crotch-hugging revealing chainmail bikini")
        {
            outputText("your [armor] feels as if it's become incredibly dense, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  What's worse, the links that make up your armor have narrowed and sealed shut.");
        }
        else
        {
            outputText("your [armor] feels as if it were made from 6</i>\" thick steel, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  You continue to run your hands across it, having trouble believing that the material has become so incredibly dense and rigid despite its appearance.");
        }
        ...
        {
            outputText(" along with anything else unlucky enough to reside within");
        }
        outputText(".\n\n");
        ...
        if (player.biggestTitSize() >= 2 && player.bRows() == 1)
        {
            outputText("  Your quest begins squarely on your pair of " + chestDesc() + ", your mitts feverishly groping and tugging away in the hope of finding any sanctuary from your encroaching lust.  Unable to extract any meaningful solace from your magnificent mounds, your sights set on your " + nippleDescript(0) + "s.");
        }
        //[if ≥2 rows of breasts]
        else if (player.biggestTitSize() >= 2)
        {
            outputText("  The [allbreasts] lined down your chest should serve a proper conquest.  Your palms set off to work at once, manhandling as much titflesh as they can satisfy at once.  They dart from one row to the next, inside to out, anything to relieve your libido.  You don't appear to be settling down any, however, so you draw your focus on your top row of " + nippleDescript(0) + "s.");
        }
        else
        {
            outputText("  With little else to turn to, your " + nippleDescript(0) + "s are your only guiding light to hopefully bringing you the peace you crave.");
        }
        //[if nipplecunts]
        if (player.hasFuckableNipples())
        {
            outputText("  You waste little time in pushing four fingers into each gaping teat, anxious for any sort of pleasure.  You tickle and tease, push and pull, anything you can think to release you from this torment.");
        }
        else
        {
            outputText("  A little tapping, tickling, and teasing is about all the effort you can seem to muster.");
        }
    ...
    private function exgartuanBulgeTortureIII() : Void
    {
        ...
        //[if armorname IS EQUAL TO \"<i>crotch-hugging full platemail</i>\" OR \"<i>crotch-hugging scale-mail armor</i>\"]
        if (player.armorName == "crotch-hugging full platemail" || player.armorName == "crotch-hugging scale-mail")
        {
            outputText("  As you stare in bewilderment, you can't even begin to fathom how it possibly seeped through the steel of your solid " + player.armorName);
        }
        //[if armorname IS EQUAL TO \"<i>crotch-hugging practically indecent steel armor</i>\" OR \"<i>crotch-hugging full-body chainmail</i>\" OR \"<i>crotch-hugging revealing chainmail bikini</i>\"]
        else if (player.armorName == "crotch-hugging practically indecent steel armor" || player.armorName == "crotch-hugging full-body chainmail" || player.armorName == "crotch-hugging revealing chainmail bikini")
        {
            outputText("  Your fixation on the drop draws to question just how it managed its way through the sealed chains of your " + player.armorName);
        }
        else
        {
            outputText("  A strange feeling of betrayal casts over as you begin to question how the liquid worked its way through the material when none of your struggles have registered even the slightest sensation.");
        }
        ...
        {
            outputText("  Your " + cockDescript(1) + " remains flaccid beside this bronze adonis, as if sapped of all its life.");
        }
        //[if cocks ≥3]
        else if (player.cockTotal() > 2)
        {
            outputText("  Your extra cocks remain flaccid beside this bronze adonis, as if sapped of all their life.");
        }
        ...
        if (flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] == 0)
        {
            outputText("  No words are exchanged; no thoughts dare to cross your mind. The only sound is that of your heart, its rhythm acting as prelude for the action you desperately covet.  Mixed emotions of guilt, fright, awe, and satisfaction claw at you.");
        }
        //[if occurrence ≥2]
        else if (flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] < 6)
        {
            outputText("  \"<i>Your will cannot even begin to compare to my might, my helpless little champion. You really shouldn't continue acting as if you're above temptation; I'd hate to see what would happen.</i>\"");
        }
        //[if occurrence ≥6]
        else if (flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] >= 6 && flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] < 10)
        {
            outputText("  \"<i>You know, I never thought I would enjoy even the mere thought of celibacy-not even for a moment.  But watching such an <b>honest</b> champion break down to a quivering pile of helplessness is worth it when the attention I receive afterward is so... thorough.</i>\"");
        }
        //[if occurrence ≥10]
        else if (flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] >= 10 && flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] < 12)
        {
            outputText("\"<i>I can keep this up much longer than you can, [armor].  As much as I enjoy watching you struggle to maintain some form of morality and moderation, I would much rather be exploring the world and its many orifices.  Some day you'll leave that fantasy realm you keep running to and join me in the real world.</i>\"");
        }
        //[if occurrence ≥12]
        else
        {
            outputText("\"<i>Oh, it's that time again, I see.  Sorry, I was still thinking about how much I enjoyed myself the <b>last</b> occasion you tried to forget about me!  Well, let's not waste any more time; you know the routine.</i>\"");
        }
        outputText("\n\n");
        ...
        if (player.biggestTitSize() > 1)
        {
            outputText("  Your " + chestDesc() + " work just as hard, smothering Exgartuan in all of their jiggly glory.");
        }
        ...
        if (player.hasBalls())
        {
            outputText("  Your [balls] churn with mighty force, roiling in anticipation.");
        }
        outputText("\n\n");
        ...
        {
            outputText("sizably sticky");
        }
        //[if cumQ()<300]
        else if (player.cumQ() < 300)
        {
            outputText("mighty thick");
        }
        //[if cumQ()<800]
        ...
        if (player.cumQ() < 500)
        {
            outputText("a blast of thick demonic jizz");
        }
        //[else]
        else
        {
            outputText("a colossal wave of heavy demonic jizz");
        }
    ...
    private function exgartuanBulgeTortureIV() : Void
    {
        ...
        {
            outputText("  For a moment, you consider asking someone outside if they remember anything from last night.  But you decide it's better to just keep it to yourself, afraid of what you might find out.");
        }
        //[else]
        else
        {
            outputText("  You glance around at your " + camp.homeDesc() + ", searching for anything that may clue you in on what transpired last night.  After a few moments, however, you decide it better to just move on with your day.");
        }
    ...
    private function boobGartuanSURPRISE() : Void
    {
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
        {
            ...
            if (player.cor < 33)
            {
                outputText("Not long enough, Nemus, I'm afraid!");
            }
            else if (player.cor < 66)
            {
                outputText("Too long, honestly.  You've grown slow over the years, Nemus,");
            }
            else
            {
                outputText("I was worried you'd forgotten about me, Nemus.  You never write,");
            }
            ...
            if (player.cor < 33)
            {
                outputText("I always wondered where you kept this.");
            }
            else if (player.cor < 66)
            {
                outputText("This is one delivery that you'll just have to return to sender, I'm afraid.");
            }
            else
            {
                outputText("You scheme about as well as you fuck, Nemus.");
            }
    ...
    private function boobgartuanSurprise2() : Void
    {
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
        {
            ...
            if (player.cor < 33)
            {
                outputText("Hey, Teensy, remember me?</i>\"");
            }
            //[if corruption ≥30 & <70]
            else if (player.cor < 66)
            {
                outputText("I see you haven't gotten any prettier since last time we met, Teensy.</i>\"");
            }
            //[if corruption ≥70]
            else
            {
                outputText("Timed to get fucked, stud,</i>\"");
            }
            ...
            if (player.cor < 33)
            {
                outputText("Your " + chestDesc() + " brush against the imp's enormous scrotum, causing him to eventually tumble over from the sensation, blocking the impeding entourage of imps behind you.");
            }
            //[if corruption ≥30 & <70]
            else if (player.cor < 66)
            {
                outputText("As you coast under the beast, you take the opportunity to slap around his crown jewels, playing them as if they were a novelty pair of bongos.  The sensation causes him to tumble over, blocking the impeding entourage of imps behind you.");
            }
            else
            {
                outputText("A devilish smile cracks across your face as you coast under the lummox, delivering a quick peck of a kiss on his hanging ballsack.  The sensation causes him to tumble over in confusion, blocking the impeding entourage of imps behind you.");
            }
            outputText("\n\n");
            ...
            if (player.cor < 33)
            {
                outputText("wave goodbye to Nemus");
            }
            //[if corruption ≥30 & <70]
            else if (player.cor < 66)
            {
                outputText("blow a kiss to Nemus");
            }
            //[if corruption ≥70]
            else
            {
                outputText("flip Nemus a mighty bird");
            }
    ...
    private function boobgartuanSurprise3() : Void
    {
        ...
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
        {
            ...
            //[if occurrence ≥2]
            if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] >= 2)
            {
                outputText("s");
            }
        ...
        if (player.cor < 50)
        {
            outputText("  Xenora's tormenting has gone on long enough tonight.");
        }
        else
        {
            outputText("  You love foreplay just as much as any other creature, but this is getting ridiculous.");
        }
        outputText("\n\n");
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
        {
            outputText("\"<i>Don't think you can overpower me like those puny imps that infest your dreams, champion.</i>\"");
        }
        //[if occurrence ≥1]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
        {
            outputText("\"<i>We haven't even started the curriculum yet, champion.</i>\"");
        }
        //[occurrence ≥4]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
        {
            outputText("\"<i>HOW can you forget to caress these cans!?  Tease these teats!?</i>\"");
        }
        //[if occurrence ≥8]
        else
        {
            outputText("\"<i>Did you find anything to grab onto this time besides weeds? It doesn't look like you have.</i>\"");
        }
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
        {
            outputText("\"<i>Well, I suppose you've had enough, champion,</i>\" Xenora yields, building lust betraying her usual taunting behavior, \"<i>Now why don't we move on to what we both want, hm?</i>\"");
        }
        //[if occurrence ≥1]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
        {
            outputText("\"<i>Ready for your final, eh, [name]?</i>\" Xenora teases, a faint lustful waver in her voice contrasting against her dominating demeanor, \"<i>Let's make this one to remember.</i>\"");
        }
        //[if occurrence ≥4]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
        {
            outputText("\"<i>Do you think you'll remember now!</i>\" Xenora shouts exasperatedly, your breasts pushing against your grasp one final time, \"<i>Now stop wasting my time and get to the only thing you're halfway decent at.</i>\"");
        }
        //[if occurrence ≥8]
        else
        {
            outputText("\"<i>I suppose that ends tonight's opening act,</i>\" Xenora goads, her voice as domineering as ever, \"<i>I know you're dying to get on to the grand finale.</i>\"");
        }
        ...
        if (player.cor < 50)
        {
            outputText("It is becoming increasingly clear to you that she evidently just cannot seem to sit idly by when you actually do decide to pay her heed.");
        }
        //[else]
        else
        {
            outputText("You're glad to sit back and bask in the expert manhandling that only she can deliver you.");
        }
        ...
        if (player.gender > 0)
        {
            ...
            if (player.hasCock() && player.hasVagina())
            {
                outputText("an aromatic cocktail of pre and juice");
            }
        ...
        if (player.cor < 50)
        {
            outputText("  At this point you are too far gone to resist.");
        }
        //[else]
        else
        {
            outputText("  You wiggle your fingers in anxious anticipation.");
        }
        ...
        if (player.cor < 50)
        {
            outputText("  Brought on artificially or not, you cannot deny it; you would probably be cursing the wretched demoness if you were not already preoccupied contending with your mounting passion and desire.");
        }
        outputText("  As you paw uselessly at the firm seal, you begin to feel moisture seeping out.");
        //[if not lactating]
        if (player.biggestLactation() < 1 || player.lactationQ() == 0)
        {
            outputText("  <b>Your " + chestDesc() + " have started to lactate profusely.</b>");
        }
        //[if lacationmultipler <4]
        else if (player.biggestLactation() < 4)
        {
            outputText("  <b>Your breasts are only mounting up their lactation to new heights.</b>");
        }
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
        {
            outputText("Perhaps instead of dreaming of being fucked by imps and raiding tombs, you'll remember to take care of these luscious love muffins.");
        }
        //[if occurrence ≥1]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
        {
            outputText("I guess you're ready to graduate.  Just don't forget what you've learned here today.");
        }
        //[if occurrence ≥4]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
        {
            outputText("Never again forget that these tantalizing tits are the most important things in your life, champion.  Or I'll make sure that you remember again.");
        }
        //[if occurrence ≥8]
        else
        {
            outputText("Well, this has been fun, [name].  I look forward to beating you senseless and enjoying the wonderful makeup massage should you forget to see to my means yet again.");
        }
        outputText("</i>\"\n\n");
        ...
        else
        {
            ...
            {
                outputText("  Your nipples are much thicker than you remember, increasing to at least 3 inches in diameter.");
            }
        }
    ...
    public function exgartuanNagaStoleMyMasturbation() : Void
    {
        ...
        if (player.cor < 15)
        {
            outputText("You sheepishly find some rocks to hide in, where you remove your clothes.  \"Keeping me all to yourself, slut? Hide as much as you want, it'll never keep me down,\" Exgartuan gloats.\n\n");
        }
        ...
        if (player.cor <= 25)
        {
            outputText("You make sure you are alone and strip naked.  Exgartuan chides, \"Yes, champion, wallow around in the shadows.  Keep pretending you can continue to hide my brilliance from the world.\"");
        }
        //[if corruption ≥30 & <60]
        else if (player.cor <= 50)
        {
            outputText("You happily remove your [armor], eager to pleasure yourself.  Your possessed cock pulses happily as you remove the last article.");
        }
        //[if corruption ≥60 & <80]
        else if (player.cor <= 75)
        {
            outputText("You strip naked in an exaggerated fashion, hoping someone might be watching.  Exgartuan begins flooding you with lust in response to your willing inclination.");
        }
        //[if corruption ≥80]
        else
        {
            outputText("You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.  Your demonic dong throbs happily from within you, anxious to move on with the festivities.");
        }
        outputText("\n\n");
        ...
        if (player.cor < 33)
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText(", your remaining tool hiding away inside you, uninvited.");
            }
            //[if cocks ≥ 3]
            else if (player.cockTotal() >= 3)
            {
                outputText(", your remaining poles hiding away inside you, uninvited.");
            }
            else
            {
                outputText(".");
        ...
        if (player.cor > 33 && player.cor < 66)
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText(", your remaining tool still hiding away inside you, uninvited.");
            }
            //[if cocks ≥ 3]
            else if (player.cockTotal() > 2)
            {
                outputText(", your remaining poles still hiding away inside you, uninvited.");
            }
            else
            {
                outputText(".  You lean down to embrace the demon and your arms are frozen in place before you can even touch him.  Of course.  \"Are you hungry, champion?\" Exgartuan mocks, shaking slightly to further dig in the knife, \"And to think you're so eager to jump in and have some fun.  But I have something else planned today.\"\n\n");
            }
        }
        //[else]
        else
        {
            ...
            if (player.cockTotal() == 2)
            {
                outputText("  Speaking of resisting, it appears your second tool has been forced to stay in the shed.");
            }
            //[if cocks ≥ 3]
            else if (player.cockTotal() >= 3)
            {
                outputText("  Speaking of resisting, it appears your remaining tools have been forced to stay in the shed.");
            }
        ...
        if (player.inte > 9)
        {
            outputText("You aren't stupid; you can hazard more than just a guess as to what's about to happen.");
        }
        //[else]
        else
        {
            outputText("You may be stupid, but it's incredibly clear what's going on here.");
        }
        ...
        if (player.cocks[0].cockLength >= player.tallness * .5)
        {
            outputText("  There's not quite enough of you to fully envelop the horny monument, however.  Its head pokes out of the top of the scaley volcano, continuing to spew its not-quite-so-molten lava.");
        }
        //[else]
        else
        {
            outputText("  As impressive as Exgartuan's mighty length is in these lands, your tail is plenty capable of completely enveloping the titan in its scaley embrace.");
        }
        ...
        if (player.cor < 33)
        {
            outputText("\"<i>You can't measure up to treatment of this magnitude, champion,\" Exgarutan insults you, his voice trembling as the slick massage persists, \"But don't think that I'm giving you permission to slack off.  A slut like you can go on dreaming; one day maybe you'll have the perseverance to get close.\"");
        }
        //[if corruption ≥33 & <66]
        else if (player.cor < 66)
        {
            outputText("Your corrupt cock begins to speak up, the demon's unrelenting motions refusing to ease off, \"You're loving every bit of this champion.  There isn't a hint of uncertainty lingering in your senses.  If only you were this accepting all the time.\"");
        }
        //[else]
        else
        {
            outputText("\"<i>Isn't this great, [name]? With both of our sexual expertise combined, we'll own this land in no time, and enjoy the fuck out of any downtime.\"");
        }
